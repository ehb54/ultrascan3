...
void
PM_WORKER::set_grid_size (double grid_conversion_factor, bool quiet)
{
...
void
PM_WORKER::reset_grid_size (bool quiet)
{
...
bool
PM_WORKER::create_model (vector<double> params, set<pm_point> &model,
...
set<pm_point>
PM_WORKER::recenter (set<pm_point> &model)
{
  int cx = 0;
  int cy = 0;
  int cz = 0;
...
bool
PM_WORKER::rotation_matrix (double l, double m, double n, double theta,
...
bool
PM_WORKER::apply_rotation_matrix (vector<vector<double> > &rm, int x, int y,
...
bool
PM_WORKER::split (vector<double> &params, vector<int> &types,
...
bool
PM_WORKER::join (vector<double> &params, vector<int> &types,
                 vector<double> &fparams)
{
  params.clear ();
