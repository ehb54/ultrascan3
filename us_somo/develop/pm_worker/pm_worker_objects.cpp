...
bool
PM_WORKER::create_1_model (int model_pos, vector<double> &params,
...
bool
PM_WORKER::sphere (int model_pos, vector<double> &params,
                   vector<double> &params_left, set<pm_point> &model)
{
  int ofs = 1;
...
bool
PM_WORKER::cylinder (int model_pos, vector<double> &params,
                     vector<double> &params_left, set<pm_point> &model)
{
  int ofs = 1;
  double radius = params[ofs++];
...
bool
PM_WORKER::ellipsoid (int model_pos, vector<double> &params,
                      vector<double> &params_left, set<pm_point> &model)
{
  int ofs = 1;
...
bool
PM_WORKER::spheroid (int model_pos, vector<double> &params,
                     vector<double> &params_left, set<pm_point> &model)
{
  int ofs = 1;
  double radiusa = params[ofs++];
...
bool
PM_WORKER::torus_segment (int model_pos, vector<double> &params,
                          vector<double> &params_left, set<pm_point> &model)
{
  int ofs = 1;
  double radiusa = params[ofs++];
...
bool
PM_WORKER::torus (int model_pos, vector<double> &params,
                  vector<double> &params_left, set<pm_point> &model)
{
  int ofs = 1;
  double radiusa = params[ofs++];
