...
US_Hydrodyn_OR::setupGUI ()
{
  ...
  cb_remove->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cb_replicate_method->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_replicate_method->setPalette (PALET_NORMAL);
  AUTFBACK (cb_replicate_method);
  connect (cb_replicate_method, SIGNAL (clicked ()),
           SLOT (set_replicate_method ()));
  ...
  cb_fuse->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  cnt_fuse->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  cnt_fuse->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_fuse);
  connect (cnt_fuse, SIGNAL (valueChanged (double)),
           SLOT (update_fuse (double)));
  ...
  cb_hierarch->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cnt_hierarch->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  cb_sync->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  cnt_sync->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  cnt_sync->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_sync);
  connect (cnt_sync, SIGNAL (valueChanged (double)),
           SLOT (update_sync (double)));
...
void
US_Hydrodyn_OR::set_replicate_method ()
{
...
void
US_Hydrodyn_OR::update_fuse (double val)
{
...
void
US_Hydrodyn_OR::update_sync (double val)
{
...
void
US_Hydrodyn_OR::update_hierarch (double val)
{
