...
void US_Hydrodyn_Dad::adjust_wheel(double pos) {
...
void US_Hydrodyn_Dad::wheel_cancel(bool from_wheel_save) {
...
void US_Hydrodyn_Dad::wheel_save() {
  clear_smoothed();  // for now always on cancel or save
  clear_oldstyle();  // for now always on cancel or save
...
void US_Hydrodyn_Dad::wheel_pressed() {
  // qDebug() << "wheel_pressed()";
  wheel_is_pressed = true;
}

void US_Hydrodyn_Dad::wheel_released() {
