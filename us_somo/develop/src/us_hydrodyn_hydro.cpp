...
US_Hydrodyn_Hydro::US_Hydrodyn_Hydro (struct hydro_options *hydro,
                                      bool *hydro_widget, void *us_hydrodyn,
...
US_Hydrodyn_Hydro::~US_Hydrodyn_Hydro () { *hydro_widget = false; }

void
US_Hydrodyn_Hydro::setupGUI ()
{
  int minHeight1 = 30;
  QString str;
  lbl_info
      = new QLabel (us_tr ("SOMO Hydrodynamic Calculation Options:"), this);
  ...
  lbl_unit = new QLabel (us_tr ("Model scale (10^-x m) (10 = Angstrom, 9 = "
                                "nanometer), where x is :"),
                         this);
  ...
  lbl_solvent_name->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  le_solvent_name->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  le_solvent_name->setEnabled (true);
  connect (le_solvent_name, SIGNAL (textChanged (const QString &)),
           SLOT (update_solvent_name (const QString &)));
  ...
  cb_solvent_defaults->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_solvent_defaults->setPalette (PALET_NORMAL);
  AUTFBACK (cb_solvent_defaults);
  connect (cb_solvent_defaults, SIGNAL (clicked ()), this,
           SLOT (set_solvent_defaults ()));

  lbl_solvent_acronym = new QLabel (us_tr (" Solvent acronym:"));
  //   lbl_solvent_acronym = new QLabel(us_tr(" Solvent acronym (max 5
  //   characters):"), bg_solvent_conditions);
  ...
  lbl_solvent_acronym->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));
  ...
  le_solvent_acronym->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  le_solvent_acronym->setEnabled (true);
  connect (le_solvent_acronym, SIGNAL (textChanged (const QString &)),
           SLOT (update_solvent_acronym (const QString &)));

  lbl_temperature = new QLabel (
      us_tr (QString (" Temperature (%1C): ").arg (DEGREE_SYMBOL)),
      bg_solvent_conditions);
  ...
  lbl_solvent_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1,
                                         QFont::Bold));

  le_solvent_viscosity = new QLineEdit ();
  le_solvent_viscosity->setText (
      str.sprintf ("%f", (*hydro).solvent_viscosity));
  ...
  le_solvent_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  le_solvent_viscosity->setEnabled (true);
  connect (le_solvent_viscosity, SIGNAL (textChanged (const QString &)),
           SLOT (update_solvent_viscosity (const QString &)));
  ...
  lbl_solvent_density->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));
  ...
  le_solvent_density->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  le_solvent_density->setEnabled (true);
  connect (le_solvent_density, SIGNAL (textChanged (const QString &)),
           SLOT (update_solvent_density (const QString &)));

  cb_manual_solvent_conditions = new QCheckBox ();
  cb_manual_solvent_conditions->setText (us_tr (
      "Use manually entered solvent conditions regardless of temperature."));
  cb_manual_solvent_conditions->setEnabled (true);
  cb_manual_solvent_conditions->setChecked (hydro->manual_solvent_conditions);
  cb_manual_solvent_conditions->setFont (QFont (
  ...
  connect (cb_manual_solvent_conditions, SIGNAL (clicked ()), this,
           SLOT (set_manual_solvent_conditions ()));

  lbl_tc_solvent_viscosity
      = new QLabel (us_tr (" T.C. Solvent viscosity [cP]:"));
  ...
  lbl_tc_solvent_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));

  le_tc_solvent_viscosity = new QLineEdit ();
  le_tc_solvent_viscosity->setText (
      str.sprintf ("%f", ((US_Hydrodyn *)us_hydrodyn)->tc_solvent_visc ()));
  ...
  le_tc_solvent_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  le_tc_solvent_viscosity->setEnabled (true);
  le_tc_solvent_viscosity->setReadOnly (true);

  lbl_tc_solvent_density
      = new QLabel (us_tr (" T.C. Solvent density [g/ml]:"));
  ...
  lbl_tc_solvent_density->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1,
                                          QFont::Bold));

  le_tc_solvent_density = new QLineEdit ();
  le_tc_solvent_density->setText (
      str.sprintf ("%f", ((US_Hydrodyn *)us_hydrodyn)->tc_solvent_dens ()));
  ...
  le_tc_solvent_density->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  rb_diffusion_center->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  rb_diffusion_center->setPalette (PALET_NORMAL);
  AUTFBACK (rb_diffusion_center);
  connect (rb_diffusion_center, SIGNAL (clicked ()), this,
           SLOT (select_reference_system ()));
  ...
  rb_cartesian_origin->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  rb_cartesian_origin->setPalette (PALET_NORMAL);
  AUTFBACK (rb_cartesian_origin);
  connect (rb_cartesian_origin, SIGNAL (clicked ()), this,
           SLOT (select_reference_system ()));
  ...
  rb_stick->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  rb_stick->setPalette (PALET_NORMAL);
  AUTFBACK (rb_stick);
  connect (rb_stick, SIGNAL (clicked ()), this,
           SLOT (select_boundary_cond ()));

  rb_slip = new QRadioButton ();
  rb_slip->setText (us_tr (" Slip "));
  rb_slip->setEnabled (true);
  rb_slip->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_mass);
  lbl_mass->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));

  le_mass = new QLineEdit (bg_mass_correction);
  le_mass->setObjectName ("Mass Line Edit");
  le_mass->setText (str.sprintf ("%5.3e", (*hydro).mass));
  le_mass->setAlignment (Qt::AlignVCenter);
  le_mass->setPalette (PALET_NORMAL);
  AUTFBACK (le_mass);
  le_mass->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  le_mass->setEnabled ((*hydro).mass_correction);
  connect (le_mass, SIGNAL (textChanged (const QString &)),
           SLOT (update_mass (const QString &)));
  ...
  AUTFBACK (lbl_volume);
  lbl_volume->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));

  le_volume = new QLineEdit (bg_volume_correction);
  le_volume->setObjectName ("Volume Line Edit");
  le_volume->setText (str.sprintf ("%5.3e", (*hydro).volume));
  le_volume->setAlignment (Qt::AlignVCenter);
  le_volume->setPalette (PALET_NORMAL);
  AUTFBACK (le_volume);
  le_volume->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  le_volume->setEnabled ((*hydro).volume_correction);
  connect (le_volume, SIGNAL (textChanged (const QString &)),
           SLOT (update_volume (const QString &)));
  ...
  bg_bead_inclusion = new QGroupBox (
      "Inclusion of Buried Beads in Hydrodynamic Calculations (for SMI):");

  rb_exclusion = new QRadioButton ();
  rb_exclusion->setText (us_tr (" Exclude "));
  rb_exclusion->setEnabled (true);
  rb_exclusion->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  rb_exclusion->setPalette (PALET_NORMAL);
  AUTFBACK (rb_exclusion);
  connect (rb_exclusion, SIGNAL (clicked ()), this,
           SLOT (select_bead_inclusion ()));

  rb_inclusion = new QRadioButton ();
  rb_inclusion->setText (us_tr (" Include "));
  rb_inclusion->setEnabled (true);
  rb_inclusion->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  rb_inclusion->setPalette (PALET_NORMAL);
  AUTFBACK (rb_inclusion);
  connect (rb_inclusion, SIGNAL (clicked ()), this,
           SLOT (select_bead_inclusion ()));
  ...
  bg_grpy_bead_inclusion = new QGroupBox (
      "Inclusion of Buried Beads in Hydrodynamic Calculations (for GRPY):");

  rb_grpy_exclusion = new QRadioButton ();
  rb_grpy_exclusion->setText (us_tr (" Exclude "));
  rb_grpy_exclusion->setEnabled (true);
  rb_grpy_exclusion->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  rb_grpy_exclusion->setPalette (PALET_NORMAL);
  AUTFBACK (rb_grpy_exclusion);
  connect (rb_grpy_exclusion, SIGNAL (clicked ()), this,
           SLOT (select_grpy_bead_inclusion ()));

  rb_grpy_inclusion = new QRadioButton ();
  rb_grpy_inclusion->setText (us_tr (" Include "));
  rb_grpy_inclusion->setEnabled (true);
  rb_grpy_inclusion->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  rb_grpy_inclusion->setPalette (PALET_NORMAL);
  AUTFBACK (rb_grpy_inclusion);
  connect (rb_grpy_inclusion, SIGNAL (clicked ()), this,
           SLOT (select_grpy_bead_inclusion ()));
  ...
  bg_buried = new QGroupBox ("Include Buried Beads in Volume Correction for "
                             "Calculation of (for SMI):");
  ...
  cb_rotational->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  lbl_overlap->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));

  le_overlap = new QLineEdit (bg_overlap);
  le_overlap->setObjectName ("Mass Line Edit");
  ...
  AUTFBACK (le_overlap);
  le_overlap->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_overlap->setEnabled ((*hydro).overlap_cutoff);
  connect (le_overlap, SIGNAL (textChanged (const QString &)),
           SLOT (update_overlap (const QString &)));
  ...
  j++;
  background->addWidget (bg_solvent_conditions, j, 0, 1 + (j + 5) - (j),
                         1 + (1) - (0));
  j += 6;
  background->addWidget (bg_reference_system, j, 0, 1 + (j + 2) - (j),
                         1 + (1) - (0));
  j += 3;
  background->addWidget (bg_boundary_cond, j, 0, 1 + (j + 2) - (j),
                         1 + (1) - (0));
  j += 3;
  background->addWidget (bg_mass_correction, j, 0, 1 + (j + 2) - (j),
                         1 + (1) - (0));
  j += 3;
  background->addWidget (bg_volume_correction, j, 0, 1 + (j + 2) - (j),
                         1 + (1) - (0));
  j += 3;
  background->addWidget (bg_bead_inclusion, j, 0, 1 + (j + 2) - (j),
                         1 + (1) - (0));
  j += 3;
  background->addWidget (bg_grpy_bead_inclusion, j, 0, 1 + (j + 2) - (j),
                         1 + (1) - (0));
  j += 3;
...
void
US_Hydrodyn_Hydro::update_unit (double val)
{
  (*hydro).unit = (int)-val;
...
void
US_Hydrodyn_Hydro::update_solvent_name (const QString &str)
{
...
void
US_Hydrodyn_Hydro::update_solvent_acronym (const QString &str)
{
...
void
US_Hydrodyn_Hydro::update_temperature (const QString &str, bool update_main)
{
  ...
  le_tc_solvent_viscosity->setText (QString ("").sprintf (
      "%f", ((US_Hydrodyn *)us_hydrodyn)->tc_solvent_visc ()));
  le_tc_solvent_density->setText (QString ("").sprintf (
      "%f", ((US_Hydrodyn *)us_hydrodyn)->tc_solvent_dens ()));
}

void
US_Hydrodyn_Hydro::update_solvent_viscosity (const QString &str)
{
...
void
US_Hydrodyn_Hydro::update_solvent_density (const QString &str)
{
...
void
US_Hydrodyn_Hydro::update_volume (const QString &str)
{
...
void
US_Hydrodyn_Hydro::update_mass (const QString &str)
{
...
void
US_Hydrodyn_Hydro::update_overlap (const QString &str)
{
...
void
US_Hydrodyn_Hydro::select_reference_system ()
{
...
void
US_Hydrodyn_Hydro::select_reference_system (int val)
{
...
void
US_Hydrodyn_Hydro::select_boundary_cond ()
{
...
void
US_Hydrodyn_Hydro::select_boundary_cond (int val)
{
...
void
US_Hydrodyn_Hydro::select_bead_inclusion ()
{
...
void
US_Hydrodyn_Hydro::select_bead_inclusion (int val)
{
...
void
US_Hydrodyn_Hydro::select_grpy_bead_inclusion ()
{
...
void
US_Hydrodyn_Hydro::select_grpy_bead_inclusion (int val)
{
...
void
US_Hydrodyn_Hydro::select_volume_correction ()
{
...
void
US_Hydrodyn_Hydro::select_volume_correction (int val)
{
...
void
US_Hydrodyn_Hydro::select_mass_correction ()
{
...
void
US_Hydrodyn_Hydro::select_mass_correction (int val)
{
...
void
US_Hydrodyn_Hydro::select_overlap ()
{
...
void
US_Hydrodyn_Hydro::select_overlap (int val)
{
...
void
US_Hydrodyn_Hydro::set_rotational ()
{
...
void
US_Hydrodyn_Hydro::set_viscosity ()
{
...
void
US_Hydrodyn_Hydro::set_manual_solvent_conditions ()
{
  hydro->manual_solvent_conditions
      = cb_manual_solvent_conditions->isChecked ();
  le_tc_solvent_viscosity->setEnabled (
      !cb_manual_solvent_conditions->isChecked ());
  le_tc_solvent_density->setEnabled (
      !cb_manual_solvent_conditions->isChecked ());
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_Hydro::set_solvent_defaults ()
{
  if (cb_solvent_defaults->isChecked ())
    {
      ...
      le_temperature->setText (
          QString ("").sprintf ("%4.2f", (*hydro).temperature));
      ((US_Hydrodyn *)us_hydrodyn)
          ->le_temperature->setText (
              QString ("").sprintf ("%4.2f", (*hydro).temperature));
      le_solvent_viscosity->setText (
          QString ("").sprintf ("%f", (*hydro).solvent_viscosity));
      le_solvent_density->setText (
          QString ("").sprintf ("%f", (*hydro).solvent_density));
    }
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_Hydro::check_solvent_defaults ()
{
  cb_solvent_defaults->setChecked (
      hydro->solvent_name == "Water" && hydro->solvent_acronym == "w"
      && hydro->temperature == K20 - K0
      && hydro->solvent_viscosity == VISC_20W * 100
      && hydro->solvent_density == DENS_20W);
}
...
void
US_Hydrodyn_Hydro::cancel ()
{
  close ();
}

void
US_Hydrodyn_Hydro::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Hydro::closeEvent (QCloseEvent *e)
{
  *hydro_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
