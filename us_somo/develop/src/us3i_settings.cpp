...
void
US3i_Settings::set_browser (const QString &browser)
{
  QSettings settings (US3, "UltraScan");
...
QString
US3i_Settings::workBaseDir (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_workBaseDir (const QString &dir)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_importDir (const QString &dir)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_tmpDir (const QString &dir)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_license (const QStringList &license)
{
  QSettings settings (US3, "UltraScan");
...
// Master Password
QByteArray
US3i_Settings::UltraScanPW (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_UltraScanPW (const QByteArray &hash)
{
  QSettings settings (US3, "UltraScan");
...
double
US3i_Settings::tempTolerance (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_tempTolerance (double tempTolerance)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_beckmanBug (bool setBug)
{
  QSettings settings (US3, "UltraScan");
  if (!setBug)
...
int
US3i_Settings::default_data_location (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_default_data_location (int location)
{
  QSettings settings (US3, "UltraScan");
  if (location == 2)
...
void
US3i_Settings::set_us_debug (int level)
{
  QSettings settings (US3, "UltraScan");
  if (level == 0)
...
#ifndef NO_DB
void
US3i_Settings::set_debug_text (QStringList debuglist)
{
  QSettings settings (US3, "UltraScan");
...
bool
US3i_Settings::debug_match (QString match)
{
...
// Investigator
QString
US3i_Settings::us_inv_name (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_us_inv_name (const QString &name)
{
  QSettings settings (US3, "UltraScan");
  if (name == "")
...
void
US3i_Settings::set_us_inv_ID (int id)
{
  QSettings settings (US3, "UltraScan");
  if (id == -1)
...
int
US3i_Settings::us_inv_level (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_us_inv_level (int level)
{
  QSettings settings (US3, "UltraScan");
  if (level == 0)
...
// advanced level
int
US3i_Settings::advanced_level (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_advanced_level (int level)
{
  QSettings settings (US3, "UltraScan");
  if (level == 0)
...
void
US3i_Settings::set_threads (int threads)
{
  QSettings settings (US3, "UltraScan");
  if (threads == 1)
...
int
US3i_Settings::noise_dialog (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_noise_dialog (int diagflag)
{
  QSettings settings (US3, "UltraScan");
  if (diagflag == 0)
...
void
US3i_Settings::set_databases (const QList<QStringList> &dblist)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_defaultDB (const QStringList &defaultDB)
{
  QSettings settings (US3, "UltraScan");
...
QList<QStringList>
US3i_Settings::xpn_db_hosts (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_xpn_db_hosts (const QList<QStringList> &xhlist)
{
  QSettings settings (US3, "UltraScan");
...
QStringList
US3i_Settings::defaultXpnHost (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US3i_Settings::set_def_xpn_host (const QStringList &defXpnHost)
{
  QSettings settings (US3, "UltraScan");
