...
// dataDir
QString US3i_Settings::dataDir(void) { return (workBaseDir() + "/data"); }

// archiveDir
QString US3i_Settings::archiveDir(void) { return (workBaseDir() + "/archive"); }

// resultDir
QString US3i_Settings::resultDir(void) { return (workBaseDir() + "/results"); }

// reportDir
QString US3i_Settings::reportDir(void) { return (workBaseDir() + "/reports"); }

// etcDir
QString US3i_Settings::etcDir(void) { return (workBaseDir() + "/etc"); }
...
int US3i_Settings::us_debug(void) { return us3i_settings_debug; }

void US3i_Settings::set_us_debug(int level) { us3i_settings_debug = level; }
#endif
...
QStringList US3i_Settings::debug_text(void) { return us_sett_debug_text; }
#endif
