...
US_Hydrodyn_Dad_Options::US_Hydrodyn_Dad_Options (
    map<QString, QString> *parameters, US_Hydrodyn *us_hydrodyn, QWidget *p)
    : QDialog (p)
{
  this->dad_win = p;
...
void
US_Hydrodyn_Dad_Options::setupGUI ()
{
  int minHeight1 = 28;
  ...
  lbl_baseline->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  rb_linear->setChecked (parameters->count ("dad_bl_linear")
                         && (*parameters)["dad_bl_linear"] == "true");
  rb_linear->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  rb_integral
      = new QRadioButton (us_tr ("Integral of I(t) baseline removal"), this);
  rb_integral->setEnabled (true);
  rb_integral->setChecked (parameters->count ("dad_bl_integral")
                           && (*parameters)["dad_bl_integral"] == "true");
  rb_integral->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  // connect( bg_bl_type, SIGNAL( buttonClicked( int id ) ), SLOT(
  // update_enables() ) );
#else
  ...
  cb_save_bl->setChecked (parameters->count ("dad_bl_save")
                          && (*parameters)["dad_bl_save"] == "true");
  cb_save_bl->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  le_smooth = new QLineEdit (this);
  le_smooth->setObjectName ("le_smooth Line Edit");
  le_smooth->setText (parameters->count ("dad_bl_smooth")
                          ? (*parameters)["dad_bl_smooth"]
                          : "10");
  le_smooth->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_smooth->setPalette (PALET_NORMAL);
  AUTFBACK (le_smooth);
  le_smooth->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator (0, 99, le_smooth);
    le_smooth->setValidator (qdv);
  }
  connect (le_smooth, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_smooth->setMinimumWidth (60);

  lbl_start_region
      = new QLabel (us_tr ("Start frames for test integral offset:"), this);
  ...
  lbl_start_region->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize,
                                    QFont::Bold));

  le_start_region = new QLineEdit (this);
  le_start_region->setObjectName ("le_start_region Line Edit");
  le_start_region->setText (parameters->count ("dad_bl_start_region")
  ...
  le_start_region->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator (0, 99, le_start_region);
    le_start_region->setValidator (qdv);
  }
  connect (le_start_region, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  lbl_i_power->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));

  le_i_power = new QLineEdit (this);
  le_i_power->setObjectName ("le_i_power Line Edit");
  le_i_power->setText (parameters->count ("dad_bl_i_power")
                           ? (*parameters)["dad_bl_i_power"]
                           : "1");
  le_i_power->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_i_power->setPalette (PALET_NORMAL);
  AUTFBACK (le_i_power);
  le_i_power->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 3, 3, le_i_power);
    le_i_power->setValidator (qdv);
  }
  connect (le_i_power, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  AUTFBACK (lbl_reps);
  lbl_reps->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));

  le_reps = new QLineEdit (this);
  le_reps->setObjectName ("le_reps Line Edit");
  le_reps->setText (
      parameters->count ("dad_bl_reps") ? (*parameters)["dad_bl_reps"] : "1");
  le_reps->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_reps->setPalette (PALET_NORMAL);
  AUTFBACK (le_reps);
  le_reps->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator (1, 20, le_reps);
    le_reps->setValidator (qdv);
  }
  connect (le_reps, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  le_epsilon = new QLineEdit (this);
  le_epsilon->setObjectName ("le_epsilon Line Edit");
  le_epsilon->setText (parameters->count ("dad_bl_epsilon")
  ...
  connect (le_epsilon, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_epsilon->setMinimumWidth (60);

  lbl_cormap_maxq
      = new QLabel (us_tr ("Global PVP Analysis maximum q [A^-1]:"), this);
  lbl_cormap_maxq->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_cormap_maxq->setPalette (PALET_LABEL);
  AUTFBACK (lbl_cormap_maxq);
  lbl_cormap_maxq->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize,
                                   QFont::Bold));

  le_cormap_maxq = new QLineEdit (this);
  le_cormap_maxq->setObjectName ("le_cormap_maxq Line Edit");
  le_cormap_maxq->setText (parameters->count ("dad_cormap_maxq")
  ...
  le_cormap_maxq->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 3, 3, le_cormap_maxq);
    le_cormap_maxq->setValidator (qdv);
  }
  connect (le_cormap_maxq, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  lbl_cormap_alpha->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize,
                                    QFont::Bold));

  le_cormap_alpha = new QLineEdit (this);
  le_cormap_alpha->setObjectName ("le_cormap_alpha Line Edit");
  le_cormap_alpha->setText (parameters->count ("dad_cormap_alpha")
  ...
  le_cormap_alpha->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 0.5, 3, le_cormap_alpha);
    le_cormap_alpha->setValidator (qdv);
  }
  connect (le_cormap_alpha, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  lbl_gaussian_type->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize,
                                     QFont::Bold));

  rb_gauss = new QRadioButton (us_tr ("Standard Gaussians"), this);
  rb_gauss->setEnabled (true);
  rb_gauss->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  rb_gauss->setPalette (PALET_NORMAL);
  AUTFBACK (rb_gauss);

  rb_gmg = new QRadioButton (us_tr ("GMG (Half-Gaussian modified Gaussian)"),
                             this);
  rb_gmg->setEnabled (true);
  rb_gmg->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  rb_gmg->setPalette (PALET_NORMAL);
  AUTFBACK (rb_gmg);

  rb_emg = new QRadioButton (us_tr ("EMG (Exponentially modified Gaussian)"),
                             this);
  rb_emg->setEnabled (true);
  rb_emg->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  rb_emggmg->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  pb_clear_gauss
      = new QPushButton (us_tr ("Clear cached Gaussian values"), this);
  pb_clear_gauss->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  lbl_other_options->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize,
                                     QFont::Bold));

  pb_detector
      = new QPushButton (us_tr ("Concentration Detector Properties"), this);
  ...
  pb_dad_parameters
      = new QPushButton (us_tr ("UV-Vis Processing Parameters"), this);
  pb_dad_parameters->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  pb_dad_parameters->setMinimumHeight (minHeight1);
  pb_dad_parameters->setPalette (PALET_PUSHB);
  connect (pb_dad_parameters, SIGNAL (clicked ()),
           SLOT (set_dad_parameters ()));
  ...
  lbl_fasta_pH->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));

  le_fasta_pH = new QLineEdit (this);
  le_fasta_pH->setObjectName ("le_fasta_pH Line Edit");
  le_fasta_pH->setText (
      QString ("").sprintf ("%4.2f", ((US_Hydrodyn *)us_hydrodyn)->hydro.pH));
  le_fasta_pH->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  le_fasta_pH->setPalette (PALET_EDIT);
  AUTFBACK (le_fasta_pH);
  le_fasta_pH->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  connect (le_fasta_pH, SIGNAL (textChanged (const QString &)),
           SLOT (update_fasta_pH (const QString &)));
  ...
  cb_csv_transposed->setChecked ((*parameters)["dad_csv_transposed"]
                                 == "true");
  cb_csv_transposed->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_csv_transposed->setPalette (PALET_NORMAL);
  AUTFBACK (cb_csv_transposed);

  lbl_zi_window
      = new QLabel (us_tr ("I(t) negative integral check window :"), this);
  lbl_zi_window->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_zi_window->setPalette (PALET_LABEL);
  AUTFBACK (lbl_zi_window);
  lbl_zi_window->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize, QFont::Bold));

  le_zi_window = new QLineEdit (this);
  le_zi_window->setObjectName ("le_zi_window Line Edit");
  le_zi_window->setText ((*parameters)["dad_zi_window"]);
  le_zi_window->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_zi_window->setPalette (PALET_NORMAL);
  AUTFBACK (le_zi_window);
  le_zi_window->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator (5, 200, le_zi_window);
    le_zi_window->setValidator (qdv);
  }
  connect (le_zi_window, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_zi_window->setMinimumWidth (60);

  cb_discard_it_sd_mult = new QCheckBox (this);
  cb_discard_it_sd_mult->setText (
      us_tr ("On Make I(t), discard I(t) with no signal above std. dev. "
             "multiplied by: "));
  cb_discard_it_sd_mult->setEnabled (true);
  cb_discard_it_sd_mult->setChecked ((*parameters)["dad_cb_discard_it_sd_mult"]
                                     == "true");
  cb_discard_it_sd_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_discard_it_sd_mult->setPalette (PALET_NORMAL);
  AUTFBACK (cb_discard_it_sd_mult);
  connect (cb_discard_it_sd_mult, SIGNAL (clicked ()),
           SLOT (update_enables ()));

  le_discard_it_sd_mult = new QLineEdit (this);
  le_discard_it_sd_mult->setObjectName ("le_discard_it_sd_mult Line Edit");
  le_discard_it_sd_mult->setText ((*parameters)["dad_discard_it_sd_mult"]);
  ...
  le_discard_it_sd_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (1, 20, 3, le_discard_it_sd_mult);
    le_discard_it_sd_mult->setValidator (qdv);
  }
  connect (le_discard_it_sd_mult, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  le_guinier_qrgmax = new QLineEdit (this);
  ...
  cb_gg_smooth->setText (us_tr ("Experimental: Global Gaussian initialization "
                                "smoothing. Maximum smoothing points: "));
  cb_gg_smooth->setEnabled (true);
  cb_gg_smooth->setChecked ((*parameters)["dad_cb_gg_smooth"] == "true");
  cb_gg_smooth->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_gg_smooth->setPalette (PALET_NORMAL);
  AUTFBACK (cb_gg_smooth);
  connect (cb_gg_smooth, SIGNAL (clicked ()), SLOT (update_enables ()));

  le_gg_smooth = new QLineEdit (this);
  le_gg_smooth->setObjectName ("le_gg_smooth Line Edit");
  le_gg_smooth->setText ((*parameters)["dad_gg_smooth"]);
  le_gg_smooth->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_gg_smooth->setPalette (PALET_NORMAL);
  AUTFBACK (le_gg_smooth);
  le_gg_smooth->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  {
    QIntValidator *qiv = new QIntValidator (1, 50, le_gg_smooth);
    le_gg_smooth->setValidator (qiv);
  }
  connect (le_gg_smooth, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_gg_smooth->setMinimumWidth (60);

  cb_gg_cyclic = new QCheckBox (this);
  cb_gg_cyclic->setText (
      us_tr ("Experimental: Global Gaussian Gaussian cyclic fit"));
  cb_gg_cyclic->setEnabled (true);
  cb_gg_cyclic->setChecked ((*parameters)["dad_cb_gg_cyclic"] == "true");
  cb_gg_cyclic->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  cb_gg_oldstyle->setText (us_tr ("Experimental: Global Gaussian - Enable old "
                                  "style Gaussian fit display"));
  cb_gg_oldstyle->setEnabled (true);
  cb_gg_oldstyle->setChecked ((*parameters)["dad_cb_gg_oldstyle"] == "true");
  cb_gg_oldstyle->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_mwt_k);
  lbl_mwt_k->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));

  le_mwt_k = new QLineEdit (this);
  le_mwt_k->setObjectName ("le_mwt_k Line Edit");
  le_mwt_k->setText (parameters->count ("guinier_mwt_k")
                         ? (*parameters)["guinier_mwt_k"]
                         : "0.973");
  le_mwt_k->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_mwt_k->setPalette (PALET_NORMAL);
  AUTFBACK (le_mwt_k);
  le_mwt_k->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0.001, 3, 6, le_mwt_k);
    le_mwt_k->setValidator (qdv);
  }
  connect (le_mwt_k, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  AUTFBACK (lbl_mwt_c);
  lbl_mwt_c->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));

  le_mwt_c = new QLineEdit (this);
  le_mwt_c->setObjectName ("le_mwt_c Line Edit");
  le_mwt_c->setText (parameters->count ("guinier_mwt_c")
                         ? (*parameters)["guinier_mwt_c"]
                         : "-1.878");
  le_mwt_c->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_mwt_c->setPalette (PALET_NORMAL);
  AUTFBACK (le_mwt_c);
  le_mwt_c->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (-3, 0, 6, le_mwt_c);
    le_mwt_c->setValidator (qdv);
  }
  connect (le_mwt_c, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  lbl_mwt_qmax->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize, QFont::Bold));

  le_mwt_qmax = new QLineEdit (this);
  le_mwt_qmax->setObjectName ("le_mwt_qmax Line Edit");
  le_mwt_qmax->setText (parameters->count ("guinier_mwt_qmax")
  ...
  le_mwt_qmax->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0.05, 1.0, 3, le_mwt_qmax);
    le_mwt_qmax->setValidator (qdv);
  }
  connect (le_mwt_qmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_mwt_qmax->setMinimumWidth (60);

  lbl_dist_max = new QLabel (
      us_tr ("Maximum absolute value of EMG and GMG distortions:"), this);
  lbl_dist_max->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_dist_max->setPalette (PALET_LABEL);
  AUTFBACK (lbl_dist_max);
  lbl_dist_max->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize, QFont::Bold));

  le_dist_max = new QLineEdit (this);
  le_dist_max->setObjectName ("le_dist_max Line Edit");
  le_dist_max->setText ((*parameters)["dad_dist_max"]);
  le_dist_max->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_dist_max->setPalette (PALET_NORMAL);
  AUTFBACK (le_dist_max);
  le_dist_max->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (10, 1000, 1, le_dist_max);
    le_dist_max->setValidator (qdv);
  }
  connect (le_dist_max, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_dist_max->setMinimumWidth (60);

  lbl_ampl_width_min = new QLabel (
      us_tr ("Global minimum value for amplitude and width:"), this);
  ...
  lbl_ampl_width_min->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize,
                                      QFont::Bold));

  le_ampl_width_min = new QLineEdit (this);
  le_ampl_width_min->setObjectName ("le_ampl_width_min Line Edit");
  le_ampl_width_min->setText ((*parameters)["dad_ampl_width_min"]);
  ...
  le_ampl_width_min->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (1e-50, 1e-3, 1, le_ampl_width_min);
    le_ampl_width_min->setValidator (qdv);
  }
  connect (le_ampl_width_min, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_ampl_width_min->setMinimumWidth (60);

  cb_lock_min_retry = new QCheckBox (this);
  cb_lock_min_retry->setText (
      us_tr ("Lock curves and retry when minimum amplitude or width is "
             "pegged\nby the global minimum times this value:"));
  cb_lock_min_retry->setEnabled (true);
  cb_lock_min_retry->setChecked ((*parameters)["dad_lock_min_retry"]
                                 == "true");
  cb_lock_min_retry->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_lock_min_retry->setPalette (PALET_NORMAL);
  AUTFBACK (cb_lock_min_retry);

  le_lock_min_retry_mult = new QLineEdit (this);
  le_lock_min_retry_mult->setObjectName ("le_lock_min_retry_mult Line Edit");
  le_lock_min_retry_mult->setText ((*parameters)["dad_lock_min_retry_mult"]);
  ...
  le_lock_min_retry_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (1, 2, 3, le_lock_min_retry_mult);
    le_lock_min_retry_mult->setValidator (qdv);
  }
  connect (le_lock_min_retry_mult, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_lock_min_retry_mult->setMinimumWidth (60);

  cb_maxfpk_restart = new QCheckBox (this);
  cb_maxfpk_restart->setText (us_tr (
      "Retry fits by increasing largest free peak amplitude by percent:"));
  cb_maxfpk_restart->setEnabled (true);
  cb_maxfpk_restart->setChecked ((*parameters)["dad_maxfpk_restart"]
                                 == "true");
  cb_maxfpk_restart->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_maxfpk_restart->setPalette (PALET_NORMAL);
  AUTFBACK (cb_maxfpk_restart);

  // le_maxfpk_restart_tries = new QLineEdit( this );
  // le_maxfpk_restart_tries->setObjectName( "le_maxfpk_restart_tries Line
  // Edit" ); le_maxfpk_restart_tries->setText( (*parameters)[
  // "dad_maxfpk_restart_tries" ] );
  // le_maxfpk_restart_tries->setAlignment(Qt::AlignCenter|Qt::AlignVCenter);
  // le_maxfpk_restart_tries->setPalette( PALET_NORMAL );
  // le_maxfpk_restart_tries->setFont(QFont( USglobal->config_list.fontFamily,
  // USglobal->config_list.fontSize ));
  // {
  //    QIntValidator *qiv = new QIntValidator( 1, 10, le_maxfpk_restart_tries
  //    ); le_maxfpk_restart_tries->setValidator( qiv );
  // }
  // connect( le_maxfpk_restart_tries, SIGNAL( textChanged( const QString & )
  // ), SLOT( update_enables() ) ); le_maxfpk_restart_tries->setMinimumWidth(
  // 60 );

  le_maxfpk_restart_pct = new QLineEdit (this);
  le_maxfpk_restart_pct->setObjectName ("le_maxfpk_restart_pct Line Edit");
  le_maxfpk_restart_pct->setText ((*parameters)["dad_maxfpk_restart_pct"]);
  ...
  le_maxfpk_restart_pct->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (1, 20, 1, le_maxfpk_restart_pct);
    le_maxfpk_restart_pct->setValidator (qdv);
  }
  connect (le_maxfpk_restart_pct, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_maxfpk_restart_pct->setMinimumWidth (60);

  cb_makeiq_cutmax_pct = new QCheckBox (this);
  cb_makeiq_cutmax_pct->setText (
      us_tr ("Make I(q): drop curves below % of Gaussian max intensity"));
  cb_makeiq_cutmax_pct->setEnabled (true);
  cb_makeiq_cutmax_pct->setChecked ((*parameters)["dad_cb_makeiq_cutmax_pct"]
                                    == "true");
  cb_makeiq_cutmax_pct->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_makeiq_cutmax_pct->setPalette (PALET_NORMAL);
  AUTFBACK (cb_makeiq_cutmax_pct);
  connect (cb_makeiq_cutmax_pct, SIGNAL (clicked ()),
           SLOT (update_enables ()));

  le_makeiq_cutmax_pct = new QLineEdit (this);
  le_makeiq_cutmax_pct->setObjectName ("le_makeiq_cutmax_pct Line Edit");
  le_makeiq_cutmax_pct->setText ((*parameters)["dad_makeiq_cutmax_pct"]);
  ...
  le_makeiq_cutmax_pct->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 75, 1, le_makeiq_cutmax_pct);
    le_makeiq_cutmax_pct->setValidator (qdv);
  }
  connect (le_makeiq_cutmax_pct, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  le_makeiq_cutmax_pct->setMinimumWidth (60);

  cb_makeiq_avg_peaks = new QCheckBox (this);
  cb_makeiq_avg_peaks->setText (
      us_tr ("Make I(q): average and normalize top % of max intensity"));
  cb_makeiq_avg_peaks->setEnabled (true);
  cb_makeiq_avg_peaks->setChecked ((*parameters)["dad_cb_makeiq_avg_peaks"]
                                   == "true");
  cb_makeiq_avg_peaks->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  le_makeiq_avg_peaks = new QLineEdit (this);
  le_makeiq_avg_peaks->setObjectName ("le_makeiq_avg_peaks Line Edit");
  le_makeiq_avg_peaks->setText ((*parameters)["dad_makeiq_avg_peaks"]);
  ...
  le_makeiq_avg_peaks->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (1, 75, 1, le_makeiq_avg_peaks);
    le_makeiq_avg_peaks->setValidator (qdv);
  }
  connect (le_makeiq_avg_peaks, SIGNAL (textChanged (const QString &)),
           SLOT (update_enables ()));
  ...
  pb_ok->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize + 1));
  ...
  gl_bl->setContentsMargins (0, 0, 0, 0);
  gl_bl->setSpacing (0);
  ...
  {
    QGridLayout *gl_other = new QGridLayout (0);
    gl_other->setContentsMargins (0, 0, 0, 0);
    gl_other->setSpacing (0);
...

  {
    ...
    hbl->addWidget (pb_dad_parameters);
  ...
  always_hide_widgets.insert ({ lbl_baseline,
                                rb_linear,
                                rb_integral,
                                lbl_smooth,
                                le_smooth,
...
void
US_Hydrodyn_Dad_Options::quit ()
{
  close ();
}

bool
US_Hydrodyn_Dad_Options::any_changes ()
{
  QString gaussian_type = "";
  if (rb_gauss->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Dad::GAUSS);
    }
  else if (rb_gmg->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Dad::GMG);
    }
  else if (rb_emg->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Dad::EMG);
    }
  else if (rb_emggmg->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Dad::EMGGMG);
    }

  return (*parameters)["dad_bl_linear"]
             != (rb_linear->isChecked () ? "true" : "false")
         || (*parameters)["dad_bl_integral"]
                != (rb_integral->isChecked () ? "true" : "false")
         || (*parameters)["dad_bl_save"]
                != (cb_save_bl->isChecked () ? "true" : "false")
         || (*parameters)["dad_bl_smooth"] != (le_smooth->text ())
         || (*parameters)["dad_bl_start_region"] != (le_start_region->text ())
         || (*parameters)["dad_bl_i_power"] != (le_i_power->text ())
         || (*parameters)["dad_bl_reps"] != (le_reps->text ())
         || (*parameters)["dad_bl_epsilon"] != (le_epsilon->text ())
         || (*parameters)["dad_cormap_maxq"] != (le_cormap_maxq->text ())
         || (*parameters)["dad_cormap_alpha"] != (le_cormap_alpha->text ())
         || (*parameters)["dad_zi_window"] != (le_zi_window->text ())
         || (*parameters)["dad_cb_discard_it_sd_mult"]
                != (cb_discard_it_sd_mult->isChecked () ? "true" : "false")
         || (*parameters)["dad_discard_it_sd_mult"]
                != (le_discard_it_sd_mult->text ())
         || (*parameters)["dad_cb_guinier_qrgmax"]
                != (cb_guinier_qrgmax->isChecked () ? "true" : "false")
         || (*parameters)["dad_guinier_qrgmax"] != (le_guinier_qrgmax->text ())
         || (*parameters)["dad_cb_gg_smooth"]
                != (cb_gg_smooth->isChecked () ? "true" : "false")
         || (*parameters)["dad_gg_smooth"] != (le_gg_smooth->text ())
         || (*parameters)["dad_cb_gg_cyclic"]
                != (cb_gg_cyclic->isChecked () ? "true" : "false")
         || (*parameters)["dad_cb_gg_oldstyle"]
                != (cb_gg_oldstyle->isChecked () ? "true" : "false")
         || (*parameters)["dad_dist_max"] != (le_dist_max->text ())
         ...
         || (*parameters)["dad_cb_makeiq_cutmax_pct"]
                != (cb_makeiq_cutmax_pct->isChecked () ? "true" : "false")
         || (*parameters)["dad_makeiq_cutmax_pct"]
                != (le_makeiq_cutmax_pct->text ())
         || (*parameters)["dad_cb_makeiq_avg_peaks"]
                != (cb_makeiq_avg_peaks->isChecked () ? "true" : "false")
         || (*parameters)["dad_makeiq_avg_peaks"]
                != (le_makeiq_avg_peaks->text ())
         || (*parameters)["dad_csv_transposed"]
                != (cb_csv_transposed->isChecked () ? "true" : "false")
         || (*parameters)["dad_ampl_width_min"] != (le_ampl_width_min->text ())
         || (*parameters)["dad_lock_min_retry"]
                != (cb_lock_min_retry->isChecked () ? "true" : "false")
         || (*parameters)["dad_lock_min_retry_mult"]
                != (le_lock_min_retry_mult->text ())
         || (*parameters)["dad_maxfpk_restart"]
                != (cb_maxfpk_restart->isChecked () ? "true" : "false")
         || (*parameters)["dad_maxfpk_restart_pct"]
                != (le_maxfpk_restart_pct->text ())
         || (*parameters)["gaussian_type"] != (gaussian_type);
}

void
US_Hydrodyn_Dad_Options::ok ()
{
  (*parameters)["ok"] = "true";

  (*parameters)["dad_bl_linear"] = rb_linear->isChecked () ? "true" : "false";
  (*parameters)["dad_bl_integral"]
      = rb_integral->isChecked () ? "true" : "false";
  (*parameters)["dad_bl_save"] = cb_save_bl->isChecked () ? "true" : "false";
  (*parameters)["dad_bl_smooth"] = le_smooth->text ();
  (*parameters)["dad_bl_start_region"] = le_start_region->text ();
  (*parameters)["dad_bl_i_power"] = le_i_power->text ();
  (*parameters)["dad_bl_reps"] = le_reps->text ();
  ...
  (*parameters)["dad_cb_discard_it_sd_mult"]
      = cb_discard_it_sd_mult->isChecked () ? "true" : "false";
  (*parameters)["dad_discard_it_sd_mult"] = le_discard_it_sd_mult->text ();
  (*parameters)["dad_cb_guinier_qrgmax"]
      = cb_guinier_qrgmax->isChecked () ? "true" : "false";
  (*parameters)["dad_guinier_qrgmax"] = le_guinier_qrgmax->text ();
  (*parameters)["dad_cb_gg_smooth"]
  ...
  (*parameters)["dad_cb_makeiq_cutmax_pct"]
      = cb_makeiq_cutmax_pct->isChecked () ? "true" : "false";
  (*parameters)["dad_makeiq_cutmax_pct"] = le_makeiq_cutmax_pct->text ();
  (*parameters)["dad_cb_makeiq_avg_peaks"]
      = cb_makeiq_avg_peaks->isChecked () ? "true" : "false";
  (*parameters)["dad_makeiq_avg_peaks"] = le_makeiq_avg_peaks->text ();

  if (rb_gauss->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Dad::GAUSS);
    }
  if (rb_gmg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Dad::GMG);
    }
  if (rb_emg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Dad::EMG);
    }
  if (rb_emggmg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Dad::EMGGMG);
    }
  ...
  (*parameters)["dad_lock_min_retry"]
      = cb_lock_min_retry->isChecked () ? "true" : "false";
  (*parameters)["dad_lock_min_retry_mult"] = le_lock_min_retry_mult->text ();

  (*parameters)["dad_maxfpk_restart"]
      = cb_maxfpk_restart->isChecked () ? "true" : "false";
  // (*parameters)[ "dad_maxfpk_restart_tries" ] =
  // le_maxfpk_restart_tries->text();
  (*parameters)["dad_maxfpk_restart_pct"] = le_maxfpk_restart_pct->text ();

  close ();
}

void
US_Hydrodyn_Dad_Options::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Dad_Options::closeEvent (QCloseEvent *e)
{
  if (any_changes ())
    {
      QMessageBox mb (
...
void
US_Hydrodyn_Dad_Options::update_enables ()
{
  ...
  pb_clear_gauss->setEnabled (((US_Hydrodyn_Dad *)dad_win)->any_gaussians ());
  le_epsilon->setEnabled (rb_integral->isChecked ());
  ...
  if (cb_makeiq_cutmax_pct->isEnabled () && cb_makeiq_cutmax_pct->isChecked ()
      && le_makeiq_avg_peaks->text ().toDouble ()
             > 100.0 - le_makeiq_cutmax_pct->text ().toDouble ())
    {
      le_makeiq_avg_peaks->setText (QString ("%1").arg (
          100.0 - le_makeiq_cutmax_pct->text ().toDouble ()));
    }
}

void
US_Hydrodyn_Dad_Options::clear_gauss ()
{
  if (QMessageBox::Yes
      == QMessageBox::question (
          this, windowTitle () + us_tr (": Clear cached Gaussian values"),
          us_tr ("Are you sure you want to clear all cached Gaussian values?"),
          QMessageBox::Yes, QMessageBox::No | QMessageBox::Default))
    {
      ((US_Hydrodyn_Dad *)dad_win)->clear_gaussians ();
    }
  update_enables ();
}

void
US_Hydrodyn_Dad_Options::set_detector ()
{
  {
    map<QString, QString> parameters;
    parameters["uv_conv"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->detector_uv_conv, 0, 'g', 8);
    parameters["ri_conv"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->detector_ri_conv, 0, 'g', 8);
    if (((US_Hydrodyn_Dad *)dad_win)->detector_uv)
      {
        parameters["uv"] = "true";
      }
    else
      {
        if (((US_Hydrodyn_Dad *)dad_win)->detector_ri)
          {
            parameters["ri"] = "true";
          }
      }
    ...
    ((US_Hydrodyn_Dad *)dad_win)->detector_uv
        = (parameters.count ("uv") && parameters["uv"] == "true") ? true
                                                                  : false;
    ((US_Hydrodyn_Dad *)dad_win)->detector_ri
        = (parameters.count ("ri") && parameters["ri"] == "true") ? true
                                                                  : false;
    ((US_Hydrodyn_Dad *)dad_win)->detector_ri_conv
        = parameters["ri_conv"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->detector_uv_conv
        = parameters["uv_conv"].toDouble ();
  }
}

void
US_Hydrodyn_Dad_Options::set_dad_parameters ()
{
  {
    map<QString, QString> parameters;

    parameters["dad_param_desc"]
        = ((US_Hydrodyn_Dad *)dad_win)->dad_param_desc;

    parameters["dad_param_lambda"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_lambda, 0, 'g', 8);
    parameters["dad_param_n"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_n, 0, 'g', 8);
    parameters["dad_param_g_dndc"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_dndc, 0, 'g', 8);
    parameters["dad_param_g_extinction_coef"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_extinction_coef, 0, 'g', 8);
    parameters["dad_param_g_conc"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_conc, 0, 'g', 8);
    parameters["dad_param_DLS_detector"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_DLS_detector);

    parameters["dad_param_dndc2_a"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_dndc2_a, 0, 'g', 8);
    parameters["dad_param_dndc2_b"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_dndc2_b, 0, 'g', 8);
    parameters["dad_param_dndc2_c"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_dndc2_c, 0, 'g', 8);

    parameters["dad_param_n2_a"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_n2_a, 0, 'g', 8);
    parameters["dad_param_n2_b"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_n2_b, 0, 'g', 8);
    parameters["dad_param_n2_c"] = QString ("%1").arg (
        ((US_Hydrodyn_Dad *)dad_win)->dad_param_n2_c, 0, 'g', 8);

    US_Hydrodyn_Dad_Parameters *dad_parameters
        = new US_Hydrodyn_Dad_Parameters (us_hydrodyn, &parameters, this);
    US_Hydrodyn::fixWinButtons (dad_parameters);
    dad_parameters->exec ();
    delete dad_parameters;
    ...
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_lambda
        = parameters["dad_param_lambda"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_n
        = parameters["dad_param_n"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_dndc
        = parameters["dad_param_g_dndc"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_extinction_coef
        = parameters["dad_param_g_extinction_coef"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_conc
        = parameters["dad_param_g_conc"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_DLS_detector
        = parameters["dad_param_DLS_detector"].toInt ();

    ((US_Hydrodyn_Dad *)dad_win)->dad_param_dndc2_a
        = parameters["dad_param_dndc2_a"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_dndc2_b
        = parameters["dad_param_dndc2_b"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_dndc2_c
        = parameters["dad_param_dndc2_c"].toDouble ();

    ((US_Hydrodyn_Dad *)dad_win)->dad_param_n2_a
        = parameters["dad_param_n2_a"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_n2_b
        = parameters["dad_param_n2_b"].toDouble ();
    ((US_Hydrodyn_Dad *)dad_win)->dad_param_n2_c
        = parameters["dad_param_n2_c"].toDouble ();
  }
}

void
US_Hydrodyn_Dad_Options::fasta_file ()
{
  // load file
...
void
US_Hydrodyn_Dad_Options::update_fasta_pH (const QString &str)
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)
      ->le_pH->setText (QString ("").sprintf (
          "%4.2f", ((US_Hydrodyn *)us_hydrodyn)->hydro.pH));
