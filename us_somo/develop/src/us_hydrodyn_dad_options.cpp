...
void US_Hydrodyn_Dad_Options::setupGUI()
{
   ...
   rb_linear->setChecked( parameters->count( "dad_bl_linear" ) && (*parameters)[ "dad_bl_linear" ] == "true" );
   ...
   rb_integral->setChecked( parameters->count( "dad_bl_integral" ) && (*parameters)[ "dad_bl_integral" ] == "true" );
   ...
   cb_save_bl->setChecked( parameters->count( "dad_bl_save" ) && (*parameters)[ "dad_bl_save" ] == "true" );
   ...
   le_smooth->setText( parameters->count( "dad_bl_smooth" ) ? (*parameters)[ "dad_bl_smooth" ] : "10" );
   ...
   le_start_region->setText( parameters->count( "dad_bl_start_region" ) ? (*parameters)[ "dad_bl_start_region" ] : "10" );
   ...
   le_i_power->setText( parameters->count( "dad_bl_i_power" ) ? (*parameters)[ "dad_bl_i_power" ] : "1" );
   ...
   le_reps->setText( parameters->count( "dad_bl_reps" ) ? (*parameters)[ "dad_bl_reps" ] : "1" );
   ...
   le_epsilon->setText( parameters->count( "dad_bl_epsilon" ) ? (*parameters)[ "dad_bl_epsilon" ] : "1" );
   ...
   le_cormap_maxq->setText( parameters->count( "dad_cormap_maxq" ) ? (*parameters)[ "dad_cormap_maxq" ] : "0.05" );
   ...
   le_cormap_alpha->setText( parameters->count( "dad_cormap_alpha" ) ? (*parameters)[ "dad_cormap_alpha" ] : "0.01" );
   ...
   cb_discard_it_sd_mult->setChecked( (*parameters)[ "dad_cb_discard_it_sd_mult" ] == "true" );
   ...
   le_ampl_min->setText( (*parameters)[ "dad_ampl_min" ] );
   ...
   // le_maxfpk_restart_tries->setText( (*parameters)[ "dad_maxfpk_restart_tries" ] );
   ...
   cb_makeiq_cutmax_pct->setChecked( (*parameters)[ "dad_cb_makeiq_cutmax_pct" ] == "true" );
   ...
   cb_makeiq_avg_peaks->setChecked( (*parameters)[ "dad_cb_makeiq_avg_peaks" ] == "true" );
...
void US_Hydrodyn_Dad_Options::quit()
{
   close();
}
...
bool US_Hydrodyn_Dad_Options::any_changes()
{
   ...
   return
      ...
      || (*parameters)[ "dad_bl_integral"             ] != ( rb_integral            ->isChecked() ? "true" : "false" )
      ...
      || (*parameters)[ "dad_cb_discard_it_sd_mult"   ] != ( cb_discard_it_sd_mult  ->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_discard_it_sd_mult"      ] != ( le_discard_it_sd_mult  ->text() )
      || (*parameters)[ "dad_cb_guinier_qrgmax"       ] != ( cb_guinier_qrgmax      ->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_guinier_qrgmax"          ] != ( le_guinier_qrgmax      ->text() )
      || (*parameters)[ "dad_cb_gg_smooth"            ] != ( cb_gg_smooth  ->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_gg_smooth"               ] != ( le_gg_smooth  ->text() )
      || (*parameters)[ "dad_cb_gg_cyclic"            ] != ( cb_gg_cyclic  ->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_cb_gg_oldstyle"          ] != ( cb_gg_oldstyle  ->isChecked() ? "true" : "false" )
      ...
      || (*parameters)[ "dad_cb_makeiq_cutmax_pct"    ] != ( cb_makeiq_cutmax_pct   ->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_makeiq_cutmax_pct"       ] != ( le_makeiq_cutmax_pct   ->text() )
      || (*parameters)[ "dad_cb_makeiq_avg_peaks"     ] != ( cb_makeiq_avg_peaks    ->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_makeiq_avg_peaks"        ] != ( le_makeiq_avg_peaks    ->text() )
      || (*parameters)[ "dad_csv_transposed"          ] != ( cb_csv_transposed->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_ampl_width_min"          ] != ( le_ampl_width_min      ->text() )
      || (*parameters)[ "dad_ampl_min"                ] != ( le_ampl_min            ->text() )
      || (*parameters)[ "dad_lock_min_retry"          ] != ( cb_lock_min_retry->isChecked() ? "true" : "false" )
      || (*parameters)[ "dad_lock_min_retry_mult"     ] != ( le_lock_min_retry_mult ->text() )
      || (*parameters)[ "dad_maxfpk_restart"          ] != ( cb_maxfpk_restart->isChecked() ? "true" : "false" )
...
void US_Hydrodyn_Dad_Options::ok()
{
   ...
   (*parameters)[ "dad_maxfpk_restart"       ] = cb_maxfpk_restart->isChecked() ? "true" : "false";
   // (*parameters)[ "dad_maxfpk_restart_tries" ] = le_maxfpk_restart_tries->text();
   (*parameters)[ "dad_maxfpk_restart_pct"   ] = le_maxfpk_restart_pct  ->text();
...
void US_Hydrodyn_Dad_Options::set_detector()
{
   {
      map < QString, QString > parameters;
      parameters[ "uv_conv" ] = QString( "%1" ).arg( ((US_Hydrodyn_Dad *)dad_win)->detector_uv_conv, 0, 'g', 8 );
      parameters[ "ri_conv" ] = QString( "%1" ).arg( ((US_Hydrodyn_Dad *)dad_win)->detector_ri_conv, 0, 'g', 8 );
      ...
      ((US_Hydrodyn_Dad *)dad_win)->detector_uv      = ( parameters.count( "uv" ) && parameters[ "uv" ] == "true" ) ? true : false;
      ((US_Hydrodyn_Dad *)dad_win)->detector_ri      = ( parameters.count( "ri" ) && parameters[ "ri" ] == "true" ) ? true : false;
      ((US_Hydrodyn_Dad *)dad_win)->detector_ri_conv = parameters[ "ri_conv" ].toDouble();
      ((US_Hydrodyn_Dad *)dad_win)->detector_uv_conv = parameters[ "uv_conv" ].toDouble();
   }
}
...
{
   {
      ...
      parameters[ "dad_param_g_extinction_coef" ] = QString( "%1" ).arg( ((US_Hydrodyn_Dad *)dad_win)->dad_param_g_extinction_coef, 0, 'g', 8 );
