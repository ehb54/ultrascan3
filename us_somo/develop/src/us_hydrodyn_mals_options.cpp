...
void US_Hydrodyn_Mals_Options::setupGUI()
{
   ...
   rb_linear->setChecked( parameters->count( "mals_bl_linear" ) && (*parameters)[ "mals_bl_linear" ] == "true" );
   ...
   rb_integral->setChecked( parameters->count( "mals_bl_integral" ) && (*parameters)[ "mals_bl_integral" ] == "true" );
   ...
   cb_save_bl->setChecked( parameters->count( "mals_bl_save" ) && (*parameters)[ "mals_bl_save" ] == "true" );
   ...
   le_smooth->setText( parameters->count( "mals_bl_smooth" ) ? (*parameters)[ "mals_bl_smooth" ] : "10" );
   ...
   le_start_region->setText( parameters->count( "mals_bl_start_region" ) ? (*parameters)[ "mals_bl_start_region" ] : "10" );
   ...
   le_i_power->setText( parameters->count( "mals_bl_i_power" ) ? (*parameters)[ "mals_bl_i_power" ] : "1" );
   ...
   le_reps->setText( parameters->count( "mals_bl_reps" ) ? (*parameters)[ "mals_bl_reps" ] : "1" );
   ...
   le_epsilon->setText( parameters->count( "mals_bl_epsilon" ) ? (*parameters)[ "mals_bl_epsilon" ] : "1" );
   ...
   le_cormap_maxq->setText( parameters->count( "mals_cormap_maxq" ) ? (*parameters)[ "mals_cormap_maxq" ] : "0.05" );
   ...
   le_cormap_alpha->setText( parameters->count( "mals_cormap_alpha" ) ? (*parameters)[ "mals_cormap_alpha" ] : "0.01" );
   ...
   cb_discard_it_sd_mult->setChecked( (*parameters)[ "mals_cb_discard_it_sd_mult" ] == "true" );
   ...
   // le_maxfpk_restart_tries->setText( (*parameters)[ "mals_maxfpk_restart_tries" ] );
   ...
   cb_makeiq_cutmax_pct->setChecked( (*parameters)[ "mals_cb_makeiq_cutmax_pct" ] == "true" );
...
bool US_Hydrodyn_Mals_Options::any_changes()
{
   ...
   return
      ...
      || (*parameters)[ "mals_bl_integral"             ] != ( rb_integral            ->isChecked() ? "true" : "false" )
      ...
      || (*parameters)[ "mals_cb_discard_it_sd_mult"   ] != ( cb_discard_it_sd_mult  ->isChecked() ? "true" : "false" )
      || (*parameters)[ "mals_discard_it_sd_mult"      ] != ( le_discard_it_sd_mult  ->text() )
      || (*parameters)[ "mals_cb_guinier_qrgmax"       ] != ( cb_guinier_qrgmax      ->isChecked() ? "true" : "false" )
      || (*parameters)[ "mals_guinier_qrgmax"          ] != ( le_guinier_qrgmax      ->text() )
      || (*parameters)[ "mals_cb_gg_smooth"            ] != ( cb_gg_smooth  ->isChecked() ? "true" : "false" )
      || (*parameters)[ "mals_gg_smooth"               ] != ( le_gg_smooth  ->text() )
      || (*parameters)[ "mals_cb_gg_cyclic"            ] != ( cb_gg_cyclic  ->isChecked() ? "true" : "false" )
      || (*parameters)[ "mals_cb_gg_oldstyle"          ] != ( cb_gg_oldstyle  ->isChecked() ? "true" : "false" )
      ...
      || (*parameters)[ "mals_cb_makeiq_cutmax_pct"    ] != ( cb_makeiq_cutmax_pct   ->isChecked() ? "true" : "false" )
...
void US_Hydrodyn_Mals_Options::ok()
{
   ...
   {
      (*parameters)[ "gaussian_type" ] = QString( "%1" ).arg( US_Hydrodyn_Mals::EMGGMG );
   }
   ...
   (*parameters)[ "mals_maxfpk_restart"       ] = cb_maxfpk_restart->isChecked() ? "true" : "false";
   // (*parameters)[ "mals_maxfpk_restart_tries" ] = le_maxfpk_restart_tries->text();
   (*parameters)[ "mals_maxfpk_restart_pct"   ] = le_maxfpk_restart_pct  ->text();
...
void US_Hydrodyn_Mals_Options::set_detector()
{
   {
      map < QString, QString > parameters;
      parameters[ "uv_conv" ] = QString( "%1" ).arg( ((US_Hydrodyn_Mals *)mals_win)->detector_uv_conv, 0, 'g', 8 );
      parameters[ "ri_conv" ] = QString( "%1" ).arg( ((US_Hydrodyn_Mals *)mals_win)->detector_ri_conv, 0, 'g', 8 );
      ...
      ((US_Hydrodyn_Mals *)mals_win)->detector_uv      = ( parameters.count( "uv" ) && parameters[ "uv" ] == "true" ) ? true : false;
