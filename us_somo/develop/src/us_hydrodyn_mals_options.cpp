...
US_Hydrodyn_Mals_Options::US_Hydrodyn_Mals_Options (
    ...
    : QDialog (p)
{
  ...
  setWindowTitle (us_tr ("US-SOMO: MALS : Options"));
...
void
US_Hydrodyn_Mals_Options::setupGUI ()
{
  int minHeight1 = 28;

  lbl_title = new QLabel (us_tr ("US-SOMO: MALS : Options"), this);
  ...
  rb_linear->setChecked (parameters->count ("mals_bl_linear")
                         && (*parameters)["mals_bl_linear"] == "true");
  ...
  rb_integral->setChecked (parameters->count ("mals_bl_integral")
                           && (*parameters)["mals_bl_integral"] == "true");
  ...
  cb_save_bl->setChecked (parameters->count ("mals_bl_save")
                          && (*parameters)["mals_bl_save"] == "true");
  ...
  le_smooth->setText (parameters->count ("mals_bl_smooth")
  ...
  le_start_region->setText (parameters->count ("mals_bl_start_region")
  ...
  le_i_power->setText (parameters->count ("mals_bl_i_power")
  ...
  le_reps->setText (parameters->count ("mals_bl_reps")
  ...
  le_epsilon->setText (parameters->count ("mals_bl_epsilon")
  ...
  le_cormap_maxq->setText (parameters->count ("mals_cormap_maxq")
  ...
  le_cormap_alpha->setText (parameters->count ("mals_cormap_alpha")
  ...
  pb_mals_parameters
      = new QPushButton (us_tr ("MALS Processing Parameters"), this);
  pb_mals_parameters->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  pb_mals_parameters->setMinimumHeight (minHeight1);
  pb_mals_parameters->setPalette (PALET_PUSHB);
  connect (pb_mals_parameters, SIGNAL (clicked ()),
           SLOT (set_mals_parameters ()));
  ...
  cb_csv_transposed->setChecked ((*parameters)["mals_csv_transposed"]
                                 == "true");
  ...
  le_zi_window->setText ((*parameters)["mals_zi_window"]);
  ...
  cb_discard_it_sd_mult->setChecked (
      (*parameters)["mals_cb_discard_it_sd_mult"] == "true");
  ...
  le_discard_it_sd_mult->setText ((*parameters)["mals_discard_it_sd_mult"]);
  ...
  le_gg_smooth->setText ((*parameters)["mals_gg_smooth"]);
  ...
  le_dist_max->setText ((*parameters)["mals_dist_max"]);
  ...
  le_ampl_width_min->setText ((*parameters)["mals_ampl_width_min"]);
  ...
  cb_lock_min_retry->setChecked ((*parameters)["mals_lock_min_retry"]
                                 == "true");
  ...
  le_lock_min_retry_mult->setText ((*parameters)["mals_lock_min_retry_mult"]);
  ...
  cb_maxfpk_restart->setChecked ((*parameters)["mals_maxfpk_restart"]
                                 == "true");
  ...
  le_maxfpk_restart_pct->setText ((*parameters)["mals_maxfpk_restart_pct"]);
  ...
  cb_makeiq_cutmax_pct->setChecked ((*parameters)["mals_cb_makeiq_cutmax_pct"]
                                    == "true");
  ...
  le_makeiq_cutmax_pct->setText ((*parameters)["mals_makeiq_cutmax_pct"]);
  ...
  cb_makeiq_avg_peaks->setChecked ((*parameters)["mals_cb_makeiq_avg_peaks"]
                                   == "true");
...

  {
    ...
    hbl->addWidget (pb_mals_parameters);
...
void
US_Hydrodyn_Mals_Options::quit ()
{
  close ();
}

bool
US_Hydrodyn_Mals_Options::any_changes ()
{
  QString gaussian_type = "";
  if (rb_gauss->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Mals::GAUSS);
    }
  else if (rb_gmg->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Mals::GMG);
    }
  else if (rb_emg->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Mals::EMG);
    }
  else if (rb_emggmg->isChecked ())
    {
      gaussian_type = QString ("%1").arg (US_Hydrodyn_Mals::EMGGMG);
    }

  return (*parameters)["mals_bl_linear"]
         ...
         || (*parameters)["mals_bl_smooth"] != (le_smooth->text ())
         || (*parameters)["mals_bl_start_region"] != (le_start_region->text ())
         || (*parameters)["mals_bl_i_power"] != (le_i_power->text ())
         || (*parameters)["mals_bl_reps"] != (le_reps->text ())
         || (*parameters)["mals_bl_epsilon"] != (le_epsilon->text ())
         || (*parameters)["mals_cormap_maxq"] != (le_cormap_maxq->text ())
         || (*parameters)["mals_cormap_alpha"] != (le_cormap_alpha->text ())
         || (*parameters)["mals_zi_window"] != (le_zi_window->text ())
         ...
         || (*parameters)["mals_guinier_qrgmax"]
                != (le_guinier_qrgmax->text ())
         || (*parameters)["mals_cb_gg_smooth"]
                != (cb_gg_smooth->isChecked () ? "true" : "false")
         || (*parameters)["mals_gg_smooth"] != (le_gg_smooth->text ())
         ...
         || (*parameters)["mals_dist_max"] != (le_dist_max->text ())
...
void
US_Hydrodyn_Mals_Options::ok ()
{
  (*parameters)["ok"] = "true";

  (*parameters)["mals_bl_linear"] = rb_linear->isChecked () ? "true" : "false";
  (*parameters)["mals_bl_integral"]
      = rb_integral->isChecked () ? "true" : "false";
  (*parameters)["mals_bl_save"] = cb_save_bl->isChecked () ? "true" : "false";
  (*parameters)["mals_bl_smooth"] = le_smooth->text ();
  (*parameters)["mals_bl_start_region"] = le_start_region->text ();
  (*parameters)["mals_bl_i_power"] = le_i_power->text ();
  (*parameters)["mals_bl_reps"] = le_reps->text ();
  ...
  (*parameters)["mals_cb_discard_it_sd_mult"]
      = cb_discard_it_sd_mult->isChecked () ? "true" : "false";
  (*parameters)["mals_discard_it_sd_mult"] = le_discard_it_sd_mult->text ();
  (*parameters)["mals_cb_guinier_qrgmax"]
      = cb_guinier_qrgmax->isChecked () ? "true" : "false";
  (*parameters)["mals_guinier_qrgmax"] = le_guinier_qrgmax->text ();
  (*parameters)["mals_cb_gg_smooth"]
      = cb_gg_smooth->isChecked () ? "true" : "false";
  (*parameters)["mals_gg_smooth"] = le_gg_smooth->text ();
  (*parameters)["mals_cb_gg_cyclic"]
  ...
  (*parameters)["mals_cb_makeiq_cutmax_pct"]
      = cb_makeiq_cutmax_pct->isChecked () ? "true" : "false";
  (*parameters)["mals_makeiq_cutmax_pct"] = le_makeiq_cutmax_pct->text ();
  (*parameters)["mals_cb_makeiq_avg_peaks"]
      = cb_makeiq_avg_peaks->isChecked () ? "true" : "false";
  ...
  if (rb_gauss->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Mals::GAUSS);
    }
  if (rb_gmg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Mals::GMG);
    }
  if (rb_emg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Mals::EMG);
    }
  if (rb_emggmg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Mals::EMGGMG);
    }
  ...
  (*parameters)["mals_maxfpk_restart_pct"] = le_maxfpk_restart_pct->text ();

  close ();
}

void
US_Hydrodyn_Mals_Options::help ()
{
  US_Help *online_help;
  online_help = new US_Help (this);
  online_help->show_help ("manual/somo/mals_options.html");
}

void
US_Hydrodyn_Mals_Options::closeEvent (QCloseEvent *e)
{
  if (any_changes ())
    {
      QMessageBox mb (
...
void
US_Hydrodyn_Mals_Options::update_enables ()
{
  ...
  pb_clear_gauss->setEnabled (
      ((US_Hydrodyn_Mals *)mals_win)->any_gaussians ());
  le_epsilon->setEnabled (rb_integral->isChecked ());
...
void
US_Hydrodyn_Mals_Options::clear_gauss ()
{
  if (QMessageBox::Yes
    ...
    {
      ((US_Hydrodyn_Mals *)mals_win)->clear_gaussians ();
    }
  update_enables ();
}

void
US_Hydrodyn_Mals_Options::set_detector ()
{
  {
    map<QString, QString> parameters;
    parameters["uv_conv"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->detector_uv_conv, 0, 'g', 8);
    parameters["ri_conv"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->detector_ri_conv, 0, 'g', 8);
    ...
    ((US_Hydrodyn_Mals *)mals_win)->detector_uv
        = (parameters.count ("uv") && parameters["uv"] == "true") ? true
                                                                  : false;
    ((US_Hydrodyn_Mals *)mals_win)->detector_ri
        = (parameters.count ("ri") && parameters["ri"] == "true") ? true
                                                                  : false;
    ((US_Hydrodyn_Mals *)mals_win)->detector_ri_conv
        = parameters["ri_conv"].toDouble ();
    ((US_Hydrodyn_Mals *)mals_win)->detector_uv_conv
        = parameters["uv_conv"].toDouble ();
  }
}

void
US_Hydrodyn_Mals_Options::set_mals_parameters ()
{
  {
    map<QString, QString> parameters;
    parameters["mals_param_lambda"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->mals_param_lambda, 0, 'g', 8);
    parameters["mals_param_n"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->mals_param_n, 0, 'g', 8);
    parameters["mals_param_g_dndc"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->mals_param_g_dndc, 0, 'g', 8);
    parameters["mals_param_g_extinction_coef"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->mals_param_g_extinction_coef, 0, 'g',
        8);
    parameters["mals_param_g_conc"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->mals_param_g_conc, 0, 'g', 8);
    parameters["mals_param_DLS_detector"] = QString ("%1").arg (
        ((US_Hydrodyn_Mals *)mals_win)->mals_param_DLS_detector);

    US_Hydrodyn_Mals_Parameters *mals_parameters
        = new US_Hydrodyn_Mals_Parameters (us_hydrodyn, &parameters, this);
    ...
    ((US_Hydrodyn_Mals *)mals_win)->mals_param_lambda
        = parameters["mals_param_lambda"].toDouble ();
    ((US_Hydrodyn_Mals *)mals_win)->mals_param_n
        = parameters["mals_param_n"].toDouble ();
    ((US_Hydrodyn_Mals *)mals_win)->mals_param_g_dndc
        = parameters["mals_param_g_dndc"].toDouble ();
    ((US_Hydrodyn_Mals *)mals_win)->mals_param_g_extinction_coef
        = parameters["mals_param_g_extinction_coef"].toDouble ();
    ((US_Hydrodyn_Mals *)mals_win)->mals_param_g_conc
        = parameters["mals_param_g_conc"].toDouble ();
    ((US_Hydrodyn_Mals *)mals_win)->mals_param_DLS_detector
        = parameters["mals_param_DLS_detector"].toInt ();
  }
}

void
US_Hydrodyn_Mals_Options::fasta_file ()
{
  // load file
...
void
US_Hydrodyn_Mals_Options::update_fasta_pH (const QString &str)
{
