...
void
US_Hydrodyn_Saxs_Hplc_Bl::setupGUI ()
{
  int minHeight1 = 30;
...
void
US_Hydrodyn_Saxs_Hplc_Bl::quit ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Bl::go ()
{
  (*parameters)["go"] = "true";
...
void
US_Hydrodyn_Saxs_Hplc_Bl::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Bl::update_enables ()
{
