...
US_Hydrodyn_SasOptionsSans::US_Hydrodyn_SasOptionsSans(struct saxs_options *saxs_options, bool *sas_options_sans_widget, void *us_hydrodyn, QWidget *p, const char *) : QFrame( p )
{
