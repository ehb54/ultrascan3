...
void
US_Hydrodyn_SasOptionsSans::setupGUI ()
{
  ...
  cnt_h_scat_len->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cnt_d_scat_len->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  cnt_h2o_scat_len_dens->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  cnt_d2o_scat_len_dens->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  cnt_d2o_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  lbl_frac_of_exch_pep = new QLabel (
      us_tr (" Fraction of non-exchanged peptide H (0 - 1): "), this);
  ...
  cnt_frac_of_exch_pep->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  ...
  cnt_perdeuteration->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  cb_sans_iq_native_debye->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  if (started_in_expert_mode)
    {
      ...
      cb_sans_iq_native_hybrid->setChecked (
          (*saxs_options).sans_iq_native_hybrid);
      cb_sans_iq_native_hybrid->setFont (QFont (
      ...
      cb_sans_iq_native_hybrid2->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
      ...
      cb_sans_iq_native_hybrid3->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
      ...
      cb_sans_iq_hybrid_adaptive->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_sans_iq_native_fast->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  cb_sans_iq_native_fast_compute_pr->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_sans_iq_cryson->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  lbl_cryson_sh_max_harmonics->setFont (
  ...
  cnt_cryson_sh_max_harmonics->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cnt_cryson_sh_fibonacci_grid_order->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_cryson_manual_hs->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  //    lbl_cryson_hydration_shell_contrast = new QLabel(
  ...
  cnt_cryson_hydration_shell_contrast->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...
void
US_Hydrodyn_SasOptionsSans::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsSans::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsSans::closeEvent (QCloseEvent *e)
{
  *sas_options_sans_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsSans::update_h_scat_len (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_d_scat_len (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_h2o_scat_len_dens (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_d2o_scat_len_dens (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_d2o_conc (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_frac_of_exch_pep (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_perdeuteration (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_native_debye ()
{
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_native_fast_compute_pr ()
{
  (*saxs_options).sans_iq_native_fast_compute_pr
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_native_hybrid ()
{
  (*saxs_options).sans_iq_native_hybrid
      = cb_sans_iq_native_hybrid->isChecked ();
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_native_hybrid2 ()
{
  (*saxs_options).sans_iq_native_hybrid2
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_native_hybrid3 ()
{
  (*saxs_options).sans_iq_native_hybrid3
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_hybrid_adaptive ()
{
  (*saxs_options).sans_iq_hybrid_adaptive
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_native_fast ()
{
...
void
US_Hydrodyn_SasOptionsSans::set_sans_iq_cryson ()
{
...
void
US_Hydrodyn_SasOptionsSans::update_cryson_sh_max_harmonics (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_cryson_sh_fibonacci_grid_order (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::update_cryson_hydration_shell_contrast (double val)
{
...
void
US_Hydrodyn_SasOptionsSans::set_cryson_manual_hs ()
{
...
void
US_Hydrodyn_SasOptionsSans::recompute_contrast ()
{
  cnt_cryson_hydration_shell_contrast->setValue (
...
void
US_Hydrodyn_SasOptionsSans::update_enables ()
{
