...
US_Hydrodyn_Mals::setupGUI ()
{
  ...
  */
  ...
  //    pb_set_mals->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  //    lbl_mals->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  pb_save_created_csv->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_csv_transposed")
              && ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_csv_transposed"]
                     == "true"
          ? us_tr ("Save CSV Tr")
          : us_tr (" Save CSV "));
  ...
  cb_guinier_qrgmax->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_cb_guinier_qrgmax")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_guinier_qrgmax"]
             == "true");
  ...
  le_guinier_qrgmax->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_guinier_qrgmax")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_guinier_qrgmax"]
          : "1.3");
  ...
  pb_mals_angles_save->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  pb_mals_angles_save->setMinimumHeight (minHeight1);
  pb_mals_angles_save->setPalette (PALET_PUSHB);
  connect (pb_mals_angles_save, SIGNAL (clicked ()),
           SLOT (mals_angles_save ()));
  ...
  lbl_mals_angles_data->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_mals->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  //    QBoxLayout * hbl_mals = new QHBoxLayout();
  //    hbl_mals->setContentsMargins( 0, 0, 0, 0 ); hbl_mals->setSpacing( 0 );
  ...
  // vbl_plot_group->addWidget ( lbl_mals_angles_data, 0, Qt::AlignCenter ); //
  // don't like this
  ...
  //                 "mals_files_widgets" ) || ( ( US_Hydrodyn * ) us_hydrodyn
  //                 )->gparams[ "mals_files_widgets" ] == "false" ? false :
  //                 true );
  //   hide_widgets( editor_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "mals_editor_widgets" ) || ( ( US_Hydrodyn * ) us_hydrodyn
  //                 )->gparams[ "mals_editor_widgets" ] == "false" ? false :
  //                 true );
  //   hide_widgets( created_files_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "mals_created_files_widgets" ) || ( ( US_Hydrodyn * )
  //                 us_hydrodyn )->gparams[ "mals_creaded_files_widgets" ] ==
  //                 "false" ? false : true );

  always_hide_widgets.insert ({ pb_create_i_of_t, pb_test_i_of_t,
                                pb_blanks_start, pb_baseline_start,
                                pb_baseline_apply });
...
void
US_Hydrodyn_Mals::mode_setup_widgets ()
{
...
void
US_Hydrodyn_Mals::mode_select (modes mode)
{
  current_mode = mode;
  mode_select ();
}
...
void
US_Hydrodyn_Mals::mode_title (QString title)
{
...
void
US_Hydrodyn_Mals::update_enables ()
{
  ...
  pb_create_ihash_t->setEnabled (
      ...
      && mals_param_n && mals_param_lambda && mals_param_g_dndc
...
void
US_Hydrodyn_Mals::model_enables ()
{
...
void
US_Hydrodyn_Mals::model_select_all ()
{
...
void
US_Hydrodyn_Mals::model_remove (QStringList files)
{
  disable_updates = true;
...
void
US_Hydrodyn_Mals::model_view (QStringList files)
{
...
void
US_Hydrodyn_Mals::model_text (QStringList files)
{
...
bool
US_Hydrodyn_Mals::model_save (QStringList files)
{
  bool errors = false;
...
bool
US_Hydrodyn_Mals::model_save (QString file, bool &cancel, bool &overwrite_all)
{
...
void
US_Hydrodyn_Mals::usp_config_plot_dist (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_plot_ref (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_ggqfit_plot (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_guinier_plot (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_guinier_plot_rg (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_guinier_plot_mw (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_guinier_plot_summary (const QPoint &)
{
...
void
US_Hydrodyn_Mals::usp_config_guinier_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Mals::set_pbmode_main ()
{
  pbmode_select (PBMODE_MAIN);
}

void
US_Hydrodyn_Mals::set_pbmode_sel ()
{
  pbmode_select (PBMODE_SEL);
}

void
US_Hydrodyn_Mals::set_pbmode_crop ()
{
  pbmode_select (PBMODE_CROP);
}

void
US_Hydrodyn_Mals::set_pbmode_conc ()
{
  pbmode_select (PBMODE_CONC);
}

void
US_Hydrodyn_Mals::set_pbmode_sd ()
{
  pbmode_select (PBMODE_SD);
}

void
US_Hydrodyn_Mals::set_pbmode_fasta ()
{
  pbmode_select (PBMODE_FASTA);
}

void
US_Hydrodyn_Mals::set_pbmode_mals ()
{
  pbmode_select (PBMODE_MALS);
}

void
US_Hydrodyn_Mals::set_pbmode_none ()
{
  pbmode_select (PBMODE_NONE);
}

void
US_Hydrodyn_Mals::pbmode_select (pbmodes mode)
{
