...
void US_Hydrodyn_Mals::setupGUI() {
  ...
  */
  ...
  //    QBoxLayout * hbl_mals = new QHBoxLayout(); hbl_mals->setContentsMargins(
  //    0, 0, 0, 0 ); hbl_mals->setSpacing( 0 ); hbl_mals->addWidget (
  //    pb_set_mals ); hbl_mals->addWidget ( lbl_mals );
  ...
  always_hide_widgets.insert({pb_create_i_of_t, pb_test_i_of_t, pb_blanks_start,
                              pb_baseline_start, pb_baseline_apply});
...
bool US_Hydrodyn_Mals::model_save(QString file, bool &cancel,
                                  bool &overwrite_all) {
...
void US_Hydrodyn_Mals::set_pbmode_main() { pbmode_select(PBMODE_MAIN); }

void US_Hydrodyn_Mals::set_pbmode_sel() { pbmode_select(PBMODE_SEL); }

void US_Hydrodyn_Mals::set_pbmode_crop() { pbmode_select(PBMODE_CROP); }

void US_Hydrodyn_Mals::set_pbmode_conc() { pbmode_select(PBMODE_CONC); }

void US_Hydrodyn_Mals::set_pbmode_sd() { pbmode_select(PBMODE_SD); }

void US_Hydrodyn_Mals::set_pbmode_fasta() { pbmode_select(PBMODE_FASTA); }

void US_Hydrodyn_Mals::set_pbmode_mals() { pbmode_select(PBMODE_MALS); }

void US_Hydrodyn_Mals::set_pbmode_none() { pbmode_select(PBMODE_NONE); }
