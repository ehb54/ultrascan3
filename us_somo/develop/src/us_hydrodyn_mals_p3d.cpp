...
void
US_Hydrodyn_Mals_P3d::quit ()
{
  close ();
}

void
US_Hydrodyn_Mals_P3d::plot ()
{
...
void
US_Hydrodyn_Mals_P3d::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Mals_P3d::update_enables ()
{
