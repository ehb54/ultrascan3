...
QString US_Eigen::errors() { return error_text; }

bool US_Eigen::evaluate_polynomial(const vector<double> &coeff,
...
void US_Eigen::polyfit(const std::vector<double> &t,
                       const std::vector<double> &v, std::vector<double> &coeff,
                       int order) {
...
bool US_Eigen::polyfit(const vector<double> &x, const vector<double> &y,
                       const int degree,
...
bool US_Eigen::polyfit(const vector<double> &x_input,
