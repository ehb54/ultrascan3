...
void
US_Hydrodyn_Mals_Parameters::setupGUI ()
{
  int minHeight1 = 30;

  lbl_title = new QLabel (us_tr ("US-SOMO: MALS : MALS Processing Parameters"),
                          this);
  ...
  lbl_mals_param_lambda->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  lbl_mals_param_lambda->setMinimumHeight (minHeight1);

  le_mals_param_lambda = new QLineEdit (this);
  le_mals_param_lambda->setObjectName ("le_mals_param_lambda Line Edit");
  ...
  le_mals_param_lambda->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (400, 600, 1, le_mals_param_lambda);
    le_mals_param_lambda->setValidator (qdv);
  }
  connect (le_mals_param_lambda, SIGNAL (textChanged (const QString &)),
           SLOT (set_mals_param_lambda (const QString &)));
  ...
  if (((US_Hydrodyn_Mals *)us_hydrodyn_mals)->lb_files->count () > 0)
    {
      ...
      le_mals_param_lambda->setToolTip (
          us_tr ("Files are loaded so this value can not be adjusted"));
      lbl_mals_param_lambda->setToolTip (
          us_tr ("Files are loaded so this value can not be adjusted"));
    }
  ...
  lbl_mals_param_n->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  lbl_mals_param_n->setMinimumHeight (minHeight1);

  le_mals_param_n = new QLineEdit (this);
  le_mals_param_n->setObjectName ("le_mals_param_n Line Edit");
  ...
  le_mals_param_n->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 5, 4, le_mals_param_n);
    le_mals_param_n->setValidator (qdv);
  }
  connect (le_mals_param_n, SIGNAL (textChanged (const QString &)),
           SLOT (set_mals_param_n (const QString &)));
  ...
  if (((US_Hydrodyn_Mals *)us_hydrodyn_mals)->lb_files->count () > 0)
    {
      ...
      le_mals_param_n->setToolTip (
          us_tr ("Files are loaded so this value can not be adjusted"));
      lbl_mals_param_n->setToolTip (
          us_tr ("Files are loaded so this value can not be adjusted"));
    }
  ...
  lbl_mals_param_g_dndc->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  lbl_mals_param_g_dndc->setMinimumHeight (minHeight1);

  le_mals_param_g_dndc = new QLineEdit (this);
  le_mals_param_g_dndc->setObjectName ("le_mals_param_g_dndc Line Edit");
  ...
  le_mals_param_g_dndc->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 1, 5, le_mals_param_g_dndc);
    le_mals_param_g_dndc->setValidator (qdv);
  }
  connect (le_mals_param_g_dndc, SIGNAL (textChanged (const QString &)),
           SLOT (set_mals_param_g_dndc (const QString &)));
  le_mals_param_g_dndc->setMinimumWidth (200);
  le_mals_param_g_dndc->setMinimumHeight (minHeight1);

  lbl_mals_param_g_extinction_coef = new QLabel (
      us_tr ("Global extinction coefficient [mL mg^-1 cm^-1]: "), this);
  lbl_mals_param_g_extinction_coef->setAlignment (Qt::AlignLeft
                                                  | Qt::AlignVCenter);
  lbl_mals_param_g_extinction_coef->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_mals_param_g_extinction_coef);
  lbl_mals_param_g_extinction_coef->setFont (QFont (
  ...
  le_mals_param_g_extinction_coef = new QLineEdit (this);
  le_mals_param_g_extinction_coef->setObjectName (
      "le_mals_param_g_extinction_coef Line Edit");
  le_mals_param_g_extinction_coef->setText (
      (*parameters)["mals_param_g_extinction_coef"]);
  le_mals_param_g_extinction_coef->setAlignment (Qt::AlignCenter
                                                 | Qt::AlignVCenter);
  le_mals_param_g_extinction_coef->setPalette (PALET_NORMAL);
  AUTFBACK (le_mals_param_g_extinction_coef);
  le_mals_param_g_extinction_coef->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 1, 5, le_mals_param_g_extinction_coef);
    le_mals_param_g_extinction_coef->setValidator (qdv);
  }
  connect (le_mals_param_g_extinction_coef,
           SIGNAL (textChanged (const QString &)),
           SLOT (set_mals_param_g_extinction_coef (const QString &)));
  le_mals_param_g_extinction_coef->setMinimumWidth (200);
  le_mals_param_g_extinction_coef->setMinimumHeight (minHeight1);

  lbl_mals_param_g_conc
  ...
  lbl_mals_param_g_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  lbl_mals_param_g_conc->setMinimumHeight (minHeight1);

  le_mals_param_g_conc = new QLineEdit (this);
  le_mals_param_g_conc->setObjectName ("le_mals_param_g_conc Line Edit");
  ...
  le_mals_param_g_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 9, 5, le_mals_param_g_conc);
    le_mals_param_g_conc->setValidator (qdv);
  }
  connect (le_mals_param_g_conc, SIGNAL (textChanged (const QString &)),
           SLOT (set_mals_param_g_conc (const QString &)));
  le_mals_param_g_conc->setMinimumWidth (200);
  le_mals_param_g_conc->setMinimumHeight (minHeight1);

  lbl_mals_param_DLS_detector
  ...
  lbl_mals_param_DLS_detector->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_mals_param_DLS_detector->setMinimumHeight (minHeight1);

  le_mals_param_DLS_detector = new QLineEdit (this);
  le_mals_param_DLS_detector->setObjectName (
      "le_mals_param_DLS_detector Line Edit");
  le_mals_param_DLS_detector->setText (
      (*parameters)["mals_param_DLS_detector"]);
  le_mals_param_DLS_detector->setAlignment (Qt::AlignCenter
                                            | Qt::AlignVCenter);
  le_mals_param_DLS_detector->setPalette (PALET_NORMAL);
  AUTFBACK (le_mals_param_DLS_detector);
  le_mals_param_DLS_detector->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator (1, 99, le_mals_param_DLS_detector);
    le_mals_param_DLS_detector->setValidator (qdv);
  }
  connect (le_mals_param_DLS_detector, SIGNAL (textChanged (const QString &)),
           SLOT (set_mals_param_DLS_detector (const QString &)));
...
void
US_Hydrodyn_Mals_Parameters::quit ()
{
  close ();
}

void
US_Hydrodyn_Mals_Parameters::save ()
{
  ...
  QString fn = QFileDialog::getSaveFileName (
      this, us_tr ("Select a name to save the MALS parameters"), use_dir,
      "*_mals_param.dat");
  ...
  if (!le_mals_param_lambda->text ().isEmpty ())
    {
      ts << "# __mals_param_lambda: " << le_mals_param_lambda->text ()
         << Qt::endl;
    }
  ...
  if (!le_mals_param_g_dndc->text ().isEmpty ())
    {
      ts << "# __mals_param_g_dndc: " << le_mals_param_g_dndc->text ()
         << Qt::endl;
    }
  if (!le_mals_param_g_extinction_coef->text ().isEmpty ())
    {
      ts << "# __mals_param_g_extinction_coef: "
         << le_mals_param_g_extinction_coef->text () << Qt::endl;
    }

  if (!le_mals_param_g_conc->text ().isEmpty ())
    {
      ts << "# __mals_param_g_conc: " << le_mals_param_g_conc->text ()
         << Qt::endl;
    }

  if (!le_mals_param_DLS_detector->text ().isEmpty ())
    {
      ts << "# __mals_param_DLS_detector: "
         << le_mals_param_DLS_detector->text () << Qt::endl;
    }
...
void
US_Hydrodyn_Mals_Parameters::keep ()
{
  (*parameters)["keep"] = "set";
  close ();
}
...
void
US_Hydrodyn_Mals_Parameters::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Mals_Parameters::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Mals_Parameters::set_mals_param_lambda (const QString &text)
{
  (*parameters)["mals_param_lambda"] = text;
}

void
US_Hydrodyn_Mals_Parameters::set_mals_param_n (const QString &text)
{
  (*parameters)["mals_param_n"] = text;
}

void
US_Hydrodyn_Mals_Parameters::set_mals_param_g_dndc (const QString &text)
{
  (*parameters)["mals_param_g_dndc"] = text;
}

void
US_Hydrodyn_Mals_Parameters::set_mals_param_g_extinction_coef (
    const QString &text)
{
...
void
US_Hydrodyn_Mals_Parameters::set_mals_param_g_conc (const QString &text)
{
  (*parameters)["mals_param_g_conc"] = text;
}

void
US_Hydrodyn_Mals_Parameters::set_mals_param_DLS_detector (const QString &text)
{
