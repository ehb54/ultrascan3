...
void US_Hydrodyn_Mals_Parameters::setupGUI() {
  ...
  lbl_title =
      new QLabel(us_tr("US-SOMO: MALS : MALS Processing Parameters"), this);
  ...
  lbl_mals_param_g_extinction_coef->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_mals_param_g_extinction_coef->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv =
  ...
  connect(le_mals_param_g_extinction_coef, SIGNAL(textChanged(const QString &)),
  ...
  lbl_mals_param_DLS_detector->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_mals_param_DLS_detector->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
...
void US_Hydrodyn_Mals_Parameters::quit() { close(); }
...
void US_Hydrodyn_Mals_Parameters::save() {
  ...
  if (!le_mals_param_DLS_detector->text().isEmpty()) {
    ts << "# __mals_param_DLS_detector: " << le_mals_param_DLS_detector->text()
       << Qt::endl;
  }
...
void US_Hydrodyn_Mals_Parameters::set_mals_param_g_extinction_coef(
    const QString &text) {
...
void US_Hydrodyn_Mals_Parameters::set_mals_param_DLS_detector(
    const QString &text) {
