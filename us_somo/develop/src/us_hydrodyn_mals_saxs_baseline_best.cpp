...
void US_Hydrodyn_Mals_Saxs_Baseline_Best::cancel() { close(); }
...
void US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_hb_msg(QString color,
                                                        QString msg) {
...
void US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_msg(QString color, QString msg,
                                                     QTextEdit *e) {
  if (!e) {
    e = editor;
  }
...
void US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_ec_msg(QString msg,
                                                        QTextEdit *e) {
  if (!e) {
    e = editor;
  }
