...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::setupGUI ()
{
  int minHeight1 = 30;
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::cancel ()
{
  close ();
}

void
US_Hydrodyn_Mals_Saxs_Baseline_Best::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::closeEvent (QCloseEvent *e)
{
  if (((US_Hydrodyn *)us_hydrodyn)->mals_saxs_widget)
    {
      US_Hydrodyn_Mals_Saxs *mals_saxs_win
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_hb_msg (QString color, QString msg)
{
  return editor_msg (color, msg, hb_editor);
}

void
US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_hb_ec_msg (QString msg)
{
  return editor_ec_msg (msg, hb_editor);
}

void
US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_msg (QString color, QString msg,
                                                 QTextEdit *e)
{
  if (!e)
    {
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::editor_ec_msg (QString msg, QTextEdit *e)
{
  if (!e)
    {
      e = editor;
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
  hb_editor->clear ();
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::update_font ()
{
  bool ok;
  QFont newFont;
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::save ()
{
  QString fn;
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::displayData ()
{
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::set_best ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->mals_saxs_widget)
    {
      US_Hydrodyn_Mals_Saxs *mals_saxs_win
      ...
      if (mals_saxs_win->current_mode == US_Hydrodyn_Mals_Saxs::MODE_BASELINE
          && vdparameters.count ("bestpos") && dparameters.count ("width"))
        {
          ...
          mals_saxs_win->le_baseline_end_s->setText (
              QString ("%1").arg (bestpos));
          mals_saxs_win->le_baseline_end_e->setText (
              QString ("%1").arg (bestpos + dparameters["width"] - 1));
          mals_saxs_win->le_baseline_width->setText (
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::set_hb_best ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->mals_saxs_widget)
    {
      US_Hydrodyn_Mals_Saxs *mals_saxs_win
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::update_enables ()
{
  if (!parameters.count ("hb"))
    {
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::usp_config_plot (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs_Baseline_Best::usp_config_hb_plot (const QPoint &)
{
