...
// Fonts
QString US3i_GuiSettings::fontFamily(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("fontFamily", "Helvetica").toString();
}

void US3i_GuiSettings::set_fontFamily(const QString& fontFamily) {
  QSettings settings(US3, "UltraScan");
...
int US3i_GuiSettings::fontSize(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("fontSize", 10).toInt();
}

void US3i_GuiSettings::set_fontSize(int fontSize) {
  QSettings settings(US3, "UltraScan");
  if (fontSize == 10)
...
// Misc
int US3i_GuiSettings::plotMargin(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("plotMargin", 10).toInt();
}

void US3i_GuiSettings::set_plotMargin(int fontSize) {
  QSettings settings(US3, "UltraScan");
  if (fontSize == 10)
...
// Label
QPalette US3i_GuiSettings::labelColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::labelColorDefault(void) {
  QPalette p;
  p.setColor(QPalette::Active, QPalette::WindowText,
             c_white);  // windowText/foreground
...
void US3i_GuiSettings::set_labelColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
  settings.setValue("palettes/labelColor", palette);
}

// Edit
QPalette US3i_GuiSettings::editColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::editColorDefault(void) {
  QPalette p;
  p.setColor(QPalette::Active, QPalette::WindowText,
             c_black);  // windowText/foreground
  ...
  p.setColor(QPalette::Active, QPalette::Mid,
             c_black);  // Between light and dark
...
void US3i_GuiSettings::set_editColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::frameColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::frameColorDefault(void) {
  QPalette p;
  p.setColor(QPalette::Active, QPalette::WindowText,
             c_white);  // windowText/foreground
...
void US3i_GuiSettings::set_frameColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::pushbColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::pushbColorDefault(void) {
  QPalette p;
...
void US3i_GuiSettings::set_pushbColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::normalColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::normalColorDefault(void) {
  QPalette p;
  p.setColor(QPalette::Active, QPalette::WindowText,
             c_black);  // windowText/foreground
...
void US3i_GuiSettings::set_normalColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
  settings.setValue("palettes/normalColor", palette);
}

// LCD
QPalette US3i_GuiSettings::lcdColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::lcdColorDefault(void) {
  QPalette p;
...
void US3i_GuiSettings::set_lcdColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
  settings.setValue("palettes/lcdColor", palette);
}

// Plot frame
QPalette US3i_GuiSettings::plotColor(void) {
  QSettings settings(US3, "UltraScan");
...
QPalette US3i_GuiSettings::plotColorDefault(void) {
  QPalette p;
...
void US3i_GuiSettings::set_plotColor(const QPalette& palette) {
  QSettings settings(US3, "UltraScan");
  settings.setValue("palettes/plotColor", palette);
}

// Plot curve color
QColor US3i_GuiSettings::plotCurve(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("palettes/plotCurve", c_yellow).value<QColor>();
}

void US3i_GuiSettings::set_plotCurve(const QColor& color) {
  QSettings settings(US3, "UltraScan");
  if (color == Qt::yellow)
...
// Canvas background
QColor US3i_GuiSettings::plotCanvasBG(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("palettes/normalColor", c_darkBlue).value<QColor>();
}

void US3i_GuiSettings::set_plotCanvasBG(const QColor& color) {
  QSettings settings(US3, "UltraScan");
...
QColor US3i_GuiSettings::plotMajGrid(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("palettes/plotMajGrid", c_white).value<QColor>();
}

void US3i_GuiSettings::set_plotMajGrid(const QColor& color) {
  QSettings settings(US3, "UltraScan");
  if (color == c_white)
...
QColor US3i_GuiSettings::plotMinGrid(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("palettes/plotMinGrid", c_lightGray).value<QColor>();
}

void US3i_GuiSettings::set_plotMinGrid(const QColor& color) {
  QSettings settings(US3, "UltraScan");
...
QColor US3i_GuiSettings::plotPicker(void) {
  QSettings settings(US3, "UltraScan");
  return settings.value("palettes/plotPicker", c_white).value<QColor>();
}

void US3i_GuiSettings::set_plotPicker(const QColor& color) {
  QSettings settings(US3, "UltraScan");
  if (color == c_white)
