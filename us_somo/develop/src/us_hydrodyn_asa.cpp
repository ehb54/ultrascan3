...
US_Hydrodyn_ASA::US_Hydrodyn_ASA (struct asa_options *asa, bool *asa_widget,
...
US_Hydrodyn_ASA::~US_Hydrodyn_ASA () { *asa_widget = false; }

void
US_Hydrodyn_ASA::setupGUI ()
{
  int minHeight1 = 30;
  ...
  connect (bg_asa_method, SIGNAL (clicked (int)), this,
           SLOT (select_asa_method (int)));

  cb_surfracer = new QCheckBox (bg_asa_method);
  cb_surfracer->setText (
      us_tr (" Voronoi Tesselation (Surfrace, Tsodikov et al.)"));
  cb_surfracer->setEnabled (true);
  cb_surfracer->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cb_asab1->setText (
      us_tr (" Rolling Sphere (ASAB1, Lee && Richards' Method)"));
  cb_asab1->setEnabled (true);
  cb_asab1->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  rb_surfracer->setText (
      us_tr (" Voronoi Tesselation (Surfrace, Tsodikov et al.)"));
  rb_surfracer->setEnabled (true);
  rb_surfracer->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  rb_surfracer->setPalette (PALET_NORMAL);
  AUTFBACK (rb_surfracer);
  connect (rb_surfracer, SIGNAL (clicked ()), this,
           SLOT (select_asa_method ()));

  rb_asab1 = new QRadioButton ();
  rb_asab1->setText (
      us_tr (" Rolling Sphere (ASAB1, Lee && Richards' Method)"));
  rb_asab1->setEnabled (true);
  rb_asab1->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  switch ((*asa).method)
    {
    case 0:
      rb_surfracer->setChecked (true);
      break;
    case 1:
      rb_asab1->setChecked (true);
      break;
    default:
      qDebug () << "asa missing asa method selection error";
      break;
    }

#endif

  lbl_probe_radius = new QLabel (
      us_tr (" ASA Probe Radius [" + UNICODE_ANGSTROM_QS + "]: "), this);
  ...
  cnt_probe_radius->setRange (0, 10);
  cnt_probe_radius->setSingleStep (0.01);
  ...
  cnt_probe_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cnt_probe_radius->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_probe_radius);
  connect (cnt_probe_radius, SIGNAL (valueChanged (double)),
           SLOT (update_probe_radius (double)));

  lbl_probe_recheck_radius = new QLabel (
      us_tr (" ASA Probe Recheck Radius [" + UNICODE_ANGSTROM_QS + "]: "),
      this);
  ...
  lbl_probe_recheck_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));
  ...
  cnt_probe_recheck_radius->setRange (0, 10);
  cnt_probe_recheck_radius->setSingleStep (0.01);
  ...
  cnt_probe_recheck_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  cnt_probe_recheck_radius->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_probe_recheck_radius);
  connect (cnt_probe_recheck_radius, SIGNAL (valueChanged (double)),
           SLOT (update_probe_recheck_radius (double)));

  lbl_asa_threshold
      = new QLabel (us_tr (" SOMO ASA Threshold [" + UNICODE_ANGSTROM_QS
                           + UNICODE_SUPER_2 + "]: "),
                    this);
  ...
  lbl_asa_threshold->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));
  ...
  cnt_asa_threshold->setRange (0, 100);
  cnt_asa_threshold->setSingleStep (0.1);
  ...
  cnt_asa_threshold->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cnt_asa_threshold->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_asa_threshold);
  connect (cnt_asa_threshold, SIGNAL (valueChanged (double)),
           SLOT (update_asa_threshold (double)));

  lbl_asa_threshold_percent
      = new QLabel (us_tr (" SOMO Bead ASA Threshold %: "), this);
  ...
  lbl_asa_threshold_percent->setFont (
  ...
  cnt_asa_threshold_percent->setRange (0, 100);
  cnt_asa_threshold_percent->setSingleStep (0.1);
  ...
  cnt_asa_threshold_percent->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  cnt_asa_threshold_percent->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_asa_threshold_percent);
  connect (cnt_asa_threshold_percent, SIGNAL (valueChanged (double)),
           SLOT (update_asa_threshold_percent (double)));

  lbl_asa_grid_threshold
      = new QLabel (us_tr (" Grid ASA Threshold [" + UNICODE_ANGSTROM_QS
                           + UNICODE_SUPER_2 + "]: "),
                    this);
  ...
  lbl_asa_grid_threshold->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1,
                                          QFont::Bold));
  ...
  cnt_asa_grid_threshold->setRange (0, 100);
  cnt_asa_grid_threshold->setSingleStep (0.1);
  ...
  cnt_asa_grid_threshold->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cnt_asa_grid_threshold->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_asa_grid_threshold);
  connect (cnt_asa_grid_threshold, SIGNAL (valueChanged (double)),
           SLOT (update_asa_grid_threshold (double)));

  lbl_asa_grid_threshold_percent
      = new QLabel (us_tr (" Grid Bead ASA Threshold %: "), this);
  Q_CHECK_PTR (lbl_asa_grid_threshold_percent);
  lbl_asa_grid_threshold_percent->setAlignment (Qt::AlignLeft
                                                | Qt::AlignVCenter);
  ...
  lbl_asa_grid_threshold_percent->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  cnt_asa_grid_threshold_percent->setRange (0, 100);
  cnt_asa_grid_threshold_percent->setSingleStep (0.1);
  ...
  cnt_asa_grid_threshold_percent->setFont (QFont (
  ...
  connect (cnt_asa_grid_threshold_percent, SIGNAL (valueChanged (double)),
           SLOT (update_asa_grid_threshold_percent (double)));

  lbl_vdw_grpy_probe_radius = new QLabel (
      us_tr (" vdW+GRPY ASA Probe Radius [" + UNICODE_ANGSTROM_QS + "]: "),
      this);
  ...
  lbl_vdw_grpy_probe_radius->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  cnt_vdw_grpy_probe_radius = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_vdw_grpy_probe_radius);
  cnt_vdw_grpy_probe_radius->setRange (0, 10);
  cnt_vdw_grpy_probe_radius->setSingleStep (0.01);
  ...
  cnt_vdw_grpy_probe_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  cnt_vdw_grpy_probe_radius->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_vdw_grpy_probe_radius);
  connect (cnt_vdw_grpy_probe_radius, SIGNAL (valueChanged (double)),
           SLOT (update_vdw_grpy_probe_radius (double)));

  lbl_vdw_grpy_threshold_percent
      = new QLabel (us_tr (" vdW+GRPY ASA Threshold %: "), this);
  lbl_vdw_grpy_threshold_percent->setAlignment (Qt::AlignLeft
                                                | Qt::AlignVCenter);
  ...
  lbl_vdw_grpy_threshold_percent->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  cnt_vdw_grpy_threshold_percent = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_vdw_grpy_threshold_percent);
  cnt_vdw_grpy_threshold_percent->setRange (0, 100);
  cnt_vdw_grpy_threshold_percent->setSingleStep (0.1);
  ...
  cnt_vdw_grpy_threshold_percent->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cnt_vdw_grpy_threshold_percent->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_vdw_grpy_threshold_percent);
  connect (cnt_vdw_grpy_threshold_percent, SIGNAL (valueChanged (double)),
           SLOT (update_vdw_grpy_threshold_percent (double)));

  lbl_hydrate_probe_radius = new QLabel (
      us_tr (" vdW Hydrate ASA Probe Radius [" + UNICODE_ANGSTROM_QS + "]: "),
      this);
  ...
  lbl_hydrate_probe_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));

  cnt_hydrate_probe_radius = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_hydrate_probe_radius);
  cnt_hydrate_probe_radius->setRange (0, 10);
  cnt_hydrate_probe_radius->setSingleStep (0.01);
  ...
  cnt_hydrate_probe_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  cnt_hydrate_probe_radius->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_hydrate_probe_radius);
  connect (cnt_hydrate_probe_radius, SIGNAL (valueChanged (double)),
           SLOT (update_hydrate_probe_radius (double)));

  lbl_hydrate_threshold
      = new QLabel (us_tr (" vdW Hydrate ASA Threshold [" + UNICODE_ANGSTROM_QS
                           + UNICODE_SUPER_2 + "]: "),
                    this);
  ...
  lbl_hydrate_threshold->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1,
                                         QFont::Bold));

  cnt_hydrate_threshold = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_hydrate_threshold);
  cnt_hydrate_threshold->setRange (0, 100);
  cnt_hydrate_threshold->setSingleStep (0.1);
  ...
  cnt_hydrate_threshold->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cnt_hydrate_threshold->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_hydrate_threshold);
  connect (cnt_hydrate_threshold, SIGNAL (valueChanged (double)),
           SLOT (update_hydrate_threshold (double)));

  lbl_asab1_step = new QLabel (
      us_tr (" ASAB1 Step Size [" + UNICODE_ANGSTROM_QS + "]: "), this);
  ...
  lbl_asab1_step->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1,
                                  QFont::Bold));
  ...
  cnt_asab1_step->setRange (0.1, 100);
  cnt_asab1_step->setSingleStep (0.1);
  ...
  cnt_asab1_step->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cnt_asab1_step->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_asab1_step);
  connect (cnt_asab1_step, SIGNAL (valueChanged (double)),
           SLOT (update_asab1_step (double)));
  ...
  lbl_vvv_probe_radius = new QLabel (
      us_tr (" VVV probe radius [" + UNICODE_ANGSTROM_QS + "]: "), this);
  ...
  lbl_vvv_probe_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1,
                                        QFont::Bold));

  cnt_vvv_probe_radius = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_vvv_probe_radius);
  cnt_vvv_probe_radius->setRange (0.0, 20.0);
  cnt_vvv_probe_radius->setSingleStep (0.1);
  ...
  cnt_vvv_probe_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cnt_vvv_probe_radius->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_vvv_probe_radius);
  connect (cnt_vvv_probe_radius, SIGNAL (valueChanged (double)),
           SLOT (update_vvv_probe_radius (double)));

  lbl_vvv_grid_dR = new QLabel (
      us_tr (" VVV grid edge size [" + UNICODE_ANGSTROM_QS + "]: "), this);
  ...
  lbl_vvv_grid_dR->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));

  cnt_vvv_grid_dR = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_vvv_grid_dR);
  cnt_vvv_grid_dR->setRange (0.1, 20.0);
  cnt_vvv_grid_dR->setSingleStep (0.01);
  ...
  cnt_vvv_grid_dR->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  cnt_vvv_grid_dR->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_vvv_grid_dR);
  connect (cnt_vvv_grid_dR, SIGNAL (valueChanged (double)),
           SLOT (update_vvv_grid_dR (double)));
  ...
  cb_asa_calculation->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  cb_asa_calculation->setPalette (PALET_NORMAL);
  AUTFBACK (cb_asa_calculation);
  connect (cb_asa_calculation, SIGNAL (clicked ()),
           SLOT (set_asa_calculation ()));
  ...
  cb_bead_check->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  j++;
  background->addWidget (bg_asa_method, j, 0, 1 + (j + 3) - (j),
                         1 + (1) - (0));
  j += 4;
...
void
US_Hydrodyn_ASA::cancel ()
{
  close ();
}

void
US_Hydrodyn_ASA::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_ASA::closeEvent (QCloseEvent *e)
{
  *asa_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_ASA::update_probe_radius (double val)
{
...
void
US_Hydrodyn_ASA::update_probe_recheck_radius (double val)
{
...
void
US_Hydrodyn_ASA::update_asa_threshold (double val)
{
...
void
US_Hydrodyn_ASA::update_asa_threshold_percent (double val)
{
...
void
US_Hydrodyn_ASA::update_asa_grid_threshold (double val)
{
...
void
US_Hydrodyn_ASA::update_asa_grid_threshold_percent (double val)
{
...
void
US_Hydrodyn_ASA::update_hydrate_probe_radius (double val)
{
...
void
US_Hydrodyn_ASA::update_hydrate_threshold (double val)
{
...
void
US_Hydrodyn_ASA::update_vdw_grpy_probe_radius (double val)
{
...
void
US_Hydrodyn_ASA::update_vdw_grpy_threshold_percent (double val)
{
...
void
US_Hydrodyn_ASA::update_asab1_step (double val)
{
...
void
US_Hydrodyn_ASA::set_asa_calculation ()
{
...
void
US_Hydrodyn_ASA::set_bead_check ()
{
...
void
US_Hydrodyn_ASA::select_asa_method ()
{
...
void
US_Hydrodyn_ASA::select_asa_method (int val)
{
  (*asa).method = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_ASA::update_vvv_probe_radius (double val)
{
...
void
US_Hydrodyn_ASA::update_vvv_grid_dR (double val)
{
