...
void US_Hydrodyn_Saxs_Mw::setupGUI() {
  ...
  if (allow_none) {
    ...
    pb_do_not_normalize->setFont(QFont(USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize + 1));
...
void US_Hydrodyn_Saxs_Mw::cancel() { close(); }
...
void US_Hydrodyn_Saxs_Mw::update_partial(const QString &str) { *partial = str; }
