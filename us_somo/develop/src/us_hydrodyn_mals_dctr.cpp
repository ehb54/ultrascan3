...
US_Hydrodyn_Mals_Dctr::US_Hydrodyn_Mals_Dctr (
    ...
    : QDialog (p)
{
  ...
  setWindowTitle (us_tr ("US-SOMO: MALS : Concentration Detector"));
...
void
US_Hydrodyn_Mals_Dctr::setupGUI ()
{
  int minHeight1 = 30;

  lbl_title
      = new QLabel (us_tr ("US-SOMO: MALS : Concentration Detector"), this);
...
void
US_Hydrodyn_Mals_Dctr::quit ()
{
  close ();
}

void
US_Hydrodyn_Mals_Dctr::save ()
{
...
void
US_Hydrodyn_Mals_Dctr::help ()
{
  US_Help *online_help;
  online_help = new US_Help (this);
  online_help->show_help ("manual/somo/mals_dctr.html");
}

void
US_Hydrodyn_Mals_Dctr::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Mals_Dctr::uv_conv_text (const QString &text)
{
  (*parameters)["uv_conv"] = text;
}

void
US_Hydrodyn_Mals_Dctr::ri_conv_text (const QString &text)
{
