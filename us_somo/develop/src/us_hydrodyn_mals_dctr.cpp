...
US_Hydrodyn_Mals_Dctr::US_Hydrodyn_Mals_Dctr(void *us_hydrodyn_mals,
...
void US_Hydrodyn_Mals_Dctr::setupGUI() {
  int minHeight1 = 30;

  lbl_title = new QLabel(us_tr("US-SOMO: MALS : Concentration Detector"), this);
...
void US_Hydrodyn_Mals_Dctr::quit() { close(); }

void US_Hydrodyn_Mals_Dctr::save() {
...
void US_Hydrodyn_Mals_Dctr::keep() {
  (*parameters)["keep"] = "set";
  close();
}

void US_Hydrodyn_Mals_Dctr::help() {
  US_Help *online_help;
  online_help = new US_Help(this);
  online_help->show_help("manual/somo/mals_dctr.html");
}

void US_Hydrodyn_Mals_Dctr::closeEvent(QCloseEvent *e) {
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept();
}

void US_Hydrodyn_Mals_Dctr::set_uv() {
...
void US_Hydrodyn_Mals_Dctr::set_ri() {
...
void US_Hydrodyn_Mals_Dctr::uv_conv_text(const QString &text) {
  (*parameters)["uv_conv"] = text;
}

void US_Hydrodyn_Mals_Dctr::ri_conv_text(const QString &text) {
