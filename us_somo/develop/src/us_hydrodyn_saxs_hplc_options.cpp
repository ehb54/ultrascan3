...
void
US_Hydrodyn_Saxs_Hplc_Options::setupGUI ()
{
  int minHeight1 = 28;
  ...
  rb_linear->setChecked (parameters->count ("hplc_bl_linear")
                         && (*parameters)["hplc_bl_linear"] == "true");
  ...
  rb_integral->setChecked (parameters->count ("hplc_bl_integral")
                           && (*parameters)["hplc_bl_integral"] == "true");
  ...
  cb_save_bl->setChecked (parameters->count ("hplc_bl_save")
                          && (*parameters)["hplc_bl_save"] == "true");
  ...
  le_smooth->setText (parameters->count ("hplc_bl_smooth")
  ...
  le_start_region->setText (parameters->count ("hplc_bl_start_region")
  ...
  le_i_power->setText (parameters->count ("hplc_bl_i_power")
  ...
  le_reps->setText (parameters->count ("hplc_bl_reps")
  ...
  le_epsilon->setText (parameters->count ("hplc_bl_epsilon")
  ...
  le_cormap_maxq->setText (parameters->count ("hplc_cormap_maxq")
  ...
  le_cormap_alpha->setText (parameters->count ("hplc_cormap_alpha")
  ...
  pb_saxs_hplc_parameters
      = new QPushButton (us_tr ("SAXS Processing Parameters"), this);
  pb_saxs_hplc_parameters->setFont (QFont (
  ...
  connect (pb_saxs_hplc_parameters, SIGNAL (clicked ()),
           SLOT (set_saxs_hplc_parameters ()));
  ...
  cb_csv_transposed->setChecked ((*parameters)["hplc_csv_transposed"]
                                 == "true");
  ...
  cb_discard_it_sd_mult->setChecked (
      (*parameters)["hplc_cb_discard_it_sd_mult"] == "true");
  ...
  cb_gg_oldstyle->setText (us_tr (
      "Experimental: Global Gaussian - Enable legacy Gaussian fit display"));
  ...
  cb_lock_min_retry->setChecked ((*parameters)["hplc_lock_min_retry"]
                                 == "true");
  ...
  cb_maxfpk_restart->setChecked ((*parameters)["hplc_maxfpk_restart"]
                                 == "true");
  ...
  cb_makeiq_cutmax_pct->setChecked ((*parameters)["hplc_cb_makeiq_cutmax_pct"]
                                    == "true");
  ...
  cb_makeiq_avg_peaks->setChecked ((*parameters)["hplc_cb_makeiq_avg_peaks"]
                                   == "true");
...
void
US_Hydrodyn_Saxs_Hplc_Options::quit ()
{
  close ();
}

bool
US_Hydrodyn_Saxs_Hplc_Options::any_changes ()
{
  ...
  return (*parameters)["hplc_bl_linear"]
...
void
US_Hydrodyn_Saxs_Hplc_Options::ok ()
{
  (*parameters)["ok"] = "true";
  ...
  if (rb_gauss->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Saxs_Hplc::GAUSS);
    }
  if (rb_gmg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Saxs_Hplc::GMG);
    }
  if (rb_emg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Saxs_Hplc::EMG);
    }
  if (rb_emggmg->isChecked ())
    {
      (*parameters)["gaussian_type"]
          = QString ("%1").arg (US_Hydrodyn_Saxs_Hplc::EMGGMG);
    }
...
void
US_Hydrodyn_Saxs_Hplc_Options::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Options::closeEvent (QCloseEvent *e)
{
  if (any_changes ())
    {
      QMessageBox mb (
...
void
US_Hydrodyn_Saxs_Hplc_Options::update_enables ()
{
  ...
  pb_clear_gauss->setEnabled (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->any_gaussians ());
  le_epsilon->setEnabled (rb_integral->isChecked ());
...
void
US_Hydrodyn_Saxs_Hplc_Options::clear_gauss ()
{
  if (QMessageBox::Yes
...
void
US_Hydrodyn_Saxs_Hplc_Options::set_detector ()
{
  {
    map<QString, QString> parameters;
    parameters["uv_conv"] = QString ("%1").arg (
        ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->detector_uv_conv, 0, 'g', 8);
    parameters["ri_conv"] = QString ("%1").arg (
        ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->detector_ri_conv, 0, 'g', 8);
    ...
    ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->detector_uv
        = (parameters.count ("uv") && parameters["uv"] == "true") ? true
                                                                  : false;
    ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->detector_ri
        = (parameters.count ("ri") && parameters["ri"] == "true") ? true
                                                                  : false;
    ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->detector_ri_conv
        = parameters["ri_conv"].toDouble ();
    ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->detector_uv_conv
        = parameters["uv_conv"].toDouble ();
  }
}

void
US_Hydrodyn_Saxs_Hplc_Options::set_saxs_hplc_parameters ()
{
  map<QString, QString> parameters;

  parameters["saxs_hplc_param_frame_interval"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_frame_interval, 0,
      'g', 8);
  parameters["saxs_hplc_param_g_conc"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_g_conc, 0, 'g', 8);
  parameters["saxs_hplc_param_g_psv"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_g_psv, 0, 'g', 8);
  parameters["saxs_hplc_param_I0_exp"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_I0_exp, 0, 'g', 8);
  parameters["saxs_hplc_param_I0_theo"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_I0_theo, 0, 'g', 8);
  parameters["saxs_hplc_param_diffusion_len"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_diffusion_len, 0,
      'g', 8);
  parameters["saxs_hplc_param_electron_nucleon_ratio"]
      = QString ("%1").arg (((US_Hydrodyn_Saxs_Hplc *)hplc_win)
                                ->saxs_hplc_param_electron_nucleon_ratio,
                            0, 'g', 8);
  parameters["saxs_hplc_param_nucleon_mass"] = QString ("%1").arg (
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_nucleon_mass, 0,
      'g', 8);
  parameters["saxs_hplc_param_solvent_electron_density"]
      = QString ("%1").arg (((US_Hydrodyn_Saxs_Hplc *)hplc_win)
                                ->saxs_hplc_param_solvent_electron_density,
                            0, 'g', 8);

  US_Hydrodyn_Saxs_Hplc_Parameters *saxs_hplc_parameters
      = new US_Hydrodyn_Saxs_Hplc_Parameters (this, &parameters, this);
  ...
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_g_conc
      = parameters["saxs_hplc_param_g_conc"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_frame_interval
      = parameters["saxs_hplc_param_frame_interval"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_g_psv
      = parameters["saxs_hplc_param_g_psv"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_I0_exp
      = parameters["saxs_hplc_param_I0_exp"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_I0_theo
      = parameters["saxs_hplc_param_I0_theo"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_diffusion_len
      = parameters["saxs_hplc_param_diffusion_len"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_electron_nucleon_ratio
      = parameters["saxs_hplc_param_electron_nucleon_ratio"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_nucleon_mass
      = parameters["saxs_hplc_param_nucleon_mass"].toDouble ();
  ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_solvent_electron_density
      = parameters["saxs_hplc_param_solvent_electron_density"].toDouble ();

  if (parameters.count ("save"))
    {
      ((US_Hydrodyn *)us_hydrodyn)->gparams["saxs_hplc_param_g_conc"]
          = QString ("%1").arg (
              ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_g_conc);
      ((US_Hydrodyn *)us_hydrodyn)->gparams["saxs_hplc_param_frame_interval"]
          = QString ("%1").arg (((US_Hydrodyn_Saxs_Hplc *)hplc_win)
      ...
      ((US_Hydrodyn *)us_hydrodyn)->saxs_options.I0_exp
          = ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_I0_exp;
      ((US_Hydrodyn *)us_hydrodyn)->saxs_options.I0_theo
          = ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_I0_theo;
      ((US_Hydrodyn *)us_hydrodyn)->saxs_options.diffusion_len
          = ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_diffusion_len;
      ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_electron_nucleon_ratio"]
          = QString ("%1").arg (((US_Hydrodyn_Saxs_Hplc *)hplc_win)
                                    ->saxs_hplc_param_electron_nucleon_ratio);
...
void
US_Hydrodyn_Saxs_Hplc_Options::fasta_file ()
{
  // load file
...
void
US_Hydrodyn_Saxs_Hplc_Options::update_fasta_pH (const QString &str)
{
