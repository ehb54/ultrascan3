...
void US_Hydrodyn_Saxs_Hplc_Options::setupGUI() {
  ...
  le_reps->setText(
      parameters->count("hplc_bl_reps") ? (*parameters)["hplc_bl_reps"] : "1");
  ...
  pb_saxs_hplc_parameters->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
...
void US_Hydrodyn_Saxs_Hplc_Options::quit() { close(); }
...
void US_Hydrodyn_Saxs_Hplc_Options::set_saxs_hplc_parameters() {
  ...
  parameters["saxs_hplc_param_nucleon_mass"] = QString("%1").arg(
      ((US_Hydrodyn_Saxs_Hplc *)hplc_win)->saxs_hplc_param_nucleon_mass, 0, 'g',
      8);
...
void US_Hydrodyn_Saxs_Hplc_Options::update_fasta_pH(const QString &str) {
