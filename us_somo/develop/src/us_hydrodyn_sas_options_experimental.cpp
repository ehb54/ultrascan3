...
US_Hydrodyn_SasOptionsExperimental::US_Hydrodyn_SasOptionsExperimental(struct saxs_options *saxs_options, bool *sas_options_experimental_widget, void *us_hydrodyn, QWidget *p, const char *) : QFrame( p )
{
