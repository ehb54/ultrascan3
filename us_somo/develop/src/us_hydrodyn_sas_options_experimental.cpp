...
void
US_Hydrodyn_SasOptionsExperimental::setupGUI ()
{
  int minHeight1 = 30;
  lbl_info = new QLabel (us_tr ("SOMO SAS Experimental Code Options: NB: This "
  ...
  cb_iqq_scale_linear_offset->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cb_autocorrelate->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_autocorrelate->setPalette (PALET_NORMAL);
  AUTFBACK (cb_autocorrelate);
  connect (cb_autocorrelate, SIGNAL (clicked ()), this,
           SLOT (set_autocorrelate ()));
  ...
  cb_hybrid_radius_excl_vol->setChecked (
      (*saxs_options).hybrid_radius_excl_vol);
  cb_hybrid_radius_excl_vol->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  cb_subtract_radius->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  cb_iqq_use_atomic_ff->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  ...
  cb_iqq_use_saxs_excl_vol->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  ...
  cb_use_somo_ff->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cb_use_somo_ff->setPalette (PALET_NORMAL);
  AUTFBACK (cb_use_somo_ff);
  connect (cb_use_somo_ff, SIGNAL (clicked ()), this,
           SLOT (set_use_somo_ff ()));
  ...
  cb_iqq_scale_nnls->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  cb_iqq_log_fitting->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  cb_iqq_scale_play->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  cb_alt_ff->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_iq_exact_q->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_compute_exponentials->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  cb_multiply_iq_by_atomic_volume->setFont (QFont (
  ...
  le_ev_exp_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  cb_compute_chi2shannon->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  le_chi2shannon_dmax->setValidator (
      new QDoubleValidator (le_chi2shannon_dmax));
  ...
  le_chi2shannon_dmax->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("chi2shannon_dmax")
          ? ((US_Hydrodyn *)us_hydrodyn)
                ->gparams["chi2shannon_dmax"]
                .toDouble ()
          : 50e0));
  le_chi2shannon_dmax->setEnabled (true);
  le_chi2shannon_dmax->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  lbl_chi2shannon_k
      = new QLabel (us_tr (" Chi^2_Shannon Iterations : "), this);
  ...
  le_chi2shannon_k->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  cb_alt_sh1->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_alt_sh2->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_create_shd->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  background->addWidget (pb_create_somo_ff, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
  j++;
...
void
US_Hydrodyn_SasOptionsExperimental::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsExperimental::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsExperimental::closeEvent (QCloseEvent *e)
{
  *sas_options_experimental_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsExperimental::set_iqq_scale_linear_offset ()
{
  (*saxs_options).iqq_scale_linear_offset
...
void
US_Hydrodyn_SasOptionsExperimental::set_autocorrelate ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_hybrid_radius_excl_vol ()
{
  (*saxs_options).hybrid_radius_excl_vol
...
void
US_Hydrodyn_SasOptionsExperimental::set_subtract_radius ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_iqq_use_atomic_ff ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_iqq_use_saxs_excl_vol ()
{
  (*saxs_options).iqq_use_saxs_excl_vol
      = cb_iqq_use_saxs_excl_vol->isChecked ();
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_SasOptionsExperimental::set_use_somo_ff ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_iqq_scale_nnls ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_iqq_log_fitting ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_iqq_scale_play ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_alt_ff ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_five_term_gaussians ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_iq_exact_q ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_compute_exponentials ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::update_compute_exponential_terms (
    double val)
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_multiply_iq_by_atomic_volume ()
{
  (*saxs_options).multiply_iq_by_atomic_volume
...
void
US_Hydrodyn_SasOptionsExperimental::set_alt_sh1 ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_alt_sh2 ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::set_create_shd ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::create_somo_ff ()
{
  QString errormsg = "";
...
void
US_Hydrodyn_SasOptionsExperimental::update_ev_exp_mult (const QString &str)
{
  (*saxs_options).ev_exp_mult = str.toDouble ();
}

void
US_Hydrodyn_SasOptionsExperimental::set_compute_chi2shannon ()
{
...
void
US_Hydrodyn_SasOptionsExperimental::update_chi2shannon_dmax (
    const QString &str)
{
...
void
US_Hydrodyn_SasOptionsExperimental::update_chi2shannon_k (const QString &str)
{
