...
void US_Hydrodyn_Saxs_Hplc_Baseline_Best::editor_msg( QString color, QString msg, QTextEdit *e )
{
   if ( !e ) {
      e = editor;
   }
...
void US_Hydrodyn_Saxs_Hplc_Baseline_Best::editor_ec_msg( QString msg, QTextEdit *e )
{
   if ( !e ) {
      e = editor;
   }
