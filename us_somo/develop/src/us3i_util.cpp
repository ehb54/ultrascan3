...
QString
US3i_Util::getToken (QString &s, const QString &separator)
{
  QString token;
...
QString
US3i_Util::md5sum_file (QString filename)
{
  QFile f (filename);
...
QString
US3i_Util::toUTCDatetimeText (QString dttext, bool knownUTC)
{
    ...
    { // If we don't know that it's UTC, convert when " UTC" is missing
      ...
      if (!haveUTC)
        { // If no " UTC", convert to UTC and append " UTC"
          ...
          if (dttext.indexOf ("-") == 4)
            { // If already in ISO form, get UTC DateTime from string in ISO
              // form
...
QString
US3i_Util::toISODatetimeText (QString dttext)
{
...
QString
US3i_Util::uuid_unparse (unsigned char *uu)
{
...
QString
US3i_Util::compressed_triple (const QString &ccw)
{
...
// Convert a triple string from expanded to compressed form
QString
US3i_Util::expanded_triple (const QString &ccw, bool spaces)
{
...
unsigned char
US3i_Util::hex2int (unsigned char c)
{
  if (c <= '9')
...
void
US3i_Util::uuid_parse (const QString &in, unsigned char *uu)
{
...
bool
US3i_Util::bool_flag (const QString xmlattr)
{
...
QString
US3i_Util::bool_string (const bool boolval)
{
...
int
US3i_Util::listlistBuild (QList<QStringList> &lsl, QString &llstring)
{
...
//   each stringlist.
int
US3i_Util::listlistParse (QList<QStringList> &lsl, QString &llstring)
{
  int nlelem = 0;
