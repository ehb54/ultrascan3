...
US_Hydrodyn_Dad_Ciq::US_Hydrodyn_Dad_Ciq (void *us_hydrodyn_dad,
                                          map<QString, QString> *parameters,
                                          QWidget *p, const char *)
    : QDialog (p)
{
  this->us_hydrodyn_dad = us_hydrodyn_dad;
  this->parameters = parameters;

  USglobal = new US_Config ();
  setPalette (PALET_FRAME);
  setWindowTitle (us_tr ("US-SOMO: UV-Vis : Make I*(q)"));
...
US_Hydrodyn_Dad_Ciq::~US_Hydrodyn_Dad_Ciq () {}

void
US_Hydrodyn_Dad_Ciq::setupGUI ()
{
  ...
  lbl_title = new QLabel (
      parameters->count ("ngmode")
          ? us_tr ("US-SOMO: UV-Vis : Make I*(q) without Gaussians")
          : us_tr ("US-SOMO: UV-Vis : Make I*(q)"),
      this);
...
void
US_Hydrodyn_Dad_Ciq::quit ()
{
  close ();
}

void
US_Hydrodyn_Dad_Ciq::create_ng ()
{
  (*parameters)["go"] = "true";
...
void
US_Hydrodyn_Dad_Ciq::help ()
{
  US_Help *online_help;
  online_help = new US_Help (this);
  online_help->show_help ("manual/somo/dad_ciq.html");
}

void
US_Hydrodyn_Dad_Ciq::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Dad_Ciq::set_add_bl ()
{
  (*parameters)["add_baseline"] = cb_add_bl->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Dad_Ciq::set_sd_source ()
{
  update_enables ();
}

void
US_Hydrodyn_Dad_Ciq::set_normalize ()
{
  update_enables ();
}

void
US_Hydrodyn_Dad_Ciq::set_I0se ()
{
  update_enables ();
}

void
US_Hydrodyn_Dad_Ciq::set_save_as_pct_iq ()
{
...
void
US_Hydrodyn_Dad_Ciq::set_sd_zero_avg_local_sd ()
{
  (*parameters)["sd_zero_avg_local_sd"]
      = cb_sd_zero_avg_local_sd->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Dad_Ciq::set_sd_zero_keep_as_zeros ()
{
  (*parameters)["sd_zero_keep_as_zeros"]
      = cb_sd_zero_keep_as_zeros->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Dad_Ciq::set_sd_zero_set_to_pt1pct ()
{
  (*parameters)["sd_zero_set_to_pt1pct"]
      = cb_sd_zero_set_to_pt1pct->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Dad_Ciq::set_zero_drop_points ()
{
  (*parameters)["zero_drop_points"]
      = cb_zero_drop_points->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Dad_Ciq::set_zero_avg_local_sd ()
{
  (*parameters)["zero_avg_local_sd"]
      = cb_zero_avg_local_sd->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Dad_Ciq::set_zero_keep_as_zeros ()
{
  (*parameters)["zero_keep_as_zeros"]
      = cb_zero_keep_as_zeros->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Dad_Ciq::update_enables ()
{
  bool no_go = false;
...
void
US_Hydrodyn_Dad_Ciq::ws_hide (vector<QWidget *> ws, bool hide)
{
...
void
US_Hydrodyn_Dad_Ciq::zeros_found ()
{
