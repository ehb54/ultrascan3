...
{
  QSettings settings (US3, "US-SOMO");
  return QColor (settings.value ("palettes/normalColor", QColor (Qt::darkBlue))
                     .toString ());
}
...
US_GuiSettings::plotMinGrid (void)
{
  QSettings settings (US3, "US-SOMO");
  return QColor (
      settings.value ("palettes/plotMinGrid", QColor (Qt::lightGray))
          .toString ());
}
