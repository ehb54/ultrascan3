...
{
bool
plegendre (int l, int m, double x, double &result)
{
  double fact;
  double oldfact;
  double pll = 0e0;
...
bool
chebev (double a, double b, double c[], int m, double x, double &res)
{
  double d = 0e0;
  double dd = 0e0;
  double sv;
...
bool
beschb (double x, double &gam1, double &gam2, double &gampl, double &gammi)
{
  double xx;
  static double c1[] = {
...
bool
bessj (double x, double xnu, double *rj)
{
  int isign;
  int i;
  int l;
...
bool
sphbes (int n, double x, double &sj)
{
  double order;
  double rj;
...
{
bool
spherical_harmonic (int l, int m, double theta, double phi,
...
bool
conj_spherical_harmonic (int l, int m, double theta, double phi,
                         std::complex<double> &result)
{
  bool r_sign = false;
  bool i_sign = false;
...
bool
alt_conj_sh (int max_harmonics, double theta, double phi,
...
void
build_grid (std::vector<std::vector<double> > &fib_grid, unsigned int size)
{
