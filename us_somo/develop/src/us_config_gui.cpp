...
US_Config_GUI::US_Config_GUI(QWidget *parent, const char *) : QFrame(parent) {
  ...
  lbl_directions =
      new QLabel(us_tr("UltraScan " + US_Version + " Configuration:"), this);
  ...
  US_Config::connect(le_root_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_root_dir(const QString &)));
  ...
  US_Config::connect(le_data_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_data_dir(const QString &)));
  ...
  US_Config::connect(le_result_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_result_dir(const QString &)));
  ...
  US_Config::connect(le_html_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_html_dir(const QString &)));
  ...
  US_Config::connect(le_archive_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_archive_dir(const QString &)));
  ...
  US_Config::connect(le_system_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_system_dir(const QString &)));
  ...
  US_Config::connect(le_help_dir, SIGNAL(textChanged(const QString &)), this,
                     SLOT(update_help_dir(const QString &)));
  ...
  US_Config::connect(le_temperature_tol, SIGNAL(textChanged(const QString &)),
                     this, SLOT(update_temperature_tol(const QString &)));
...
void US_Config_GUI::cancel() { close(); }
...
void US_Config_GUI::update_browser(const QString &newText) {
  if (newText != "") USglobal->config_list.browser = newText;
}
...
void US_Config_GUI::update_system_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.system_dir = newText;
}

void US_Config_GUI::open_help_dir() {
  QString help = QFileDialog::getExistingDirectory(
      0, QString(), USglobal->config_list.help_dir, QFileDialog::ShowDirsOnly);
...
void US_Config_GUI::update_help_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.help_dir = newText;
}

void US_Config_GUI::update_temperature_tol(const QString &newText) {
  if (newText != "") USglobal->config_list.temperature_tol = newText.toFloat();
}
...
void US_Config_GUI::open_html_dir() {
  QString html = QFileDialog::getExistingDirectory(
      0, QString(), USglobal->config_list.html_dir, QFileDialog::ShowDirsOnly);
...
void US_Config_GUI::update_html_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.html_dir = newText;
}
...
void US_Config_GUI::update_tmp_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.tmp_dir = newText;
}

void US_Config_GUI::open_data_dir() {
  QString data = QFileDialog::getExistingDirectory(
      0, QString(), USglobal->config_list.data_dir, QFileDialog::ShowDirsOnly);
...
void US_Config_GUI::update_data_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.data_dir = newText;
}
...
void US_Config_GUI::update_archive_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.archive_dir = newText;
}

void US_Config_GUI::open_root_dir() {
  QString root = QFileDialog::getExistingDirectory(
      0, QString(), USglobal->config_list.root_dir, QFileDialog::ShowDirsOnly);
...
void US_Config_GUI::update_root_dir(const QString &newText) {
  if (newText != "") USglobal->config_list.root_dir = newText;
}
