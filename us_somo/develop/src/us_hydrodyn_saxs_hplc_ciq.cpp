...
void US_Hydrodyn_Saxs_Hplc_Ciq::quit() { close(); }
...
void US_Hydrodyn_Saxs_Hplc_Ciq::set_sd_source() { update_enables(); }

void US_Hydrodyn_Saxs_Hplc_Ciq::set_normalize() { update_enables(); }

void US_Hydrodyn_Saxs_Hplc_Ciq::set_istarq() { update_enables(); }
