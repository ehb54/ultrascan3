...
US_Hydrodyn_Saxs_Hplc_Ciq::US_Hydrodyn_Saxs_Hplc_Ciq (
    void *us_hydrodyn_saxs_hplc, map<QString, QString> *parameters, QWidget *p,
    const char *)
    : QDialog (p)
{
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::setupGUI ()
{
  ...
  lbl_title = new QLabel (
      parameters->count ("ngmode")
          ? us_tr ("US-SOMO: HPLC/KIN : Make I(q) without Gaussians")
          : us_tr ("US-SOMO: HPLC/KIN : Make I(q)"),
      this);
  ...
  cb_istarq->setText (parameters->count ("istarq_message")
                          ? (*parameters)["istarq_message"]
                          : QString (""));
  cb_istarq->setEnabled (parameters->count ("istarq_ok")
                         && (*parameters)["istarq_ok"] == "true");
  connect (cb_istarq, SIGNAL (clicked ()), SLOT (set_istarq ()));
  cb_istarq->setChecked (false);
  cb_istarq->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_I0se->setText (us_tr (
      "Data already normalized. I0 standard experimental value (a.u.) : "));
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::quit ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Ciq::create_ng ()
{
  (*parameters)["go"] = "true";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_add_bl ()
{
  (*parameters)["add_baseline"] = cb_add_bl->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Saxs_Hplc_Ciq::set_sd_source ()
{
  update_enables ();
}

void
US_Hydrodyn_Saxs_Hplc_Ciq::set_normalize ()
{
  update_enables ();
}

void
US_Hydrodyn_Saxs_Hplc_Ciq::set_istarq ()
{
  update_enables ();
}

void
US_Hydrodyn_Saxs_Hplc_Ciq::set_I0se ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_save_as_pct_iq ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::global ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_sd_zero_avg_local_sd ()
{
  (*parameters)["sd_zero_avg_local_sd"]
      = cb_sd_zero_avg_local_sd->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_sd_zero_keep_as_zeros ()
{
  (*parameters)["sd_zero_keep_as_zeros"]
      = cb_sd_zero_keep_as_zeros->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_sd_zero_set_to_pt1pct ()
{
  (*parameters)["sd_zero_set_to_pt1pct"]
      = cb_sd_zero_set_to_pt1pct->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_zero_drop_points ()
{
  (*parameters)["zero_drop_points"]
      = cb_zero_drop_points->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_zero_avg_local_sd ()
{
  (*parameters)["zero_avg_local_sd"]
      = cb_zero_avg_local_sd->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::set_zero_keep_as_zeros ()
{
  (*parameters)["zero_keep_as_zeros"]
      = cb_zero_keep_as_zeros->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::update_enables ()
{
  bool no_go = false;
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::ws_hide (vector<QWidget *> ws, bool hide)
{
...
void
US_Hydrodyn_Saxs_Hplc_Ciq::zeros_found ()
{
