...
void
US_Hydrodyn_Saxs_Hplc::invert_all_created ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::remove_created ()
{
  disable_all ();
  QStringList files;
...
bool
US_Hydrodyn_Saxs_Hplc::all_have_f_gaussians (QStringList &files)
{
...
US_Hydrodyn_Saxs_Hplc::p3d ()
{
...

  {
    ...
    US_Hydrodyn_Saxs_Hplc_P3d *hplc_p3d
        = new US_Hydrodyn_Saxs_Hplc_P3d (this, &parameters, this);
...
void
US_Hydrodyn_Saxs_Hplc::set_detector ()
{
  disable_all ();

  {
    ...
    US_Hydrodyn_Saxs_Hplc_Dctr *hplc_dctr
        = new US_Hydrodyn_Saxs_Hplc_Dctr (this, &parameters, this);
...
bool
US_Hydrodyn_Saxs_Hplc::height_wheel_file (double &val, double pos)
{
...
void
US_Hydrodyn_Saxs_Hplc::gauss_match_amplitude ()
{
  if (current_mode != MODE_GAUSSIAN)
    {
      return;
...
bool
US_Hydrodyn_Saxs_Hplc::opt_repeak_gaussians (QString file)
{
  if (!gaussians.size ())
    {
      return false;
...
vector<double>
US_Hydrodyn_Saxs_Hplc::conc_curve (vector<double> &t, unsigned int peak,
                                   double conv)
{
...
bool
US_Hydrodyn_Saxs_Hplc::adjacent_ok (QString name)
{
...
void
US_Hydrodyn_Saxs_Hplc::adjacent ()
{
  QString match_name;
  int match_pos = 0;
  QStringList turn_on;
...
void
US_Hydrodyn_Saxs_Hplc::adjacent_created ()
{
  QString match_name;
  int match_pos = 0;
  QStringList turn_on;
...
bool
US_Hydrodyn_Saxs_Hplc::adjacent_select (QListWidget *lb, QString match)
{
  bool ok;
...
QString
US_Hydrodyn_Saxs_Hplc::select_conc_file (QString tag)
{
...
void
US_Hydrodyn_Saxs_Hplc::repeak (QStringList files)
{
...
void
US_Hydrodyn_Saxs_Hplc::crop_common ()
{
...
QStringList
US_Hydrodyn_Saxs_Hplc::get_frames (QStringList files, QString head,
                                   QString tail)
{
  QStringList result;
...
void
US_Hydrodyn_Saxs_Hplc::avg (QStringList files, QString suffix)
{
...
void
US_Hydrodyn_Saxs_Hplc::conc_avg (QStringList files)
{
  // create average of selected
  vector<QString> avg_qs_string;
  vector<double> avg_qs;
...
void
US_Hydrodyn_Saxs_Hplc::select_nth ()
{
  map<QString, QString> parameters;
  ...
  US_Hydrodyn_Saxs_Hplc_Nth *hplc_nth
      = new US_Hydrodyn_Saxs_Hplc_Nth (this, &parameters, this);
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_nth_contains"]
      = parameters.count ("hplc_nth_contains")
            ? parameters["hplc_nth_contains"]
            : "";
...
void
US_Hydrodyn_Saxs_Hplc::axis_y (bool nochange, bool no_replot)
{
  if (!nochange)
    {
...
void
US_Hydrodyn_Saxs_Hplc::axis_x (bool nochange, bool no_replot)
{
...
US_Hydrodyn_Saxs_Hplc::options ()
{
  ...
  parameters["hplc_bl_linear"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_linear"];
  parameters["hplc_bl_integral"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_integral"];
  parameters["hplc_bl_save"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_save"];
  parameters["hplc_bl_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_smooth"];
  parameters["hplc_bl_start_region"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_start_region"];
  parameters["hplc_bl_i_power"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_i_power"];
  parameters["hplc_bl_reps"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_reps"];
  parameters["hplc_bl_epsilon"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_epsilon"];
  parameters["hplc_cormap_maxq"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cormap_maxq"];
  parameters["hplc_cormap_alpha"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cormap_alpha"];
  parameters["hplc_zi_window"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_zi_window"];
  parameters["hplc_discard_it_sd_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_discard_it_sd_mult"];
  parameters["hplc_cb_discard_it_sd_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_discard_it_sd_mult"];
  parameters["hplc_guinier_qrgmax"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_guinier_qrgmax"];
  parameters["hplc_cb_guinier_qrgmax"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_guinier_qrgmax"];
  parameters["hplc_gg_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_gg_smooth"];
  parameters["hplc_cb_gg_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_gg_smooth"];
  parameters["hplc_cb_gg_cyclic"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_gg_cyclic"];
  parameters["hplc_cb_gg_oldstyle"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_gg_oldstyle"];
  parameters["hplc_dist_max"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_dist_max"];
  ...
  parameters["hplc_ampl_width_min"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_ampl_width_min"];
  parameters["hplc_lock_min_retry"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_lock_min_retry"];
  parameters["hplc_lock_min_retry_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_lock_min_retry_mult"];
  parameters["hplc_maxfpk_restart"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_maxfpk_restart"];
  parameters["hplc_maxfpk_restart_tries"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_maxfpk_restart_tries"];
  parameters["hplc_maxfpk_restart_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_maxfpk_restart_pct"];

  parameters["hplc_makeiq_cutmax_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_makeiq_cutmax_pct"];
  parameters["hplc_cb_makeiq_cutmax_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_makeiq_cutmax_pct"];
  parameters["hplc_cb_makeiq_avg_peaks"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_makeiq_avg_peaks"];
  parameters["hplc_makeiq_avg_peaks"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_makeiq_avg_peaks"];
  ...
  saxs_hplc_options_widget = new US_Hydrodyn_Saxs_Hplc_Options (
      &parameters, (US_Hydrodyn *)us_hydrodyn, this);
  US_Hydrodyn::fixWinButtons (
      (US_Hydrodyn_Saxs_Hplc_Options *)saxs_hplc_options_widget);
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_linear"]
          != parameters["hplc_bl_linear"]
      || ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_integral"]
             != parameters["hplc_bl_integral"]
      || ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cormap_maxq"]
  ...
  cb_guinier_qrgmax->setChecked (parameters["hplc_cb_guinier_qrgmax"]
                                 == "true");
...
void
US_Hydrodyn_Saxs_Hplc::clear_gaussians ()
{
  unified_ggaussian_ok = false;
  f_gaussians.clear ();
  gaussians.clear ();
...
bool
US_Hydrodyn_Saxs_Hplc::any_gaussians ()
{
...
void
US_Hydrodyn_Saxs_Hplc::hide_files ()
{
  if (U_EXPT)
    {
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_files_widgets"]
      = files_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Saxs_Hplc::hide_created_files ()
{
  if (U_EXPT)
    {
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_created_files_widgets"]
      = created_files_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Saxs_Hplc::hide_editor ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_editor_widgets"]
      = editor_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Saxs_Hplc::svd ()
{
  disable_all ();
  ...
  new US_Hydrodyn_Saxs_Hplc_Svd (this, selected_files);
}

void
US_Hydrodyn_Saxs_Hplc::line_width ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_line_width"]
...
void
US_Hydrodyn_Saxs_Hplc::color_rotate ()
{
  US_Plot_Zoom upz (plot_dist, plot_dist_zoomer);
...
void
US_Hydrodyn_Saxs_Hplc::movie ()
{
  disable_all ();

  US_Hydrodyn_Saxs_Hplc_Movie *shm = new US_Hydrodyn_Saxs_Hplc_Movie (this);
...
void
US_Hydrodyn_Saxs_Hplc::update_ref ()
{
  if (!plot_ref->isVisible ())
    {
      return;
...
double
US_Hydrodyn_Saxs_Hplc::tot_intensity (QString &file, double q_min,
                                      double q_max)
{
...
void
US_Hydrodyn_Saxs_Hplc::set_selected (set<QString> &to_select, bool do_replot)
{
  disable_updates = true;
  lb_files->clearSelection ();
  for (int i = 0; i < (int)lb_files->count (); i++)
...
void
US_Hydrodyn_Saxs_Hplc::set_created_selected (set<QString> &to_select,
                                             bool do_replot)
{
  disable_updates = true;
...
void
US_Hydrodyn_Saxs_Hplc::artificial_gaussians ()
{
...
bool
US_Hydrodyn_Saxs_Hplc::constant_e (QString file, double e)
{
  if (!f_qs.count (file))
    {
      return false;
...
int
US_Hydrodyn_Saxs_Hplc::slice (const vector<double> &q, const vector<double> &I,
...
double
US_Hydrodyn_Saxs_Hplc::wyatt_errors (QString file, double start_q,
                                     double end_q)
{
  if (!f_qs.count (file))
    {
...
double
US_Hydrodyn_Saxs_Hplc::wyatt_errors (const vector<double> &q,
                                     ...
                                     vector<double> &new_y)
{
  ...
  // compute SVD of M (see: us_hydrodyn_saxs_hplc_svd.cpp and us_svd.cpp for
  // usage)
...
void
US_Hydrodyn_Saxs_Hplc::plot_debug ()
{
...
bool
US_Hydrodyn_Saxs_Hplc::ask_to_decimate (map<QString, QString> &parameters)
{
  switch (QMessageBox::warning (
      this,
      windowTitle ()
...
bool
US_Hydrodyn_Saxs_Hplc::ask_cormap_minq (map<QString, QString> &parameters)
{
  bool ok;
...
void
US_Hydrodyn_Saxs_Hplc::cormap (map<QString, QString> &parameters)
{
  disable_all ();
  ...
  double cormap_maxq
      = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("hplc_cormap_maxq")
            ? ((US_Hydrodyn *)us_hydrodyn)
                  ->gparams["hplc_cormap_maxq"]
                  .toDouble ()
            : 0.05;
...
void
US_Hydrodyn_Saxs_Hplc::bin (QStringList files)
{
  bool ok;
...
void
US_Hydrodyn_Saxs_Hplc::bb_cm_inc ()
{
  // us_qdebug( "bb_cm_inc" );
...
bool
US_Hydrodyn_Saxs_Hplc::blanks_params ()
{
...
QStringList
US_Hydrodyn_Saxs_Hplc::vector_qstring_to_qstringlist (vector<QString> vqs)
{
  QStringList qsl;
...
void
US_Hydrodyn_Saxs_Hplc::simulate ()
{
  us_qdebug ("simulate");
...
void
US_Hydrodyn_Saxs_Hplc::gauss_mode ()
{
  map<QString, QString> parameters;
  ...
  US_Hydrodyn_Saxs_Hplc_Gauss_Mode *sho
      = new US_Hydrodyn_Saxs_Hplc_Gauss_Mode (
          &parameters, (US_Hydrodyn *)us_hydrodyn, this);
...
void
US_Hydrodyn_Saxs_Hplc::reset_saxs_hplc_params ()
{
  saxs_hplc_param_frame_interval
      = ((US_Hydrodyn *)us_hydrodyn)
                ->gparams.count ("saxs_hplc_param_frame_interval")
            ? ((US_Hydrodyn *)us_hydrodyn)
                  ->gparams["saxs_hplc_param_frame_interval"]
                  .toDouble ()
            : 1;
  ...
  saxs_hplc_param_g_conc
      = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("saxs_hplc_param_g_conc")
            ? ((US_Hydrodyn *)us_hydrodyn)
                  ->gparams["saxs_hplc_param_g_conc"]
                  .toDouble ()
            : 0;
  ...
  saxs_hplc_param_diffusion_len
      = ((US_Hydrodyn *)us_hydrodyn)->saxs_options.diffusion_len;
  saxs_hplc_param_electron_nucleon_ratio
      = ((US_Hydrodyn *)us_hydrodyn)
                ->gparams.count ("guinier_electron_nucleon_ratio")
            ? ((US_Hydrodyn *)us_hydrodyn)
                  ->gparams["guinier_electron_nucleon_ratio"]
                  .toDouble ()
            : 1.87e0;
  saxs_hplc_param_nucleon_mass
      = ((US_Hydrodyn *)us_hydrodyn)->saxs_options.nucleon_mass;
  saxs_hplc_param_solvent_electron_density
      = QString ("%1")
            .arg (((US_Hydrodyn *)us_hydrodyn)->saxs_options.water_e_density,
                  0, 'f', 4)
            .toDouble ();
}
