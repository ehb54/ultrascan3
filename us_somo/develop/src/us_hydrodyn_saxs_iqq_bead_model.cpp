...
void
US_Hydrodyn_Saxs::calc_saxs_iq_native_fast_bead_model ()
{
      ...
      if (atoms.size () == 1)
        {
          editor_msg (
              "dark blue",
              us_tr ("Notice: using full Debye since only 1 bead available"));
...
//  ------------------------------------------------------------------------------------------------------
void
US_Hydrodyn_Saxs::calc_saxs_iq_native_debye_bead_model ()
{
  // don't forget to later merge deleted waters into model_vector
  // right now we are going with first residue map entry
  stopFlag = false;
...
//  ------------------------------------------------------------------------------------------------------
void
US_Hydrodyn_Saxs::calc_saxs_iq_native_hybrid2_bead_model ()
{
  stopFlag = false;
  pb_stop->setEnabled (true);
  pb_plot_saxs_sans->setEnabled (false);
...
double
US_Hydrodyn_Saxs::compute_ff_bead_model (saxs &s, double q_o_4pi2)
{
