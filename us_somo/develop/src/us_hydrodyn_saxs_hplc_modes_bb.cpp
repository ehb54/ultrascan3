...
void US_Hydrodyn_Saxs_Hplc::blanks_start() {
...
void US_Hydrodyn_Saxs_Hplc::blanks_enables() {
...
// --- baseline ---
void US_Hydrodyn_Saxs_Hplc::baseline_start(bool from_blanks_mode_save) {
  if (axis_y_log) {
    axis_y();
  }
...
void US_Hydrodyn_Saxs_Hplc::baseline_apply(QStringList files, bool integral,
  ...
  bool use_start_region =
      ...
      ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_bl_start_region"].toInt() > 0;
...
int US_Hydrodyn_Saxs_Hplc::input_double_to_pos(double d) {
