...
void US_Hydrodyn_Saxs_Hplc::baseline_start( bool from_blanks_mode_save )
{
...

   {
      bool use_i_power = 
         ...
         ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "hplc_bl_i_power" ].toDouble() != 1e0;
      ...
      if ( integral ) {
         {
            // recompute start_y
            if ( use_start_region ) {
               int start_region_frames = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "hplc_bl_start_region" ].toInt();
      ...
      if ( ca.sliding( 
         ...
         // plot of results
         {
            ...
            if ( best_vdparameters[ "x" ].size() ) {
               US_Hydrodyn_Saxs_Hplc_Baseline_Best * uhsbb = new US_Hydrodyn_Saxs_Hplc_Baseline_Best( us_hydrodyn,
                                                                                                      best_parameters,
                                                                                                      best_dparameters,
                                                                                                      best_vdparameters
                                                                                                      );
...
void US_Hydrodyn_Saxs_Hplc::baseline_test_pos( int pos ) {
   ...
   baseline_apply( qsl
                   ...
                   ,true
                   ,( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "hplc_bl_reps" ].toInt()
                   ,false
                   ,true );
