    ...
    : QDialog (p)
{
  ...
  setWindowTitle (
      ((US_Hydrodyn_Pdb_Tool *)us_hydrodyn_pdb_tool)->windowTitle ()
...
void
US_Hydrodyn_Pdb_Tool_Selres::setupGUI ()
{
  int minHeight1 = 26;
  ...
  le_max_dist->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cb_sel_only_new->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_save_sel->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  le_save_sel->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cb_asa->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  cb_naccess->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_naccess_sc_or_mc->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Pdb_Tool_Selres::quit ()
{
  close ();
}

void
US_Hydrodyn_Pdb_Tool_Selres::go ()
{
  (*parameters)["go"] = "true";
...
void
US_Hydrodyn_Pdb_Tool_Selres::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Pdb_Tool_Selres::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Pdb_Tool_Selres::update_enables ()
{
