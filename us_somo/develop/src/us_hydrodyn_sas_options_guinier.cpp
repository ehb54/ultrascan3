...
void US_Hydrodyn_SasOptionsGuinier::setupGUI() {
  ...
  lbl_guinier_and_cs_guinier =
      new QLabel(us_tr("Guinier, CS Guinier and TV Guinier Options:"), this);
  ...
  lbl_guinier_and_cs_guinier->setFont(QFont(USglobal->config_list.fontFamily,
  ...
  cb_guinier_use_qRlimit->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_guinier_outlier_reject->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_guinier_outlier_reject_dist->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_guinier_outlier_reject_dist->setPalette(PALET_NORMAL);
  AUTFBACK(le_guinier_outlier_reject_dist);
  connect(le_guinier_outlier_reject_dist, SIGNAL(textChanged(const QString &)),
  ...
  le_guinier_csv_filename->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_guinier_csv_save_data->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_conc->setFont(QFont(USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));
  lbl_conc->setToolTip(
      us_tr("<html><head/><body><p>Note: This value is used when the SAS curve "
            "does not have stored values.</p><p>You can change them by using "
            "the 'Set Curve concentration, PSV, I0 standard experimental' "
            "button above.</body></html>"));
  ...
  lbl_I0_exp =
      new QLabel(us_tr(" Default I0 standard experimental (a.u.) : "), this);
  ...
  lbl_electron_nucleon_ratio->setFont(QFont(USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));
  ...
  le_electron_nucleon_ratio->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_guinier_use_standards->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...

  {
    ...
    // leftside->addWidget( lbl_cs_guinier , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1
    // ) - ( 0 ) ); j++;
...
void US_Hydrodyn_SasOptionsGuinier::cancel() { close(); }
...
void US_Hydrodyn_SasOptionsGuinier::update_guinier_csv_filename(
    const QString &str) {
...
void US_Hydrodyn_SasOptionsGuinier::set_guinier_use_qRlimit() {
  ...
  if (cb_guinier_use_qRlimit->isChecked() && cb_guinier_auto_fit->isChecked()) {
...
void US_Hydrodyn_SasOptionsGuinier::update_guinier_outlier_reject_dist(
    const QString &str) {
  double val = str.toDouble();
...
void US_Hydrodyn_SasOptionsGuinier::update_electron_nucleon_ratio(
    const QString &str) {
