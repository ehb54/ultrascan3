...
US_Hydrodyn_SasOptionsGuinier::US_Hydrodyn_SasOptionsGuinier (
    struct saxs_options *saxs_options, bool *sas_options_guinier_widget,
...
void
US_Hydrodyn_SasOptionsGuinier::setupGUI ()
{
  int minHeight1 = 30;

  lbl_guinier_and_cs_guinier = new QLabel (
      us_tr ("Guinier, CS Guinier and TV Guinier Options:"), this);
  lbl_guinier_and_cs_guinier->setFrameStyle (QFrame::WinPanel
                                             | QFrame::Raised);
  lbl_guinier_and_cs_guinier->setAlignment (Qt::AlignCenter
                                            | Qt::AlignVCenter);
  lbl_guinier_and_cs_guinier->setPalette (PALET_FRAME);
  AUTFBACK (lbl_guinier_and_cs_guinier);
  lbl_guinier_and_cs_guinier->setFont (
  ...
  AUTFBACK (lbl_qRgmax);
  lbl_qRgmax->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  le_qRgmax->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  le_qRgmax->setPalette (PALET_NORMAL);
  AUTFBACK (le_qRgmax);
  connect (le_qRgmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_qRgmax (const QString &)));
  ...
  //    lbl_cs_guinier->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize + 1, QFont::Bold));
  ...
  lbl_cs_qRgmax->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));
  ...
  le_cs_qRgmax->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_cs_qRgmax->setPalette (PALET_NORMAL);
  AUTFBACK (le_cs_qRgmax);
  connect (le_cs_qRgmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_cs_qRgmax (const QString &)));
  ...
  lbl_Rt_qRtmax->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));
  ...
  le_Rt_qRtmax->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("guinier_qRtmax")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_qRtmax"]
          : "");
  le_Rt_qRtmax->setEnabled (true);
  le_Rt_qRtmax->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_Rt_qRtmax->setPalette (PALET_NORMAL);
  AUTFBACK (le_Rt_qRtmax);
  connect (le_Rt_qRtmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_Rt_qRtmax (const QString &)));
  ...
  lbl_cs_qstart->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));
  ...
  le_cs_qstart->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_cs_qstart->setPalette (PALET_NORMAL);
  AUTFBACK (le_cs_qstart);
  connect (le_cs_qstart, SIGNAL (textChanged (const QString &)),
           SLOT (update_cs_qstart (const QString &)));
  ...
  lbl_cs_qend->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));
  ...
  le_cs_qend->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_cs_qend->setPalette (PALET_NORMAL);
  AUTFBACK (le_cs_qend);
  connect (le_cs_qend, SIGNAL (textChanged (const QString &)),
           SLOT (update_cs_qend (const QString &)));
  ...
  AUTFBACK (lbl_qstart);
  lbl_qstart->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  ...
  le_qstart->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  le_qstart->setPalette (PALET_NORMAL);
  AUTFBACK (le_qstart);
  connect (le_qstart, SIGNAL (textChanged (const QString &)),
           SLOT (update_qstart (const QString &)));
  ...
  AUTFBACK (lbl_qend);
  lbl_qend->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  le_qend->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  le_qend->setPalette (PALET_NORMAL);
  AUTFBACK (le_qend);
  connect (le_qend, SIGNAL (textChanged (const QString &)),
           SLOT (update_qend (const QString &)));
  ...
  cb_guinier_auto_fit->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("guinier_auto_fit")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_auto_fit"] == "1");
  cb_guinier_auto_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_guinier_auto_fit->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_auto_fit);
  connect (cb_guinier_auto_fit, SIGNAL (clicked ()), this,
           SLOT (set_guinier_auto_fit ()));
  ...
  lbl_pointsmin->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));
  ...
  le_pointsmin->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_pointsmin->setPalette (PALET_NORMAL);
  AUTFBACK (le_pointsmin);
  connect (le_pointsmin, SIGNAL (textChanged (const QString &)),
           SLOT (update_pointsmin (const QString &)));
  ...
  lbl_pointsmax->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));
  ...
  le_pointsmax->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_pointsmax->setPalette (PALET_NORMAL);
  AUTFBACK (le_pointsmax);
  connect (le_pointsmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_pointsmax (const QString &)));

  cb_guinier_use_qRlimit = new QCheckBox (this);
  cb_guinier_use_qRlimit->setText (
      us_tr (" Limit maximum q to max q*Rg, q*Rc or q*Rg\n (not active in "
             "Search mode)"));
  cb_guinier_use_qRlimit->setEnabled (true);
  cb_guinier_use_qRlimit->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("guinier_use_qRlimit")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_use_qRlimit"] == "1");
  cb_guinier_use_qRlimit->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_guinier_use_qRlimit->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_use_qRlimit);
  connect (cb_guinier_use_qRlimit, SIGNAL (clicked ()), this,
           SLOT (set_guinier_use_qRlimit ()));
  ...
  cb_guinier_use_sd->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_guinier_use_sd->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_use_sd);
  connect (cb_guinier_use_sd, SIGNAL (clicked ()), this,
           SLOT (set_guinier_use_sd ()));

  cb_guinier_outlier_reject = new QCheckBox (this);
  cb_guinier_outlier_reject->setText (
      us_tr (" Repeat the analysis after discarding\n points over the "
             "regression line\n by more than SD of "));
  cb_guinier_outlier_reject->setEnabled (true);
  cb_guinier_outlier_reject->setChecked (
      (*saxs_options).guinier_outlier_reject);
  cb_guinier_outlier_reject->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  cb_guinier_outlier_reject->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_outlier_reject);
  connect (cb_guinier_outlier_reject, SIGNAL (clicked ()), this,
           SLOT (set_guinier_outlier_reject ()));

  le_guinier_outlier_reject_dist = new QLineEdit (this);
  le_guinier_outlier_reject_dist->setValidator (
      new QDoubleValidator (le_guinier_outlier_reject_dist));
  ((QDoubleValidator *)le_guinier_outlier_reject_dist->validator ())
      ->setRange (0, 1, 2);
  le_guinier_outlier_reject_dist->setText (
      QString ("%1").arg ((*saxs_options).guinier_outlier_reject_dist));
  le_guinier_outlier_reject_dist->setEnabled (true);
  le_guinier_outlier_reject_dist->setFont (QFont (
  ...
  connect (le_guinier_outlier_reject_dist,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_guinier_outlier_reject_dist (const QString &)));
  ...
  cb_guinier_csv->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cb_guinier_csv->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_csv);
  connect (cb_guinier_csv, SIGNAL (clicked ()), this,
           SLOT (set_guinier_csv ()));

  le_guinier_csv_filename = new QLineEdit (this);
  le_guinier_csv_filename->setObjectName ("guinier_csv_filename Line Edit");
  ...
  le_guinier_csv_filename->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  connect (le_guinier_csv_filename, SIGNAL (textChanged (const QString &)),
           SLOT (update_guinier_csv_filename (const QString &)));

  cb_guinier_csv_save_data = new QCheckBox (this);
  cb_guinier_csv_save_data->setText (
      us_tr (" Save processed q, I(q) data to csv file"));
  cb_guinier_csv_save_data->setEnabled (true);
  cb_guinier_csv_save_data->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("guinier_csv_save_data")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_csv_save_data"]
             == "1");
  cb_guinier_csv_save_data->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  cb_guinier_csv_save_data->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_csv_save_data);
  connect (cb_guinier_csv_save_data, SIGNAL (clicked ()), this,
           SLOT (set_guinier_csv_save_data ()));

  lbl_conc_header
      = new QLabel (us_tr ("MW and M/L computation options:"), this);
  ...
  lbl_conc_header->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1,
                                   QFont::Bold));

  pb_curve_conc = new QPushButton (
      us_tr ("Set Curve Concentration, PSV, I0 standard experimental"), this);
  pb_curve_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  AUTFBACK (lbl_conc);
  lbl_conc->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));
  lbl_conc->setToolTip (
      us_tr ("<html><head/><body><p>Note: This value is used when the SAS "
             "curve does not have stored values.</p><p>You can change them by "
             "using the 'Set Curve concentration, PSV, I0 standard "
             "experimental' button above.</body></html>"));
  ...
  le_conc->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  lbl_psv
      = new QLabel (us_tr (" Default partial specific volume (ml/g): "), this);
  ...
  lbl_I0_exp = new QLabel (
      us_tr (" Default I0 standard experimental (a.u.) : "), this);
  lbl_I0_exp->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_I0_exp->setPalette (PALET_LABEL);
  AUTFBACK (lbl_I0_exp);
  lbl_I0_exp->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_I0_exp->setToolTip (
      us_tr ("<html><head/><body><p>Note: This value is used when the SAS "
             "curve does not have stored values.</p><p>You can change them by "
             "using the 'Set Curve concentration, PSV, I0 standard "
             "experimental' button above.</body></html>"));
  ...
  le_I0_exp->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  le_I0_exp->setPalette (PALET_NORMAL);
  AUTFBACK (le_I0_exp);
  connect (le_I0_exp, SIGNAL (textChanged (const QString &)),
           SLOT (update_I0_exp (const QString &)));
  le_I0_exp->setToolTip (
      us_tr ("<html><head/><body><p>Note: This value is used when the SAS "
             "curve does not have stored values.</p><p>You can change them by "
             "using the 'Set Curve concentration, PSV, I0 standard "
             "experimental' button above.</body></html>"));
  ...
  cb_use_cs_psv->setText (
      us_tr (" Partial specific volume override for CS (ml/g): "));
  ...
  cb_use_cs_psv->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  le_cs_psv->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  le_cs_psv->setPalette (PALET_NORMAL);
  AUTFBACK (le_cs_psv);
  connect (le_cs_psv, SIGNAL (textChanged (const QString &)),
           SLOT (update_cs_psv (const QString &)));
  ...
  lbl_diffusion_len->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));

  le_diffusion_len = new QLineEdit (this);
  le_diffusion_len->setValidator (new QDoubleValidator (le_diffusion_len));
  le_diffusion_len->setText (
      QString ("%1").arg ((*saxs_options).diffusion_len));
  le_diffusion_len->setEnabled (true);
  le_diffusion_len->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  le_diffusion_len->setPalette (PALET_NORMAL);
  AUTFBACK (le_diffusion_len);
  connect (le_diffusion_len, SIGNAL (textChanged (const QString &)),
           SLOT (update_diffusion_len (const QString &)));

  lbl_electron_nucleon_ratio
      = new QLabel (us_tr (" Electron/nucleon ratio Z/A : "), this);
  ...
  lbl_electron_nucleon_ratio->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_electron_nucleon_ratio = new QLineEdit (this);
  le_electron_nucleon_ratio->setValidator (
      new QDoubleValidator (le_electron_nucleon_ratio));
  ...
  le_electron_nucleon_ratio->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  le_electron_nucleon_ratio->setPalette (PALET_NORMAL);
  AUTFBACK (le_electron_nucleon_ratio);
  connect (le_electron_nucleon_ratio, SIGNAL (textChanged (const QString &)),
           SLOT (update_electron_nucleon_ratio (const QString &)));
  ...
  lbl_nucleon_mass->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1,
                                    QFont::Bold));
  ...
  le_nucleon_mass->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  le_nucleon_mass->setPalette (PALET_NORMAL);
  AUTFBACK (le_nucleon_mass);
  connect (le_nucleon_mass, SIGNAL (textChanged (const QString &)),
           SLOT (update_nucleon_mass (const QString &)));
  ...
  connect (le_mwt_k, SIGNAL (textChanged (const QString &)),
           SLOT (update_mwt_k (const QString &)));
  ...
  connect (le_mwt_c, SIGNAL (textChanged (const QString &)),
           SLOT (update_mwt_c (const QString &)));
  ...
  connect (le_mwt_qmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_mwt_qmax (const QString &)));

  cb_guinier_use_standards = new QCheckBox (this);
  cb_guinier_use_standards->setText (
      us_tr (" Use I0 standards for normalization"));
  cb_guinier_use_standards->setEnabled (true);
  connect (cb_guinier_use_standards, SIGNAL (clicked ()),
           SLOT (set_guinier_use_standards ()));
  cb_guinier_use_standards->setChecked ((*saxs_options).guinier_use_standards);
  cb_guinier_use_standards->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  cb_guinier_use_standards->setPalette (PALET_NORMAL);
  AUTFBACK (cb_guinier_use_standards);
  cb_guinier_use_standards->setToolTip (
      us_tr ("<html><head/><body><p>If checked, the 'I0 standard theoretical' "
             "below and the curve's 'I0 standard experimental' values will be "
             "used to compute the MW. Otherwise, the curve is already assumed "
             "to be properly normalized.</p></body></html>"));

  lbl_I0_theo
      = new QLabel (us_tr (" I0 standard theoretical (cm^-1) : "), this);
  lbl_I0_theo->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_I0_theo->setPalette (PALET_LABEL);
  AUTFBACK (lbl_I0_theo);
  lbl_I0_theo->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));
  lbl_I0_theo->setToolTip (
      us_tr ("<html><head/><body><p>Note: Only used if 'Use I0 standards for "
             "normalization' checkbox above is set.</p></body></html>"));
  ...
  le_I0_theo->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_I0_theo->setPalette (PALET_NORMAL);
  AUTFBACK (le_I0_theo);
  connect (le_I0_theo, SIGNAL (textChanged (const QString &)),
           SLOT (update_I0_theo (const QString &)));
  le_I0_theo->setToolTip (
      us_tr ("<html><head/><body><p>Note: Only used if 'Use I0 standards for "
             "normalization' checkbox above is set.</p></body></html>"));
  ...
  pb_cs_guinier->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_Rt_guinier->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
...

  {
    ...
    leftside->addWidget (lbl_guinier_and_cs_guinier, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
    j++;
    ...
    // leftside->addWidget( lbl_cs_guinier , j , 0 , 1 + ( j ) - ( j ) , 1 + (
    // 1 ) - ( 0 ) ); j++;
    ...
    j++;
    leftside->addWidget (cb_guinier_use_qRlimit, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
    j++;
    leftside->addWidget (cb_guinier_use_sd, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
    j++;
    ...
    leftside->addWidget (cb_guinier_csv_save_data, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
    j++;

    leftside->addWidget (cb_guinier_auto_fit, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
    j++;
...

  {
    ...
    rightside->addWidget (cb_guinier_use_standards, j, 0, 1 + (j) - (j),
                          1 + (1) - (0));
    j++;
...
void
US_Hydrodyn_SasOptionsGuinier::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsGuinier::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsGuinier::closeEvent (QCloseEvent *e)
{
  *sas_options_guinier_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsGuinier::update_qRgmax (const QString &str)
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_qstart (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_qend (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_cs_qRgmax (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_Rt_qRtmax (const QString &str)
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_qRtmax"] = str;
}

void
US_Hydrodyn_SasOptionsGuinier::update_cs_qstart (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_cs_qend (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_pointsmin (const QString &str)
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_pointsmax (const QString &str)
{
  unsigned int val = str.toUInt ();
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_csv ()
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_guinier_csv_filename (const QString &str)
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_conc (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_psv (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_use_qRlimit ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_use_qRlimit"]
      = cb_guinier_use_qRlimit->isChecked () ? "1" : "0";
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_use_sd ()
{
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_outlier_reject ()
{
  (*saxs_options).guinier_outlier_reject
      = cb_guinier_outlier_reject->isChecked ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_guinier_outlier_reject_dist (
    const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::set_use_cs_psv ()
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_cs_psv (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_use_standards ()
{
  (*saxs_options).guinier_use_standards
      = cb_guinier_use_standards->isChecked ();
  //   ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_SasOptionsGuinier::update_I0_exp (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_I0_theo (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_diffusion_len (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_electron_nucleon_ratio (
    const QString &str)
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_electron_nucleon_ratio"]
      = QString ("%1").arg (str.toDouble (), 0, 'g', 8);
  //   ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_SasOptionsGuinier::update_nucleon_mass (const QString &str)
{
  double val = str.toDouble ();
...
void
US_Hydrodyn_SasOptionsGuinier::update_mwt_k (const QString &str)
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_mwt_c (const QString &str)
{
...
void
US_Hydrodyn_SasOptionsGuinier::update_mwt_qmax (const QString &str)
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_mwt_qmax"]
      = QString ("%1").arg (str.toDouble (), 0, 'g', 8);
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
...
void
US_Hydrodyn_SasOptionsGuinier::guinier ()
{
...
void
US_Hydrodyn_SasOptionsGuinier::cs_guinier ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_widget)
    {
      if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_window->isVisible ())
...
void
US_Hydrodyn_SasOptionsGuinier::Rt_guinier ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_widget)
    {
      if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_window->isVisible ())
...
void
US_Hydrodyn_SasOptionsGuinier::curve_conc ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_widget)
    {
      ((US_Hydrodyn *)us_hydrodyn)->saxs_plot_window->sync_conc_csv ();
      US_Hydrodyn_Saxs_Conc *hsc = new US_Hydrodyn_Saxs_Conc (
          ((US_Hydrodyn *)us_hydrodyn)->saxs_plot_window->conc_csv,
          ((US_Hydrodyn *)us_hydrodyn)->saxs_plot_window, this);
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_auto_fit ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_auto_fit"]
      = cb_guinier_auto_fit->isChecked () ? "1" : "0";
...
void
US_Hydrodyn_SasOptionsGuinier::set_guinier_csv_save_data ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_csv_save_data"]
      = cb_guinier_csv_save_data->isChecked () ? "1" : "0";
  //   ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}
