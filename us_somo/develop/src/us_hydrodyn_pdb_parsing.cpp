...
void
US_Hydrodyn_PDB_Parsing::setupGUI ()
{
  int minHeight1 = 30;
  ...
  cb_skip_hydrogen->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_skip_hydrogen->setPalette (PALET_NORMAL);
  AUTFBACK (cb_skip_hydrogen);
  connect (cb_skip_hydrogen, SIGNAL (clicked ()), this,
           SLOT (skip_hydrogen ()));
  ...
  cb_skip_water->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_alternate->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  cb_find_sh->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  le_thresh_SS->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("thresh_SS")
  ...
  cb_save_csv_on_load->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  cb_use_WAT_Tf->setText (us_tr (
      " Use explicit WAT radii as specified in PDB the T-factor field"));
  ...
  cb_use_WAT_Tf->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
...
void
US_Hydrodyn_PDB_Parsing::skip_hydrogen ()
{
...
void
US_Hydrodyn_PDB_Parsing::skip_water ()
{
...
void
US_Hydrodyn_PDB_Parsing::alternate ()
{
...
void
US_Hydrodyn_PDB_Parsing::find_sh ()
{
...
void
US_Hydrodyn_PDB_Parsing::save_csv_on_load ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["save_csv_on_load_pdb"]
...
void
US_Hydrodyn_PDB_Parsing::use_WAT_Tf ()
{
...
void
US_Hydrodyn_PDB_Parsing::residue ()
{
...
void
US_Hydrodyn_PDB_Parsing::residue (int val)
{
...
void
US_Hydrodyn_PDB_Parsing::atom (int val)
{
...
void
US_Hydrodyn_PDB_Parsing::cancel ()
{
  close ();
}

void
US_Hydrodyn_PDB_Parsing::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_PDB_Parsing::closeEvent (QCloseEvent *e)
{
  *pdb_parsing_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_PDB_Parsing::update_thresh_SS (const QString &str)
{
