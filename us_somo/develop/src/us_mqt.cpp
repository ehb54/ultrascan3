...
void mQThread::sleep(unsigned long secs) { QThread::sleep(secs); }

void mQThread::msleep(unsigned long msecs) { QThread::msleep(msecs); }

void mQThread::usleep(unsigned long usecs) { QThread::usleep(usecs); }

void ShowHide::hide_widgets(const std::set<QWidget *> &widgets, bool hide,
                            QWidget *do_resize) {
...
void ShowHide::hide_widgets(const std::vector<QWidget *> &widgets, bool hide,
                            QWidget *do_resize) {
  std::set<QWidget *> always_hide_widgets;
  return hide_widgets(widgets, always_hide_widgets, hide, do_resize);
}
...
QColor PC::color(int i) { return plot_colors[i % plot_colors.size()]; }
