...
US_Hydrodyn_Saxs_Cormap::US_Hydrodyn_Saxs_Cormap (
    ...
    vector<vector<double> > adjpvaluepairs, vector<QString> selected_files,
...
void
US_Hydrodyn_Saxs_Cormap::setupGUI ()
{
  int minHeight1 = 30;
  ...
  lbl_title = new QLabel (
      parameters.count ("title") ? parameters["title"] : QString (""), this);
  ...
  // gl_image->setContentsMargins( 0, 0, 0, 0 ); gl_image->setSpacing( 0 );
  ...
  // setup frame for off screen imaging
  {
    ...
    lbl_f_title->setFont (QFont (USglobal->config_list.fontFamily,
    ...
    if (parameters.count ("as_pairs"))
      {
...
#endif
        f_thermo_top->setScale (1, pvaluepairs.size () ? pvaluepairs[0].size ()
                                                       : 1);
        ...
        f_thermo_top->setFont (QFont (USglobal->config_list.fontFamily,
    ...
    else
      {
        ...
        f_thermo_left->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 2));
...
#endif
  plot->setAxisFont (QwtPlot::yLeft,
                     QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
...
//    plot->setMargin(USglobal->config_list.margin);
  ...
  connect ((QWidget *)plot_cluster->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_cluster (const QPoint &)));
  ((QWidget *)plot_cluster->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_cluster->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_cluster (const QPoint &)));
  ((QWidget *)plot_cluster->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_cluster->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_cluster (const QPoint &)));
  ((QWidget *)plot_cluster->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
#if QT_VERSION < 0x040000
...
#if QT_VERSION < 0x040000
  plot_cluster->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  plot_cluster->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  plot_cluster_grid->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  plot_cluster_grid->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
...
#if QT_VERSION < 0x040000
  plot_cluster->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 3,
                                     QFont::Bold));
  plot_cluster->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_cluster->setAxisFont (QwtPlot::yLeft,
                             QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  plot_cluster->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_cluster->setAxisFont (QwtPlot::xBottom,
                             QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  plot_cluster->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_cluster->setAxisFont (QwtPlot::yRight,
                             QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  cb_adj->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 2));
  ...
  cb_hb->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 2));
  ...
  pb_sliding->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize + 1));
...
void
US_Hydrodyn_Saxs_Cormap::cancel ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Cormap::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Cormap::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Cormap::editor_msg (QString color, QString msg)
{
...
void
US_Hydrodyn_Saxs_Cormap::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
}
...
void
US_Hydrodyn_Saxs_Cormap::update_font ()
{
  bool ok;
  QFont newFont;
...
bool
US_Hydrodyn_Saxs_Cormap::streak_check (vector<int> &row1, vector<int> &row2,
                                       int &N, int &S, int &C, double &P)
{
...
void
US_Hydrodyn_Saxs_Cormap_Cluster_Analysis::cluster_expand (uhs_index_pair x)
{
  // check neighbors
  ...
  uhs_index_pair xp;
  {
    xp = x;
    xp.r++;
    if (cluster_data.count (xp) && !cluster_marked.count (xp)
        && cluster_data[xp] == -1)
      {
...
bool
US_Hydrodyn_Saxs_Cormap::cluster_analysis ()
{
  US_Hydrodyn_Saxs_Cormap_Cluster_Analysis ca;

  if (ca.run (pvaluepairs, parameters, csv_report, this))
    {
      ...
      if (ca.cluster_size_histogram.size ())
        {
          ...
          for (map<int, int>::iterator it = ca.cluster_size_histogram.begin ();
               it != ca.cluster_size_histogram.end (); ++it)
            {
          ...
          {
            int use_line_width = parameters.count ("linewidth")
                                     ? parameters["linewidth"].toInt ()
                                     : 1;
...
#if QT_VERSION < 0x040000
              plot_cluster->setCurvePen (
                  curve, QPen (Qt::red, 2 * use_line_width, Qt::SolidLine));
              plot_cluster->setCurveData (curve, (double *)&cluster_hist_x[0],
                                          (double *)&cluster_hist_y[0],
                                          cluster_hist_x.size ());
#else
              curve->setPen (
                  QPen (Qt::red, 2 * use_line_width, Qt::SolidLine));
              curve->setSamples ((double *)&cluster_hist_x[0],
                                 (double *)&cluster_hist_y[0],
                                 cluster_hist_x.size ());
            ...
            if (!plot_cluster_zoomer)
              {
                plot_cluster->setAxisScale (QwtPlot::xBottom,
                                            cluster_hist_x.front () - 1,
                                            cluster_hist_x.back () + 1);
                plot_cluster->setAxisScale (QwtPlot::yLeft, 0, max_y * 1.1);
                plot_cluster_zoomer
                    = new ScrollZoomer (plot_cluster->canvas ());
                plot_cluster_zoomer->setRubberBandPen (
                    QPen (Qt::yellow, 0, Qt::DotLine));
#if QT_VERSION < 0x040000
                plot_cluster_zoomer->setCursorLabelPen (QPen (Qt::yellow));
#endif
                // connect( plot_cluster_zoomer, SIGNAL( zoomed( const QRectF &
                // ) ), SLOT( plot_cluster_zoomed( const QRectF & ) ) );
              }
          }
        }
      else
...
void
US_Hydrodyn_Saxs_Cormap::sliding ()
{
  US_Hydrodyn_Saxs_Cormap_Cluster_Analysis ca;
...
bool
US_Hydrodyn_Saxs_Cormap_Cluster_Analysis::sliding (
    vector<vector<double> > &pvaluepairs, map<QString, QString> &parameters,
    map<QString, double> &sliding_results,
    map<QString, double> &hb_sliding_results, QWidget *parent,
    QProgressBar *progress)
{
  if (!parameters.count ("hb"))
    {
      if (!sliding (pvaluepairs, parameters, sliding_results, parent,
                    progress))
        {
          return false;
        }
      ...
      if (!sliding (pvaluepairs, parameters, hb_sliding_results, parent,
                    progress))
        {
          parameters.erase ("hb");
          return false;
  ...
  if (!sliding (pvaluepairs, parameters, sliding_results, parent, progress))
    {
...
US_Hydrodyn_Saxs_Cormap_Cluster_Analysis::sliding (
    vector<vector<double> > &pvaluepairs, map<QString, QString> &parameters,
    map<QString, double> &sliding_results, QWidget *parent,
    QProgressBar *progress)
{

  double alpha
      = parameters.count ("alpha") ? parameters["alpha"].toDouble () : 0.05;
  double alpha_over_5 = parameters.count ("alpha_over_5")
                            ? parameters["alpha_over_5"].toDouble ()
                            : 0.2 * alpha;

  // us_qdebug( QString( "sliding alpha %1 over5 %2" ).arg( alpha ).arg(
  // alpha_over_5 ) );
  ...
  if (pc != (int)pvaluepairs[0].size ())
    {
      errormsg = us_tr ("Internal error: cormap of brookes selected, but "
                        "pvaluepairs not square");
      if (parent)
        {
  ...
  int start_size = parameters.count ("sliding_minimum_size")
                       ? parameters["sliding_minimum_size"].toInt ()
                       : 10;

  if (start_size > pc)
    {
      errormsg = us_tr (
          "Brookes map sliding cluster analysis: too few frames for analysis");
      if (parent)
        {
          QMessageBox::warning (parent, parent->windowTitle (), errormsg);
        }
  ...
  int pos_base = parameters.count ("sliding_baseline_pos_base")
                     ? parameters["sliding_baseline_pos_base"].toInt ()
                     : 0;

  // build sub matricies of pvaluepairs and average red cluster size over

  int largest_window = parameters.count ("sliding_maximum_size")
                           ? parameters["sliding_maximum_size"].toInt ()
                           : pc;
  ...
  if (progress)
    {
      progress->setValue (0);
      progress->setMaximum (largest_window - start_size + 1);
    }

  QString save_alpha
      = parameters.count ("alpha") ? parameters["alpha"] : "0.05";
  ...
  for (int i = start_size; i <= largest_window; ++i)
    {
      ...
      for (int j = 0; j <= pc - i; ++j)
        {
          // us_qdebug( QString( "start sliding analysis size %1 pos %2" ).arg(
          // i ).arg( j ) );
          for (int k = 0; k < i; ++k)
            {
              for (int l = 0; l < i; ++l)
          ...
          if (parameters.count ("hb"))
            {
              ...
              parameters["alpha"] = QString ("%1").arg (
                  US_Saxs_Util::holm_bonferroni (P, alpha));
              parameters["alpha_over_5"] = QString ("%1").arg (
                  US_Saxs_Util::holm_bonferroni (P, alpha_over_5));
            }

          if (!run (sliding_window, parameters, csv_report, parent))
            {
              errormsg
                  = us_tr ("Brookes map sliding cluster analysis:") + errormsg;
              if (parent)
                {
          ...
          if (parameters.count ("sliding_baseline_mode"))
            {
              for (map<QString, QString>::iterator it = csv_report.begin ();
                   it != csv_report.end (); ++it)
                {
                  QString this_tag
                      = QString ("%1:").arg (pos_base + j) + it->first;
      ...
      if (!count)
        {
          errormsg = us_tr ("Brookes map sliding cluster analysis: internal "
                            "error count is zero?");
          if (parent)
            {
              QMessageBox::warning (parent, parent->windowTitle (), errormsg);
              ...
              if (count > 1)
                {
                  ...
                  sliding_results[this_tag2]
                      = sqrt (countm1inv
                              * (sliding_results[this_tag2]
                                 - countinv * sliding_results[this_tag]
                                       * sliding_results[this_tag]));
                }
              else
                {
...
bool
US_Hydrodyn_Saxs_Cormap_Cluster_Analysis::run (
    vector<vector<double> > &pvaluepairs, map<QString, QString> &parameters,
    map<QString, QString> &csv_report, QWidget *parent)
{
  double alpha
      = parameters.count ("alpha") ? parameters["alpha"].toDouble () : 0.05;
  double alpha_over_5 = parameters.count ("alpha_over_5")
  ...
  // us_qdebug( QString( "cca.run alpha %1 alpha_over_5 %2" ).arg( alpha ).arg(
  // alpha_over_5 ) );
  ...
  csv_report["% red pairs"] = QString ("").sprintf (
      "%.2f", hb_count_points
                  ? 100.0 * ((double)hb_count_red / (double)hb_count_points)
                  : 0e0);
          ...
          if (!cluster_marked.count (x) && cluster_data[x] == -1)
            {
              ...
              sum2_cluster_size
                  += (double)cluster_red.size () * (double)cluster_red.size ();
              if (area > 0)
                {
                  double this_cluster_size_pct
                      = 100.0 * (double)cluster_red.size () / area;
                  avg_cluster_size_pct += this_cluster_size_pct;
                  sum2_cluster_size_pct
                      += this_cluster_size_pct * this_cluster_size_pct;
                }
      ...
      if (cluster_sizes.size () > 2)
        {
          ...
          avg_cluster_size_sd
              = sqrt (countm1inv
                      * (sum2_cluster_size
                         - countinv * avg_cluster_size * avg_cluster_size));
          avg_cluster_size_pct_sd = sqrt (
              countm1inv
              * (sum2_cluster_size_pct
                 - countinv * avg_cluster_size_pct * avg_cluster_size_pct));
          if (avg_cluster_size > 0)
            {
              avg_cluster_size_sd_as_pct = 100.0 * avg_cluster_size_sd
  ...
  // build cluster report
  {
    ...
    int max_cluster_size
        = cluster_size_histogram.rbegin () != cluster_size_histogram.rend ()
              ? cluster_size_histogram.rbegin ()->first
              : 0;

    double avg_cluster_size_pct
        = area > 0 ? 100e0 * (double)avg_cluster_size / area : 0e0;

    double max_cluster_size_pct
        = area > 0 ? 100e0 * (double)max_cluster_size / area : 0e0;

    parameters["clusterheader"]
        = cluster_sizes.size ()
              ?
#if QT_VERSION < 0x050000
              QString (us_tr ("Red cluster count %1, average size %2 ±%3 %4, "
                              "average size as pct of total area %5\% ±%6\n"
#else
              QString (
                  us_tr ("Red cluster count %1, average size %2 \u00b1%3 %4, "
                         "average size as pct of total area %5\% \u00b1%6\n"
#endif
                  ...
                  .arg (avg_cluster_size > 0
                            ? QString ("").sprintf ("(%.1f%%)",
                                                    avg_cluster_size_sd_as_pct)
                            : QString (""))
                  ...
                  .arg (
                      max_cluster_size
                              && cluster_size_to_pos.count (max_cluster_size)
                          ? QString (us_tr (" has %1 occurrence%2 and "
                                            "%3begins at [%4,%5]"))
                                ...
                                .arg (cluster_size_histogram.rbegin ()->second
                                          ...
                                          ? "first occurrence "
                                          : "")
                                .arg (cluster_size_to_pos[max_cluster_size].r
                                      + 1)
                                .arg (cluster_size_to_pos[max_cluster_size].c
                                      + 1)
                          : QString (""))

              : QString (us_tr ("No red clusters found.\n"));

    csv_report["Red cluster size average"]
        = QString ("").sprintf ("%.3f", avg_cluster_size);
    csv_report["Red cluster size average sd"]
        = QString ("").sprintf ("%.3f", avg_cluster_size_sd);
    csv_report["Red cluster size average sd as pct"]
        = QString ("").sprintf ("%.3f", avg_cluster_size_sd_as_pct);
    csv_report["Red cluster size average as pct of total area"]
        = QString ("").sprintf ("%.3f", avg_cluster_size_pct);
    csv_report["Red cluster size average as pct of total area sd"]
        = QString ("").sprintf ("%.3f", avg_cluster_size_pct_sd);
    csv_report["Red cluster size maximum size"]
        = QString ("%1").arg (max_cluster_size);
    csv_report["Red cluster size maximum size as pct"]
        = QString ("").sprintf ("%.3f", max_cluster_size_pct);
  }
...
bool
US_Hydrodyn_Saxs_Cormap::big_green_box_analysis ()
{
...
void
US_Hydrodyn_Saxs_Cormap::save_csv ()
{
  // QMessageBox::warning(this,
  //                      windowTitle() + us_tr( " : Save" ),
  //                      us_tr( "Saving PVP analysis results is not currently
  //                      functional" ), QMessageBox::Ok |
  //                      QMessageBox::Default, QMessageBox::NoButton
  //                      );
  ...
  if (parameters.count ("name"))
    {
      use_dir += "/" + parameters["name"] + (cb_hb->isChecked () ? "_hb" : "")
                 + QString ("_a%1").arg (parameters.count ("alpha")
  ...
  use_filename
      = use_filename.replace (QRegExp (".csv$", Qt::CaseInsensitive), "");
  use_filename += ".csv";
  ...
  if (!f.open (QIODevice::WriteOnly))
    {
      QMessageBox::warning (
          this, windowTitle () + us_tr (" : Save CSV"),
  ...
  ts << "\"PVP Analysis\"" << Qt::endl;

  ts << QString ("\"P value matrix Rows, Columns:\",%1,%2")
            .arg (pvaluepairs.size ())
            .arg (pvaluepairs.size () ? pvaluepairs.front ().size () : 0)
     << Qt::endl;
  ...
  ts << "\"Parameter\",\"Value\"," << parameters.size () << Qt::endl;
...
US_Hydrodyn_Saxs_Cormap::load_csv ()
{
  ...
  if (load_csv (filename, parameters, pvaluepairs, adjpvaluepairs,
                selected_files, this))
    {
      us_qdebug ("load ok");
      displayData ();
...
bool
US_Hydrodyn_Saxs_Cormap::load_csv (QString filename,
                                   ...
                                   QWidget *parent)
{
  if (!QFile::exists (filename))
    {
      if (parent)
        {
          QMessageBox::warning (
              parent, parent->windowTitle () + us_tr (" : Load CSV file"),
      ...
      if (parent)
        {
          QMessageBox::warning (
              parent, parent->windowTitle () + us_tr (" : Load CSV file"),
              QString (us_tr ("The CSV file %1 is empty")).arg (filename));
        }
      return false;
    }
  ...
  if (qv[0] != "\"PVP Analysis\"")
    {
      if (parent)
        {
          QMessageBox::warning (
              parent, parent->windowTitle () + " : Load CSV file",
              QString (
                  us_tr (
                      "The CSV file %1 is not tagged as a PVP Analysis file"))
                  .arg (filename));
        }
      return false;
    }
  ...
  // US_Vector::printvector2( "new_pvaluepairs 0,1", new_pvaluepairs[ 0 ],
  // new_pvaluepairs[ 1 ] );
    ...
    for (int i = 0; i < params; ++i)
      {
        ...
        new_parameters[qsl[0]]
            = qsl[1].replace ("__cr__", "\n").replace ("__dqt__", "\"");
        // cout << QString( "qsl before replace\n----\n%1\n-----\n
        // after\n%2\n----\n" ).arg( qsl[ 1 ] ).arg( qsl[ 1 ].replace(
        // "__cr__", "\n" ) ) << endl;
      }
  }
...
void
US_Hydrodyn_Saxs_Cormap::csv_corrupt_msg (QString file, int line,
                                          QWidget *parent)
{
  if (parent)
    {
      QMessageBox::warning (parent,
                            ...
                            QString (us_tr ("The CSV file %1 line %2: ended "
                                            "permaturely or is corrupted"))
                                .arg (file)
                                .arg (line + 1));
    }
}
...
void
US_Hydrodyn_Saxs_Cormap::displayData ()
{
  ...
  cb_adj->setChecked (parameters.count ("adjusted")
                      && !parameters.count ("hide_adjpvalues"));
  cb_hb->setChecked (parameters.count ("hb")
                     && !parameters.count ("hide_hb_pvalues"));

  editor->clear ();
  plot->detachItems (QwtPlotItem::Rtti_PlotCurve);
  plot->detachItems (QwtPlotItem::Rtti_PlotMarker);
  ;
  plot_cluster->detachItems (QwtPlotItem::Rtti_PlotCurve);
  plot_cluster->detachItems (QwtPlotItem::Rtti_PlotMarker);
  ;
  ...
  csv_headers << (parameters.count ("csv_id_header")
                      ? parameters["csv_id_header"]
                      : QString (""))
  ...
  if (parameters.count ("save_png"))
    {
      ...
      csv_report["Image file"]
          = "\"" + QFileInfo (parameters["save_png"]).fileName () + "\"";
    }

  csv_report[parameters.count ("csv_id_header") ? parameters["csv_id_header"]
                                                : QString ("")]
      = parameters.count ("csv_id_data") ? parameters["csv_id_data"]
                                         : QString ("");

  int sfs = (int)selected_files.size ();

  QString fileheader
      = parameters.count ("fileheader") ? parameters["fileheader"] : "Name";
  ...
  if (parameters.count ("as_pairs"))
    {
      ...
      if (pvaluepairs.size ())
        {
          int use_height = parameters["as_pairs"].toInt () > 0
                               ? parameters["as_pairs"].toInt ()
                               : 1;
          lbl_image->setMinimumHeight (use_height > 100 ? use_height : 100);
      ...
      msg += QString ("").sprintf (
          ...
          tot_c_pct * (double)green_c, tot_c_pct * (double)yellow_c,
      ...
      msg_headers += "\n";
      csv_report["Red points pct"]
          = QString ("").sprintf ("%.2f", tot_c_pct * (double)red_c);
    }
  else
    {
      int green_c = 0;
      ...
      if (cb_hb->isChecked ())
        {
          pvdefmsg
              = QString (
                    ...
                    "  P is the pairwise P value as determined by a PVP "
                    "analysis\n"
                    "  Green corresponds to              P >= %2\n"
                    "  Yellow corresponds to %3 > P >= %4\n"
                    "  Red corresponds to    %5 > P\n")
      ...
      if (!parameters.count ("hide_adjpvalues"))
        {
          msg += QString ("").sprintf (
              ...
              tot_c_pct * (double)adj_yellow_c, tot_c_pct * (double)adj_red_c);
        }
      else
        {
          ...
          if (parameters.count ("hb"))
            {
              msg += QString ("").sprintf (
                  ...
                  // "Yellow HB P value cutoff %.3g Red HB P value cutoff
                  // %.3g\n"
                  " %5.1f%% green (%.1f%%) + yellow (%.1f%%) pairs\n"
                  " %5.1f%% red pairs\n"
                  // ,hb_alpha
      ...
      if (pc != (int)pvaluepairs[0].size ())
        {
          QMessageBox::warning (
              this, windowTitle (),
              us_tr ("Internal error: cormap of brookes selected, but "
                     "pvaluepairs not square"));
        }
      else
        {
                  ...
                  if (i != j)
                    {
                      rows[i].push_back (
                          i == j
                              ? 0
                              : (pvaluepairs[i][j] >= alpha_over_5 ? 1 : -1));
                    }
                }
          ...
          for (int i = 0; !bad_streak && i < pc; ++i)
            {
              ...
              if (!streak_check (row0, rows[i], N, S, C, P))
                {
                  ...
                  QMessageBox::warning (
                      this, windowTitle (),
                      QString (us_tr ("Internal error: cormap of brookes got "
                                      "cormap error %1"))
              ...
              cobreport
                  += QString ("%1\t %2\t %2\t %4\%\n")
                         .arg (i + 1, -7)
                         .arg (
                             QString ("").sprintf ("%.4f", P).rightJustified (
                                 12))
                         .arg (C, 6)
                         .arg (QString ("")
                                   .sprintf ("%3.2f", red_pct)
                                   .rightJustified (12));
            }
          ...
          if (pc > 2)
            {
              ...
              double pct_red_sd = sqrt (
                  countm1inv
                  * (sum2_pctred - countinv * avg_pctred * avg_pctred));
              double P_sd
                  = sqrt (countm1inv * (sum2_P - countinv * avg_P * avg_P));
...
#if QT_VERSION < 0x050000
              cobheader
                  += QString ("Contiguous red points P value average %1 ±%2\n")
#else
              cobheader
                  += QString (
                         "Contiguous red points P value average %1 \u00b1%2\n")
#endif
...
#if QT_VERSION < 0x050000
              cobheader
                  += QString ("Contiguous red points average %1\% ±%2 %3 "
                              "maximum %4\%\n")
#else
              cobheader
                  += QString ("Contiguous red points average %1\% \u00b1%2 %3 "
              ...
              csv_report["Red contiguous points average P value"]
                  = QString ("").sprintf ("%.6f", avg_P);
              csv_report["Red contiguous points average P value sd"]
                  = QString ("").sprintf ("%.6f", P_sd);

              csv_report["Red contiguous points average pct"]
                  = QString ("").sprintf ("%.2f", avg_pctred);
              csv_report["Red contiguous points maximum pct"]
                  = QString ("").sprintf ("%.2f", max_pctred);
            }
        }
    }
  ...
  if (parameters.count ("linewisesummary"))
    {
      ...
      if (sfs != (int)pvaluepairs.size ()
        ...
        {
          msg += QString ("Internal error, cormap utility can't compute "
                          "linewise summary %1 != %2 or !%3\n")
                     .arg (sfs)
      ...
      else
        {
          ...
          double use_alpha_over_5
              = cb_hb->isChecked () ? hb_alpha_over_5 : alpha_over_5;
          ...
          if (sfs > 2)
            {
              ...
              avgP_sd = sqrt (countm1inv
                              * (sum2_avgP - countinv * avg_avgP * avg_avgP));
              pct_red_sd = sqrt (
                  countm1inv
                  * (sum2_pct_red - countinv * avg_pct_red * avg_pct_red));

              avg_avgP *= countinv;
              avg_pct_red *= countinv;

#if QT_VERSION < 0x050000
              msg += QString ("\nAverage one-to-all P value %1 ±%2 %3 \% red "
                              "%4\% ±%5 %6\n")
#else
              msg += QString ("\nAverage one-to-all P value %1 \u00b1%2 %3 \% "
                              "red %4\% \u00b1%5 %6\n")
#endif
                         .arg (QString ("").sprintf ("%.4g", avg_avgP))
                         .arg (QString ("").sprintf ("%.4g", avgP_sd))
                         .arg (avg_avgP > 0 ? QString ("").sprintf (
                                                  "(%.1f%%)",
                                                  100.0 * avgP_sd / avg_avgP)
                                            : QString (""))
                         ...
                         .arg (avg_pct_red > 0
                                   ...
                                   : QString (""))
                     + cobheader
                     + (parameters.count ("clusterheader")
                            ? parameters["clusterheader"]
                            : "")
                     + cobreport + linereport;
              ...
              csv_report["Average one-to-all P value"]
                  = QString ("").sprintf ("%.4g", avg_avgP);
              csv_report["Average one-to-all P value sd"]
                  = QString ("").sprintf ("%.4g", avgP_sd);
            }
          else
            {
              avg_avgP *= countinv;
...

          {
...

            {
              ...
              plot->setCurvePen (
                  curve, QPen (Qt::red, 2 * use_line_width, Qt::SolidLine));
              plot->setCurveData (curve, (double *)&plot_pos[0],
                                  (double *)&plot_redpct[0], plot_pos.size ());
#else
              curve->setPen (
                  QPen (Qt::red, 2 * use_line_width, Qt::SolidLine));
              curve->setSamples ((double *)&plot_pos[0],
                                 (double *)&plot_redpct[0], plot_pos.size ());
              curve->attach (plot);
#endif
            }
...
#if QT_VERSION < 0x040000
                plot->setCurvePen (
                    curve, QPen (Qt::green, use_line_width, Qt::DotLine));
...
#if QT_VERSION < 0x040000
                    plot->setCurvePen (
                        curve, QPen (Qt::yellow, use_line_width, Qt::DotLine));
                    plot->setCurveData (curve, x, y, 2);
#else
                    curve->setPen (
                        QPen (Qt::yellow, use_line_width, Qt::DotLine));
                    curve->setSamples (x, y, 2);
                    curve->attach (plot);
#endif
                  }
      ...
      for (int i = 0; i < (int)csv_headers.size (); ++i)
        {
          ...
          ((US_Hydrodyn *)us_hydrodyn)
              ->data_csv[csv_headers[i]][parameters["data_csv"]]
              ...
              if (parameters.count ("clusteranalysis"))
                {
                  ...
                  plot_geom.setWidth (
                      (parameters["global_width"].toInt () - 20) / 4);
                  plot->setGeometry (plot_geom);
                  QRect plot_cluster_geom = plot->geometry ();
                  plot_cluster_geom.setWidth (
                      (parameters["global_width"].toInt () - 20) / 4);
                  plot_cluster->setGeometry (plot_geom);

                  // plot->setMaximumWidth( ( parameters[ "global_width"
                  // ].toInt() - 20 ) / 4 ); plot->setMinimumWidth( (
                  // parameters[ "global_width" ].toInt() - 20 ) / 4 );
                  // plot_cluster->setMaximumWidth( ( parameters[
                  // "global_width" ].toInt() - 20 ) / 4 );
                  // plot_cluster->setMinimumWidth( ( parameters[
                  // "global_width" ].toInt() - 20 ) / 4 );
                }
              else
                {
                  QRect plot_geom = plot->geometry ();
                  plot_geom.setWidth (
                      (parameters["global_width"].toInt () - 20) / 2);
                  plot->setGeometry (plot_geom);
                  // plot->setMaximumWidth( ( parameters[ "global_width"
                  // ].toInt() - 20 ) / 2 ); plot->setMinimumWidth( (
                  // parameters[ "global_width" ].toInt() - 20 ) / 2 );
                }
            }
        }
...
void
US_Hydrodyn_Saxs_Cormap::forceImageResized ()
{
  last_width = -1;
  if (cb_hb->isChecked ())
    {
...
void
US_Hydrodyn_Saxs_Cormap::imageResized ()
{
  // us_qdebug( QString( "image width %1 height %2" ).arg( lbl_image->width()
  // ).arg( lbl_image->height() ) ); us_qdebug( QString( "last use width %1
  // height %2" ).arg( last_width ).arg( last_height ) ); us_qdebug( QString(
  // "editor width %1 height %2" ).arg( editor->width() ).arg( editor->height()
  // ) );
  ...
  int avail_i_width
      = max_width - (f_thermo_left ? f_thermo_left->width () : 0);
  int avail_i_height
      = max_height - f_thermo_top->height () - lbl_f_title->height ();
  ...
  if (parameters.count ("as_pairs"))
    {
      ...
      int use_i_height
          = avail_i_height + f_thermo_top->height () + lbl_f_title->height ();

      if (use_i_width == last_width && use_i_height == last_height)
        {
          // us_qdebug( "skipped" );
          return;
        }
      ...
      {
        QPixmap pm;
        lbl_f_title->setText (parameters.count ("ppvm_title")
                                  ? parameters["ppvm_title"]
                                  : us_tr ("Pairwise P value map"));
        pm.convertFromImage (
#if QT_VERSION >= 0x040000
            qi->scaled (QSize (use_i_width, avail_i_height)
                        // ,  Qt::KeepAspectRatio
                        )
#else
            qi->smoothScale (use_i_width, avail_i_height)
#endif
        );
        lbl_f_image->setPixmap (pm);
      }
  ...
  int avail_i
      = avail_i_height > avail_i_width ? avail_i_width : avail_i_height;

  int use_i_width = avail_i + (f_thermo_left ? f_thermo_left->width () : 0);
  int use_i_height
      = avail_i + f_thermo_top->height () + lbl_f_title->height ();
  ...
  // us_qdebug( QString( "use_i width %1 height %2" ).arg( use_i_height ).arg(
  // use_i_width ) ); us_qdebug( QString( "lbl_f_image width %1 height %2"
  // ).arg( lbl_f_image->width() ).arg( lbl_f_image->height() ) );
    ...
    if (parameters.count ("as_pairs"))
      {
        ...
        pm.convertFromImage (
#if QT_VERSION >= 0x040000
            qi->scaled (QSize (lbl_f_image->width (), lbl_f_image->height ())
                        // ,  Qt::KeepAspectRatio
                        )
#else
            qi->smoothScale (lbl_f_image->width (), lbl_f_image->height ())
#endif
        );
      }
    else
        ...
        if (cb_adj->isChecked ())
          {
            ...
            pm.convertFromImage (
#if QT_VERSION >= 0x040000
                qi_adj->scaled (QSize (avail_i, avail_i), Qt::KeepAspectRatio)
#else
                qi_adj->smoothScale (avail_i, avail_i
                                     // ,lbl_f_image->width()
                                     // ,lbl_f_image->height()
                                     // ,QImage::ScaleMin
                                     )
            ...
            if (cb_hb->isChecked ())
              {
                ...
                pm.convertFromImage (
#if QT_VERSION >= 0x040000
                    qi_hb->scaled (QSize (avail_i, avail_i),
                                   Qt::KeepAspectRatio)
#else
                    qi_hb->smoothScale (avail_i, avail_i
                                        // ,lbl_f_image->width()
                                        // ,lbl_f_image->height()
                                        // ,QImage::ScaleMin
                                        )
            ...
            else
              {
                ...
                pm.convertFromImage (
#if QT_VERSION >= 0x040000
                    qi->scaled (QSize (avail_i, avail_i), Qt::KeepAspectRatio)
#else
                    qi->smoothScale (avail_i, avail_i
                                     // ,lbl_f_image->width()
                                     // ,lbl_f_image->height()
                                     // ,QImage::ScaleMin
                                     )
...
#endif
  {
    ...
    pm.convertFromImage (
#if QT_VERSION >= 0x040000
        qi.scaled (QSize (use_i_width, use_i_height), Qt::KeepAspectRatio)
#else
        qi.smoothScale (use_i_width, use_i_height, Qt::KeepAspectRatio)
#endif
    );
    if (org_geom != geometry ())
      {
...
void
US_Hydrodyn_Saxs_Cormap::usp_config_plot (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Cormap::usp_config_plot_cluster (const QPoint &)
{
