...
mals_stack_data
US_Hydrodyn_Mals::current_data (bool selected_only)
{
...
void
US_Hydrodyn_Mals::stack_push_all ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals::stack_push_sel ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals::set_current_data (mals_stack_data &tmp_stack)
{
  lb_files->clear ();
...
void
US_Hydrodyn_Mals::stack_rot_down ()
{
  vector<mals_stack_data> new_stack;
...
void
US_Hydrodyn_Mals::stack_join ()
{
  stack_join (stack_data.back ());
}

void
US_Hydrodyn_Mals::stack_join (mals_stack_data &tmp_stack)
{
