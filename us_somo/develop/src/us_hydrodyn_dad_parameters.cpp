...
void
US_Hydrodyn_Dad_Parameters::setupGUI ()
{
  int minHeight1 = 30;

  lbl_title = new QLabel (
      us_tr ("US-SOMO: UV-Vis : UV-Vis Processing Parameters"), this);
  ...
  lbl_dad_param_desc->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  lbl_dad_param_desc->setMinimumHeight (minHeight1);

  le_dad_param_desc = new QLineEdit (this);
  le_dad_param_desc->setObjectName ("le_dad_param_desc Line Edit");
  ...
  le_dad_param_desc->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  connect (le_dad_param_desc, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_desc (const QString &)));
  ...
  lbl_dad_param_lambda->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  lbl_dad_param_lambda->setMinimumHeight (minHeight1);

  le_dad_param_lambda = new QLineEdit (this);
  le_dad_param_lambda->setObjectName ("le_dad_param_lambda Line Edit");
  ...
  le_dad_param_lambda->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (400, 600, 1, le_dad_param_lambda);
    le_dad_param_lambda->setValidator (qdv);
  }
  connect (le_dad_param_lambda, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_lambda (const QString &)));
...
#warning might need to bring disable lambda change back
  ...
  //    le_dad_param_lambda->setToolTip( us_tr( "Files are loaded so this value
  //    can not be adjusted" ) ); lbl_dad_param_lambda->setToolTip( us_tr(
  //    "Files are loaded so this value can not be adjusted" ) );
  // }
  ...
  lbl_dad_param_n->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  lbl_dad_param_n->setMinimumHeight (minHeight1);

  le_dad_param_n = new QLineEdit (this);
  le_dad_param_n->setObjectName ("le_dad_param_n Line Edit");
  ...
  le_dad_param_n->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 5, 4, le_dad_param_n);
    le_dad_param_n->setValidator (qdv);
  }
  connect (le_dad_param_n, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_n (const QString &)));
  ...
  if (((US_Hydrodyn_Dad *)us_hydrodyn_dad)->lb_files->count () > 0)
    {
      ...
      le_dad_param_n->setToolTip (
          us_tr ("Files are loaded so this value can not be adjusted"));
      lbl_dad_param_n->setToolTip (
          us_tr ("Files are loaded so this value can not be adjusted"));
    }
  ...
  lbl_dad_param_g_dndc->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  lbl_dad_param_g_dndc->setMinimumHeight (minHeight1);

  le_dad_param_g_dndc = new QLineEdit (this);
  le_dad_param_g_dndc->setObjectName ("le_dad_param_g_dndc Line Edit");
  ...
  le_dad_param_g_dndc->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 1, 5, le_dad_param_g_dndc);
    le_dad_param_g_dndc->setValidator (qdv);
  }
  connect (le_dad_param_g_dndc, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_g_dndc (const QString &)));
  le_dad_param_g_dndc->setMinimumWidth (200);
  le_dad_param_g_dndc->setMinimumHeight (minHeight1);

  lbl_dad_param_g_extinction_coef
      = new QLabel (us_tr ("Extinction coefficient [mL mg^-1 cm^-1]: "), this);
  lbl_dad_param_g_extinction_coef->setAlignment (Qt::AlignLeft
                                                 | Qt::AlignVCenter);
  lbl_dad_param_g_extinction_coef->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_dad_param_g_extinction_coef);
  lbl_dad_param_g_extinction_coef->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_dad_param_g_extinction_coef->setMinimumHeight (minHeight1);

  le_dad_param_g_extinction_coef = new QLineEdit (this);
  le_dad_param_g_extinction_coef->setObjectName (
      "le_dad_param_g_extinction_coef Line Edit");
  le_dad_param_g_extinction_coef->setText (
      (*parameters)["dad_param_g_extinction_coef"]);
  le_dad_param_g_extinction_coef->setAlignment (Qt::AlignCenter
                                                | Qt::AlignVCenter);
  le_dad_param_g_extinction_coef->setPalette (PALET_NORMAL);
  AUTFBACK (le_dad_param_g_extinction_coef);
  le_dad_param_g_extinction_coef->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 1, 5, le_dad_param_g_extinction_coef);
    le_dad_param_g_extinction_coef->setValidator (qdv);
  }
  connect (le_dad_param_g_extinction_coef,
           SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_g_extinction_coef (const QString &)));
  ...
  lbl_dad_param_g_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  lbl_dad_param_g_conc->setMinimumHeight (minHeight1);

  le_dad_param_g_conc = new QLineEdit (this);
  le_dad_param_g_conc->setObjectName ("le_dad_param_g_conc Line Edit");
  ...
  le_dad_param_g_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 9, 5, le_dad_param_g_conc);
    le_dad_param_g_conc->setValidator (qdv);
  }
  connect (le_dad_param_g_conc, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_g_conc (const QString &)));
  ...
  lbl_dad_param_DLS_detector->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  lbl_dad_param_DLS_detector->setMinimumHeight (minHeight1);

  le_dad_param_DLS_detector = new QLineEdit (this);
  le_dad_param_DLS_detector->setObjectName (
      "le_dad_param_DLS_detector Line Edit");
  ...
  le_dad_param_DLS_detector->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator (1, 99, le_dad_param_DLS_detector);
    le_dad_param_DLS_detector->setValidator (qdv);
  }
  connect (le_dad_param_DLS_detector, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_DLS_detector (const QString &)));
  le_dad_param_DLS_detector->setMinimumWidth (200);
  le_dad_param_DLS_detector->setMinimumHeight (minHeight1);

  lbl_lambda_dependence_coeff = new QLabel (
      us_tr (UNICODE_LAMBDA_QS + "-dependence coefficients:"), this);
  lbl_lambda_dependence_coeff->setAlignment (Qt::AlignCenter
                                             | Qt::AlignVCenter);
  ...
  lbl_lambda_dependence_coeff->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize + 1, QFont::Bold));

  lbl_dad_param_dndc2_a = new QLabel (
      us_tr ("[[dn/dc](" + UNICODE_LAMBDA_QS + ")]^0.5 coeff. A: "), this);
  ...
  lbl_dad_param_dndc2_a->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  lbl_dad_param_dndc2_a->setMinimumHeight (minHeight1);

  le_dad_param_dndc2_a = new QLineEdit (this);
  le_dad_param_dndc2_a->setObjectName ("le_dad_param_dndc2_a Line Edit");
  ...
  le_dad_param_dndc2_a->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 9, 5, le_dad_param_dndc2_a);
    le_dad_param_dndc2_a->setValidator (qdv);
  }
  connect (le_dad_param_dndc2_a, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_dndc2_a (const QString &)));
  le_dad_param_dndc2_a->setMinimumWidth (200);
  le_dad_param_dndc2_a->setMinimumHeight (minHeight1);

  lbl_dad_param_dndc2_b = new QLabel (
      us_tr ("[[dn/dc](" + UNICODE_LAMBDA_QS + ")]^0.5 coeff. B: "), this);
  ...
  lbl_dad_param_dndc2_b->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  lbl_dad_param_dndc2_b->setMinimumHeight (minHeight1);

  le_dad_param_dndc2_b = new QLineEdit (this);
  le_dad_param_dndc2_b->setObjectName ("le_dad_param_dndc2_b Line Edit");
  ...
  le_dad_param_dndc2_b->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 9, 5, le_dad_param_dndc2_b);
    le_dad_param_dndc2_b->setValidator (qdv);
  }
  connect (le_dad_param_dndc2_b, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_dndc2_b (const QString &)));
  le_dad_param_dndc2_b->setMinimumWidth (200);
  le_dad_param_dndc2_b->setMinimumHeight (minHeight1);

  lbl_dad_param_dndc2_c = new QLabel (
      us_tr ("[[dn/dc](" + UNICODE_LAMBDA_QS + ")]^0.5 coeff. C: "), this);
  ...
  lbl_dad_param_dndc2_c->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  lbl_dad_param_dndc2_c->setMinimumHeight (minHeight1);

  le_dad_param_dndc2_c = new QLineEdit (this);
  le_dad_param_dndc2_c->setObjectName ("le_dad_param_dndc2_c Line Edit");
  ...
  le_dad_param_dndc2_c->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0, 9, 5, le_dad_param_dndc2_c);
    le_dad_param_dndc2_c->setValidator (qdv);
  }
  connect (le_dad_param_dndc2_c, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_dndc2_c (const QString &)));
  le_dad_param_dndc2_c->setMinimumWidth (200);
  le_dad_param_dndc2_c->setMinimumHeight (minHeight1);

  lbl_dad_param_n2_a = new QLabel (
      us_tr ("Refractive index [n(" + UNICODE_LAMBDA_QS + ")]^0.5 coeff. A: "),
      this);
  ...
  lbl_dad_param_n2_a->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  lbl_dad_param_n2_a->setMinimumHeight (minHeight1);

  le_dad_param_n2_a = new QLineEdit (this);
  le_dad_param_n2_a->setObjectName ("le_dad_param_n2_a Line Edit");
  ...
  le_dad_param_n2_a->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 9, 5, le_dad_param_n2_a);
    le_dad_param_n2_a->setValidator (qdv);
  }
  connect (le_dad_param_n2_a, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_n2_a (const QString &)));
  le_dad_param_n2_a->setMinimumWidth (200);
  le_dad_param_n2_a->setMinimumHeight (minHeight1);

  lbl_dad_param_n2_b = new QLabel (
      us_tr ("Refractive index [n(" + UNICODE_LAMBDA_QS + ")]^0.5 coeff. B: "),
      this);
  ...
  lbl_dad_param_n2_b->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  lbl_dad_param_n2_b->setMinimumHeight (minHeight1);

  le_dad_param_n2_b = new QLineEdit (this);
  le_dad_param_n2_b->setObjectName ("le_dad_param_n2_b Line Edit");
  ...
  le_dad_param_n2_b->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 9, 5, le_dad_param_n2_b);
    le_dad_param_n2_b->setValidator (qdv);
  }
  connect (le_dad_param_n2_b, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_n2_b (const QString &)));
  le_dad_param_n2_b->setMinimumWidth (200);
  le_dad_param_n2_b->setMinimumHeight (minHeight1);

  lbl_dad_param_n2_c = new QLabel (
      us_tr ("Refractive index [n(" + UNICODE_LAMBDA_QS + ")]^0.5 coeff. C: "),
      this);
  ...
  lbl_dad_param_n2_c->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  lbl_dad_param_n2_c->setMinimumHeight (minHeight1);

  le_dad_param_n2_c = new QLineEdit (this);
  le_dad_param_n2_c->setObjectName ("le_dad_param_n2_c Line Edit");
  ...
  le_dad_param_n2_c->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (0, 9, 5, le_dad_param_n2_c);
    le_dad_param_n2_c->setValidator (qdv);
  }
  connect (le_dad_param_n2_c, SIGNAL (textChanged (const QString &)),
           SLOT (set_dad_param_n2_c (const QString &)));
  ...
  always_hide_widgets.insert (
      { lbl_dad_param_n, le_dad_param_n, lbl_dad_param_g_dndc,
        le_dad_param_g_dndc, lbl_dad_param_g_conc, le_dad_param_g_conc,
        lbl_dad_param_DLS_detector, le_dad_param_DLS_detector });

  ShowHide::hide_widgets (always_hide_widgets);
}

void
US_Hydrodyn_Dad_Parameters::quit ()
{
  close ();
}

void
US_Hydrodyn_Dad_Parameters::save ()
{
  ...
  QString fn = QFileDialog::getSaveFileName (
      this, us_tr ("Select a name to save the UV-Vis parameters"), use_dir,
      "*_uv_vis_param.dat");
  ...
  if (!le_dad_param_desc->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_desc: " << le_dad_param_desc->text ()
         << Qt::endl;
    }

  if (!le_dad_param_lambda->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_lambda: " << le_dad_param_lambda->text ()
         << Qt::endl;
    }
  ...
  if (!le_dad_param_g_dndc->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_g_dndc: " << le_dad_param_g_dndc->text ()
         << Qt::endl;
    }
  if (!le_dad_param_g_extinction_coef->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_g_extinction_coef: "
         << le_dad_param_g_extinction_coef->text () << Qt::endl;
    }

  if (!le_dad_param_g_conc->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_g_conc: " << le_dad_param_g_conc->text ()
         << Qt::endl;
    }

  if (!le_dad_param_DLS_detector->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_DLS_detector: "
         << le_dad_param_DLS_detector->text () << Qt::endl;
    }

  if (!le_dad_param_dndc2_a->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_dndc2_a: " << le_dad_param_dndc2_a->text ()
         << Qt::endl;
    }

  if (!le_dad_param_dndc2_b->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_dndc2_b: " << le_dad_param_dndc2_b->text ()
         << Qt::endl;
    }

  if (!le_dad_param_dndc2_c->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_dndc2_c: " << le_dad_param_dndc2_c->text ()
         << Qt::endl;
    }

  if (!le_dad_param_n2_a->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_n2_a: " << le_dad_param_n2_a->text ()
         << Qt::endl;
    }

  if (!le_dad_param_n2_b->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_n2_b: " << le_dad_param_n2_b->text ()
         << Qt::endl;
    }

  if (!le_dad_param_n2_c->text ().isEmpty ())
    {
      ts << "# __uv_vis_param_n2_c: " << le_dad_param_n2_c->text ()
         << Qt::endl;
    }
...
void
US_Hydrodyn_Dad_Parameters::load ()
{
  // alternatively, could use dad_win->load()
  // remove some code duplication, but would require friending class & saving &
  // restoring params in case user did not "keep" could also have some
  // unintended side-effects - if they load a different file
  ...
  QString filename = QFileDialog::getOpenFileName (
      this, us_tr ("Load UV-Vis parameter file"), use_dir,
      ...
      if (qv[0].contains (" UV-Vis parameter file"))
        {
          ...
          QRegExp rx_dad_param_lambda (
              "^# __uv_vis_param_lambda: (\\S+)\\s*$");
          QRegExp rx_dad_param_n ("^# __uv_vis_param_n: (\\S+)\\s*$");
          QRegExp rx_dad_param_g_dndc (
              "^# __uv_vis_param_g_dndc: (\\S+)\\s*$");
          QRegExp rx_dad_param_g_extinction_coef (
              "^# __uv_vis_param_g_extinction_coef: (\\S+)\\s*$");
          QRegExp rx_dad_param_g_conc (
              "^# __uv_vis_param_g_conc: (\\S+)\\s*$");
          QRegExp rx_dad_param_DLS_detector (
              "^# __uv_vis_param_DLS_detector: (\\S+)\\s*$");
          QRegExp rx_dad_param_dndc2_a (
              "^# __uv_vis_param_dndc2_a: (\\S+)\\s*$");
          QRegExp rx_dad_param_dndc2_b (
              "^# __uv_vis_param_dndc2_b: (\\S+)\\s*$");
          QRegExp rx_dad_param_dndc2_c (
              "^# __uv_vis_param_dndc2_c: (\\S+)\\s*$");
          ...
          for (int i = 1; i < (int)qv.size (); i++)
            {
              ...
              if (rx_dad_param_g_extinction_coef.indexIn (qv[i]) != -1)
                {
                  le_dad_param_g_extinction_coef->setText (
                      rx_dad_param_g_extinction_coef.cap (1));
                  continue;
                }
              ...
              if (rx_dad_param_DLS_detector.indexIn (qv[i]) != -1)
                {
                  le_dad_param_DLS_detector->setText (
                      rx_dad_param_DLS_detector.cap (1));
                  continue;
                }
...
void
US_Hydrodyn_Dad_Parameters::keep ()
{
  (*parameters)["keep"] = "set";
  close ();
}
...
void
US_Hydrodyn_Dad_Parameters::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Dad_Parameters::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Dad_Parameters::set_dad_param_desc (const QString &text)
{
  (*parameters)["dad_param_desc"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_lambda (const QString &text)
{
  (*parameters)["dad_param_lambda"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_n (const QString &text)
{
  (*parameters)["dad_param_n"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_g_dndc (const QString &text)
{
  (*parameters)["dad_param_g_dndc"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_g_extinction_coef (
    const QString &text)
{
...
void
US_Hydrodyn_Dad_Parameters::set_dad_param_g_conc (const QString &text)
{
  (*parameters)["dad_param_g_conc"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_DLS_detector (const QString &text)
{
  (*parameters)["dad_param_DLS_detector"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_dndc2_a (const QString &text)
{
  (*parameters)["dad_param_dndc2_a"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_dndc2_b (const QString &text)
{
  (*parameters)["dad_param_dndc2_b"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_dndc2_c (const QString &text)
{
  (*parameters)["dad_param_dndc2_c"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_n2_a (const QString &text)
{
  (*parameters)["dad_param_n2_a"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_n2_b (const QString &text)
{
  (*parameters)["dad_param_n2_b"] = text;
}

void
US_Hydrodyn_Dad_Parameters::set_dad_param_n2_c (const QString &text)
{
