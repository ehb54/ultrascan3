...
void US_Hydrodyn_Dad_Parameters::setupGUI() {
  ...
  lbl_title =
      new QLabel(us_tr("US-SOMO: UV-Vis : UV-Vis Processing Parameters"), this);
...
#warning might need to bring disable lambda change back
  ...
  lbl_dad_param_g_extinction_coef->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_dad_param_g_extinction_coef->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv =
  ...
  connect(le_dad_param_g_extinction_coef, SIGNAL(textChanged(const QString &)),
  ...
  lbl_dad_param_DLS_detector->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_dad_param_DLS_detector->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
  ...
  lbl_lambda_dependence_coeff =
      new QLabel(us_tr(UNICODE_LAMBDA_QS + "-dependence coefficients:"), this);
  ...
  lbl_lambda_dependence_coeff->setFont(QFont(USglobal->config_list.fontFamily,
...
void US_Hydrodyn_Dad_Parameters::quit() { close(); }
...
void US_Hydrodyn_Dad_Parameters::save() {
  ...
  if (!le_dad_param_DLS_detector->text().isEmpty()) {
    ts << "# __uv_vis_param_DLS_detector: " << le_dad_param_DLS_detector->text()
       << Qt::endl;
  }
...
void US_Hydrodyn_Dad_Parameters::set_dad_param_g_extinction_coef(
    const QString &text) {
...
void US_Hydrodyn_Dad_Parameters::set_dad_param_DLS_detector(
    const QString &text) {
