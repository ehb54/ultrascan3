...
void
US_Hydrodyn_Dad::invert_all_created ()
{
  disable_all ();
...
void
US_Hydrodyn_Dad::remove_created ()
{
  disable_all ();
  QStringList files;
...
bool
US_Hydrodyn_Dad::all_have_f_gaussians (QStringList &files)
{
...
US_Hydrodyn_Dad::p3d ()
{
...

  {
    ...
    US_Hydrodyn_Dad_P3d *dad_p3d
        = new US_Hydrodyn_Dad_P3d (this, &parameters, this);
...
US_Hydrodyn_Dad::set_detector ()
{
...

  {
    ...
    US_Hydrodyn_Dad_Dctr *dad_dctr
        = new US_Hydrodyn_Dad_Dctr (this, &parameters, this);
...
bool
US_Hydrodyn_Dad::height_wheel_file (double &val, double pos)
{
...
void
US_Hydrodyn_Dad::gauss_match_amplitude ()
{
  if (current_mode != MODE_GAUSSIAN)
    {
      return;
...
bool
US_Hydrodyn_Dad::opt_repeak_gaussians (QString file)
{
  if (!gaussians.size ())
    {
      return false;
...
vector<double>
US_Hydrodyn_Dad::conc_curve (vector<double> &t, unsigned int peak, double conv)
{
...
bool
US_Hydrodyn_Dad::adjacent_ok (QString name)
{
...
void
US_Hydrodyn_Dad::adjacent_created ()
{
  QString match_name;
  int match_pos = 0;
  QStringList turn_on;
...
bool
US_Hydrodyn_Dad::adjacent_select (QListWidget *lb, QString match)
{
  bool ok;
...
QString
US_Hydrodyn_Dad::select_conc_file (QString tag)
{
...
void
US_Hydrodyn_Dad::repeak (QStringList files)
{
...
QStringList
US_Hydrodyn_Dad::get_frames (QStringList files, QString head, QString tail)
{
  QStringList result;
...
void
US_Hydrodyn_Dad::avg (QStringList files, QString suffix)
{
  ...
  if (all_nonzero_errors)
  ...
  else
    {
      ...
      editor_msg ("darkblue",
                  "computing standard deviations from the values themselves");
...
void
US_Hydrodyn_Dad::conc_avg (QStringList files)
{
  // create average of selected
  vector<QString> avg_qs_string;
  vector<double> avg_qs;
...
US_Hydrodyn_Dad::select_nth ()
{
  ...
  US_Hydrodyn_Dad_Nth *dad_nth
      = new US_Hydrodyn_Dad_Nth (this, &parameters, this);
...
void
US_Hydrodyn_Dad::axis_y (bool nochange, bool no_replot)
{
...
void
US_Hydrodyn_Dad::axis_x (bool nochange, bool no_replot)
{
  if (!nochange)
    {
...
US_Hydrodyn_Dad::options ()
{
  ...
  parameters["dad_bl_linear"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_linear"];
  parameters["dad_bl_integral"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_integral"];
  parameters["dad_bl_save"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_save"];
  parameters["dad_bl_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_smooth"];
  parameters["dad_bl_start_region"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_start_region"];
  parameters["dad_bl_i_power"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_i_power"];
  parameters["dad_bl_reps"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_reps"];
  parameters["dad_bl_epsilon"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_epsilon"];
  parameters["dad_cormap_maxq"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cormap_maxq"];
  parameters["dad_cormap_alpha"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cormap_alpha"];
  parameters["dad_zi_window"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_zi_window"];
  parameters["dad_discard_it_sd_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_discard_it_sd_mult"];
  parameters["dad_cb_discard_it_sd_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_discard_it_sd_mult"];
  parameters["dad_guinier_qrgmax"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_guinier_qrgmax"];
  parameters["dad_cb_guinier_qrgmax"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_guinier_qrgmax"];
  parameters["dad_gg_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_gg_smooth"];
  parameters["dad_cb_gg_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_gg_smooth"];
  parameters["dad_cb_gg_cyclic"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_gg_cyclic"];
  parameters["dad_cb_gg_oldstyle"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_gg_oldstyle"];
  parameters["dad_dist_max"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_dist_max"];
  ...
  parameters["dad_ampl_width_min"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_ampl_width_min"];
  parameters["dad_lock_min_retry"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_lock_min_retry"];
  parameters["dad_lock_min_retry_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_lock_min_retry_mult"];
  parameters["dad_maxfpk_restart"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_maxfpk_restart"];
  parameters["dad_maxfpk_restart_tries"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_maxfpk_restart_tries"];
  parameters["dad_maxfpk_restart_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_maxfpk_restart_pct"];

  parameters["dad_makeiq_cutmax_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_makeiq_cutmax_pct"];
  parameters["dad_cb_makeiq_cutmax_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_makeiq_cutmax_pct"];
  parameters["dad_cb_makeiq_avg_peaks"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_makeiq_avg_peaks"];
  parameters["dad_makeiq_avg_peaks"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_makeiq_avg_peaks"];
  ...
  dad_options_widget = new US_Hydrodyn_Dad_Options (
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_linear"]
          != parameters["dad_bl_linear"]
      || ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_integral"]
             != parameters["dad_bl_integral"]
      || ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cormap_maxq"]
  ...
  cb_guinier_qrgmax->setChecked (parameters["dad_cb_guinier_qrgmax"]
                                 == "true");
...
void
US_Hydrodyn_Dad::clear_gaussians ()
{
  unified_ggaussian_ok = false;
  f_gaussians.clear ();
  gaussians.clear ();
...
US_Hydrodyn_Dad::hide_files ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_files_widgets"]
      = files_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Dad::hide_created_files ()
{
  if (U_EXPT)
    {
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_created_files_widgets"]
      = created_files_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Dad::hide_editor ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_editor_widgets"]
...
US_Hydrodyn_Dad::svd ()
{
  ...
  new US_Hydrodyn_Dad_Svd (this, selected_files);
}

void
US_Hydrodyn_Dad::line_width ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_line_width"]
...
void
US_Hydrodyn_Dad::movie ()
{
  disable_all ();

  US_Hydrodyn_Dad_Movie *shm = new US_Hydrodyn_Dad_Movie (this);
...
double
US_Hydrodyn_Dad::tot_intensity (QString &file, double q_min, double q_max)
{
...
void
US_Hydrodyn_Dad::set_selected (set<QString> &to_select, bool do_replot,
                               bool scroll_to_first)
{
  disable_updates = true;
  lb_files->clearSelection ();
...
void
US_Hydrodyn_Dad::set_created_selected (set<QString> &to_select, bool do_replot)
{
  disable_updates = true;
...
void
US_Hydrodyn_Dad::artificial_gaussians ()
{
...
bool
US_Hydrodyn_Dad::constant_e (QString file, double e)
{
  if (!f_qs.count (file))
    {
      return false;
...
int
US_Hydrodyn_Dad::slice (const vector<double> &q, const vector<double> &I,
...
double
US_Hydrodyn_Dad::wyatt_errors (QString file, double start_q, double end_q)
{
  if (!f_qs.count (file))
    {
      return -1e0;
...
double
US_Hydrodyn_Dad::wyatt_errors (const vector<double> &q,
...
bool
US_Hydrodyn_Dad::ask_to_decimate (map<QString, QString> &parameters)
{
  switch (QMessageBox::warning (
      this,
      windowTitle ()
...
bool
US_Hydrodyn_Dad::ask_cormap_minq (map<QString, QString> &parameters)
{
  bool ok;
...
void
US_Hydrodyn_Dad::cormap (map<QString, QString> &parameters)
{
  disable_all ();
  ...
  if (!parameters.count ("alpha"))
    {
      parameters["alpha"] = QString ("%1").arg (
          ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("dad_cormap_alpha")
              ? ((US_Hydrodyn *)us_hydrodyn)
                        ->gparams["dad_cormap_alpha"]
                        .toDouble ()
                    * 5
              : 0.05);
    }
  ...
  double cormap_maxq
      = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("dad_cormap_maxq")
            ? ((US_Hydrodyn *)us_hydrodyn)
                  ->gparams["dad_cormap_maxq"]
                  .toDouble ()
            : 0.05;
...
void
US_Hydrodyn_Dad::bin (QStringList files)
{
  bool ok;
...
QStringList
US_Hydrodyn_Dad::vector_qstring_to_qstringlist (vector<QString> vqs)
{
  QStringList qsl;
...
US_Hydrodyn_Dad::simulate ()
{
  ...
  US_Hydrodyn_Dad_Simulate *uhshs
      = new US_Hydrodyn_Dad_Simulate (us_hydrodyn, this, selected, q, I, e);
  uhshs->show ();
}

void
US_Hydrodyn_Dad::gauss_mode ()
{
  map<QString, QString> parameters;
  ...
  parameters["gaussian_type"] = QString ("%1").arg (gaussian_type);
  US_Hydrodyn_Dad_Gauss_Mode *sho = new US_Hydrodyn_Dad_Gauss_Mode (
      &parameters, (US_Hydrodyn *)us_hydrodyn, this);
...
bool
US_Hydrodyn_Dad::dad_load (const QString &filename, const QStringList &qsl,
                           QString &errormsg)
{
  errormsg = "";
  ...
  if (!dad_lambdas.lambdas.size ())
    {
      errormsg = QString (
          UNICODE_LAMBDA_QS
          + "s must be loaded prior to loading of UV-Vis absorption data");
      return false;
    }
  ...
  if (dad_lambdas.lambdas.size () != absorption_row_size)
    {
      errormsg
          = QString (
                "UV-Vis absorption column count %1 does not match number of "
                + UNICODE_LAMBDA_QS + "s %2")
  ...
  switch (QMessageBox::question (
      this, windowTitle () + us_tr (" : Load UV-Vis Data"),
      dad_lambdas.summary_rich ()
          + QString ("<hr>"
                     "Proceed with these UV_Vis "
                     + UNICODE_LAMBDA_QS + "s?")))
    {
    ...
    do
      {
        ...
        dialog.setWindowTitle (windowTitle ()
                               + us_tr (": UV-Vis load : subselect "
                                        + UNICODE_LAMBDA_QS + " range"));
        ...
        form.addRow (new QLabel (
            QString (
                us_tr ("Fill out the values below and click OK to subselect\n"
        ...
        vector<QWidget *> widgets
            = { new QLineEdit (&dialog), new QLineEdit (&dialog) };

        vector<double> defaults = { lambda_start, lambda_end };
        ...
        if (dialog.exec () == QDialog::Accepted)
          {
            if (((QLineEdit *)fields[0])->text ().toDouble ()
    ...
    do
      {
        ...
        // Add some text above the fields
        form.addRow (
            new QLabel (us_tr ("Fill out the values below and click OK\n")));

        // Add the lineEdits with their respective labels
        QList<QWidget *> fields;

        vector<QString> labels = { us_tr ("Start time [s]:"),
        ...
        vector<double> defaults
            = { start_time_seconds, collection_interval_seconds };
            ...
            if (((QLineEdit *)fields[1])->text ().toDouble () == 0)
            ...
            else
              {
                ...
                collection_interval_seconds
                    = ((QLineEdit *)fields[1])->text ().toDouble ();
                TSO << QString ("start time seconds          %1\n"
  ...
  // create A(t)
  {
        ...
        for (size_t i = 0; i < absorption_data_size; ++i)
          {
            ...
            if (!US_Saxs_Util::crop (dad_lambdas.lambdas, absorption_data[i],
                                     lambda_start, lambda_end, x_cropped,
                                     y_cropped, errormsg))
              {

                QMessageBox::critical (
                    this, windowTitle () + us_tr (": "),
                    QString (us_tr ("cropping error " + UNICODE_LAMBDA_QS
                                    + " for %1 to [%2,%3]\n%4"))
                        .arg (basename)
                        .arg (lambda_start)
                        .arg (lambda_end)
            ...
            times.push_back (start_time_seconds
                             + i * collection_interval_seconds);
          }
      }
    else
      {
    ...
    {
      QString errormsg;
      if (!US_Saxs_Util::transpose_vvd (absorption_data,
                                        absorption_data_by_lambda, errormsg))
        {
          QMessageBox::critical (
              this, windowTitle () + us_tr (": "),
              QString (us_tr ("transpose error %1")).arg (errormsg));
          progress->reset ();
    ...
    for (size_t i = 0; i < lambda_size; ++i)
      {
        if (!(i % 20))
          {
            progress->setValue (i);
            progress->setMaximum (lambda_size);
            qApp->processEvents ();
          }
        QString name = QString ("%1_UV-Vis_At_L%2")
                           .arg (basename)
                           .arg (lambdas[i])
...
//       QString use_filename = QFileDialog::getSaveFileName( this , us_tr(
//       "Select a file name for saving the UV-Vis Angles" ),  use_dir ,
//       "*.csv" );
...
//       QRegularExpression::CaseInsensitiveOption ), "" ); use_filename +=
//       ".csv";

//       if ( QFile::exists( use_filename ) ){
//          use_filename = ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck(
//          use_filename, 0, this ); raise();
//       }
...
void
US_Hydrodyn_Dad::conc_info (const QString &msg)
{
  TSO << "============================================================\n"
      << msg << "\n"
      << "------------------------------------------------------------\n";
...
void
US_Hydrodyn_Dad::dndc_info (const QString &msg)
{
  TSO << "============================================================\n"
      << msg << "\n"
      << "------------------------------------------------------------\n";
...
void
US_Hydrodyn_Dad::extc_info (const QString &msg)
{
  TSO << "============================================================\n"
      << msg << "\n"
      << "------------------------------------------------------------\n";
