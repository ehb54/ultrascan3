...
void
US_Hydrodyn_Mals::wheel_enables (bool enable)
{
...
void
US_Hydrodyn_Mals::adjust_wheel (double pos)
{
...
void
US_Hydrodyn_Mals::wheel_cancel (bool from_wheel_save)
{
...
void
US_Hydrodyn_Mals::wheel_pressed ()
{
...
void
US_Hydrodyn_Mals::wheel_released ()
{
