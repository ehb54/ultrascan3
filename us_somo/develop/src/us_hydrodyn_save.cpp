...
US_Hydrodyn_Save::US_Hydrodyn_Save (save_info *save, void *us_hydrodyn,
                                    bool *save_widget, QWidget *p,
                                    const char *)
    : QFrame (p)
{
  this->save = save;
  ...
  // build vectors, maps
  {
    vector<QString> expert_mode_data = {
      "__SECTION__", "Main hydro results:",

      "results.name", "Model name", "Model name",
      ...
      "results.total_beads", "Total beads in model", "Total beads in model",
      ...
      "results.used_beads", "Used beads in model", "Used beads in model",
      ...
      "results.mass", "Molecular mass [Da]", "Molecular mass [Da]",

      "__BREAK__",

      "results.vbar", "Partial specific volume [cm^3/g]",
      "Partial specific volume [cm^3/g]",

      "__BREAK__",

      "results.s20w", "Sedimentation coefficient s [S]",
      "Sedimentation coefficient s [S]",

      "__BREAK__", "results.D20w",
      "Translational diffusion coefficient D [cm^2/sec]",
      "Translational diffusion coefficient D [cm^2/sec]",

      "__BREAK__",

      "results.rs", "Stokes radius [nm]", "Stokes radius [nm]",

      "tra_fric_coef", "Translational frictional coefficient [g/s]",
      "Translational frictional coefficient",

      "__BREAK__",

      "results.ff0", "Frictional ratio", "Frictional ratio",

      "__BREAK__",

      "results.tau", "Relaxation Time, tau(h) [ns]",
      ...
      "results.viscosity", "Intrinsic viscosity [cm^3/g]",
      "Intrinsic viscosity [cm^3/g]",

      "results.rg", "Radius of gyration [nm] (from bead model)",
      ...
      "use_beads_vol", "Used beads volume [nm^3]", "Used beads volume [nm^3]",

      "use_beads_surf", "Used beads surface area [nm^2]",
      "Used beads surface area [nm^2]",

      "use_bead_mass", "Used bead mass [Da]", "Used bead mass [Da]",

      "tot_surf_area", "Total surface area of beads in the model [nm^2]",
      "Total surface area of beads in the model [nm^2]",

      "tot_volume_of", "Total volume of beads in the model [nm^3]",
      "Total volume of beads in the model [nm^3]",

      "num_of_unused", "Number of unused beads", "Number of unused beads",

      "con_factor", "Conversion Factor", "Conversion Factor",

      "proc_time", "Processing time [s] ", "Processing time [s] ",

      "max_ext_x", "Maximum extensions [ X, Y, Z ] [nm]",
      "Maximum extensions [ X, Y, Z ] [nm]",

      "axi_ratios_xz", "Axial ratios [ X:Z, X:Y, Y:Z ] ",
      "Axial ratios [ X:Z, X:Y, Y:Z ] ",

      "__SECTION__", "Additional SMI results:",

      "cen_of_res_x", "Centre of resistance [ X, Y, Z ] [nm]",
      "Centre of resistance [ X, Y, Z ] [nm]",

      "cen_of_mass_x", "Centre of mass [ X, Y, Z ] [nm]",
      "Centre of mass [ X, Y, Z ] [nm]",

      "cen_of_diff_x", "Centre of diffusion [ X, Y, Z ] [nm]",
      ...
      "__SECTION__", "Additional ZENO results:",

      "results.s20w_sd", "Sedimentation coefficient s.d.",
      "Sedimentation coefficient s.d.",

      "results.D20w_sd", "Translational diffusion coefficient D s.d.",
      "Translational diffusion coefficient D s.d.",

      "results.rs_sd", "Stokes radius s.d.", "Stokes radius s.d.",

      "tra_fric_coef_sd", "Translational frictional coefficient s.d.",
      "Translational frictional coefficient s.d.",

      "results.ff0_sd", "Frictional ratio s.d.", "Frictional ratio s.d.",

      "results.viscosity_sd", "Intrinsic viscosity s.d.",
      "Intrinsic viscosity s.d.",

      "dt_d0", "Dt/d0", "Dt/d0",

      "dt_d0_sd", "Dt/d0 s.d.", "Dt/d0 s.d.",

      "dimless_eta", "Dimensionless intrinsic viscosity [eta]",
      "Dimensionless intrinsic viscosity [eta]",

      "dimless_eta_sd", "Dimensionless intrinsic viscosity s.d.",
      "Dimensionless intrinsic viscosity s.d.",

      "zeno_skin_thickness", "Skin Thickness", "Skin Thickness",

      "__SECTION__", "Additional GRPY results:",

      "rot_fric_coef", "Rotational frictional coefficient [g*cm^2/s]",
      "Rotational frictional coefficient [g*cm^2/s]",

      "rot_diff_coef", "Rotational diffusion coefficient [1/s]",
      ...
      "rot_diff_coef_x", "Rotational diffusion coefficient [ X, Y, Z ] [1/s]",
      "Rotational diffusion coefficient [ X, Y, Z ] [1/s]",

      "rot_stokes_rad_x", "Rotational Stokes' radius [ X, Y, Z ] [nm]",
      "Rotational Stokes' radius [ X, Y, Z ] [nm]",

      "rel_times_tau_1", "Relaxation times, tau(1) [ns]",
      "Relaxation times, tau(1) [ns]",

      "rel_times_tau_2", "Relaxation times, tau(2) [ns]",
      "Relaxation times, tau(2) [ns]",

      "rel_times_tau_3", "Relaxation times, tau(3) [ns]",
      "Relaxation times, tau(3) [ns]",

      "rel_times_tau_4", "Relaxation times, tau(4) [ns]",
      "Relaxation times, tau(4) [ns]",

      "rel_times_tau_5", "Relaxation times, tau(5) [ns]",
      "Relaxation times, tau(5) [ns]",

      "rel_times_tau_m", "Relaxation times, tau(m) [ns]",
      ...
      "grpy_einst_rad", "GRPY Einstein's radius [nm]",
      "GRPY Einstein's radius [nm]",

      "__SECTION__", "Additional vdW results:",

      "vdw_theo_waters", "vdW Theoretical waters", "vdW Theoretical waters",

      "vdw_exposed_residues", "vdW Exposed residues", "vdW Exposed residues",

      "vdw_exposed_waters", "vdW Exposed waters", "vdW Exposed waters",

      "__SECTION__", "Solvent conditions:",

      "hydro.solvent_name", "Solvent name", "Solvent name",

      "hydro.solvent_acronym", "Solvent acronym", "Solvent acronym",

      "__BREAK__",

      "hydro.temperature", "Solvent Temperature [C]",
      "Solvent Temperature [C]",

      "hydro.solvent_viscosity", "Solvent viscosity [cP]",
      "Solvent viscosity [cP]",

      "hydro.solvent_density", "Solvent density [g/ml]",
      "solvent_density [g/ml]",

      "hydro.pH", "pH", "pH",

      "__SECTION__", "ASA results and options:",
      ...
      "hydrate_probe_radius", "ASA Hydrate probe radius [A]",
      "ASA Hydrate probe radius [A]",

      "hydrate_threshold", "ASA Hydrate Threshold [A^2]",
      "ASA Hydrate Threshold [A^2]",

      "vdw_grpy_probe_radius", "ASA vdW+GRPY Probe Radius [A]",
      "ASA vdW+GRPY Probe Radius [A]",

      "vdw_grpy_threshold", "ASA vdW+GRPY Threshold [%]",
      "ASA vdW+GRPY Threshold [%]",

      "__SECTION__", "Fractal Dimension:",

      "fractal_dimension_parameters", "Fractal dimension parameters",
      "Fractal dimension parameters",

      "fractal_dimension", "Fractal dimension", "Fractal dimension",

      "fractal_dimension_sd", "Fractal dimension s.d.",
      "Fractal dimension s.d.",

      "fractal_dimension_wtd", "Fractal dimension weighted average",
      "Fractal dimension weighted average",

      "fractal_dimension_wtd_sd", "Fractal dimension weighted average s.d.",
      ...
      "rg_over_fractal_dimension", "Rg / Fractal dimension",
      "Rg / Fractal dimension",

      "rg_over_fractal_dimension_sd", "Rg / Fractal dimension s.d.",
    ...
    // vector < QString > data = ((US_Hydrodyn
    // *)us_hydrodyn)->advanced_config.expert_mode ? expert_mode_data :
    // non_expert_mode_data; always use expert mode ... if expert_mode fields
    // are selected and run in non expert mode, causes issues. perhaps rethink
    // thin
  ...
  for (unsigned int i = 0; i < field.size (); i++)
    {
      ...
      if (field[i] == "results.num_models")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.num_models);
      ...
      if (field[i] == "results.total_beads")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.total_beads);
      ...
      if (field[i] == "results.total_beads_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.total_beads_sd);
          field_to_save_data_type[field[i]] = DT_FLOAT;
      ...
      if (field[i] == "results.used_beads")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.used_beads);
          field_to_save_data_type[field[i]] = DT_FLOAT;
          field_to_precision[field[i]] = 0;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "results.used_beads_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.used_beads_sd);
          field_to_save_data_type[field[i]] = DT_FLOAT;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "results.viscosity")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.viscosity);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "results.viscosity_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.viscosity_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "tra_fric_coef_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.tra_fric_coef_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'e';
          continue;
      ...
      if (field[i] == "rot_stokes_rad_x")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rot_stokes_rad_x);
          field_to_save_data_type[field[i]] = DT_TRIPLE_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "zeno_skin_thickness")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.zeno_skin_thickness);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 4;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "hydro.solvent_name")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydro.solvent_name);
          field_to_save_data_type[field[i]] = DT_QSTRING;
          continue;
        }
      ...
      if (field[i] == "hydro.solvent_acronym")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydro.solvent_acronym);
          field_to_save_data_type[field[i]] = DT_QSTRING;
          continue;
        }
      ...
      if (field[i] == "hydro.temperature")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydro.temperature);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "hydro.solvent_viscosity")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydro.solvent_viscosity);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "hydro.solvent_density")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydro.solvent_density);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "results.asa_rg_pos")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.asa_rg_pos);
      ...
      if (field[i] == "results.asa_rg_neg")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.results.asa_rg_neg);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 4;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "vdw_exposed_residues")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.vdw_exposed_residues);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "vdw_exposed_waters")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.vdw_exposed_waters);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "hydrate_probe_radius")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydrate_probe_radius);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "hydrate_threshold")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.hydrate_threshold);
          field_to_save_data_type[field[i]] = DT_DOUBLE;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "vdw_grpy_probe_radius")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.vdw_grpy_probe_radius);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "vdw_grpy_threshold")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.vdw_grpy_threshold);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'g';
          continue;
      ...
      if (field[i] == "fractal_dimension_parameters")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension_parameters);
          field_to_save_data_type[field[i]] = DT_QSTRING;
          continue;
        }
      if (field[i] == "fractal_dimension")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "fractal_dimension_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "fractal_dimension_wtd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension_wtd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "fractal_dimension_wtd_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension_wtd_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "fractal_dimension_wtd_wtd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension_wtd_wtd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "fractal_dimension_wtd_wtd_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.fractal_dimension_wtd_wtd_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "rg_over_fractal_dimension")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rg_over_fractal_dimension);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "rg_over_fractal_dimension_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rg_over_fractal_dimension_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "rg_over_fractal_dimension_wtd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rg_over_fractal_dimension_wtd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "rg_over_fractal_dimension_wtd_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rg_over_fractal_dimension_wtd_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "rg_over_fractal_dimension_wtd_wtd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rg_over_fractal_dimension_wtd_wtd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
      ...
      if (field[i] == "rg_over_fractal_dimension_wtd_wtd_sd")
        {
          field_to_save_data[field[i]]
              = (void *)&(save->data.rg_over_fractal_dimension_wtd_wtd_sd);
          field_to_save_data_type[field[i]] = DT_DOUBLE_NA;
          field_to_precision[field[i]] = 6;
          field_to_format[field[i]] = 'f';
          continue;
...
US_Hydrodyn_Save::setupGUI ()
{
  ...
  lbl_possible->setFont (QFont (USglobal->config_list.fontFamily,
      ...
      if (section_name.count (field[i]))
        {
          ...
          lb_this->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1,
                                   QFont::Bold));
          lb_this->setEnabled (true);
          lb_possible.push_back (lb_this);
          tw_possible->addTab (lb_this, section_name[field[i]]);
          connect (lb_this, SIGNAL (itemSelectionChanged ()),
                   SLOT (update_enables_possible ()));
  ...
  connect (tw_possible, SIGNAL (currentChanged (int)),
  ...
  vbl_possible->setContentsMargins (0, 0, 0, 0);
  vbl_possible->setSpacing (0);
  vbl_possible->addWidget (lbl_possible);
  vbl_possible->addWidget (tw_possible);

  QVBoxLayout *vbl_add_remove = new QVBoxLayout;
  vbl_add_remove->setContentsMargins (0, 0, 0, 0);
  vbl_add_remove->setSpacing (0);
  ...
  vbl_selected->setContentsMargins (0, 0, 0, 0);
  vbl_selected->setSpacing (0);
...
void
US_Hydrodyn_Save::cancel ()
{
  close ();
}

void
US_Hydrodyn_Save::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Save::closeEvent (QCloseEvent *e)
{
  *save_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_Save::update_enables_possible ()
{
...
void
US_Hydrodyn_Save::update_enables_selected ()
{
  bool any_selected = false;
  ...
  for (int i = 0; i < lb_selected->count (); i++)
    {
      if (lb_selected->item (i)->isSelected ()
        ...
        {
          unsigned int pos
              = descriptive_name_to_section[lb_selected->item (i)->text ()];
...
US_Hydrodyn_Save::rebuild ()
{
  ...
  for (unsigned int t = 0; t < lb_possible.size (); t++)
    {
      for (int i = 0; i < lb_possible[t]->count (); i++)
        {
          possible_selected[lb_possible[t]->item (i)->text ()]
              = lb_possible[t]->item (i)->isSelected ();
        }
    }
  ...
  for (int i = 0; i < lb_selected->count (); i++)
    {
      selected[lb_selected->item (i)->text ()]
          = lb_selected->item (i)->isSelected ();
    }
  ...
  for (unsigned int t = 0; t < lb_possible.size (); t++)
    {
      for (int i = 0; i < lb_possible[t]->count (); i++)
        {
          lb_possible[t]->item (i)->setSelected (
              possible_selected[lb_possible[t]->item (i)->text ()]);
        }
    }
  ...
  for (int i = 0; i < lb_selected->count (); i++)
    {
      save->field_flag
          [field[descriptive_name_to_pos[lb_selected->item (i)->text ()]]]
          = true;
      save->field.push_back (
          field[descriptive_name_to_pos[lb_selected->item (i)->text ()]]);
      printf ("%s\n",
              field[descriptive_name_to_pos[lb_selected->item (i)->text ()]]
                  .toLatin1 ()
...
void
US_Hydrodyn_Save::tab_changed (int)
{
  update_enables_possible ();
}

QString
US_Hydrodyn_Save::header ()
{
  QString result;
  QString this_field;
  for (unsigned int i = 0; i < save->field.size (); i++)
      ...
      if (this_field.contains ("[ X, Y, Z ]")
          || this_field.contains ("[ X:Z, X:Y, Y:Z ]"))
        {
          ...
          result += QString ("%1\"%2\",\"%3\",\"%4\"")
                        .arg (i ? "," : "")
                        .arg (field_x.replace ("[ X, Y, Z ]", "X")
                                  .replace ("[ X:Z, X:Y, Y:Z ]", "X:Z"))
                        .arg (field_y.replace ("[ X, Y, Z ]", "Y")
                                  .replace ("[ X:Z, X:Y, Y:Z ]", "X:Y"))
                        .arg (field_z.replace ("[ X, Y, Z ]", "Z")
                                  .replace ("[ X:Z, X:Y, Y:Z ]", "Y:Z"));
        }
      else
        {
          result += QString ("%1\"%2\"").arg (i ? "," : "").arg (this_field);
        }
    }
...
// #define ZARG(s)
// arg(s,0,field_to_format[save->field[i]],field_to_precision[save->field[i]]).replace(QRegExp("\\.0+$"),"")
// #define DBFARG(s) printf("i = %u _field <%s> _format <%c> _precision
// <%d>\n",i,save->field[i].toLatin1().data(),
// field_to_format[save->field[i]],field_to_precision[save->field[i]]);fflush(stdout)
#define FARG(s)                                                               \
  arg (s, 0, field_to_format[save->field[i]],                                 \
       field_to_precision[save->field[i]])

QString
US_Hydrodyn_Save::dataString (save_data *data)
{
  save->data = *data;
  QString result;
  for (unsigned int i = 0; i < save->field.size (); i++)
    {
      switch (field_to_save_data_type[save->field[i]])
        ...
        case DT_BOOL:
          result += QString ("%1%2")
                        .arg (i ? "," : "")
                        .arg (*((bool *)(field_to_save_data[save->field[i]]))
                                  ? 1
                                  : 0);
          break;
        case DT_FLOAT:
...
vector<save_data>
US_Hydrodyn_Save::stats (vector<save_data> *data)
{
  ...
  for (unsigned int i = 0; i < field.size (); i++)
    {
      ...
      //      fflush(stdout); printf("field[i] %s type
      //      %d\n",field[i].toLatin1().data(),
      //      field_to_save_data_type[field[i]]); fflush(stdout);
      //      printf("save->field[i] %s\n",save->field[i].toLatin1().data());
      //      fflush(stdout);
          ...
          switch (field_to_save_data_type[field[i]])
            ...
            case DT_TRIPLE_DOUBLE:
              ...
              *((double *)(field_to_save_data[field[i]]) + 1)
                  += tmp_double_2 * tmp_double_2;
              *((double *)(field_to_save_data[field[i]]) + 2)
                  += tmp_double_2 * tmp_double_3;
              sum2 = save->data;
      ...
      switch (field_to_save_data_type[field[i]])
          ...
          *((float *)(field_to_save_data[field[i]])) /= tmp_count_float;
...

          {
            ...
            if (tmp_vmin == tmp_vmax)
              ...
              {
                *((float *)(field_to_save_data[field[i]]))
                    = sqrt (fabs ((*((float *)(field_to_save_data[field[i]]))
                                   - tmp_float * tmp_float * tmp_count_float)
                                  / (tmp_count_float - 1)));
              }
            sum2 = save->data;
          }
          ...
          *((double *)(field_to_save_data[field[i]])) /= tmp_count_double;
...

          {
            ...
            if (tmp_vmin == tmp_vmax)
              ...
              {
                *((double *)(field_to_save_data[field[i]])) = sqrt (
                    fabs ((*((double *)(field_to_save_data[field[i]]))
                           - tmp_double * tmp_double * tmp_count_double)
                          / (tmp_count_double - 1)));
              }
            sum2 = save->data;
          }
        ...
        case DT_UNSIGNED_INT:
          ...
          *((unsigned int *)(field_to_save_data[field[i]])) /= tmp_count_uint;
          ...
          {
            save->data = vmin;
            unsigned int tmp_vmin
                = *((unsigned int *)(field_to_save_data[field[i]]));

            save->data = vmax;
            unsigned int tmp_vmax
                = *((unsigned int *)(field_to_save_data[field[i]]));
            ...
            if (tmp_vmin == tmp_vmax)
            ...
            else
              {
                *((unsigned int *)(field_to_save_data[field[i]]))
                    = (*((unsigned int *)(field_to_save_data[field[i]]))
                       - tmp_uint * tmp_uint * tmp_count_uint)
                      / (tmp_count_uint - 1);
              }
            sum2 = save->data;
          }
          ...
          *((double *)(field_to_save_data[field[i]]) + 2) /= tmp_count_double;
...

          {
            ...
            double tmp_vmin0
                = *((unsigned int *)(field_to_save_data[field[i]]));
            double tmp_vmin1
                = *((unsigned int *)(field_to_save_data[field[i]]) + 1);
            double tmp_vmin2
                = *((unsigned int *)(field_to_save_data[field[i]]) + 2);
            ...
            if (tmp_vmin1 == tmp_vmax1)
              ...
              {
                *((double *)(field_to_save_data[field[i]]) + 1) = sqrt (
                    fabs ((*((double *)(field_to_save_data[field[i]]) + 1)
                           - tmp_double_2 * tmp_double_2 * tmp_count_double)
                          / (tmp_count_double - 1)));
              }
            ...
            if (tmp_vmin2 == tmp_vmax2)
              ...
              {
                *((double *)(field_to_save_data[field[i]]) + 2) = sqrt (
                    fabs ((*((double *)(field_to_save_data[field[i]]) + 2)
                           - tmp_double_3 * tmp_double_3 * tmp_count_double)
                          / (tmp_count_double - 1)));
              }
            sum2 = save->data;
          }
...
QString
US_Hydrodyn_Save::hydroFormatStats (vector<save_data> stats,
                                    enum HydroTypes hydrotype)
{
  QString result;
  ...
  if (stats.size () != 2)
    {
      result.sprintf (
          "INTERNAL ERROR: ******** US_Hydrodyn_Save::hydroFormatStats called "
          "with wrong size stats %u\n",
  ...
  result += QString ("").sprintf (
      "- TRANS. FRICT. COEFF.        \t%.3e\t%.3e\t[g/s]\n",
      stats[0].tra_fric_coef, stats[1].tra_fric_coef);

  result += QString ("").sprintf (
      "- TRANS. DIFF. COEFF.         \t%.2e\t%.3e\t[cm^2/s]\n",
      stats[0].results.D20w, stats[1].results.D20w);

  //   if (raflag == -1.0)
  //   {
  //      result += QString("").sprintf("- SED. COEFF. (psv
  //      unhyd.rad.)\t%.2f\t\t%.2f\t\t[S]\n",
  ...
  QString bead_model_source
      = ((US_Hydrodyn *)us_hydrodyn)->misc.compute_vbar
            ? (((US_Hydrodyn *)us_hydrodyn)->bead_model_from_file ? "from file"
                                                                  : "computed")
            : "user entered";
  ...
  //   {
  result += QString ("").sprintf (
      "- SED. COEFF. (psv %s) \t%.2f\t\t%.2f\t\t[S]\n",
      bead_model_source.toLatin1 ().data (), stats[0].results.s20w,
      stats[1].results.s20w);
  //   }

  result += QString ("").sprintf (
      "- FRICTIONAL RATIO            \t%.2f\t%.3e\n\n", stats[0].results.ff0,
      stats[1].results.ff0);

  if (hydrotype == HYDRO_UNKNOWN || hydrotype == HYDRO_SMI)
    {
      result += QString ("").sprintf (
          "- ROT. FRICT. COEFF.          \t%.3e\t%.3e\t[g*cm^2/s]\n",
          stats[0].rot_fric_coef, stats[1].rot_fric_coef);
    }

  if (hydrotype != HYDRO_ZENO)
    {
      result += QString ("").sprintf (
          "- ROT. DIFF. COEFF.           \t%.0f\t\t%.0f\t[1/s]\n",
          stats[0].rot_diff_coef, stats[1].rot_diff_coef);
    }

  if (hydrotype == HYDRO_UNKNOWN || hydrotype == HYDRO_SMI)
    {
      result += QString ("").sprintf (
          "- ROT. FRICT. COEFF. [ X ]    \t%.3e\t%.3e\t[g*cm^2/s]\n",
          stats[0].rot_fric_coef_x, stats[1].rot_fric_coef_x);
      result += QString ("").sprintf (
          "- ROT. FRICT. COEFF. [ Y ]    \t%.3e\t%.3e\t[g*cm^2/s]\n",
          stats[0].rot_fric_coef_y, stats[1].rot_fric_coef_y);
      result += QString ("").sprintf (
          "- ROT. FRICT. COEFF. [ Z ]    \t%.3e\t%.3e\t[g*cm^2/s]\n",
          stats[0].rot_fric_coef_z, stats[1].rot_fric_coef_z);
      result += QString ("").sprintf (
          "- ROT. DIFF. COEFF. [ X ]     \t%.0f\t\t%.0f\t[1/s]\n",
          stats[0].rot_diff_coef_x, stats[1].rot_diff_coef_x);
      result += QString ("").sprintf (
          "- ROT. DIFF. COEFF. [ Y ]     \t%.0f\t\t%.0f\t[1/s]\n",
          stats[0].rot_diff_coef_y, stats[1].rot_diff_coef_y);
      result += QString ("").sprintf (
          "- ROT. DIFF. COEFF. [ Z ]     \t%.0f\t\t%.0f\t[1/s]\n",
          stats[0].rot_diff_coef_z, stats[1].rot_diff_coef_z);
    }

  result += QString ("").sprintf (
      "\n- RADIUS OF GYRATION          \t%.2f\t\t%.2f\t\t[nm]\n",
      stats[0].results.rg, stats[1].results.rg);

  result += QString ("").sprintf (
      "- TRANS. STOKES' RADIUS       \t%.2f\t\t%.2f\t\t[nm]\n",
      stats[0].results.rs, stats[1].results.rs);

  if (hydrotype == HYDRO_UNKNOWN || hydrotype == HYDRO_SMI)
    {
      result += QString ("").sprintf (
          "- ROTAT. STOKES' RADIUS [ X ] \t%.2f\t\t%.2f\t\t[nm]\n",
          stats[0].rot_stokes_rad_x, stats[1].rot_stokes_rad_x);
      result += QString ("").sprintf (
          "- ROTAT. STOKES' RADIUS [ Y ] \t%.2f\t\t%.2f\t\t[nm]\n",
          stats[0].rot_stokes_rad_y, stats[1].rot_stokes_rad_y);
      result += QString ("").sprintf (
          "- ROTAT. STOKES' RADIUS [ Z ] \t%.2f\t\t%.2f\t\t[nm]\n",
          stats[0].rot_stokes_rad_z, stats[1].rot_stokes_rad_z);
    }
  ...
  if (stats[0].results.viscosity)
    {
      result += QString ("").sprintf (
          ...
          stats[0].results.viscosity, stats[1].results.viscosity);
    }
  ...
  if (hydrotype == HYDRO_UNKNOWN || hydrotype == HYDRO_SMI)
    {
      result += QString ("").sprintf (
          ...
          stats[0].unc_int_visc, stats[1].unc_int_visc);
      result += QString ("").sprintf (
          "- UNCORRECTED EINSTEIN'S RADIUS\t%.2f\t\t%.2f\t\t[nm]\n",
          stats[0].unc_einst_rad, stats[1].unc_einst_rad);
      result += QString ("").sprintf (
          "- CORRECTED INTRINSIC VISCOSITY\t%.2f\t\t%.2f\t\t[cm^3/g]\n",
          stats[0].cor_int_visc, stats[1].cor_int_visc);
      result += QString ("").sprintf (
          "- CORRECTED EINSTEIN'S RADIUS\t%.2f\t\t%.2f\t\t[nm]\n",
          stats[0].cor_einst_rad, stats[1].cor_einst_rad);
    }

#if defined(TSUDA_DOUBLESUM)
  result += QString ("").sprintf (
      "- INTRINSIC VISC. (Double Sum)\t%.2f\t\t%.2f\t\t[cm^3/g]\n", stats[0].,
      stats[1].);
  result += QString ("").sprintf (
      "- EINSTEIN'S RADIUS (D. Sum)  \t%.2f\t\t%.2f\t\t[nm]\n", stats[0].,
      stats[1].);
  result += QString ("").sprintf (
      "- INTRINSIC VISC. (Tsuda CM)  \t%.2f\t\t%.2f\t\t[cm^3/g]\n", stats[0].,
      stats[1].);
  result += QString ("").sprintf (
      "- EINSTEIN'S RADIUS (Tsuda CM)\t%.2f\t\t%.2f\t\t[nm]\n", stats[0].,
      stats[1].);
  result += QString ("").sprintf (
      "- INTRINSIC VISC. (Tsuda CV)  \t%.2f\t\t%.2f\t\t[cm^3/g]\n", stats[0].,
      stats[1].);
  result += QString ("").sprintf (
      "- EINSTEIN'S RADIUS (Tsuda CV)\t%.2f\t\t%.2f\t\t[nm]\n", stats[0].,
      stats[1].);
#endif
  ...
  if (hydrotype != HYDRO_ZENO)
    {
      ...
      result += QString ("").sprintf (
          " Tau(1)                       \t%.2f\t\t%.2f\t\t[ns]\n",
          stats[0].rel_times_tau_1, stats[1].rel_times_tau_1);
      result += QString ("").sprintf (
          " Tau(2)                       \t%.2f\t\t%.2f\t\t[ns]\n",
          stats[0].rel_times_tau_2, stats[1].rel_times_tau_2);
      result += QString ("").sprintf (
          " Tau(3)                       \t%.2f\t\t%.2f\t\t[ns]\n",
          stats[0].rel_times_tau_3, stats[1].rel_times_tau_3);
      result += QString ("").sprintf (
          " Tau(4)                       \t%.2f\t\t%.2f\t\t[ns]\n",
          stats[0].rel_times_tau_4, stats[1].rel_times_tau_4);
      result += QString ("").sprintf (
          " Tau(5)                       \t%.2f\t\t%.2f\t\t[ns]\n",
          stats[0].rel_times_tau_5, stats[1].rel_times_tau_5);
    }
  ...
  //   result += QString("").sprintf(" Tau(m) (Weighted average)
  //   \t%.2f\t\t\t\t[ns]\n",
  //                                 avgv);
  //   result += QString("").sprintf(" Tau(h) (Weighted average)
  //   \t%.2f\t\t\t\t[ns]\n",
  //                                 1.0 / avgrv);
  ...
  if (hydrotype != HYDRO_ZENO)
    {
      result += QString ("").sprintf (
          ...
          stats[0].rel_times_tau_m, stats[1].rel_times_tau_m);
      result += QString ("").sprintf (
          " Tau(h) (Unweighted average)  \t%.2f\t\t%.2f\t\t[ns]\n",
          stats[0].rel_times_tau_h, stats[1].rel_times_tau_h);
    }
...
save_data
US_Hydrodyn_Save::save_data_initialized ()
{
  save_data data;

  // hydro_options hydro; these should always be initialized from current
  // hydro_options
...
US_Hydrodyn_Save::save_data_initialized_from_bead_model (
    const vector<PDB_atom *> model, bool bead_exclusion)
{
