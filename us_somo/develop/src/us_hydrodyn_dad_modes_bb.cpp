...
void US_Hydrodyn_Dad::blanks_start() {
...
void US_Hydrodyn_Dad::blanks_enables() {
...
// --- baseline ---
void US_Hydrodyn_Dad::baseline_start(bool from_blanks_mode_save) {
  if (axis_y_log) {
    axis_y();
  }
...
void US_Hydrodyn_Dad::baseline_enables() {
...
void US_Hydrodyn_Dad::set_baseline_start_zero() {
  if (!cb_baseline_start_zero->isChecked()) {
    // QMessageBox::warning(
    //                      this,
...
void US_Hydrodyn_Dad::baseline_init_markers() {
...
void US_Hydrodyn_Dad::replot_baseline(QString /* qs */) {
...
void US_Hydrodyn_Dad::baseline_apply() {
  int smoothing = 0;
  bool integral =
      ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_integral"] == "true";
  if (integral) {
    smoothing = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_smooth"].toInt();
  }
...
void US_Hydrodyn_Dad::baseline_apply(QStringList files, bool integral,
  ...
  bool use_start_region =
      ...
      ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_start_region"].toInt() > 0;
...
void US_Hydrodyn_Dad::set_baseline_fix_width() {
  // us_qdebug( "set baseline fix width" );
  baseline_enables();
}

int US_Hydrodyn_Dad::input_double_to_pos(double d) {
...
void US_Hydrodyn_Dad::baseline_end_s_text(const QString &text) {
...
void US_Hydrodyn_Dad::baseline_end_text(const QString &text) {
...
void US_Hydrodyn_Dad::baseline_end_e_text(const QString &text) {
...
void US_Hydrodyn_Dad::baseline_start_s_focus(bool hasFocus) {
...
void US_Hydrodyn_Dad::baseline_start_focus(bool hasFocus) {
...
void US_Hydrodyn_Dad::baseline_start_e_focus(bool hasFocus) {
...
void US_Hydrodyn_Dad::baseline_end_s_focus(bool hasFocus) {
...
void US_Hydrodyn_Dad::baseline_end_focus(bool hasFocus) {
...
void US_Hydrodyn_Dad::baseline_end_e_focus(bool hasFocus) {
...
void US_Hydrodyn_Dad::baseline_width_text(const QString &text) {
  int blw = text.toInt();
...
void US_Hydrodyn_Dad::baseline_width_focus(bool hasFocus) {
  if (hasFocus) {
...
void US_Hydrodyn_Dad::baseline_best() {
  disable_all();
      ...
      // plot of results
      {
        ...
        if (best_vdparameters["x"].size()) {
          US_Hydrodyn_Dad_Baseline_Best *uhsbb =
              new US_Hydrodyn_Dad_Baseline_Best(us_hydrodyn, best_parameters,
                                                best_dparameters,
                                                best_vdparameters);
          uhsbb->show();
...
void US_Hydrodyn_Dad::baseline_test() {
...
void US_Hydrodyn_Dad::baseline_test_pos(int pos) {
  ...
  baseline_apply(
      qsl, true, ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_smooth"].toInt(),
      true, ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_reps"].toInt(), false,
      true);
