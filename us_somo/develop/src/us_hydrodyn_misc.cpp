...
US_Hydrodyn_Misc::US_Hydrodyn_Misc (struct misc_options *misc,
                                    bool *misc_widget, void *us_hydrodyn,
...
US_Hydrodyn_Misc::~US_Hydrodyn_Misc () { *misc_widget = false; }

void
US_Hydrodyn_Misc::setupGUI ()
{
  int minHeight1 = 22;
  ...
  AUTFBACK (lbl_info);
  lbl_info->setFont (
      QFont (USglobal->config_list.fontFamily, hdrFontSize, QFont::Bold));

  lbl_hydrovol
      = new QLabel (us_tr (" Hydration Water Vol. [" + UNICODE_ANGSTROM_QS
                           + UNICODE_SUPER_3_QS + "]: "),
                    this);
  ...
  lbl_hydrovol->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  cnt_hydrovol = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_hydrovol);
  Q_CHECK_PTR (cnt_hydrovol);
  cnt_hydrovol->setRange (0, 100);
  cnt_hydrovol->setSingleStep (0.001);
  ...
  cnt_hydrovol->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_hydrovol->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_hydrovol);
  connect (cnt_hydrovol, SIGNAL (valueChanged (double)),
           SLOT (update_hydrovol (double)));
  ...
  lbl_vbar = new QLabel (
      us_tr (" Enter a vbar value [cm" + UNICODE_SUPER_3_QS + "/g]: "), this);
  ...
  le_vbar->setObjectName ("vbar Line Edit");
  ...
  lbl_vbar_temperature
      = new QLabel (us_tr (QString (" Vbar measured/computed at T=[%1C]: ")
                               .arg (DEGREE_SYMBOL)),
                    this);
  ...
  lbl_vbar_temperature->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  le_vbar_temperature = new QLineEdit (this);
  le_vbar_temperature->setObjectName ("vbar_temperature Line Edit");
  le_vbar_temperature->setMinimumHeight (minHeight1);
  le_vbar_temperature->setEnabled (!(*misc).compute_vbar);
  le_vbar_temperature->setText (
      str.sprintf ("%5.2f", (*misc).vbar_temperature));
  le_vbar_temperature->setPalette (PALET_NORMAL);
  AUTFBACK (le_vbar_temperature);
  le_vbar_temperature->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_vbar_temperature, SIGNAL (textChanged (const QString &)),
           SLOT (update_vbar_temperature (const QString &)));
  ...
  lbl_avg_banner->setFont (
      QFont (USglobal->config_list.fontFamily, hdrFontSize, QFont::Bold));

  lbl_avg_radius = new QLabel (
      us_tr (" Average atomic radius [" + UNICODE_ANGSTROM_QS + "]: "), this);
  ...
  cnt_avg_radius->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_radius->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_radius);
  connect (cnt_avg_radius, SIGNAL (valueChanged (double)),
           SLOT (update_avg_radius (double)));
  ...
  cnt_avg_mass->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_mass->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_mass);
  connect (cnt_avg_mass, SIGNAL (valueChanged (double)),
           SLOT (update_avg_mass (double)));

  lbl_avg_num_elect
      = new QLabel (us_tr (" Average atomic number of electrons: "), this);
  ...
  cnt_avg_num_elect->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_num_elect->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_num_elect);
  connect (cnt_avg_num_elect, SIGNAL (valueChanged (double)),
           SLOT (update_avg_num_elect (double)));

  lbl_avg_protons
      = new QLabel (us_tr (" Average atomic number of protons: "), this);
  ...
  cnt_avg_protons->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_protons->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_protons);
  connect (cnt_avg_protons, SIGNAL (valueChanged (double)),
           SLOT (update_avg_protons (double)));
  ...
  cnt_avg_hydration->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_hydration->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_hydration);
  connect (cnt_avg_hydration, SIGNAL (valueChanged (double)),
           SLOT (update_avg_hydration (double)));

  lbl_avg_volume
      = new QLabel (us_tr (" Average bead/atom volume [" + UNICODE_ANGSTROM_QS
                           + UNICODE_SUPER_3_QS + "]: "),
                    this);
  ...
  cnt_avg_volume->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_volume->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_volume);
  connect (cnt_avg_volume, SIGNAL (valueChanged (double)),
           SLOT (update_avg_volume (double)));

  lbl_avg_vbar = new QLabel (
      us_tr (" Average Residue vbar [cm" + UNICODE_SUPER_3_QS + "/g]: "),
      this);
  ...
  cnt_avg_vbar->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cnt_avg_vbar->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_avg_vbar);
  connect (cnt_avg_vbar, SIGNAL (valueChanged (double)),
           SLOT (update_avg_vbar (double)));
  ...
  lbl_bead_model_controls->setFont (
      QFont (USglobal->config_list.fontFamily, hdrFontSize, QFont::Bold));

  lbl_target_e_density = new QLabel (
      us_tr (" Target electron density [" + UNICODE_ANGSTROM_QS
             + UNICODE_SUPER_MINUS_QS + UNICODE_SUPER_3_QS + "]: "),
      this);
  ...
  lbl_target_e_density->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  le_target_e_density = new QLineEdit (this);
  le_target_e_density->setObjectName ("target_e_density Line Edit");
  ...
  le_target_e_density->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_target_e_density, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_e_density (const QString &)));

  lbl_target_volume
      = new QLabel (us_tr (" Target volume [" + UNICODE_ANGSTROM_QS
                           + UNICODE_SUPER_3_QS + "]: "),
                    this);
  ...
  lbl_target_volume->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  le_target_volume = new QLineEdit (this);
  le_target_volume->setObjectName ("target_volume Line Edit");
  ...
  le_target_volume->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_target_volume, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_volume (const QString &)));
  ...
  cb_set_target_on_load_pdb->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cb_set_target_on_load_pdb->setPalette (PALET_NORMAL);
  AUTFBACK (cb_set_target_on_load_pdb);
  connect (cb_set_target_on_load_pdb, SIGNAL (clicked ()),
           SLOT (set_set_target_on_load_pdb ()));
  ...
  cb_equalize_radii->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cb_equalize_radii->setPalette (PALET_NORMAL);
  AUTFBACK (cb_equalize_radii);
  connect (cb_equalize_radii, SIGNAL (clicked ()),
           SLOT (set_equalize_radii ()));
  ...
  // lbl_hydro_method->setFont(QFont( USglobal->config_list.fontFamily,
  // hdrFontSize, QFont::Bold));
  ...
  // cb_hydro_supc->setFont(QFont( USglobal->config_list.fontFamily,
  // useFontSize)); cb_hydro_supc->setPalette( PALET_NORMAL );
  ...
  // cb_hydro_zeno->setFont(QFont( USglobal->config_list.fontFamily,
  // useFontSize)); cb_hydro_zeno->setPalette( PALET_NORMAL );
  // connect(cb_hydro_zeno, SIGNAL(clicked()), SLOT(set_hydro_zeno()));

  lbl_threshold
      = new QLabel (us_tr ("Additonal computed vbar controls:"), this);
  ...
  lbl_threshold->setFont (
      QFont (USglobal->config_list.fontFamily, hdrFontSize, QFont::Bold));
  lbl_threshold->hide ();

  lbl_covolume = new QLabel (
      us_tr (" Covolume [cm" + UNICODE_SUPER_3_QS + "/mol]: "), this);
  ...
  lbl_covolume->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  le_covolume = new QLineEdit (this);
  le_covolume->setObjectName ("covolume Line Edit");
  le_covolume->setMinimumHeight (minHeight1);
  le_covolume->setEnabled (true);
  le_covolume->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("covolume")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["covolume"]
          : "12.4"));
  ...
  connect (le_covolume, SIGNAL (textChanged (const QString &)),
           SLOT (update_covolume (const QString &)));

  // lbl_thresh_SS = new QLabel(us_tr(" Disulfide distance threshold [" +
  // UNICODE_ANGSTROM_QS + "]: "), this);
  ...
  // useFontSize, QFont::Bold));

  // le_thresh_SS = new QLineEdit( this );    le_thresh_SS->setObjectName(
  // "thresh_SS Line Edit" ); le_thresh_SS->setMinimumHeight(minHeight1);
  // le_thresh_SS->setEnabled(true);
  // le_thresh_SS->setText(QString("%1").arg( ( ( US_Hydrodyn * ) us_hydrodyn
  // )->gparams.count( "thresh_SS" ) ?
  //                                            ( ( US_Hydrodyn * ) us_hydrodyn
  //                                            )->gparams[ "thresh_SS" ] :
  //                                            "2.3" ) );
  // le_thresh_SS->setPalette( PALET_NORMAL );
  // AUTFBACK( le_thresh_SS );
  // le_thresh_SS->setFont(QFont( USglobal->config_list.fontFamily,
  // useFontSize)); connect(le_thresh_SS, SIGNAL(textChanged(const QString &)),
  // SLOT(update_thresh_SS(const QString &)));

  lbl_thresh_carb_O = new QLabel (us_tr (" Carbohydrate O distance threshold ["
                                         + UNICODE_ANGSTROM_QS + "]:"),
                                  this);
  ...
  lbl_thresh_carb_O->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));
  lbl_thresh_carb_O->hide ();

  le_thresh_carb_O = new QLineEdit (this);
  le_thresh_carb_O->setObjectName ("thresh_carb_O Line Edit");
  le_thresh_carb_O->setMinimumHeight (minHeight1);
  le_thresh_carb_O->setEnabled (true);
  le_thresh_carb_O->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("thresh_carb_O")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["thresh_carb_O"]
          : "2"));
  le_thresh_carb_O->setPalette (PALET_NORMAL);
  AUTFBACK (le_thresh_carb_O);
  le_thresh_carb_O->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_thresh_carb_O, SIGNAL (textChanged (const QString &)),
           SLOT (update_thresh_carb_O (const QString &)));
  le_thresh_carb_O->hide ();

  lbl_thresh_carb_N = new QLabel (us_tr (" Carbohydrate N distance threshold ["
                                         + UNICODE_ANGSTROM_QS + "]:"),
                                  this);
  ...
  lbl_thresh_carb_N->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));
  lbl_thresh_carb_N->hide ();

  le_thresh_carb_N = new QLineEdit (this);
  le_thresh_carb_N->setObjectName ("thresh_carb_N Line Edit");
  le_thresh_carb_N->setMinimumHeight (minHeight1);
  le_thresh_carb_N->setEnabled (true);
  le_thresh_carb_N->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("thresh_carb_N")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["thresh_carb_N"]
          : "2"));
  le_thresh_carb_N->setPalette (PALET_NORMAL);
  AUTFBACK (le_thresh_carb_N);
  le_thresh_carb_N->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_thresh_carb_N, SIGNAL (textChanged (const QString &)),
           SLOT (update_thresh_carb_N (const QString &)));
  ...
  cb_export_msroll->setText (us_tr (
      " Create MSROLL atomic radii and name files on load residue file"));
  cb_export_msroll->setChecked ((*misc).export_msroll);
  cb_export_msroll->setMinimumHeight (minHeight1);
  cb_export_msroll->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  ...
  cb_export_ssbond->setText (
      us_tr (" Create SSBOND txt file when loading PDB"));
  cb_export_ssbond->setChecked ((*misc).export_ssbond);
  cb_export_ssbond->setMinimumHeight (minHeight1);
  cb_export_ssbond->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  ...
  lbl_vdw_ot_mult->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  le_vdw_ot_mult = new QLineEdit (this);
  le_vdw_ot_mult->setObjectName ("vdw_ot_mult Line Edit");
  le_vdw_ot_mult->setMinimumHeight (minHeight1);
  le_vdw_ot_mult->setEnabled (true);
  le_vdw_ot_mult->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("vdw_ot_mult")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_ot_mult"]
          : "0"));
  le_vdw_ot_mult->setPalette (PALET_NORMAL);
  AUTFBACK (le_vdw_ot_mult);
  le_vdw_ot_mult->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_vdw_ot_mult, SIGNAL (textChanged (const QString &)),
           SLOT (update_vdw_ot_mult (const QString &)));

  lbl_vdw_ot_dpct
      = new QLabel (us_tr (" vdW OT additonal water decrease %: "), this);
  ...
  lbl_vdw_ot_dpct->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));

  le_vdw_ot_dpct = new QLineEdit (this);
  le_vdw_ot_dpct->setObjectName ("vdw_ot_dpct Line Edit");
  le_vdw_ot_dpct->setMinimumHeight (minHeight1);
  le_vdw_ot_dpct->setEnabled (true);
  le_vdw_ot_dpct->setText (QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("vdw_ot_dpct")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_ot_dpct"]
          : "0"));
  le_vdw_ot_dpct->setPalette (PALET_NORMAL);
  AUTFBACK (le_vdw_ot_dpct);
  le_vdw_ot_dpct->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  connect (le_vdw_ot_dpct, SIGNAL (textChanged (const QString &)),
           SLOT (update_vdw_ot_dpct (const QString &)));

  cb_vdw_ot_alt = new QCheckBox (this);
  cb_vdw_ot_alt->setText (us_tr (" vdW use alternate method for OT"));
  cb_vdw_ot_alt->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("vdw_ot_alt")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_ot_alt"] == "true");
  cb_vdw_ot_alt->setMinimumHeight (minHeight1);
  cb_vdw_ot_alt->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  ...
  cb_vdw_saxs_water_beads->setChecked (
  ...
  cb_vdw_saxs_water_beads->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cb_vdw_saxs_water_beads->setPalette (PALET_NORMAL);
  AUTFBACK (cb_vdw_saxs_water_beads);
  connect (cb_vdw_saxs_water_beads, SIGNAL (clicked ()),
           SLOT (set_vdw_saxs_water_beads ()));

  cb_vdw_saxs_skip_pr0pair = new QCheckBox (this);
  cb_vdw_saxs_skip_pr0pair->setText (
      us_tr (" vdW saxs pr skip 0 distance pairs"));
  cb_vdw_saxs_skip_pr0pair->setChecked (
  ...
  cb_vdw_saxs_skip_pr0pair->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize));
  cb_vdw_saxs_skip_pr0pair->setPalette (PALET_NORMAL);
  AUTFBACK (cb_vdw_saxs_skip_pr0pair);
  connect (cb_vdw_saxs_skip_pr0pair, SIGNAL (clicked ()),
           SLOT (set_vdw_saxs_skip_pr0pair ()));
  ...
  // auto calc method
  lbl_auto_calc_hydro_method
      = new QLabel (us_tr (" Method used when automatically\n calculate "
                           "hydrodynamics is checked:"),
                    this);
  ...
  lbl_auto_calc_hydro_method->setFont (
      QFont (USglobal->config_list.fontFamily, useFontSize, QFont::Bold));
  ...
  cmb_auto_calc_hydro_method->setFont (QFont (
  ...
  cmb_auto_calc_hydro_method->addItem (
      us_tr ("SMI or ZENO if overlaps present (legacy)"), AUTO_CALC_HYDRO_SMI);
  ...
  {
    int index = cmb_auto_calc_hydro_method->findData (
        (int)(*misc).auto_calc_hydro_method);
    if (index != -1)
      {
  ...
  connect (cmb_auto_calc_hydro_method, SIGNAL (currentIndexChanged (QString)),
           SLOT (update_auto_calc_hydro_method ()));
  ...
  leftside->setContentsMargins (margin, margin, margin, margin);
  {
    ...
    leftside->addWidget (lbl_bead_model_controls, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
    j++;
    ...
    // leftside->addWidget( cb_export_msroll , j , 0 , 1 + ( j ) - ( j ) , 1 +
    // ( 1  ) - ( 0 ) ); j++; leftside->addWidget( cb_export_ssbond , j , 0 , 1
    // + ( j ) - ( j ) , 1 + ( 1  ) - ( 0 ) ); j++;
  ...
  rightside->setContentsMargins (margin, margin, margin, margin);
  {
    ...
    // rightside->addWidget( lbl_hydro_method , j , 0 , 1 + ( j ) - ( j ) , 1 +
    // ( 1 ) - ( 0 ) ); j++; rightside->addWidget(cb_hydro_supc, j, 0);
    // rightside->addWidget(cb_hydro_zeno, j, 1);
    // j++;
    // rightside->addWidget( lbl_threshold , j , 0 , 1 + ( j ) - ( j ) , 1 + (
    // 1 ) - ( 0 ) ); j++; rightside->addWidget(lbl_covolume, j, 0);
...
void
US_Hydrodyn_Misc::update_vbar (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_vbar_temperature (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_vbar_signal (float /* val1 */, float val2)
{
  QString str;
  // float vbar20;
  // vbar20 = val1;
...
US_Hydrodyn_Misc::select_vbar ()
{
  ...
  connect (vbar_dlg, SIGNAL (valueChanged (float, float)),
           SLOT (update_vbar_signal (float, float)));
  vbar_dlg->exec ();
  emit vbar_changed ();
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
#endif
...
void
US_Hydrodyn_Misc::set_pb_rule_on ()
{
...
void
US_Hydrodyn_Misc::update_target_e_density (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_target_volume (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_covolume (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_thresh_carb_O (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_thresh_carb_N (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_vdw_ot_mult (const QString &str)
{
...
void
US_Hydrodyn_Misc::update_vdw_ot_dpct (const QString &str)
{
...
void
US_Hydrodyn_Misc::set_vdw_ot_alt ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_ot_alt"]
      = cb_vdw_ot_alt->isChecked () ? "true" : "false";
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_Misc::set_vdw_saxs_water_beads ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_saxs_water_beads"]
      = cb_vdw_saxs_water_beads->isChecked () ? "true" : "false";
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_Misc::set_vdw_saxs_skip_pr0pair ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_saxs_skip_pr0pair"]
      = cb_vdw_saxs_skip_pr0pair->isChecked () ? "true" : "false";
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_Misc::set_set_target_on_load_pdb ()
{
...
void
US_Hydrodyn_Misc::set_equalize_radii ()
{
...
void
US_Hydrodyn_Misc::set_export_msroll ()
{
...
void
US_Hydrodyn_Misc::set_export_ssbond ()
{
...
void
US_Hydrodyn_Misc::set_parallel_grpy ()
{
...
void
US_Hydrodyn_Misc::cancel ()
{
  close ();
}

void
US_Hydrodyn_Misc::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Misc::update_hydrovol (double val)
{
  (*misc).hydrovol = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_Misc::update_avg_radius (double val)
{
  (*misc).avg_radius = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_Misc::update_avg_mass (double val)
{
  (*misc).avg_mass = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_Misc::update_avg_num_elect (double val)
{
...
void
US_Hydrodyn_Misc::update_avg_protons (double val)
{
...
void
US_Hydrodyn_Misc::update_avg_hydration (double val)
{
...
void
US_Hydrodyn_Misc::update_avg_volume (double val)
{
  (*misc).avg_volume = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_Misc::update_avg_vbar (double val)
{
  (*misc).avg_vbar = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_Misc::update_auto_calc_hydro_method ()
{
...
void
US_Hydrodyn_Misc::closeEvent (QCloseEvent *e)
{
  *misc_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
