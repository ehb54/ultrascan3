...
US_Hydrodyn_Dad_Gauss_Mode::US_Hydrodyn_Dad_Gauss_Mode (
...
void
US_Hydrodyn_Dad_Gauss_Mode::setupGUI ()
{
  int minHeight1 = 30;
...
void
US_Hydrodyn_Dad_Gauss_Mode::quit ()
{
  close ();
}

void
US_Hydrodyn_Dad_Gauss_Mode::ok ()
{
  (*parameters)["ok"] = "true";
...
void
US_Hydrodyn_Dad_Gauss_Mode::help ()
{
  US_Help *online_help;
  online_help = new US_Help (this);
  online_help->show_help ("manual/somo/dad_gauss_mode.html");
}

void
US_Hydrodyn_Dad_Gauss_Mode::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Dad_Gauss_Mode::update_enables ()
{
}

void
US_Hydrodyn_Dad_Gauss_Mode::clear_gauss ()
{
  if (QMessageBox::Yes
