          ...
          control_parameters[ "output" ] == "dat" ) )
   {
      ...
      if ( fsaxs ) 
      {
         ...
         QString last_saxs_header =
            QString::asprintf( "Simulated SAXS data generated from %s by US_SOMO %s %s q(%f:%f ) step %f\n"
            ...
            it++ )
      {
               ...
               it2++ )
         {
            ...
            if ( any_for_this )
            {
               ...
               {
                  output_files << fname;
                  QString header = QString::asprintf( "Simulated SAXS data generated by US_SOMO %s"
                                                      , US_Version.toLatin1( ).data()
                                                      );
