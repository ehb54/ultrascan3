                                                     ...
                                                     ) : QDialog( p )
{
   ...
   setWindowTitle( us_tr( "US-SOMO: DAD : Make I*(q)" ) );
...
void US_Hydrodyn_Dad_Cistarq::setupGUI()
{
   ...
   lbl_title =  new QLabel      ( parameters->count( "ngmode" ) ?  us_tr( "US-SOMO: DAD : Make I*(q) without Gaussians" ) :  us_tr( "US-SOMO: DAD : Make I*(q)" ), this );
