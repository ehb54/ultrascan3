...
void US_Hydrodyn_Dad_Cistarq::setupGUI()
{
   ...
   lbl_title =  new QLabel      ( parameters->count( "ngmode" ) ?  us_tr( "US-SOMO: UV-Vis : Make I*(q) without Gaussians" ) :  us_tr( "US-SOMO: UV-Vis : Make I*(q)" ), this );
...
void US_Hydrodyn_Dad_Cistarq::quit()
{
   close();
}
...
void US_Hydrodyn_Dad_Cistarq::set_sd_source()
{
   update_enables();
}

void US_Hydrodyn_Dad_Cistarq::set_normalize()
{
   update_enables();
}

void US_Hydrodyn_Dad_Cistarq::set_I0se()
{
   update_enables();
}
