...
US_AddResidue::US_AddResidue (bool *widget_flag, const double hydrovol,
...
US_AddResidue::setupGUI ()
{
  ...
  lbl_atom_file->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));

  pb_select_residue_file
      = new QPushButton (us_tr ("Load Residue Definition File"), this);
  ...
  lbl_residue_file->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));

  lbl_numresidues
      = new QLabel (us_tr (" Number of Residues in File: 0"), this);
  ...
  lbl_numresidues->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));
  ...
  lb_residues->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  lb_residues->setMinimumHeight (minHeight1 * 5);
  connect (lb_residues, SIGNAL (itemSelectionChanged ()), this,
           SLOT (residue_selection_changed ()));
  ...
  lbl_residue_name->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1,
                                    QFont::Bold));

  le_residue_name = new QLineEdit (this);
  le_residue_name->setObjectName ("Residue name Line Edit");
  ...
  le_residue_name->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  connect (le_residue_name, SIGNAL (textChanged (const QString &)),
  ...
  lbl_residue_comment->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));

  le_residue_comment = new QLineEdit (this);
  le_residue_comment->setObjectName ("Residue name Line Edit");
  ...
  le_residue_comment->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  connect (le_residue_comment, SIGNAL (textChanged (const QString &)),
           SLOT (update_comment (const QString &)));
  ...
  lbl_numatoms->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  ...
  cnt_numatoms->setRange (0, 1000);
  cnt_numatoms->setSingleStep (1);
  ...
  connect (cnt_numatoms, SIGNAL (valueChanged (double)),
           SLOT (update_numatoms (double)));
  ...
  lbl_numbeads->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  ...
  cnt_numbeads->setRange (0, 1000);
  cnt_numbeads->setSingleStep (1);
  ...
  connect (cnt_numbeads, SIGNAL (valueChanged (double)),
           SLOT (update_numbeads (double)));
  ...
  AUTFBACK (lbl_type);
  lbl_type->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));

  cmb_type = new QComboBox (this);
  cmb_type->setObjectName ("Bead Color");
  cmb_type->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_type);
  cmb_type->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  lbl_molvol
      = new QLabel (us_tr (" Residue anhydrous mol. vol. [A^3]:"), this);
  ...
  AUTFBACK (lbl_molvol);
  lbl_molvol->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));

  le_molvol = new QLineEdit (this);
  le_molvol->setObjectName ("Residue molvol Line Edit");
  le_molvol->setPalette (PALET_NORMAL);
  AUTFBACK (le_molvol);
  le_molvol->setMinimumHeight (minHeight1);
  le_molvol->setEnabled (false);
  le_molvol->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_molvol, SIGNAL (textChanged (const QString &)),
           SLOT (update_molvol (const QString &)));

  lbl_vbar
      = new QLabel (us_tr (" Residue partial spec. vol. [cm^3/g]:"), this);
  ...
  AUTFBACK (lbl_vbar);
  lbl_vbar->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));

  le_vbar = new QLineEdit (this);
  le_vbar->setObjectName ("Residue vbar Line Edit");
  le_vbar->setPalette (PALET_NORMAL);
  AUTFBACK (le_vbar);
  le_vbar->setMinimumHeight (minHeight1);
  le_vbar->setEnabled (false);
  le_vbar->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  connect (le_vbar, SIGNAL (textChanged (const QString &)),
           SLOT (update_vbar (const QString &)));

  // lbl_vbar2 = new QLabel(us_tr(" Residue partial spec. vol. ionized
  // [cm^3/g]:"), this); Q_CHECK_PTR(lbl_vbar2);
  // lbl_vbar2->setAlignment(Qt::AlignLeft|Qt::AlignVCenter);
  // lbl_vbar2->setMinimumHeight(minHeight1);
  // lbl_vbar2->setPalette( PALET_LABEL );
  // AUTFBACK( lbl_vbar2 );
  // lbl_vbar2->setFont(QFont( USglobal->config_list.fontFamily,
  // USglobal->config_list.fontSize-1, QFont::Bold));

  // le_vbar2 = new QLineEdit( this );    le_vbar2->setObjectName( "Residue
  // vbar2 Line Edit" ); le_vbar2->setPalette( PALET_NORMAL ); AUTFBACK(
  // le_vbar2 ); le_vbar2->setMinimumHeight(minHeight1);
  // le_vbar2->setEnabled(false);
  // le_vbar2->setFont(QFont( USglobal->config_list.fontFamily,
  // USglobal->config_list.fontSize)); connect(le_vbar2,
  // SIGNAL(textChanged(const QString &)), SLOT(update_vbar2(const QString
  // &)));

  lbl_asa
      = new QLabel (us_tr (" Max. Accessible Surface Area [A^2]:    "), this);
  Q_CHECK_PTR (lbl_asa);
  lbl_asa->setMinimumHeight (minHeight1);
  lbl_asa->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_asa->setPalette (PALET_LABEL);
  AUTFBACK (lbl_asa);
  lbl_asa->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1, QFont::Bold));

  le_asa = new QLineEdit (this);
  le_asa->setObjectName ("Residue asa Line Edit");
  le_asa->setPalette (PALET_NORMAL);
  AUTFBACK (le_asa);
  le_asa->setMinimumHeight (minHeight1);
  le_asa->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_asa->setEnabled (false);
  connect (le_asa, SIGNAL (textChanged (const QString &)),
           SLOT (update_asa (const QString &)));

  pb_accept_residue
      = new QPushButton (us_tr (" Accept Residue and Continue "), this);
  Q_CHECK_PTR (pb_accept_residue);
  pb_accept_residue->setEnabled (false);
  pb_accept_residue->setMinimumHeight (minHeight1);
  pb_accept_residue->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 1));
  ...
  lbl_r_atoms
      = new QLabel (us_tr (" Select Residue Atom to be defined:  "), this);
  ...
  lbl_r_atoms->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));

  cmb_r_atoms = new QComboBox (this);
  cmb_r_atoms->setObjectName ("Residue's Atom Listing");
  cmb_r_atoms->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_r_atoms);
  cmb_r_atoms->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  //   cmb_r_atoms->setSizeLimit(5);
  cmb_r_atoms->setMinimumHeight (minHeight1);
  connect (cmb_r_atoms, SIGNAL (activated (int)), this,
           SLOT (select_r_atom (int)));

  lbl_define_atom
      = new QLabel (us_tr (" Select Atom from Lookup Table:"), this);
  ...
  lbl_define_atom->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));

  cmb_atoms = new QComboBox (this);
  cmb_atoms->setObjectName ("Atom Listing");
  cmb_atoms->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_atoms);
  cmb_atoms->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  //   cmb_atoms->setSizeLimit(5);
  cmb_atoms->setMinimumHeight (minHeight1);
  connect (cmb_atoms, SIGNAL (activated (int)), this,
           SLOT (update_hybrid (int)));

  lbl_define_hybrid
      = new QLabel (us_tr (" Select Hybridization for Atom:"), this);
  ...
  lbl_define_hybrid->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));

  cmb_hybrids = new QComboBox (this);
  cmb_hybrids->setObjectName ("Hybridization Listing");
  cmb_hybrids->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_hybrids);
  cmb_hybrids->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  lbl_positioning->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));
  ...
  cb_positioning->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  lbl_atom_hydration
      = new QLabel (us_tr (" Hydration Number for Atom: "), this);
  ...
  lbl_atom_hydration->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1,
                                      QFont::Bold));
  ...
  cnt_atom_hydration->setRange (0, 100);
  cnt_atom_hydration->setSingleStep (1);
  ...
  connect (cnt_atom_hydration, SIGNAL (valueChanged (double)),
           SLOT (update_atom_hydration (double)));
  ...
  lbl_enable_pKa->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1,
                                  QFont::Bold));
  ...
  cb_enable_pKa->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_pKa);
  lbl_pKa->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1, QFont::Bold));

  le_pKa = new QLineEdit (this);
  le_pKa->setObjectName ("Residue pKa Line Edit");
  le_pKa->setPalette (PALET_NORMAL);
  AUTFBACK (le_pKa);
  le_pKa->setMinimumHeight (minHeight1);
  le_pKa->setEnabled (false);
  le_pKa->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  connect (le_pKa, SIGNAL (textChanged (const QString &)),
           SLOT (update_pKa (const QString &)));

  lbl_define_hybrid2
      = new QLabel (us_tr (" Select Hybridization for Atom [pH 14]:"), this);
  ...
  lbl_define_hybrid2->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1,
                                      QFont::Bold));

  cmb_hybrids2 = new QComboBox (this);
  cmb_hybrids2->setObjectName ("Hybridization Listing");
  cmb_hybrids2->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_hybrids2);
  cmb_hybrids2->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  //   cmb_hybrids2->setSizeLimit(5);
  cmb_hybrids2->setMinimumHeight (minHeight1);

  lbl_atom_hydration2
      = new QLabel (us_tr (" Hydration Number for Atom [pH 14]: "), this);
  ...
  lbl_atom_hydration2->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));
  ...
  cnt_atom_hydration2->setRange (0, 100);
  cnt_atom_hydration2->setSingleStep (1);
  ...
  connect (cnt_atom_hydration2, SIGNAL (valueChanged (double)),
           SLOT (update_atom_hydration2 (double)));
  ...
  pb_accept_atom->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1));
  ...
  pb_atom_continue->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize + 1));
  pb_atom_continue->setPalette (PALET_PUSHB);
  connect (pb_atom_continue, SIGNAL (clicked ()), SLOT (atom_continue ()));

  lbl_info3
      = new QLabel (us_tr (" 3. Define Residue Bead Properties: "), this);
  ...
  lbl_r_beads
      = new QLabel (us_tr (" Select Residue Bead to be defined: "), this);
  ...
  lbl_r_beads->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));

  cmb_r_beads = new QComboBox (this);
  cmb_r_beads->setObjectName ("bead Listing");
  cmb_r_beads->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_r_beads);
  cmb_r_beads->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  //   cmb_r_beads->setSizeLimit(5);
  cmb_r_beads->setEnabled (false);
  cmb_r_beads->setMinimumHeight (minHeight1);
  connect (cmb_r_beads, SIGNAL (activated (int)), this,
           SLOT (select_r_bead (int)));
  ...
  lbl_bead_color->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1,
                                  QFont::Bold));

  cmb_bead_color = new QComboBox (this);
  cmb_bead_color->setObjectName ("Bead Color");
  cmb_bead_color->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_bead_color);
  cmb_bead_color->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  connect (cmb_bead_color, SIGNAL (activated (int)), this,
           SLOT (select_bead_color (int)));
  ...
  cb_hydration->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  ...
  cnt_hydration->setRange (0, 100);
  cnt_hydration->setSingleStep (1);
  ...
  connect (cnt_hydration, SIGNAL (valueChanged (double)),
           SLOT (update_hydration (double)));
  ...
  lbl_placing->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));

  cmb_placing = new QComboBox (this);
  cmb_placing->setObjectName ("Placing Combo");
  cmb_placing->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_placing);
  cmb_placing->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  connect (cmb_placing, SIGNAL (activated (int)), this,
           SLOT (select_placing_method (int)));

  lbl_select_beadatom = new QLabel (
      us_tr (" Select Atom for Bead (multi-selection OK): "), this);
  ...
  lbl_select_beadatom->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));

  lbl_list_beadatom
      = new QLabel (us_tr (" Currently defined Atoms for Bead: "), this);
  ...
  lbl_list_beadatom->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));
  ...
  lb_select_beadatom->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  connect (lb_select_beadatom, SIGNAL (itemSelectionChanged ()), this,
           SLOT (select_beadatom ()));

  lb_list_beadatom = new QListWidget (this);
  lb_list_beadatom->setPalette (PALET_NORMAL);
  AUTFBACK (lb_list_beadatom);
  lb_list_beadatom->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  lbl_beadchain->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));
  ...
  rb_backbone->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  rb_sidechain->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  lbl_bead_volume->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));

  le_bead_volume = new QLineEdit (this);
  le_bead_volume->setObjectName ("Bead Volume Line Edit");
  le_bead_volume->setPalette (PALET_NORMAL);
  AUTFBACK (le_bead_volume);
  le_bead_volume->setMinimumHeight (minHeight1);
  le_bead_volume->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  le_bead_volume->setEnabled (false);
  connect (le_bead_volume, SIGNAL (textChanged (const QString &)),
           SLOT (update_bead_volume (const QString &)));
  ...
  lbl_bead_mw->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));

  le_bead_mw = new QLineEdit (this);
  le_bead_mw->setObjectName ("Bead MW Line Edit");
  le_bead_mw->setPalette (PALET_NORMAL);
  AUTFBACK (le_bead_mw);
  le_bead_mw->setMinimumHeight (minHeight1);
  le_bead_mw->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_bead_mw->setEnabled (true);
  le_bead_mw->setReadOnly (true);

  lbl_bead_hydro_from_atom
      = new QLabel (us_tr (" Bead Hydration from Atoms' Values: "), this);
  ...
  lbl_bead_hydro_from_atom->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));

  le_bead_hydro_from_atom = new QLineEdit (this);
  le_bead_hydro_from_atom->setObjectName (
      "Bead Hydration from Atoms' Line Edit");
  ...
  le_bead_hydro_from_atom->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_bead_hydrovol->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));

  le_bead_hydrovol = new QLineEdit (this);
  le_bead_hydrovol->setObjectName ("Residue Volume Line Edit");
  le_bead_hydrovol->setPalette (PALET_NORMAL);
  AUTFBACK (le_bead_hydrovol);
  le_bead_hydrovol->setMinimumHeight (minHeight1);
  le_bead_hydrovol->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  lbl_bead_hydrorad->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));

  le_bead_hydrorad = new QLineEdit (this);
  le_bead_hydrorad->setObjectName ("Residue Volume Line Edit");
  le_bead_hydrorad->setPalette (PALET_NORMAL);
  AUTFBACK (le_bead_hydrorad);
  le_bead_hydrorad->setMinimumHeight (minHeight1);
  le_bead_hydrorad->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  pb_accept_bead->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1));
  ...
  pb_delete_residue->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 1));
  ...
  int /* rows=24, columns = 5, */ spacing = 2, j = 0, margin = 4,
                                  colspace = 10;
  ...
  {
    int rows = 13;
    background->addWidget (lb_list_beadatom, j, 3, 1 + (j + rows) - (j),
                           1 + (3) - (3));
    background->addWidget (lb_select_beadatom, j, 4, 1 + (j + rows) - (j),
                           1 + (4) - (4));
    j += rows + 1;
  }
...
void
US_AddResidue::enable_area_1 (bool state)
{
...
void
US_AddResidue::enable_area_2 (bool state)
{
...
void
US_AddResidue::enable_area_3 (bool state)
{
...
US_AddResidue::add ()
{
  ...
  if (cmp1 != cmp2)
    {
      switch (QMessageBox::warning (
          this, us_tr ("Attention:"),
          us_tr (
              "The residue volume does not match the volume of the beads:\n\n")
              + QString (
                    us_tr ("Residue volume: %1 A^3, Sum of beads: %2 A^3\n\n"))
                    .arg (cmp1)
                    .arg (cmp2)
              + us_tr ("What would you like to do?\n"),
          us_tr ("&Correct the bead volume manually"), us_tr ("&Override"), 0,
          0, 0))
        {
      ...
      //      US_Static::us_message("Attention:", "The residue volume does not
      //      match the volume of the beads:\n\n" + str1); return;
    }
  // info_residue( "add" );
  for (i = 0; i < residue_list.size (); i++)
    {
      if (residue_list[i].name.toUpper () == new_residue.name.toUpper ()
          && residue_list[i].comment.toUpper ()
                 == new_residue.comment.toUpper ())
        {
          item = (int)i;
  ...
  write_residue_file ();
  str1 = QString (us_tr (" Number of Residues in File: %1"))
...
void
US_AddResidue::read_residue_file (const QString &filename)
{
      ...
      while (!ts.atEnd ())
        {
          ...
          // ts >> numbeads;
          // ts >> new_residue.vbar;
          // //            cout << "name: " << new_residue.name << ", type: "
          // << new_residue.type
          // //                  << ", molvol: " << new_residue.molvol << ",
          // asa: " << new_residue.asa <<
          // //                  ", numatoms: " << numatoms << ", beads: " <<
          // numbeads << ", vbar: " << new_residue.vbar << endl; ts.readLine();
          // // read rest of line
          line_count++;
...
void
US_AddResidue::select_residue_file ()
{
...
void
US_AddResidue::calc_bead_mw (struct residue *res)
{
          ...
          if ((*res).r_atom[j].bead_assignment == i)
            {
              ...
              if (res->r_atom[j].ionization_index
                  && res->r_atom_1.count (res->r_atom[j].ionization_index))
                {
                  res->r_bead[i].atom_hydration2
                      += res->r_atom_1[res->r_atom[j].ionization_index]
                             .hydration;
                  res->r_bead[i].mw2
                      += res->r_atom_1[res->r_atom[j].ionization_index]
                             .hybrid.mw;
...
void
US_AddResidue::select_atom_file ()
{
              ...
              for (j = 0; j < atoms.size (); j++)
                {
                  if (atoms[j] == atom_list[i].name)
                    {
                      flag = true; // this atom_list item is already in the
                                   // atoms vector
                    }
                }
              if (flag)
...
void
US_AddResidue::update_name (const QString &str)
{
  new_residue.name = str;
}

void
US_AddResidue::update_comment (const QString &str)
{
  new_residue.comment = str;
}

void
US_AddResidue::update_numatoms (double val)
{
  QString str;
  new_residue.r_atom.clear ();
...
void
US_AddResidue::update_numbeads (double val)
{
  QString str;
  new_residue.r_bead.clear ();
...
void
US_AddResidue::update_molvol (const QString &str)
{
  new_residue.molvol = str.toFloat ();
}

void
US_AddResidue::update_vbar (const QString &str)
{
...
void
US_AddResidue::update_asa (const QString &str)
{
  new_residue.asa = str.toFloat ();
}

void
US_AddResidue::select_type (int val)
{
  new_residue.type = (unsigned int)val;
}

void
US_AddResidue::update_hybrid (int val)
{
  cmb_hybrids->clear ();
  cmb_hybrids2->clear ();
...
US_AddResidue::select_beadatom ()
{
  ...
  for (i = 0; i < (unsigned int)lb_select_beadatom->count (); i++)
    {
      if (new_residue.r_atom[i].bead_assignment == current_bead)
        {
          new_residue.r_atom[i].bead_assignment
              = 100000; // reset all atoms previously assigned to this bead to
                        // a different value
        }
    }
  for (i = 0; i < (unsigned int)lb_select_beadatom->count (); i++)
  ...
  calc_bead_mw (&new_residue);
  if (new_residue.r_bead[current_bead].atom_hydration
          == new_residue.r_bead[current_bead].atom_hydration2
      && new_residue.r_bead[current_bead].mw
             == new_residue.r_bead[current_bead].mw2)
    {
  ...
  else
    {
      new_residue.r_bead[current_bead].hydration
          = new_residue.r_bead[current_bead].atom_hydration;
      cnt_hydration->setValue (new_residue.r_bead[current_bead].hydration);
      str.sprintf ("[pH 0]: %.0f   [pH 14]: %.0f ",
                   new_residue.r_bead[current_bead].atom_hydration,
                   new_residue.r_bead[current_bead].atom_hydration2);
      cnt_hydration->setEnabled (false);
      cnt_hydration->setToolTip (
          us_tr ("Disabled because pKa values exist for at least one atom in "
                 "this bead<br>"));
      str2.sprintf ("[pH 0]: %7.2f  [pH 14]: %7.2f",
                    new_residue.r_bead[current_bead].mw,
                    new_residue.r_bead[current_bead].mw2);
    }
...
void
US_AddResidue::update_hydration (double val)
{
  new_bead.hydration = (unsigned int)val;
  cb_hydration->setChecked (new_bead.hydration != new_bead.atom_hydration);
  clear_bead_hydrated_info ();
}

void
US_AddResidue::update_atom_hydration (double val)
{
  new_atom.hydration = (unsigned int)val;
}

void
US_AddResidue::update_atom_hydration2 (double val)
{
  new_atom.hydration2 = (unsigned int)val;
}

void
US_AddResidue::select_bead_color (int val)
{
  if (val == 0 || val == 6)
    {
      QMessageBox::warning (
          this, us_tr ("UltraScan Warning"),
          us_tr ("Please note:\n\nBlack and brown are reserved "
...
void
US_AddResidue::select_placing_method (int val)
{
  new_bead.placing_method = (unsigned int)val;
}

void
US_AddResidue::select_r_bead (int val)
{
  ...
  if (1 || existing_residue)
    {
      ...
      new_bead.placing_method
          = new_residue.r_bead[current_bead].placing_method;
      ...
      if (enable_assign_hydration)
      ...
      else
        {
          ...
          cnt_hydration->setEnabled (false);
          cnt_hydration->setToolTip (
              us_tr ("Disabled because hydration or pKa values exist for at "
                     "least one atom in this residue<br>"));
          cb_hydration->setToolTip (
              us_tr ("Disabled because hydration or pKa values exist for at "
                     "least one atom in this residue<br>"));
          str2.sprintf ("[pH 0]: %7.2f  [pH 14]: %7.2f",
      ...
      // float h_volume  = new_residue.r_bead[current_bead].hydration       *
      // hydrovol + new_residue.r_bead[current_bead].volume; float h_volume2 =
      // new_residue.r_bead[current_bead].atom_hydration2 * hydrovol +
      // new_residue.r_bead[current_bead].volume;
      ...
      // } else {
      //    str.sprintf("[pH 0]: %7.2f A^3  [pH14]: %7.2f A^3", h_volume,
      //    h_volume2 ); str2.sprintf("[pH 0]: %7.2f A  [pH 14]: %7.2f A",
      //    radius, radius2 );
      // }
      ...
      if (new_residue.r_atom[i].bead_assignment == current_bead)
        {
          ...
          if (new_residue.r_atom[i].positioner)
            {
              str += " (" + new_residue.r_atom[i].hybrid.name
                     + ", Positioning: yes)";
            }
          else
            {
...
void
US_AddResidue::update_bead_hydrated_info ()
{
  int current_bead = cmb_r_beads->currentIndex ();
  // TSO << "update_hydrated_info() current_bead " << current_bead << "
  // start\n";

  float h_volume = new_residue.r_bead[current_bead].hydration * hydrovol
                   + new_residue.r_bead[current_bead].volume;
  float h_volume2 = new_residue.r_bead[current_bead].atom_hydration2 * hydrovol
                    + new_residue.r_bead[current_bead].volume;
  ...
  if (enable_assign_hydration || (h_volume == h_volume2 && radius == radius2))
    {
      str.sprintf ("%7.2f A^3", h_volume);
      str2.sprintf ("%7.2f A", radius);
    }
...
void
US_AddResidue::clear_bead_hydrated_info ()
{
...
void
US_AddResidue::select_r_atom (int val)
{
  if (1 || existing_residue)
    {
          ...
          if (cmb_atoms->itemText (i) == new_residue.r_atom[val].name)
            {
              ...
              update_hybrid (i);
              for (unsigned int j = 0; j < (unsigned int)cmb_hybrids->count ();
                   j++)
                {
                  if (cmb_hybrids->itemText (j)
                      == new_residue.r_atom[val].hybrid.name)
                    {
      ...
      // pKa enabled
      {
        ...
        //    QString().sprintf(
        //                      "select_r_atom(%d):\n"
        //                      "\tnew_residue.r_atom[%d].ionization_index
        //                      %d\n"
        //                      "\tr_atom_0.size() %d\n"
        //                      "\tr_atom_1.size() %d\n" ,val ,val,
        //                      new_residue.r_atom[val].ionization_index
        ...
        if (has_index)
          {
            for (unsigned int j = 0; j < (unsigned int)cmb_hybrids2->count ();
                 j++)
              {
                if (cmb_hybrids2->itemText (j)
                    == new_residue.r_atom_1[index].hybrid.name)
                  {
            ...
            le_pKa->setText (
                QString ("%1").arg (new_residue.r_atom_1[index].pKa));
            cnt_atom_hydration2->setValue (
                (double)new_residue.r_atom_1[index].hydration);
          }
      }
    }
}
...
void
US_AddResidue::select_residue (int val)
{
  ...
  // le_vbar2->setText( residue_list[val].vbar2 != 0 ? str.sprintf("%5.3f",
  // residue_list[val].vbar2 ) : QString( "" ) ); le_pKa->setText(
  // residue_list[val].pKa != 0 ? str.sprintf("%5.3f", residue_list[val].pKa) :
  // QString( "" ) );
...
void
US_AddResidue::residue_selection_changed ()
{
  emit select_residue (lb_residues->currentRow ());
}

void
US_AddResidue::print_residue (struct residue res)
{
  unsigned int i;
...
void
US_AddResidue::reset (bool /* reselect */)
{
  // some oddness on pb_reset, clears too much but this reset() is called in
  // multiple places
...
US_AddResidue::accept_residue ()
{
  ...
  if (new_residue.name.isEmpty () || new_residue.r_atom.size () == 0
      || new_residue.r_bead.size () == 0 || new_residue.molvol == 0
      || new_residue.vbar == 0 || new_residue.asa == 0)
    {
      QMessageBox::warning (this, us_tr ("UltraScan Warning"),
  ...
  if (existing_residue)
    {
      ...
      //       {
      //          if (cmb_hybrids->itemText(j) ==
      //          new_residue.r_atom[0].hybrid.name)
      //          {
      //             cmb_hybrids->setCurrentIndex(j);
      //             break;
      //          }
      ...
      //    cb_positioning->setChecked(false);
      // }
      // cnt_atom_hydration->setValue((double)
      // new_residue.r_atom[0].hydration);
    }
  else
    {
      for (unsigned int i = 0; i < new_residue.r_atom.size (); i++)
  ...
  // if we loaded an existing residue for editing and all atoms have been
  // defined, we can activate the Continue button at this point. First, we need
  // to check that the atoms all have been defined.
  QString str;
  bool flag = true;
...
void
US_AddResidue::accept_bead ()
{
  if (new_bead.volume == 0.0)
    {
      US_Static::us_message ("Attention:",
                             "No bead volume entered for this bead!\nPlease "
  ...
  if (new_bead.color == 0 || new_bead.color == 6)
    {
      QMessageBox::warning (
          this, us_tr ("UltraScan Warning"),
          us_tr ("Please note:\n\nBlack (0) and brown (6) are reserved "
...
void
US_AddResidue::accept_atom ()
{
  int current_item1, current_item2 = 0;
  if (existing_residue)
    {
      position_flag
          = new_residue.r_atom[cmb_r_atoms->currentIndex ()].positioner;
    }
#if defined(DEBUG_RESIDUE)
  ...
  for (unsigned int i = 0; i < atom_list.size (); i++)
    {
      if (cmb_atoms->currentText () == atom_list[i].name
          && cmb_hybrids->currentText () == atom_list[i].hybrid.name)
        {
          current_item2 = i;
          break;
        }
  ...
  if (existing_residue)
    {
      ...
      int ionization_index
          = new_residue.r_atom[current_item1].ionization_index;
  ...
  // assign a serial number specific to this residue so atoms can be
  // distinguished and prevented from being used twice in different beads

  new_residue.r_atom[current_item1].hydration
      = (unsigned int)cnt_atom_hydration->value ();
  new_residue.r_atom[current_item1].serial_number = current_item1;
  new_residue.r_atom[current_item1].positioner
      = cb_positioning->isChecked (); // position_flag;

  str.sprintf (qPrintable ("Atom %d: " + atom_list[current_item2].name),
               current_item1 + 1);
  str += " (" + new_residue.r_atom[current_item1].hybrid.name
         + ", Positioning: ";
...
void
US_AddResidue::info_residue (const QString &msg)
{
  TSO << LD << "info_residue() : " << msg << Qt::endl << LD;

  TSO << new_residue.comment << Qt::endl;
  TSO << new_residue.name.toUpper () << "\t" << new_residue.type << "\t"
      << QString ().sprintf ("%7.2f", new_residue.molvol) << "\t"
      << new_residue.asa << "\t" << new_residue.r_atom.size () << "\t"
      << new_residue.r_bead.size () << "\t" << new_residue.vbar;

  for (int j = 0; j < (int)new_residue.pKas.size (); ++j)
    {
      TSO << "\t" << new_residue.vbar << "\t" << new_residue.pKas[j];
    }
          ...
          if (new_residue.r_atom_1.count (ionization_index))
            {
              TSO << "\t" << ionization_index << "\t"
                  ...
                  << new_residue.r_atom_1[ionization_index].bead_assignment
                  << "\t"
                  << (unsigned int)new_residue.r_atom_1[ionization_index]
                         .positioner
                  << "\t"
  ...
  for (int i = 0; i < (int)new_residue.r_atom.size (); ++i)
    {
      TSO << QString ("r_atom %1 name %2 hybrid.name %3 ionization_index %4\n")
                 .arg (i, 2)
  ...
  for (auto it = new_residue.r_atom_1.begin ();
       it != new_residue.r_atom_1.end (); ++it)
    {
      TSO << QString (
                 "r_atom_1 %1 name %2 hybrid.name %3 ionization_index %4\n")
                 .arg (it->first, 2)
  ...
  for (int i = 0; i < (int)new_residue.pKas.size (); ++i)
    {
      TSO << QString (" new_residue.pKas[%1] = %2\n")
                 .arg (i)
...
bool
US_AddResidue::update_pKas (int atomno)
{
  TSO << LEQ;
      ...
      if (cb_enable_pKa->isChecked ())
        {
          ...
          if (!new_residue.r_atom_1.count (ionization_index))
            {
              TSO << "ERROR new_residue.r_atom_1 missing ionization index "
                  << ionization_index << Qt::endl;
              ok = false;
            }
          pKas_need_sort
              = new_residue.pKas.size () > 1
                && new_residue.pKas[ionization_index - 1] != new_atom.pKa;
          new_residue.pKas[ionization_index - 1] = new_atom.pKa;
          new_residue.r_atom_1[ionization_index].hybrid
              = atom_list[atom_list_pos_hybrid2].hybrid;
          new_residue.r_atom_1[ionization_index].hydration
              = new_atom.hydration2;
          new_residue.r_atom_1[ionization_index].pKa = new_atom.pKa;
          new_residue.r_atom[atomno].ionization_index = ionization_index;
          new_residue.r_atom_1[ionization_index].ionization_index
              = ionization_index;
        }
      else
        {
          // removed a pKa
          TSO << "update_pKas() removed a pKa with ionization index "
              << ionization_index << "\n";
      ...
      if (cb_enable_pKa->isChecked ())
        {
          ...
          new_residue.r_atom_1[ionization_index]
              = atom_list[atom_list_pos_hybrid2];
          new_residue.r_atom_1[ionization_index].hybrid
              = atom_list[atom_list_pos_hybrid2].hybrid;
          new_residue.r_atom_1[ionization_index].hydration
              = new_atom.hydration2;
          ...
          new_residue.r_atom_1[ionization_index].ionization_index
              = ionization_index;
          new_residue.r_atom_1[ionization_index].bead_assignment
              = new_residue.r_atom[atomno].bead_assignment;
          new_residue.r_atom_1[ionization_index].positioner
              = new_residue.r_atom[atomno].positioner;
          new_residue.r_atom_1[ionization_index].serial_number
              = new_residue.r_atom[atomno].serial_number;
        }
      else
        {
          // nothing to do
  ...
  for (int i = 0; i < (int)new_residue.r_atom.size (); ++i)
    {
      if (atom_name_to_no[new_residue.r_atom[i].name]
        ...
        {
          errors += QString ("Duplicate atom name %1 found in atom %2, atom "
      ...
      if (new_residue.r_atom[i].name.isEmpty ())
        {
          errors += QString ("Undefined atom name for atom %2\n").arg (i + 1);
          ok = false;
        }
      ...
      for (auto it = new_residue.r_atom_1.begin ();
           it != new_residue.r_atom_1.end (); ++it)
        {
          if ((int)new_residue.pKas.size () < it->first)
            {
              TSO << "ERROR new_residue.pKas don't contain expected "
                     "ionization index\n";
              ok = false;
            }
          else
            {
              TSO << "update_pKas() assigning tmp index " << it->first
                  << Qt::endl;
      ...
      for (auto it = tmp.begin (); it != tmp.end (); ++it)
        {
          ...
          new_residue.r_atom[atom_name_to_no[it->second.name]].ionization_index
              = it->second.ionization_index;
        }
    }

  if (new_residue.pKas.size () > 2)
    {
      errors += QString ("Currently only 2 atoms with pKa enabled are "
                         "supported, you have defined %1\n")
  ...
  if (!errors.isEmpty ())
    {
      QMessageBox::warning (this, us_tr (windowTitle ()),
                            us_tr ("Warning: problems below must be corrected "
...
void
US_AddResidue::set_chain (int val)
{
  new_bead.chain = val;
}

void
US_AddResidue::set_positioning ()
{
  ...
  if (cb_enable_pKa->isChecked ())
    {
      ...
      lbl_define_hybrid->setText (
          us_tr (" Select Hybridization for Atom [pH 0]:"));
      lbl_atom_hydration->setText (
          us_tr (" Hydration Number for Atom [pH 0]:"));
    }
  else
    {
      pKa_flag = false;
...
void
US_AddResidue::closeEvent (QCloseEvent *e)
{
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_AddResidue::update_bead_volume (const QString &val)
{
...
void
US_AddResidue::update_pKa (const QString &val)
{
  new_atom.pKa = val.toFloat ();
}

void
US_AddResidue::delete_residue ()
{
  QString str1;
  ...
  write_residue_file ();
  str1 = QString (us_tr (" Number of Residues in File: %d"))
             .arg (residue_list.size ());
  lbl_numresidues->setText (str1);
  pb_accept_bead->setEnabled (false);
  pb_add->setEnabled (false);
...
void
US_AddResidue::write_residue_file ()
{
  QString str1;
  QFile f (residue_filename);
  ...
  if (f.open (QIODevice::WriteOnly | QIODevice::Text))
    {
      ...
      QTextStream ts (&f);
      qDebug () << "write residue file, residue_list.size(): "
                << residue_list.size ();
      ...
      public:
        ...
        bool
        operator< (const sortable_residue &objIn) const
        {
          return type == objIn.type
                     ? (name == objIn.name ? comment < objIn.comment
                                           : name < objIn.name)
                     : type < objIn.type;
        }
      };
...

      {
        ...
        for (auto it = sort_residues.begin (); it != sort_residues.end ();
             ++it)
          {
      ...
      for (unsigned int i = 0; i < residue_list.size (); i++)
        {
          qDebug () << "write residue file name:"
                    << residue_list[i].name.toUpper ();
          ...
          for (unsigned int j = 0; j < residue_list[i].r_atom.size (); j++)
            {
              ...
              if (residue_list[i].r_atom[j].ionization_index)
                {
                  int ionization_index
                      = residue_list[i].r_atom[j].ionization_index;
                  if (residue_list[i].r_atom_1.count (ionization_index))
                    {
                      ts << "\t" << ionization_index << "\t"
                         << residue_list[i]
                                .r_atom_1[ionization_index]
                                .hybrid.name
                         << "\t"
                         << residue_list[i]
                                .r_atom_1[ionization_index]
