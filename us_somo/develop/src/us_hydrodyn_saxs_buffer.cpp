...
US_Hydrodyn_Saxs_Buffer::US_Hydrodyn_Saxs_Buffer (csv csv1, void *us_hydrodyn,
    ...
    : QFrame (p)
{
...

  {
    ...
    for (unsigned int i = 0; i < pbs.size (); i++)
      {
        pbs[i]->setMaximumWidth (percharwidth
                                 * (pbs[i]->text ().length () + 2));
      }
  }
...
void
US_Hydrodyn_Saxs_Buffer::setupGUI ()
{
  int minHeight1 = 24;
  int minHeight3 = 25;
  ...
  pb_asum->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1));
  ...
  pb_conc_avg
      = new QPushButton (us_tr ("Concentration normalized average"), this);
  ...
  pb_set_buffer->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_buffer);
  lbl_buffer->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  lbl_created_dir->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 2));
  connect (lbl_created_dir, SIGNAL (pressed ()),
           SLOT (created_dir_pressed ()));
  ...
  pb_run_current
      = new QPushButton (us_tr ("Current value buffer subtraction"), this);
  ...
  pb_run_divide
      = new QPushButton (us_tr ("Current value buffer divide"), this);
  pb_run_divide->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
...
#endif
#if QT_VERSION < 0x040000
  connect (plot_dist->canvas (), SIGNAL (mouseReleased (const QMouseEvent &)),
  ...
  pb_join_start->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_join_swap = new QPushButton (
      join_adjust_lowq ? us_tr ("Scale high-q") : us_tr ("Scale low-q"), this);
  pb_join_swap->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  lbl_join_offset->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));

  le_join_offset = new mQLineEdit (this);
  le_join_offset->setObjectName ("le_join_offset Line Edit");
  ...
  le_join_offset->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  le_join_offset->setEnabled (false);
  le_join_offset->setValidator (new QDoubleValidator (le_join_offset));
  connect (le_join_offset, SIGNAL (textChanged (const QString &)),
           SLOT (join_offset_text (const QString &)));
  connect (le_join_offset, SIGNAL (focussed (bool)),
           SLOT (join_offset_focus (bool)));
  ...
  lbl_join_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));

  le_join_mult = new mQLineEdit (this);
  le_join_mult->setObjectName ("le_join_mult Line Edit");
  ...
  le_join_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  le_join_mult->setEnabled (false);
  le_join_mult->setValidator (new QDoubleValidator (le_join_mult));
  connect (le_join_mult, SIGNAL (textChanged (const QString &)),
           SLOT (join_mult_text (const QString &)));
  connect (le_join_mult, SIGNAL (focussed (bool)),
           SLOT (join_mult_focus (bool)));
  ...
  lbl_join_start->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));

  le_join_start = new mQLineEdit (this);
  le_join_start->setObjectName ("le_join_start Line Edit");
  ...
  le_join_start->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_join_start->setEnabled (false);
  le_join_start->setValidator (new QDoubleValidator (le_join_start));
  connect (le_join_start, SIGNAL (textChanged (const QString &)),
           SLOT (join_start_text (const QString &)));
  connect (le_join_start, SIGNAL (focussed (bool)),
           SLOT (join_start_focus (bool)));
  ...
  lbl_join_point->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));

  le_join_point = new mQLineEdit (this);
  le_join_point->setObjectName ("le_join_point Line Edit");
  ...
  le_join_point->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_join_point->setEnabled (false);
  le_join_point->setValidator (new QDoubleValidator (le_join_point));
  connect (le_join_point, SIGNAL (textChanged (const QString &)),
           SLOT (join_point_text (const QString &)));
  connect (le_join_point, SIGNAL (focussed (bool)),
           SLOT (join_point_focus (bool)));
  ...
  lbl_join_end->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));

  le_join_end = new mQLineEdit (this);
  le_join_end->setObjectName ("le_join_end Line Edit");
  le_join_end->setText ("");
  le_join_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_join_end->setPalette (PALET_NORMAL);
  AUTFBACK (le_join_end);
  le_join_end->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  le_join_end->setEnabled (false);
  le_join_end->setValidator (new QDoubleValidator (le_join_end));
  connect (le_join_end, SIGNAL (textChanged (const QString &)),
           SLOT (join_end_text (const QString &)));
  connect (le_join_end, SIGNAL (focussed (bool)),
           SLOT (join_end_focus (bool)));

  pb_join_fit_scaling = new QPushButton (us_tr ("Fit"), this);
  pb_join_fit_scaling->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  ...
  connect (pb_join_fit_scaling, SIGNAL (clicked ()),
           SLOT (join_fit_scaling ()));

  pb_join_fit_linear = new QPushButton (us_tr ("Linear"), this);
  pb_join_fit_linear->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  lbl_join_rmsd->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  lbl_guinier->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_np);
  lbl_np->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));

  rb_np_crop = new QRadioButton (us_tr ("Crop "), this);
  rb_np_crop->setEnabled (true);
  rb_np_crop->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  rb_np_min->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  rb_np_min->setPalette (PALET_NORMAL);
  AUTFBACK (rb_np_min);

  rb_np_ignore = new QRadioButton (
      us_tr ("Ignore (log of non-positive not defined)"), this);
  rb_np_ignore->setEnabled (true);
  rb_np_ignore->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  rb_np_ask->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  cb_multi_sub->setText (us_tr (" Subtract buffer from every selected file "
                                "(exepting set buffer and set blank) "));
  cb_multi_sub->setChecked (false);
  cb_multi_sub->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  cb_multi_sub_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  cb_multi_sub_conc_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  vbl_files->setContentsMargins (0, 0, 0, 0);
  vbl_files->setSpacing (0);
  ...
  QHBoxLayout *hbl_join = new QHBoxLayout ();
  hbl_join->setContentsMargins (0, 0, 0, 0);
  hbl_join->setSpacing (0);
  ...
  hbl_plot_buttons->setContentsMargins (0, 0, 0, 0);
  hbl_plot_buttons->setSpacing (0);
  ...
  hbl_plot_buttons_2->setContentsMargins (0, 0, 0, 0);
  hbl_plot_buttons_2->setSpacing (0);
  ...
  // hbl_files_plot->setSpacing( 0 ); hbl_files_plot->addLayout( vbl_files );
  ...
  QHBoxLayout *hbl_np = new QHBoxLayout ();
  hbl_np->setContentsMargins (0, 0, 0, 0);
  hbl_np->setSpacing (0);
  ...
  QHBoxLayout *hbl_multi = new QHBoxLayout ();
  hbl_multi->setContentsMargins (0, 0, 0, 0);
  hbl_multi->setSpacing (0);
...
void
US_Hydrodyn_Saxs_Buffer::cancel ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Buffer::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Buffer::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Buffer::table_value (int row, int col)
{
  cout << "table value\n";
  if (col == 2 || col == 3 || col == 5 || col == 6)
    {
      if (!t_csv->item (row, col)->text ().isEmpty ()
          && t_csv->item (row, col)->text ()
                 != QString ("%1").arg (
                     t_csv->item (row, col)->text ().toDouble ()))
        {
          t_csv->setItem (row, col,
...
void
US_Hydrodyn_Saxs_Buffer::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
}
...
void
US_Hydrodyn_Saxs_Buffer::update_font ()
{
  bool ok;
  QFont newFont;
...
void
US_Hydrodyn_Saxs_Buffer::start ()
{
  if (!validate () || !any_to_run ())
    {
      return;
    }
...
void
US_Hydrodyn_Saxs_Buffer::run_current ()
{
  if (cb_multi_sub->isChecked ())
    {
      ...
      for (int i = 0; i < lb_files->count (); i++)
        {
          if (lb_files->item (i)->isSelected ()
            ...
            {
              selected_non_buffer_non_empty[lb_files->item (i)->text ()]
                  = true;
            }
        }
      ...
      for (map<QString, bool>::iterator it
           = selected_non_buffer_non_empty.begin ();
           it != selected_non_buffer_non_empty.end (); it++)
        {
          if (!is_running)
            {
...
void
US_Hydrodyn_Saxs_Buffer::run_divide ()
{
  if (cb_multi_sub->isChecked ())
    {
      bool is_running = running;
...
void
US_Hydrodyn_Saxs_Buffer::run_one (bool do_plot)
{
  // subtract buffer
  ...
  if (!current_files.count (buffer))
    {
      editor_msg (
          "red",
          QString (us_tr ("Error: no data found for buffer %1")).arg (buffer));
      return;
    }
  ...
  if (!current_files.count (solution))
    {
      editor_msg ("red",
                  QString (us_tr ("Error: no data found for solution %1"))
                      .arg (solution));
      return;
    }
  ...
  if (!empty.isEmpty () && !current_files.count (empty))
    {
      editor_msg (
          "red",
          QString (us_tr ("Error: no data found for blank %1")).arg (empty));
      return;
    }
  ...
  for (unsigned int j = 0; j < f_Is[buffer].size (); j++)
    {
      if (fabs (bsub_q[j] - f_qs[buffer][j]) > Q_VAL_TOL
        ...
        {
          editor_msg ("red", us_tr ("Error: incompatible grids, the q values "
  ...
  if ((!use_alpha && !use_psv) || (use_alpha && use_psv))
    {
      editor_msg ("red",
                  us_tr ("Internal error: both alpha & psv methods active"));
      return;
    }

  if ((use_alpha && t_csv->item (0, 6)->text ().isEmpty ())
      || (use_psv
          && (t_csv->item (1, 6)->text ().isEmpty ()
              || t_csv->item (2, 6)->text ().isEmpty ())))
    {
      editor_msg (
          "red",
          us_tr (
              "Internal error: method selected does not have current values"));
      return;
    }
  ...
  if (use_psv)
    {
      if (!concs.count (solution) || concs[solution] == 0e0)
        {
          editor_msg ("dark red",
                      us_tr ("Warning: the solution has zero concentration"));
        }
  ...
  if (buffer_has_errors && !solution_has_errors)
    {
      editor_msg (
          "dark red",
          us_tr (
              "Warning: the buffer has errors defined but not the solution"));
      ...
      if (!buffer_has_errors && !solution_has_errors && empty_has_errors)
        {
          ...
          editor_msg ("dark red",
                      us_tr ("Warning: the blank has errors defined but not "
                             "the solution or buffer!"));
      ...
      if (!empty.isEmpty ())
        {
          ...
          if ((buffer_has_errors || solution_has_errors) && empty_has_errors)
            {
              bsub_error[i]
                  = sqrt (bsub_error[i] * bsub_error[i]
                          + (1e0 - alpha) * (1e0 - alpha) * f_errors[empty][i]
                                * f_errors[empty][i]);
            }
        }
    }
  ...
  if (any_negative)
    {
      ...
      if (rb_np_crop->isChecked ())
        {
          editor_msg ("dark red",
                      QString (us_tr ("Warning: non-positive values caused "
                                      "cropping at q = %1"))
      ...
      if (rb_np_min->isChecked ())
        {
          editor_msg ("dark red",
                      QString (us_tr ("Warning: non-positive values caused %1 "
                                      "minimum values set"))
                          .arg (negative_count));
          result = 1;
        }
      if (rb_np_ignore->isChecked ())
        {
          editor_msg (
              "dark red",
              QString (us_tr ("Warning: %1 non-positive values ignored"))
                  .arg (negative_count));
          result = 2;
        }
      if (rb_np_ask->isChecked ())
        {
          result = QMessageBox::warning (
              ...
              QString (us_tr ("Please note:\n\n"
                              "The buffer subtraction causes %1 points be "
                              "non-positive\n"
            ...
            if (negative_pos < 2)
              {
                if (rb_np_ask->isChecked ())
                  ...
                  {
                    editor_msg ("red",
                                us_tr ("Notice: Cropping left nothing"));
                  }
                return;
              }
  ...
  QString head
      = solution + QString ("_bsub_a%1").arg (alpha).replace (".", "_");
  unsigned int ext = 0;
  ...
  for (unsigned int i = 0; i < csv_conc.data.size (); i++)
    {
      if (csv_conc.data[i].size () > 1 && csv_conc.data[i][0] == bsub_name)
        {
...
void
US_Hydrodyn_Saxs_Buffer::run_best ()
{
}

void
US_Hydrodyn_Saxs_Buffer::stop ()
{
  running = false;
...
void
US_Hydrodyn_Saxs_Buffer::update_enables ()
{
  ...
  pb_set_signal->setEnabled (
      files_selected_count == 1
      && lb_files->item (last_selected_pos)->text () != lbl_buffer->text ()
      && lb_files->item (last_selected_pos)->text () != lbl_empty->text ()
      && lb_files->item (last_selected_pos)->text () != lbl_signal->text ());
  pb_set_empty->setEnabled (
      files_selected_count == 1
      && lb_files->item (last_selected_pos)->text () != lbl_buffer->text ()
      && lb_files->item (last_selected_pos)->text () != lbl_empty->text ()
      && lb_files->item (last_selected_pos)->text () != lbl_signal->text ());
  ...
  pb_start->setEnabled (
      !running && any_selected
      && (!lbl_signal->text ().isEmpty ()
          || (cb_multi_sub->isChecked ()
              && non_buffer_non_empty_files_selected_count > 0))
      && !lbl_buffer->text ().isEmpty ());
  pb_run_current->setEnabled (
      !running && any_selected
      && (!lbl_signal->text ().isEmpty ()
          || (cb_multi_sub->isChecked ()
              && non_buffer_non_empty_files_selected_count > 0))
      && !lbl_buffer->text ().isEmpty () && !any_current_empty);
  pb_run_divide->setEnabled (
      !running && any_selected
      && (!lbl_signal->text ().isEmpty ()
          || (cb_multi_sub->isChecked ()
              && non_buffer_non_empty_files_selected_count > 0))
      && !lbl_buffer->text ().isEmpty () && !any_current_empty);
  pb_run_best->setEnabled (
      !running
      && (!lbl_signal->text ().isEmpty ()
          || (cb_multi_sub->isChecked ()
              && non_buffer_non_empty_files_selected_count > 0))
      && !lbl_buffer->text ().isEmpty () && !any_best_empty && any_selected);
...
bool
US_Hydrodyn_Saxs_Buffer::any_to_run ()
{
  for (unsigned int i = 0; i < (unsigned int)t_csv->rowCount (); i++)
    {
      if (((QCheckBox *)(t_csv->cellWidget (i, 1)))->isChecked ())
...
void
US_Hydrodyn_Saxs_Buffer::editor_msg (QString color, QString msg)
{
...
void
US_Hydrodyn_Saxs_Buffer::editor_msg_qc (QColor qcolor, QString msg)
{
  QColor save_color = editor->textColor ();
...
bool
US_Hydrodyn_Saxs_Buffer::validate ()
{
  bool errors = false;
...
bool
US_Hydrodyn_Saxs_Buffer::activate_saxs_window ()
{
  if (!*saxs_widget)
    {
...
csv
US_Hydrodyn_Saxs_Buffer::current_csv ()
{
  csv tmp_csv = csv1;
...
void
US_Hydrodyn_Saxs_Buffer::recompute_interval_from_points ()
{
  for (unsigned int i = 0; i < (unsigned int)t_csv->rowCount (); i++)
    {
      QString toset
...
void
US_Hydrodyn_Saxs_Buffer::recompute_points_from_interval ()
{
  for (unsigned int i = 0; i < (unsigned int)t_csv->rowCount (); i++)
    {
      QString toset
...
void
US_Hydrodyn_Saxs_Buffer::clear_files ()
{
  QStringList files;
  for (int i = 0; i < lb_files->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::clear_files (QStringList files)
{
  ...
  disable_updates = false;
  plot_files ();
  if (!lb_files->count () && plot_dist_zoomer)
    {
      delete plot_dist_zoomer;
      plot_dist_zoomer = (ScrollZoomer *)0;
    }
...
void
US_Hydrodyn_Saxs_Buffer::add_files ()
{
  ...
  if (cb_lock_dir->isChecked ())
    {
      ((US_Hydrodyn *)us_hydrodyn)
          ->add_to_directory_history (lbl_dir->text ());
    }
  ...
  if (filenames.size () > 1)
    {
      ...
      us_qdebug (QString ("sort head <%1> tail <%2>  dp %3 ")
                     .arg (head)
                     .arg (tail)
                     .arg (add_dp ? "yes" : "no"));
#endif
...
#ifdef DEBUG_LOAD_REORDER
          us_qdebug (
              QString ("sort tmp <%1> xval <%2>").arg (tmp).arg (sval.x));
#endif
        }
      if (reorder)
        {
...
void
US_Hydrodyn_Saxs_Buffer::add_files (QStringList filenames)
{
  map<QString, bool> existing_items;
  for (int i = 0; i < lb_files->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::plot_files ()
{
  ...
  for (int i = 0; i < lb_files->count (); i++)
    {
      if (lb_files->item (i)->isSelected ())
        {
          // any_selected = true;
          if (plot_file (lb_files->item (i)->text (), file_minx, file_maxx,
                         file_miny, file_maxy))
            {
              if (first)
                {
        ...
        {
          if (get_min_max (lb_files->item (i)->text (), file_minx, file_maxx,
                           file_miny, file_maxy))
            {
              if (first)
                {
...
bool
US_Hydrodyn_Saxs_Buffer::plot_file (QString file, double &minx, double &maxx,
  ...
  if (!axis_y_log)
    {
      ...
      plot_dist->setCurveData (
          ...
          (double *)&(f_qs[file][0]), (double *)&(f_Is[file][0]), q_points);
      plot_dist->setCurvePen (
          Iq,
          QPen (plot_colors[f_pos[file] % plot_colors.size ()], 1, SolidLine));
#else
      curve->setSamples (
      ...
      curve->setPen (QPen (plot_colors[f_pos[file] % plot_colors.size ()], 1,
                           Qt::SolidLine));
...
void
US_Hydrodyn_Saxs_Buffer::update_files ()
{
  if (!disable_updates)
    {
      plot_files ();
...
bool
US_Hydrodyn_Saxs_Buffer::get_min_max (QString file, double &minx, double &maxx,
                                      double &miny, double &maxy)
{
  if (!f_qs_string.count (file) || !f_qs.count (file) || !f_Is.count (file)
      || !f_pos.count (file))
...
void
US_Hydrodyn_Saxs_Buffer::invert ()
{
...
void
US_Hydrodyn_Saxs_Buffer::select_all ()
{
...
void
US_Hydrodyn_Saxs_Buffer::select_all_created ()
{
  bool all_selected = true;
  for (int i = 0; i < lb_created_files->count (); i++)
    {
...
bool
US_Hydrodyn_Saxs_Buffer::load_file (QString filename)
{
  errormsg = "";
  QFile f (filename);
  if (!f.exists ())
...
void
US_Hydrodyn_Saxs_Buffer::set_buffer ()
{
  for (int i = 0; i < lb_files->count (); i++)
    {
      if (lb_files->item (i)->isSelected ())
...
void
US_Hydrodyn_Saxs_Buffer::set_signal ()
{
  for (int i = 0; i < lb_files->count (); i++)
    {
      if (lb_files->item (i)->isSelected ())
...
void
US_Hydrodyn_Saxs_Buffer::set_empty ()
{
  for (int i = 0; i < lb_files->count (); i++)
    {
      if (lb_files->item (i)->isSelected ())
...
void
US_Hydrodyn_Saxs_Buffer::update_created_files ()
{
  if (!disable_updates)
    {
      update_enables ();
...
void
US_Hydrodyn_Saxs_Buffer::avg (QStringList files)
{
      ...
      for (int j = 0; j < (int)files.size (); j++)
        {
          ...
          double invweight
              = all_nonzero_errors
                    ...
                    : 1e0;
          sum += weight * (invweight * t_Is[this_file][i] - avg_Is[i])
...
QString
US_Hydrodyn_Saxs_Buffer::qstring_common_head (QStringList qsl,
                                              bool strip_digits)
{
  if (!qsl.size ())
    {
...
QString
US_Hydrodyn_Saxs_Buffer::qstring_common_tail (QStringList qsl,
                                              bool strip_digits)
{
  if (!qsl.size ())
    {
...
QString
US_Hydrodyn_Saxs_Buffer::qstring_common_head (QString s1, QString s2)
{
...
QString
US_Hydrodyn_Saxs_Buffer::qstring_common_tail (QString s1, QString s2)
{
  int min_len = (int)s1.length ();
  if (min_len > (int)s2.length ())
    {
...
void
US_Hydrodyn_Saxs_Buffer::save_created ()
{
  QStringList created_not_saved_list;
...
void
US_Hydrodyn_Saxs_Buffer::save_created_csv ()
{
  QStringList created_not_saved_list;
...
bool
US_Hydrodyn_Saxs_Buffer::save_files_csv (QStringList files)
{
  if (!files.size ())
    {
      editor_msg ("red",
...
bool
US_Hydrodyn_Saxs_Buffer::save_files (QStringList files)
{
  bool errors = false;
...
bool
US_Hydrodyn_Saxs_Buffer::save_file (QString file, bool &cancel,
                                    bool &overwrite_all)
{
  if (!f_qs.count (file))
    {
  ...
  ts << QString (title + us_tr (" output: %1%2%3%4 Units:1/a\n"))
            .arg (file)
            .arg (f_psv.count (file) ? QString (" PSV:%1").arg (f_psv[file])
                                     : QString (""))
            .arg (f_I0se.count (file) ? QString (" I0se:%1").arg (f_I0se[file])
                                      : QString (""))
            .arg (use_conc);
...
void
US_Hydrodyn_Saxs_Buffer::update_csv_conc ()
{
...
US_Hydrodyn_Saxs_Buffer::conc ()
{
  ...
  if (conc_widget)
    ...
    {
      conc_window = new US_Hydrodyn_Saxs_Buffer_Conc (csv_conc, this);
      conc_window->show ();
    }
}

map<QString, double>
US_Hydrodyn_Saxs_Buffer::current_concs (bool quiet)
{
...
map<QString, double>
US_Hydrodyn_Saxs_Buffer::window_concs ()
{
  map<QString, double> concs;
  if (conc_widget)
    {
...
void
US_Hydrodyn_Saxs_Buffer::conc_avg ()
{
  QStringList files;
  for (int i = 0; i < lb_files->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::conc_avg (QStringList files)
{
  // create average of selected
  vector<QString> avg_qs_string;
  vector<double> avg_qs;
...
bool
US_Hydrodyn_Saxs_Buffer::all_selected_have_nonzero_conc ()
{
...
void
US_Hydrodyn_Saxs_Buffer::delete_zoomer_if_ranges_changed ()
{
}

void
US_Hydrodyn_Saxs_Buffer::show_created ()
{
...
void
US_Hydrodyn_Saxs_Buffer::show_only_created ()
{
  disable_updates = true;
...
QString
US_Hydrodyn_Saxs_Buffer::vector_double_to_csv (vector<double> vd)
{
  QString result;
...
void
US_Hydrodyn_Saxs_Buffer::rescale ()
{
  // bool any_selected = false;
  double minx = 0e0;
  double maxx = 1e0;
...
bool
US_Hydrodyn_Saxs_Buffer::adjacent_ok (QString name)
{
...
void
US_Hydrodyn_Saxs_Buffer::adjacent_created ()
{
  QString match_name;
  int match_pos = 0;
  QStringList turn_on;
...
bool
US_Hydrodyn_Saxs_Buffer::adjacent_select (QListWidget *lb, QString match)
{
  bool ok;
...
void
US_Hydrodyn_Saxs_Buffer::to_saxs ()
{
          ...
          if (f_qs.count (this_file) && f_Is.count (this_file))
            {
              ...
              saxs_window->update_conc_csv (
                  ...
                  (concs.count (this_file) && concs[this_file] != 0e0)
                      ? concs[this_file]
...
void
US_Hydrodyn_Saxs_Buffer::plot_zoomed (const QRectF & /* rect */)
{
...
void
US_Hydrodyn_Saxs_Buffer::zoom_info ()
{
  if (plot_dist_zoomer)
    {
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::plot_mouse (const QMouseEvent & /* me */)
{
  // cout << "mouse event\n";
  // zoom_info();
  if (plot_dist_zoomer)
...
void
US_Hydrodyn_Saxs_Buffer::select_vis ()
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::remove_vis ()
{
#if QT_VERSION < 0x040000
  double zrx1 = plot_dist_zoomer->zoomRect ().x1 ();
  double zrx2 = plot_dist_zoomer->zoomRect ().x2 ();
...
void
US_Hydrodyn_Saxs_Buffer::crop_left ()
{
...
void
US_Hydrodyn_Saxs_Buffer::crop_right ()
{
...
void
US_Hydrodyn_Saxs_Buffer::crop_undo ()
{
  if (!crop_undos.size ())
    {
      return;
...
void
US_Hydrodyn_Saxs_Buffer::guinier ()
{
}

void
US_Hydrodyn_Saxs_Buffer::crop_common ()
{
  map<QString, bool> selected_files;
...
bool
US_Hydrodyn_Saxs_Buffer::is_nonzero_vector (vector<double> &v)
{
...
void
US_Hydrodyn_Saxs_Buffer::to_created (QString file)
{
...
void
US_Hydrodyn_Saxs_Buffer::crop_vis ()
{
  // find curves within zoomRect & select only them
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::legend ()
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::axis_y ()
{
...
void
US_Hydrodyn_Saxs_Buffer::legend_set ()
{
#if QT_VERSION >= 0x040000
#if QT_VERSION >= 0x050000
  if (legend_vis)
...
void
US_Hydrodyn_Saxs_Buffer::similar_files ()
{
  vector<QString> selected;
  for (int i = 0; i < lb_files->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::regex_load ()
{
...
void
US_Hydrodyn_Saxs_Buffer::rename_from_context (const QPoint &pos)
{
#if QT_VERSION >= 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::rename_created (QListWidgetItem *lbi, const QPoint &)
{
  map<QString, bool> existing_items;
  for (int i = 0; i < (int)lb_files->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::normalize ()
{
  QStringList files;
  for (int i = 0; i < lb_files->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::add_plot (QString name, vector<double> q,
                                   vector<double> I)
{
...
void
US_Hydrodyn_Saxs_Buffer::run_one_divide ()
{
  // subtract buffer
  QString buffer = lbl_buffer->text ();
  QString solution = lbl_signal->text ();
  ...
  QString head
      = solution + QString ("_bdiv_a%1").arg (alpha).replace (".", "_");
  unsigned int ext = 0;
...
void
US_Hydrodyn_Saxs_Buffer::crop_zero ()
{
...
void
US_Hydrodyn_Saxs_Buffer::adjust_wheel (double pos)
{
...
void
US_Hydrodyn_Saxs_Buffer::join_offset_focus (bool hasFocus)
{
  ...
  if (hasFocus)
    {
      ...
      qwtw_wheel->setRange (join_offset_start, join_offset_end);
      qwtw_wheel->setSingleStep (join_offset_delta);
      connect (qwtw_wheel, SIGNAL (valueChanged (double)),
               SLOT (adjust_wheel (double)));
...
void
US_Hydrodyn_Saxs_Buffer::join_mult_focus (bool hasFocus)
{
  ...
  if (hasFocus)
    {
      le_last_focus = le_join_mult;
      disconnect (qwtw_wheel, SIGNAL (valueChanged (double)), 0, 0);
      qwtw_wheel->setRange (join_mult_start, join_mult_end);
      qwtw_wheel->setSingleStep (join_mult_delta);
      connect (qwtw_wheel, SIGNAL (valueChanged (double)),
               SLOT (adjust_wheel (double)));
...
void
US_Hydrodyn_Saxs_Buffer::join_start_focus (bool hasFocus)
{
  ...
  if (hasFocus)
    {
      le_last_focus = le_join_start;
      disconnect (qwtw_wheel, SIGNAL (valueChanged (double)), 0, 0);
      qwtw_wheel->setRange (join_low_q, join_high_q);
      qwtw_wheel->setSingleStep (0.00005);
      connect (qwtw_wheel, SIGNAL (valueChanged (double)),
               SLOT (adjust_wheel (double)));
...
void
US_Hydrodyn_Saxs_Buffer::join_point_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Saxs_Buffer::join_end_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Saxs_Buffer::wheel_cancel ()
{
  ...
  plot_dist->setCurveData (
      wheel_curve,
      /* cb_guinier->isChecked() ? (double *)&(plotted_q2[p][0]) : */
      (double *)&(f_qs[wheel_file][0]), (double *)&(f_Is[wheel_file][0]),
      f_qs[wheel_file].size ());
  plot_dist->setCurveData (
      join_curve,
      /* cb_guinier->isChecked() ? (double *)&(plotted_q2[p][0]) : */
      (double *)&(f_qs[join_file][0]), (double *)&(f_Is[join_file][0]),
      f_qs[join_file].size ());
#else
  ...
  if (plotted_curves.count (wheel_file) && f_pos.count (wheel_file))
    {
#if QT_VERSION < 0x040000
      plot_dist->setCurvePen (
          plotted_curves[wheel_file],
          QPen (plot_colors[f_pos[wheel_file] % plot_colors.size ()], 1,
                SolidLine));
#else
  ...
  if (plotted_curves.count (join_file) && f_pos.count (join_file))
    {
#if QT_VERSION < 0x040000
      plot_dist->setCurvePen (
          plotted_curves[join_file],
          QPen (plot_colors[f_pos[join_file] % plot_colors.size ()], 1,
                SolidLine));
#else
      plotted_curves[join_file]->setPen (
          QPen (plot_colors[f_pos[join_file] % plot_colors.size ()], 1,
                Qt::SolidLine));
#endif
    }
...
void
US_Hydrodyn_Saxs_Buffer::join_offset_text (const QString &text)
{
...
void
US_Hydrodyn_Saxs_Buffer::join_do_replot ()
{
...
#if QT_VERSION < 0x040000
  plot_dist->setCurveData (
      join_adjust_lowq ? wheel_curve : join_curve,
      /* cb_guinier->isChecked() ? (double *)&(plotted_q2[p][0]) : */
      (double *)&(f_qs[wheel_file][0]), (double *)&(offset_I[0]),
      offset_I.size ());
#else
  (join_adjust_lowq ? wheel_curve : join_curve)
      ->setSamples (
...
void
US_Hydrodyn_Saxs_Buffer::join_mult_text (const QString &text)
{
  if (!wheel_is_pressed && qwtw_wheel->value () != text.toDouble ())
    {
      qwtw_wheel->setValue (text.toDouble ());
...
void
US_Hydrodyn_Saxs_Buffer::join_start_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::join_point_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::join_end_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::disable_all ()
{
...
void
US_Hydrodyn_Saxs_Buffer::join_enables ()
{
  pb_join_start->setEnabled (false);
  ...
  qwtw_wheel->setEnabled (
      le_join_offset->hasFocus () || le_join_mult->hasFocus ()
      || le_join_start->hasFocus () || le_join_point->hasFocus ()
      || le_join_end->hasFocus ());
}

void
US_Hydrodyn_Saxs_Buffer::join_fit_linear ()
{
  ...
  bool use_errors
      = f_errors.count (join_file) && f_errors[join_file].size () > 0
        && f_errors.count (wheel_file) && f_errors[wheel_file].size () > 0;

  for (unsigned int i = 0; i < (unsigned int)f_qs[wheel_file].size (); i++)
    {
      if (f_qs[wheel_file][i] >= join_start && f_qs[wheel_file][i] >= join_end)
        {
  ...
  for (unsigned int i = 0; i < (unsigned int)f_qs[join_file].size (); i++)
    {
      if (f_qs[join_file][i] >= join_start && f_qs[join_file][i] >= join_end)
        {
...
void
US_Hydrodyn_Saxs_Buffer::join_fit_scaling ()
{
  // needs common grid or interpolation!
...
void
US_Hydrodyn_Saxs_Buffer::join_swap ()
{
  ...
  pb_join_swap->setText (join_adjust_lowq ? us_tr ("Scale high-q")
                                          : us_tr ("Scale low-q"));
  // disconnect( le_join_offset, SIGNAL( textChanged( const QString & ) ) );
  // disconnect( le_join_mult  , SIGNAL( textChanged( const QString & ) ) );
  le_join_offset->setText (
      QString ("%1").arg (-le_join_offset->text ().toDouble ()));
  le_join_mult->setText (
      QString ("%1").arg (1e0 / le_join_mult->text ().toDouble ()));
  // connect( le_join_offset, SIGNAL( textChanged( const QString & ) ), SLOT(
  // join_offset_text( const QString & ) ) ); connect( le_join_mult  , SIGNAL(
  // textChanged( const QString & ) ), SLOT( join_mult_text  ( const QString &
  // ) ) ); replot_join();
}

void
US_Hydrodyn_Saxs_Buffer::join_set_wheel_range ()
{
  ...
  if (le_join_offset->text ().isEmpty ())
    {
      disconnect (le_join_offset, SIGNAL (textChanged (const QString &)), 0,
                  0);
      le_join_offset->setText ("0");
      connect (le_join_offset, SIGNAL (textChanged (const QString &)),
               SLOT (join_offset_text (const QString &)));
  ...
  if (le_join_point->text ().isEmpty ()
      || le_join_point->text ().toDouble () < join_low_q)
    {
      ...
      le_join_point->setText (
          QString ("%1").arg ((join_low_q + join_high_q / 2)));
      connect (le_join_point, SIGNAL (textChanged (const QString &)),
               SLOT (join_point_text (const QString &)));
    }
...
void
US_Hydrodyn_Saxs_Buffer::join_start ()
{
  QStringList selected_files;
  lbl_wheel_pos->setText (QString ("%1").arg (0));
  pb_join_swap->setText (join_adjust_lowq ? us_tr ("Scale low-q")
                                          : us_tr ("Scale high-q"));
  ...
  if (selected_files.size () != 2)
    {
      editor_msg ("red",
                  us_tr ("Internal error: not exactly 2 curves to join"));
      return;
    }

  bool ok;

  wheel_file = US_Static::getItem (us_tr ("SOMO: Buffer join: select file"),
                                   us_tr ("Select the low-q valued curve:\n"),
                                   selected_files, 0, false, &ok, this);
  if (!ok)
    {
      return;
    }
      ...
      if (!plotted_curves.count (selected_files[i]))
        {
          editor_msg (
              "red",
              QString (us_tr ("Internal error: curve %1 not found in data"))
                  .arg (selected_files[i]));
          return;
        }
  ...
  plot_dist->setCurvePen (plotted_curves[wheel_file],
                          QPen (Qt::cyan, 1, SolidLine));
  plot_dist->setCurvePen (plotted_curves[join_file],
                          QPen (Qt::yellow, 1, SolidLine));
#else
  ...
  join_low_q = f_qs[wheel_file][0] > f_qs[join_file][0] ? f_qs[wheel_file][0]
                                                        : f_qs[join_file][1];

  join_high_q = f_qs[wheel_file].back () < f_qs[join_file].back ()
...
void
US_Hydrodyn_Saxs_Buffer::join_delete_markers ()
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Saxs_Buffer::join_init_markers ()
{
  join_delete_markers ();

  plotted_markers.clear ();

  join_add_marker (le_join_start->text ().toDouble (), Qt::red,
                   us_tr ("Start"));
  join_add_marker (le_join_point->text ().toDouble (), Qt::magenta,
                   us_tr ("Join point"));
  join_add_marker (le_join_end->text ().toDouble (), Qt::red, us_tr ("End"),
...
void
US_Hydrodyn_Saxs_Buffer::join_add_marker (double pos, QColor color,
                                          QString text,
#if QT_VERSION < 0x040000
                                          int
#else
...
void
US_Hydrodyn_Saxs_Buffer::replot_join ()
{
      ...
      for (unsigned int i = 0; i < (unsigned int)f_qs[wheel_file].size (); i++)
        {
          if (f_qs[wheel_file][i] >= join_start
              && f_qs[wheel_file][i] >= join_end)
            {
              ...
              if (use_errors)
                {
                  // which one's errors to use?, what about compatible grids
                  // etc? wheel_y.push_back( ( mult * f_Is[ wheel_file ][ i ] +
                  // offset ) / f_errors[ wheel_file ][ i ] );
          ...
          if (f_qs[wheel_file][i] >= join_start
              && f_qs[wheel_file][i] >= join_end)
            {
              ...
              if (use_errors)
                {
                  // which one's errors to use?, what about compatible grids
                  // etc? nwheel_y.push_back( ( mult * f_Is[ wheel_file ][ i ]
                  // + offset ) / f_errors[ wheel_file ][ i ] );
                  wheel_e.push_back (f_errors[wheel_file][i]);
                }
            }
  ...
  lbl_join_rmsd->setText (
      QString ("%1").arg (US_Saxs_Util::calc_rmsd (join_y, wheel_y)));
}

void
US_Hydrodyn_Saxs_Buffer::wheel_save ()
{
  disable_all ();
  ...
  if (le_join_offset->text ().toDouble () != 0e0)
    {
      QMessageBox::information (
          ...
          us_tr (
              ...
              "requires great care because it can hide an experimental "
              "problem\n"
              "which is thus swept under the carpet but could lead to "
...
void
US_Hydrodyn_Saxs_Buffer::color_rotate ()
{
...
void
US_Hydrodyn_Saxs_Buffer::push_back_color_if_ok (QColor bg, QColor set)
{
...
void
US_Hydrodyn_Saxs_Buffer::dir_pressed ()
{
...
void
US_Hydrodyn_Saxs_Buffer::created_dir_pressed ()
{
  QString use_dir = lbl_dir->text ();
  ((US_Hydrodyn *)us_hydrodyn)->select_from_directory_history (use_dir, this);
  QString s = QFileDialog::getExistingDirectory (
...
QStringList
US_Hydrodyn_Saxs_Buffer::all_selected_files ()
{
  QStringList files;
  for (int i = 0; i < lb_files->count (); i++)
    {
...
bool
US_Hydrodyn_Saxs_Buffer::is_zero_vector (vector<double> &v)
{
  bool is_zero = true;
  for (int i = 0; i < (int)v.size (); i++)
    {
...
void
US_Hydrodyn_Saxs_Buffer::asum (QStringList files)
{
  // create average of selected
  ...
  for (int i = 0; i < (int)files.size (); i++)
    {
      ...
      bool ok;
      double res = US_Static::getDouble (title + us_tr (": Weighted sum"), txt,
                                         1, 1e-5, 1e8, 5, &ok, this);
      if (ok)
        {
          // user entered something and pressed OK
          mults.push_back (res);
      ...
      if (first)
        {
          ...
          avg_conc
              = concs.count (this_file) ? mults[i] * concs[this_file] : 0e0;
          avg_psv = f_psv.count (this_file) ? f_psv[this_file] : 0e0;
          avg_I0se = f_I0se.count (this_file) ? f_I0se[this_file] : 0e0;
        }
      else
  ...
  for (int i = 0; i < (int)csv_conc.data.size (); i++)
    {
      if (csv_conc.data[i].size () > 1 && csv_conc.data[i][0] == wsum_name)
        {
          csv_conc.data[i][1] = QString ("%1").arg (avg_conc);
        }
    }
...
void
US_Hydrodyn_Saxs_Buffer::select_these (map<QString, QString> &parameters,
                                       bool reenable)
{
  disable_updates = true;
  lb_files->clearSelection ();
...
void
US_Hydrodyn_Saxs_Buffer::select_nth ()
{
  ...
  US_Hydrodyn_Saxs_Buffer_Nth *buffer_nth
      = new US_Hydrodyn_Saxs_Buffer_Nth (this, &parameters, this);
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["buffer_nth_contains"]
      = parameters.count ("buffer_nth_contains")
            ? parameters["buffer_nth_contains"]
            : "";
...
double
US_Hydrodyn_Saxs_Buffer::tot_intensity (QString &file, double q_min,
                                        double q_max)
{
  if (!f_qs_string.count (file) || !f_qs.count (file) || !f_Is.count (file)
      || !f_pos.count (file))
...
void
US_Hydrodyn_Saxs_Buffer::wheel_pressed ()
{
...
void
US_Hydrodyn_Saxs_Buffer::wheel_released ()
{
...
void
US_Hydrodyn_Saxs_Buffer::usp_config_plot_dist (const QPoint &)
{
