...
void US_Hydrodyn_Saxs_Hplc_Scale_Trend::setupGUI() {
...
void US_Hydrodyn_Saxs_Hplc_Scale_Trend::cancel() { close(); }

void US_Hydrodyn_Saxs_Hplc_Scale_Trend::help() {
  US_Help *online_help;
  online_help = new US_Help(this);
  online_help->show_help("manual/somo/hplc_scale_trend.html");
}

void US_Hydrodyn_Saxs_Hplc_Scale_Trend::closeEvent(QCloseEvent *e) {
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept();
}
