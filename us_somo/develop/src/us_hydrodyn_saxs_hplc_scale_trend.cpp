...
void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::setupGUI ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::cancel ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::help ()
{
  US_Help *online_help;
  online_help = new US_Help (this);
  online_help->show_help ("manual/somo/hplc_scale_trend.html");
}

void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::update_plot ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::analysis ()
{
  us_qdebug ("analysis");
...
void
US_Hydrodyn_Saxs_Hplc_Scale_Trend::usp_config_plot (const QPoint &)
{
