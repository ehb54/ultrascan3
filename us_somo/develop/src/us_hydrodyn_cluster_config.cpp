...
US_Hydrodyn_Cluster_Config::US_Hydrodyn_Cluster_Config (void *us_hydrodyn,
                                                        QWidget *p,
                                                        const char *)
    : QDialog (p)
{
...
void
US_Hydrodyn_Cluster_Config::setupGUI ()
{
  int minHeight1 = 30;
  ...
  lbl_cluster_id->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1,
                                  QFont::Bold));

  le_cluster_id = new QLineEdit (this);
  le_cluster_id->setObjectName ("csv_filename Line Edit");
  le_cluster_id->setText (
  ...
  le_cluster_id->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  connect (le_cluster_id, SIGNAL (textChanged (const QString &)),
           SLOT (update_cluster_id (const QString &)));
  ...
  lbl_cluster_pw->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1,
                                  QFont::Bold));

  le_cluster_pw = new QLineEdit (this);
  le_cluster_pw->setObjectName ("csv_filename Line Edit");
  le_cluster_pw->setText (
  ...
  le_cluster_pw->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_cluster_pw->setEchoMode (QLineEdit::Password);
  connect (le_cluster_pw, SIGNAL (textChanged (const QString &)),
           SLOT (update_cluster_pw (const QString &)));
  ...
  lbl_cluster_pw2->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1,
                                   QFont::Bold));

  le_cluster_pw2 = new QLineEdit (this);
  le_cluster_pw2->setObjectName ("csv_filename Line Edit");
  le_cluster_pw2->setText (
      ((US_Hydrodyn_Cluster *)cluster_window)->cluster_config["userpw"]);
  ...
  le_cluster_pw2->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  le_cluster_pw2->setEchoMode (QLineEdit::Password);
  connect (le_cluster_pw2, SIGNAL (textChanged (const QString &)),
           SLOT (update_cluster_pw2 (const QString &)));
  ...
  lbl_cluster_email->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 1,
                                     QFont::Bold));

  le_cluster_email = new QLineEdit (this);
  le_cluster_email->setObjectName ("csv_filename Line Edit");
  le_cluster_email->setText (
      ((US_Hydrodyn_Cluster *)cluster_window)->cluster_config["useremail"]);
  ...
  le_cluster_email->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  connect (le_cluster_email, SIGNAL (textChanged (const QString &)),
           SLOT (update_cluster_email (const QString &)));
  ...
  lbl_submit_url->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1,
                                  QFont::Bold));

  le_submit_url = new QLineEdit (this);
  le_submit_url->setObjectName ("csv_filename Line Edit");
  le_submit_url->setText (
      ((US_Hydrodyn_Cluster *)cluster_window)->cluster_config["server"]);
  ...
  le_submit_url->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  lbl_manage_url->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1,
                                  QFont::Bold));

  le_manage_url = new QLineEdit (this);
  le_manage_url->setObjectName ("csv_filename Line Edit");
  le_manage_url->setText (
  ...
  le_manage_url->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  connect (le_manage_url, SIGNAL (textChanged (const QString &)),
           SLOT (update_manage_url (const QString &)));

  pb_check_user = new QPushButton (us_tr ("Check user status"), this);
  pb_check_user->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_add_user->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize + 1));
  ...
  pb_add_new->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize + 1));
  ...
  pb_edit->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize + 1));
  ...
  pb_delete_system->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize + 1));
  ...
  gl_grid->setContentsMargins (0, 0, 0, 0);
  gl_grid->setSpacing (0);
  ...
  QHBoxLayout *hbl_check_add_user = new QHBoxLayout ();
  hbl_check_add_user->setContentsMargins (0, 0, 0, 0);
  hbl_check_add_user->setSpacing (0);
  hbl_check_add_user->addWidget (pb_check_user);
  hbl_check_add_user->addWidget (pb_add_user);
  hbl_check_add_user->addWidget (pb_reset);

  QHBoxLayout *hbl_add_del = new QHBoxLayout ();
  hbl_add_del->setContentsMargins (0, 0, 0, 0);
  hbl_add_del->setSpacing (0);
...
void
US_Hydrodyn_Cluster_Config::cancel ()
{
  if (comm_active)
    {
      http_reply->abort ();
...
void
US_Hydrodyn_Cluster_Config::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster_Config::closeEvent (QCloseEvent *e)
{
  if (comm_active)
    {
      http_reply->abort ();
...
void
US_Hydrodyn_Cluster_Config::save_config ()
{
      ...
      if (it->second.count ("stage"))
        {
          ...
          dir.replace (QRegExp ("^.*:"), "");
          if (domain_to_dir.count (domain) && domain_to_dir[domain] != dir)
            {
              QMessageBox::warning (
                  this, lbl_title->text (),
                  QString (us_tr ("Staging locations for duplicate physical "
                                  "servers must be identical\n"
                                  "There is an inconsistancy with stage '%1' "
                                  "found with server '%2'\n"
      ...
      if (it->second.count ("stage"))
        {
          ...
          ((US_Hydrodyn_Cluster *)cluster_window)
              ->cluster_stage_to_system[system]
              = it->first;
        }
    }
...
void
US_Hydrodyn_Cluster_Config::systems ()
{
...
void
US_Hydrodyn_Cluster_Config::add_new ()
{
  bool ok;
  QString text
      = US_Static::getText (us_tr ("US-SOMO: Cluster Config: Add new system"),
  ...
  if (cluster_systems.count (text))
    {
      QMessageBox::warning (
          this, us_tr ("US-SOMO: Cluster config: Add new"),
  ...
  bool do_blank = true;
  if (any_selected && cluster_systems.count (lb_systems->item (pos)->text ()))
    {
      switch (QMessageBox::question (
          this, us_tr ("US-SOMO: Cluster config: Add new"),
          QString (us_tr ("Do you want to copy system data from the selected "
                          "system '%1?'"))
              .arg (lb_systems->item (pos)->text ()),
          us_tr ("&Yes"), us_tr ("&No"), QString (), 0, 1))
        {
        case 0:
          cluster_systems[text]
              = cluster_systems[lb_systems->item (pos)->text ()];
          do_blank = false;
          break;
...
void
US_Hydrodyn_Cluster_Config::delete_system ()
{
  for (int i = 0; i < lb_systems->count (); i++)
    {
      if (lb_systems->item (i)->isSelected ())
        {
          if (cluster_systems.count (lb_systems->item (i)->text ()))
            ...
            {
              QMessageBox::warning (
                  this, us_tr ("US-SOMO: Cluster config"),
                  QString (us_tr ("Internal error: The system %1 does not "
                                  "seem to exist?"))
...
void
US_Hydrodyn_Cluster_Config::edit ()
{
  for (int i = 0; i < lb_systems->count (); i++)
    {
      if (lb_systems->item (i)->isSelected ())
          ...
          if (cluster_systems.count (lb_systems->item (i)->text ()))
            {
              US_Hydrodyn_Cluster_Config_Server *hccs
                  = new US_Hydrodyn_Cluster_Config_Server (
                      ...
                      lb_systems->item (i)->text (), us_hydrodyn, this);
...
void
US_Hydrodyn_Cluster_Config::http_error (QNetworkReply::NetworkError /* code */)
{
  qDebug () << "http: error";
...
void
US_Hydrodyn_Cluster_Config::http_finished ()
{
  cout << "http: finished\n" << endl << flush;
  ...
  if (comm_mode == "add_user")
    {
      ...
      current_response_status
          = readJson.count ("info")
                ? (readJson["info"].contains (QRegExp ("added$"))
                       ? QString ("Success")
                       : readJson["info"])
                : QString ("Error");
    }
...
void
US_Hydrodyn_Cluster_Config::http_uploadProgress (qint64 done, qint64 total)
{
  cout << "http: uploadProgress " << done << " " << total << "\n";
}

void
US_Hydrodyn_Cluster_Config::http_downloadProgress (qint64 done, qint64 total)
{
...
void
US_Hydrodyn_Cluster_Config::http_done (bool error)
{
  qDebug () << "http_done";
      ...
      if (current_response_status == "Success")
        {
          QMessageBox::information (
              this, us_tr ("US-SOMO: Cluster Config: Add user"),
              QString (us_tr ("User \"%1\" successfully added"))
      ...
      else
        {
          QMessageBox::warning (
              this, us_tr ("US-SOMO: Cluster Config: Add user"),
              QString (us_tr ("There was an error trying to add User "
                              "\"%1\"\nWarning: %2"))
                  .arg (le_cluster_id->text ())
  ...
  if (comm_mode == "check_user")
    {
      if (check_not_ok)
        {
          QMessageBox::information (
              this, us_tr ("US-SOMO: Cluster Config: Check user"),
        ...
        {
          map<QString, QString> readJson
              = US_Json::split (current_http_response);
          QString errors;
          ...
          // {
          //    errors += QString( us_tr( "Incorrect password.  Possibly
          //    another user has registered the same cluster id.\n" ) );
          // } else {
          //    password_ok = true;
          // }
              ...
              if (password_ok)
                {
                  ...
                  errors += QString (
                      us_tr ("The email doesn't match, resetting\n"));
                }
              else
                {
...
void
US_Hydrodyn_Cluster_Config::update_enables ()
{
  pb_check_user->setEnabled (!comm_active && !le_cluster_id->text ().isEmpty ()
                             && !le_cluster_pw->text ().isEmpty ());
...
void
US_Hydrodyn_Cluster_Config::check_user ()
{
  ...
  if (le_cluster_pw->text ().length () < 6)
    {
      QMessageBox::warning (this,
                            us_tr ("US-SOMO: Cluster Config: Check user"),
                            us_tr ("Enter a longer password"), QMessageBox::Ok,
  ...
  if (!le_cluster_email->text ().contains (QRegExp ("^\\S+@\\S+\\.\\w+$")))
    {
      QMessageBox::warning (
          this, us_tr ("US-SOMO: Cluster Config: Check user"),
          us_tr ("The email address is improperly formatted"), QMessageBox::Ok,
          QMessageBox::NoButton);
      return;
    }
  ...
  // if ( !le_manage_url->text().contains( QRegExp(
  // "^\\S+:\\d+/portal/app/idservice/user$" ) ) )
  // {
  //    QMessageBox::warning( this,
  //                          us_tr("US-SOMO: Cluster Config: Check user"),
  //                          us_tr( "The Job Management URL is improperly
  //                          formatted" ), QMessageBox::Ok,
  //                          QMessageBox::NoButton
  //                          );
  //    return;
  // }
  ...
  //    QMessageBox::warning( this,
  //                          us_tr("US-SOMO: Cluster Config: Check user"),
  //                          us_tr( "The Job Submit URL is improperly
  //                          formatted" ), QMessageBox::Ok,
  //                          QMessageBox::NoButton
  //                          );
  //    return;
  ...
  QString manage_url_host = QString ("%1")
                                .arg (le_manage_url->text ())
                                .replace (QRegExp (":.*$"), "");

  QString manage_url_port = QString ("%1")
                                .arg (le_manage_url->text ())
                                .replace (QRegExp ("^.*:"), "")
                                .replace (QRegExp ("/.*$"), "");
  ...
  http_request.setUrl (QUrl (
      QString ("http://%1%2").arg (le_manage_url->text ()).arg (msg_request)));
...
void
US_Hydrodyn_Cluster_Config::add_user ()
{
  comm_active = true;
  comm_mode = "add_user";
  current_response_status = "";
  ...
  QString msg_request = QString ("/useradd?user=%1&email=%2&pw=%3")
                            .arg (le_cluster_id->text ())
...
void
US_Hydrodyn_Cluster_Config::update_cluster_id (const QString &)
{
  check_tried = false;
  update_enables ();
}
...
void
US_Hydrodyn_Cluster_Config::update_cluster_pw (const QString &)
{
  check_tried = false;
  update_enables ();
}
...
void
US_Hydrodyn_Cluster_Config::update_cluster_pw2 (const QString &)
{
  check_tried = false;
  update_enables ();
}
...
void
US_Hydrodyn_Cluster_Config::update_cluster_email (const QString &)
{
  check_tried = false;
  update_enables ();
}
...
void
US_Hydrodyn_Cluster_Config::update_manage_url (const QString &)
{
  check_tried = false;
  update_enables ();
}
...
void
US_Hydrodyn_Cluster_Config::reset ()
{
  if (le_manage_url->text ().contains (QRegExp ("^\\S+:\\d+$")) &&
      // le_manage_url->text().contains( QRegExp(
      // "^\\S+:\\d+/portal/app/idservice/user$" ) ) &&
      // le_submit_url->text().contains( QRegExp( "^\\S+:\\d+$" ) ) &&
      QMessageBox::Yes
          != QMessageBox::question (this, lbl_title->text (),
                                    us_tr ("Resetting will replace the "
  ...
  if (!QFile::remove ("config"))
    {
      QMessageBox::warning (this, lbl_title->text (),
