...
void US_Hydrodyn_Mals_Nth::setupGUI() {
  ...
  for (int i = 0; i < ((US_Hydrodyn_Mals *)us_hydrodyn_mals)->lb_files->count();
       ++i) {
    lb_files->addItem(QString("%1 : %2").arg(i + 1).arg(
        ((US_Hydrodyn_Mals *)us_hydrodyn_mals)->lb_files->item(i)->text()));
  ...
  {
    QIntValidator *qdv = new QIntValidator(
        1, ((US_Hydrodyn_Mals *)us_hydrodyn_mals)->lb_files->count(), le_start);
  ...
  lbl_start_name = new QLabel(((US_Hydrodyn_Mals *)us_hydrodyn_mals)
  ...
  lbl_end_name = new QLabel(((US_Hydrodyn_Mals *)us_hydrodyn_mals)
...
void US_Hydrodyn_Mals_Nth::quit() { close(); }
