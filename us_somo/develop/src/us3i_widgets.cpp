...
US3i_widgets::US3i_widgets (bool set_position, QWidget *w) : QFrame (w)
{
  QApplication::setStyle (
      QStyleFactory::create (US3i_GuiSettings::guiStyle ()));
...
// label
QLabel *
US3i_widgets::us_label (const QString &labelString, int fontAdjust, int weight)
{
  ...
  newLabel->setFont (QFont (US3i_GuiSettings::fontFamily (),
...
QLabel *
US3i_widgets::us_textlabel (const QString &labelString, int fontAdjust,
                            int weight)
{
...
QLabel *
US3i_widgets::us_banner (const QString &labelString, int fontAdjust,
                         int weight)
{
  QLabel *newLabel = us_label (labelString, fontAdjust, weight);
...
// pushbutton
QPushButton *
US3i_widgets::us_pushbutton (const QString &labelString, bool enabled,
                             int fontAdjust)
{
...
// lineedit
QLineEdit *
US3i_widgets::us_lineedit (const QString &text, int fontAdjust, bool readonly)
{
...
void
US3i_widgets::us_setReadOnly (QLineEdit *le, bool readonly)
{
  if (readonly)
    {
...
void
US3i_widgets::us_setReadOnly (QTextEdit *te, bool readonly)
{
  if (readonly)
    {
...
// List Widget
QListWidget *
US3i_widgets::us_listwidget (int fontAdjust)
{
...
// checkbox
QGridLayout *
US3i_widgets::us_checkbox (const QString &text, QCheckBox *&cb, bool state)
{
  QPalette p = US3i_GuiSettings::normalColor ();
  QFont font = QFont (US3i_GuiSettings::fontFamily (),
                      US3i_GuiSettings::fontSize (), QFont::Bold);

  QFontMetrics fm (font);

  QLabel *lb_spacer = new QLabel;
  lb_spacer->setFixedWidth (
      fm.horizontalAdvance ("w")); // Space as wide as a 'w'
...
// radiobutton
QGridLayout *
US3i_widgets::us_radiobutton (const QString &text, QRadioButton *&rb,
                              bool state)
{
  QPalette p = US3i_GuiSettings::normalColor ();
  QFont font = QFont (US3i_GuiSettings::fontFamily (),
...
// Progress Bar
QProgressBar *
US3i_widgets::us_progressBar (int low, int high, int value)
{
...
// LCD
QLCDNumber *
US3i_widgets::us_lcd (int digits, int value)
{
...
// QwtCounter
QwtCounter *
US3i_widgets::us_counter (int buttons, double low, double high, double value)
{
...
QwtPlot *
US3i_widgets::us3i_plot (const QString &title, const QString &x_axis,
...
QwtPlotGrid *
US3i_widgets::us_grid (QwtPlot *plot)
{
...
QwtPlotCurve *
US3i_widgets::us_curve (QwtPlot *plot, const QString &title)
{
...
QwtPlotPicker *
US3i_widgets::us_picker (QwtPlot *plot)
{
  QwtPlotPicker *pick
...
// tabWidget
QTabWidget *
US3i_widgets::us_tabwidget (int fontAdjust, int weight)
{
  QTabWidget *newtw = new QTabWidget (this);

  newtw->setAutoFillBackground (true);

  newtw->setFont (QFont (US3i_GuiSettings::fontFamily (),
                         US3i_GuiSettings::fontSize () + fontAdjust, weight));
...
// TimeEdit
QHBoxLayout *
US3i_widgets::us_timeedit (QTimeEdit *&tedt, const int fontAdjust,
                           QSpinBox **sbox)
{
...
// day-hh-mm-ss box
QHBoxLayout *
US3i_widgets::us_ddhhmmss (const int fontAdjust, QSpinBox **dd, QSpinBox **hh,
...
// SpinBox
QSpinBox *
US3i_widgets::us_spinbox (const int fontAdjust)
{
...
void
US3i_widgets::write_plot (const QString &fname, const QwtPlot *plot)
{
...
int
US3i_widgets::clean_etc_dir (bool report)
{
  int nfmove = 0;
  int nfcopy = 0;
  int nfdele = 0;
...
US_Disk_DB_Controls::US_Disk_DB_Controls (int state)
{
  ...
  if (state == Default)
    state = US3i_Settings::default_data_location ();
