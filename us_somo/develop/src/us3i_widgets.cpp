...
// pushbutton
QPushButton* US3i_widgets::us_pushbutton(const QString& labelString,
                                         bool enabled, int fontAdjust) {
...
QTextEdit* US3i_widgets::us_textedit(void) {
  ...
  te->setFont(
      QFont(US3i_GuiSettings::fontFamily(), US3i_GuiSettings::fontSize() - 1));
...
// checkbox
QGridLayout* US3i_widgets::us_checkbox(const QString& text, QCheckBox*& cb,
                                       bool state) {
...
// radiobutton
QGridLayout* US3i_widgets::us_radiobutton(const QString& text,
                                          QRadioButton*& rb, bool state) {
  QPalette p = US3i_GuiSettings::normalColor();
  QFont font = QFont(US3i_GuiSettings::fontFamily(),
                     US3i_GuiSettings::fontSize(), QFont::Bold);
...
// tabWidget
QTabWidget* US3i_widgets::us_tabwidget(int fontAdjust, int weight) {
...
// TimeEdit
QHBoxLayout* US3i_widgets::us_timeedit(QTimeEdit*& tedt, const int fontAdjust,
                                       QSpinBox** sbox) {
...
// day-hh-mm-ss box
QHBoxLayout* US3i_widgets::us_ddhhmmss(const int fontAdjust, QSpinBox** dd,
