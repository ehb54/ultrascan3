...
bool US_Hydrodyn_Mals::gg_fit_vector(
                                          vector < double > & fit,
                                          vector < double > & pfit
                                          )
{
   ...
   double alpha        = 
      ...
      ? ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_cormap_alpha" ].toDouble() * 5e0 
      : 0.05;
...
bool US_Hydrodyn_Mals::pvalue( const vector < double > &q, vector < double > &I, vector < double > &G, double &P, QString &errormsg ) {
   errormsg = "";
...
bool US_Hydrodyn_Mals::pvalue( const QString & file, double &P, QString &errormsg ) {
   errormsg = "";
