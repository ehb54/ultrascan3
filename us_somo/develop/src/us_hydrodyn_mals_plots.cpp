...
void US_Hydrodyn_Mals::update_plot_errors_group()
{
   ...
   qDebug() <<
      QString::asprintf( "mals_plots::update_plot_errors_group\n"
                         "\tminx %e maxx %e\n"
                         "\tminy %e maxy %e\n"
                         , minx, maxx
                         , -maxy, maxy );
                                                ...
                                                QColor             use_color )
{
   ...
   // if ( !plot_errors_zoomer )
   {
...
#if defined( DEBUG_RESCALE )
      {
         ...
         tso <<
            QString::asprintf( "mals_plots::update_plot_errors\n"
                               "\tminx %e maxx %e\n"
                               "\tminy %e maxy %e\n"
                               , x[0], x.back( )
                               , -maxy, maxy
...
void US_Hydrodyn_Mals::set_plot_errors_group()
{
   redo_plot_errors();
}
...
void US_Hydrodyn_Mals::plot_files()
{
...
#if defined( DEBUG_RESCALE )
   {
      ...
      tso <<
         QString::asprintf( "mals_plots::plot_files\n"
                            "\tminx %e maxx %e\n"
                            "\tminy %e maxy %e\n"
                            , minx, maxx
                            , miny, maxy );
...
bool US_Hydrodyn_Mals::get_min_max( QString file,
                                         double &minx,
                                         double &maxx,
                                         double &miny,
                                         double &maxy )
...
bool US_Hydrodyn_Mals::plot_file( QString file,
                                       double &minx,
                                       double &maxx,
                                       double &miny,
                                       double &maxy )
...
void US_Hydrodyn_Mals::rescale()
{
...
#if defined( DEBUG_RESCALE )
   {
      ...
      tso <<
         QString::asprintf( "mals_plots::rescale\n"
                            "\tminx %e maxx %e\n"
                            "\tminy %e maxy %e\n"
                            , minx, maxx
                            , miny, maxy );
