...
void
US_Hydrodyn_Mals::guinier_scroll_highlight (int pos)
{
...
void
US_Hydrodyn_Mals::guinier_scroll ()
{
...
void
US_Hydrodyn_Mals::guinier_add_marker (QwtPlot *plot, double pos, QColor color,
...
void
US_Hydrodyn_Mals::guinier_plot_rg_toggle ()
{
...
void
US_Hydrodyn_Mals::guinier_plot_mw_toggle ()
{
...
void
US_Hydrodyn_Mals::guinier_residuals (bool reset)
{
  if (reset)
    {
...
void
US_Hydrodyn_Mals::guinier_residuals_update ()
{
  if (rb_guinier_resid_diff->isChecked ())
    {
...
void
US_Hydrodyn_Mals::guinier_analysis ()
{
      ...
      do
        {
          ...
          if (pts_decrease)
            {
              ...
              usu->wave["mals"].q.resize (usu->wave["mals"].q.size ()
                                          - pts_decrease);
          ...
          unsigned int pend = usu->wave["mals"].q.size ()
                                  ? usu->wave["mals"].q.size () - 1
                                  : 0;

          computed_rg
              = usu->guinier_plot ("malsrg", "mals")
                && usu->guinier_fit (this_log, "malsrg", pstart, pend, a, b,
      ...
      if (computed_rg)
        {
          ...
          if (!us_isnan (Rg))
            {
              ...
              if (!count)
              ...
              else
                {
                  ...
                  if (us_isnan (siga)
                      || (unsigned int)usu->wave["mals"].q.size () < 3)
                    {
                      if (rg_sd_min > Rg)
                        {
                          rg_sd_min = Rg;
          ...
          QString report = QString ("%1:%2 ").arg (pos).arg (this_name)
                           + QString ("").sprintf (
                               ...
                               (unsigned int)usu->wave["mals"].q.size (), chi2,
...
void
US_Hydrodyn_Mals::guinier_delete_markers ()
{
...
void
US_Hydrodyn_Mals::guinier_range (double minq2, double maxq2, double minI,
                                 double maxI)
{
...
void
US_Hydrodyn_Mals::guinier_range ()
{
  double minI = 1e99;
  double maxI = 0e0;
  double minq2 = le_guinier_q2_start->text ().toDouble ()
...
void
US_Hydrodyn_Mals::guinier_replot ()
{
...
void
US_Hydrodyn_Mals::guinier_enables ()
{
...
bool
US_Hydrodyn_Mals::guinier_check_qmax (bool show_message)
{
  QString report;
...
void
US_Hydrodyn_Mals::check_mwt_constants (bool force)
{
...
bool
US_Hydrodyn_Mals::guinier_check_qmax (QString &report, bool show_message)
{
  report = "";
...
void
US_Hydrodyn_Mals::guinier_qrgmax ()
{
  disable_all ();
  qApp->processEvents ();
  guinier_analysis ();
...
void
US_Hydrodyn_Mals::guinier_qrgmax_text (const QString &)
{
...
void
US_Hydrodyn_Mals::guinier_q_start_text (const QString &text)
{
...
void
US_Hydrodyn_Mals::guinier_q_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_q_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_q_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_q2_start_text (const QString &text)
{
...
void
US_Hydrodyn_Mals::guinier_q2_end_text (const QString &text)
{
...
void
US_Hydrodyn_Mals::guinier_q2_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_q2_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_delta_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_delta_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_delta_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_delta_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_t_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_t_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_t_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_t_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_rg_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_rg_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_rg_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_rg_rg_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_t_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_t_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_t_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_t_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_mw_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_mw_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_mw_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Mals::guinier_mw_mw_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
