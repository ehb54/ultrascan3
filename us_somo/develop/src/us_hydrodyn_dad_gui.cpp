...
US_Hydrodyn_Dad::setupGUI ()
{
  ...
  cg_magenta.setBrush (QPalette::Base,
                       QBrush (QColor ("magenta"), Qt::SolidPattern));

  /*
    cg_magenta.setBrush( QPalette::WindowText, QBrush( QColor( "magenta" ),
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Button, QBrush(
    QColor( "blue" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::Light, QBrush( QColor( "darkcyan" ), Qt::SolidPattern ) );
    cg_magenta.setBrush( QPalette::Midlight, QBrush( QColor( "darkblue" ),
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Dark, QBrush( QColor(
    "yellow" ), Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Mid,
    QBrush( QColor( "darkred" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::Text, QBrush( QColor( "green" ), Qt::SolidPattern ) );
    cg_magenta.setBrush( QPalette::BrightText, QBrush( QColor( "darkgreen" ),
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::ButtonText, QBrush(
    QColor( "cyan" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::Base, QBrush( QColor( "gray" ), Qt::SolidPattern ) );
    cg_magenta.setBrush( QPalette::Shadow, QBrush( QColor( "magenta" ),
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Highlight, QBrush(
    QColor( "darkyellow" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::HighlightedText, QBrush( QColor( "darkred" ), Qt::SolidPattern )
    );
  */
  ...
  cg_fit_1.setBrush (QPalette::Base,
                     QBrush (powerfit_color_q, Qt::SolidPattern));

  lbl_title = new QLabel (
      "Developed by Emre Brookes and Mattia Rocco (see TBD., 2024)", this);
  ...
  AUTFBACK (lbl_files);
  lbl_files->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  cb_lock_dir->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 2));
  ...
  // USglobal->config_list.fontSize - 2)); connect( lbl_dir, SIGNAL(pressed()),
  // SLOT( dir_pressed() ));
  ...
  pb_add_files->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  pb_add_dir->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_similar_files->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_conc->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1));
  ...
  pb_clear_files->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_regex_load->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  le_regex = new QLineEdit (this);
  le_regex->setObjectName ("le_regex Line Edit");
  le_regex->setText ("");
  le_regex->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_regex->setPalette (PALET_NORMAL);
  AUTFBACK (le_regex);
  le_regex->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));

  le_regex_args = new QLineEdit (this);
  le_regex_args->setObjectName ("le_regex_args Line Edit");
  ...
  le_regex_args->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));

  pb_save_state = new QPushButton (us_tr ("SS"), this);
  pb_save_state->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lb_files);
  lb_files->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  lbl_selected->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 2));

  pb_select_all = new mQPushButton (us_tr ("Sel. all"), this);
  pb_select_all->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_invert->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_select_nth->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_line_width->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_color_rotate->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  //    pb_join->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1 )); pb_join->setMinimumHeight(
  //    minHeight1 ); pb_join->setMaximumWidth ( minHeight1 * 2 );
  //    pb_join->setPalette( PALET_PUSHB );
  //    connect(pb_join, SIGNAL(clicked()), SLOT(join()));

  //    pb_adjacent = new QPushButton(us_tr("Similar"), this);
  //    pb_adjacent->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1 ));
  ...
  pb_to_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_view->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1));
  ...
  pb_movie->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  cb_eb->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 2));
  ...
  cb_dots->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 2));
  ...
  pb_rescale->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_rescale_y->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_ag->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 1));
  ...
  pb_stack_push_all->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_stack_push_sel->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_stack);
  lbl_stack->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 2));

  pb_stack_copy = new QPushButton (us_tr ("Cpy"), this);
  pb_stack_copy->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_stack_pcopy->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_stack_paste->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_stack_drop->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_stack_join->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_stack_rot_up->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_stack_rot_down->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_stack_swap->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  // pb_plot_files->setFont(QFont( USglobal->config_list.fontFamily,
  // USglobal->config_list.fontSize - 1 ));
  ...
  pb_conc_avg->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_normalize->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_add->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  pb_avg->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  pb_bin->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  pb_smooth->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_powerfit->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  lbl_powerfit_msg->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  lbl_powerfit_msg->setTextInteractionFlags (Qt::TextSelectableByMouse);
  lbl_powerfit_msg->setMinimumWidth (
      QFontMetrics (lbl_powerfit_msg->font ()).averageCharWidth () * 40);
  lbl_powerfit_msg->setCursor (QCursor (Qt::IBeamCursor));

  pb_powerfit_fit = new QPushButton (us_tr ("Fit"), this);
  pb_powerfit_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  lbl_powerfit_fit_curve->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));

  cb_powerfit_fit_curve = new QComboBox (this);
  cb_powerfit_fit_curve->setPalette (PALET_NORMAL);
  AUTFBACK (cb_powerfit_fit_curve);
  cb_powerfit_fit_curve->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  cb_powerfit_fit_curve->addItem (us_tr ("2nd degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P2);
  cb_powerfit_fit_curve->addItem (us_tr ("3rd degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P3);
  cb_powerfit_fit_curve->addItem (us_tr ("4th degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P4);
  cb_powerfit_fit_curve->addItem (us_tr ("5th degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P5);
  cb_powerfit_fit_curve->addItem (us_tr ("6th degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P6);
  cb_powerfit_fit_curve->addItem (us_tr ("7th degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P7);
  cb_powerfit_fit_curve->addItem (us_tr ("8th degree Polynomial"),
                                  POWERFIT_FIT_CURVE_P8);
  cb_powerfit_fit_curve->setCurrentIndex (1);
  connect (cb_powerfit_fit_curve, SIGNAL (currentIndexChanged (QString)),
           SLOT (powerfit_fit_curve_index ()));

  cb_powerfit_fit_alg = new QComboBox (this);
  cb_powerfit_fit_alg->setPalette (PALET_NORMAL);
  AUTFBACK (cb_powerfit_fit_alg);
  cb_powerfit_fit_alg->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  ...
  cb_powerfit_fit_alg->addItem (us_tr ("SVD Jacobi"),
                                US_Eigen::EIGEN_SVD_JACOBI);
  cb_powerfit_fit_alg->addItem (us_tr ("QR Householder full pivoting"),
                                US_Eigen::EIGEN_HOUSEHOLDER_QR_PIVOT_FULL);
  cb_powerfit_fit_alg->addItem (us_tr ("QR Householder column pivoting"),
                                US_Eigen::EIGEN_HOUSEHOLDER_QR_PIVOT_COL);
  cb_powerfit_fit_alg->addItem (us_tr ("QR Householder"),
                                US_Eigen::EIGEN_HOUSEHOLDER_QR);
  cb_powerfit_fit_alg->addItem (us_tr ("LR"), US_Eigen::EIGEN_NORMAL);
  cb_powerfit_fit_alg->setCurrentIndex (5);
  connect (cb_powerfit_fit_alg, SIGNAL (currentIndexChanged (QString)),
           SLOT (powerfit_fit_alg_index ()));
  ...
  cb_powerfit_fit_alg_weight->setFont (QFont (
  ...
  cb_powerfit_fit_alg_weight->addItem (us_tr ("no weighting"),
                                       US_Eigen::EIGEN_NO_WEIGHTS);
  cb_powerfit_fit_alg_weight->addItem (us_tr ("1/amount"),
                                       US_Eigen::EIGEN_1_OVER_AMOUNT);
  cb_powerfit_fit_alg_weight->addItem (us_tr ("1/amount^2"),
                                       US_Eigen::EIGEN_1_OVER_AMOUNT_SQ);
  cb_powerfit_fit_alg_weight->addItem (us_tr ("1/SD"),
                                       US_Eigen::EIGEN_1_OVER_SD);
  cb_powerfit_fit_alg_weight->addItem (us_tr ("1/SD^2"),
                                       US_Eigen::EIGEN_1_OVER_SD_SQ);

  cb_powerfit_fit_alg_weight->setCurrentIndex (3); // US_Eigen::EIGEN_1_OVER_SD
  connect (cb_powerfit_fit_alg_weight, SIGNAL (currentIndexChanged (QString)),
           SLOT (powerfit_fit_alg_weight_index ()));

  pb_powerfit_reset = new QPushButton (us_tr ("Reset"), this);
  pb_powerfit_reset->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_powerfit_create_adjusted_curve
      = new QPushButton (us_tr ("Create adjusted curve"), this);
  pb_powerfit_create_adjusted_curve->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_powerfit_create_adjusted_curve->setMinimumHeight (minHeight1);
  pb_powerfit_create_adjusted_curve->setPalette (PALET_PUSHB);
  connect (pb_powerfit_create_adjusted_curve, SIGNAL (clicked ()),
           SLOT (powerfit_create_adjusted_curve ()));
  ...
  lbl_powerfit_q_range->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  lbl_powerfit_q_range->hide ();

  le_powerfit_q_start = new mQLineEdit (this);
  le_powerfit_q_start->setObjectName ("le_powerfit_q_start Line Edit");
  ...
  le_powerfit_q_start->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_powerfit_q_start->setEnabled (false);
  le_powerfit_q_start->setValidator (
      new QDoubleValidator (le_powerfit_q_start));
  le_powerfit_q_start->hide ();
  connect (le_powerfit_q_start, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_q_start_text (const QString &)));
  connect (le_powerfit_q_start, SIGNAL (focussed (bool)),
           SLOT (powerfit_q_start_focus (bool)));

  le_powerfit_q_end = new mQLineEdit (this);
  le_powerfit_q_end->setObjectName ("le_powerfit_q_end Line Edit");
  ...
  le_powerfit_q_end->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  connect (le_powerfit_q_end, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_q_end_text (const QString &)));
  connect (le_powerfit_q_end, SIGNAL (focussed (bool)),
           SLOT (powerfit_q_end_focus (bool)));
  ...
  lbl_powerfit_a->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  lbl_powerfit_a->hide ();

  le_powerfit_a = new mQLineEdit (this);
  le_powerfit_a->setObjectName ("le_powerfit_a Line Edit");
  le_powerfit_a->setText ("0");
  le_powerfit_a->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_powerfit_a->setPalette (PALET_NORMAL);
  le_powerfit_a->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_powerfit_a->setEnabled (false);
  le_powerfit_a->setValidator (new QDoubleValidator (le_powerfit_a));
  le_powerfit_a->hide ();
  connect (le_powerfit_a, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_a_text (const QString &)));
  connect (le_powerfit_a, SIGNAL (focussed (bool)),
           SLOT (powerfit_a_focus (bool)));
  ...
  lbl_powerfit_b->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  lbl_powerfit_b->hide ();

  le_powerfit_b = new mQLineEdit (this);
  le_powerfit_b->setObjectName ("le_powerfit_b Line Edit");
  le_powerfit_b->setText ("1");
  le_powerfit_b->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_powerfit_b->setPalette (PALET_NORMAL);
  le_powerfit_b->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_powerfit_b->setEnabled (false);
  le_powerfit_b->setValidator (new QDoubleValidator (le_powerfit_b));
  le_powerfit_b->hide ();
  connect (le_powerfit_b, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_b_text (const QString &)));
  connect (le_powerfit_b, SIGNAL (focussed (bool)),
           SLOT (powerfit_b_focus (bool)));
  ...
  lbl_powerfit_c->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  lbl_powerfit_c->hide ();

  le_powerfit_c = new mQLineEdit (this);
  le_powerfit_c->setObjectName ("le_powerfit_c Line Edit");
  le_powerfit_c->setText ("4");
  le_powerfit_c->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_powerfit_c->setPalette (PALET_NORMAL);
  le_powerfit_c->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_powerfit_c->setEnabled (false);
  le_powerfit_c->setValidator (new QDoubleValidator (le_powerfit_c));
  le_powerfit_c->hide ();
  connect (le_powerfit_c, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_c_text (const QString &)));
  connect (le_powerfit_c, SIGNAL (focussed (bool)),
           SLOT (powerfit_c_focus (bool)));

  le_powerfit_c_min = new mQLineEdit (this);
  le_powerfit_c_min->setObjectName ("le_powerfit_c_min Line Edit");
  ...
  le_powerfit_c_min->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  connect (le_powerfit_c_min, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_c_min_text (const QString &)));
  connect (le_powerfit_c_min, SIGNAL (focussed (bool)),
           SLOT (powerfit_c_min_focus (bool)));

  le_powerfit_c_max = new mQLineEdit (this);
  le_powerfit_c_max->setObjectName ("le_powerfit_c_max Line Edit");
  ...
  le_powerfit_c_max->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  connect (le_powerfit_c_max, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_c_max_text (const QString &)));
  connect (le_powerfit_c_max, SIGNAL (focussed (bool)),
           SLOT (powerfit_c_max_focus (bool)));

  lbl_powerfit_fit_epsilon
      = new QLabel (us_tr (UNICODE_EPSILON_QS + " : "), this);
  ...
  lbl_powerfit_fit_epsilon->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_fit_epsilon->hide ();

  le_powerfit_fit_epsilon = new mQLineEdit (this);
  le_powerfit_fit_epsilon->setObjectName ("le_powerfit_fit_epsilon Line Edit");
  ...
  le_powerfit_fit_epsilon->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  le_powerfit_fit_epsilon->setEnabled (false);
  le_powerfit_fit_epsilon->setValidator (
      new QDoubleValidator (le_powerfit_fit_epsilon));
  le_powerfit_fit_epsilon->hide ();
  connect (le_powerfit_fit_epsilon, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_fit_epsilon_text (const QString &)));
  connect (le_powerfit_fit_epsilon, SIGNAL (focussed (bool)),
           SLOT (powerfit_fit_epsilon_focus (bool)));

  lbl_powerfit_fit_iterations = new QLabel (us_tr (" Iter.: "), this);
  lbl_powerfit_fit_iterations->setAlignment (Qt::AlignRight
                                             | Qt::AlignVCenter);
  lbl_powerfit_fit_iterations->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_powerfit_fit_iterations);
  lbl_powerfit_fit_iterations->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_fit_iterations->hide ();

  le_powerfit_fit_iterations = new mQLineEdit (this);
  le_powerfit_fit_iterations->setObjectName (
      "le_powerfit_fit_iterations Line Edit");
  le_powerfit_fit_iterations->setText ("1000");
  le_powerfit_fit_iterations->setAlignment (Qt::AlignCenter
                                            | Qt::AlignVCenter);
  le_powerfit_fit_iterations->setPalette (PALET_NORMAL);
  le_powerfit_fit_iterations->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  le_powerfit_fit_iterations->setEnabled (false);
  le_powerfit_fit_iterations->setValidator (
      new QIntValidator (2, 1000000, le_powerfit_fit_iterations));
  le_powerfit_fit_iterations->hide ();
  connect (le_powerfit_fit_iterations, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_fit_iterations_text (const QString &)));
  connect (le_powerfit_fit_iterations, SIGNAL (focussed (bool)),
           SLOT (powerfit_fit_iterations_focus (bool)));
  ...
  lbl_powerfit_fit_max_calls->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_fit_max_calls->hide ();

  le_powerfit_fit_max_calls = new mQLineEdit (this);
  le_powerfit_fit_max_calls->setObjectName (
      "le_powerfit_fit_max_calls Line Edit");
  ...
  le_powerfit_fit_max_calls->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  le_powerfit_fit_max_calls->setEnabled (false);
  le_powerfit_fit_max_calls->setValidator (
      new QIntValidator (2, 1000000, le_powerfit_fit_max_calls));
  le_powerfit_fit_max_calls->hide ();
  connect (le_powerfit_fit_max_calls, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_fit_max_calls_text (const QString &)));
  connect (le_powerfit_fit_max_calls, SIGNAL (focussed (bool)),
           SLOT (powerfit_fit_max_calls_focus (bool)));

  lbl_powerfit_uncorrected_conc = new QLabel (
      us_tr (" Uncorr., Scat. corr.,Full corr. c [mg/mL]: "), this);
  lbl_powerfit_uncorrected_conc->setAlignment (Qt::AlignRight
                                               | Qt::AlignVCenter);
  lbl_powerfit_uncorrected_conc->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_powerfit_uncorrected_conc);
  lbl_powerfit_uncorrected_conc->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_uncorrected_conc->hide ();

  le_powerfit_uncorrected_conc = new mQLineEdit (this);
  le_powerfit_uncorrected_conc->setObjectName (
      "le_powerfit_uncorrected_conc Line Edit");
  le_powerfit_uncorrected_conc->setText ("");
  le_powerfit_uncorrected_conc->setAlignment (Qt::AlignCenter
                                              | Qt::AlignVCenter);
  le_powerfit_uncorrected_conc->setPalette (PALET_NORMAL);
  le_powerfit_uncorrected_conc->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  connect (le_powerfit_uncorrected_conc,
           SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_uncorrected_conc_text (const QString &)));
  connect (le_powerfit_uncorrected_conc, SIGNAL (focussed (bool)),
           SLOT (powerfit_uncorrected_conc_focus (bool)));
  ...
  lbl_powerfit_scat_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  lbl_powerfit_scat_conc->hide ();

  le_powerfit_scat_conc = new mQLineEdit (this);
  le_powerfit_scat_conc->setObjectName ("le_powerfit_scat_conc Line Edit");
  ...
  le_powerfit_scat_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  le_powerfit_scat_conc->setEnabled (true);
  le_powerfit_scat_conc->setReadOnly (true);
  le_powerfit_scat_conc->hide ();
  connect (le_powerfit_scat_conc, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_scat_conc_text (const QString &)));
  connect (le_powerfit_scat_conc, SIGNAL (focussed (bool)),
           SLOT (powerfit_scat_conc_focus (bool)));
  ...
  lbl_powerfit_computed_conc->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_computed_conc->hide ();

  le_powerfit_computed_conc = new mQLineEdit (this);
  le_powerfit_computed_conc->setObjectName (
      "le_powerfit_computed_conc Line Edit");
  ...
  le_powerfit_computed_conc->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  le_powerfit_computed_conc->setEnabled (true);
  le_powerfit_computed_conc->setReadOnly (true);
  le_powerfit_computed_conc->hide ();
  connect (le_powerfit_computed_conc, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_computed_conc_text (const QString &)));
  connect (le_powerfit_computed_conc, SIGNAL (focussed (bool)),
           SLOT (powerfit_computed_conc_focus (bool)));

  lbl_powerfit_lambda = new QLabel (
      us_tr (QString ("%1(abs) [nm]:").arg (UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  lbl_powerfit_lambda->hide ();

  le_powerfit_lambda = new mQLineEdit (this);
  le_powerfit_lambda->setObjectName ("le_powerfit_lambda Line Edit");
  ...
  le_powerfit_lambda->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  le_powerfit_lambda->setMaximumWidth (
      QFontMetrics (le_powerfit_lambda->font ()).averageCharWidth ()
      * le_powerfit_lambda->maxLength ());
  le_powerfit_lambda->hide ();
  connect (le_powerfit_lambda, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_lambda_text (const QString &)));
  connect (le_powerfit_lambda, SIGNAL (focussed (bool)),
           SLOT (powerfit_lambda_focus (bool)));

  lbl_powerfit_lambda_abs = new QLabel (
      us_tr (QString ("A(%1,abs) [a.u.]:").arg (UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda_abs->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_lambda_abs->hide ();

  le_powerfit_lambda_abs = new mQLineEdit (this);
  le_powerfit_lambda_abs->setObjectName ("le_powerfit_lambda_abs Line Edit");
  ...
  le_powerfit_lambda_abs->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_powerfit_lambda_abs->setValidator (
      new QDoubleValidator (le_powerfit_lambda_abs));
  le_powerfit_lambda_abs->setMaxLength (10);
  le_powerfit_lambda_abs->setMaximumWidth (
      QFontMetrics (le_powerfit_lambda_abs->font ()).averageCharWidth ()
      * le_powerfit_lambda_abs->maxLength ());
  le_powerfit_lambda_abs->setEnabled (true);
  le_powerfit_lambda_abs->setReadOnly (true);
  le_powerfit_lambda_abs->hide ();
  connect (le_powerfit_lambda_abs, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_lambda_abs_text (const QString &)));
  connect (le_powerfit_lambda_abs, SIGNAL (focussed (bool)),
           SLOT (powerfit_lambda_abs_focus (bool)));

  lbl_powerfit_lambda2 = new QLabel (
      us_tr (QString ("%1(scat) [nm]:").arg (UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda2->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  lbl_powerfit_lambda2->hide ();

  le_powerfit_lambda2 = new mQLineEdit (this);
  le_powerfit_lambda2->setObjectName ("le_powerfit_lambda2 Line Edit");
  ...
  le_powerfit_lambda2->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_powerfit_lambda2->setValidator (
      new QDoubleValidator (le_powerfit_lambda2));
  le_powerfit_lambda2->setMaxLength (8);
  le_powerfit_lambda2->setMaximumWidth (
      QFontMetrics (le_powerfit_lambda2->font ()).averageCharWidth ()
      * le_powerfit_lambda2->maxLength ());
  le_powerfit_lambda2->setEnabled (true);
  le_powerfit_lambda2->hide ();
  connect (le_powerfit_lambda2, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_lambda2_text (const QString &)));
  connect (le_powerfit_lambda2, SIGNAL (focussed (bool)),
           SLOT (powerfit_lambda2_focus (bool)));

  lbl_powerfit_lambda2_abs = new QLabel (
      us_tr (QString ("A(%1,scat) [a.u.]:").arg (UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda2_abs->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_lambda2_abs->hide ();

  le_powerfit_lambda2_abs = new mQLineEdit (this);
  le_powerfit_lambda2_abs->setObjectName ("le_powerfit_lambda2_abs Line Edit");
  ...
  le_powerfit_lambda2_abs->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  le_powerfit_lambda2_abs->setValidator (
      new QDoubleValidator (le_powerfit_lambda2_abs));
  le_powerfit_lambda2_abs->setMaxLength (10);
  le_powerfit_lambda2_abs->setMaximumWidth (
      QFontMetrics (le_powerfit_lambda2_abs->font ()).averageCharWidth ()
      * le_powerfit_lambda2_abs->maxLength ());
  le_powerfit_lambda2_abs->setReadOnly (true);
  le_powerfit_lambda2_abs->setEnabled (true);
  le_powerfit_lambda2_abs->hide ();
  connect (le_powerfit_lambda2_abs, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_lambda2_abs_text (const QString &)));
  connect (le_powerfit_lambda2_abs, SIGNAL (focussed (bool)),
           SLOT (powerfit_lambda2_abs_focus (bool)));

  lbl_powerfit_extinction_coef
      = new QLabel (us_tr (" Extc. coef. [mL/(mg*cm)]: "), this);
  lbl_powerfit_extinction_coef->setAlignment (Qt::AlignRight
                                              | Qt::AlignVCenter);
  lbl_powerfit_extinction_coef->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_powerfit_extinction_coef);
  lbl_powerfit_extinction_coef->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_powerfit_extinction_coef->hide ();

  le_powerfit_extinction_coef = new mQLineEdit (this);
  le_powerfit_extinction_coef->setObjectName (
      "le_powerfit_extinction_coef Line Edit");
  le_powerfit_extinction_coef->setText ("");
  le_powerfit_extinction_coef->setAlignment (Qt::AlignCenter
                                             | Qt::AlignVCenter);
  le_powerfit_extinction_coef->setPalette (PALET_NORMAL);
  le_powerfit_extinction_coef->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  le_powerfit_extinction_coef->setValidator (
      new QDoubleValidator (le_powerfit_extinction_coef));
  le_powerfit_extinction_coef->setMaxLength (10);
  le_powerfit_extinction_coef->setMaximumWidth (
      QFontMetrics (le_powerfit_extinction_coef->font ()).averageCharWidth ()
      * le_powerfit_extinction_coef->maxLength ());
  le_powerfit_extinction_coef->setEnabled (true);
  le_powerfit_extinction_coef->hide ();
  connect (le_powerfit_extinction_coef, SIGNAL (textChanged (const QString &)),
           SLOT (powerfit_extinction_coef_text (const QString &)));
  connect (le_powerfit_extinction_coef, SIGNAL (focussed (bool)),
           SLOT (powerfit_extinction_coef_focus (bool)));
  ...
  cb_powerfit_dispersion_correction->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  cb_powerfit_dispersion_correction->setPalette (PALET_NORMAL);
  AUTFBACK (cb_powerfit_dispersion_correction);
  connect (cb_powerfit_dispersion_correction, SIGNAL (clicked ()),
           SLOT (powerfit_dispersion_correction_clicked ()));
  ...
  pb_baseline2_start->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  pb_baseline2_apply->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  lbl_baseline2_msg->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  lbl_baseline2_msg->setTextInteractionFlags (Qt::TextSelectableByMouse);
  lbl_baseline2_msg->setMinimumWidth (
      QFontMetrics (lbl_baseline2_msg->font ()).averageCharWidth () * 40);
  lbl_baseline2_msg->setCursor (QCursor (Qt::IBeamCursor));

  pb_baseline2_fit = new QPushButton (us_tr ("Fit"), this);
  pb_baseline2_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_baseline2_create_adjusted_curve
      = new QPushButton (us_tr ("Create baseline subtracted Curve"), this);
  pb_baseline2_create_adjusted_curve->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_baseline2_create_adjusted_curve->setMinimumHeight (minHeight1);
  pb_baseline2_create_adjusted_curve->setPalette (PALET_PUSHB);
  connect (pb_baseline2_create_adjusted_curve, SIGNAL (clicked ()),
           SLOT (baseline2_create_adjusted_curve ()));
  ...
  lbl_baseline2_q_range->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  lbl_baseline2_q_range->hide ();

  le_baseline2_q_start = new mQLineEdit (this);
  le_baseline2_q_start->setObjectName ("le_baseline2_q_start Line Edit");
  ...
  le_baseline2_q_start->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  le_baseline2_q_start->setEnabled (false);
  le_baseline2_q_start->setValidator (
      new QDoubleValidator (le_baseline2_q_start));
  le_baseline2_q_start->hide ();
  connect (le_baseline2_q_start, SIGNAL (textChanged (const QString &)),
           SLOT (baseline2_q_start_text (const QString &)));
  connect (le_baseline2_q_start, SIGNAL (focussed (bool)),
           SLOT (baseline2_q_start_focus (bool)));

  le_baseline2_q_end = new mQLineEdit (this);
  le_baseline2_q_end->setObjectName ("le_baseline2_q_end Line Edit");
  ...
  le_baseline2_q_end->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  connect (le_baseline2_q_end, SIGNAL (textChanged (const QString &)),
           SLOT (baseline2_q_end_text (const QString &)));
  connect (le_baseline2_q_end, SIGNAL (focussed (bool)),
           SLOT (baseline2_q_end_focus (bool)));

  // baseline2 end

  pb_svd = new QPushButton (us_tr ("SVD / EFA"), this);
  pb_svd->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  pb_create_i_of_t->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_test_i_of_t->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_create_i_of_q
      = new QPushButton (us_tr ("Make A(" + UNICODE_LAMBDA_QS + ")"), this);
  pb_create_i_of_q->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_create_ihash_t->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_create_istar_q->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_load_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_repeak->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_conc_file->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  lbl_conc_file->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));

  pb_detector = new QPushButton (us_tr ("Detector"), this);
  pb_detector->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  //    pb_set_dad->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  //    lbl_dad->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));

  //    pb_set_empty = new QPushButton(us_tr("Set blank"), this);
  //    pb_set_empty->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1 ));
  ...
  //    lbl_empty->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));

  //    pb_set_signal = new QPushButton(us_tr("Set solution"), this);
  //    pb_set_signal->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1 ));
  ...
  //    lbl_signal->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  lbl_created_files->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));
  connect (lbl_created_files, SIGNAL (pressed ()),
           SLOT (hide_created_files ()));
  ...
  // lbl_created_dir->setFont(QFont( USglobal->config_list.fontFamily,
  // USglobal->config_list.fontSize - 2)); connect( lbl_created_dir,
  // SIGNAL(pressed()), SLOT( created_dir_pressed() ));
  ...
  le_created_dir->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 2));
  ...
  lb_created_files->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  connect (lb_created_files, SIGNAL (itemSelectionChanged ()),
           SLOT (update_created_files ()));
  ...
  lbl_selected_created->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 2));

  pb_select_all_created = new QPushButton (us_tr ("Select all"), this);
  pb_select_all_created->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  pb_select_all_created->setMinimumHeight (minHeight1);
  pb_select_all_created->setPalette (PALET_PUSHB);
  connect (pb_select_all_created, SIGNAL (clicked ()),
           SLOT (select_all_created ()));

  pb_invert_all_created = new QPushButton (us_tr ("Sel. Unsel."), this);
  pb_invert_all_created->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  pb_invert_all_created->setMinimumHeight (minHeight1);
  pb_invert_all_created->setPalette (PALET_PUSHB);
  connect (pb_invert_all_created, SIGNAL (clicked ()),
           SLOT (invert_all_created ()));

  pb_adjacent_created = new QPushButton (us_tr ("Similar"), this);
  pb_adjacent_created->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  pb_adjacent_created->setMinimumHeight (minHeight1);
  pb_adjacent_created->setPalette (PALET_PUSHB);
  connect (pb_adjacent_created, SIGNAL (clicked ()),
           SLOT (adjacent_created ()));
  pb_adjacent_created->hide ();

  pb_remove_created = new QPushButton (us_tr ("Remove"), this);
  pb_remove_created->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_save_created_csv->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("dad_csv_transposed")
              && ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_csv_transposed"]
                     == "true"
          ? us_tr ("Save CSV Tr")
          : us_tr (" Save CSV "));
  pb_save_created_csv->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  pb_save_created_csv->setMinimumHeight (minHeight1);
  pb_save_created_csv->setPalette (PALET_PUSHB);
  connect (pb_save_created_csv, SIGNAL (clicked ()),
           SLOT (save_created_csv ()));

  pb_save_created = new QPushButton (us_tr ("Save"), this);
  pb_save_created->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_show_created->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_show_only_created->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  pb_show_only_created->setMinimumHeight (minHeight1);
  pb_show_only_created->setPalette (PALET_PUSHB);
  connect (pb_show_only_created, SIGNAL (clicked ()),
           SLOT (show_only_created ()));
  ...
  lbl_model_files->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));
  ...
  lb_model_files->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_model_view->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_model_remove->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_model_save->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  le_dummy = new QLineEdit (this);
  le_dummy->setObjectName ("le_dummy Line Edit");
  le_dummy->setText ("");
  le_dummy->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_dummy->setPalette (PALET_NORMAL);
  AUTFBACK (le_dummy);
  le_dummy->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 3));
  ...
  AUTFBACK (lbl_editor);
  lbl_editor->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  ...
  editor->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 2));
  ...
  connect ((QWidget *)plot_dist->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_dist (const QPoint &)));
  ((QWidget *)plot_dist->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_dist->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_dist (const QPoint &)));
  ((QWidget *)plot_dist->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_dist->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_dist (const QPoint &)));
  ((QWidget *)plot_dist->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  ...
  AUTFBACK (plot_dist);
#if QT_VERSION < 0x040000
  plot_dist->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  plot_dist->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  grid_saxs->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  grid_saxs->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
  grid_saxs->attach (plot_dist);
#endif
  plot_dist->setAxisTitle (
      QwtPlot::xBottom,
      /* cb_guinier->isChecked() ? us_tr("q^2 (1/Angstrom^2)") : */ us_tr (
          "q [1/Angstrom]")); // or Time or Frame"));
  plot_dist->setAxisTitle (QwtPlot::yLeft,
                           us_tr ("Intensity [a.u.] (log scale)"));
#if QT_VERSION < 0x040000
  plot_dist->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 3,
                                  QFont::Bold));
  plot_dist->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_dist->setAxisFont (QwtPlot::yLeft,
                          QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  plot_dist->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_dist->setAxisFont (QwtPlot::xBottom,
                          QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  plot_dist->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_dist->setAxisFont (QwtPlot::yRight,
                          QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  plot_dist->setLegendFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 2));
#else
  {
  ...
  connect (plot_dist_zoomer, SIGNAL (zoomed (const QRectF &)),
           SLOT (plot_zoomed (const QRectF &)));

  //   plot_ref = new QwtPlot( qs_plots );
  usp_plot_ref = new US_Plot (plot_ref, "", "", "", qs_plots);
  connect ((QWidget *)plot_ref->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_ref (const QPoint &)));
  ((QWidget *)plot_ref->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_ref->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_ref (const QPoint &)));
  ((QWidget *)plot_ref->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_ref->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_ref (const QPoint &)));
  ((QWidget *)plot_ref->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  ...
  AUTFBACK (plot_ref);
#if QT_VERSION < 0x040000
  plot_ref->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  plot_ref->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  grid_ref->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  grid_ref->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
...
#if QT_VERSION < 0x040000
  plot_ref->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 3,
                                 QFont::Bold));
  plot_ref->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_ref->setAxisFont (QwtPlot::yLeft,
                         QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  plot_ref->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_ref->setAxisFont (QwtPlot::xBottom,
                         QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  plot_ref->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  plot_ref->setAxisFont (QwtPlot::yRight,
                         QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  plot_ref->hide ();
  plot_ref->setSizePolicy (
      QSizePolicy (QSizePolicy::Expanding, QSizePolicy::Expanding));
  //   plot_errors = new QwtPlot( this );
  usp_plot_errors = new US_Plot (plot_errors, "", "", "", this);
  connect ((QWidget *)plot_errors->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_errors (const QPoint &)));
  ((QWidget *)plot_errors->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_errors->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_errors (const QPoint &)));
  ((QWidget *)plot_errors->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)plot_errors->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_plot_errors (const QPoint &)));
  ((QWidget *)plot_errors->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
...
#if QT_VERSION < 0x040000
  plot_errors->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  plot_errors->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  grid_errors->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  grid_errors->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
  grid_errors->attach (plot_errors);
#endif
  // plot_errors->setAxisTitle(QwtPlot::xBottom, /* cb_guinier->isChecked() ?
  // us_tr("q^2 (1/Angstrom^2)") : */  us_tr("q (1/Angstrom) or Frame"));
  // plot_errors->setAxisTitle(QwtPlot::yLeft, us_tr("I(q) (log scale)"));
#if QT_VERSION < 0x040000
  // plot_errors->setTitleFont(QFont( USglobal->config_list.fontFamily,
  // USglobal->config_list.fontSize + 3, QFont::Bold));
  // plot_errors->setAxisTitleFont(QwtPlot::yLeft, QFont(
  // USglobal->config_list.fontFamily, USglobal->config_list.fontSize,
  // QFont::Bold));
#endif
  plot_errors->setAxisFont (QwtPlot::yLeft,
                            QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  // plot_errors->setAxisTitleFont(QwtPlot::xBottom, QFont(
  // USglobal->config_list.fontFamily, USglobal->config_list.fontSize,
  // QFont::Bold));
#endif
  plot_errors->setAxisFont (QwtPlot::xBottom,
                            QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  // plot_errors->setAxisTitleFont(QwtPlot::yRight, QFont(
  // USglobal->config_list.fontFamily, USglobal->config_list.fontSize,
  // QFont::Bold));
#endif
  // plot_errors->setAxisFont(QwtPlot::yRight, QFont(
  // USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  connect (plot_errors_zoomer, SIGNAL (zoomed (const QRectF &)),
           SLOT (plot_zoomed (const QRectF &)));

  connect (((QObject *)plot_dist->axisWidget (QwtPlot::xBottom)),
           SIGNAL (scaleDivChanged ()), usp_plot_errors,
           SLOT (scaleDivChangedXSlot ()), Qt::UniqueConnection);
  connect (((QObject *)plot_errors->axisWidget (QwtPlot::xBottom)),
           SIGNAL (scaleDivChanged ()), usp_plot_dist,
           SLOT (scaleDivChangedXSlot ()), Qt::UniqueConnection);
  ...
  cb_plot_errors_rev->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  cb_plot_errors_rev->setPalette (PALET_NORMAL);
  AUTFBACK (cb_plot_errors_rev);
  connect (cb_plot_errors_rev, SIGNAL (clicked ()),
           SLOT (set_plot_errors_rev ()));
  ...
  cb_plot_errors_sd->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  cb_plot_errors_sd->setPalette (PALET_NORMAL);
  AUTFBACK (cb_plot_errors_sd);
  connect (cb_plot_errors_sd, SIGNAL (clicked ()),
           SLOT (set_plot_errors_sd ()));
  ...
  cb_plot_errors_pct->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  cb_plot_errors_pct->setPalette (PALET_NORMAL);
  AUTFBACK (cb_plot_errors_pct);
  connect (cb_plot_errors_pct, SIGNAL (clicked ()),
           SLOT (set_plot_errors_pct ()));
  ...
  cb_plot_errors_group->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  cb_plot_errors_group->setPalette (PALET_NORMAL);
  AUTFBACK (cb_plot_errors_group);
  connect (cb_plot_errors_group, SIGNAL (clicked ()),
           SLOT (set_plot_errors_group ()));

  plot_errors->setAxisTitle (
      QwtPlot::yLeft,
      us_tr (cb_plot_errors_pct->isChecked () ? "%" : "delta I(q)"));

  QHBoxLayout *hbl_plot_errors_buttons = new QHBoxLayout ();
  hbl_plot_errors_buttons->setContentsMargins (0, 0, 0, 0);
  hbl_plot_errors_buttons->setSpacing (0);
  ...
  pb_timeshift->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_timescale->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_p3d->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_blank1);
  lbl_blank1->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  lbl_wheel_pos->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_blank2);
  lbl_blank2->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  lbl_wheel_pos_below->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  ...
  lbl_wheel_Pcolor->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_wheel_dec->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  connect (qwtw_wheel, SIGNAL (valueChanged (double)),
           SLOT (adjust_wheel (double)));
  ...
  pb_wheel_inc->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_ref->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  pb_errors->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_ggqfit->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_cormap->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_pp->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 1));
  ...
  pb_wheel_cancel->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_wheel_save->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_mode->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_start->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_clear->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_new->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_delete->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_prev->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  lbl_gauss_pos->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));

  pb_gauss_next = new QPushButton (">", this);
  pb_gauss_next->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  le_gauss_pos = new mQLineEdit (this);
  le_gauss_pos->setObjectName ("le_gauss_pos Line Edit");
  ...
  le_gauss_pos->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  connect (le_gauss_pos, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_pos_text (const QString &)));
  connect (le_gauss_pos, SIGNAL (focussed (bool)),
           SLOT (gauss_pos_focus (bool)));

  le_gauss_pos_width = new mQLineEdit (this);
  le_gauss_pos_width->setObjectName ("le_gauss_pos_width Line Edit");
  ...
  le_gauss_pos_width->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  connect (le_gauss_pos_width, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_pos_width_text (const QString &)));
  connect (le_gauss_pos_width, SIGNAL (focussed (bool)),
           SLOT (gauss_pos_width_focus (bool)));

  le_gauss_pos_height = new mQLineEdit (this);
  le_gauss_pos_height->setObjectName ("le_gauss_pos_height Line Edit");
  ...
  le_gauss_pos_height->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  ...
  // le_gauss_pos_height->setValidator( new QDoubleValidator(
  // le_gauss_pos_height ) ); le_gauss_pos_height->validator()->setDecimals(
  // UHSH_VAL_DEC );
  connect (le_gauss_pos_height, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_pos_height_text (const QString &)));
  connect (le_gauss_pos_height, SIGNAL (focussed (bool)),
           SLOT (gauss_pos_height_focus (bool)));

  le_gauss_pos_dist1 = new mQLineEdit (this);
  le_gauss_pos_dist1->setObjectName ("le_gauss_pos_dist1 Line Edit");
  ...
  le_gauss_pos_dist1->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  connect (le_gauss_pos_dist1, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_pos_dist1_text (const QString &)));
  connect (le_gauss_pos_dist1, SIGNAL (focussed (bool)),
           SLOT (gauss_pos_dist1_focus (bool)));

  le_gauss_pos_dist2 = new mQLineEdit (this);
  le_gauss_pos_dist2->setObjectName ("le_gauss_pos_dist2 Line Edit");
  ...
  le_gauss_pos_dist2->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  connect (le_gauss_pos_dist2, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_pos_dist2_text (const QString &)));
  connect (le_gauss_pos_dist2, SIGNAL (focussed (bool)),
           SLOT (gauss_pos_dist2_focus (bool)));
  ...
  cb_fix_width->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  cb_fix_dist1->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  cb_fix_dist2->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  lbl_gauss_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));

  le_gauss_fit_start = new mQLineEdit (this);
  le_gauss_fit_start->setObjectName ("le_gauss_fit_start Line Edit");
  ...
  le_gauss_fit_start->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  le_gauss_fit_start->setEnabled (false);
  le_gauss_fit_start->setValidator (new QDoubleValidator (le_gauss_fit_start));
  connect (le_gauss_fit_start, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_fit_start_text (const QString &)));
  connect (le_gauss_fit_start, SIGNAL (focussed (bool)),
           SLOT (gauss_fit_start_focus (bool)));

  le_gauss_fit_end = new mQLineEdit (this);
  le_gauss_fit_end->setObjectName ("le_gauss_fit_end Line Edit");
  le_gauss_fit_end->setText ("");
  le_gauss_fit_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_gauss_fit_end->setPalette (cg_red);
  le_gauss_fit_end->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  le_gauss_fit_end->setEnabled (false);
  le_gauss_fit_end->setValidator (new QDoubleValidator (le_gauss_fit_end));
  connect (le_gauss_fit_end, SIGNAL (textChanged (const QString &)),
           SLOT (gauss_fit_end_text (const QString &)));
  connect (le_gauss_fit_end, SIGNAL (focussed (bool)),
           SLOT (gauss_fit_end_focus (bool)));

  pb_gauss_save = new QPushButton (us_tr ("Save"), this);
  pb_gauss_save->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  le_gauss_local_pts = new mQLineEdit (this);
  le_gauss_local_pts->setObjectName ("le_gauss_local_pts Line Edit");
  ...
  le_gauss_local_pts->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  le_gauss_local_pts->setToolTip (
      us_tr ("Number of points for Gaussian peak fit"));

  pb_gauss_local_caruanas = new QPushButton (us_tr ("Caruanas"), this);
  pb_gauss_local_caruanas->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_gauss_local_caruanas->setMinimumHeight (minHeight1);
  pb_gauss_local_caruanas->setPalette (PALET_PUSHB);
  pb_gauss_local_caruanas->setToolTip (
      us_tr ("Gaussian peak fit by Caruanas method"));
  connect (pb_gauss_local_caruanas, SIGNAL (clicked ()),
           SLOT (gauss_local_caruanas ()));

  pb_gauss_local_guos = new QPushButton (us_tr ("Guos"), this);
  pb_gauss_local_guos->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  ...
  connect (pb_gauss_local_guos, SIGNAL (clicked ()),
           SLOT (gauss_local_guos ()));
  ...
  pb_ggauss_start->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_ggauss_rmsd->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_ggauss_results->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_as_curves->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  pb_ggauss_as_curves->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  ...
  connect (pb_ggauss_as_curves, SIGNAL (clicked ()),
           SLOT (gauss_as_curves ()));

  // wyatt

  pb_wyatt_start = new QPushButton (us_tr ("SD eval."), this);
  pb_wyatt_start->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_wyatt_apply->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  le_wyatt_start = new mQLineEdit (this);
  le_wyatt_start->setObjectName ("le_wyatt_start Line Edit");
  le_wyatt_start->setText ("");
  le_wyatt_start->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_wyatt_start->setPalette (cg_red);
  le_wyatt_start->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  le_wyatt_start->setEnabled (false);
  le_wyatt_start->setValidator (new QDoubleValidator (le_wyatt_start));
  connect (le_wyatt_start, SIGNAL (textChanged (const QString &)),
           SLOT (wyatt_start_text (const QString &)));
  connect (le_wyatt_start, SIGNAL (focussed (bool)),
           SLOT (wyatt_start_focus (bool)));

  le_wyatt_end = new mQLineEdit (this);
  le_wyatt_end->setObjectName ("le_wyatt_end Line Edit");
  le_wyatt_end->setText ("");
  le_wyatt_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_wyatt_end->setPalette (cg_red);
  le_wyatt_end->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  le_wyatt_end->setEnabled (false);
  le_wyatt_end->setValidator (new QDoubleValidator (le_wyatt_end));
  connect (le_wyatt_end, SIGNAL (textChanged (const QString &)),
           SLOT (wyatt_end_text (const QString &)));
  connect (le_wyatt_end, SIGNAL (focussed (bool)),
           SLOT (wyatt_end_focus (bool)));

  le_wyatt_start2 = new mQLineEdit (this);
  le_wyatt_start2->setObjectName ("le_wyatt_start2 Line Edit");
  le_wyatt_start2->setText ("");
  le_wyatt_start2->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_wyatt_start2->setPalette (cg_magenta);
  le_wyatt_start2->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  le_wyatt_start2->setEnabled (false);
  le_wyatt_start2->setValidator (new QDoubleValidator (le_wyatt_start2));
  connect (le_wyatt_start2, SIGNAL (textChanged (const QString &)),
           SLOT (wyatt_start2_text (const QString &)));
  connect (le_wyatt_start2, SIGNAL (focussed (bool)),
           SLOT (wyatt_start2_focus (bool)));

  le_wyatt_end2 = new mQLineEdit (this);
  le_wyatt_end2->setObjectName ("le_wyatt_end2 Line Edit");
  le_wyatt_end2->setText ("");
  le_wyatt_end2->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_wyatt_end2->setPalette (cg_magenta);
  le_wyatt_end2->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_wyatt_end2->setEnabled (false);
  le_wyatt_end2->setValidator (new QDoubleValidator (le_wyatt_end2));
  connect (le_wyatt_end2, SIGNAL (textChanged (const QString &)),
           SLOT (wyatt_end2_text (const QString &)));
  connect (le_wyatt_end2, SIGNAL (focussed (bool)),
           SLOT (wyatt_end2_focus (bool)));

  cb_wyatt_2 = new QCheckBox (this);
  cb_wyatt_2->setText (us_tr ("2 regions "));
  cb_wyatt_2->setChecked (false);
  cb_wyatt_2->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_blanks_start->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_blanks_params->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_bb_cm_inc->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_baseline_start->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_baseline_apply->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_baseline_test->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  cb_baseline_start_zero->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  cb_baseline_start_zero->setPalette (PALET_NORMAL);
  AUTFBACK (cb_baseline_start_zero);
  connect (cb_baseline_start_zero, SIGNAL (clicked ()),
           SLOT (set_baseline_start_zero ()));

  le_baseline_start_s = new mQLineEdit (this);
  le_baseline_start_s->setObjectName ("le_baseline_start_s Line Edit");
  ...
  le_baseline_start_s->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_baseline_start_s->setEnabled (false);
  le_baseline_start_s->setValidator (
      new QDoubleValidator (le_baseline_start_s));
  connect (le_baseline_start_s, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_start_s_text (const QString &)));
  connect (le_baseline_start_s, SIGNAL (focussed (bool)),
           SLOT (baseline_start_s_focus (bool)));

  le_baseline_start = new mQLineEdit (this);
  le_baseline_start->setObjectName ("le_baseline_start Line Edit");
  ...
  le_baseline_start->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_baseline_start->setEnabled (false);
  le_baseline_start->setValidator (new QDoubleValidator (le_baseline_start));
  connect (le_baseline_start, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_start_text (const QString &)));
  connect (le_baseline_start, SIGNAL (focussed (bool)),
           SLOT (baseline_start_focus (bool)));

  le_baseline_start_e = new mQLineEdit (this);
  le_baseline_start_e->setObjectName ("le_baseline_start_e Line Edit");
  ...
  le_baseline_start_e->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_baseline_start_e->setEnabled (false);
  le_baseline_start_e->setValidator (
      new QDoubleValidator (le_baseline_start_e));
  connect (le_baseline_start_e, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_start_e_text (const QString &)));
  connect (le_baseline_start_e, SIGNAL (focussed (bool)),
           SLOT (baseline_start_e_focus (bool)));

  le_baseline_end_s = new mQLineEdit (this);
  le_baseline_end_s->setObjectName ("le_baseline_end_s Line Edit");
  ...
  le_baseline_end_s->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_baseline_end_s->setEnabled (false);
  le_baseline_end_s->setValidator (new QDoubleValidator (le_baseline_end_s));
  connect (le_baseline_end_s, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_end_s_text (const QString &)));
  connect (le_baseline_end_s, SIGNAL (focussed (bool)),
           SLOT (baseline_end_s_focus (bool)));

  le_baseline_end = new mQLineEdit (this);
  le_baseline_end->setObjectName ("le_baseline_end Line Edit");
  le_baseline_end->setText ("");
  le_baseline_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_baseline_end->setPalette (cg_red);
  le_baseline_end->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  le_baseline_end->setEnabled (false);
  le_baseline_end->setValidator (new QDoubleValidator (le_baseline_end));
  connect (le_baseline_end, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_end_text (const QString &)));
  connect (le_baseline_end, SIGNAL (focussed (bool)),
           SLOT (baseline_end_focus (bool)));

  le_baseline_end_e = new mQLineEdit (this);
  le_baseline_end_e->setObjectName ("le_baseline_end_e Line Edit");
  ...
  le_baseline_end_e->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_baseline_end_e->setEnabled (false);
  le_baseline_end_e->setValidator (new QDoubleValidator (le_baseline_end_e));
  connect (le_baseline_end_e, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_end_e_text (const QString &)));
  connect (le_baseline_end_e, SIGNAL (focussed (bool)),
           SLOT (baseline_end_e_focus (bool)));

  cb_baseline_fix_width = new QCheckBox (this);
  cb_baseline_fix_width->setText (us_tr (" Fix window width: "));
  cb_baseline_fix_width->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  cb_baseline_fix_width->setPalette (PALET_NORMAL);
  AUTFBACK (cb_baseline_fix_width);
  connect (cb_baseline_fix_width, SIGNAL (clicked ()),
           SLOT (set_baseline_fix_width ()));

  le_baseline_width = new mQLineEdit (this);
  le_baseline_width->setObjectName ("le_baseline_width Line Edit");
  ...
  le_baseline_width->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_baseline_width->setEnabled (false);
  le_baseline_width->setValidator (new QIntValidator (le_baseline_width));
  connect (le_baseline_width, SIGNAL (textChanged (const QString &)),
           SLOT (baseline_width_text (const QString &)));
  connect (le_baseline_width, SIGNAL (focussed (bool)),
           SLOT (baseline_width_focus (bool)));

  pb_baseline_best = new QPushButton (us_tr ("Find best region"), this);
  pb_baseline_best->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_select_vis->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_remove_vis->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_crop_common->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_crop_vis->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_crop_to_vis->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_crop_zero->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_crop_left->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_crop_undo->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_crop_right->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_legend->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_axis_x->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_axis_y->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  lbl_mode_title->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1,
                                  QFont::Bold));
  lbl_mode_title->hide ();
  ...
  connect ((QWidget *)ggqfit_plot->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_ggqfit_plot (const QPoint &)));
  ((QWidget *)ggqfit_plot->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)ggqfit_plot->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_ggqfit_plot (const QPoint &)));
  ((QWidget *)ggqfit_plot->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)ggqfit_plot->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_ggqfit_plot (const QPoint &)));
  ((QWidget *)ggqfit_plot->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
...
#if QT_VERSION < 0x040000
  ggqfit_plot->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  ggqfit_plot->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  ggqfit_plot_grid->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  ggqfit_plot_grid->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
...
#if QT_VERSION < 0x040000
  ggqfit_plot->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize + 3,
                                    QFont::Bold));
  ggqfit_plot->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  ggqfit_plot->setAxisFont (QwtPlot::yLeft,
                            QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  ggqfit_plot->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  ggqfit_plot->setAxisFont (QwtPlot::xBottom,
                            QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  ggqfit_plot->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  ggqfit_plot->setAxisFont (QwtPlot::yRight,
                            QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  ggqfit_plot->setLegendFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 2));
#else
  // {
  //    QwtLegend* legend_pd = new QwtLegend;
  ...
  // }
#endif
  //   connect( ggqfit_plot->canvas(), SIGNAL( mouseReleased( const QMouseEvent
  //   & ) ), SLOT( plot_mouse(  const QMouseEvent & ) ) );

  ggqfit_plot->enableAxis (QwtPlot::yRight, true);
#if QT_VERSION < 0x040000
  ggqfit_plot->setAxisOptions (QwtPlot::yRight, QwtAutoScale::Logarithmic);
#else
  ggqfit_plot->setAxisScaleEngine (QwtPlot::yRight,
  ...
  cb_ggq_plot_chi2->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  cb_ggq_plot_P->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  cb_ggauss_scroll->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
...

  {
    ...
    cb_ggauss_scroll_smoothed->setFont (QFont (
        USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
    cb_ggauss_scroll_smoothed->setPalette (PALET_NORMAL);
    AUTFBACK (cb_ggauss_scroll_smoothed);
    connect (cb_ggauss_scroll_smoothed, SIGNAL (clicked ()),
             SLOT (ggauss_scroll_smoothed ()));
    ...
    cb_ggauss_scroll_oldstyle->setFont (QFont (
        USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
    cb_ggauss_scroll_oldstyle->setPalette (PALET_NORMAL);
    AUTFBACK (cb_ggauss_scroll_oldstyle);
    connect (cb_ggauss_scroll_oldstyle, SIGNAL (clicked ()),
             SLOT (ggauss_scroll_oldstyle ()));
  }
  // scale mode

  pb_scale = new QPushButton (us_tr ("Scale Analysis"), this);
  pb_scale->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  lbl_scale_low_high->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));

  rb_scale_low = new QRadioButton (us_tr ("Minimum "), this);
  rb_scale_low->setPalette (PALET_NORMAL);
  AUTFBACK (rb_scale_low);
  rb_scale_low->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  rb_scale_high->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_scale_scroll->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  cb_scale_sd->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  cb_scale_save_intp->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  lbl_scale_q_range->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));

  le_scale_q_start = new mQLineEdit (this);
  le_scale_q_start->setObjectName ("le_scale_q_start Line Edit");
  le_scale_q_start->setText ("");
  le_scale_q_start->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_scale_q_start->setPalette (cg_red);
  le_scale_q_start->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  le_scale_q_start->setEnabled (false);
  le_scale_q_start->setValidator (new QDoubleValidator (le_scale_q_start));
  connect (le_scale_q_start, SIGNAL (textChanged (const QString &)),
           SLOT (scale_q_start_text (const QString &)));
  connect (le_scale_q_start, SIGNAL (focussed (bool)),
           SLOT (scale_q_start_focus (bool)));

  le_scale_q_end = new mQLineEdit (this);
  le_scale_q_end->setObjectName ("le_scale_q_end Line Edit");
  le_scale_q_end->setText ("");
  le_scale_q_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_scale_q_end->setPalette (cg_red);
  le_scale_q_end->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  le_scale_q_end->setEnabled (false);
  le_scale_q_end->setValidator (new QDoubleValidator (le_scale_q_end));
  connect (le_scale_q_end, SIGNAL (textChanged (const QString &)),
           SLOT (scale_q_end_text (const QString &)));
  connect (le_scale_q_end, SIGNAL (focussed (bool)),
           SLOT (scale_q_end_focus (bool)));

  pb_scale_q_reset = new QPushButton (us_tr ("Reset q range"), this);
  pb_scale_q_reset->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_scale_reset->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_scale_apply->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_scale_create->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_testiq->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  lbl_testiq_q_range->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));

  le_testiq_q_start = new mQLineEdit (this);
  le_testiq_q_start->setObjectName ("le_testiq_q_start Line Edit");
  ...
  le_testiq_q_start->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_testiq_q_start->setEnabled (false);
  le_testiq_q_start->setValidator (new QDoubleValidator (le_testiq_q_start));
  connect (le_testiq_q_start, SIGNAL (textChanged (const QString &)),
           SLOT (testiq_q_start_text (const QString &)));
  connect (le_testiq_q_start, SIGNAL (focussed (bool)),
           SLOT (testiq_q_start_focus (bool)));

  le_testiq_q_end = new mQLineEdit (this);
  le_testiq_q_end->setObjectName ("le_testiq_q_end Line Edit");
  le_testiq_q_end->setText ("");
  le_testiq_q_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_testiq_q_end->setPalette (cg_red);
  le_testiq_q_end->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  le_testiq_q_end->setEnabled (false);
  le_testiq_q_end->setValidator (new QDoubleValidator (le_testiq_q_end));
  connect (le_testiq_q_end, SIGNAL (textChanged (const QString &)),
           SLOT (testiq_q_end_text (const QString &)));
  connect (le_testiq_q_end, SIGNAL (focussed (bool)),
           SLOT (testiq_q_end_focus (bool)));

  cb_testiq_from_gaussian = new QCheckBox (this);
  cb_testiq_from_gaussian->setText (us_tr ("as pure Gaussian"));
  cb_testiq_from_gaussian->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  lbl_testiq_gaussians->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));

  rb_testiq_from_i_t = new QRadioButton (us_tr ("None "), this);
  rb_testiq_from_i_t->setPalette (PALET_NORMAL);
  AUTFBACK (rb_testiq_from_i_t);
  rb_testiq_from_i_t->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  connect (rb_testiq_from_i_t, SIGNAL (clicked ()),
           SLOT (testiq_gauss_line ()));
  ...
  pb_testiq_visrange->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  pb_testiq_testset->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_guinier->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_guinier_plot_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  connect (pb_guinier_plot_rg, SIGNAL (clicked ()),
           SLOT (guinier_plot_rg_toggle ()));

  pb_guinier_plot_mw = new QPushButton (us_tr ("Approx. MW plot"), this);
  pb_guinier_plot_mw->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  connect (pb_guinier_plot_mw, SIGNAL (clicked ()),
           SLOT (guinier_plot_mw_toggle ()));
  ...
  cb_guinier_scroll->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  lbl_guinier_q_range->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  lbl_guinier_q_range->hide ();

  le_guinier_q_start = new mQLineEdit (this);
  le_guinier_q_start->setObjectName ("le_guinier_q_start Line Edit");
  ...
  le_guinier_q_start->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  le_guinier_q_start->setEnabled (false);
  le_guinier_q_start->setValidator (new QDoubleValidator (le_guinier_q_start));
  connect (le_guinier_q_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_q_start_text (const QString &)));
  connect (le_guinier_q_start, SIGNAL (focussed (bool)),
           SLOT (guinier_q_start_focus (bool)));
  le_guinier_q_start->hide ();

  le_guinier_q_end = new mQLineEdit (this);
  le_guinier_q_end->setObjectName ("le_guinier_q_end Line Edit");
  le_guinier_q_end->setText ("");
  le_guinier_q_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_guinier_q_end->setPalette (cg_red);
  le_guinier_q_end->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  le_guinier_q_end->setEnabled (false);
  le_guinier_q_end->setValidator (new QDoubleValidator (le_guinier_q_end));
  connect (le_guinier_q_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_q_end_text (const QString &)));
  connect (le_guinier_q_end, SIGNAL (focussed (bool)),
           SLOT (guinier_q_end_focus (bool)));
  ...
  lbl_guinier_q2_range->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  lbl_guinier_q2_range->hide ();

  le_guinier_q2_start = new mQLineEdit (this);
  le_guinier_q2_start->setObjectName ("le_guinier_q2_start Line Edit");
  ...
  le_guinier_q2_start->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_guinier_q2_start->setEnabled (false);
  le_guinier_q2_start->setValidator (
      new QDoubleValidator (le_guinier_q2_start));
  le_guinier_q2_start->hide ();
  connect (le_guinier_q2_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_q2_start_text (const QString &)));
  connect (le_guinier_q2_start, SIGNAL (focussed (bool)),
           SLOT (guinier_q2_start_focus (bool)));

  le_guinier_q2_end = new mQLineEdit (this);
  le_guinier_q2_end->setObjectName ("le_guinier_q2_end Line Edit");
  ...
  le_guinier_q2_end->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  connect (le_guinier_q2_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_q2_end_text (const QString &)));
  connect (le_guinier_q2_end, SIGNAL (focussed (bool)),
           SLOT (guinier_q2_end_focus (bool)));
  ...
  lbl_guinier_delta_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));

  le_guinier_delta_start = new mQLineEdit (this);
  le_guinier_delta_start->setObjectName ("le_guinier_delta_start Line Edit");
  ...
  le_guinier_delta_start->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_guinier_delta_start->setEnabled (false);
  le_guinier_delta_start->setValidator (
      new QDoubleValidator (le_guinier_delta_start));
  connect (le_guinier_delta_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_delta_start_text (const QString &)));
  connect (le_guinier_delta_start, SIGNAL (focussed (bool)),
           SLOT (guinier_delta_start_focus (bool)));

  le_guinier_delta_end = new mQLineEdit (this);
  le_guinier_delta_end->setObjectName ("le_guinier_delta_end Line Edit");
  ...
  le_guinier_delta_end->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  le_guinier_delta_end->setEnabled (false);
  le_guinier_delta_end->setValidator (
      new QDoubleValidator (le_guinier_delta_end));
  connect (le_guinier_delta_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_delta_end_text (const QString &)));
  connect (le_guinier_delta_end, SIGNAL (focussed (bool)),
           SLOT (guinier_delta_end_focus (bool)));
  ...
  cb_guinier_qrgmax->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("dad_cb_guinier_qrgmax")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_cb_guinier_qrgmax"]
             == "true");
  cb_guinier_qrgmax->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  cb_guinier_qrgmax->hide ();
  connect (cb_guinier_qrgmax, SIGNAL (clicked ()), SLOT (guinier_qrgmax ()));

  le_guinier_qrgmax = new mQLineEdit (this);
  le_guinier_qrgmax->setObjectName ("le_guinier_qrgmax Line Edit");
  le_guinier_qrgmax->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("dad_guinier_qrgmax")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_guinier_qrgmax"]
          : "1.3");
  ...
  le_guinier_qrgmax->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  connect (le_guinier_qrgmax, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_qrgmax_text (const QString &)));
  le_guinier_qrgmax->hide ();

  cb_guinier_sd = new QCheckBox (this);
  cb_guinier_sd->setText (us_tr ("SD "));
  cb_guinier_sd->setChecked (true);
  cb_guinier_sd->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  rb_guinier_resid_diff->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  connect (rb_guinier_resid_diff, SIGNAL (clicked ()),
           SLOT (guinier_residuals_update ()));
  ...
  rb_guinier_resid_sd->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  connect (rb_guinier_resid_sd, SIGNAL (clicked ()),
           SLOT (guinier_residuals_update ()));
  ...
  rb_guinier_resid_pct->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  connect (rb_guinier_resid_pct, SIGNAL (clicked ()),
           SLOT (guinier_residuals_update ()));
  ...
  lbl_guinier_stats->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize,
                                     QFont::Bold));

  //   guinier_plot = new QwtPlot( qs_plots );
  usp_guinier_plot = new US_Plot (guinier_plot, "", "", "", qs_plots);
  connect ((QWidget *)guinier_plot->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot (const QPoint &)));
  ((QWidget *)guinier_plot->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot (const QPoint &)));
  ((QWidget *)guinier_plot->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot (const QPoint &)));
  ((QWidget *)guinier_plot->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
...
#if QT_VERSION < 0x040000
  guinier_plot->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  guinier_plot->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  guinier_plot_grid->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  guinier_plot_grid->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
...
#if QT_VERSION < 0x040000
  guinier_plot->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 3,
                                     QFont::Bold));
  guinier_plot->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot->setAxisFont (QwtPlot::yLeft,
                             QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot->setAxisFont (QwtPlot::xBottom,
                             QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot->setAxisFont (QwtPlot::yRight,
                             QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
...
#else
  guinier_plot->setAxisScaleEngine (QwtPlot::yLeft,
                                    new QwtLogScaleEngine (10));
#endif
  ...
  guinier_plot->setLegendFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 2));
#else
  // {
  //    QwtLegend* legend_pd = new QwtLegend;
...
#endif
#if QT_VERSION < 0x040000
  connect (guinier_plot->canvas (),
           SIGNAL (mouseReleased (const QMouseEvent &)),
           SLOT (plot_mouse (const QMouseEvent &)));
#endif

  //   guinier_plot_errors = new QwtPlot( qs_plots );
  usp_guinier_plot_errors
      = new US_Plot (guinier_plot_errors, "", "", "", qs_plots);
  connect ((QWidget *)guinier_plot_errors->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_errors (const QPoint &)));
  ((QWidget *)guinier_plot_errors->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_errors->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_errors (const QPoint &)));
  ((QWidget *)guinier_plot_errors->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_errors->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_errors (const QPoint &)));
  ((QWidget *)guinier_plot_errors->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
...
#if QT_VERSION < 0x040000
  guinier_plot_errors->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  guinier_plot_errors->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  guinier_plot_errors_grid->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  guinier_plot_errors_grid->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
  guinier_plot_errors_grid->attach (guinier_plot_errors);
#endif
  guinier_plot_errors->setAxisTitle (QwtPlot::xBottom,
                                     us_tr ("q^2 [1/Angstrom^2]"));
  guinier_plot_errors->setAxisTitle (QwtPlot::yLeft,
                                     us_tr ("Intensity [a.u.] (log scale)"));
#if QT_VERSION < 0x040000
  guinier_plot_errors->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize + 3,
                                            QFont::Bold));
  guinier_plot_errors->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_errors->setAxisFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_errors->setAxisTitleFont (
...
#else
  guinier_plot_errors->setAxisScaleEngine (QwtPlot::yLeft,
  ...
  guinier_plot_errors->setLegendFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 2));
#else
  // {
  //    QwtLegend* legend_pd = new QwtLegend;
  //    legend_pd->setFrameStyle( QFrame::Box | QFrame::Sunken );
...
#endif
#if QT_VERSION < 0x040000
  connect (guinier_plot_errors->canvas (),
           SIGNAL (mouseReleased (const QMouseEvent &)),
           SLOT (plot_mouse (const QMouseEvent &)));
#endif
  ...
  connect ((QWidget *)guinier_plot_rg->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_rg (const QPoint &)));
  ((QWidget *)guinier_plot_rg->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_rg->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_rg (const QPoint &)));
  ((QWidget *)guinier_plot_rg->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_rg->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_rg (const QPoint &)));
  ((QWidget *)guinier_plot_rg->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
...
#if QT_VERSION < 0x040000
  guinier_plot_rg->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  guinier_plot_rg->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  guinier_plot_rg_grid->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  guinier_plot_rg_grid->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
...
#if QT_VERSION < 0x040000
  guinier_plot_rg->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize + 3,
                                        QFont::Bold));
  guinier_plot_rg->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_rg->setAxisFont (QwtPlot::yLeft,
                                QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_rg->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_rg->setAxisFont (QwtPlot::xBottom,
                                QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_rg->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_rg->setAxisFont (QwtPlot::yRight,
                                QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
...
#else
  guinier_plot_rg->setAxisScaleEngine (QwtPlot::yLeft,
                                       new QwtLinearScaleEngine);
#endif
  ...
  guinier_plot_rg->setLegendFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 2));
#else
  // {
  //    QwtLegend* legend_pd = new QwtLegend;
...
#endif
#if QT_VERSION < 0x040000
  connect (guinier_plot_rg->canvas (),
           SIGNAL (mouseReleased (const QMouseEvent &)),
           SLOT (plot_mouse (const QMouseEvent &)));
#endif
  ...
  connect ((QWidget *)guinier_plot_mw->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_mw (const QPoint &)));
  ((QWidget *)guinier_plot_mw->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_mw->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_mw (const QPoint &)));
  ((QWidget *)guinier_plot_mw->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_mw->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_mw (const QPoint &)));
  ((QWidget *)guinier_plot_mw->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
...
#if QT_VERSION < 0x040000
  guinier_plot_mw->setGridMajPen (
      QPen (USglobal->global_colors.major_ticks, 0, DotLine));
  guinier_plot_mw->setGridMinPen (
      QPen (USglobal->global_colors.minor_ticks, 0, DotLine));
#else
  guinier_plot_mw_grid->setMajorPen (
      QPen (USglobal->global_colors.major_ticks, 0, Qt::DotLine));
  guinier_plot_mw_grid->setMinorPen (
      QPen (USglobal->global_colors.minor_ticks, 0, Qt::DotLine));
  guinier_plot_mw_grid->attach (guinier_plot_mw);
#endif
  guinier_plot_mw->setAxisTitle (QwtPlot::xBottom, us_tr ("Time [a.u.]"));
  guinier_plot_mw->setAxisTitle (
      QwtPlot::yLeft, us_tr (started_in_expert_mode ? "Approx. MW [Daltons]"
                                                    : "MW[RT] [Daltons]"));
#if QT_VERSION < 0x040000
  guinier_plot_mw->setTitleFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize + 3,
                                        QFont::Bold));
  guinier_plot_mw->setAxisTitleFont (
      QwtPlot::yLeft, QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_mw->setAxisFont (QwtPlot::yLeft,
                                QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_mw->setAxisTitleFont (
      QwtPlot::xBottom, QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_mw->setAxisFont (QwtPlot::xBottom,
                                QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_mw->setAxisTitleFont (
      QwtPlot::yRight, QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_mw->setAxisFont (QwtPlot::yRight,
                                QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
...
#else
  guinier_plot_mw->setAxisScaleEngine (QwtPlot::yLeft,
                                       new QwtLinearScaleEngine);
#endif
  ...
  guinier_plot_mw->setLegendFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 2));
#else
  // {
  //    QwtLegend* legend_pd = new QwtLegend;
...
#endif
#if QT_VERSION < 0x040000
  connect (guinier_plot_mw->canvas (),
           SIGNAL (mouseReleased (const QMouseEvent &)),
           SLOT (plot_mouse (const QMouseEvent &)));
#endif
  ...
  connect ((QWidget *)guinier_plot_summary->titleLabel (),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_summary (const QPoint &)));
  ((QWidget *)guinier_plot_summary->titleLabel ())
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_summary->axisWidget (QwtPlot::yLeft),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_summary (const QPoint &)));
  ((QWidget *)guinier_plot_summary->axisWidget (QwtPlot::yLeft))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  connect ((QWidget *)guinier_plot_summary->axisWidget (QwtPlot::xBottom),
           SIGNAL (customContextMenuRequested (const QPoint &)),
           SLOT (usp_config_guinier_plot_summary (const QPoint &)));
  ((QWidget *)guinier_plot_summary->axisWidget (QwtPlot::xBottom))
      ->setContextMenuPolicy (Qt::CustomContextMenu);
  guinier_plot_summary->hide ();
  plot_info["HPLC SAXS Guinier Summary"] = guinier_plot_summary;

  lbl_guinier_rg_t_range
      = new QLabel (us_tr ("Time range for Rg plot: "), this);
  ...
  lbl_guinier_rg_t_range->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));

  le_guinier_rg_t_start = new mQLineEdit (this);
  le_guinier_rg_t_start->setObjectName ("le_guinier_rg_t_start Line Edit");
  ...
  le_guinier_rg_t_start->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  le_guinier_rg_t_start->setEnabled (false);
  le_guinier_rg_t_start->setValidator (
      new QDoubleValidator (le_guinier_rg_t_start));
  connect (le_guinier_rg_t_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_rg_t_start_text (const QString &)));
  connect (le_guinier_rg_t_start, SIGNAL (focussed (bool)),
           SLOT (guinier_rg_t_start_focus (bool)));

  le_guinier_rg_t_end = new mQLineEdit (this);
  le_guinier_rg_t_end->setObjectName ("le_guinier_rg_t_end Line Edit");
  ...
  le_guinier_rg_t_end->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_guinier_rg_t_end->setEnabled (false);
  le_guinier_rg_t_end->setValidator (
      new QDoubleValidator (le_guinier_rg_t_end));
  connect (le_guinier_rg_t_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_rg_t_end_text (const QString &)));
  connect (le_guinier_rg_t_end, SIGNAL (focussed (bool)),
           SLOT (guinier_rg_t_end_focus (bool)));
  ...
  lbl_guinier_rg_rg_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));

  le_guinier_rg_rg_start = new mQLineEdit (this);
  le_guinier_rg_rg_start->setObjectName ("le_guinier_rg_rg_start Line Edit");
  ...
  le_guinier_rg_rg_start->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_guinier_rg_rg_start->setEnabled (false);
  le_guinier_rg_rg_start->setValidator (
      new QDoubleValidator (le_guinier_rg_rg_start));
  connect (le_guinier_rg_rg_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_rg_rg_start_text (const QString &)));
  connect (le_guinier_rg_rg_start, SIGNAL (focussed (bool)),
           SLOT (guinier_rg_rg_start_focus (bool)));

  le_guinier_rg_rg_end = new mQLineEdit (this);
  le_guinier_rg_rg_end->setObjectName ("le_guinier_rg_rg_end Line Edit");
  ...
  le_guinier_rg_rg_end->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  le_guinier_rg_rg_end->setEnabled (false);
  le_guinier_rg_rg_end->setValidator (
      new QDoubleValidator (le_guinier_rg_rg_end));
  connect (le_guinier_rg_rg_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_rg_rg_end_text (const QString &)));
  connect (le_guinier_rg_rg_end, SIGNAL (focussed (bool)),
           SLOT (guinier_rg_rg_end_focus (bool)));
  ...
  cb_guinier_lock_rg_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  pb_guinier_replot->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  lbl_guinier_mw_t_range
      = new QLabel (us_tr ("Time range for MW plot: "), this);
  ...
  lbl_guinier_mw_t_range->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));

  le_guinier_mw_t_start = new mQLineEdit (this);
  le_guinier_mw_t_start->setObjectName ("le_guinier_mw_t_start Line Edit");
  ...
  le_guinier_mw_t_start->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  le_guinier_mw_t_start->setEnabled (false);
  le_guinier_mw_t_start->setValidator (
      new QDoubleValidator (le_guinier_mw_t_start));
  connect (le_guinier_mw_t_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_mw_t_start_text (const QString &)));
  connect (le_guinier_mw_t_start, SIGNAL (focussed (bool)),
           SLOT (guinier_mw_t_start_focus (bool)));

  le_guinier_mw_t_end = new mQLineEdit (this);
  le_guinier_mw_t_end->setObjectName ("le_guinier_mw_t_end Line Edit");
  ...
  le_guinier_mw_t_end->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_guinier_mw_t_end->setEnabled (false);
  le_guinier_mw_t_end->setValidator (
      new QDoubleValidator (le_guinier_mw_t_end));
  connect (le_guinier_mw_t_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_mw_t_end_text (const QString &)));
  connect (le_guinier_mw_t_end, SIGNAL (focussed (bool)),
           SLOT (guinier_mw_t_end_focus (bool)));
  ...
  lbl_guinier_mw_mw_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));

  le_guinier_mw_mw_start = new mQLineEdit (this);
  le_guinier_mw_mw_start->setObjectName ("le_guinier_mw_mw_start Line Edit");
  ...
  le_guinier_mw_mw_start->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_guinier_mw_mw_start->setEnabled (false);
  le_guinier_mw_mw_start->setValidator (
      new QDoubleValidator (le_guinier_mw_mw_start));
  connect (le_guinier_mw_mw_start, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_mw_mw_start_text (const QString &)));
  connect (le_guinier_mw_mw_start, SIGNAL (focussed (bool)),
           SLOT (guinier_mw_mw_start_focus (bool)));

  le_guinier_mw_mw_end = new mQLineEdit (this);
  le_guinier_mw_mw_end->setObjectName ("le_guinier_mw_mw_end Line Edit");
  ...
  le_guinier_mw_mw_end->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  le_guinier_mw_mw_end->setEnabled (false);
  le_guinier_mw_mw_end->setValidator (
      new QDoubleValidator (le_guinier_mw_mw_end));
  connect (le_guinier_mw_mw_end, SIGNAL (textChanged (const QString &)),
           SLOT (guinier_mw_mw_end_text (const QString &)));
  connect (le_guinier_mw_mw_end, SIGNAL (focussed (bool)),
           SLOT (guinier_mw_mw_end_focus (bool)));
  ...
  cb_guinier_lock_mw_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  pb_guinier_mw_replot->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  ...
  connect (pb_guinier_mw_replot, SIGNAL (clicked ()),
           SLOT (guinier_replot ()));

  // rgc mode

  pb_rgc = new QPushButton (us_tr ("Rg utility"), this);
  pb_rgc->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_rgc_mw);
  lbl_rgc_mw->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));

  le_rgc_mw = new mQLineEdit (this);
  le_rgc_mw->setObjectName ("le_rgc_mw Line Edit");
  le_rgc_mw->setText ("");
  le_rgc_mw->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_rgc_mw->setPalette (PALET_NORMAL);
  AUTFBACK (le_rgc_mw);
  le_rgc_mw->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  connect (le_rgc_mw, SIGNAL (textChanged (const QString &)),
           SLOT (rgc_mw_text (const QString &)));
  ...
  lbl_rgc_vol->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));

  le_rgc_vol = new mQLineEdit (this);
  le_rgc_vol->setObjectName ("le_rgc_vol Line Edit");
  le_rgc_vol->setText ("");
  le_rgc_vol->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_rgc_vol->setPalette (PALET_NORMAL);
  AUTFBACK (le_rgc_vol);
  le_rgc_vol->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  connect (le_rgc_vol, SIGNAL (textChanged (const QString &)),
           SLOT (rgc_vol_text (const QString &)));
  ...
  lbl_rgc_rho->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));

  le_rgc_rho = new mQLineEdit (this);
  le_rgc_rho->setObjectName ("le_rgc_rho Line Edit");
  le_rgc_rho->setText ("1.4");
  le_rgc_rho->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_rgc_rho->setPalette (PALET_NORMAL);
  AUTFBACK (le_rgc_rho);
  le_rgc_rho->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  connect (le_rgc_rho, SIGNAL (textChanged (const QString &)),
           SLOT (rgc_rho_text (const QString &)));
  ...
  rb_rgc_shape_sphere->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  rb_rgc_shape_oblate->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  rb_rgc_shape_prolate->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  ...
  rb_rgc_shape_ellipsoid->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  lbl_rgc_axis->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));

  le_rgc_axis_b = new mQLineEdit (this);
  le_rgc_axis_b->setObjectName ("le_rgc_axis_b Line Edit");
  ...
  le_rgc_axis_b->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_rgc_axis_b->setEnabled (true);
  le_rgc_axis_b->setValidator (
      new QDoubleValidator (0.01, 1.0, 3, le_rgc_axis_b));
  connect (le_rgc_axis_b, SIGNAL (textChanged (const QString &)),
           SLOT (rgc_axis_b_text (const QString &)));

  le_rgc_axis_c = new mQLineEdit (this);
  le_rgc_axis_c->setObjectName ("le_rgc_axis_c Line Edit");
  ...
  le_rgc_axis_c->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_rgc_axis_c->setEnabled (true);
  le_rgc_axis_c->setValidator (
      new QDoubleValidator (0.01, 1.0, 3, le_rgc_axis_c));
  connect (le_rgc_axis_c, SIGNAL (textChanged (const QString &)),
           SLOT (rgc_axis_c_text (const QString &)));
  ...
  AUTFBACK (lbl_rgc_rg);
  lbl_rgc_rg->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));

  le_rgc_rg = new mQLineEdit (this);
  le_rgc_rg->setObjectName ("le_rgc_rg Line Edit");
  le_rgc_rg->setText ("");
  le_rgc_rg->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_rgc_rg->setPalette (PALET_NORMAL);
  AUTFBACK (le_rgc_rg);
  le_rgc_rg->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  le_rgc_rg->setEnabled (false);
  le_rgc_rg->setReadOnly (true);
  connect (le_rgc_rg, SIGNAL (textChanged (const QString &)),
           SLOT (rgc_rg_text (const QString &)));
  ...
  lbl_rgc_extents->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));

  le_rgc_extents = new mQLineEdit (this);
  le_rgc_extents->setObjectName ("le_rgc_extents Line Edit");
  ...
  le_rgc_extents->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  lbl_rgc_g_qrange->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));

  le_rgc_g_qrange = new mQLineEdit (this);
  le_rgc_g_qrange->setObjectName ("le_rgc_g_qrange Line Edit");
  ...
  le_rgc_g_qrange->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_simulate->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_pm->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 1));
  ...
  rb_pm_shape_sphere->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  rb_pm_shape_spheroid->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  ...
  rb_pm_shape_ellipsoid->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  rb_pm_shape_cylinder->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  ...
  rb_pm_shape_torus->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  cb_pm_sd->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  cb_pm_q_logbin->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  lbl_pm_q_range->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));

  le_pm_q_start = new mQLineEdit (this);
  le_pm_q_start->setObjectName ("le_pm_q_start Line Edit");
  le_pm_q_start->setText ("");
  le_pm_q_start->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_pm_q_start->setPalette (cg_red);
  le_pm_q_start->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_pm_q_start->setEnabled (false);
  le_pm_q_start->setValidator (new QDoubleValidator (le_pm_q_start));
  connect (le_pm_q_start, SIGNAL (textChanged (const QString &)),
           SLOT (pm_q_start_text (const QString &)));
  connect (le_pm_q_start, SIGNAL (focussed (bool)),
           SLOT (pm_q_start_focus (bool)));

  le_pm_q_end = new mQLineEdit (this);
  le_pm_q_end->setObjectName ("le_pm_q_end Line Edit");
  le_pm_q_end->setText ("");
  le_pm_q_end->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_pm_q_end->setPalette (cg_red);
  le_pm_q_end->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  le_pm_q_end->setEnabled (false);
  le_pm_q_end->setValidator (new QDoubleValidator (le_pm_q_end));
  connect (le_pm_q_end, SIGNAL (textChanged (const QString &)),
           SLOT (pm_q_end_text (const QString &)));
  connect (le_pm_q_end, SIGNAL (focussed (bool)),
           SLOT (pm_q_end_focus (bool)));

  pb_pm_q_reset = new QPushButton (us_tr ("Reset q range"), this);
  pb_pm_q_reset->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  lbl_pm_samp_e_dens
      = new QLabel (us_tr ("Sample e density [e/A^3] (Tp. Prot: .41-.44, "
                           "DNA:.59: RNA:.6 Carb:.49)"),
                    this);
  ...
  lbl_pm_samp_e_dens->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));

  le_pm_samp_e_dens = new QLineEdit (this);
  le_pm_samp_e_dens->setObjectName ("le_pm_samp_e_dens Line Edit");
  ...
  le_pm_samp_e_dens->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_pm_samp_e_dens->setEnabled (false);
  le_pm_samp_e_dens->setValidator (new QDoubleValidator (le_pm_samp_e_dens));
  connect (le_pm_samp_e_dens, SIGNAL (textChanged (const QString &)),
           SLOT (pm_samp_e_dens_text (const QString &)));
  ...
  lbl_pm_buff_e_dens->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));

  le_pm_buff_e_dens = new QLineEdit (this);
  le_pm_buff_e_dens->setObjectName ("le_pm_buff_e_dens Line Edit");
  le_pm_buff_e_dens->setText (QString ("%1").arg (
      (((US_Hydrodyn *)us_hydrodyn)->saxs_options.water_e_density)));
  ...
  le_pm_buff_e_dens->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  le_pm_buff_e_dens->setEnabled (false);
  le_pm_buff_e_dens->setValidator (new QDoubleValidator (le_pm_buff_e_dens));
  connect (le_pm_buff_e_dens, SIGNAL (textChanged (const QString &)),
           SLOT (pm_buff_e_dens_text (const QString &)));
  ...
  lbl_pm_grid_size->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));

  le_pm_grid_size = new QLineEdit (this);
  le_pm_grid_size->setObjectName ("le_pm_grid_size Line Edit");
  ...
  le_pm_grid_size->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  le_pm_grid_size->setEnabled (false);
  le_pm_grid_size->setValidator (new QIntValidator (le_pm_grid_size));
  connect (le_pm_grid_size, SIGNAL (textChanged (const QString &)),
           SLOT (pm_grid_size_text (const QString &)));
  ...
  lbl_pm_q_pts->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));

  le_pm_q_pts = new QLineEdit (this);
  le_pm_q_pts->setObjectName ("le_pm_q_pts Line Edit");
  ...
  le_pm_q_pts->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  le_pm_q_pts->setEnabled (false);
  le_pm_q_pts->setValidator (new QIntValidator (le_pm_q_pts));
  connect (le_pm_q_pts, SIGNAL (textChanged (const QString &)),
           SLOT (pm_q_pts_text (const QString &)));

  pb_pm_run = new QPushButton (us_tr ("Start"), this);
  pb_pm_run->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_fasta_file
      = new QPushButton (us_tr ("Load FASTA sequence from file"), this);
  pb_fasta_file->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  lbl_fasta_value->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  le_fasta_value->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  lbl_dad_lambdas_data->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_pbmode);
  lbl_pbmode->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));

  rb_pbmode_main = new QRadioButton ("Options", this);
  rb_pbmode_main->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_sel->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_crop->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_sd->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_fasta->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_dad->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  rb_pbmode_q_exclude->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  rb_pbmode_q_exclude->setMinimumHeight (minHeight3);
  rb_pbmode_q_exclude->setPalette (PALET_NORMAL);
  AUTFBACK (rb_pbmode_q_exclude);
  connect (rb_pbmode_q_exclude, SIGNAL (clicked ()),
           SLOT (set_pbmode_q_exclude ()));

  rb_pbmode_none = new QRadioButton ("None", this);
  rb_pbmode_none->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_q_exclude_vis->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_q_exclude_left->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_q_exclude_right->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  pb_q_exclude_clear->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  lbl_q_exclude_detail->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  ...
  pb_options->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  connect (this, SIGNAL (do_resize_guinier_plots ()),
           SLOT (resize_guinier_plots ()));
  ...
  hbl_file_buttons->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons->setSpacing (0);
  ...
  hbl_file_buttons_1->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_1->setSpacing (0);
  ...
  hbl_file_buttons_2->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_2->setSpacing (0);
  ...
  hbl_file_buttons_2b->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_2b->setSpacing (0);
  ...
  hbl_file_buttons_3->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_3->setSpacing (0);
  ...
  QBoxLayout *hbl_file_buttons_3b = new QHBoxLayout ();
  hbl_file_buttons_3b->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_3b->setSpacing (0);
  ...
  hbl_file_buttons_4->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_4->setSpacing (0);
  ...
  hbl_conc_file->setContentsMargins (0, 0, 0, 0);
  hbl_conc_file->setSpacing (0);
  ...
  //    QBoxLayout * hbl_dad = new QHBoxLayout(); hbl_dad->setContentsMargins(
  //    0, 0, 0, 0 ); hbl_dad->setSpacing( 0 ); hbl_dad->addWidget ( pb_set_dad
  //    ); hbl_dad->addWidget ( lbl_dad );

  //    QBoxLayout * hbl_empty = new QHBoxLayout();
  //    hbl_empty->setContentsMargins( 0, 0, 0, 0 ); hbl_empty->setSpacing( 0
  //    ); hbl_empty->addWidget ( pb_set_empty ); hbl_empty->addWidget (
  //    lbl_empty );

  //    QBoxLayout * hbl_signal = new QHBoxLayout();
  //    hbl_signal->setContentsMargins( 0, 0, 0, 0 ); hbl_signal->setSpacing( 0
  //    ); hbl_signal->addWidget ( pb_set_signal ); hbl_signal->addWidget (
  //    lbl_signal );

  QBoxLayout *hbl_created = new QHBoxLayout ();
  hbl_created->setContentsMargins (0, 0, 0, 0);
  hbl_created->setSpacing (0);
  ...
  hbl_created_2->setContentsMargins (0, 0, 0, 0);
  hbl_created_2->setSpacing (0);
  ...
  QHBoxLayout *hbl_dir = new QHBoxLayout ();
  hbl_dir->setContentsMargins (0, 0, 0, 0);
  hbl_dir->setSpacing (0);
  ...
  vbl_model->setContentsMargins (0, 0, 0, 0);
  vbl_model->setSpacing (0);
  ...
  gl_files->setContentsMargins (0, 0, 0, 0);
  gl_files->setSpacing (0);
  {
    unsigned int j = 0;
    gl_files->addWidget (lbl_files, j, 0);
    j++;
    gl_files->addLayout (hbl_dir, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_0, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_1, j, 0);
    j++;
    gl_files->addWidget (lb_files, j, 0);
    j++;
    gl_files->addWidget (lbl_selected, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_2, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_2b, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_3, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_3b, j, 0);
    j++;
    gl_files->addLayout (hbl_file_buttons_4, j, 0);
    j++;
    gl_files->addLayout (hbl_conc_file, j, 0);
    j++;
    ...
    gl_files->addWidget (lbl_created_files, j, 0);
    j++;
    gl_files->addWidget (le_created_dir, j, 0);
    j++;
    gl_files->addWidget (lb_created_files, j, 0);
    j++;
    gl_files->addWidget (lbl_selected_created, j, 0);
    j++;
    gl_files->addLayout (hbl_created, j, 0);
    j++;
    gl_files->addLayout (hbl_created_2, j, 0);
    j++;
    gl_files->addLayout (vbl_model, j, 0);
    j++;
    gl_files->addLayout (vbl_editor_group, j, 0);
    j++;
  }

  QGridLayout *gl_wheel = new QGridLayout (0);
  gl_wheel->setContentsMargins (0, 0, 0, 0);
  gl_wheel->setSpacing (0);
  ...
  QGridLayout *gl_wheel_extra = new QGridLayout (0);
  gl_wheel_extra->setContentsMargins (0, 0, 0, 0);
  gl_wheel_extra->setSpacing (0);
  ...
  // gl_wheel->addWidget( pb_timeshift  , 0 , 0 , 1 + ( 0 ) - ( 0 ) , 1 + ( 1
  // ) - ( 0 ) ); gl_wheel->addWidget         ( lbl_wheel_pos  , 0, 2 );
  // gl_wheel->addWidget( qwtw_wheel      , 0 , 3 , 1 + ( 0 ) - ( 0 ) , 1 + ( 7
  // ) - ( 3 ) ); gl_wheel->addWidget         ( pb_ref         , 0, 8 );
  ...
  hbl_top->setContentsMargins (0, 0, 0, 0);
  hbl_top->setSpacing (0);
  ...
  // QBoxLayout * hbl_mode = new QHBoxLayout(); hbl_mode->setContentsMargins(
  // 0, 0, 0, 0 ); hbl_mode->setSpacing( 0 ); hbl_mode->addWidget(
  // pb_gauss_start ); hbl_mode->addWidget( pb_ggauss_start );
  ...
  hbl_mode0->setContentsMargins (0, 0, 0, 0);
  hbl_mode0->setSpacing (0);
  ...
  hbl_mode->setContentsMargins (0, 0, 0, 0);
  hbl_mode->setSpacing (0);
  ...
  vbl_scale->setContentsMargins (0, 0, 0, 0);
  vbl_scale->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
    hbl->setSpacing (0);
  ...
  vbl_testiq->setContentsMargins (0, 0, 0, 0);
  vbl_testiq->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
    hbl->setSpacing (0);
  ...
  hbl_guinier_resid->setContentsMargins (0, 0, 0, 0);
  hbl_guinier_resid->setSpacing (0);
  ...
  vbl_guinier->setContentsMargins (0, 0, 0, 0);
  vbl_guinier->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
    hbl->setSpacing (0);
  ...
  QBoxLayout *vbl_powerfit = new QVBoxLayout (0);
  vbl_powerfit->setContentsMargins (0, 0, 0, 0);
  vbl_powerfit->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
    hbl->setSpacing (0);
  ...
  // {
  //    QGridLayout * gl = new QGridLayout(); gl->setContentsMargins( 0, 0, 0,
  //    0 ); gl->setSpacing( 0 ); int row = 0; int col = 0;
  ...
  //    gl->addWidget( lbl_powerfit_msg             , row, row, col, col + 5 );
  //    col += 5 + 1;
  ...
  //    gl->addWidget( lbl_powerfit_uncorrected_conc, row, row, col, col + 3 );
  //    col += 3 + 1;
  //    {
  //       QBoxLayout * hbl = new QHBoxLayout(); hbl->setContentsMargins( 0, 0,
  //       0, 0 ); hbl->setSpacing( 0 ); hbl->addWidget(
  //       le_powerfit_uncorrected_conc ); hbl->addWidget(
  //       lbl_powerfit_scat_conc ); hbl->addWidget( le_powerfit_scat_conc );
  ...
  QBoxLayout *vbl_baseline2 = new QVBoxLayout (0);
  vbl_baseline2->setContentsMargins (0, 0, 0, 0);
  vbl_baseline2->setSpacing (0);
  ...
  // vbl_guinier_plots->setContentsMargins( 0, 0, 0, 0 );
  // vbl_guinier_plots->setSpacing( 0 ); vbl_guinier_plots->addWidget(
  // guinier_plot ); vbl_guinier_plots->addWidget( guinier_plot_errors );

  // pm
  QBoxLayout *vbl_pm = new QVBoxLayout (0);
  vbl_pm->setContentsMargins (0, 0, 0, 0);
  vbl_pm->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
  ...
  vbl_rgc->setContentsMargins (0, 0, 0, 0);
  vbl_rgc->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
    hbl->setSpacing (0);
  ...
  hbl_ggauss_scroll->setContentsMargins (0, 0, 0, 0);
  hbl_ggauss_scroll->setSpacing (0);
  {
  ...
  gl_gauss->setContentsMargins (0, 0, 0, 0);
  gl_gauss->setSpacing (0);
  {
    int ofs = 1;
  ...
  gl_gauss2->setContentsMargins (0, 0, 0, 0);
  gl_gauss2->setSpacing (0);
  {
    int ofs = 1;
  ...
  QHBoxLayout *hbl_baseline = new QHBoxLayout ();
  hbl_baseline->setContentsMargins (0, 0, 0, 0);
  hbl_baseline->setSpacing (0);
  ...
  QHBoxLayout *hbl_wyatt = new QHBoxLayout ();
  hbl_wyatt->setContentsMargins (0, 0, 0, 0);
  hbl_wyatt->setSpacing (0);
  ...
  hbl_ggqfit_plot_ctls->setContentsMargins (0, 0, 0, 0);
  hbl_ggqfit_plot_ctls->setSpacing (0);
  hbl_ggqfit_plot_ctls->addWidget (cb_ggq_plot_chi2);
  hbl_ggqfit_plot_ctls->addWidget (cb_ggq_plot_P);

  vbl_plot_group = new QVBoxLayout (0);
  vbl_plot_group->setContentsMargins (0, 0, 0, 0);
  vbl_plot_group->setSpacing (0);
  ...
  // vbl_plot_group->addWidget ( lbl_dad_lambdas_data, 0, Qt::AlignCenter ); //
  // don't like this
  ...
  //    hbl_files_plot->setContentsMargins( 0, 0, 0, 0 );
  //    hbl_files_plot->setSpacing( 0 );
  ...
  gl_bottom->setContentsMargins (0, 0, 0, 0);
  gl_bottom->setSpacing (0);
  ...
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "dad_files_widgets" ) || ( ( US_Hydrodyn * ) us_hydrodyn
  //                 )->gparams[ "dad_files_widgets" ] == "false" ? false :
  //                 true );
  //   hide_widgets( editor_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "dad_editor_widgets" ) || ( ( US_Hydrodyn * ) us_hydrodyn
  //                 )->gparams[ "dad_editor_widgets" ] == "false" ? false :
  //                 true );
  //   hide_widgets( created_files_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "dad_created_files_widgets" ) || ( ( US_Hydrodyn * )
  //                 us_hydrodyn )->gparams[ "dad_creaded_files_widgets" ] ==
  //                 "false" ? false : true );
...
void
US_Hydrodyn_Dad::mode_setup_widgets ()
{
...
US_Hydrodyn_Dad::mode_select ()
{
  ...
  switch (current_mode)
    ...
    case MODE_NORMAL:
      {
        ...
        for (int i = 0; i < (int)pb_row_widgets.size (); ++i)
          {
            ShowHide::hide_widgets (pb_row_widgets[i], always_hide_widgets,
                                    false);
          }
      }
      break;
    ...
    case MODE_WYATT:
      mode_title (pb_wyatt_start->text ());
      ShowHide::hide_widgets (wyatt_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0, always_hide_widgets);
      break;
    case MODE_BLANKS:
      mode_title (pb_blanks_start->text ());
      ShowHide::hide_widgets (blanks_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0, always_hide_widgets);
      break;
    case MODE_BASELINE:
      mode_title (pb_baseline_start->text ());
      ShowHide::hide_widgets (baseline_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0, always_hide_widgets);
      break;
    case MODE_TIMESHIFT:
      mode_title (pb_timeshift->text ());
      ShowHide::hide_widgets (timeshift_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0, always_hide_widgets);
      break;
    case MODE_SCALE:
      mode_title (pb_scale->text ());
      ShowHide::hide_widgets (scale_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1, always_hide_widgets);
      break;
    case MODE_TESTIQ:
      mode_title (pb_testiq->text ());
      ShowHide::hide_widgets (testiq_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1, always_hide_widgets);
      break;
    case MODE_GUINIER:
      mode_title (pb_guinier->text ());
      ShowHide::hide_widgets (guinier_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1, always_hide_widgets);
      break;
    case MODE_RGC:
      mode_title (pb_rgc->text ());
      ShowHide::hide_widgets (rgc_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1, always_hide_widgets);
      break;
    case MODE_PM:
      mode_title (pb_pm->text ());
      ShowHide::hide_widgets (pm_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1, always_hide_widgets);
      break;
    case MODE_POWERFIT:
      mode_title (pb_powerfit->text ());
      ShowHide::hide_widgets (powerfit_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 9, always_hide_widgets);
      break;
    case MODE_BASELINE2:
      mode_title (pb_baseline2_start->text ());
      ShowHide::hide_widgets (baseline2_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 9, always_hide_widgets);
      break;
    default:
      us_qdebug ("mode select error");
      break;
    }
...
void
US_Hydrodyn_Dad::mode_select (modes mode)
{
  current_mode = mode;
  mode_select ();
}
...
void
US_Hydrodyn_Dad::mode_title (QString title)
{
...
void
US_Hydrodyn_Dad::update_enables ()
{
  ...
  bool all_rt
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_Rt_q").size ();
  bool all_ihasht
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_Ihasht_q").size ();
  bool all_ihashq
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_Ihashq_").size ();
  bool all_istarq
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_Istarq_").size ();
  bool all_UV_Vis
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_UV-Vis_").size ();
  bool all_atl
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_At_L").size ();
  bool any_blc
      = files_selected_count
        && files_selected_count
               == (unsigned int)selected_files.filter ("_blc").size ();

  bool files_compatible = compatible_files (selected_files);
  bool files_are_time = type_files (selected_files);
  //   bool one_conc_file    = files_selected_count == 1 && files_are_time &&
  //   conc_files.count( last_selected_file );
  // if ( files_selected_count == 1 )
  // {
  //    us_qdebug( QString( "last_selected_file: %1\nconc_files: %2" ).arg(
  //    last_selected_file ).arg( conc_files.size() ) ); for ( set < QString
  //    >::iterator it = conc_files.begin();
  //          it != conc_files.end();
  //          ++it )
  //    {
      ...
      if (lb_created_files->item (i)->isSelected ())
        {
          ...
          if (created_files_not_saved.count (
                  lb_created_files->item (i)->text ()))
            {
  ...
  baseline_integral
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["dad_bl_integral"] == "true";

  // pb_timeshift        ->setEnabled( files_selected_count > 0 &&
  // files_compatible && files_are_time );
  pb_timeshift->setEnabled (
      (int64_t)files_selected_count - conc_selected_count > 0
      && files_compatible && files_are_time && conc_files.size ());
  pb_timescale->setEnabled (files_selected_count && files_are_time
                            && conc_selected_count == files_selected_count);
  ...
  pb_ggauss_start->setEnabled (files_selected_count > 1 && files_are_time
                               && gaussians.size ());
  cb_sd_weight->setEnabled (files_selected_count && files_are_time
                            && gaussians.size ());
  cb_fix_width->setEnabled (files_selected_count && files_are_time
                            && gaussians.size () && U_EXPT);
  cb_fix_dist1->setEnabled (files_selected_count && files_are_time
                            && gaussians.size () && U_EXPT);
  cb_fix_dist2->setEnabled (files_selected_count && files_are_time
                            && gaussians.size () && U_EXPT);
  pb_blanks_start->setEnabled (
      default_blanks.size ()
      || (files_selected_count > 1 && !files_are_time && files_compatible));
  pb_baseline_start->setEnabled (!files_are_time && files_compatible
                                 && files_selected_count == 1);

  pb_baseline_apply->setEnabled (
      files_selected_count && files_are_time
      && le_baseline_start->text ().toDouble ()
             < le_baseline_end->text ().toDouble ()
      && !baseline_integral
      // ( !baseline_integral || baseline_ready_to_apply )
  );
  pb_wyatt_start->setEnabled (files_selected_count == 1 && files_are_time);
  pb_wyatt_apply->setEnabled (files_selected_count && files_are_time
  ...
  pb_avg->setEnabled (files_selected_count > 1 && files_compatible
                      && !files_are_time);
  pb_bin->setEnabled (files_selected_count
                      && files_compatible /* && !files_are_time */);
  pb_smooth->setEnabled (files_selected_count);
  pb_powerfit->setEnabled (!files_are_time && files_selected_count == 1);
  pb_baseline2_start->setEnabled (files_are_time && files_selected_count == 1
                                  && all_atl && all_UV_Vis);
  pb_baseline2_apply->setEnabled (files_are_time && files_selected_count
                                  && all_atl && all_UV_Vis && baseline2_fit_ok
                                  && !any_blc);
  pb_svd->setEnabled (files_selected_count > 1
                      && files_compatible); // && !files_are_time );
  pb_create_i_of_t->setEnabled (files_selected_count > 1 && files_compatible
                                && !files_are_time);
  pb_test_i_of_t->setEnabled (files_selected_count && files_compatible
                              && files_are_time);
  pb_create_i_of_q->setEnabled (files_selected_count > 1 && files_compatible
                                && files_are_time && all_atl
                                && all_UV_Vis /* && gaussians.size() */);
  pb_create_ihash_t->setEnabled (
      files_selected_count > 1 && files_compatible && files_are_time
      && dad_param_n && dad_param_lambda && dad_param_g_dndc
      && selected_files.count () == selected_files.filter ("_Rt_").count ());
  pb_create_istar_q->setEnabled (files_selected_count > 1 && files_compatible
                                 && files_are_time && all_ihasht);
  pb_load_conc->setEnabled (true);
  // pb_repeak             ->setEnabled( files_selected_count > 1 &&
  // files_compatible && files_are_time );
  pb_repeak->setEnabled (
      files_are_time && conc_files.size ()
  ...
  //                                        lb_files->item( last_selected_pos
  //                                        )->text() != lbl_dad->text() &&
  //                                        lb_files->item( last_selected_pos
  //                                        )->text() != lbl_empty ->text() &&
  //                                        lb_files->item( last_selected_pos
  //                                        )->text() != lbl_signal->text()
  //                                        );
  ...
  pb_to_saxs->setEnabled (files_selected_count && files_compatible
                          && !files_are_time);
  ...
  pb_ag->setEnabled (files_selected_count == 1 && files_compatible
                     && !files_are_time);
  ...
  pb_q_exclude_vis->setEnabled (files_selected_count && files_compatible
                                && !files_are_time);
  pb_q_exclude_left->setEnabled (files_selected_count && files_compatible
                                 && !files_are_time);
  pb_q_exclude_right->setEnabled (files_selected_count && files_compatible
                                  && !files_are_time);
...
#if defined(DEBUG_SCALING)
  {
    ...
    tso << "------------------------------------------------------------------"
           "--------------\n";
    tso << QString ().sprintf (
        "plot_dist->axisScaleDiv( QwtPlot::xBottom ).lower,upperBound()     "
        "%g\t%g\n"
        "plot_dist->axisScaleDiv( QwtPlot::yLeft ).lower,upperBound()       "
        "%g\t%g\n"
    ...
    tso << "------------------------------------------------------------------"
           "--------------\n";
    tso << QString ().sprintf (
        "plot_errors->axisScaleDiv( QwtPlot::xBottom ).lower,upperBound()     "
        "%g\t%g\n"
        "plot_errors->axisScaleDiv( QwtPlot::yLeft ).lower,upperBound()       "
        "%g\t%g\n"
  ...
  pb_select_vis->setEnabled (files_selected_count && plot_dist_zoomer
                             && plot_dist_zoomer->zoomRect ()
                                    != plot_dist_zoomer->zoomBase ());
  pb_remove_vis->setEnabled (files_selected_count && plot_dist_zoomer
                             && plot_dist_zoomer->zoomRect ()
                                    != plot_dist_zoomer->zoomBase ());
  pb_crop_common->setEnabled (files_selected_count && files_compatible);

  pb_crop_vis->setEnabled (files_selected_count && plot_dist_zoomer
                           && plot_dist_zoomer->zoomRect ()
                                  != plot_dist_zoomer->zoomBase ());
  pb_crop_to_vis->setEnabled (files_selected_count && plot_dist_zoomer
                              && plot_dist_zoomer->zoomRect ()
                                     != plot_dist_zoomer->zoomBase ());
  pb_crop_zero->setEnabled (files_selected_count);
  pb_crop_left->setEnabled (files_selected_count && plot_dist_zoomer
                            && plot_dist_zoomer->zoomRect ()
                                   != plot_dist_zoomer->zoomBase ());
  pb_crop_undo->setEnabled (crop_undos.size ());
  pb_crop_right->setEnabled (files_selected_count && plot_dist_zoomer
                             && plot_dist_zoomer->zoomRect ()
                                    != plot_dist_zoomer->zoomBase ());
  ...
  pb_rgc->setEnabled (true);
  pb_simulate->setEnabled (files_selected_count && files_compatible
                           && !files_are_time);
  pb_pm->setEnabled (files_selected_count == 1 && files_compatible
                     && !files_are_time);
  pb_testiq->setEnabled (files_selected_count > 4 && files_compatible
                         && files_are_time);
  pb_guinier->setEnabled (files_selected_count && files_compatible
                          && !files_are_time && all_istarq);
  ...
  pb_ref->setEnabled (files_selected_count == 1 && !files_are_time
                      && !lbl_conc_file->text ().isEmpty ());
  ...
  pb_save_state->setEnabled ((lb_files->count () || stack_data.size ())
                             && !files_created_selected_not_saved_count);

  pb_p3d->setEnabled (files_selected_count > 1 && files_compatible
                      && files_are_time);

  {
    ...
    plot_dist->enableAxis (QwtPlot::xBottom, !plot_errors->isVisible ());
    // qDebug() << "::update_enables() plot_errors is " << (
    // plot_errors->isVisible() ? "visible" : "not visible" );
  }
  {
    QString title;
    if (!files_compatible)
  ...
  if (cb_eb->isChecked () && !cb_eb->isEnabled ())
    {
      cb_eb->setChecked (false);
      set_eb ();
    }
...
void
US_Hydrodyn_Dad::model_select_all ()
{
...
void
US_Hydrodyn_Dad::model_remove (QStringList files)
{
  disable_updates = true;
  ...
  if (model_not_saved_list.size ())
    {
      ...
      if (qsl.size () < model_not_saved_list.size ())
        {
          qsl << QString (us_tr ("... and %1 more not listed"))
                     .arg (model_not_saved_list.size () - qsl.size ());
        }

      switch (QMessageBox::warning (
          this, windowTitle () + us_tr (" Remove Models"),
          QString (us_tr ("Please note:\n\n"
                          "These models were created but not saved as "
                          ".bead_model files:\n"
                          "%1\n\n"
                          "What would you like to do?\n"))
              .arg (qsl.join ("\n")),
          us_tr ("&Save them now"), us_tr ("&Remove them anyway"),
  ...
  for (int i = lb_model_files->count () - 1; i >= 0; i--)
    {
      if (selected_map.count (lb_model_files->item (i)->text ()))
        {
          editor_msg ("black", QString (us_tr ("Removed model %1"))
                                   .arg (lb_model_files->item (i)->text ()));
...
void
US_Hydrodyn_Dad::model_view (QStringList files)
{
      ...
      if (dir.mkdir (tmpd))
        {
          editor_msg (
              "red",
              QString (
                  us_tr ("Error: could not create temporary directory %1"))
                  .arg (tmpd));
          return;
        }
    }
  ...
  for (int i = 0; i < (int)files.size (); ++i)
    {
      ...
      if (qsl0.size () < 1)
        {
          editor_msg (
              "red",
              QString (
                  us_tr ("Error: insufficient model info for file %1 [a]"))
                  .arg (files[i]));
          return;
        }
      ...
      {
        QStringList qsl
            = (qsl0[0]).split (QRegExp ("\\s+"), Qt::SkipEmptyParts);
        if (qsl.size () < 1)
          {
            editor_msg (
                "red",
                QString (
                    us_tr ("Error: insufficient model info for file %1 [b]"))
                    .arg (files[i]));
            return;
          }
      ...
      for (int j = 1; j < (int)qsl0.size () && linepos < bead_count; ++j)
        {
          ...
          QStringList qsl
              = (qsl0[j]).split (QRegExp ("\\s+"), Qt::SkipEmptyParts);

          if (qsl.size () < 4)
            {
              editor_msg ("red",
                          QString (us_tr ("Error: insufficient model info for "
                                          "file %1 line %2 [c]"))
                              .arg (files[i])
                              .arg (linepos));
              return;
        ...
        if (!f.open (QIODevice::WriteOnly))
          {
            editor_msg (
                "red",
                QString (us_tr ("Error: could not create output file %1"))
                    .arg (f.fileName ()));
            return;
          }
        QTextStream ts (&f);
      ...
      ((US_Hydrodyn *)us_hydrodyn)
          ->model_viewer (tmpd + QDir::separator () + files[i] + ".spt",
                          "-script");
    }
}

void
US_Hydrodyn_Dad::model_text (QStringList files)
{
  ...
  for (int i = 0; i < (int)files.size (); ++i)
    {
      ...
      if (!f.open (QIODevice::WriteOnly))
        {
          editor_msg (
              "red", QString (us_tr ("Error: could not create output file %1"))
                         .arg (f.fileName ()));
          return;
        }
      QTextStream ts (&f);
...
bool
US_Hydrodyn_Dad::model_save (QStringList files)
{
  bool errors = false;
...
bool
US_Hydrodyn_Dad::model_save (QString file, bool &cancel, bool &overwrite_all)
{
  if (!models.count (file))
    {
      editor_msg ("red",
                  QString (us_tr ("Error: no data found for %1")).arg (file));
      return false;
    }
    ...
    if (!dir1.exists ())
      {
        if (dir1.mkdir (le_created_dir->text ()))
          {
            editor_msg ("black", QString (us_tr ("Created directory %1"))
                                     .arg (le_created_dir->text ()));
          }
        else
          {
            editor_msg ("red",
                        QString (us_tr ("Error: Can not create directory %1 "
                                        "Check permissions."))
                            .arg (le_created_dir->text ()));
            return false;
          }
  ...
  if (!QDir::setCurrent (le_created_dir->text ()))
    {
      editor_msg ("red", QString (us_tr ("Error: can not set directory %1"))
                             .arg (le_created_dir->text ()));
      return false;
    }
  ...
  if (!overwrite_all && QFile::exists (use_filename))
    {
      use_filename = ((US_Hydrodyn *)us_hydrodyn)
                         ->fileNameCheck2 (use_filename, cancel, overwrite_all,
                                           0, this);
      raise ();
      if (cancel)
        {
  ...
  if (!f.open (QIODevice::WriteOnly))
    {
      editor_msg (
          "red",
          QString (
              us_tr ("Error: can not open %1 in directory %2 for writing"))
              .arg (use_filename)
  ...
  editor_msg (
      "black",
      QString (us_tr ("%1 written as %2")).arg (file).arg (use_filename));
  models_not_saved.erase (file);
  return true;
}

void
US_Hydrodyn_Dad::usp_config_plot_dist (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_plot_ref (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_ggqfit_plot (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_guinier_plot (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_guinier_plot_rg (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_guinier_plot_mw (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_guinier_plot_summary (const QPoint &)
{
...
void
US_Hydrodyn_Dad::usp_config_guinier_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Dad::set_pbmode_main ()
{
  pbmode_select (PBMODE_MAIN);
}

void
US_Hydrodyn_Dad::set_pbmode_sel ()
{
  pbmode_select (PBMODE_SEL);
}

void
US_Hydrodyn_Dad::set_pbmode_crop ()
{
  pbmode_select (PBMODE_CROP);
}

void
US_Hydrodyn_Dad::set_pbmode_conc ()
{
  pbmode_select (PBMODE_CONC);
}

void
US_Hydrodyn_Dad::set_pbmode_sd ()
{
  pbmode_select (PBMODE_SD);
}

void
US_Hydrodyn_Dad::set_pbmode_fasta ()
{
  pbmode_select (PBMODE_FASTA);
}

void
US_Hydrodyn_Dad::set_pbmode_dad ()
{
  pbmode_select (PBMODE_DAD);
}

void
US_Hydrodyn_Dad::set_pbmode_q_exclude ()
{
  pbmode_select (PBMODE_Q_EXCLUDE);
}

void
US_Hydrodyn_Dad::set_pbmode_none ()
{
  pbmode_select (PBMODE_NONE);
}

void
US_Hydrodyn_Dad::pbmode_select (pbmodes mode)
{
  ...
  switch (mode)
    ...
    case PBMODE_SD:
      ...
      break;
    case PBMODE_FASTA:
      ShowHide::hide_widgets (pbmode_fasta_widgets, always_hide_widgets,
                              false);
      break;
    case PBMODE_DAD:
    ...
    case PBMODE_Q_EXCLUDE:
      ShowHide::hide_widgets (pbmode_q_exclude_widgets, always_hide_widgets,
                              false);
      break;
    case PBMODE_NONE:
      break;
...
US_Hydrodyn_Dad::fasta_file ()
{
  ...
  QString filename = QFileDialog::getOpenFileName (
      this, windowTitle () + us_tr ("Load FASTA sequence File"), use_dir,
  ...
  if (!f.open (QIODevice::ReadOnly))
    {
      QMessageBox::warning (
          this, windowTitle () + us_tr (": Compute PSV from FASTA"),
          QString (us_tr ("Could not open file '%1' for reading. Possibly a "
                          "permissions issue."))
              .arg (filename));
      return;
    }
  ...
  if (seq.isEmpty ())
    {
      QMessageBox::warning (
          this, windowTitle () + us_tr (": Compute PSV from FASTA"),
          QString (us_tr ("File '%1' no sequence information found."))
              .arg (filename));
      return;
    }
  ...
  if (!((US_Hydrodyn *)us_hydrodyn)->calc_fasta_vbar (seq_chars, psv, msgs))
    {
      QMessageBox::warning (
          this, windowTitle () + us_tr (": Compute PSV from FASTA"), msgs);
      return;
    }
...
void
US_Hydrodyn_Dad::q_exclude_update_lbl ()
{
  ...
  if (!q_exclude.size ())
    {
      lbl_q_exclude_detail->setText (
          msg + us_tr ("<b>Currently no excluded q values</b>") + "<br>");
      plot_files (true);
      return;
    }
...
void
US_Hydrodyn_Dad::q_exclude_clear ()
{
  q_exclude.clear ();
  q_exclude_update_lbl ();
}
      ...
      if (lb_files->item (i)->isSelected ())
        {
          ...
          if (f_qs.count (this_file) && f_Is.count (this_file))
            {
              for (unsigned int i = 0; i < f_qs[this_file].size (); i++)
                {
                  if (f_qs[this_file][i] >= minx && f_qs[this_file][i] <= maxx
  ...
  if (!selected_files.size ())
    {
      editor_msg (
          "red",
          us_tr ("q exclude visible: The current visible plot is empty"));
      return;
    }
  ...
  if (added)
    {
      msg += QString (
                 us_tr (
                     " %1 selected q value(s) added to the exclusion list."))
                 .arg (added);
    }
  if (preexisting)
    {
      msg += QString (
                 us_tr (" %1 selected q value(s) was(were) already excluded."))
                 .arg (preexisting);
      if (!added)
        {
          color = "darkred";
...
void
US_Hydrodyn_Dad::q_exclude_left ()
{
  // find curves within zoomRect
  double minx = plot_dist_zoomer->zoomRect ().left ();
  double maxx = plot_dist_zoomer->zoomRect ().right ();
  ...
  if (!selected_files.size ())
    {
      editor_msg ("red",
                  us_tr ("q exclude left: The current visible plot is empty"));
      return;
    }
  ...
  if (this_q_new.size ())
    {
      ...
      editor_msg (
          "darkblue",
          us_tr ("q exclude : 1 new visible left q value was added\n"));
      q_exclude_update_lbl ();
    }
  else
    {
      editor_msg (
          "darkred",
          us_tr ("q exclude : no new visible left q values were found\n"));
    }
}

void
US_Hydrodyn_Dad::q_exclude_right ()
{
  // find curves within zoomRect
  double minx = plot_dist_zoomer->zoomRect ().left ();
  double maxx = plot_dist_zoomer->zoomRect ().right ();
  ...
  if (!selected_files.size ())
    {
      editor_msg (
          "red", us_tr ("q exclude right: The current visible plot is empty"));
      return;
    }
  ...
  if (this_q_new.size ())
    {
      ...
      editor_msg (
          "darkblue",
          us_tr ("q exclude : 1 new visible right q value was added\n"));
      q_exclude_update_lbl ();
    }
  else
    {
      editor_msg (
          "darkred",
          us_tr ("q exclude : no new visible right q values were found\n"));
    }
}

void
US_Hydrodyn_Dad::q_exclude_opt_remove_unreferenced ()
{
  ...
  switch (QMessageBox::question (
      this, windowTitle () + us_tr (" : q excludes"),
      QString (
          us_tr (
