...
void US_Hydrodyn_Dad::setupGUI() {
  ...
  /*
    ...
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Button, QBrush( QColor(
    "blue" ), Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Light,
    QBrush( QColor( "darkcyan" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::Midlight, QBrush( QColor( "darkblue" ), Qt::SolidPattern ) );
    cg_magenta.setBrush( QPalette::Dark, QBrush( QColor( "yellow" ),
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Mid, QBrush( QColor(
    "darkred" ), Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Text,
    QBrush( QColor( "green" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::BrightText, QBrush( QColor( "darkgreen" ), Qt::SolidPattern ) );
    cg_magenta.setBrush( QPalette::ButtonText, QBrush( QColor( "cyan" ),
    Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Base, QBrush( QColor(
    "gray" ), Qt::SolidPattern ) ); cg_magenta.setBrush( QPalette::Shadow,
    QBrush( QColor( "magenta" ), Qt::SolidPattern ) ); cg_magenta.setBrush(
    QPalette::Highlight, QBrush( QColor( "darkyellow" ), Qt::SolidPattern ) );
    cg_magenta.setBrush( QPalette::HighlightedText, QBrush( QColor( "darkred" ),
    Qt::SolidPattern ) );
  */
  ...
  lbl_powerfit_fit_epsilon->setFont(QFont(USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  ...
  le_powerfit_fit_epsilon->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  le_powerfit_fit_max_calls->setFont(QFont(USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 1));
  ...
  lbl_powerfit_uncorrected_conc =
      new QLabel(us_tr(" Uncorr., Scat. corr.,Full corr. c [mg/mL]: "), this);
  ...
  connect(le_powerfit_uncorrected_conc, SIGNAL(textChanged(const QString &)),
  ...
  le_powerfit_computed_conc->setFont(QFont(USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 1));
  ...
  lbl_powerfit_lambda =
      new QLabel(us_tr(QString("%1(abs) [nm]:").arg(UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda_abs =
      new QLabel(us_tr(QString("A(%1,abs) [a.u.]:").arg(UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda_abs->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  lbl_powerfit_lambda2 =
      new QLabel(us_tr(QString("%1(scat) [nm]:").arg(UNICODE_LAMBDA)), this);
  ...
  lbl_powerfit_lambda2_abs->setFont(QFont(USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  ...
  le_powerfit_lambda2_abs->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
...
#else
  connect(lb_created_files, SIGNAL(customContextMenuRequested(const QPoint &)),
  ...
  cb_gauss_match_amplitude->setFont(QFont(USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  ...
  pb_gauss_local_caruanas->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
...

  {
    ...
    cb_ggauss_scroll_p_red->setFont(QFont(USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  ...
  cb_testiq_from_gaussian->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  lbl_guinier_delta_range->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
...
#endif
#if QT_VERSION < 0x040000
  connect(guinier_plot->canvas(), SIGNAL(mouseReleased(const QMouseEvent &)),
          SLOT(plot_mouse(const QMouseEvent &)));
#endif
  ...
  guinier_plot_errors->setAxisTitleFont(
      QwtPlot::yLeft, QFont(USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_errors->setAxisFont(QwtPlot::yLeft,
                                   QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_errors->setAxisTitleFont(
      QwtPlot::xBottom, QFont(USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_errors->setAxisFont(QwtPlot::xBottom,
                                   QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
#if QT_VERSION < 0x040000
  guinier_plot_errors->setAxisTitleFont(
      QwtPlot::yRight, QFont(USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));
#endif
  guinier_plot_errors->setAxisFont(QwtPlot::yRight,
                                   QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  guinier_plot_errors->setLegendFont(QFont(USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 2));
#else
  // {
  //    QwtLegend* legend_pd = new QwtLegend;
...
#endif
#if QT_VERSION < 0x040000
  connect(guinier_plot_rg->canvas(), SIGNAL(mouseReleased(const QMouseEvent &)),
          SLOT(plot_mouse(const QMouseEvent &)));
#endif
...
#endif
#if QT_VERSION < 0x040000
  connect(guinier_plot_mw->canvas(), SIGNAL(mouseReleased(const QMouseEvent &)),
          SLOT(plot_mouse(const QMouseEvent &)));
#endif
  ...
  lbl_guinier_rg_rg_range->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  cb_guinier_lock_rg_range->setFont(QFont(USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  ...
  lbl_guinier_mw_mw_range->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  cb_guinier_lock_mw_range->setFont(QFont(USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  ...
  rb_rgc_shape_ellipsoid->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_pm_samp_e_dens = new QLabel(us_tr("Sample e density [e/A^3] (Tp. Prot: "
                                        ".41-.44, DNA:.59: RNA:.6 Carb:.49)"),
                                  this);
  ...
  // QBoxLayout * hbl_mode = new QHBoxLayout(); hbl_mode->setContentsMargins( 0,
  // 0, 0, 0 ); hbl_mode->setSpacing( 0 ); hbl_mode->addWidget( pb_gauss_start
  // ); hbl_mode->addWidget( pb_ggauss_start ); hbl_mode->addWidget(
  // pb_baseline_start ); hbl_mode->addWidget( pb_baseline_apply );
  ...
  //    ); gl->setSpacing( 0 ); int row = 0; int col = 0;
  ...
  //                 )->gparams[ "dad_files_widgets" ] == "false" ? false : true
  //                 );
  ...
  if (model_not_saved_list.size()) {
    ...
    switch (QMessageBox::warning(
        ...
        QString(us_tr("Please note:\n\n"
                      "These models were created but not saved as .bead_model "
                      "files:\n"
                      "%1\n\n"
...
void US_Hydrodyn_Dad::model_view(QStringList files) {
  ...
  if (!dir.exists()) {
    if (dir.mkdir(tmpd)) {
      editor_msg(
          "red",
          QString(us_tr("Error: could not create temporary directory %1"))
              .arg(tmpd));
      return;
    }
  }
  ...
  for (int i = 0; i < (int)files.size(); ++i) {
    ...
    if (qsl0.size() < 1) {
      editor_msg(
          "red",
          QString(us_tr("Error: insufficient model info for file %1 [a]"))
              .arg(files[i]));
      return;
    }

    {
      ...
      if (qsl.size() < 1) {
        editor_msg(
            "red",
            QString(us_tr("Error: insufficient model info for file %1 [b]"))
                .arg(files[i]));
        return;
      }
    ...
    for (int j = 1; j < (int)qsl0.size() && linepos < bead_count; ++j) {
      ...
      if (qsl.size() < 4) {
        editor_msg(
            "red",
            QString(
                us_tr("Error: insufficient model info for file %1 line %2 [c]"))
                .arg(files[i])
                .arg(linepos));
        return;
      }
    ...
    ((US_Hydrodyn *)us_hydrodyn)
        ->model_viewer(tmpd + QDir::separator() + files[i] + ".spt", "-script");
  }
}
...
void US_Hydrodyn_Dad::model_text(QStringList files) {
  ...
  for (int i = 0; i < (int)files.size(); ++i) {
    ...
    QFile f(tmpd + "/" + file);
    if (!f.open(QIODevice::WriteOnly)) {
      editor_msg("red", QString(us_tr("Error: could not create output file %1"))
                            .arg(f.fileName()));
      return;
    }
    QTextStream ts(&f);
...
bool US_Hydrodyn_Dad::model_save(QString file, bool &cancel,
                                 bool &overwrite_all) {
...

  {
    ...
    if (!dir1.exists()) {
      if (dir1.mkdir(le_created_dir->text())) {
        editor_msg(
            "black",
            QString(us_tr("Created directory %1")).arg(le_created_dir->text()));
      } else {
        editor_msg(
            "red",
            QString(
                us_tr("Error: Can not create directory %1 Check permissions."))
  ...
  if (!overwrite_all && QFile::exists(use_filename)) {
    use_filename =
        ((US_Hydrodyn *)us_hydrodyn)
            ->fileNameCheck2(use_filename, cancel, overwrite_all, 0, this);
    raise();
    if (cancel) {
      return false;
    }
  ...
  if (!f.open(QIODevice::WriteOnly)) {
    editor_msg(
        "red",
        QString(us_tr("Error: can not open %1 in directory %2 for writing"))
            .arg(use_filename)
...
void US_Hydrodyn_Dad::set_pbmode_main() { pbmode_select(PBMODE_MAIN); }

void US_Hydrodyn_Dad::set_pbmode_sel() { pbmode_select(PBMODE_SEL); }

void US_Hydrodyn_Dad::set_pbmode_crop() { pbmode_select(PBMODE_CROP); }

void US_Hydrodyn_Dad::set_pbmode_conc() { pbmode_select(PBMODE_CONC); }

void US_Hydrodyn_Dad::set_pbmode_sd() { pbmode_select(PBMODE_SD); }

void US_Hydrodyn_Dad::set_pbmode_fasta() { pbmode_select(PBMODE_FASTA); }

void US_Hydrodyn_Dad::set_pbmode_dad() { pbmode_select(PBMODE_DAD); }

void US_Hydrodyn_Dad::set_pbmode_q_exclude() {
  pbmode_select(PBMODE_Q_EXCLUDE);
}

void US_Hydrodyn_Dad::set_pbmode_none() { pbmode_select(PBMODE_NONE); }
...
void US_Hydrodyn_Dad::q_exclude_vis() {
      ...
      if (f_qs.count(this_file) && f_Is.count(this_file)) {
        for (unsigned int i = 0; i < f_qs[this_file].size(); i++) {
          if (f_qs[this_file][i] >= minx && f_qs[this_file][i] <= maxx &&
              f_Is[this_file][i] >= miny && f_Is[this_file][i] <= maxy) {
  ...
  if (added) {
    msg +=
        QString(us_tr(" %1 selected q value(s) added to the exclusion list."))
            .arg(added);
  }
  if (preexisting) {
    msg += QString(us_tr(" %1 selected q value(s) was(were) already excluded."))
               .arg(preexisting);
    if (!added) {
      color = "darkred";
    }
...
void US_Hydrodyn_Dad::q_exclude_right() {
  ...
  if (!selected_files.size()) {
    editor_msg("red",
               us_tr("q exclude right: The current visible plot is empty"));
    return;
  }
...
void US_Hydrodyn_Dad::q_exclude_opt_remove_unreferenced() {
  ...
  switch (QMessageBox::question(
      ...
      QString(
          us_tr("%1 excluded q values are no longer referenced by any curves\n"
