...
US_Hydrodyn_Saxs_Hplc_Simulate::US_Hydrodyn_Saxs_Hplc_Simulate (
    void *us_hydrodyn, void *hplc_win, QStringList files,
...
void
US_Hydrodyn_Saxs_Hplc_Simulate::setupGUI ()
{
  if (files.size () > 5)
    {
...
void
US_Hydrodyn_Saxs_Hplc_Simulate::cancel ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Simulate::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Simulate::closeEvent (QCloseEvent *e)
{
  QMessageBox mb (
      this->windowTitle (),
...
void
US_Hydrodyn_Saxs_Hplc_Simulate::displayData ()
{
  update_enables ();
}

void
US_Hydrodyn_Saxs_Hplc_Simulate::update_enables ()
{
...
#define HW ((US_Hydrodyn_Saxs_Hplc *)hplc_win)
...
void
US_Hydrodyn_Saxs_Hplc_Simulate::simulate ()
{
  ...
  // make a bunch of I(t)'s first... then convert to I(q) for output to hplc
