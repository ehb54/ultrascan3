...
void US_Hydrodyn_Saxs_Hplc_Simulate::cancel() { close(); }

void US_Hydrodyn_Saxs_Hplc_Simulate::help() {
  US_Help *online_help;
...
void US_Hydrodyn_Saxs_Hplc_Simulate::displayData() { update_enables(); }

void US_Hydrodyn_Saxs_Hplc_Simulate::update_enables() {
