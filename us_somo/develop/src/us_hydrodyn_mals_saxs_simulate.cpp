...
US_Hydrodyn_Mals_Saxs_Simulate::US_Hydrodyn_Mals_Saxs_Simulate (
    void *us_hydrodyn, void *mals_saxs_win, QStringList files,
...
void
US_Hydrodyn_Mals_Saxs_Simulate::setupGUI ()
{
  if (files.size () > 5)
    {
...
void
US_Hydrodyn_Mals_Saxs_Simulate::cancel ()
{
  close ();
}

void
US_Hydrodyn_Mals_Saxs_Simulate::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Mals_Saxs_Simulate::closeEvent (QCloseEvent *e)
{
  QMessageBox mb (
      this->windowTitle (),
...
void
US_Hydrodyn_Mals_Saxs_Simulate::displayData ()
{
  update_enables ();
}

void
US_Hydrodyn_Mals_Saxs_Simulate::update_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs_Simulate::simulate ()
{
  ...
  // make a bunch of I(t)'s first... then convert to I(q) for output to
  // mals_saxs
