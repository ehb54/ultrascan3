...
public:
  ...
  unsigned int index;
  bool
  operator< (const sortable_vector_double &objIn) const
  {
    unsigned int i;
    for (i = 0; i < vd.size (); i++)
      {
...
public:
  ...
  unsigned int index;
  bool
  operator< (const sortable_unsigned_int &objIn) const
  {
    return (ui < objIn.ui);
  }
};
...
void
US_Hydrodyn_Comparative::csv_sort (csv &csv1, vector<unsigned int> cols)
{
...
void
US_Hydrodyn_Comparative::build_ce_names_map ()
{
  ce_names.clear ();
  ce_map.clear ();
...
comparative_entry
US_Hydrodyn_Comparative::empty_comparative_entry (QString name)
{
...
bool
US_Hydrodyn_Comparative::comparative_entry_equals (comparative_entry ce1,
                                                   comparative_entry ce2)
{
  return ce1.name == ce2.name && ce1.active == ce2.active
         && ce1.target == ce2.target && ce1.rank == ce2.rank
         && ce1.include_in_weight == ce2.include_in_weight
         && ce1.weight == ce2.weight && ce1.buckets == ce2.buckets
         && ce1.min == ce2.min && ce1.max == ce2.max
...
comparative_info
US_Hydrodyn_Comparative::empty_comparative_info ()
{
  comparative_info ci;
  ci.ce_s = empty_comparative_entry ("Sedimentation coefficient s [S]");
  ci.ce_D = empty_comparative_entry (
  ...
  ci.ce_rg
      = empty_comparative_entry ("Radius of gyration [nm] (from bead model)");
...
bool
US_Hydrodyn_Comparative::comparative_info_equals (comparative_info ci1,
                                                  comparative_info ci2)
{
  return comparative_entry_equals (ci1.ce_s, ci2.ce_s)
...
QString
US_Hydrodyn_Comparative::serialize_comparative_entry (comparative_entry ce)
{
  return QString (
...
comparative_entry
US_Hydrodyn_Comparative::deserialize_comparative_entry (QString qs)
{
...
QString
US_Hydrodyn_Comparative::serialize_comparative_info (comparative_info ci)
{
...
comparative_info
US_Hydrodyn_Comparative::deserialize_comparative_info (QString qs)
{
  ...
  if (qsl0.size () < 4)
    {
      serial_error
          = us_tr ("Error: invalid parameter file (line 1 too short)");
      return ci;
    }
...
void
US_Hydrodyn_Comparative::setupGUI ()
{
  int minHeight0 = 0;
  int minHeight1 = 30;
  int minHeight2b = 52;
  ...
  lbl_title_param->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1,
                                   QFont::Bold));

  lbl_active
      = new QLabel (us_tr ("Select to enable variable comparison"), this);
  ...
  AUTFBACK (lbl_active);
  lbl_active->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lbl_target);
  lbl_target->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lbl_sort);
  lbl_sort->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lbl_rank);
  lbl_rank->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));

  cb_weight_controls = new QCheckBox (this);
  cb_weight_controls->setMinimumHeight (minHeight2b);
  cb_weight_controls->setText (
      QString (us_tr ("By weighted sum\nof %1absolute\ndifferences"))
          .arg (comparative->by_pct ? "% " : ""));
  ...
  connect (cb_weight_controls, SIGNAL (clicked ()),
           SLOT (set_weight_controls ()));
  ...
  lbl_include_in_weight->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  AUTFBACK (lbl_weight);
  lbl_weight->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lbl_ec);
  lbl_ec->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize, QFont::Bold));
  ...
  lbl_buckets->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lbl_min);
  lbl_min->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lbl_max);
  lbl_max->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize, QFont::Bold));
  ...
  lbl_csv_controls->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize,
                                    QFont::Bold));
  ...
  lbl_store_reference->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize,
                                       QFont::Bold));

  lbl_store_diff = new QLabel (
  ...
  lbl_store_diff->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize,
                                  QFont::Bold));
  ...
  lbl_store_abs_diff->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize,
                                      QFont::Bold));
  ...
  cb_active_s->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  cb_active_s->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_s);
  connect (cb_active_s, SIGNAL (clicked ()), SLOT (set_active_s ()));

  le_target_s = new QLineEdit (this);
  le_target_s->setObjectName ("target_s Line Edit");
  ...
  le_target_s->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  connect (le_target_s, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_s (const QString &)));

  le_rank_s = new QLineEdit (this);
  le_rank_s->setObjectName ("rank_s Line Edit");
  ...
  AUTFBACK (le_rank_s);
  le_rank_s->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_rank_s, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_s (const QString &)));
  ...
  cb_include_in_weight_s->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_include_in_weight_s->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_s);
  connect (cb_include_in_weight_s, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_s ()));

  le_weight_s = new QLineEdit (this);
  le_weight_s->setObjectName ("weight_s Line Edit");
  ...
  le_weight_s->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  connect (le_weight_s, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_s (const QString &)));

  le_buckets_s = new QLineEdit (this);
  le_buckets_s->setObjectName ("buckets_s Line Edit");
  ...
  le_buckets_s->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_buckets_s, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_s (const QString &)));

  le_min_s = new QLineEdit (this);
  le_min_s->setObjectName ("min_s Line Edit");
  ...
  AUTFBACK (le_min_s);
  le_min_s->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  connect (le_min_s, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_s (const QString &)));

  le_max_s = new QLineEdit (this);
  le_max_s->setObjectName ("max_s Line Edit");
  ...
  AUTFBACK (le_max_s);
  le_max_s->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  connect (le_max_s, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_s (const QString &)));
  ...
  cb_store_reference_s->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_store_reference_s->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_s);
  connect (cb_store_reference_s, SIGNAL (clicked ()),
           SLOT (set_store_reference_s ()));
  ...
  cb_store_diff_s->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_store_abs_diff_s->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_store_abs_diff_s->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_s);
  connect (cb_store_abs_diff_s, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_s ()));
  ...
  cb_active_D->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  cb_active_D->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_D);
  connect (cb_active_D, SIGNAL (clicked ()), SLOT (set_active_D ()));

  le_target_D = new QLineEdit (this);
  le_target_D->setObjectName ("target_D Line Edit");
  ...
  le_target_D->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  connect (le_target_D, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_D (const QString &)));

  le_rank_D = new QLineEdit (this);
  le_rank_D->setObjectName ("rank_D Line Edit");
  ...
  AUTFBACK (le_rank_D);
  le_rank_D->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_rank_D, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_D (const QString &)));
  ...
  cb_include_in_weight_D->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_include_in_weight_D->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_D);
  connect (cb_include_in_weight_D, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_D ()));

  le_weight_D = new QLineEdit (this);
  le_weight_D->setObjectName ("weight_D Line Edit");
  ...
  le_weight_D->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  connect (le_weight_D, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_D (const QString &)));

  le_buckets_D = new QLineEdit (this);
  le_buckets_D->setObjectName ("buckets_D Line Edit");
  ...
  le_buckets_D->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_buckets_D, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_D (const QString &)));

  le_min_D = new QLineEdit (this);
  le_min_D->setObjectName ("min_D Line Edit");
  ...
  AUTFBACK (le_min_D);
  le_min_D->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  connect (le_min_D, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_D (const QString &)));

  le_max_D = new QLineEdit (this);
  le_max_D->setObjectName ("max_D Line Edit");
  ...
  AUTFBACK (le_max_D);
  le_max_D->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  connect (le_max_D, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_D (const QString &)));
  ...
  cb_store_reference_D->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_store_reference_D->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_D);
  connect (cb_store_reference_D, SIGNAL (clicked ()),
           SLOT (set_store_reference_D ()));
  ...
  cb_store_diff_D->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_store_abs_diff_D->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_store_abs_diff_D->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_D);
  connect (cb_store_abs_diff_D, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_D ()));
  ...
  cb_active_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_active_sr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_sr);
  connect (cb_active_sr, SIGNAL (clicked ()), SLOT (set_active_sr ()));

  le_target_sr = new QLineEdit (this);
  le_target_sr->setObjectName ("target_sr Line Edit");
  ...
  le_target_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_target_sr, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_sr (const QString &)));

  le_rank_sr = new QLineEdit (this);
  le_rank_sr->setObjectName ("rank_sr Line Edit");
  ...
  AUTFBACK (le_rank_sr);
  le_rank_sr->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_rank_sr, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_sr (const QString &)));
  ...
  cb_include_in_weight_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  cb_include_in_weight_sr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_sr);
  connect (cb_include_in_weight_sr, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_sr ()));

  le_weight_sr = new QLineEdit (this);
  le_weight_sr->setObjectName ("weight_sr Line Edit");
  ...
  le_weight_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_weight_sr, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_sr (const QString &)));

  le_buckets_sr = new QLineEdit (this);
  le_buckets_sr->setObjectName ("buckets_sr Line Edit");
  ...
  le_buckets_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_buckets_sr, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_sr (const QString &)));

  le_min_sr = new QLineEdit (this);
  le_min_sr->setObjectName ("min_sr Line Edit");
  ...
  AUTFBACK (le_min_sr);
  le_min_sr->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_min_sr, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_sr (const QString &)));

  le_max_sr = new QLineEdit (this);
  le_max_sr->setObjectName ("max_sr Line Edit");
  ...
  AUTFBACK (le_max_sr);
  le_max_sr->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_max_sr, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_sr (const QString &)));
  ...
  cb_store_reference_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_store_reference_sr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_sr);
  connect (cb_store_reference_sr, SIGNAL (clicked ()),
           SLOT (set_store_reference_sr ()));
  ...
  cb_store_diff_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  cb_store_abs_diff_sr->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_store_abs_diff_sr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_sr);
  connect (cb_store_abs_diff_sr, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_sr ()));
  ...
  cb_active_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_active_fr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_fr);
  connect (cb_active_fr, SIGNAL (clicked ()), SLOT (set_active_fr ()));

  le_target_fr = new QLineEdit (this);
  le_target_fr->setObjectName ("target_fr Line Edit");
  ...
  le_target_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_target_fr, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_fr (const QString &)));

  le_rank_fr = new QLineEdit (this);
  le_rank_fr->setObjectName ("rank_fr Line Edit");
  ...
  AUTFBACK (le_rank_fr);
  le_rank_fr->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_rank_fr, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_fr (const QString &)));
  ...
  cb_include_in_weight_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  cb_include_in_weight_fr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_fr);
  connect (cb_include_in_weight_fr, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_fr ()));

  le_weight_fr = new QLineEdit (this);
  le_weight_fr->setObjectName ("weight_fr Line Edit");
  ...
  le_weight_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_weight_fr, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_fr (const QString &)));

  le_buckets_fr = new QLineEdit (this);
  le_buckets_fr->setObjectName ("buckets_fr Line Edit");
  ...
  le_buckets_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_buckets_fr, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_fr (const QString &)));

  le_min_fr = new QLineEdit (this);
  le_min_fr->setObjectName ("min_fr Line Edit");
  ...
  AUTFBACK (le_min_fr);
  le_min_fr->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_min_fr, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_fr (const QString &)));

  le_max_fr = new QLineEdit (this);
  le_max_fr->setObjectName ("max_fr Line Edit");
  ...
  AUTFBACK (le_max_fr);
  le_max_fr->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_max_fr, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_fr (const QString &)));
  ...
  cb_store_reference_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_store_reference_fr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_fr);
  connect (cb_store_reference_fr, SIGNAL (clicked ()),
           SLOT (set_store_reference_fr ()));
  ...
  cb_store_diff_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  cb_store_abs_diff_fr->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_store_abs_diff_fr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_fr);
  connect (cb_store_abs_diff_fr, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_fr ()));
  ...
  cb_active_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_active_rg->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_rg);
  connect (cb_active_rg, SIGNAL (clicked ()), SLOT (set_active_rg ()));

  le_target_rg = new QLineEdit (this);
  le_target_rg->setObjectName ("target_rg Line Edit");
  ...
  le_target_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_target_rg, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_rg (const QString &)));

  le_rank_rg = new QLineEdit (this);
  le_rank_rg->setObjectName ("rank_rg Line Edit");
  ...
  AUTFBACK (le_rank_rg);
  le_rank_rg->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_rank_rg, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_rg (const QString &)));
  ...
  cb_include_in_weight_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  cb_include_in_weight_rg->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_rg);
  connect (cb_include_in_weight_rg, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_rg ()));

  le_weight_rg = new QLineEdit (this);
  le_weight_rg->setObjectName ("weight_rg Line Edit");
  ...
  le_weight_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  connect (le_weight_rg, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_rg (const QString &)));

  le_buckets_rg = new QLineEdit (this);
  le_buckets_rg->setObjectName ("buckets_rg Line Edit");
  ...
  le_buckets_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_buckets_rg, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_rg (const QString &)));

  le_min_rg = new QLineEdit (this);
  le_min_rg->setObjectName ("min_rg Line Edit");
  ...
  AUTFBACK (le_min_rg);
  le_min_rg->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_min_rg, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_rg (const QString &)));

  le_max_rg = new QLineEdit (this);
  le_max_rg->setObjectName ("max_rg Line Edit");
  ...
  AUTFBACK (le_max_rg);
  le_max_rg->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  connect (le_max_rg, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_rg (const QString &)));
  ...
  cb_store_reference_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_store_reference_rg->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_rg);
  connect (cb_store_reference_rg, SIGNAL (clicked ()),
           SLOT (set_store_reference_rg ()));
  ...
  cb_store_diff_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  cb_store_abs_diff_rg->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_store_abs_diff_rg->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_rg);
  connect (cb_store_abs_diff_rg, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_rg ()));
  ...
  cb_active_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  cb_active_tau->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_tau);
  connect (cb_active_tau, SIGNAL (clicked ()), SLOT (set_active_tau ()));

  le_target_tau = new QLineEdit (this);
  le_target_tau->setObjectName ("target_tau Line Edit");
  ...
  le_target_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_target_tau, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_tau (const QString &)));

  le_rank_tau = new QLineEdit (this);
  le_rank_tau->setObjectName ("rank_tau Line Edit");
  ...
  le_rank_tau->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  connect (le_rank_tau, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_tau (const QString &)));
  ...
  cb_include_in_weight_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  cb_include_in_weight_tau->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_tau);
  connect (cb_include_in_weight_tau, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_tau ()));

  le_weight_tau = new QLineEdit (this);
  le_weight_tau->setObjectName ("weight_tau Line Edit");
  ...
  le_weight_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_weight_tau, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_tau (const QString &)));

  le_buckets_tau = new QLineEdit (this);
  le_buckets_tau->setObjectName ("buckets_tau Line Edit");
  ...
  le_buckets_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  connect (le_buckets_tau, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_tau (const QString &)));

  le_min_tau = new QLineEdit (this);
  le_min_tau->setObjectName ("min_tau Line Edit");
  ...
  AUTFBACK (le_min_tau);
  le_min_tau->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_min_tau, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_tau (const QString &)));

  le_max_tau = new QLineEdit (this);
  le_max_tau->setObjectName ("max_tau Line Edit");
  ...
  AUTFBACK (le_max_tau);
  le_max_tau->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_max_tau, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_tau (const QString &)));
  ...
  cb_store_reference_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_store_reference_tau->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_tau);
  connect (cb_store_reference_tau, SIGNAL (clicked ()),
           SLOT (set_store_reference_tau ()));
  ...
  cb_store_diff_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_store_diff_tau->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_diff_tau);
  connect (cb_store_diff_tau, SIGNAL (clicked ()),
           SLOT (set_store_diff_tau ()));
  ...
  cb_store_abs_diff_tau->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_store_abs_diff_tau->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_tau);
  connect (cb_store_abs_diff_tau, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_tau ()));
  ...
  cb_active_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  cb_active_eta->setPalette (PALET_NORMAL);
  AUTFBACK (cb_active_eta);
  connect (cb_active_eta, SIGNAL (clicked ()), SLOT (set_active_eta ()));

  le_target_eta = new QLineEdit (this);
  le_target_eta->setObjectName ("target_eta Line Edit");
  ...
  le_target_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_target_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_target_eta (const QString &)));

  le_rank_eta = new QLineEdit (this);
  le_rank_eta->setObjectName ("rank_eta Line Edit");
  ...
  le_rank_eta->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  connect (le_rank_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_rank_eta (const QString &)));
  ...
  cb_include_in_weight_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  cb_include_in_weight_eta->setPalette (PALET_NORMAL);
  AUTFBACK (cb_include_in_weight_eta);
  connect (cb_include_in_weight_eta, SIGNAL (clicked ()),
           SLOT (set_include_in_weight_eta ()));

  le_weight_eta = new QLineEdit (this);
  le_weight_eta->setObjectName ("weight_eta Line Edit");
  ...
  le_weight_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  connect (le_weight_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_weight_eta (const QString &)));

  le_buckets_eta = new QLineEdit (this);
  le_buckets_eta->setObjectName ("buckets_eta Line Edit");
  ...
  le_buckets_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  connect (le_buckets_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_buckets_eta (const QString &)));

  le_min_eta = new QLineEdit (this);
  le_min_eta->setObjectName ("min_eta Line Edit");
  ...
  AUTFBACK (le_min_eta);
  le_min_eta->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_min_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_min_eta (const QString &)));

  le_max_eta = new QLineEdit (this);
  le_max_eta->setObjectName ("max_eta Line Edit");
  ...
  AUTFBACK (le_max_eta);
  le_max_eta->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  connect (le_max_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_max_eta (const QString &)));
  ...
  cb_store_reference_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_store_reference_eta->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_reference_eta);
  connect (cb_store_reference_eta, SIGNAL (clicked ()),
           SLOT (set_store_reference_eta ()));
  ...
  cb_store_diff_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_store_diff_eta->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_diff_eta);
  connect (cb_store_diff_eta, SIGNAL (clicked ()),
           SLOT (set_store_diff_eta ()));
  ...
  cb_store_abs_diff_eta->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_store_abs_diff_eta->setPalette (PALET_NORMAL);
  AUTFBACK (cb_store_abs_diff_eta);
  connect (cb_store_abs_diff_eta, SIGNAL (clicked ()),
           SLOT (set_store_abs_diff_eta ()));

  pb_load_param = new QPushButton (us_tr ("Load Parameters"), this);
  pb_load_param->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_reset_param->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1));
  ...
  pb_save_param->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  lbl_title_csv->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1,
                                 QFont::Bold));

  pb_load_csv = new QPushButton (us_tr ("Load"), this);
  pb_load_csv->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize + 1));
  ...
  pb_process_csv->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1));
  ...
  pb_save_csv->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize + 1));
  ...
  // lbl_loaded->setFont(QFont( USglobal->config_list.fontFamily,
  ...
  AUTFBACK (lb_loaded);
  lb_loaded->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize + 1, QFont::Bold));
  lb_loaded->setSelectionMode (QAbstractItemView::MultiSelection);
  lb_loaded->setEnabled (true);
  connect (lb_loaded, SIGNAL (itemSelectionChanged ()),
           SLOT (update_loaded ()));

  pb_loaded_select_all = new QPushButton (us_tr ("Select all"), this);
  pb_loaded_select_all->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize + 1));
  ...
  connect (pb_loaded_select_all, SIGNAL (clicked ()),
           SLOT (loaded_select_all ()));

  pb_loaded_view = new QPushButton (us_tr ("View"), this);
  pb_loaded_view->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1));
  ...
  pb_loaded_merge->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1));
  ...
  pb_loaded_set_ranges->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  ...
  connect (pb_loaded_set_ranges, SIGNAL (clicked ()),
           SLOT (loaded_set_ranges ()));

  pb_loaded_remove = new QPushButton (us_tr ("Remove"), this);
  pb_loaded_remove->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize + 1));
  ...
  lb_selected->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize + 1,
                               QFont::Bold));
  lb_selected->setSelectionMode (QAbstractItemView::MultiSelection);
  lb_selected->setEnabled (true);
  connect (lb_selected, SIGNAL (itemSelectionChanged ()),
           SLOT (update_selected ()));

  pb_selected_select_all = new QPushButton (us_tr ("Select All"), this);
  pb_selected_select_all->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize + 1));
  ...
  connect (pb_selected_select_all, SIGNAL (clicked ()),
           SLOT (selected_select_all ()));

  pb_selected_merge = new QPushButton (us_tr ("Merge"), this);
  pb_selected_merge->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 1));
  ...
  pb_selected_set_ranges->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize + 1));
  ...
  connect (pb_selected_set_ranges, SIGNAL (clicked ()),
           SLOT (selected_set_ranges ()));

  pb_selected_remove = new QPushButton (us_tr ("Remove"), this);
  pb_selected_remove->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize + 1));
  ...
  background->addWidget (cb_by_pct, j + 1, 2, 1 + (j + 1) - (j + 1),
                         1 + (4) - (2));

  background->addWidget (cb_rank, j + 2, 2, 1 + (j + 2) - (j + 2),
                         1 + (2) - (2));
  background->addWidget (lbl_rank, j + 3, 2);

  background->addWidget (cb_weight_controls, j + 2, 3, 1 + (j + 2) - (j + 2),
                         1 + (4) - (3));
  background->addWidget (lbl_include_in_weight, j + 3, 3);
  background->addWidget (lbl_weight, j + 3, 4);

  background->addWidget (lbl_ec, j + 1, 5, 1 + (j + 1) - (j + 1),
                         1 + (7) - (5));
  background->addWidget (cb_by_ec, j + 2, 5, 1 + (j + 2) - (j + 2),
                         1 + (7) - (5));
  background->addWidget (lbl_buckets, j + 3, 5, 1 + (j + 3) - (j + 3),
                         1 + (5) - (5));
  background->addWidget (lbl_min, j + 3, 6, 1 + (j + 3) - (j + 3),
                         1 + (6) - (6));
  background->addWidget (lbl_max, j + 3, 7, 1 + (j + 3) - (j + 3),
                         1 + (7) - (7));

  background->addWidget (lbl_csv_controls, j, 8, 1 + (j + 1) - (j),
                         1 + (10) - (8));
  background->addWidget (lbl_store_reference, j + 2, 8, 1 + (j + 3) - (j + 2),
                         1 + (8) - (8));
  background->addWidget (lbl_store_diff, j + 2, 9, 1 + (j + 3) - (j + 2),
                         1 + (9) - (9));
  background->addWidget (lbl_store_abs_diff, j + 2, 10, 1 + (j + 3) - (j + 2),
                         1 + (10) - (10));
  ...
  hbl_param->setContentsMargins (0, 0, 0, 0);
  hbl_param->setSpacing (0);
  ...
  QGridLayout *gl_loaded_selected_editor = new QGridLayout;
  gl_loaded_selected_editor->setContentsMargins (0, 0, 0, 0);
  gl_loaded_selected_editor->setSpacing (0);
  gl_loaded_selected_editor->setSpacing (0);
  gl_loaded_selected_editor->setContentsMargins (0, 0, 0, 0);

  // gl_loaded_selected_editor->addWidget(lbl_loaded, 0, 0);
  gl_loaded_selected_editor->addWidget (lb_loaded, 0, 0, 1 + (1) - (0),
                                        1 + (0) - (0));
  QBoxLayout *hbl_loaded_buttons1 = new QHBoxLayout ();
  hbl_loaded_buttons1->setContentsMargins (0, 0, 0, 0);
  hbl_loaded_buttons1->setSpacing (0);
  ...
  hbl_loaded_buttons2->setContentsMargins (0, 0, 0, 0);
  hbl_loaded_buttons2->setSpacing (0);
  ...
  gl_loaded_selected_editor->addWidget (lb_selected, 0, 1, 1 + (1) - (0),
                                        1 + (1) - (1));

  QBoxLayout *hbl_selected_buttons1 = new QHBoxLayout ();
  hbl_selected_buttons1->setContentsMargins (0, 0, 0, 0);
  hbl_selected_buttons1->setSpacing (0);
  ...
  hbl_selected_buttons2->setContentsMargins (0, 0, 0, 0);
  hbl_selected_buttons2->setSpacing (0);
  ...
  //   gl_loaded_selected_editor->addWidget( editor , 1 , 2 , 1 + ( 1 ) - ( 1 )
  //   , 1 + ( 2 ) - ( 2 ) );
  gl_loaded_selected_editor->addLayout (vbl_editor_group, 0, 2, 1 + (3) - (0),
                                        1 + (2) - (2));

  background->addLayout (gl_loaded_selected_editor, j, 0, 1 + (j) - (j),
                         1 + (10) - (0));
  j++;
...
void
US_Hydrodyn_Comparative::cancel ()
{
  close ();
}

void
US_Hydrodyn_Comparative::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Comparative::closeEvent (QCloseEvent *e)
{
  *comparative_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_Comparative::update_enables ()
{
  if (updates_enabled)
    {
      cout << "update_enables\n";
      ...
      //      .arg(all_selected_csv_contain( comparative->ce_s ) ? "true" :
      //      "false");

      cb_active_s->setEnabled (enable_s);
      le_target_s->setEnabled (enable_s && cb_active_s->isChecked ());
      le_rank_s->setEnabled (enable_s && cb_active_s->isChecked ()
                             && cb_rank->isChecked ());
      cb_include_in_weight_s->setEnabled (enable_s && cb_active_s->isChecked ()
                                          && cb_weight_controls->isChecked ());
      le_weight_s->setEnabled (enable_s && cb_active_s->isChecked ()
                               && cb_weight_controls->isChecked ());
      le_buckets_s->setEnabled (cb_by_ec->isChecked () && enable_s
                                && cb_active_s->isChecked ());
      le_min_s->setEnabled (cb_by_ec->isChecked () && enable_s
                            && cb_active_s->isChecked ()
                            && comparative->ce_s.buckets);
      le_max_s->setEnabled (cb_by_ec->isChecked () && enable_s
                            && cb_active_s->isChecked ()
                            && comparative->ce_s.buckets);
      ...
      le_rank_D->setEnabled (enable_D && cb_active_D->isChecked ()
                             && cb_rank->isChecked ());
      cb_include_in_weight_D->setEnabled (enable_D && cb_active_D->isChecked ()
                                          && cb_weight_controls->isChecked ());
      le_weight_D->setEnabled (enable_D && cb_active_D->isChecked ()
                               && cb_weight_controls->isChecked ());
      le_buckets_D->setEnabled (cb_by_ec->isChecked () && enable_D
                                && cb_active_D->isChecked ());
      le_min_D->setEnabled (cb_by_ec->isChecked () && enable_D
                            && cb_active_D->isChecked ()
                            && comparative->ce_D.buckets);
      le_max_D->setEnabled (cb_by_ec->isChecked () && enable_D
                            && cb_active_D->isChecked ()
                            && comparative->ce_D.buckets);
      ...
      le_rank_sr->setEnabled (enable_sr && cb_active_sr->isChecked ()
                              && cb_rank->isChecked ());
      cb_include_in_weight_sr->setEnabled (
          enable_sr && cb_active_sr->isChecked ()
          && cb_weight_controls->isChecked ());
      le_weight_sr->setEnabled (enable_sr && cb_active_sr->isChecked ()
                                && cb_weight_controls->isChecked ());
      le_buckets_sr->setEnabled (cb_by_ec->isChecked () && enable_sr
                                 && cb_active_sr->isChecked ());
      le_min_sr->setEnabled (cb_by_ec->isChecked () && enable_sr
                             && cb_active_sr->isChecked ()
                             && comparative->ce_sr.buckets);
      le_max_sr->setEnabled (cb_by_ec->isChecked () && enable_sr
                             && cb_active_sr->isChecked ()
                             && comparative->ce_sr.buckets);
      cb_store_reference_sr->setEnabled (enable_sr
                                         && cb_active_sr->isChecked ());
      ...
      le_rank_fr->setEnabled (enable_fr && cb_active_fr->isChecked ()
                              && cb_rank->isChecked ());
      cb_include_in_weight_fr->setEnabled (
          enable_fr && cb_active_fr->isChecked ()
          && cb_weight_controls->isChecked ());
      le_weight_fr->setEnabled (enable_fr && cb_active_fr->isChecked ()
                                && cb_weight_controls->isChecked ());
      le_buckets_fr->setEnabled (cb_by_ec->isChecked () && enable_fr
                                 && cb_active_fr->isChecked ());
      le_min_fr->setEnabled (cb_by_ec->isChecked () && enable_fr
                             && cb_active_fr->isChecked ()
                             && comparative->ce_fr.buckets);
      le_max_fr->setEnabled (cb_by_ec->isChecked () && enable_fr
                             && cb_active_fr->isChecked ()
                             && comparative->ce_fr.buckets);
      cb_store_reference_fr->setEnabled (enable_fr
                                         && cb_active_fr->isChecked ());
      ...
      le_rank_rg->setEnabled (enable_rg && cb_active_rg->isChecked ()
                              && cb_rank->isChecked ());
      cb_include_in_weight_rg->setEnabled (
          enable_rg && cb_active_rg->isChecked ()
          && cb_weight_controls->isChecked ());
      le_weight_rg->setEnabled (enable_rg && cb_active_rg->isChecked ()
                                && cb_weight_controls->isChecked ());
      le_buckets_rg->setEnabled (cb_by_ec->isChecked () && enable_rg
                                 && cb_active_rg->isChecked ());
      le_min_rg->setEnabled (cb_by_ec->isChecked () && enable_rg
                             && cb_active_rg->isChecked ()
                             && comparative->ce_rg.buckets);
      le_max_rg->setEnabled (cb_by_ec->isChecked () && enable_rg
                             && cb_active_rg->isChecked ()
                             && comparative->ce_rg.buckets);
      cb_store_reference_rg->setEnabled (enable_rg
                                         && cb_active_rg->isChecked ());
      ...
      le_rank_tau->setEnabled (enable_tau && cb_active_tau->isChecked ()
                               && cb_rank->isChecked ());
      cb_include_in_weight_tau->setEnabled (
          enable_tau && cb_active_tau->isChecked ()
          && cb_weight_controls->isChecked ());
      le_weight_tau->setEnabled (enable_tau && cb_active_tau->isChecked ()
                                 && cb_weight_controls->isChecked ());
      le_buckets_tau->setEnabled (cb_by_ec->isChecked () && enable_tau
                                  && cb_active_tau->isChecked ());
      le_min_tau->setEnabled (cb_by_ec->isChecked () && enable_tau
                              && cb_active_tau->isChecked ()
                              && comparative->ce_tau.buckets);
      le_max_tau->setEnabled (cb_by_ec->isChecked () && enable_tau
                              && cb_active_tau->isChecked ()
                              && comparative->ce_tau.buckets);
      cb_store_reference_tau->setEnabled (enable_tau
                                          && cb_active_tau->isChecked ());
      cb_store_diff_tau->setEnabled (enable_tau
                                     && cb_active_tau->isChecked ());
      cb_store_abs_diff_tau->setEnabled (
          enable_tau && cb_active_tau->isChecked () && !cb_rank->isChecked ());
      ...
      le_rank_eta->setEnabled (enable_eta && cb_active_eta->isChecked ()
                               && cb_rank->isChecked ());
      cb_include_in_weight_eta->setEnabled (
          enable_eta && cb_active_eta->isChecked ()
          && cb_weight_controls->isChecked ());
      le_weight_eta->setEnabled (enable_eta && cb_active_eta->isChecked ()
                                 && cb_weight_controls->isChecked ());
      le_buckets_eta->setEnabled (cb_by_ec->isChecked () && enable_eta
                                  && cb_active_eta->isChecked ());
      le_min_eta->setEnabled (cb_by_ec->isChecked () && enable_eta
                              && cb_active_eta->isChecked ()
                              && comparative->ce_eta.buckets);
      le_max_eta->setEnabled (cb_by_ec->isChecked () && enable_eta
                              && cb_active_eta->isChecked ()
                              && comparative->ce_eta.buckets);
      cb_store_reference_eta->setEnabled (enable_eta
                                          && cb_active_eta->isChecked ());
      cb_store_diff_eta->setEnabled (enable_eta
                                     && cb_active_eta->isChecked ());
      cb_store_abs_diff_eta->setEnabled (
          enable_eta && cb_active_eta->isChecked () && !cb_rank->isChecked ());

      pb_process_csv->setEnabled (
          any_selected_selected () && (!comparative->by_ec || ec_ready ())
...
void
US_Hydrodyn_Comparative::update_lb_loaded_enables ()
{
  if (updates_enabled)
    {
...
void
US_Hydrodyn_Comparative::update_lb_selected_enables ()
{
  if (updates_enabled)
    {
      ...
      pb_selected_merge->setEnabled (any_selected
                                     && !one_selected_selected ());
      pb_selected_set_ranges->setEnabled (any_selected
                                          && any_params_enabled ());
      pb_selected_remove->setEnabled (any_selected);
      pb_process_csv->setEnabled (
          any_selected && (!comparative->by_ec || ec_ready ())
          && ((cb_active_s->isEnabled () && cb_active_s->isChecked ())
              || (cb_active_D->isEnabled () && cb_active_D->isChecked ())
              || (cb_active_sr->isEnabled () && cb_active_sr->isChecked ())
              || (cb_active_fr->isEnabled () && cb_active_fr->isChecked ())
...
void
US_Hydrodyn_Comparative::disable_updates ()
{
...
void
US_Hydrodyn_Comparative::enable_updates ()
{
  updates_enabled = true;
...
void
US_Hydrodyn_Comparative::set_by_pct ()
{
...
void
US_Hydrodyn_Comparative::set_by_ec ()
{
...
void
US_Hydrodyn_Comparative::set_rank ()
{
...
void
US_Hydrodyn_Comparative::set_weight_controls ()
{
...
void
US_Hydrodyn_Comparative::set_active_s ()
{
...
void
US_Hydrodyn_Comparative::update_target_s (const QString &val)
{
  comparative->ce_s.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_s (const QString &val)
{
  comparative->ce_s.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_s ()
{
...
void
US_Hydrodyn_Comparative::update_weight_s (const QString &val)
{
  comparative->ce_s.weight = val.toDouble ();
  if (comparative->ce_s.weight != 0.0 && !comparative->ce_s.include_in_weight)
    {
...
void
US_Hydrodyn_Comparative::update_buckets_s (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_s (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_s (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_s ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_s ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_s ()
{
...
void
US_Hydrodyn_Comparative::set_active_D ()
{
...
void
US_Hydrodyn_Comparative::update_target_D (const QString &val)
{
  comparative->ce_D.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_D (const QString &val)
{
  comparative->ce_D.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_D ()
{
...
void
US_Hydrodyn_Comparative::update_weight_D (const QString &val)
{
  comparative->ce_D.weight = val.toDouble ();
  if (comparative->ce_D.weight != 0.0 && !comparative->ce_D.include_in_weight)
    {
...
void
US_Hydrodyn_Comparative::update_buckets_D (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_D (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_D (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_D ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_D ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_D ()
{
...
void
US_Hydrodyn_Comparative::set_active_sr ()
{
...
void
US_Hydrodyn_Comparative::update_target_sr (const QString &val)
{
  comparative->ce_sr.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_sr (const QString &val)
{
  comparative->ce_sr.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_sr ()
{
...
void
US_Hydrodyn_Comparative::update_weight_sr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_buckets_sr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_sr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_sr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_sr ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_sr ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_sr ()
{
...
void
US_Hydrodyn_Comparative::set_active_fr ()
{
...
void
US_Hydrodyn_Comparative::update_target_fr (const QString &val)
{
  comparative->ce_fr.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_fr (const QString &val)
{
  comparative->ce_fr.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_fr ()
{
...
void
US_Hydrodyn_Comparative::update_weight_fr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_buckets_fr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_fr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_fr (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_fr ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_fr ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_fr ()
{
...
void
US_Hydrodyn_Comparative::set_active_rg ()
{
...
void
US_Hydrodyn_Comparative::update_target_rg (const QString &val)
{
  comparative->ce_rg.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_rg (const QString &val)
{
  comparative->ce_rg.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_rg ()
{
...
void
US_Hydrodyn_Comparative::update_weight_rg (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_buckets_rg (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_rg (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_rg (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_rg ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_rg ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_rg ()
{
...
void
US_Hydrodyn_Comparative::set_active_tau ()
{
...
void
US_Hydrodyn_Comparative::update_target_tau (const QString &val)
{
  comparative->ce_tau.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_tau (const QString &val)
{
  comparative->ce_tau.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_tau ()
{
  comparative->ce_tau.include_in_weight
      = cb_include_in_weight_tau->isChecked ();
  update_enables ();
}

void
US_Hydrodyn_Comparative::update_weight_tau (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_buckets_tau (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_tau (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_tau (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_tau ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_tau ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_tau ()
{
...
void
US_Hydrodyn_Comparative::set_active_eta ()
{
...
void
US_Hydrodyn_Comparative::update_target_eta (const QString &val)
{
  comparative->ce_eta.target = val.toDouble ();
}

void
US_Hydrodyn_Comparative::update_rank_eta (const QString &val)
{
  comparative->ce_eta.rank = val.toInt ();
}

void
US_Hydrodyn_Comparative::set_include_in_weight_eta ()
{
  comparative->ce_eta.include_in_weight
      = cb_include_in_weight_eta->isChecked ();
  update_enables ();
}

void
US_Hydrodyn_Comparative::update_weight_eta (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_buckets_eta (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_min_eta (const QString &val)
{
...
void
US_Hydrodyn_Comparative::update_max_eta (const QString &val)
{
...
void
US_Hydrodyn_Comparative::set_store_reference_eta ()
{
...
void
US_Hydrodyn_Comparative::set_store_diff_eta ()
{
...
void
US_Hydrodyn_Comparative::set_store_abs_diff_eta ()
{
...
void
US_Hydrodyn_Comparative::load_param ()
{
  QString use_dir = comparative->path_param.isEmpty ()
  ...
  QString fname = QFileDialog::getOpenFileName (
      this, us_tr ("Choose a filename to load the parameters"), use_dir,
      "*.smp");
  ...
  if (!f.open (QIODevice::ReadOnly))
    {
      QMessageBox::warning (
          this, "UltraScan",
          QString (us_tr ("Could not open %1 for reading! (permissions?)"))
              .arg (fname));
      return;
    }
...
void
US_Hydrodyn_Comparative::reset_param ()
{
...
void
US_Hydrodyn_Comparative::save_param ()
{
  ...
  QString fname = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the parameters"), use_dir,
      "*.smp");
...
void
US_Hydrodyn_Comparative::load_csv ()
{
  QString use_dir = comparative->path_csv.isEmpty ()
                        ? USglobal->config_list.root_dir + "/" + "somo"
                        : comparative->path_csv;

  ((US_Hydrodyn *)us_hydrodyn)->select_from_directory_history (use_dir, this);

  QStringList filenames = QFileDialog::getOpenFileNames (this, "Open", use_dir,
                                                         "csv files (*.csv)");
          ...
          if (!csv_warn.isEmpty ())
            {
              QMessageBox::warning (
                  this, "UltraScan",
                  QString (us_tr ("Loading the csv %1 produced the following "
                                  "warnings:\n%2"))
                      .arg (*it)
                      .arg (csv_warn));
              editor_msg ("dark red",
                          QString ("loaded with warnings: %1\n").arg (*it));
            }
          else
            {
...
void
US_Hydrodyn_Comparative::update_loaded ()
{
      ...
      if (lb_loaded->item (i)->isSelected ())
        {
          if (csvs.count (lb_loaded->item (i)->text ()))
            {
              lb_selected->addItems (
                  csv_model_names (csvs[lb_loaded->item (i)->text ()]));
            }
          else
            {
              editor_msg (
                  "red",
                  QString (
                      us_tr ("internal error: could not find %1 csv data"))
                      .arg (lb_loaded->item (i)->text ()));
            }
        }
    }
  update_lb_loaded_enables ();
...
void
US_Hydrodyn_Comparative::loaded_select_all ()
{
...
void
US_Hydrodyn_Comparative::loaded_set_ranges ()
{
  if (!any_loaded_selected ())
    {
      editor_msg ("red", us_tr ("internal error: loaded set exp min/max "
                                "called but no item selected!\n"));
      return;
    }
...
void
US_Hydrodyn_Comparative::loaded_view ()
{
      ...
      if (lb_loaded->item (i)->isSelected ())
        {
          if (!csvs.count (lb_loaded->item (i)->text ()))
            ...
            {
              US_Hydrodyn_Csv_Viewer *csv_viewer_window
                  = new US_Hydrodyn_Csv_Viewer (
                      csvs[lb_loaded->item (i)->text ()], this);
...
void
US_Hydrodyn_Comparative::loaded_merge ()
{
  if (!csv_premerge_column_warning_all_loaded_selected ())
    {
      if (QMessageBox::warning (
              this, us_tr ("Merge CSV's"),
              QString (
                  us_tr ("The CSVs do not all have the same column names.\n"
                         ...
                         "\n%1\n\n"
                         "This will effect statistics computed on these extra "
                         "columns.\n"
...
void
US_Hydrodyn_Comparative::csv_remove (QString name, int i)
{
  ...
  if (csvs.count (name))
    {
      for (unsigned int j = 0; j < csvs[name].prepended_names.size (); j++)
        {
          // cout << QString(" name: %1|%2\n").arg(csvs[ name ].name).arg(csvs[
          // name ].prepended_names[j]);
          map<QString, bool>::iterator it
              = loaded_csv_row_prepended_names.find (
                  csvs[name].name + "|" + csvs[name].prepended_names[j]);
    ...
    {
      editor_msg ("red", QString (us_tr ("internal error: csv_remove %1 could "
                                         "not find csv to remove!"))
                             .arg (name));
    }
...
void
US_Hydrodyn_Comparative::loaded_remove ()
{
  disable_updates ();
...
void
US_Hydrodyn_Comparative::set_loaded_csv_row_prepended_names (csv &csv1)
{
      ...
      if (loaded_csv_row_prepended_names.count (csv1.name + "|"
                                                + csv1.prepended_names[i]))
        {
          editor_msg (
              "red",
              us_tr (
                  "internal error: duplicate loaded prepended names found!"));
        }
      else
        {
...
void
US_Hydrodyn_Comparative::update_selected ()
{
  update_lb_selected_enables ();
  update_enables ();
}
...
void
US_Hydrodyn_Comparative::selected_select_all ()
{
  bool select_all = false;
  ...
  if (select_all)
    {
      lb_selected->scrollToItem (
          lb_selected->item (lb_selected->count () - 1));
    }
}

void
US_Hydrodyn_Comparative::selected_merge ()
{
  csv csv_merged;
...
void
US_Hydrodyn_Comparative::selected_set_ranges ()
{
...
void
US_Hydrodyn_Comparative::selected_remove ()
{
...
void
US_Hydrodyn_Comparative::editor_msg (QString color, QString msg)
{
...
void
US_Hydrodyn_Comparative::process_csv ()
{
  csv csv_processed;
  if (!csv_merge_selected_selected (csv_processed))
    {
      enable_updates ();
      // editor_msg("red", us_tr("internal error: should not get here without
      // anything selected!"));
      return;
    }
  ...
  editor->append (
      QString (us_tr ("Processed into: %1\n")).arg (csv_processed.name));
  enable_updates ();
}

void
US_Hydrodyn_Comparative::save_csv ()
{
  if (any_loaded_selected () && !one_loaded_selected ())
    {
      if (QMessageBox::question (this, us_tr ("Merge CSV's"),
                                 us_tr ("Multiple CSV are selected and must "
                                        "be merged before saving\n"
      ...
      if (!csv_premerge_column_warning_all_loaded_selected ())
        {
          if (QMessageBox::warning (
                  ...
                  QString (
                      us_tr (
                          "The CSVs do not all have the same column names.\n"
                          "This will create additional columns with blank "
                          "entries\n"
                          "for rows from CSVs without these extra columns:\n"
                          "\n%1\n\n"
                          "This will effect statistics computed on these "
                          "extra columns.\n"
                          "Do you still want to merge them?"))
                      .arg (csv_premerge_missing_header_qsl.join ("\n")),
                  us_tr ("&Yes"), us_tr ("&No"), QString (), 0, 1))
      ...
      if (any_loaded_selected () && !one_loaded_selected ())
        {
          editor_msg (
              "red", "oops, csv_merge_loaded_selected didn't work as planned");
          return;
        }
    }
  ...
  if (sel_name.isEmpty ())
    {
      editor_msg ("red",
                  us_tr ("internal error: could not find csv for saving!"));
      return;
    }
  if (!csvs.count (sel_name))
    {
      editor_msg (
          "red", QString (us_tr ("internal error: could not find %1 csv data"))
                     .arg (sel_name));
      return;
    }
  ...
  QString fname = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the parameters"), use_name,
      "*.csv");
...
void
US_Hydrodyn_Comparative::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
}
...
void
US_Hydrodyn_Comparative::update_font ()
{
  bool ok;
  QFont newFont;
...
void
US_Hydrodyn_Comparative::refresh ()
{
  cb_by_pct->setChecked (comparative->by_pct);
  cb_rank->setChecked (comparative->rank);
  cb_weight_controls->setChecked (comparative->weight_controls);
...
csv
US_Hydrodyn_Comparative::csv_read (QString filename)
{
  csv csv1;
  ...
  if (!f.exists ())
    {
      csv_error
          = QString (us_tr ("File %1 does not exist")).arg (f.fileName ());
      return csv1;
    }

  if (!f.open (QIODevice::ReadOnly))
    {
      csv_error = QString (us_tr ("Can not open file %1.  Check permissions"))
                      .arg (f.fileName ());
      return csv1;
    }
  ...
  if (loaded_csv_names.count (filename))
    {
      if (QMessageBox::warning (
              this, us_tr ("Read CSV"),
              QString (us_tr ("The CSV named %1 is already loaded\nDo you "
                              "want to reload it?"))
                  .arg (filename),
              us_tr ("&Yes"), us_tr ("&No"), QString (), 0, 1))
        {
      ...
      if (!removed_one)
        {
          editor_msg (
              "red",
              QString (
                  us_tr ("internal error: could not find %1 in loaded list."))
                  .arg (filename));
        }
    }
  ...
  for (QStringList::iterator it = qsl_h.begin (); it != qsl_h.end (); it++)
    {
      QString qs = *it;
      qs.replace ("\"", "");
      if (csv1.header_map.count (qs))
        {
          csv_error
              = QString (
                    us_tr ("Duplicate header name \"%1\" found in file %2"))
                    .arg (qs)
                    .arg (f.fileName ());
          return csv1;
        }
                ...
                if (vd.size () >= csv1.header.size ())
                  {
                    csv_warn
                        += QString (
                               us_tr ("%1Row %2 has more columns than the "
                                      "header, these columns are skipped"))
            ...
            if (vd.size () < csv1.header.size ())
              {
                csv_warn
                    += QString (
                           us_tr (
                               "%1Row %2 has insufficient columns, skipped"))
                           .arg (csv_warn.isEmpty () ? "" : "\n")
                           .arg (row);
              }
            else
  ...
  for (unsigned int i = 0; i < csv1.data.size (); i++)
    {
      ...
      csv1.prepended_names.push_back (
          qs_prepend + csv1.data[i][csv1.header_map["Model name"]]
          + QString ("%1").arg (inc ? QString ("-%1").arg (inc) : ""));
    }
...
QString
US_Hydrodyn_Comparative::csv_info (csv &csv1)
{
  QString qs = QString ("csv_info for %1:\n"
                        " headers_map: %2\n")
                   .arg (csv1.name)
                   .arg (csv1.header_map.size ());

  for (map<QString, int>::iterator it = csv1.header_map.begin ();
       it != csv1.header_map.end (); it++)
    {
...
csv
US_Hydrodyn_Comparative::csv_merge (csv &csv1, csv &csv2)
{
  csv_error = "";
  ...
  if (!csv1.data.size () || !csv2.data.size ())
    {
      csv_error
          = us_tr ("internal error: csv_merge called with zero data csv");
      return csv_merge;
    }
  ...
  // save number of empties that will be needed for csv2's columns that are not
  // present in csv1
...
QStringList
US_Hydrodyn_Comparative::csv_model_names (csv &csv1)
{
  QStringList qsl;
  for (unsigned int i = 0; i < csv1.prepended_names.size (); i++)
    {
...
bool
US_Hydrodyn_Comparative::csv_contains (comparative_entry ce, csv &csv1)
{
  return csv1.header_map.count (ce.name) > 0;
}

bool
US_Hydrodyn_Comparative::all_selected_csv_contain (comparative_entry ce)
{
      ...
      if (lb_loaded->item (i)->isSelected ())
        {
          if (csvs.count (lb_loaded->item (i)->text ()))
            {
              if (!csvs[lb_loaded->item (i)->text ()].header_map.count (
                      ce.name))
                {
                  all_contain = false;
                  break;
...
bool
US_Hydrodyn_Comparative::any_loaded_selected ()
{
...
bool
US_Hydrodyn_Comparative::one_loaded_selected ()
{
  int no_selected = 0;
  for (unsigned int i = 0; i < (unsigned int)lb_loaded->count (); i++)
    {
...
QString
US_Hydrodyn_Comparative::first_loaded_selected ()
{
  QString qs;
  for (unsigned int i = 0; i < (unsigned int)lb_loaded->count (); i++)
    {
...
bool
US_Hydrodyn_Comparative::any_selected_selected ()
{
  bool any_selected = false;
...
bool
US_Hydrodyn_Comparative::one_selected_selected ()
{
  int no_selected = 0;
  for (unsigned int i = 0; i < (unsigned int)lb_selected->count (); i++)
    {
...
void
US_Hydrodyn_Comparative::csv_write (QString filename, csv &csv1)
{
...
void
US_Hydrodyn_Comparative::csv_merge_loaded_selected ()
{
  if (!any_loaded_selected () || one_loaded_selected ())
    {
      // nothing to do here
      ...
      if (!skip_first && lb_loaded->item (i)->isSelected ())
        {
          ...
          csv_merged
              = csv_merge (csv_merged, csvs[lb_loaded->item (i)->text ()]);
        }
...
QString
US_Hydrodyn_Comparative::get_unique_csv_name (QString name)
{
  unsigned int inc = 0;
  while (
      loaded_csv_names.count (name + (inc ? QString ("-%1").arg (inc) : "")))
    {
      inc++;
    }
...
bool
US_Hydrodyn_Comparative::csv_merge_selected_selected (csv &csv_merged)
{
  disable_updates ();
      ...
      if (lb_loaded->item (i)->isSelected ())
        {
          ...
          for (unsigned int j = 0;
               j < csvs[lb_loaded->item (i)->text ()].prepended_names.size ();
               j++)
            {
              if (selected_names.count (
                      csvs[lb_loaded->item (i)->text ()].prepended_names[j]))
                {
                  ...
                  selected_models[csvs[lb_loaded->item (i)->text ()]
                                      .prepended_names[j]]
                      = true;
                }
            }
  ...
  csv_merged.name
      = "selected_rows_from_" + QFileInfo (ref_csv->name).completeBaseName ();
          ...
          if (selected_models.count (ref_csv->prepended_names[j]))
            {
              ...
              csv_to_merge.prepended_names.push_back (
                  ref_csv->prepended_names[j]);
            }
        }
  ...
  if (!is_ok)
    {
      if (QMessageBox::warning (
              this, us_tr ("Merge notice"),
              QString (
                  us_tr ("The selected models do not all have the same column "
                         "names.\n"
                         "This will create additional columns with blank "
                         "entries\n"
                         "for rows from CSVs without these extra columns:\n"
...
bool
US_Hydrodyn_Comparative::csv_process (csv &csv1)
{
  cout << "csv_process\n";
  // cout << csv_info(csv1);
  csv_error = "";
  ...
  QString header_abs_diff
      = QString (comparative->by_pct ? "% " : "") + "AbsDiff:";
  QString header_weight = "Weighted sum of "
                          + QString (comparative->by_pct ? "% " : "")
  ...
  bool processed_fields_exist
      = (do_weight && csv1.header_map.count (header_weight));

  for (unsigned int i = 0; i < ce_names.size (); i++)
    {
      do_[i]
          = csv1.header_map.count (ce_names[i]) && ce_map[ce_names[i]]->active;
      ...
      if (!processed_fields_exist && do_[i]
          && ((ref_[i] && csv1.header_map.count (header_exp + ce_names[i]))
              || (diff_[i]
                  && csv1.header_map.count (header_diff + ce_names[i]))
              || (abs_diff_[i]
                  && csv1.header_map.count (header_abs_diff + ce_names[i]))))
        {
  ...
  if (processed_fields_exist)
    {
      if (!QMessageBox::question (this, us_tr ("Process"),
                                  us_tr ("Some of the added columns that will "
                                         "be computed already exist.\n"
                                         "What do you want remove them?"),
                                  us_tr ("&Yes, remove them"),
                                  us_tr ("&No, rename them"), QString (), 0,
                                  1))
        {
          for (unsigned int i = 0; i < ce_names.size (); i++)
            {
              if (do_[i])
                {
                  if (ref_[i]
                      && csv1.header_map.count (header_exp + ce_names[i]))
                    {
              ...
              if (do_[i])
                {
                  if (ref_[i]
                      && csv1.header_map.count (header_exp + ce_names[i]))
                    {
                      csv_make_unique_header_name (csv1,
                                                   header_exp + ce_names[i]);
                    }
                  if (diff_[i]
                      && csv1.header_map.count (header_diff + ce_names[i]))
                    {
                      csv_make_unique_header_name (csv1,
                                                   header_diff + ce_names[i]);
                    }
                  if (abs_diff_[i]
                      && csv1.header_map.count (header_abs_diff + ce_names[i]))
                    {
                      csv_make_unique_header_name (csv1, header_abs_diff
                                                             + ce_names[i]);
                    }
                }
            }
          ...
          if (abs_diff_[i])
            {
              ...
              csv1.header_map[header_abs_diff + ce_names[i]]
                  = col_abs_diff_[i];
            }
        }
    }
              ...
              if (ref_[j])
                {
                  ...
                  csv1.data[i][col_ref_[j]]
                      = QString ("%1").arg (csv1.num_data[i][col_ref_[j]]);
                }
              if (diff_[j])
                {
                  csv1.num_data[i][col_diff_[j]]
                      = csv1.num_data[i][col_model_[j]] - exp_[j];
                  if (comparative->by_pct && exp_[j] != 0.0)
                    {
                      csv1.num_data[i][col_diff_[j]]
                          = 100.0 * csv1.num_data[i][col_diff_[j]] / exp_[j];
                    }
                  csv1.data[i][col_diff_[j]]
                      = QString ("%1").arg (csv1.num_data[i][col_diff_[j]]);
                }
              if (abs_diff_[j])
                {
                  csv1.num_data[i][col_abs_diff_[j]]
                      = fabs (csv1.num_data[i][col_model_[j]] - exp_[j]);
                  if (comparative->by_pct && exp_[j] != 0.0)
                    {
                      csv1.num_data[i][col_abs_diff_[j]]
                          = 100.0 * csv1.num_data[i][col_abs_diff_[j]]
                            / exp_[j];
                    }
                  csv1.data[i][col_abs_diff_[j]] = QString ("%1").arg (
                      csv1.num_data[i][col_abs_diff_[j]]);
                }
              if (do_weight && ce_map[ce_names[j]]->include_in_weight)
                {
                  if (comparative->by_pct && exp_[j] != 0.0)
                    {
                      weight += 100.0
                                * (fabs (csv1.num_data[i][col_model_[j]]
                                         - exp_[j])
                                   / exp_[j])
              ...
              if (do_ec && ec_[j])
                {
                  ...
                  if (abs_diff > ec_delta_over_2_[j])
                    {
                      ec_pos += (unsigned int)((abs_diff - ec_delta_over_2_[j])
                                               / ec_delta_over_2_[j]);
                    }
                }
            }
  ...
  if (!sort_cols.size ())
    {
      editor_msg (
          "red",
          us_tr ("Internal error: could not find any columns to sort!"));
    }
  else
    {
...
bool
US_Hydrodyn_Comparative::any_params_enabled ()
{
...
void
US_Hydrodyn_Comparative::update_selected_map ()
{
  selected_map.clear ();
  for (unsigned int i = 0; i < (unsigned int)lb_selected->count (); i++)
    {
...
bool
US_Hydrodyn_Comparative::csv_get_min_max (double &min, double &max,
                                          unsigned int &rows_used_count,
                                          comparative_entry ce, csv &csv1,
                                          bool ignore_selected_selected)
{
  // cout << QString("start csv_get_min_max ce.name %1
  // %2\n").arg(ce.name).arg(ignore_selected_selected ? "all loaded selected" :
  ...
  for (unsigned int i = 0; i < csv1.num_data.size (); i++)
    {
      if (ignore_selected_selected
          || selected_map.count (csv1.prepended_names[i]))
        {
          rows_used_count++;
          if (done_first)
            {
  ...
  // cout << QString("finish csv_get_min_max ce.name %1 min %2 max %3 rows used
...
bool
US_Hydrodyn_Comparative::csv_get_loaded_min_max (double &min, double &max,
                                                 comparative_entry ce)
{
      ...
      if (lb_loaded->item (i)->isSelected ())
        {
          ...
          if (!csv_get_min_max (tmp_min, tmp_max, rows_used_count, ce,
                                csvs[lb_loaded->item (i)->text ()]))
            {
              editor_msg (
                  "red",
                  QString (
                      us_tr ("internal error: could not find %1 in csv %2"))
                      .arg (ce.name)
                      .arg (lb_loaded->item (i)->text ()));
              return false;
            }
          if (!rows_used_count)
            {
              editor_msg ("red",
                          QString (us_tr ("internal error: could not find any "
                                          "rows for %1 in csv %2"))
                              .arg (ce.name)
                              .arg (lb_loaded->item (i)->text ()));
              return false;
  ...
  if (!total_rows_used_count)
    {
      editor_msg ("red",
                  QString (us_tr ("internal error: could not find any rows "
                                  "for %1 in any of the loaded selected csvs"))
                      .arg (ce.name));
      return false;
    }
  return true;
...
bool
US_Hydrodyn_Comparative::csv_get_selected_min_max (double &min, double &max,
                                                   comparative_entry ce)
{
      ...
      if (lb_loaded->item (i)->isSelected ())
        {
          ...
          if (!csv_get_min_max (tmp_min, tmp_max, rows_used_count, ce,
                                csvs[lb_loaded->item (i)->text ()], false))
            {
              editor_msg (
                  "red",
                  QString (
...
QStringList
US_Hydrodyn_Comparative::csv_parse_line (QString qs)
{
  ...
  for (QStringList::iterator it = qsl_chars.begin (); it != qsl_chars.end ();
       it++)
    {
      if (!in_quote && *it == ",")
        {
...
bool
US_Hydrodyn_Comparative::csv_premerge_column_warning (csv &csv1, csv &csv2)
{
  bool is_ok = true;
  for (unsigned int i = 0; i < csv1.header.size (); i++)
    {
          ...
          if (!csv_premerge_missing_header_map.count (csv1.header[i]))
            {
              ...
              if (csv_premerge_missing_header_qsl.size ()
                  < PREMERGE_LIST_LIMIT + 1)
                {
                  if (csv_premerge_missing_header_qsl.size ()
                      == PREMERGE_LIST_LIMIT)
                    {
                      csv_premerge_missing_header_qsl
                          << us_tr (" (Additional extra columns not shown.)");
                      return is_ok;
                    }
                  csv_premerge_missing_header_qsl
                      << QString (" From %1: %2")
                             .arg (QFileInfo (csv1.name).completeBaseName ())
                             .arg (csv1.header[i]);
                }
            }
        }
          ...
          if (!csv_premerge_missing_header_map.count (csv2.header[i]))
            {
              ...
              if (csv_premerge_missing_header_qsl.size ()
                  < PREMERGE_LIST_LIMIT + 1)
                {
                  ...
                  csv_premerge_missing_header_qsl
                      << QString (" From %1: %2")
                             .arg (QFileInfo (csv2.name).completeBaseName ())
                             .arg (csv2.header[i]);
                }
            }
        }
...
bool
US_Hydrodyn_Comparative::csv_premerge_column_warning_all_loaded_selected ()
{
  csv_premerge_missing_header_map.clear ();
  csv_premerge_missing_header_qsl.clear ();
      ...
      if (!skip_first && lb_loaded->item (i)->isSelected ())
        {
          ...
          if (!csv_premerge_column_warning (*csv_ref,
                                            csvs[lb_loaded->item (i)->text ()])
              && csv_premerge_missing_header_qsl.size ()
                     >= PREMERGE_LIST_LIMIT)
            {
              return false;
            }
...
QString
US_Hydrodyn_Comparative::loaded_info ()
{
  QString qs;

  qs = "loaded_csv_names:\n";
  for (map<QString, bool>::iterator it = loaded_csv_names.begin ();
       it != loaded_csv_names.end (); it++)
    {
      qs += " " + it->first + "\n";
    }

  qs += "loaded_csv_row_prepended_names:\n";
  for (map<QString, bool>::iterator it
       = loaded_csv_row_prepended_names.begin ();
       it != loaded_csv_row_prepended_names.end (); it++)
    {
      qs += " " + it->first + "\n";
    }
...
bool
US_Hydrodyn_Comparative::csv_has_column_name (csv &csv1, QString name)
{
  return csv1.header_map.count (name) > 0;
}

void
US_Hydrodyn_Comparative::csv_remove_column (csv &csv1, QString name)
{
...
void
US_Hydrodyn_Comparative::csv_make_unique_header_name (csv &csv1, QString name)
{
  if (!csv1.header_map.count (name))
    {
      return;
...
bool
US_Hydrodyn_Comparative::ec_ready ()
{
  ...
  if (comparative->by_ec)
    {
      for (unsigned int i = 0; i < ce_names.size (); i++)
        {
          if (ce_map[ce_names[i]]->active && ce_map[ce_names[i]]->buckets > 0
