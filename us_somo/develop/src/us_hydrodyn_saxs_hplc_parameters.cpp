...
void US_Hydrodyn_Saxs_Hplc_Parameters::setupGUI() {
  ...
  lbl_title =
      new QLabel(us_tr("US-SOMO: HPLC/KIN : SAXS Processing Parameters"), this);
  ...
  lbl_saxs_hplc_param_frame_interval->setFont(
  ...
  le_saxs_hplc_param_frame_interval->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv =
        new QDoubleValidator(0.1, 600, 1, le_saxs_hplc_param_frame_interval);
  ...
  lbl_saxs_hplc_param_g_conc->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_g_conc->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  ...
  lbl_saxs_hplc_param_g_psv->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_g_psv->setMinimumHeight(minHeight1);

  le_saxs_hplc_param_g_psv = new QLineEdit(this);
  le_saxs_hplc_param_g_psv->setObjectName("le_saxs_hplc_param_g_psv Line Edit");
  ...
  le_saxs_hplc_param_g_psv->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  ...
  lbl_saxs_hplc_param_I0_exp->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_I0_exp->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv =
  ...
  lbl_saxs_hplc_param_I0_theo->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_I0_theo->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  ...
  lbl_saxs_hplc_param_diffusion_len->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_diffusion_len->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  ...
  lbl_saxs_hplc_param_electron_nucleon_ratio->setAlignment(Qt::AlignLeft |
                                                           Qt::AlignVCenter);
  lbl_saxs_hplc_param_electron_nucleon_ratio->setPalette(PALET_NORMAL);
  AUTFBACK(lbl_saxs_hplc_param_electron_nucleon_ratio);
  lbl_saxs_hplc_param_electron_nucleon_ratio->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_electron_nucleon_ratio->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  ...
  // }
  connect(le_saxs_hplc_param_electron_nucleon_ratio,
          SIGNAL(textChanged(const QString &)),
  ...
  lbl_saxs_hplc_param_nucleon_mass->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_nucleon_mass->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  ...
  // }
  connect(le_saxs_hplc_param_nucleon_mass, SIGNAL(textChanged(const QString &)),
  ...
  lbl_saxs_hplc_param_solvent_electron_density->setAlignment(Qt::AlignLeft |
                                                             Qt::AlignVCenter);
  ...
  lbl_saxs_hplc_param_solvent_electron_density->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_saxs_hplc_param_solvent_electron_density->setAlignment(Qt::AlignCenter |
                                                            Qt::AlignVCenter);
  le_saxs_hplc_param_solvent_electron_density->setPalette(PALET_NORMAL);
  AUTFBACK(le_saxs_hplc_param_solvent_electron_density);
  le_saxs_hplc_param_solvent_electron_density->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  ...
  // }
  connect(le_saxs_hplc_param_solvent_electron_density,
          SIGNAL(textChanged(const QString &)),
...
void US_Hydrodyn_Saxs_Hplc_Parameters::quit() { close(); }
...
void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_frame_interval(
    const QString &text) {
  (*parameters)["saxs_hplc_param_frame_interval"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_g_conc(
    const QString &text) {
  (*parameters)["saxs_hplc_param_g_conc"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_g_psv(
    const QString &text) {
  (*parameters)["saxs_hplc_param_g_psv"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_I0_exp(
    const QString &text) {
  (*parameters)["saxs_hplc_param_I0_exp"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_I0_theo(
    const QString &text) {
  (*parameters)["saxs_hplc_param_I0_theo"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_diffusion_len(
    const QString &text) {
  (*parameters)["saxs_hplc_param_diffusion_len"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::
    set_saxs_hplc_param_electron_nucleon_ratio(const QString &text) {
  (*parameters)["saxs_hplc_param_electron_nucleon_ratio"] = text;
}

void US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_nucleon_mass(
    const QString &text) {
