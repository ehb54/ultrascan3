...
void
US_Hydrodyn_Saxs_Hplc_Parameters::setupGUI ()
{
  int minHeight1 = 30;

  lbl_title = new QLabel (
      us_tr ("US-SOMO: HPLC/KIN : SAXS Processing Parameters"), this);
  ...
  lbl_saxs_hplc_param_frame_interval
      = new QLabel (us_tr ("Frame Interval [s] :"), this);
  lbl_saxs_hplc_param_frame_interval->setAlignment (Qt::AlignLeft
                                                    | Qt::AlignVCenter);
  lbl_saxs_hplc_param_frame_interval->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_saxs_hplc_param_frame_interval);
  lbl_saxs_hplc_param_frame_interval->setFont (QFont (
  ...
  le_saxs_hplc_param_frame_interval = new QLineEdit (this);
  le_saxs_hplc_param_frame_interval->setObjectName (
      "le_saxs_hplc_param_frame_interval Line Edit");
  le_saxs_hplc_param_frame_interval->setText (
      (*parameters)["saxs_hplc_param_frame_interval"]);
  le_saxs_hplc_param_frame_interval->setAlignment (Qt::AlignCenter
                                                   | Qt::AlignVCenter);
  le_saxs_hplc_param_frame_interval->setPalette (PALET_NORMAL);
  AUTFBACK (le_saxs_hplc_param_frame_interval);
  le_saxs_hplc_param_frame_interval->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv = new QDoubleValidator (
        0.1, 600, 1, le_saxs_hplc_param_frame_interval);
    le_saxs_hplc_param_frame_interval->setValidator (qdv);
  }
  connect (le_saxs_hplc_param_frame_interval,
           SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_frame_interval (const QString &)));
  le_saxs_hplc_param_frame_interval->setMinimumWidth (200);
  le_saxs_hplc_param_frame_interval->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_g_conc
      = new QLabel (us_tr ("Default concentration [mg/mL] :"), this);
  ...
  lbl_saxs_hplc_param_g_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_g_conc->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_g_conc = new QLineEdit (this);
  le_saxs_hplc_param_g_conc->setObjectName (
      "le_saxs_hplc_param_g_conc Line Edit");
  ...
  le_saxs_hplc_param_g_conc->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_g_conc ); le_saxs_hplc_param_g_conc->setValidator(
  //    qdv );
  // }
  connect (le_saxs_hplc_param_g_conc, SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_g_conc (const QString &)));
  le_saxs_hplc_param_g_conc->setMinimumWidth (200);
  le_saxs_hplc_param_g_conc->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_g_psv
  ...
  lbl_saxs_hplc_param_g_psv->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_g_psv->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_g_psv = new QLineEdit (this);
  le_saxs_hplc_param_g_psv->setObjectName (
      "le_saxs_hplc_param_g_psv Line Edit");
  ...
  le_saxs_hplc_param_g_psv->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_g_psv ); le_saxs_hplc_param_g_psv->setValidator( qdv
  //    );
  // }
  connect (le_saxs_hplc_param_g_psv, SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_g_psv (const QString &)));
  le_saxs_hplc_param_g_psv->setMinimumWidth (200);
  le_saxs_hplc_param_g_psv->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_I0_exp
  ...
  lbl_saxs_hplc_param_I0_exp->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_I0_exp->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_I0_exp = new QLineEdit (this);
  le_saxs_hplc_param_I0_exp->setObjectName (
      "le_saxs_hplc_param_I0_exp Line Edit");
  ...
  le_saxs_hplc_param_I0_exp->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (400, 600, 1, le_saxs_hplc_param_I0_exp);
    le_saxs_hplc_param_I0_exp->setValidator (qdv);
  }
  connect (le_saxs_hplc_param_I0_exp, SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_I0_exp (const QString &)));
  le_saxs_hplc_param_I0_exp->setMinimumWidth (200);
  le_saxs_hplc_param_I0_exp->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_I0_theo
  ...
  lbl_saxs_hplc_param_I0_theo->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_I0_theo->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_I0_theo = new QLineEdit (this);
  le_saxs_hplc_param_I0_theo->setObjectName (
      "le_saxs_hplc_param_I0_theo Line Edit");
  le_saxs_hplc_param_I0_theo->setText (
      (*parameters)["saxs_hplc_param_I0_theo"]);
  le_saxs_hplc_param_I0_theo->setAlignment (Qt::AlignCenter
                                            | Qt::AlignVCenter);
  le_saxs_hplc_param_I0_theo->setPalette (PALET_NORMAL);
  AUTFBACK (le_saxs_hplc_param_I0_theo);
  le_saxs_hplc_param_I0_theo->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_I0_theo ); le_saxs_hplc_param_I0_theo->setValidator(
  //    qdv );
  // }
  connect (le_saxs_hplc_param_I0_theo, SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_I0_theo (const QString &)));
  le_saxs_hplc_param_I0_theo->setMinimumWidth (200);
  le_saxs_hplc_param_I0_theo->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_diffusion_len
      = new QLabel (us_tr ("Diffusion length [cm] :"), this);
  lbl_saxs_hplc_param_diffusion_len->setAlignment (Qt::AlignLeft
                                                   | Qt::AlignVCenter);
  lbl_saxs_hplc_param_diffusion_len->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_saxs_hplc_param_diffusion_len);
  lbl_saxs_hplc_param_diffusion_len->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_diffusion_len->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_diffusion_len = new QLineEdit (this);
  le_saxs_hplc_param_diffusion_len->setObjectName (
      "le_saxs_hplc_param_diffusion_len Line Edit");
  le_saxs_hplc_param_diffusion_len->setText (
      (*parameters)["saxs_hplc_param_diffusion_len"]);
  le_saxs_hplc_param_diffusion_len->setAlignment (Qt::AlignCenter
                                                  | Qt::AlignVCenter);
  le_saxs_hplc_param_diffusion_len->setPalette (PALET_NORMAL);
  AUTFBACK (le_saxs_hplc_param_diffusion_len);
  le_saxs_hplc_param_diffusion_len->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_diffusion_len );
  //    le_saxs_hplc_param_diffusion_len->setValidator( qdv );
  // }
  connect (le_saxs_hplc_param_diffusion_len,
           SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_diffusion_len (const QString &)));
  le_saxs_hplc_param_diffusion_len->setMinimumWidth (200);
  le_saxs_hplc_param_diffusion_len->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_electron_nucleon_ratio
      = new QLabel (us_tr ("Electron/nucleon ratio Z/A :"), this);
  lbl_saxs_hplc_param_electron_nucleon_ratio->setAlignment (
  ...
  lbl_saxs_hplc_param_electron_nucleon_ratio->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_electron_nucleon_ratio->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_electron_nucleon_ratio = new QLineEdit (this);
  le_saxs_hplc_param_electron_nucleon_ratio->setObjectName (
      "le_saxs_hplc_param_electron_nucleon_ratio Line Edit");
  le_saxs_hplc_param_electron_nucleon_ratio->setText (
      (*parameters)["saxs_hplc_param_electron_nucleon_ratio"]);
  le_saxs_hplc_param_electron_nucleon_ratio->setAlignment (Qt::AlignCenter
                                                           | Qt::AlignVCenter);
  le_saxs_hplc_param_electron_nucleon_ratio->setPalette (PALET_NORMAL);
  AUTFBACK (le_saxs_hplc_param_electron_nucleon_ratio);
  le_saxs_hplc_param_electron_nucleon_ratio->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_electron_nucleon_ratio );
  //    le_saxs_hplc_param_electron_nucleon_ratio->setValidator( qdv );
  // }
  connect (
      le_saxs_hplc_param_electron_nucleon_ratio,
      SIGNAL (textChanged (const QString &)),
      SLOT (set_saxs_hplc_param_electron_nucleon_ratio (const QString &)));
  ...
  lbl_saxs_hplc_param_nucleon_mass
      = new QLabel (us_tr ("Nucleon mass [g] :"), this);
  lbl_saxs_hplc_param_nucleon_mass->setAlignment (Qt::AlignLeft
                                                  | Qt::AlignVCenter);
  lbl_saxs_hplc_param_nucleon_mass->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_saxs_hplc_param_nucleon_mass);
  lbl_saxs_hplc_param_nucleon_mass->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_nucleon_mass->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_nucleon_mass = new QLineEdit (this);
  le_saxs_hplc_param_nucleon_mass->setObjectName (
      "le_saxs_hplc_param_nucleon_mass Line Edit");
  le_saxs_hplc_param_nucleon_mass->setText (
      (*parameters)["saxs_hplc_param_nucleon_mass"]);
  le_saxs_hplc_param_nucleon_mass->setAlignment (Qt::AlignCenter
                                                 | Qt::AlignVCenter);
  le_saxs_hplc_param_nucleon_mass->setPalette (PALET_NORMAL);
  AUTFBACK (le_saxs_hplc_param_nucleon_mass);
  le_saxs_hplc_param_nucleon_mass->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_nucleon_mass );
  //    le_saxs_hplc_param_nucleon_mass->setValidator( qdv );
  // }
  connect (le_saxs_hplc_param_nucleon_mass,
           SIGNAL (textChanged (const QString &)),
           SLOT (set_saxs_hplc_param_nucleon_mass (const QString &)));
  le_saxs_hplc_param_nucleon_mass->setMinimumWidth (200);
  le_saxs_hplc_param_nucleon_mass->setMinimumHeight (minHeight1);

  lbl_saxs_hplc_param_solvent_electron_density
      = new QLabel (us_tr ("Solvent electron density [e A^-3] :"), this);
  lbl_saxs_hplc_param_solvent_electron_density->setAlignment (
      Qt::AlignLeft | Qt::AlignVCenter);
  ...
  lbl_saxs_hplc_param_solvent_electron_density->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  lbl_saxs_hplc_param_solvent_electron_density->setMinimumHeight (minHeight1);

  le_saxs_hplc_param_solvent_electron_density = new QLineEdit (this);
  le_saxs_hplc_param_solvent_electron_density->setObjectName (
      "le_saxs_hplc_param_solvent_electron_density Line Edit");
  le_saxs_hplc_param_solvent_electron_density->setText (
      (*parameters)["saxs_hplc_param_solvent_electron_density"]);
  le_saxs_hplc_param_solvent_electron_density->setAlignment (
  ...
  le_saxs_hplc_param_solvent_electron_density->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  // {
  //    QDoubleValidator *qdv = new QDoubleValidator( 400, 600, 1,
  //    le_saxs_hplc_param_solvent_electron_density );
  //    le_saxs_hplc_param_solvent_electron_density->setValidator( qdv );
  // }
  connect (
      le_saxs_hplc_param_solvent_electron_density,
      SIGNAL (textChanged (const QString &)),
      SLOT (set_saxs_hplc_param_solvent_electron_density (const QString &)));
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::quit ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Parameters::save ()
{
  ...
  // QString fn = QFileDialog::getSaveFileName( this , us_tr( "Select a name to
  // save the SAXS parameters" ) , use_dir , "*_saxs_hplc_param.dat" );
  ...
  //    ts << "# __saxs_hplc_param_g_conc: " <<
  //    le_saxs_hplc_param_g_conc->text() << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_g_psv->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_g_psv: " << le_saxs_hplc_param_g_psv->text()
  //    << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_I0_exp->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_I0_exp: " <<
  //    le_saxs_hplc_param_I0_exp->text() << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_I0_theo->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_I0_theo: " <<
  //    le_saxs_hplc_param_I0_theo->text() << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_diffusion_len->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_diffusion_len: " <<
  //    le_saxs_hplc_param_diffusion_len->text() << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_electron_nucleon_ratio->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_electron_nucleon_ratio: " <<
  //    le_saxs_hplc_param_electron_nucleon_ratio->text() << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_nucleon_mass->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_nucleon_mass: " <<
  //    le_saxs_hplc_param_nucleon_mass->text() << Qt::endl;
  // }

  // if ( !le_saxs_hplc_param_solvent_electron_density->text().isEmpty() ) {
  //    ts << "# __saxs_hplc_param_solvent_electron_density: " <<
  //    le_saxs_hplc_param_solvent_electron_density->text() << Qt::endl;
  // }
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::keep ()
{
  (*parameters)["keep"] = "set";
  close ();
}
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_frame_interval (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_g_conc (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_g_psv (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_I0_exp (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_I0_theo (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_diffusion_len (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_electron_nucleon_ratio (
    const QString &text)
{
...
void
US_Hydrodyn_Saxs_Hplc_Parameters::set_saxs_hplc_param_nucleon_mass (
    const QString &text)
{
...
US_Hydrodyn_Saxs_Hplc_Parameters::
    set_saxs_hplc_param_solvent_electron_density (const QString &text)
{
