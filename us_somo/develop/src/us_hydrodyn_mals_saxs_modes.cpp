...
void US_Hydrodyn_Mals_Saxs::rgc_mw_text(const QString &) { rgc_calc_rg(); }
...
void US_Hydrodyn_Mals_Saxs::rgc_rho_text(const QString &) { rgc_calc_rg(); }

void US_Hydrodyn_Mals_Saxs::rgc_axis_b_text(const QString &,
                                            bool do_recompute) {
...
void US_Hydrodyn_Mals_Saxs::rgc_axis_c_text(const QString &,
                                            bool do_recompute) {
  if (le_rgc_axis_b->text().toDouble() < le_rgc_axis_c->text().toDouble()) {
...
void US_Hydrodyn_Mals_Saxs::wyatt_apply() { wyatt_apply(all_selected_files()); }
...
void US_Hydrodyn_Mals_Saxs::timescale() { timescale(all_selected_files()); }
