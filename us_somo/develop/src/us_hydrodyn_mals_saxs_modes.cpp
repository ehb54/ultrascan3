...
void
US_Hydrodyn_Mals_Saxs::pm_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs::pm_q_reset ()
{
  le_pm_q_start->setText (QString ("%1").arg (f_qs[wheel_file][0]));
  le_pm_q_end->setText (QString ("%1").arg (f_qs[wheel_file].back ()));
}
...
void
US_Hydrodyn_Mals_Saxs::pm_grid_size_text (const QString &)
{
}

void
US_Hydrodyn_Mals_Saxs::pm_buff_e_dens_text (const QString &)
{
}

void
US_Hydrodyn_Mals_Saxs::pm_samp_e_dens_text (const QString &)
{
}

void
US_Hydrodyn_Mals_Saxs::pm_q_pts_text (const QString &)
{
}

void
US_Hydrodyn_Mals_Saxs::pm_q_start_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals_Saxs::pm_q_end_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals_Saxs::pm_q_start_focus (bool hasFocus)
{
  if (hasFocus)
    {
...
void
US_Hydrodyn_Mals_Saxs::pm_q_end_focus (bool hasFocus)
{
  if (hasFocus)
    {
...
void
US_Hydrodyn_Mals_Saxs::rgc_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs::rgc_shape ()
{
  if (rb_rgc_shape_ellipsoid->isChecked ())
    {
...
void
US_Hydrodyn_Mals_Saxs::rgc_calc_rg ()
{
...
void
US_Hydrodyn_Mals_Saxs::rgc_mw_text (const QString &)
{
  rgc_calc_rg ();
}

void
US_Hydrodyn_Mals_Saxs::rgc_vol_text (const QString &)
{
...
void
US_Hydrodyn_Mals_Saxs::rgc_rho_text (const QString &)
{
  rgc_calc_rg ();
}

void
US_Hydrodyn_Mals_Saxs::rgc_axis_b_text (const QString &, bool do_recompute)
{
...
void
US_Hydrodyn_Mals_Saxs::rgc_axis_c_text (const QString &, bool do_recompute)
{
  if (le_rgc_axis_b->text ().toDouble () < le_rgc_axis_c->text ().toDouble ())
    {
...
void
US_Hydrodyn_Mals_Saxs::rgc_rg_text (const QString &)
{
}
...
void
US_Hydrodyn_Mals_Saxs::testiq_gauss_line ()
{
...
void
US_Hydrodyn_Mals_Saxs::testiq_enables ()
{
  pb_timeshift->setEnabled (false);
  pb_wheel_cancel->setEnabled (true);
...
bool
US_Hydrodyn_Mals_Saxs::testiq_make ()
{
...
void
US_Hydrodyn_Mals_Saxs::testiq_visrange ()
{
...
void
US_Hydrodyn_Mals_Saxs::testiq_testset ()
{
  if (!testiq_make ())
    {
      testiq_enables ();
...
void
US_Hydrodyn_Mals_Saxs::testiq_q_start_text (const QString &text)
{
...
void
US_Hydrodyn_Mals_Saxs::testiq_q_end_text (const QString &text)
{
  if (current_mode != MODE_TESTIQ)
    {
      return;
...
void
US_Hydrodyn_Mals_Saxs::testiq_q_start_focus (bool hasFocus)
{
  if (current_mode != MODE_TESTIQ)
    {
      return;
...
void
US_Hydrodyn_Mals_Saxs::testiq_q_end_focus (bool hasFocus)
{
  if (current_mode != MODE_TESTIQ)
    {
      return;
...
// --- wyatt ---
void
US_Hydrodyn_Mals_Saxs::wyatt_start ()
{
  if (axis_y_log)
    {
      axis_y ();
...
void
US_Hydrodyn_Mals_Saxs::wyatt_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs::wyatt_init_markers ()
{
  gauss_delete_markers ();
...
void
US_Hydrodyn_Mals_Saxs::wyatt_apply ()
{
  wyatt_apply (all_selected_files ());
}

void
US_Hydrodyn_Mals_Saxs::wyatt_apply (const QStringList &files)
{
...
void
US_Hydrodyn_Mals_Saxs::wyatt_start_text (const QString &text)
{
  int pos = 0;
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals_Saxs::wyatt_end_text (const QString &text)
{
  int pos = 1;
#if QT_VERSION < 0x040000
  plot_dist->setMarkerPos (plotted_markers[pos], text.toDouble (), 0e0);
...
void
US_Hydrodyn_Mals_Saxs::wyatt_start_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::wyatt_end_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::wyatt_start2_text (const QString &text)
{
  int pos = 2;
#if QT_VERSION < 0x040000
  plot_dist->setMarkerPos (plotted_markers[pos], text.toDouble (), 0e0);
...
void
US_Hydrodyn_Mals_Saxs::wyatt_end2_text (const QString &text)
{
  int pos = 3;
#if QT_VERSION < 0x040000
  plot_dist->setMarkerPos (plotted_markers[pos], text.toDouble (), 0e0);
...
void
US_Hydrodyn_Mals_Saxs::wyatt_start2_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::wyatt_end2_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::replot_wyatt ()
{
...
void
US_Hydrodyn_Mals_Saxs::scale_scroll_highlight (int pos)
{
...
void
US_Hydrodyn_Mals_Saxs::scale_scroll ()
{
...
void
US_Hydrodyn_Mals_Saxs::scale_update_plot_errors ()
{
...
void
US_Hydrodyn_Mals_Saxs::scale_enables ()
{
  ...
  ShowHide::hide_widgets (wheel_below_widgets, always_hide_widgets,
                          !cb_scale_scroll->isChecked ());
}

QString
US_Hydrodyn_Mals_Saxs::scale_get_target (bool do_msg)
{
  double min_i = 0e0;
  double max_i = 0e0;
  double tot_i = 0e0;
...
void
US_Hydrodyn_Mals_Saxs::scale_apply ()
{
  ...
  // setup for scale analysis
  {
    ...
    // US_Hydrodyn_Mals_Saxs_Scale_Trend * uhshst = new
    // US_Hydrodyn_Mals_Saxs_Scale_Trend( us_hydrodyn,
    //                                                                                     parameters,
    //                                                                                     plots );
    // uhshst->show();
  }
...
void
US_Hydrodyn_Mals_Saxs::scale_q_reset ()
{
  le_scale_q_start->setText (QString ("%1").arg (scale_q[wheel_file][0]));
...
void
US_Hydrodyn_Mals_Saxs::scale_reset ()
{
  for (set<QString>::iterator it = scale_selected.begin ();
       it != scale_selected.end (); ++it)
    {
...
void
US_Hydrodyn_Mals_Saxs::scale_replot ()
{
  for (set<QString>::iterator it = scale_selected.begin ();
       it != scale_selected.end (); ++it)
    {
...
void
US_Hydrodyn_Mals_Saxs::scale_create ()
{
  scale_last_created.clear ();
...
void
US_Hydrodyn_Mals_Saxs::scale_q_start_text (const QString &text)
{
  if (current_mode != MODE_SCALE)
    {
      return;
...
void
US_Hydrodyn_Mals_Saxs::scale_q_end_text (const QString &text)
{
  if (current_mode != MODE_SCALE)
    {
      return;
...
void
US_Hydrodyn_Mals_Saxs::scale_q_start_focus (bool hasFocus)
{
  if (current_mode != MODE_SCALE)
    {
      return;
...
void
US_Hydrodyn_Mals_Saxs::scale_q_end_focus (bool hasFocus)
{
  if (current_mode != MODE_SCALE)
    {
      return;
...
void
US_Hydrodyn_Mals_Saxs::ggauss_start ()
{
  plot_errors->detachItems (QwtPlotItem::Rtti_PlotCurve);
  plot_errors->detachItems (QwtPlotItem::Rtti_PlotMarker);
  ;
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll ()
{
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_p_green ()
{
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_p_red ()
{
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_p_yellow ()
{
  us_qdebug ("ggauss_scroll_p_yellow()");
  ggauss_scroll_set_selected ();
}
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_smoothed ()
{
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_oldstyle ()
{
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_set_selected ()
{
...
void
US_Hydrodyn_Mals_Saxs::ggauss_scroll_highlight (int pos)
{
...
void
US_Hydrodyn_Mals_Saxs::ggaussian_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs::timeshift ()
{
...
void
US_Hydrodyn_Mals_Saxs::timescale ()
{
  timescale (all_selected_files ());
}

void
US_Hydrodyn_Mals_Saxs::timescale (const QStringList &files)
{
  bool ok;
  double res
      = US_Static::getDouble (us_tr ("US-SOMO: MALS_SAXS: Time scale"),
...
void
US_Hydrodyn_Mals_Saxs::ggqfit ()
{
  ShowHide::hide_widgets (ggqfit_widgets, always_hide_widgets,
                          ggqfit_widgets[0]->isVisible ());
}
