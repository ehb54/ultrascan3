...
bool
US_LUD::LUPDecompose (double **A, int N, double Tol, int *P)
{
 ...
 */
void
US_LUD::LUPSolve (double **A, int *P, double *b, int N, double *x)
{
...
bool
US_LUD::caruanas (const vector<double> &q, const vector<double> &I, double &mu,
                  double &sigma, double &amp)
{
  ...
  LUPSolve ((double **)&A[0], (int *)&P[0], (double *)&B[0], 3,
            (double *)&x[0]);
...
bool
US_LUD::guos (const vector<double> &q, const vector<double> &I, double &mu,
              double &sigma, double &amp)
{
