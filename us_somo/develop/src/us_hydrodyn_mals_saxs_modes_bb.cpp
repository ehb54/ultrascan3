...
void
US_Hydrodyn_Mals_Saxs::blanks_start ()
{
...
void
US_Hydrodyn_Mals_Saxs::blanks_enables ()
{
...
// --- baseline ---
void
US_Hydrodyn_Mals_Saxs::baseline_start (bool from_blanks_mode_save)
{
  if (axis_y_log)
    {
      axis_y ();
...
void
US_Hydrodyn_Mals_Saxs::baseline_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs::set_baseline_start_zero ()
{
  if (!cb_baseline_start_zero->isChecked ())
    {
      // QMessageBox::warning(
...
void
US_Hydrodyn_Mals_Saxs::baseline_init_markers ()
{
...
void
US_Hydrodyn_Mals_Saxs::replot_baseline_integral ()
{
...
void
US_Hydrodyn_Mals_Saxs::replot_baseline (QString /* qs */)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_apply ()
{
  int smoothing = 0;
  bool integral
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_saxs_bl_integral"]
  ...
  if (integral)
    {
      smoothing = ((US_Hydrodyn *)us_hydrodyn)
                      ->gparams["mals_saxs_bl_smooth"]
                      .toInt ();
    }
  // bool save_bl = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[
  // "mals_saxs_bl_save" ] == "true";
  bool save_bl = false;
  unsigned int reps = 0;
  if (integral)
    {
      reps = ((US_Hydrodyn *)us_hydrodyn)
                 ->gparams["mals_saxs_bl_reps"]
                 .toInt ();
    }
...
void
US_Hydrodyn_Mals_Saxs::baseline_apply (QStringList files, bool integral,
                                       ...
                                       bool quiet)
{
  ...
  bool test_alt_integral_bl
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_saxs_bl_save"] == "true";
  ...
  bool use_start_region = false
                          && ((US_Hydrodyn *)us_hydrodyn)
                                 ->gparams.count ("mals_saxs_bl_start_region")
                          && ((US_Hydrodyn *)us_hydrodyn)
                                     ->gparams["mals_saxs_bl_start_region"]
                                     .toInt ()
                                 > 0;
      ...
      if (integral)
        {
          ...
          double alpha_epsilon
              = ((US_Hydrodyn *)us_hydrodyn)
                        ->gparams.count ("mals_saxs_bl_epsilon")
                    ? ((US_Hydrodyn *)us_hydrodyn)
                          ->gparams["mals_saxs_bl_epsilon"]
                          .toDouble ()
                    : 5e-3;
...
void
US_Hydrodyn_Mals_Saxs::set_baseline_fix_width ()
{
...
int
US_Hydrodyn_Mals_Saxs::input_double_to_pos (double d)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_start_s_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals_Saxs::baseline_start_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals_Saxs::baseline_start_e_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals_Saxs::baseline_end_s_text (const QString &text)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_end_text (const QString &text)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_end_e_text (const QString &text)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_start_s_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_start_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_start_e_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_end_s_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_end_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_end_e_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_width_text (const QString &text)
{
  int blw = text.toInt ();
...
void
US_Hydrodyn_Mals_Saxs::baseline_width_focus (bool hasFocus)
{
  if (hasFocus)
    {
      le_last_focus = le_baseline_width;
...
void
US_Hydrodyn_Mals_Saxs::baseline_best ()
{
  disable_all ();
      ...
      if (ca.sliding (baseline_cormap_pvaluepairs, baseline_cormap_parameters,
                      ...
                      baseline_hb_brookesmap_sliding_results, this, progress))
        {
          ...
          // plot of results
          {
            ...
            double cormap_maxq
                = ((US_Hydrodyn *)us_hydrodyn)
                          ->gparams.count ("mals_saxs_cormap_maxq")
                      ? ((US_Hydrodyn *)us_hydrodyn)
            ...
            if (best_vdparameters["x"].size ())
              {
                US_Hydrodyn_Mals_Saxs_Baseline_Best *uhsbb
                    = new US_Hydrodyn_Mals_Saxs_Baseline_Best (
...
void
US_Hydrodyn_Mals_Saxs::baseline_test ()
{
...
void
US_Hydrodyn_Mals_Saxs::baseline_test_pos (int pos)
{
  ...
  // )->gparams[ "mals_saxs_bl_smooth" ].toInt() ) );
