...
void US_Hydrodyn_Mals_Conc_Csv_Frames::showhide(vector<QWidget *> &widgets,
                                                bool isChecked) {
...
void US_Hydrodyn_Mals_Conc_Csv_Frames::update_startframenumber(
    const QString &str) {
...
void US_Hydrodyn_Mals_Conc_Csv_Frames::update_endframenumber(
    const QString &str) {
