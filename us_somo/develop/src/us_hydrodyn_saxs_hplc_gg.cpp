...
bool
US_Hydrodyn_Saxs_Hplc::unified_ggaussian_to_f_gaussians ()
{
...
bool
US_Hydrodyn_Saxs_Hplc::gg_fit_vector (vector<double> &fit,
                                      vector<double> &pfit)
{
  if (!unified_ggaussian_ok)
    {
...
vector<double>
US_Hydrodyn_Saxs_Hplc::compute_ggaussian_gaussian_sum ()
{
...
double
US_Hydrodyn_Saxs_Hplc::ggaussian_rmsd (bool norm_chi)
{
  if (!unified_ggaussian_ok)
    {
      editor_msg ("red", us_tr ("Internal error: gaussian rmsd called but "
...
bool
US_Hydrodyn_Saxs_Hplc::gg_fit_replot ()
{
  if (!unified_ggaussian_ok)
    {
      editor_msg ("red",
...
bool
US_Hydrodyn_Saxs_Hplc::data_point_window (vector<double> &q, vector<double> &I)
{
...
void
US_Hydrodyn_Saxs_Hplc::gauss_local_caruanas ()
{
...
void
US_Hydrodyn_Saxs_Hplc::gauss_local_guos ()
{
...
bool
US_Hydrodyn_Saxs_Hplc::pvalue (const vector<double> &q, vector<double> &I,
...
bool
US_Hydrodyn_Saxs_Hplc::pvalue (const QString &file, double &P,
                               QString &errormsg)
{
  errormsg = "";
