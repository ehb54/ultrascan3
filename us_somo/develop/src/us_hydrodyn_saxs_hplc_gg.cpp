...
bool US_Hydrodyn_Saxs_Hplc::gg_fit_vector(vector<double> &fit,
                                          vector<double> &pfit) {
  if (!unified_ggaussian_ok) {
...
bool US_Hydrodyn_Saxs_Hplc::data_point_window(vector<double> &q,
                                              vector<double> &I) {
...
bool US_Hydrodyn_Saxs_Hplc::pvalue(const vector<double> &q, vector<double> &I,
...
bool US_Hydrodyn_Saxs_Hplc::pvalue(const QString &file, double &P,
                                   QString &errormsg) {
  errormsg = "";
