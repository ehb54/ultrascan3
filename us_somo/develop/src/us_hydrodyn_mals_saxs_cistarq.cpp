...
void US_Hydrodyn_Mals_Saxs_Cistarq::setupGUI() {
...
void US_Hydrodyn_Mals_Saxs_Cistarq::quit() { close(); }

void US_Hydrodyn_Mals_Saxs_Cistarq::create_ng() {
  (*parameters)["go"] = "true";
  (*parameters)["make_ng"] = "true";
  close();
}

void US_Hydrodyn_Mals_Saxs_Cistarq::go() {
  (*parameters)["go"] = "true";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::help() {
  US_Help *online_help;
  online_help = new US_Help(this);
  online_help->show_help("manual/somo/mals_saxs_ciq.html");
}

void US_Hydrodyn_Mals_Saxs_Cistarq::closeEvent(QCloseEvent *e) {
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept();
}

void US_Hydrodyn_Mals_Saxs_Cistarq::set_add_bl() {
  (*parameters)["add_baseline"] = cb_add_bl->isChecked() ? "true" : "false";
}

void US_Hydrodyn_Mals_Saxs_Cistarq::set_sd_source() { update_enables(); }

void US_Hydrodyn_Mals_Saxs_Cistarq::set_normalize() { update_enables(); }

void US_Hydrodyn_Mals_Saxs_Cistarq::set_I0se() { update_enables(); }

void US_Hydrodyn_Mals_Saxs_Cistarq::set_save_as_pct_iq() {
...
void US_Hydrodyn_Mals_Saxs_Cistarq::global() {
...
void US_Hydrodyn_Mals_Saxs_Cistarq::set_sd_zero_avg_local_sd() {
  (*parameters)["sd_zero_avg_local_sd"] =
      cb_sd_zero_avg_local_sd->isChecked() ? "true" : "false";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::set_sd_zero_keep_as_zeros() {
  (*parameters)["sd_zero_keep_as_zeros"] =
      cb_sd_zero_keep_as_zeros->isChecked() ? "true" : "false";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::set_sd_zero_set_to_pt1pct() {
  (*parameters)["sd_zero_set_to_pt1pct"] =
      cb_sd_zero_set_to_pt1pct->isChecked() ? "true" : "false";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::set_zero_drop_points() {
  (*parameters)["zero_drop_points"] =
      cb_zero_drop_points->isChecked() ? "true" : "false";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::set_zero_avg_local_sd() {
  (*parameters)["zero_avg_local_sd"] =
      cb_zero_avg_local_sd->isChecked() ? "true" : "false";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::set_zero_keep_as_zeros() {
  (*parameters)["zero_keep_as_zeros"] =
      cb_zero_keep_as_zeros->isChecked() ? "true" : "false";
...
void US_Hydrodyn_Mals_Saxs_Cistarq::update_enables() {
  bool no_go = false;
...
void US_Hydrodyn_Mals_Saxs_Cistarq::ws_hide(vector<QWidget *> ws, bool hide) {
  for (unsigned int i = 0; i < (unsigned int)ws.size(); i++) {
    hide ? ws[i]->hide() : ws[i]->show();
  }
}

void US_Hydrodyn_Mals_Saxs_Cistarq::zeros_found() {
