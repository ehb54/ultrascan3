...
void
US_Hydrodyn_File::closeEvent (QCloseEvent *event)
{
  if (ok_to_close)
    {
      event->accept ();
...
US_Hydrodyn_File::US_Hydrodyn_File (QString *dir, QString *base, QString *ext,
...
void
US_Hydrodyn_File::update_base (const QString &str)
{
  *base = str;
}
