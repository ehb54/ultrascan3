...
void
US_Hydrodyn_SasOptionsHydration::setupGUI ()
{
  int minHeight1 = 30;
  ...
  cb_hydrate_pdb->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cb_hydrate_pdb->setPalette (PALET_NORMAL);
  AUTFBACK (cb_hydrate_pdb);
  connect (cb_hydrate_pdb, SIGNAL (clicked ()), this,
           SLOT (set_hydrate_pdb ()));
  set_hydrate_pdb ();
  ...
  le_default_rotamer_filename->setFont (QFont (
  ...
  lbl_steric_clash_distance->setFont (
  ...
  cnt_steric_clash_distance->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  cnt_steric_clash_recheck_distance->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_alt_hydration->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_alt_hydration->setPalette (PALET_NORMAL);
  AUTFBACK (cb_alt_hydration);
  connect (cb_alt_hydration, SIGNAL (clicked ()), this,
           SLOT (set_alt_hydration ()));
  ...
  cb_hydration_rev_asa->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
...
void
US_Hydrodyn_SasOptionsHydration::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsHydration::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsHydration::closeEvent (QCloseEvent *e)
{
  *sas_options_hydration_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsHydration::set_hydrate_pdb ()
{
...
void
US_Hydrodyn_SasOptionsHydration::default_rotamer_filename ()
{
...
void
US_Hydrodyn_SasOptionsHydration::update_steric_clash_distance (double val)
{
...
void
US_Hydrodyn_SasOptionsHydration::update_steric_clash_recheck_distance (
    double val)
{
...
void
US_Hydrodyn_SasOptionsHydration::set_alt_hydration ()
{
...
void
US_Hydrodyn_SasOptionsHydration::set_hydration_rev_asa ()
{
