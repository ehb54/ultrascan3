...
US_Saxs_Util::compute_1d ()
{
  ...
  QString name = QString ("%1_tp%2_rot%3_ar%4_d3R%5_rho0%6_pr%7_t%8")
...
bool
US_Saxs_Util::load_rotations (unsigned int number,
                              vector<vector<double> > &rotations)
{
...
double
US_Saxs_Util::q_of_pixel (int pixels_width)
{
  return q_of_pixel ((double)pixels_width * detector_width_per_pixel);
}

double
US_Saxs_Util::q_of_pixel (double width)
{
  double S_length
...
bool
US_Saxs_Util::setup_excluded_volume_map ()
{
  if (!rho0)
    {
      return true;
...
bool
US_Saxs_Util::get_excluded_volume_map ()
{
  errormsg = "";
