...
void US_Hydrodyn_Mals_Saxs_Options::setupGUI() {
  ...
  rb_integral->setChecked(parameters->count("mals_saxs_bl_integral") &&
                          (*parameters)["mals_saxs_bl_integral"] == "true");
  rb_integral->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  pb_mals_saxs_parameters->setFont(QFont(USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
...
void US_Hydrodyn_Mals_Saxs_Options::quit() { close(); }
...
void US_Hydrodyn_Mals_Saxs_Options::set_mals_saxs_parameters() {
  {
    ...
    parameters["mals_saxs_param_n"] = QString("%1").arg(
        ((US_Hydrodyn_Mals_Saxs *)mals_saxs_win)->mals_saxs_param_n, 0, 'g', 8);
    ...
    parameters["mals_saxs_param_g_conc"] = QString("%1").arg(
        ...
        'g', 8);
    parameters["mals_saxs_param_DLS_detector"] = QString("%1").arg(
