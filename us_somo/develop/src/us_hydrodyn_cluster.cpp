...
US_Hydrodyn_Cluster::US_Hydrodyn_Cluster (void *us_hydrodyn, QWidget *p,
                                          const char *)
    : QDialog (p)
{
  ...
  cluster_additional_methods_options_active
  ...
  cluster_additional_methods_modes["additional_processing_per_file"]["best"]
      = true;
  cluster_additional_methods_modes["inputfile_pat_addendum"]["best"] = true;
  cluster_additional_methods_modes["additional_processing_global"]["best"]
      = true;
  ...
  create_enabled = selected_files.size () &&
  ...
  pb_add_target->setEnabled (create_enabled
                             && batch_window->cb_iqq->isChecked ());
  pb_clear_target->setEnabled (create_enabled
                               && batch_window->cb_iqq->isChecked ());
  le_no_of_jobs->setEnabled (create_enabled);
  if (batch_window->cluster_no_of_jobs.toUInt ()
      && batch_window->cluster_no_of_jobs.toUInt ()
             <= (unsigned int)selected_files.size ())
    {
  ...
  le_output_name->setText (batch_window->cluster_output_name.isEmpty ()
                               ? "job"
                               : batch_window->cluster_output_name);
  ...
  if (!dir1.exists ())
    {
      editor_msg ("black",
                  QString (us_tr ("Created directory %1")).arg (pkg_dir));
      dir1.mkdir (pkg_dir);
    }

  {
    ...
    if (!dir1.exists ())
      {
        editor_msg (
            "black",
            QString (us_tr ("Created directory %1")).arg (submitted_dir));
    ...
    for (unsigned int i = 0; i < (unsigned int)submitted_files.count (); i++)
      {
        submitted_jobs[submitted_files[i].replace (
            QRegExp ("\\.(tar|tgz|TAR|TGZ)$"), "")]
            = true;
      }
  }

  {
    ...
    if (!dir1.exists ())
      {
        editor_msg (
            "black",
            QString (us_tr ("Created directory %1")).arg (completed_dir));
    ...
    for (unsigned int i = 0; i < (unsigned int)completed_files.count (); i++)
      {
        completed_jobs[completed_files[i].replace (
            QRegExp ("_(out|OUT)\\.(tar|tgz|TAR|TGZ)$"), "")]
            = true;
      }
  }

  {
    ...
    if (!dir1.exists ())
      {
        editor_msg (
            "black",
            QString (us_tr ("Created directory %1")).arg (results_dir));
    ...
    for (unsigned int i = 0; i < (unsigned int)results_files.count (); i++)
      {
        results_jobs[results_files[i].replace (
            QRegExp ("_(out|OUT)\\.(tar|tgz|TAR|TGZ)$"), "")]
            = true;
      }
  }
  ...
  if (unsupported.length ())
    {
      editor_msg ("red",
                  us_tr ("Unsupported options selected:\n" + unsupported));
    }

  unsigned int number_active;
  if (batch_window->cb_dmd->isChecked () && validate_csv_dmd (number_active))
    {
      dmd ();
    }
  else
  ...
  if (!create_enabled)
    {
      editor_msg (
          "dark red",
          us_tr ("Notice: you must have files selected in batch model\n"
...
US_Hydrodyn_Cluster::setupGUI ()
{
  ...
  pb_create_pkg->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_add_target
      = new QPushButton (us_tr ("Add experimental data files"), this);
  pb_add_target->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_clear_target
      = new QPushButton (us_tr ("Clear experimental data files"), this);
  pb_clear_target->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1));
  ...
  lb_target_files->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  lbl_no_of_jobs
      = new QLabel (QString (us_tr ("Number of jobs (cores) (maximum %1):"))
  ...
  lbl_no_of_jobs->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1,
                                  QFont::Bold));

  le_no_of_jobs_qv = new QIntValidator (1, selected_files.size (), this);
  le_no_of_jobs = new QLineEdit (this);
  le_no_of_jobs->setObjectName ("csv_filename Line Edit");
  ...
  le_no_of_jobs->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  le_no_of_jobs->setValidator (le_no_of_jobs_qv);

  lbl_output_name
      = new QLabel (us_tr ("Output base name (job identifier)"), this);
  ...
  lbl_output_name->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1,
                                   QFont::Bold));

  le_output_name = new QLineEdit (this);
  le_output_name->setObjectName ("csv_filename Line Edit");
  ...
  le_output_name->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  connect (le_output_name, SIGNAL (textChanged (const QString &)),
           SLOT (update_output_name (const QString &)));
  ...
  cb_for_mpi->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_split_grid->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  pb_dmd->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize + 1));
  ...
  pb_additional->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_advanced->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize + 1));
  ...
  pb_submit_pkg->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1));
  ...
  pb_check_status
      = new QPushButton (us_tr ("Check job status / Retrieve results"), this);
  pb_check_status->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1));
  ...
  pb_load_results->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize + 1));
  ...
  pb_cluster_config->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 1));
  ...
  gl_target->setContentsMargins (0, 0, 0, 0);
  gl_target->setSpacing (0);
  ...
  QHBoxLayout *hbl_no_of_jobs = new QHBoxLayout ();
  hbl_no_of_jobs->setContentsMargins (0, 0, 0, 0);
  hbl_no_of_jobs->setSpacing (0);
  ...
  QHBoxLayout *hbl_output_name = new QHBoxLayout ();
  hbl_output_name->setContentsMargins (0, 0, 0, 0);
  hbl_output_name->setSpacing (0);
  ...
  QHBoxLayout *hbl_mpi_etc = new QHBoxLayout ();
  hbl_mpi_etc->setContentsMargins (0, 0, 0, 0);
  hbl_mpi_etc->setSpacing (0);
  ...
  QHBoxLayout *hbl_create = new QHBoxLayout ();
  hbl_create->setContentsMargins (0, 0, 0, 0);
  hbl_create->setSpacing (0);
...
void
US_Hydrodyn_Cluster::cancel ()
{
  close ();
}

void
US_Hydrodyn_Cluster::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Cluster::clear_target ()
{
...
void
US_Hydrodyn_Cluster::add_target ()
{
  ...
  QStringList filenames = QFileDialog::getOpenFileNames (
      this, "Set files for grid target", use_dir,
      "All files (*);;"
      "ssaxs files (*.ssaxs);;"
      "csv files (*.csv);;"
...
void
US_Hydrodyn_Cluster::create_pkg ()
{
  ...
  if (!prepend.isEmpty ())
    {
      editor_msg (
          "blue",
          QString (us_tr ("Notice: job output name will be prepended with %1"))
              .arg (prepend));
    }
  ...
  QString filename = le_output_name->text ()
                             == QFileInfo (le_output_name->text ()).fileName ()
  ...
  if (cb_for_mpi->isChecked ())
    {
      ...
      if (QFile::exists (tar_filename))
        {
          tar_filename = ((US_Hydrodyn *)us_hydrodyn)
                             ->fileNameCheck (tar_filename, 0, this);
          filename = tar_filename;
          filename.replace (QRegExp ("\\.tar$"), "");
          le_output_name->setText (
  ...
  else
    {
      if (use_extension)
          ...
          if (QFile::exists (targz_filename))
            {
              ...
              QString name = QFileInfo (targz_filename)
                                 .fileName ()
                                 .replace (QRegExp ("\\_p1.tgz$"), "");
              targz_filename
                  = ((US_Hydrodyn *)us_hydrodyn)
                        ->fileNameCheck (&path, &name, &ext, 0, this);
      ...
      else
        {
          ...
          if (QFile::exists (targz_filename))
            {
              targz_filename = ((US_Hydrodyn *)us_hydrodyn)
                                   ->fileNameCheck (targz_filename, 0, this);
              filename = targz_filename;
...

  {
    ...
    if (qfi.exists () && !qfi.isFile ())
      {
        editor_msg ("red", QString (us_tr ("Output file \"%1\" already exists "
  ...
  editor_msg ("black",
              QString (us_tr ("Output directory is %1\n")).arg (base_dir));
  if (active_additional_methods ().size ())
    {
      create_additional_methods_pkg (base_dir, filename, common_prefix,
                                     use_extension);
      return;
    }

  QString base = "# us_saxs_cmds_t iq controlfile\n"
                 "# blank lines ok, format token <params>\n"
                 "\n";

  base += QString ("ResidueFile     %1\n")
              .arg (common_prefix
                    + QFileInfo (
                          ((US_Hydrodyn *)us_hydrodyn)->lbl_table->text ())
                          .fileName ());
  base_source_files << ((US_Hydrodyn *)us_hydrodyn)->lbl_table->text ();

  base += QString ("AtomFile        %1\n")
              .arg (common_prefix
                    + QFileInfo (our_saxs_options->default_atom_filename)
                          .fileName ());
  base_source_files << our_saxs_options->default_atom_filename;
  base += QString ("HybridFile      %1\n")
              .arg (common_prefix
                    + QFileInfo (our_saxs_options->default_hybrid_filename)
                          .fileName ());
  base_source_files << our_saxs_options->default_hybrid_filename;
  base += QString ("SaxsFile        %1\n")
              .arg (common_prefix
                    + QFileInfo (our_saxs_options->default_saxs_filename)
                          .fileName ());
  base_source_files << our_saxs_options->default_saxs_filename;

  if (our_saxs_options->swh_excl_vol != 0e0)
    {
      base += QString ("SwhExclVol      %1\n")
                  .arg (our_saxs_options->swh_excl_vol);
    }
  if (our_saxs_options->iq_target_ev != 0e0)
    {
      base += QString ("IqTargetEv      %1\n")
                  .arg (our_saxs_options->iq_target_ev);
    }
  if (our_saxs_options->hybrid_radius_excl_vol)
    {
      base += QString ("HybridRadiusExclVol\n");
    }
  if (our_saxs_options->set_iq_target_ev_from_vbar)
    {
      base += QString ("SetIqTargetEvFromVbar\n");
    }
  if (our_saxs_options->use_iq_target_ev)
    {
      base += QString ("UseIqTargetEv\n");
    }
  ...
  if (batch_window->cb_hydrate && batch_window->cb_hydrate->isChecked ())
    {
      base
          += QString ("HydrationFile   %1\n")
                 .arg (common_prefix
                       + QFileInfo (our_saxs_options->default_rotamer_filename)
                             .fileName ());
      base += QString ("HydrationSCD    %1\n")
                  .arg (our_saxs_options->steric_clash_distance);
      base += QString ("HydrationRSCD   %1\n")
  ...
  if (our_saxs_options->use_somo_ff)
    {
      base += QString ("FFFile          %1\n")
                  .arg (common_prefix
                        + QFileInfo (our_saxs_options->default_ff_filename)
                              .fileName ());
  ...
  if (our_saxs_options->five_term_gaussians)
    {
      base += QString ("FiveTermGaussian\n");
    }

  if (our_saxs_options->iqq_use_atomic_ff)
    {
      base += QString ("ExplicitH\n");
    }

  base += QString ("\n%1\n").arg (our_saxs_options->saxs_sans ? "Sans"
                                                              : "Saxs");
  ...
  if (our_saxs_options->saxs_iq_native_fast
      || our_saxs_options->sans_iq_native_fast)
    {
      iqmethod = "fd";
    }
          ...
          if (batch_window->cb_mm_all->isChecked ())
            {
              US_Static::us_message (
                  us_tr ("Please note:"),
                  us_tr (
                      "You have selected to process all models in multi-model "
                      "PDBs with the FoXS external I(q) method.\n"
                      "If you are including multi-model PDBs, a single "
                      "composite curve will be produced.\n"
                      "If you wish curves for individual models, either split "
                      "the multi model PDB\n"
                      "or use the \"fast\" Iq method.\n"
                      "You can split the multi-model PDB into individual "
                      "files using the PDB Editor / Split button."));
            }
          iqmethod = "foxs";
        }
          ...
          if (batch_window->cb_mm_all->isChecked ())
            {
              US_Static::us_message (
                  ...
                  us_tr (
                      "You have selected to process all models in multi-model "
                      "PDBs with the CRYSOL external I(q) method.\n"
                      "If you are including multi-model PDBs, only the first "
                      "model will actually be computed by CRYSOL.\n"
                      "If you wish curves for individual models, split the "
                      "multi model PDB into individual PDBs.\n"
                      "You can split the multi-model PDB into individual "
                      "files using the PDB Editor / Split button."));
            }
          iqmethod = "crysol";
  ...
  if (lb_target_files->count ())
    {
      if (lb_target_files->count () == 1 || !cb_split_grid->isChecked ())
        {
          base += QString ("ExperimentGrid  %1\n")
                      .arg (common_prefix
                            + QFileInfo (lb_target_files->item (0)->text ())
                                  .fileName ());
          ...
          for (int i = 1; i < lb_target_files->count (); i++)
            {
              base
                  += QString ("AdditionalExperimentGrid  %1\n")
                         .arg (common_prefix
                               + QFileInfo (lb_target_files->item (i)->text ())
                                     .fileName ());
  ...
  if (!cb_for_mpi->isChecked () && !copy_files_to_pkg_dir (base_source_files))
    {
  ...
  if (!unimplemented.isEmpty ())
    {
      editor_msg (
          "red",
          QString ("Can not create job files:\n%1").arg (unimplemented));
      return;
    }
      ...
      if (batch_window->cb_dmd->isChecked ()
          && dmd_entry_count (QFileInfo (selected_files[i]).fileName ()) > 1)
        {
          for (unsigned int j = 0;
               j < dmd_entry_count (QFileInfo (selected_files[i]).fileName ());
               j++)
            {
              use_selected_files
                  << QString ("%1 _dmd%2").arg (selected_files[i]).arg (j);
            }
        }
      else
        {
  ...
  unsigned int max_no_of_jobs
      = (unsigned int)ceil ((use_selected_files.size () * multi_grid_multiplier
                             * advanced_multiplier)
                            / (double)le_no_of_jobs->text ().toUInt ());
  cout << "max jobs per " << max_no_of_jobs << endl;

  unsigned int extension_count = max_no_of_jobs;
  unsigned int extension_count_length
      = QString ("%1").arg (extension_count).length ();
  map<QString, bool> already_added;

  bool last_unwritten = false;
  US_Tar ust;

  for (unsigned int this_i = 0;
       this_i < (unsigned int)use_selected_files.size ()
                    * multi_grid_multiplier * advanced_multiplier;
       this_i++)
    {
      ...
      if (multi_grid_multiplier > 1)
        {
          unsigned int grid
              = (this_i / (unsigned int)use_selected_files.size ())
                % multi_grid_multiplier;
          out += QString ("ExperimentGrid  %1\n")
                     .arg (common_prefix
                           + QFileInfo (lb_target_files->item (grid)->text ())
                                 .fileName ());
      ...
      if (advanced_multiplier > 1)
        {
          advanced_pos = this_i
                         / ((unsigned int)use_selected_files.size ()
                            * multi_grid_multiplier);
        }

      cout << QString ("this_i %1 grid %2 advanced_pos %3\n")
                  .arg (this_i)
                  .arg ((this_i / (unsigned int)use_selected_files.size ())
                        % multi_grid_multiplier)
                  .arg (advanced_pos);
      ...
      if (!batch_window->cb_dmd->isChecked () && batch_window->cb_hydrate
          && batch_window->cb_hydrate->isChecked ())
        {
      ...
      if (!((this_i + 1) % max_no_of_jobs))
        {
          ...
          QString use_file = QString ("%1%2").arg (filename).arg (
              use_extension ? QString ("_p%1").arg (ext) : "");
          // if ( !((US_Hydrodyn *)us_hydrodyn)->overwrite && QFile::exists(
          // use_file ) )
          // {
          ...
          if (!cb_for_mpi->isChecked ())
            {
              for (unsigned int i = 0;
                   i < (unsigned int)base_source_files.size (); i++)
                {
          ...
          for (unsigned int i = 0; i < (unsigned int)source_files.size (); i++)
            {
              ...
              remove_file_list
                  << pkg_dir + SLASH + QFileInfo (source_files[i]).fileName ();
            }
          remove_file_list << pkg_dir + SLASH
                                  + QFileInfo (use_file).fileName ();

          QString tar_name = use_file + ".tar";
          int result = ust.create (QFileInfo (tar_name).filePath (),
                                   to_tar_list, &list);
          ...
          if (result != TAR_OK)
            {
              editor_msg (
                  "red",
                  QString (
                      us_tr ("Error: Problem creating tar archive %1: %2"))
                      .arg (filename)
          ...
          if (result != GZIP_OK)
            {
              editor_msg (
                  "red",
                  QString (
                      us_tr ("Error: Problem gzipping tar archive %1: %2"))
                      .arg (tar_name)
                      .arg (usg.explain (result)));
              return;
            }
          QDir qd;
          ...
          if (!qd.rename (QFileInfo (tar_name + ".gz").fileName (),
                          QFileInfo (use_targz_filename).fileName ()))
            {
              editor_msg (
                  "red",
                  QString ("Error renaming %1 to %2")
          ...
          editor_msg ("dark gray",
                      QString ("Gzipped: %1").arg (use_targz_filename));
          // clean up droppings
  ...
  if (last_unwritten)
    {
      ...
      // use_file ) )
      // {
      // use_file = ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck( use_file, 0,
      // this );
      // }
      cout << use_file << endl;
      QFile f (use_file);
      ...
      if (!cb_for_mpi->isChecked ())
        {
          for (unsigned int i = 0; i < (unsigned int)base_source_files.size ();
               i++)
            {
              to_tar_list << QFileInfo (base_source_files[i]).fileName ();
            }
      ...
      for (unsigned int i = 0; i < (unsigned int)source_files.size (); i++)
        {
          to_tar_list << QFileInfo (source_files[i]).fileName ();
          remove_file_list << pkg_dir + SLASH
                                  + QFileInfo (source_files[i]).fileName ();
        }
      remove_file_list << pkg_dir + SLASH + QFileInfo (use_file).fileName ();

      QString tar_name = use_file + ".tar";
      int result
          = ust.create (QFileInfo (tar_name).filePath (), to_tar_list, &qsl);
      cout << "tar_name:" << tar_name << endl;
      cout << "to tar:\n" << to_tar_list.join ("\n") << endl;
      ...
      if (result != TAR_OK)
        {
          editor_msg (
              "red",
              QString (us_tr ("Error: Problem creating tar archive %1: %2"))
                  .arg (filename)
                  .arg (ust.explain (result)));
          return;
        }
      ...
      if (result != GZIP_OK)
        {
          editor_msg (
              "red",
              QString (us_tr ("Error: Problem gzipping tar archive %1: %2"))
                  .arg (tar_name)
                  .arg (usg.explain (result)));
          return;
        }
  ...
  if (cb_for_mpi->isChecked ())
    {
      ...
      int result
          = ust.create (QFileInfo (tar_name).filePath (), to_tar_list, &list);
      cout << "tar_name:" << tar_name << endl;
      cout << "to tar:\n" << to_tar_list.join ("\n") << endl;
  ...
  for (unsigned int i = 0; i < (unsigned int)base_source_files.size (); i++)
    {
      base_remove_file_list
          << pkg_dir + SLASH + QFileInfo (base_source_files[i]).fileName ();
    }
  ...
  if (write_count != le_no_of_jobs->text ().toUInt ())
    {
      editor_msg (
          "dark red",
          QString (us_tr ("Notice: the actually number of jobs created (%1) "
                          "is less than requested (%2)\n"
                          "This is due to the fact that the selected files "
                          "were evenly distributed among the jobs"))
              .arg (write_count)
              .arg (le_no_of_jobs->text ().toUInt ()));
    }
  if (cb_for_mpi->isChecked ())
    {
      ...
      int result
          = ust.create (QFileInfo (tarout).filePath (), local_dest_files);
      if (result != TAR_OK)
        {
          editor_msg (
              "red",
      ...
      editor_msg ("blue",
                  QString (us_tr ("Package: %1 created")).arg (tarout));
    }
  else
    {
      editor_msg (
          "blue",
          dest_files.replaceInStrings (QRegExp ("^"), us_tr ("Package: "))
...
void
US_Hydrodyn_Cluster::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
}
...
void
US_Hydrodyn_Cluster::update_font ()
{
  bool ok;
  QFont newFont;
...
void
US_Hydrodyn_Cluster::editor_msg (QString color, QString msg)
{
...
bool
US_Hydrodyn_Cluster::remove_files (QStringList &filenames)
{
  errormsg = "";
  for (unsigned int i = 0; i < (unsigned int)filenames.size (); i++)
    {
      if (!QFile::remove (filenames[i]))
        {
          editor_msg (
              "red",
              QString (us_tr ("Notice: remove of temporary file %1 failed"))
                  .arg (filenames[i]));
          return false;
        }
      else
        {
          // editor_msg("dark gray", QString(us_tr("Removed temporary file
          // %1")).arg( filenames[ i ] ));
        }
    }
  return true;
...
bool
US_Hydrodyn_Cluster::copy_files_to_pkg_dir (QStringList &filenames)
{
  errormsg = "";
  US_File_Util ufu;
...
void
US_Hydrodyn_Cluster::submit_pkg ()
{
  // open cluster directory and find *_out.tgz
  // process and make unified csvs etc and load into standard somo/saxs
  // directory
  if (!read_config () || !cluster_systems.size ())
    {
      config ();
      return;
    }
  ...
  US_Hydrodyn_Cluster_Submit *hcs
      = new US_Hydrodyn_Cluster_Submit (us_hydrodyn, this);
  if (hcs->files.size ())
    {
...
void
US_Hydrodyn_Cluster::load_results ()
{
  // open cluster directory and find *_out.tgz
  // process and make unified csvs etc and load into standard somo/saxs
  // directory
  US_Hydrodyn_Cluster_Results *hcr
      = new US_Hydrodyn_Cluster_Results (us_hydrodyn, this);
  if (hcr->files.size ())
    {
...
void
US_Hydrodyn_Cluster::update_output_name (const QString &cqs)
{
...
void
US_Hydrodyn_Cluster::config ()
{
  read_config ();

  US_Hydrodyn_Cluster_Config *hcc
      = new US_Hydrodyn_Cluster_Config (us_hydrodyn, this);
  US_Hydrodyn::fixWinButtons (hcc);
  hcc->exec ();
}

void
US_Hydrodyn_Cluster::check_status ()
{
  read_config ();

  US_Hydrodyn_Cluster_Status *hcs
      = new US_Hydrodyn_Cluster_Status (us_hydrodyn, this);
  if (hcs->files.size ())
    {
      US_Hydrodyn::fixWinButtons (hcs);
      hcs->exec ();
...
bool
US_Hydrodyn_Cluster::dup_in_submitted_or_completed ()
{
  if (submitted_jobs.count (le_output_name->text ()))
    {
      US_Static::us_message (
          ...
          us_tr ("There is a previously submitted job with the same name\n"
                 "Please change the output base name (job identifier) to a "
                 "unique value\n"
  ...
  if (cb_for_mpi->isChecked ())
    {
      if (!active_additional_methods ().size ())
        {
          le_no_of_jobs->setText (QString ("%1").arg (
...
void
US_Hydrodyn_Cluster::update_validator ()
{
  ...
  if (active_additional_methods ().size ())
  ...
  else
    {
      ...
      for (unsigned int i = 0; i < (unsigned int)selected_files.size (); i++)
        {
          if (batch_window->cb_dmd->isChecked ()
              && dmd_entry_count (QFileInfo (selected_files[i]).fileName ())
                     > 1)
            {
              tot_dmd_file_count += dmd_entry_count (
                  QFileInfo (selected_files[i]).fileName ());
            }
          else
            {
              tot_dmd_file_count++;
      ...
      max_jobs = (cb_split_grid->isChecked () && lb_target_files->count ())
                     ? tot_dmd_file_count * lb_target_files->count ()
                     : tot_dmd_file_count;

      max_jobs *= advanced_addition ().size ();
    }

  le_no_of_jobs_qv = new QIntValidator (1, max_jobs, this);
  le_no_of_jobs->setValidator (le_no_of_jobs_qv);
  lbl_no_of_jobs->setText (
      QString (us_tr ("Number of jobs (maximum %1):")).arg (max_jobs));
...
void
US_Hydrodyn_Cluster::split_grid ()
{
  update_validator ();
  if (cb_for_mpi->isChecked () && cb_split_grid->isChecked ()
      && lb_target_files->count ())
    {
      le_no_of_jobs->setText (QString ("%1").arg (
          selected_files.size () * lb_target_files->count ()));
...
void
US_Hydrodyn_Cluster::advanced ()
{
  US_Hydrodyn_Cluster_Advanced *hca
      = new US_Hydrodyn_Cluster_Advanced (csv_advanced, us_hydrodyn, this);
...
void
US_Hydrodyn_Cluster::dmd ()
{
  US_Hydrodyn_Cluster_Dmd *hcd
      = new US_Hydrodyn_Cluster_Dmd (csv_dmd, us_hydrodyn, this);
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->dmd_failed_validation)
    {
      QStringList errors;
      for (auto it = ((US_Hydrodyn *)us_hydrodyn)
                         ->dmd_all_pdb_prepare_reports.begin ();
           it
           != ((US_Hydrodyn *)us_hydrodyn)->dmd_all_pdb_prepare_reports.end ();
           ++it)
        {
...
bool
US_Hydrodyn_Cluster::any_advanced ()
{
  // cout << "any_advanced()\n";
  ...
  for (unsigned int i = 0; i < (unsigned int)csv_advanced.data.size (); i++)
    {
      if (csv_advanced.data[i].size () > 1 && csv_advanced.data[i][1] == "Y")
        {
...
QString
US_Hydrodyn_Cluster::advanced_addition_methods ()
{
  QString out;
  QString adaptive = "";
  if (our_saxs_options->saxs_iq_hybrid_adaptive
...
QStringList
US_Hydrodyn_Cluster::advanced_addition ()
{
  QStringList qsl_out;
  ...
  for (unsigned int i = 0; i < (unsigned int)csv_advanced.data.size (); i++)
    {
      for (unsigned int i = 0; i < (unsigned int)csv_advanced.data.size ();
           i++)
        {
  ...
  for (unsigned int i = 0; i < total_points; i++)
    {
      ...
      for (map<unsigned int, unsigned int>::iterator it = points.begin ();
           it != points.end (); it++)
        {
          ...
          if (csv_advanced.data[it->first][0]
...
QString
US_Hydrodyn_Cluster::dmd_base_addition (QStringList &base_source_files,
                                        QString common_prefix)
{
  QStringList files;
  QString dmd_base_dir = USglobal->config_list.system_dir + SLASH + "etc"
                         + SLASH + "dmd" + SLASH;

  files << "DMD_NA_allatom.par"
...
unsigned int
US_Hydrodyn_Cluster::dmd_entry_count (QString inputfile)
{
  ...
  // bool ok = false;
  for (unsigned int i = 0; i < (unsigned int)csv_dmd.prepended_names.size ();
       i++)
    {
      if (inputfile == csv_dmd.prepended_names[i]
          && csv_dmd.data[i].size () > 5 && csv_dmd.data[i][1] == "Y")
        {
...
QString
US_Hydrodyn_Cluster::dmd_file_addition (QString inputfile,
                                        QString /* outputfile */,
                                        int use_entry)
{
  QString out;
      ...
      if (use_entry >= (int)active_csv_rows.size ())
        {
          editor_msg (
              "red",
              QString (
                  us_tr ("Internal Error: issue creating dmd entry for %1 "
                         "position %2. Insufficient dmd entries (%3)\n"))
                  .arg (inputfile)
                  .arg (use_entry)
  ...
  if (use_entry == -1 && active_csv_rows.size () > 1)
    {
          ...
          if (this_static_range != static_range)
            {
              editor_msg (
                  ...
                  QString (
                      us_tr (
                          "Error: multiple (%1) same named DMD (%2) entries "
                          "with varying static ranges not supported for "
                          "simultaneous execution on one core in one job\n"))
                      .arg (active_csv_rows.size ())
                      .arg (inputfile));
              return "";
            }
  ...
  if (active_csv_rows.size () < 1)
    {
      editor_msg (
          "red",
          QString (
              us_tr ("Internal Error: no active DMD rows %1 position %2.\n"))
              .arg (inputfile)
              .arg (use_entry));
      return "";
    }

  {
    ...
    if (csv_dmd.data[i].size () > 11 && !csv_dmd.data[i][11].isEmpty ())
      {
  ...
  for (unsigned int j = 0; j < (unsigned int)active_csv_rows.size (); j++)
    {
      ...
      bool relax_ok = true;
      bool relax_is_on = (csv_dmd.data[i][3].toFloat () > 0
      ...
      if (csv_dmd.data[i][5].toFloat () <= 0 && csv_dmd.data[i].size () > 9
      ...
      if (csv_dmd.data[i].size () > 9)
        {
          run_ok = true;
          run_is_on = (csv_dmd.data[i][7].toFloat () > 0
                       || csv_dmd.data[i][9].toFloat () > 0);
...
bool
US_Hydrodyn_Cluster::validate_csv_dmd (unsigned int &number_active)
{
      ...
      if (!selected_map.count (csv_dmd.prepended_names[i]))
        {
          ...
          if (csv_dmd.data[i].size () > 1 && csv_dmd.data[i][1] == "Y")
            {
              errormsg += QString (us_tr ("Error: %1 is marked as Active in "
                                          "the DMD settings, "
                                          "but the file is not present in the "
                                          "batch selected files\n"))
                              .arg (csv_dmd.prepended_names[i]);
            }
          else
            {
              noticemsg += QString (us_tr ("Notice: %1 is in the DMD settings "
                                           "and is not Active, "
                                           "but the file is not present in "
                                           "the batch selected files\n"))
                               .arg (csv_dmd.prepended_names[i]);
            }
        }
      else
          ...
          if (csv_dmd.data[i].size () > 1 && csv_dmd.data[i][1] == "Y")
            {
              ...
              if (csv_dmd.data[i].size () < 6)
                {
                  errormsg
                      += QString (us_tr ("Error: %1 is marked as Active but "
                                         "has insufficient DMD settings, "
                                         "at least a Relax temp, time & "
                                         "output count must be specified\n"))
                             .arg (csv_dmd.prepended_names[i]);
                }
              else
                {
                  ...
                  if (relax_is_on && csv_dmd.data[i][2].toFloat () <= 0)
                    {
                      errormsg
                          += QString (
                                 us_tr ("Error: %1 is Active and does not "
                                        "have a positive Relax temp\n"))
                                 .arg (csv_dmd.prepended_names[i]);
                      relax_ok = false;
                    }
                  if (relax_is_on && csv_dmd.data[i][3].toFloat () <= 0)
                  ...
                  if (csv_dmd.data[i][5].toFloat () <= 0
                      ...
                      && csv_dmd.data[i][9].toFloat () <= 0)
                    {
                      errormsg
                          += QString (
                                 us_tr ("Error: %1 is Active and the Relax "
                                        "output count and the Run output "
                      ...
                      if (run_is_on && csv_dmd.data[i][9].toFloat () <= 0)
                        {
                          errormsg
                              += QString (
                                     us_tr ("Error: %1 is Active and the Run "
                                            "output count is not positive\n"))
                                     .arg (csv_dmd.prepended_names[i]);
                          run_ok = false;
                        }
                    }
                  if (!run_ok && !relax_ok)
                    {
                      errormsg
                          += QString (us_tr ("Error: %1 is Active neither the "
                                             "Relax or Run is ok\n"))
                                 .arg (csv_dmd.prepended_names[i]);
                    }
                }
      ...
      if (!present_map.count (it->first))
        {
          noticemsg
              += QString (
                     us_tr ("Notice: %1 is a batch selected file but is not "
...
bool
US_Hydrodyn_Cluster::active_additional_experimental_data ()
{
...
void
US_Hydrodyn_Cluster::update_enables ()
{
  unsigned int number_active;
  if (active_additional_methods ().size ())
    {
  ...
  if (batch_window->cb_dmd->isChecked ())
    {
      ...
      if (number_active < (unsigned int)selected_files.size ()
          ...
          && !batch_window->cb_iqq->isChecked ())
        {
          editor_msg (
              "red",
              us_tr ("For DMD only runs, all batch selected files must be "
                     "accounted for and active in the DMD settings"));
          pb_create_pkg->setEnabled (false);
          return;
        }
...
QString
US_Hydrodyn_Cluster::options_summary ()
{
  QString prefix = QString (us_tr ("Number of selected files: %1\n"
                                   "Options summary:"))
                       .arg (selected_files.size ());
...
bool
US_Hydrodyn_Cluster::corrupt_config ()
{
  switch (QMessageBox::question (
      this, windowTitle () + us_tr (" : Configuration file corrupt"),
      QString (
          us_tr ("The cluster configuration file was found to be corrupt.\n"
        ...
        if (!ufu.move (configfile, configcorruptfile, true))
          {
            editor_msg (
                "red",
                QString (
                    us_tr ("Error: Could not rename corrupt cluster "
                           "configuration file:"
                           + ufu.errormsg
          ...
          {
            editor_msg ("blue",
                        QString (us_tr ("Notice: Renamed corrupt cluster "
...
bool
US_Hydrodyn_Cluster::read_config ()
{
  ...
  if (!f.exists ())
    {
      ...
      US_File_Util ufu;
      QString ref_config
          = USglobal->config_list.system_dir + "/etc/cluster.config";
      if (!ufu.copy (ref_config, configfile))
        {
          errormsg = QString (
              us_tr ("Error: Can not create blank cluster configuration file:"
                     + ufu.errormsg));
          return false;
        }
      else
        {
          editor_msg (
              "blue",
              us_tr ("Notice: Created default cluster configuration file."));
        }
    }
  ...
  while (!ts.atEnd ())
    {
      ...
      if (rx_valid.indexIn (option) == -1)
        {
          errormsg
              = QString ("Error reading %1 line %2 : Unrecognized token %3")
                    .arg (configfile)
                    .arg (line)
                    .arg (qsl[0]);
      ...
      if (option == "system")
        {
          ...
          if (cluster_systems.count (last_system))
            {
              errormsg = QString ("Error reading %1 line %2 : system %3 "
                                  "multiply defined.")
                             .arg (configfile)
                             .arg (line)
                             .arg (qsl[0]);
      ...
      if (rx_systems.indexIn (option) != -1)
        {
          if (last_system.isEmpty ())
            {
              errormsg = QString ("Error reading %1 line %2 : system must be "
                                  "specified before %3 ")
                             .arg (configfile)
                             .arg (line)
                             .arg (option);
...
QString
US_Hydrodyn_Cluster::list_config ()
{
  QString qs;
  ...
  for (map<QString, QString>::iterator it = cluster_config.begin ();
       it != cluster_config.end (); it++)
    {
      qs += QString ("%1\t%2\n").arg (it->first).arg (it->second);
    }

  for (map<QString, map<QString, QString> >::iterator it
       = cluster_systems.begin ();
       it != cluster_systems.end (); it++)
    {
  ...
  for (map<QString, QString>::iterator it = cluster_stage_to_system.begin ();
       it != cluster_stage_to_system.end (); it++)
    {
      qs += QString ("%1\t%2\n").arg (it->first).arg (it->second);
    }
...
bool
US_Hydrodyn_Cluster::write_config ()
{
  QString out;
...
void
US_Hydrodyn_Cluster::additional ()
{
  US_Hydrodyn_Cluster_Additional *hca
      = new US_Hydrodyn_Cluster_Additional (us_hydrodyn, this);
  US_Hydrodyn::fixWinButtons (hca);
  hca->exec ();
  delete hca;
  update_enables ();
...
QStringList
US_Hydrodyn_Cluster::active_additional_methods ()
{
  QStringList methods;
  for (map<QString, bool>::iterator it
       = cluster_additional_methods_options_active->begin ();
       it != cluster_additional_methods_options_active->end (); it++)
    {
      if (it->second)
        {
          methods << it->first;
...
QStringList
US_Hydrodyn_Cluster::additional_method_files (QString method)
{
  QStringList files;
  if (cluster_additional_methods_options_active->count (method)
      ...
      && cluster_additional_methods_options_selected->count (method))
    {
      for (map<QString, QString>::iterator it
           = (*cluster_additional_methods_options_selected)[method].begin ();
...
QString
US_Hydrodyn_Cluster::additional_method_package_text (QString method)
{
  QString text;
  if (cluster_additional_methods_options_active->count (method)
      && (*cluster_additional_methods_options_active)[method]
...
bool
US_Hydrodyn_Cluster::active_additional_mpi_mix_issue ()
{
...
bool
US_Hydrodyn_Cluster::active_additional_prepend_issue ()
{
  // we can not mix real parallel jobs with trivially parallel jobs
  ...
  for (int i = 0; i < (int)methods.size (); i++)
    {
      if (!i)
        {
          first_prepend = cluster_additional_methods_prepend.count (methods[i])
...
QString
US_Hydrodyn_Cluster::job_prepend_name ()
{
  QStringList methods = active_additional_methods ();
  QString prepend
      = methods.size ()
                && cluster_additional_methods_prepend.count (methods[0])
            ? cluster_additional_methods_prepend[methods[0]]
            : "";
  if (!prepend.isEmpty () && cb_for_mpi->isChecked ())
    {
      QStringList methods = active_additional_methods ();
      if (methods.size ()
          && cluster_additional_methods_job_multiplier.count (methods[0]))
        {
          prepend += QString ("p%1_").arg (
              le_no_of_jobs->text ().toUInt ()
              * cluster_additional_methods_job_multiplier[methods[0]]);
        }
      else
        {
...
void
US_Hydrodyn_Cluster::create_additional_methods_pkg (QString base_dir,
                                                    QString filename,
                                                    QString common_prefix,
                                                    bool use_extension)
{
  editor_msg ("dark blue", us_tr ("Files:\n"
                                  + additional_method_files (
                                        active_additional_methods ()[0])
                                        .join ("\n")
                                  + "\n"));
  editor_msg ("dark blue", us_tr ("Text:\n"
                                  + additional_method_package_text (
                                      active_additional_methods ()[0])
                                  + "\n"));
  ...
  if (active_additional_mpi_mix_issue ())
    {
      editor_msg (
          "red",
          us_tr ("Multiple other methods selected that are currently "
                 "incompatible for a single job package\n"
                 "(Some of the jobs are trivially parallel and others are "
                 "parallel jobs with interprocess communications)"));
      return;
    }
  ...
  if (!methods.size ())
    {
      editor_msg ("red", us_tr ("Internal error: no other methods selected"));
      return;
    }
      ...
      for (int i = 0; i < (int)methods.size (); i++)
        {
          if (cluster_additional_methods_one_pdb_exactly.count (methods[i]))
            {
              editor_msg ("red",
                          us_tr (QString ("The addtional method %1 requires "
                                          "exactly one pdb to be selected")
                                     .arg (methods[i])));
              return;
            }
        }
          ...
          if (cluster_additional_methods_must_run_alone.count (methods[i]))
            {
              editor_msg (
                  "red",
                  us_tr ("An active additional method is required to be run "
                         "without other active active additional methods"));
              return;
            }
        }
    }
  ...
  if (cluster_additional_methods_parallel_mpi.count (methods[0]))
    {
      return create_additional_methods_parallel_pkg (
          base_dir, filename, common_prefix, use_extension);
    }
  ...
  if (batch_window->cb_mm_all->isChecked ())
    {
      ...
      for (int i = 0; i < (int)methods.size (); i++)
        {
          if (cluster_additional_methods_modes.count ("no_multi_model_pdb")
              && cluster_additional_methods_modes["no_multi_model_pdb"].count (
                  methods[i]))
            {
              errors += methods[i] + " ";
            }
      ...
      if (!errors.isEmpty ())
        {
          US_Static::us_message (
              us_tr ("Please note:"),
              QString (
                  us_tr ("You have selected to process all models in "
                         "multi-model PDBs with the %1additional method(s).\n"
                         "If you are including multi-model PDBs, only the "
                         "first model's results will be produced.\n"
                         "If you wish to process all the individual models, "
                         "split the multi model PDB into individual files\n"
                         "You can split the multi-model PDB into individual "
                         "files using the PDB Editor / Split button."))
                  .arg (errors.toUpper ()));
        }
  ...
  if (!lb_target_files->count ())
    {
      ...
      for (int i = 0; i < (int)methods.size (); i++)
        {
          if (cluster_additional_methods_require_experimental_data.count (
                  methods[i]))
            {
              editor_msg (
                  "red",
                  QString (us_tr ("Selected other method %1 requires "
                                  "experimental data and none are listed"))
  ...
  // this is a problem for dammin etc, as they can't reference a ../common
  // directory later we could force copy over
  // -------------------------------------------------
  ...
  // {
  // for ( map < QString, QString >::iterator it =
  // (*cluster_additional_methods_options_selected)[ methods[ m ] ].begin(); it
  // != (*cluster_additional_methods_options_selected)[ methods[ m ] ].end();
  // it++ )
  // {
  // if ( it->first.contains( "file" ) )
  // {
  ...
  for (int m = 0; m < (int)methods.size (); m++)
    {
      if (cluster_additional_methods_modes.count (
              "additional_processing_global")
          && cluster_additional_methods_modes["additional_processing_global"]
                 .count (methods[m]))
        {
          if (!additional_processing (base, base_source_files,
                                      "additional_processing_global",
                                      methods[m]))
            {
              editor_msg (
                  "red",
                  us_tr (
                      "Internal error:additional processing per file error"));
            }
        }
    }
  ...
  for (int i = 0; i < jobs; i++)
    {
      for (int m = 0; m < (int)methods.size (); m++)
        {
          ...
          if (cluster_additional_methods_add_selected_files.count (methods[m]))
            {
              for (unsigned int i = 0;
                   i < (unsigned int)selected_files.size (); i++)
                {
                  out += QString ("InputFile       %1\n")
          ...
          if (cluster_additional_methods_options_selected->count (methods[m]))
            {
              for (map<QString, QString>::iterator it
                   = (*cluster_additional_methods_options_selected)[methods[m]]
                         .begin ();
                   it
                   != (*cluster_additional_methods_options_selected)
                          [methods[m]]
                   ...
                   it++)
                {
                  if (!it->first.contains ("file"))
                    ...
                    {
                      if (cluster_additional_methods_modes["acceptcommon"]
                              .count (methods[m]))
                        {
                          out += QString ("%1\t%2\n")
                                     .arg (it->first)
              ...
              if (cluster_additional_methods_modes.count ("one_run_per_file")
                  && cluster_additional_methods_modes["one_run_per_file"]
                         .count (methods[m]))
                {
                  for (unsigned int j = 0;
                       j < (unsigned int)selected_files.size (); ++j)
                    {
                      if ((int)j % jobs == i)
                        {
                          QString use_filename = selected_files[j];
                          if (cluster_additional_methods_modes
                                  ["inputfile_pat_addendum"]
                                      .count (methods[m]))
                            {
                              use_filename
                                  = QFileInfo (selected_files[j]).baseName ()
                                    + "_pat" + "."
                                    + QFileInfo (selected_files[j])
                                          .completeSuffix ();
                            }

                          out += QString ("%1 %2\n")
                                     .arg (
                                         cluster_additional_methods_modes
                                                     .count ("inputfilenoread")
                                                 && cluster_additional_methods_modes
                                                        ["inputfilenoread"]
                                                            .count (methods[m])
                                             ? "InputFileNoRead"
                                             : "InputFile     ")
                                     .arg (
                                         QFileInfo (use_filename).fileName ());
                              ...
                              if (cluster_additional_methods_modes.count (
                                             ...
                                             .count (methods[m]))
                                {
                                  if (!additional_processing (
                                          out, source_files_to_clear,
                                          "additional_processing_per_file",
                                          methods[m], selected_files[j]))
                                    {
                                      editor_msg (
                                          "red",
                                          us_tr ("Internal error:additional "
                                                 "processing per file error"));
                                    }
                                }
                              out += methods[m] + "run\n";
                              out += "\n";
      ...
      // if ( !( ( i + 1 ) % jobs ) )
      {
        ...
        for (unsigned int i = 0;
             i < (unsigned int)source_files_to_clear.size (); i++)
          {
            to_tar_list << QFileInfo (source_files_to_clear[i]).fileName ();
            remove_file_list
                << pkg_dir + SLASH
                       + QFileInfo (source_files_to_clear[i]).fileName ();
          }
        remove_file_list << pkg_dir + SLASH + QFileInfo (use_file).fileName ();

        QString tar_name = use_file + ".tar";
        int result = ust.create (QFileInfo (tar_name).filePath (), to_tar_list,
                                 &list);
        cout << "tar_name:" << tar_name << endl;
        cout << "to tar:\n" << to_tar_list.join ("\n") << endl;
  ...
  if (last_unwritten)
    {
      ...
      for (unsigned int i = 0; i < (unsigned int)source_files_to_clear.size ();
           i++)
        {
          to_tar_list << QFileInfo (source_files_to_clear[i]).fileName ();
          remove_file_list
...
void
US_Hydrodyn_Cluster::create_additional_methods_parallel_pkg (
    QString /* base_dir */, QString filename, QString /* common_prefix */,
    bool /* use_extension */)
{
  QStringList methods = active_additional_methods ();
  ...
  base
      += QString ("ResidueFile     %1\n")
             .arg (QFileInfo (((US_Hydrodyn *)us_hydrodyn)->lbl_table->text ())
                       .fileName ());
  base_source_files << ((US_Hydrodyn *)us_hydrodyn)->lbl_table->text ();

  base += QString ("AtomFile        %1\n")
              .arg (QFileInfo (our_saxs_options->default_atom_filename)
                        .fileName ());
  base_source_files << our_saxs_options->default_atom_filename;
  base += QString ("HybridFile      %1\n")
              .arg (QFileInfo (our_saxs_options->default_hybrid_filename)
                        .fileName ());
  base_source_files << our_saxs_options->default_hybrid_filename;
  base += QString ("SaxsFile        %1\n")
              .arg (QFileInfo (our_saxs_options->default_saxs_filename)
                        .fileName ());
  base_source_files << our_saxs_options->default_saxs_filename;
  ...
  if (batch_window->cb_hydrate && batch_window->cb_hydrate->isChecked ())
    {
      base += QString ("HydrationFile   %1\n")
                  .arg (QFileInfo (our_saxs_options->default_rotamer_filename)
                            .fileName ());
      base += QString ("HydrationSCD    %1\n")
                  .arg (our_saxs_options->steric_clash_distance);
      base += QString ("HydrationRSCD   %1\n")
  ...
  if (our_saxs_options->use_somo_ff)
    {
      base += QString ("FFFile          %1\n")
                  .arg (QFileInfo (our_saxs_options->default_ff_filename)
                            .fileName ());
      base_source_files << our_saxs_options->default_ff_filename;
    }
  ...
  // we have to communicate this somehow to submission (?), i guess package
  // naming, otherwise it will require submission to inspect the package
  // package here is one tgz

  int loop_count = lb_target_files->count () ? lb_target_files->count () : 1;
  ...
  for (int i = 0; i < loop_count; i++)
    {
      if (lb_target_files->count ())
        {
          out += QString ("ExperimentGrid     %1\n")
                     .arg (QFileInfo (lb_target_files->item (i)->text ())
                               .fileName ());
          if (!already_added.count (
                  QFileInfo (lb_target_files->item (i)->text ()).fileName ()))
            {
...
static void
combo_with_replacement (vector<int> &elems, unsigned int req_len,
                        vector<int> &pos, vector<vector<int> > &results,
                        unsigned int depth = 0, unsigned int margin = 0)
{
  if (depth >= req_len)
    {
...
void
US_Hydrodyn_Cluster::create_additional_methods_parallel_pkg_bfnb (
    QString filename)
{
  QStringList methods = active_additional_methods ();
  ...
  if (le_no_of_jobs->text ().toUInt () < 2)
    {
      errors += QString (
                    us_tr ("Error: method %1 requires a minimum of 2 cores\n"))
                    .arg (methods[0]);
    }
  ...
  if (!lb_target_files->count ())
    {
      if (cluster_additional_methods_require_experimental_data.count (
              methods[0]))
        {
          errors += QString (us_tr ("Selected other method %1 requires "
                                    "experimental data and none are listed\n"))
                        .arg (methods[0].toUpper ());
        }
    }

  // (*cluster_additional_methods_options_selected)[ methods[ 0 ] ][
  // "pmrayleighdrho" ] = ".1";
  if (!(*cluster_additional_methods_options_selected)[methods[0]].count (
          "pmrayleighdrho"))
    {
      (*cluster_additional_methods_options_selected)[methods[0]]
                                                    ["pmrayleighdrho"]
      ...
      editor_msg (
          "dark red",
          us_tr (
              "Notice: setting sample e density to protein average of .425"));
    }
  ...
  if (!(*cluster_additional_methods_options_selected)[methods[0]].count (
          "pmbufferedensity"))
    {
      ...
      editor_msg ("dark red",
                  QString (us_tr ("Notice: setting buffer e density to SAS "
                                  "Options value of %1"))
                      .arg (our_saxs_options->water_e_density));
    }

  QString base = "# us_saxs_cmds_t pm controlfile\n"
                 "# blank lines ok, format token <params>\n"
                 "\n";

  // we are going to have to take each experimental file, produce pmi, pmq, pme
  // lines and pmbest when "pmincrementally", run for subsets of pmtypes when
  // "pmallcombinations", run for each possible combo suffix pmoutname
  // appropriately (source data, model type)
  ...
  for (map<QString, QString>::iterator it
       = (*cluster_additional_methods_options_selected)[methods[0]].begin ();
  ...
  if ((*cluster_additional_methods_options_selected)[methods[0]]
                                                    ["pmrayleighdrho"]
                                                        .toDouble ()
      == 0e0)
    {
      errors += QString (us_tr ("Method %1 pmrayleighdrho must not be zero"))
                    .arg (methods[0]);
    }

  if (req.size ())
    {
      for (map<QString, bool>::iterator it = req.begin (); it != req.end ();
           it++)
        {
          errors += QString (us_tr ("Method %1 requires parameter %2"))
                        .arg (methods[0])
                        .arg (it->first);
        }
    }
  ...
  QString pmapproxmaxdimension
      = (*cluster_additional_methods_options_selected)[methods[0]].count (
            "pmapproxmaxdimension")
            ? (*cluster_additional_methods_options_selected)
                  [methods[0]]["pmapproxmaxdimension"]
            : "";
  ...
  if (!pmapproxmaxdimension.isEmpty ())
    {
      if ((*cluster_additional_methods_options_selected)[methods[0]].count (
          ...
          && !(*cluster_additional_methods_options_selected)
                  [methods[0]]["pmbestcoarseconversion"]
                      .isEmpty ())
        {
          pmapproxmaxdimension
              = "pmapproxmaxdimension\t"
  ...
  QString pmtypes
      = (*cluster_additional_methods_options_selected)[methods[0]]["pmtypes"];
  ...
  for (int i = 0; i < (int)qsl_pmtypes.size (); ++i)
    {
      if (qsl_pmtypes[i].toInt () < US_PM::OBJECTS_FIRST
        ...
        {
          errors += QString (us_tr ("Method %1 pmtype out of range %2"))
                        .arg (methods[0])
                        .arg (qsl_pmtypes[i]);
        }
    }
          ...
          "pmincrementally"))
    {
      if ((*cluster_additional_methods_options_selected)[methods[0]].count (
              "pmallcombinations"))
        {
          ...
          vector<int> typesv;
          for (set<int>::iterator it = types.begin (); it != types.end ();
               it++)
            {
              typesv.push_back (*it);
            }
          ...
          for (int i = 1; i <= (int)qsl_pmtypes.size (); ++i)
            {
              ...
              vector<int> pos (i);
              combo_with_replacement (typesv, (int)pos.size (), pos, results);
              for (int j = 0; j < (int)results.size (); ++j)
                {
                  out_per_experimental_dataset
                      += QString ("pmoutname %1___EXPERIMENT_NAME___-")
                             .arg (pmoutprefix);
                  for (int k = 0; k < (int)results[j].size (); ++k)
                    {
                      out_per_experimental_dataset
                          += QString ("%1").arg (results[j][k]);
                    }
                  out_per_experimental_dataset += "\n";
                  out_per_experimental_dataset += "pmtypes ";
                  for (int k = 0; k < (int)results[j].size (); ++k)
                    {
                      out_per_experimental_dataset += QString ("%1%2")
                                                          .arg (k ? "," : "")
                                                          .arg (results[j][k]);
                    }
                  out_per_experimental_dataset += "\n";
  ...
  for (int i = 0; i < lb_target_files->count (); i++)
    {
      ...
      QString target_file_name
          = QFileInfo (target_file).completeBaseName ().replace (".", "_");

      // read file and extract q,I,e... add  pmq, pmi, and possibly pme with 0,
      // 'g', 8 later add pmf via "pmusedummyatomff" option and possible q
      // editing (log binning), qmax, max pts ?
      vector<double> q;
      vector<double> I;
      vector<double> e;
      QString error_msg;
      ...
      if (!US_Saxs_Util::read_sas_data (target_file, q, I, e, error_msg))
      ...
      else
        {
          if (q.size () < 3)
            {
              errors += QString ("Error: Too few q points read from data (%1)")
                            .arg (q.size ());
              continue;
            }
          ...
          US_Saxs_Util::bin_data (pmqpoints, pmlogbin, q, I, e, error_msg,
                                  notice_msg);
          ...
          if (q.size () < 3)
            {
              errors += QString ("Error: After cropping and binning, there "
                                 "are too few q points left (%1)")
                            .arg (q.size ());
            }
      ...
      out_this_experimental_dataset.replace ("___EXPERIMENT_NAME___",
                                             target_file_name);
  ...
  editor_msg (
      "dark blue",
      QString ("Notice: the total number of models to be computed is %1\n")
          .arg (tot_runs));
...

  {
    ...
    if (!f.open (QIODevice::WriteOnly))
      {
        editor_msg ("red", QString (us_tr ("Error: could not create file %1"))
                               .arg (use_file));
        return;
      }
...
bool
US_Hydrodyn_Cluster::additional_processing (QString &out,
                                            QStringList &source_files,
                                            const QString &type,
  ...
  if (method == "best")
    {
      if (type == "additional_processing_per_file")
        {
          ...
          if ((*cluster_additional_methods_options_selected).count (method)
              && (*cluster_additional_methods_options_selected)[method].count (
                  "bestbestmw"))
            {
              mw = (*cluster_additional_methods_options_selected)
                       [method]["bestbestmw"]
                           .toDouble ();
            }
          if ((*cluster_additional_methods_options_selected).count (method)
              && !(*cluster_additional_methods_options_selected)[method]
                      .count ("bestbestmw"))
            {
              // compute mw for file
              if (file.contains (QRegExp (".(pdb|PDB)$"))
                  && !((US_Hydrodyn *)us_hydrodyn)->is_dammin_dammif (file))
                {
                  ...
                  if (batch_window->screen_pdb (file, false))
                  ...
                  else
                    {
                      ...
                      editor_msg (
                          "dark red",
                          QString (us_tr ("Warning: error loading %1 for "
                                          "computation of molecular weight"))
                              .arg (file));
                      if (((US_Hydrodyn *)us_hydrodyn)
                              ->saxs_util->pdb_mw (file, mw))
                        {
                          editor_msg (
                              "dark red",
                              QString (us_tr ("Notice: direct atom method for "
                      ...
                      else
                        {
                          editor_msg (
                              "red",
                              QString (us_tr ("Error: direct atom method for "
                                              "computation of molecular "
                                              "weight of %1 failed"))
                                  .arg (file));
                          ok = false;
                  ...
                  if (ok)
                    {
                      editor_msg (
                          "blue",
                          QString (
                              us_tr ("Molecular weight of %1: %2 Daltons\n"))
                              .arg (QFileInfo (file).fileName ())
                              .arg (mw));
                      out += QString ("bestbestmw      %1\n").arg (mw);
                      // PAT
                      if (!US_Saxs_Util::pat_model (
                              ((US_Hydrodyn *)us_hydrodyn)->model_vector[0]))
                        {
                          editor_msg (
                              "red",
                              QString (us_tr ("Error: perform PAT on  %1"))
                                  .arg (file));
                        }
                      else
                        {
                          editor_msg (
                              "blue",
                              QString (us_tr ("PAT on %1 ok")).arg (file));
                          QString dir = ((US_Hydrodyn *)us_hydrodyn)->somo_dir
                                        + QDir::separator () + "tmp"
                                        + QDir::separator ();
                          QString patfile
                              = dir + QFileInfo (file).baseName () + "_pat"
                                + "." + QFileInfo (file).completeSuffix ();
                          if (!US_Saxs_Util::write_model (
                                  ((US_Hydrodyn *)us_hydrodyn)
                                      ->model_vector[0],
                                  patfile))
                            {
                              editor_msg (
                                  "red",
                                  QString (
                                      us_tr ("Error: writing PAT'd pdb %1"))
                                      .arg (patfile));
                            }
                          else
                            {
              ...
              else
                {
                  editor_msg (
                      "red",
                      "Error: bead models are not supported for msroll");
                  // result = batch_window->screen_bead_model( file );
                }
              if ((*cluster_additional_methods_options_selected).count (method)
                  && (*cluster_additional_methods_options_selected)[method]
                         .count ("bestrcoalautominmax")
                  && (*cluster_additional_methods_options_selected)
                             [method]["bestrcoalautominmax"]
                         == "true")
                {
                  ...
                  editor_msg (
                      "blue",
                      QString (
                          "COALESCE: triangles range %1 to %2 for file %3")
                          .arg (mintriangles)
                          .arg (maxtriangles)
                          .arg (file));
                }
      ...
      if (type == "additional_processing_global")
        {
          QString common_prefix = cb_for_mpi->isChecked () ? "../common/" : "";
          QString my_msroll_radii
              = ((US_Hydrodyn *)us_hydrodyn)->msroll_radii.join ("");
          if ((*cluster_additional_methods_options_selected).count (method)
              && (*cluster_additional_methods_options_selected)[method].count (
                  "bestexpand")
              && (*cluster_additional_methods_options_selected)[method]
                     ...
                     > 0e0)
            {
              double mult = (*cluster_additional_methods_options_selected)
                                [method]["bestexpand"]
                                    .toDouble ();
              editor_msg ("dark blue",
                          QString (us_tr ("Radii will be multiplied by %1"))
                              .arg (mult));
              QStringList my_qsl_radii
                  = ((US_Hydrodyn *)us_hydrodyn)->msroll_radii;
              QRegExp rx ("(^\\d+) (\\S+) (\\S+) (\\S+)");
              for (int i = 0; i < (int)my_qsl_radii.size (); ++i)
                {
                  if (rx.indexIn (my_qsl_radii[i]) == -1)
                    {
                      editor_msg ("red",
                                  us_tr ("radii multiplication failed"));
                      return false;
                    }
                  else
                    {
          ...
          if (!(*cluster_additional_methods_options_selected)[method].count (
                  "bestmsrusesomoradii")
              && !(*cluster_additional_methods_options_selected)[method]
                      .count ("bestmsrradiifile"))
            {
              (*cluster_additional_methods_options_selected)
                  [method]["bestmsrradiifile"]
                  = QString (USglobal->config_list.system_dir
                             + QDir::separator () + "etc" + QDir::separator ()
                             + "best.radii");
              editor_msg (
                  "blue",
                  QString (
                      us_tr ("Notice: using default BEST radii  file: %1"))
                      .arg ((*cluster_additional_methods_options_selected)
                                [method]["bestmsrradiifile"]));
            }
          ...
          if ((*cluster_additional_methods_options_selected)[method].count (
                  "bestmsrusesomoradii"))
            {
              if ((*cluster_additional_methods_options_selected)[method]
                      .count ("bestmsrradiifile"))
                {
                  (*cluster_additional_methods_options_selected)[method]
                      .erase ("bestmsrradiifile");
                }
              if ((*cluster_additional_methods_options_selected)[method]
                      .count ("bestmsrpatternfile"))
                {
                  (*cluster_additional_methods_options_selected)[method]
                      .erase ("bestmsrpatternfile");
                }
            }
              ...
              if (!f_radii.open (QIODevice::WriteOnly))
                {
                  editor_msg (
                      ...
                      QString (
                          us_tr (
                              "Error: can not create MSROLL radii file: %1"))
              ...
              else
                {
                  ...
                  out += QString ("bestmsrradiifile %1%2\n")
                             .arg (common_prefix)
                             .arg (QFileInfo (f_radii).fileName ());
                  editor_msg (
                      "blue",
              ...
              if (!f_names.open (QIODevice::WriteOnly))
                {
                  editor_msg (
                      ...
                      QString (
                          us_tr (
                              "Error: can not create MSROLL names file: %1"))
              ...
              else
                {
                  ...
                  for (unsigned int i = 0;
                       i < (unsigned int)((US_Hydrodyn *)us_hydrodyn)
                               ->msroll_names.size ();
                       i++)
                    {
                  ...
                  out += QString ("bestmsrpatternfile %1%2\n")
                             .arg (common_prefix)
                             .arg (QFileInfo (f_names).fileName ());
                  editor_msg (
                      "blue",
          ...
          if ((*cluster_additional_methods_options_selected)[method].count (
                  "bestmsrradiifile"))
            {
              if ((*cluster_additional_methods_options_selected)
                      .count (method))
                {
                  if ((*cluster_additional_methods_options_selected)[method]
                          .count ("bestbestwatr")
                    ...
                    {
                      editor_msg ("red",
                                  us_tr ("Manual radii file does not support "
                                         "water radius or expansion"));
                      return false;
                    }
                }
          ...
          if ((!(*cluster_additional_methods_options_selected)[method].count (
            ...
            {
              editor_msg ("red",
                          us_tr ("Manual pattern file requires radii file"));
              return false;
            }
          ...
          if (!f_directives.open (QIODevice::WriteOnly))
            {
              editor_msg (
                  "red",
                  QString (us_tr ("Error: can not create directives file: %1"))
                      .arg (f_directives.fileName ()));
            }
          else
            {
              QTextStream ts (&f_directives);
              ts << QString ("%1").arg (
                  cluster_additional_methods_job_multiplier["best"] - 1)
                 << Qt::endl;
              f_directives.close ();
