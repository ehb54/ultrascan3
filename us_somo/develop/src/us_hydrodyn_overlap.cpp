...
US_Hydrodyn_Overlap::setupGUI ()
{
  ...
  if (show_grid_only)
    {
      ...
      lbl_info
          = new QLabel (us_tr ("Grid Bead Overlap Reduction Options:"), this);
    }
  else
    {
      other_ORs.clear ();
      ...
      buried_OR
          = new US_Hydrodyn_OR (buried_overlap, replicate_o_r_method_somo,
                                &other_ORs, us_hydrodyn, this);
      other_ORs.push_back ((void *)buried_OR);
      lbl_info
          = new QLabel (us_tr ("SoMo Bead Overlap Reduction Options:"), this);
    }
  ...
  lbl_overlap_tolerance
      = new QLabel (us_tr (" Bead Overlap Tolerance: "), this);
  ...
  cnt_overlap_tolerance->setFont (QFont (USglobal->config_list.fontFamily,
...
void
US_Hydrodyn_Overlap::cancel ()
{
  close ();
}

void
US_Hydrodyn_Overlap::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Overlap::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Overlap::update_overlap_tolerance (double val)
{
