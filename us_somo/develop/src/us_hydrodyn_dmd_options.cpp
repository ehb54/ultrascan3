...
void US_Hydrodyn_DMD_Options::setupGUI()
{
   ...
   cnt_threshold_pb_pb->setRange(0, 100); cnt_threshold_pb_pb->setSingleStep( 0.1);
   ...
   cnt_threshold_pb_sc->setRange(0, 100); cnt_threshold_pb_sc->setSingleStep( 0.1);
   ...
   cnt_threshold_sc_sc->setRange(0, 100); cnt_threshold_sc_sc->setSingleStep( 0.1);
