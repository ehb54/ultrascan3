...
US_Hydrodyn_Results::~US_Hydrodyn_Results () { *result_widget = false; }

void
US_Hydrodyn_Results::setupGUI ()
{
  int minHeight1 = 70;
  int minHeight2 = 30;
  QString str;
  ...
  lbl_info = new QLabel (
      us_tr (QString ("SOMO Hydrodynamic Results\n(%1 at %2%3C, pH "
  ...
  le_name->setObjectName ("name Line Edit");
  ...
  AUTFBACK (lbl_method);
  lbl_method->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));

  le_method = new QLineEdit (this);
  le_method->setObjectName ("method Line Edit");
  ...
  AUTFBACK (le_method);
  le_method->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  lbl_total_beads->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));

  le_total_beads = new QLineEdit (this);
  le_total_beads->setObjectName ("total_beads Line Edit");
  if (fabs (results->total_beads_sd) <= 1e-100)
    ...
    {
      le_total_beads->setText (
          QString ("").sprintf ("%u (%4.2e)", (int)(results->total_beads + .5),
  ...
  le_total_beads->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  lbl_used_beads->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1,
                                  QFont::Bold));

  le_used_beads = new QLineEdit (this);
  le_used_beads->setObjectName ("used_beads Line Edit");
  if (fabs (results->used_beads_sd) <= 1e-100)
    ...
    {
      le_used_beads->setText (
          QString ("").sprintf ("%u (%4.2e)", (int)(results->used_beads + .5),
  ...
  le_used_beads->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_s20w);
  lbl_s20w->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));

  le_s20w = new QLineEdit (this);
  le_s20w->setObjectName ("s20w Line Edit");
  if (fabs ((*results).s20w_sd) <= 1e-100)
    ...
    {
      le_s20w->setText (str.sprintf ("%4.2e S (%4.2e)", (*results).s20w,
                                     (*results).s20w_sd));
    }
  ...
  AUTFBACK (le_s20w);
  le_s20w->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_D20w);
  lbl_D20w->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));

  le_D20w = new QLineEdit (this);
  le_D20w->setObjectName ("D20w Line Edit");
  if (fabs ((*results).D20w_sd) <= 1e-100)
    ...
    {
      le_D20w->setText (str.sprintf ("%4.2e cm^2/sec (%4.2e)", (*results).D20w,
                                     (*results).D20w_sd));
    }
  ...
  AUTFBACK (le_D20w);
  le_D20w->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_tau);
  lbl_tau->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1, QFont::Bold));

  le_tau = new QLineEdit (this);
  le_tau->setObjectName ("tau Line Edit");
  if (le_method->text () == "Zeno"
  ...
  else
    {
      if (fabs ((*results).tau_sd) <= 1e-100)
        ...
        {
          le_tau->setText (str.sprintf ("%4.2e ns (%4.2e)", (*results).tau,
                                        (*results).tau_sd));
        }
    }
  ...
  AUTFBACK (le_tau);
  le_tau->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  lbl_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));

  le_viscosity = new QLineEdit (this);
  le_viscosity->setObjectName ("viscosity Line Edit");
  if (fabs ((*results).viscosity_sd) <= 1e-100)
    {
      le_viscosity->setText (
          str.sprintf ("%4.2e cm^3/g", (*results).viscosity));
    }
  else
    {
      le_viscosity->setText (str.sprintf ("%4.2e cm^3/g (%4.2e)",
                                          (*results).viscosity,
  ...
  le_viscosity->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  if (le_method->text () == "SMI"
      && !((US_Hydrodyn *)us_hydrodyn)->advanced_config.expert_mode)
    {
  ...
  AUTFBACK (lbl_rs);
  lbl_rs->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_rs = new QLineEdit (this);
  le_rs->setObjectName ("rs Line Edit");
  if (fabs ((*results).rs_sd) <= 1e-100)
    ...
    {
      le_rs->setText (
          str.sprintf ("%4.2e nm (%4.2e)", (*results).rs, (*results).rs_sd));
    }
  le_rs->setReadOnly (true);
  le_rs->setAlignment (Qt::AlignVCenter);
  le_rs->setPalette (PALET_NORMAL);
  AUTFBACK (le_rs);
  le_rs->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_ff0);
  lbl_ff0->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1, QFont::Bold));

  le_ff0 = new QLineEdit (this);
  le_ff0->setObjectName ("ff0 Line Edit");
  if (fabs ((*results).ff0_sd) <= 1e-100)
    ...
    {
      le_ff0->setText (
          str.sprintf ("%3.2f nm (%3.2e)", (*results).ff0, (*results).ff0_sd));
    }
  le_ff0->setReadOnly (true);
  le_ff0->setAlignment (Qt::AlignVCenter);
  le_ff0->setPalette (PALET_NORMAL);
  AUTFBACK (le_ff0);
  le_ff0->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  AUTFBACK (lbl_rg);
  lbl_rg->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_rg = new QLineEdit (this);
  le_rg->setObjectName ("rg Line Edit");
  ...
  pb_load_results
      = new QPushButton (us_tr ("View Full Hydrodynamics Results File"), this);
  ...
  pb_load_beadmodel->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize + 1));
...
void
US_Hydrodyn_Results::cancel ()
{
  close ();
}

void
US_Hydrodyn_Results::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Results::load_beadmodel ()
{
  QString filename = QFileDialog::getOpenFileName (
      this, windowTitle (), somo_dir, "*.bead_model* *.BEAD_MODEL*");
  if (!filename.isEmpty ())
    {
      view_file (filename);
    }
...
void
US_Hydrodyn_Results::load_asa ()
{
  QString filename = QFileDialog::getOpenFileName (
      this, windowTitle (), somo_dir, "*.asa_res *.ASA_RES");
  if (!filename.isEmpty ())
    {
      view_file (filename);
    }
...
void
US_Hydrodyn_Results::view_file (const QString &filename)
{
...
void
US_Hydrodyn_Results::closeEvent (QCloseEvent *e)
{
  *result_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
hydro_results
US_Hydrodyn_Results::hydro_results_initialized ()
{
  hydro_results data;
