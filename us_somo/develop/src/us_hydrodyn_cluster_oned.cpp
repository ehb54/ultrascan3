...
void US_Hydrodyn_Cluster_Oned::setupGUI() {
  ...
  lbl_1dlambda->setFont(QFont(USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1, QFont::Bold));
  lbl_1dlambda->setMinimumWidth(QFontMetrics(lbl_1dlambda->font()).maxWidth() *
                                21);
  ...
  lbl_1ddetectorpixelswidth->setFont(QFont(USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 1,
                                           QFont::Bold));
  ...
  le_1ddetectorpixelswidth->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_1ddeltar->setFont(QFont(USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1, QFont::Bold));
  lbl_1ddeltar->setMinimumWidth(QFontMetrics(lbl_1ddeltar->font()).maxWidth() *
                                21);
  ...
  le_1dintermediatesaves->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...
void US_Hydrodyn_Cluster_Oned::cancel() { close(); }
  ...
  if (!filename.isEmpty()) {
    ...
    if (!f.open(QIODevice::WriteOnly)) {
      QMessageBox::information(
          this, us_tr(QString("%1: Save").arg("US-SOMO: 1d cluster interface")),
...
void US_Hydrodyn_Cluster_Oned::load() {
  ...
  if (!filename.isEmpty()) {
    ...
    if (!f.open(QIODevice::ReadOnly)) {
      QMessageBox::information(
          this, us_tr(QString("%1: Open").arg("US-SOMO: 1d cluster interface")),
...
void US_Hydrodyn_Cluster_Oned::update_fields() {
  ...
  le_1ddetectorwidth->setText(parameters->count("1ddetectorwidth")
                                  ...
                                  : "");
  le_1ddetectorpixelswidth->setText(parameters->count("1ddetectorpixelswidth")
  ...
  le_1ddeltar->setText(parameters->count("1ddeltar") ? (*parameters)["1ddeltar"]
                                                     : "");
  le_1dproberadius->setText(
      parameters->count("1dproberadius") ? (*parameters)["1dproberadius"] : "");
