...
void
US_Hydrodyn_Cluster_Oned::setupGUI ()
{
  int minHeight1 = 30;
  ...
  lbl_1drotationfile->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1,
                                      QFont::Bold));
  lbl_1drotationfile->setMinimumWidth (
      QFontMetrics (lbl_1drotationfile->font ()).maxWidth () * 21);

  le_1drotationfile = new QLineEdit (this);
  le_1drotationfile->setObjectName ("1drotationfile Line Edit");
  ...
  le_1drotationfile->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  le_1drotationfile->setMinimumHeight (minHeight1);
  le_1drotationfile->setMinimumWidth (150);
  connect (le_1drotationfile, SIGNAL (textChanged (const QString &)),
           SLOT (update_1drotationfile (const QString &)));

  lbl_1drotationsuserand
      = new QLabel (us_tr ("Use drand48() for rotations"), this);
  ...
  lbl_1drotationsuserand->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1,
                                          QFont::Bold));
  lbl_1drotationsuserand->setMinimumWidth (
      QFontMetrics (lbl_1drotationsuserand->font ()).maxWidth () * 21);

  le_1drotationsuserand = new QLineEdit (this);
  le_1drotationsuserand->setObjectName ("1drotationsuserand Line Edit");
  le_1drotationsuserand->setText (parameters->count ("1drotationsuserand")
                                      ? (*parameters)["1drotationsuserand"]
                                      : "");
  ...
  le_1drotationsuserand->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  le_1drotationsuserand->setMinimumHeight (minHeight1);
  le_1drotationsuserand->setMinimumWidth (150);
  connect (le_1drotationsuserand, SIGNAL (textChanged (const QString &)),
           SLOT (update_1drotationsuserand (const QString &)));
  ...
  lbl_1dlambda->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  lbl_1dlambda->setMinimumWidth (
      QFontMetrics (lbl_1dlambda->font ()).maxWidth () * 21);

  le_1dlambda = new QLineEdit (this);
  le_1dlambda->setObjectName ("1dlambda Line Edit");
  ...
  le_1dlambda->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  le_1dlambda->setMinimumHeight (minHeight1);
  le_1dlambda->setMinimumWidth (150);
  connect (le_1dlambda, SIGNAL (textChanged (const QString &)),
           SLOT (update_1dlambda (const QString &)));
  ...
  lbl_1ddetectordistance->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1,
                                          QFont::Bold));
  lbl_1ddetectordistance->setMinimumWidth (
      QFontMetrics (lbl_1ddetectordistance->font ()).maxWidth () * 21);

  le_1ddetectordistance = new QLineEdit (this);
  le_1ddetectordistance->setObjectName ("1ddetectordistance Line Edit");
  ...
  le_1ddetectordistance->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  le_1ddetectordistance->setMinimumHeight (minHeight1);
  le_1ddetectordistance->setMinimumWidth (150);
  connect (le_1ddetectordistance, SIGNAL (textChanged (const QString &)),
           SLOT (update_1ddetectordistance (const QString &)));
  ...
  lbl_1ddetectorwidth->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));
  lbl_1ddetectorwidth->setMinimumWidth (
      QFontMetrics (lbl_1ddetectorwidth->font ()).maxWidth () * 21);

  le_1ddetectorwidth = new QLineEdit (this);
  le_1ddetectorwidth->setObjectName ("1ddetectorwidth Line Edit");
  ...
  le_1ddetectorwidth->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  le_1ddetectorwidth->setMinimumHeight (minHeight1);
  le_1ddetectorwidth->setMinimumWidth (150);
  connect (le_1ddetectorwidth, SIGNAL (textChanged (const QString &)),
           SLOT (update_1ddetectorwidth (const QString &)));

  lbl_1ddetectorpixelswidth
      = new QLabel (us_tr ("Detector pixels width"), this);
  ...
  lbl_1ddetectorpixelswidth->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));
  lbl_1ddetectorpixelswidth->setMinimumWidth (
      QFontMetrics (lbl_1ddetectorpixelswidth->font ()).maxWidth () * 21);

  le_1ddetectorpixelswidth = new QLineEdit (this);
  le_1ddetectorpixelswidth->setObjectName ("1ddetectorpixelswidth Line Edit");
  ...
  le_1ddetectorpixelswidth->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  le_1ddetectorpixelswidth->setMinimumHeight (minHeight1);
  le_1ddetectorpixelswidth->setMinimumWidth (150);
  connect (le_1ddetectorpixelswidth, SIGNAL (textChanged (const QString &)),
           SLOT (update_1ddetectorpixelswidth (const QString &)));

  lbl_1drho0
      = new QLabel (us_tr ("Solvent electron density: rho0 (e-/A^3)"), this);
  ...
  AUTFBACK (lbl_1drho0);
  lbl_1drho0->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_1drho0->setMinimumWidth (QFontMetrics (lbl_1drho0->font ()).maxWidth ()
                               * 21);

  le_1drho0 = new QLineEdit (this);
  le_1drho0->setObjectName ("1drho0 Line Edit");
  ...
  AUTFBACK (le_1drho0);
  le_1drho0->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  le_1drho0->setMinimumHeight (minHeight1);
  le_1drho0->setMinimumWidth (150);
  connect (le_1drho0, SIGNAL (textChanged (const QString &)),
           SLOT (update_1drho0 (const QString &)));
  ...
  lbl_1ddeltar->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  lbl_1ddeltar->setMinimumWidth (
      QFontMetrics (lbl_1ddeltar->font ()).maxWidth () * 21);

  le_1ddeltar = new QLineEdit (this);
  le_1ddeltar->setObjectName ("1ddeltar Line Edit");
  ...
  le_1ddeltar->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  le_1ddeltar->setMinimumHeight (minHeight1);
  le_1ddeltar->setMinimumWidth (150);
  connect (le_1ddeltar, SIGNAL (textChanged (const QString &)),
           SLOT (update_1ddeltar (const QString &)));

  lbl_1dproberadius
      = new QLabel (us_tr ("Excluded volume: probe radius"), this);
  ...
  lbl_1dproberadius->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));
  lbl_1dproberadius->setMinimumWidth (
      QFontMetrics (lbl_1dproberadius->font ()).maxWidth () * 21);

  le_1dproberadius = new QLineEdit (this);
  le_1dproberadius->setObjectName ("1dproberadius Line Edit");
  ...
  le_1dproberadius->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  le_1dproberadius->setMinimumHeight (minHeight1);
  le_1dproberadius->setMinimumWidth (150);
  connect (le_1dproberadius, SIGNAL (textChanged (const QString &)),
           SLOT (update_1dproberadius (const QString &)));
  ...
  lbl_1dthreshold->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1,
                                   QFont::Bold));
  lbl_1dthreshold->setMinimumWidth (
      QFontMetrics (lbl_1dthreshold->font ()).maxWidth () * 21);

  le_1dthreshold = new QLineEdit (this);
  le_1dthreshold->setObjectName ("1dthreshold Line Edit");
  ...
  le_1dthreshold->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  le_1dthreshold->setMinimumHeight (minHeight1);
  le_1dthreshold->setMinimumWidth (150);
  connect (le_1dthreshold, SIGNAL (textChanged (const QString &)),
           SLOT (update_1dthreshold (const QString &)));
  ...
  lbl_1dsamplerotations->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1,
                                         QFont::Bold));
  lbl_1dsamplerotations->setMinimumWidth (
      QFontMetrics (lbl_1dsamplerotations->font ()).maxWidth () * 21);

  le_1dsamplerotations = new QLineEdit (this);
  le_1dsamplerotations->setObjectName ("1dsamplerotations Line Edit");
  ...
  le_1dsamplerotations->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  le_1dsamplerotations->setMinimumHeight (minHeight1);
  le_1dsamplerotations->setMinimumWidth (150);
  connect (le_1dsamplerotations, SIGNAL (textChanged (const QString &)),
           SLOT (update_1dsamplerotations (const QString &)));
  ...
  lbl_1daxisrotations->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));
  lbl_1daxisrotations->setMinimumWidth (
      QFontMetrics (lbl_1daxisrotations->font ()).maxWidth () * 21);

  le_1daxisrotations = new QLineEdit (this);
  le_1daxisrotations->setObjectName ("1daxisrotations Line Edit");
  ...
  le_1daxisrotations->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  le_1daxisrotations->setMinimumHeight (minHeight1);
  le_1daxisrotations->setMinimumWidth (150);
  connect (le_1daxisrotations, SIGNAL (textChanged (const QString &)),
           SLOT (update_1daxisrotations (const QString &)));

  lbl_1dintermediatesaves
      = new QLabel (us_tr ("Intermediate saves (comma separated)"), this);
  ...
  lbl_1dintermediatesaves->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 1,
                                           QFont::Bold));
  lbl_1dintermediatesaves->setMinimumWidth (
      QFontMetrics (lbl_1dintermediatesaves->font ()).maxWidth () * 21);

  le_1dintermediatesaves = new QLineEdit (this);
  le_1dintermediatesaves->setObjectName ("1dintermediatesaves Line Edit");
  le_1dintermediatesaves->setText (parameters->count ("1dintermediatesaves")
                                       ? (*parameters)["1dintermediatesaves"]
                                       : "");
  ...
  le_1dintermediatesaves->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  le_1dintermediatesaves->setMinimumHeight (minHeight1);
  le_1dintermediatesaves->setMinimumWidth (150);
  connect (le_1dintermediatesaves, SIGNAL (textChanged (const QString &)),
           SLOT (update_1dintermediatesaves (const QString &)));
...
void
US_Hydrodyn_Cluster_Oned::cancel ()
{
  close ();
}

void
US_Hydrodyn_Cluster_Oned::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster_Oned::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Cluster_Oned::update_1drotationfile (const QString &)
{
  QString use_dir;
  ((US_Hydrodyn *)us_hydrodyn)->select_from_directory_history (use_dir, this);
  QString filename = QFileDialog::getOpenFileName (
      this, us_tr ("Select a file for Rotation file"), use_dir, QString ());
...
void
US_Hydrodyn_Cluster_Oned::update_1drotationsuserand (const QString &)
{
  (*parameters)["1drotationsuserand"] = le_1drotationsuserand->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1dlambda (const QString &)
{
  (*parameters)["1dlambda"] = le_1dlambda->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1ddetectordistance (const QString &)
{
  (*parameters)["1ddetectordistance"] = le_1ddetectordistance->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1ddetectorwidth (const QString &)
{
  (*parameters)["1ddetectorwidth"] = le_1ddetectorwidth->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1ddetectorpixelswidth (const QString &)
{
  (*parameters)["1ddetectorpixelswidth"] = le_1ddetectorpixelswidth->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1drho0 (const QString &)
{
  (*parameters)["1drho0"] = le_1drho0->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1ddeltar (const QString &)
{
  (*parameters)["1ddeltar"] = le_1ddeltar->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1dproberadius (const QString &)
{
  (*parameters)["1dproberadius"] = le_1dproberadius->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1dthreshold (const QString &)
{
  (*parameters)["1dthreshold"] = le_1dthreshold->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1dsamplerotations (const QString &)
{
  (*parameters)["1dsamplerotations"] = le_1dsamplerotations->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1daxisrotations (const QString &)
{
  (*parameters)["1daxisrotations"] = le_1daxisrotations->text ();
}

void
US_Hydrodyn_Cluster_Oned::update_1dintermediatesaves (const QString &)
{
  (*parameters)["1dintermediatesaves"] = le_1dintermediatesaves->text ();
}

void
US_Hydrodyn_Cluster_Oned::save ()
{
  ...
  QString filename = QFileDialog::getSaveFileName (
      this, us_tr ("Save the parameters"), use_dir, "*.cluster_oned");
      ...
      if (!f.open (QIODevice::WriteOnly))
        {
          QMessageBox::information (
              this,
              us_tr (
                  QString ("%1: Save").arg ("US-SOMO: 1d cluster interface")),
...
US_Hydrodyn_Cluster_Oned::load ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)
      ->select_from_directory_history (use_dir, this, true);
  QString filename = QFileDialog::getOpenFileName (
      this, us_tr ("Load parameters"), use_dir, "*.cluster_oned");
      ...
      if (!f.open (QIODevice::ReadOnly))
        {
          QMessageBox::information (
              this,
              us_tr (
                  QString ("%1: Open").arg ("US-SOMO: 1d cluster interface")),
...
void
US_Hydrodyn_Cluster_Oned::update_fields ()
{
  disconnect (le_1drotationfile, SIGNAL (textChanged (const QString &)), 0, 0);
  le_1drotationfile->setText (parameters->count ("1drotationfile")
                                  ? (*parameters)["1drotationfile"]
                                  : "");
  connect (le_1drotationfile, SIGNAL (textChanged (const QString &)),
           SLOT (update_1drotationfile (const QString &)));
  le_1drotationsuserand->setText (parameters->count ("1drotationsuserand")
                                      ...
                                      : "");
  le_1dlambda->setText (
      parameters->count ("1dlambda") ? (*parameters)["1dlambda"] : "");
  le_1ddetectordistance->setText (parameters->count ("1ddetectordistance")
                                      ? (*parameters)["1ddetectordistance"]
                                      : "");
  le_1ddetectorwidth->setText (parameters->count ("1ddetectorwidth")
                                   ? (*parameters)["1ddetectorwidth"]
                                   : "");
  le_1ddetectorpixelswidth->setText (
      parameters->count ("1ddetectorpixelswidth")
          ? (*parameters)["1ddetectorpixelswidth"]
          : "");
  le_1drho0->setText (parameters->count ("1drho0") ? (*parameters)["1drho0"]
                                                   : "");
  le_1ddeltar->setText (
      parameters->count ("1ddeltar") ? (*parameters)["1ddeltar"] : "");
  le_1dproberadius->setText (parameters->count ("1dproberadius")
                                 ? (*parameters)["1dproberadius"]
                                 : "");
  le_1dthreshold->setText (
      parameters->count ("1dthreshold") ? (*parameters)["1dthreshold"] : "");
  le_1dsamplerotations->setText (parameters->count ("1dsamplerotations")
                                     ? (*parameters)["1dsamplerotations"]
                                     : "");
  le_1daxisrotations->setText (parameters->count ("1daxisrotations")
                                   ? (*parameters)["1daxisrotations"]
                                   : "");
  le_1dintermediatesaves->setText (parameters->count ("1dintermediatesaves")
                                       ? (*parameters)["1dintermediatesaves"]
                                       : "");
