...
void
US_Hydrodyn_Mals::invert_all_created ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals::remove_created ()
{
  disable_all ();
  QStringList files;
...
bool
US_Hydrodyn_Mals::all_have_f_gaussians (QStringList &files)
{
...
US_Hydrodyn_Mals::p3d ()
{
...

  {
    ...
    US_Hydrodyn_Mals_P3d *mals_p3d
        = new US_Hydrodyn_Mals_P3d (this, &parameters, this);
...
US_Hydrodyn_Mals::set_detector ()
{
...

  {
    ...
    US_Hydrodyn_Mals_Dctr *mals_dctr
        = new US_Hydrodyn_Mals_Dctr (this, &parameters, this);
...
bool
US_Hydrodyn_Mals::height_wheel_file (double &val, double pos)
{
...
void
US_Hydrodyn_Mals::gauss_match_amplitude ()
{
  if (current_mode != MODE_GAUSSIAN)
    {
      return;
...
bool
US_Hydrodyn_Mals::opt_repeak_gaussians (QString file)
{
  if (!gaussians.size ())
    {
      return false;
...
vector<double>
US_Hydrodyn_Mals::conc_curve (vector<double> &t, unsigned int peak,
                              double conv)
{
...
bool
US_Hydrodyn_Mals::adjacent_ok (QString name)
{
...
void
US_Hydrodyn_Mals::adjacent_created ()
{
  QString match_name;
  int match_pos = 0;
  QStringList turn_on;
...
bool
US_Hydrodyn_Mals::adjacent_select (QListWidget *lb, QString match)
{
  bool ok;
...
QString
US_Hydrodyn_Mals::select_conc_file (QString tag)
{
...
void
US_Hydrodyn_Mals::repeak (QStringList files)
{
...
QStringList
US_Hydrodyn_Mals::get_frames (QStringList files, QString head, QString tail)
{
  QStringList result;
...
void
US_Hydrodyn_Mals::avg (QStringList files, QString suffix)
{
...
void
US_Hydrodyn_Mals::conc_avg (QStringList files)
{
  // create average of selected
  vector<QString> avg_qs_string;
  vector<double> avg_qs;
...
US_Hydrodyn_Mals::select_nth ()
{
  ...
  US_Hydrodyn_Mals_Nth *mals_nth
      = new US_Hydrodyn_Mals_Nth (this, &parameters, this);
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_nth_contains"]
      = parameters.count ("mals_nth_contains")
            ? parameters["mals_nth_contains"]
            : "";
...
void
US_Hydrodyn_Mals::axis_y (bool nochange, bool no_replot)
{
...
void
US_Hydrodyn_Mals::axis_x (bool nochange, bool no_replot)
{
  if (!nochange)
    {
...
US_Hydrodyn_Mals::options ()
{
  ...
  parameters["mals_bl_linear"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_linear"];
  parameters["mals_bl_integral"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_integral"];
  parameters["mals_bl_save"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_save"];
  parameters["mals_bl_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_smooth"];
  parameters["mals_bl_start_region"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_start_region"];
  parameters["mals_bl_i_power"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_i_power"];
  parameters["mals_bl_reps"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_reps"];
  parameters["mals_bl_epsilon"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_epsilon"];
  parameters["mals_cormap_maxq"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cormap_maxq"];
  parameters["mals_cormap_alpha"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cormap_alpha"];
  parameters["mals_zi_window"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_zi_window"];
  parameters["mals_discard_it_sd_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_discard_it_sd_mult"];
  parameters["mals_cb_discard_it_sd_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_discard_it_sd_mult"];
  parameters["mals_guinier_qrgmax"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_guinier_qrgmax"];
  parameters["mals_cb_guinier_qrgmax"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_guinier_qrgmax"];
  parameters["mals_gg_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_gg_smooth"];
  parameters["mals_cb_gg_smooth"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_gg_smooth"];
  parameters["mals_cb_gg_cyclic"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_gg_cyclic"];
  parameters["mals_cb_gg_oldstyle"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_gg_oldstyle"];
  parameters["mals_dist_max"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_dist_max"];
  ...
  parameters["mals_ampl_width_min"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_ampl_width_min"];
  parameters["mals_lock_min_retry"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_lock_min_retry"];
  parameters["mals_lock_min_retry_mult"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_lock_min_retry_mult"];
  parameters["mals_maxfpk_restart"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_maxfpk_restart"];
  parameters["mals_maxfpk_restart_tries"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_maxfpk_restart_tries"];
  parameters["mals_maxfpk_restart_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_maxfpk_restart_pct"];

  parameters["mals_makeiq_cutmax_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_makeiq_cutmax_pct"];
  parameters["mals_cb_makeiq_cutmax_pct"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_makeiq_cutmax_pct"];
  parameters["mals_cb_makeiq_avg_peaks"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cb_makeiq_avg_peaks"];
  parameters["mals_makeiq_avg_peaks"]
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_makeiq_avg_peaks"];
  ...
  mals_options_widget = new US_Hydrodyn_Mals_Options (
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_linear"]
          != parameters["mals_bl_linear"]
      || ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_integral"]
             != parameters["mals_bl_integral"]
      || ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_cormap_maxq"]
  ...
  cb_guinier_qrgmax->setChecked (parameters["mals_cb_guinier_qrgmax"]
                                 == "true");
...
void
US_Hydrodyn_Mals::clear_gaussians ()
{
  unified_ggaussian_ok = false;
  f_gaussians.clear ();
  gaussians.clear ();
...
bool
US_Hydrodyn_Mals::any_gaussians ()
{
...
US_Hydrodyn_Mals::hide_files ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_files_widgets"]
      = files_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Mals::hide_created_files ()
{
  if (U_EXPT)
    {
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_created_files_widgets"]
      = created_files_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Mals::hide_editor ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_editor_widgets"]
      = editor_widgets[0]->isVisible () ? "visible" : "hidden";
}

void
US_Hydrodyn_Mals::svd ()
{
  disable_all ();
  ...
  new US_Hydrodyn_Mals_Svd (this, selected_files);
}

void
US_Hydrodyn_Mals::line_width ()
{
  ...
  ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_line_width"]
...
void
US_Hydrodyn_Mals::movie ()
{
  disable_all ();

  US_Hydrodyn_Mals_Movie *shm = new US_Hydrodyn_Mals_Movie (this);
...
double
US_Hydrodyn_Mals::tot_intensity (QString &file, double q_min, double q_max)
{
...
void
US_Hydrodyn_Mals::set_selected (set<QString> &to_select, bool do_replot)
{
  disable_updates = true;
  lb_files->clearSelection ();
  for (int i = 0; i < (int)lb_files->count (); i++)
...
void
US_Hydrodyn_Mals::set_created_selected (set<QString> &to_select,
                                        bool do_replot)
{
  disable_updates = true;
...
void
US_Hydrodyn_Mals::artificial_gaussians ()
{
...
bool
US_Hydrodyn_Mals::constant_e (QString file, double e)
{
  if (!f_qs.count (file))
    {
      return false;
...
int
US_Hydrodyn_Mals::slice (const vector<double> &q, const vector<double> &I,
                         double start_q, double end_q, vector<double> &new_q,
                         vector<double> &new_I)
{
  new_q.clear ();
  new_I.clear ();
...
double
US_Hydrodyn_Mals::wyatt_errors (QString file, double start_q, double end_q)
{
  if (!f_qs.count (file))
    {
      return -1e0;
...
double
US_Hydrodyn_Mals::wyatt_errors (const vector<double> &q,
...
US_Hydrodyn_Mals::wyatt_errors (const vector<double> &q,
                                ...
                                vector<double> &new_I, vector<double> &new_y)
{
...
bool
US_Hydrodyn_Mals::ask_to_decimate (map<QString, QString> &parameters)
{
  switch (QMessageBox::warning (
      this,
      windowTitle ()
...
bool
US_Hydrodyn_Mals::ask_cormap_minq (map<QString, QString> &parameters)
{
  bool ok;
...
void
US_Hydrodyn_Mals::cormap (map<QString, QString> &parameters)
{
  disable_all ();
  ...
  if (!parameters.count ("alpha"))
    {
      parameters["alpha"] = QString ("%1").arg (
          ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_cormap_alpha")
              ? ((US_Hydrodyn *)us_hydrodyn)
                        ->gparams["mals_cormap_alpha"]
                        .toDouble ()
                    * 5
              : 0.05);
    }
  ...
  double cormap_maxq
      = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_cormap_maxq")
            ? ((US_Hydrodyn *)us_hydrodyn)
                  ->gparams["mals_cormap_maxq"]
                  .toDouble ()
            : 0.05;
...
void
US_Hydrodyn_Mals::bin (QStringList files)
{
  bool ok;
...
bool
US_Hydrodyn_Mals::blanks_params ()
{
...
QStringList
US_Hydrodyn_Mals::vector_qstring_to_qstringlist (vector<QString> vqs)
{
  QStringList qsl;
...
US_Hydrodyn_Mals::simulate ()
{
  ...
  US_Hydrodyn_Mals_Simulate *uhshs
      = new US_Hydrodyn_Mals_Simulate (us_hydrodyn, this, selected, q, I, e);
  uhshs->show ();
}

void
US_Hydrodyn_Mals::gauss_mode ()
{
  map<QString, QString> parameters;
  ...
  parameters["gaussian_type"] = QString ("%1").arg (gaussian_type);
  US_Hydrodyn_Mals_Gauss_Mode *sho = new US_Hydrodyn_Mals_Gauss_Mode (
      &parameters, (US_Hydrodyn *)us_hydrodyn, this);
...
bool
US_Hydrodyn_Mals::mals_load (const QString &filename, const QStringList &qsl,
                             QString &errormsg)
{
  errormsg = "";
  ...
  if (!mals_param_lambda || !mals_param_n)
    {
      errormsg = "Options->MALS parameters must be defined prior to loading "
                 "MALS data";
      return false;
    }

  switch (QMessageBox::question (
      this, windowTitle () + us_tr (" : Load MALS Data"),
...

  {
    QString msg
        = QString ("")
          + "<b>Options->MALS Processing Parameters</b><br><table>" + "<hr>"
          + "<tr>" + "<td>" + us_tr ("Lambda [nm] : ") + "</td>"
          + QString ("<td>%1</td>").arg (mals_param_lambda) + "</tr><tr>"
          + "<td>" + us_tr ("Solvent refractive index : ") + "</td>"
          + QString ("<td>%1</td>").arg (mals_param_n) + "</tr><tr>" + "<td>"
          + us_tr ("Global dn/dc [ml/g] : ") + "</td>"
          + QString ("<td>%1</td>").arg (mals_param_g_dndc) + "</tr><tr>"
          + "<td>" + us_tr ("Global concentration [mg/mL] : ") + "</td>"
          + QString ("<td>%1</td>").arg (mals_param_g_conc) + "</tr>"
          + "</table>" + "<hr>";

    switch (QMessageBox::question (
        this, windowTitle () + us_tr (" : Load MALS Data"),
        msg + QString (us_tr ("Proceed with these parameters?"))))
      {
      case QMessageBox::Yes:
        break;
      default:
...
#define TIME_DELTA_TOLERANCE 0.0000001
  ...
  if (timedelta_inconsistencies)
    {
      QMessageBox::warning (
          this, "US-SOMO MALS load",
          QString (
              us_tr ("%1 inconsistent time interval(s) found in MALS data\n"
  ...
  if (!avg_timedelta_count || !avg_timedelta_sum)
    {
      errormsg
          = "Could not determine a collection interval from the MALS data";
      return false;
    }
  ...
  // adjust_times dialog
  {
    ...
    do
      {
        // US_Vector::printvector( QString( "mals detector %1 times" ).arg(
        // detector_index[0] ), t[detector_index[0]] );

        QDialog dialog (this);
        dialog.setWindowTitle (windowTitle ()
                               + us_tr (": MALS load : Adjust times"));
  ...
  for (auto it = t.begin (); it != t.end (); ++it)
    {
      if (mals_angles.mals_angle.count (it->first)
        ...
        {
          double q = RI * 4 * M_PI
                     * sin (mals_angles.mals_angle[it->first].angle_ri_corr
                            * M_PI / 360)
                     / (wavelength * 10);
          ...
          add_plot (name, t[it->first], I[it->first], sd[it->first], true,
                    false);
          f_ri_corr[last_created_file]
              = mals_angles.mals_angle[it->first].angle_ri_corr;
  ...
  if (data.size ()
          ...
          QRegularExpression ("^\\s*UV absorbance data:")))
    {
      ...
      switch (QMessageBox::question (
          this, windowTitle () + us_tr (" : Load MALS Data"),
          us_tr ("The MALS data file contains UV absorbance data.\nDo you "
                 "wish to load this?")))
        {
        case QMessageBox::Yes:
          load_uv_data = true;
      ...
      //                                          ,mals_angles.list_active().indexOf(
      //                                          QRegularExpression(
      //                                          "^\\s*\\d+\\s+90\\s+.*$" ) )
      //                                          ,false
      //                                          ,&ok
...
bool
US_Hydrodyn_Mals::mals_angles_save ()
{
  QString errormsg = "";
  if (mals_angles.mals_angle.size ())
    {
      ...
      QString use_filename = QFileDialog::getSaveFileName (
          this, us_tr ("Select a file name for saving the MALS Angles"),
          use_dir, "*.csv");
      ...
      if (!mals_angles.save (use_filename, errormsg))
        {
          QMessageBox::warning (
              this, windowTitle (),
              QString (us_tr ("Error saving MALS Angles file %1\n"
                              "Error : %2\n"))
                  .arg (use_filename)
                  .arg (errormsg));
          return false;
...
void
US_Hydrodyn_Mals::conc_info (const QString &msg)
{
  TSO << "============================================================\n"
      << msg << "\n"
      << "------------------------------------------------------------\n";
...
void
US_Hydrodyn_Mals::dndc_info (const QString &msg)
{
  TSO << "============================================================\n"
      << msg << "\n"
      << "------------------------------------------------------------\n";
...
void
US_Hydrodyn_Mals::extc_info (const QString &msg)
{
  TSO << "============================================================\n"
      << msg << "\n"
      << "------------------------------------------------------------\n";
