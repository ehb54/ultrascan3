...
namespace vvv
{
   ...
   **********************************************
   ...
   int get_ExcludeGrid_fromFile (int numatoms, const float probe,
                                 const char file[], gridpt EXCgrid[]) {
   ...
   **********************************************
   ...
   bool compute_vol_surf( const char *xyzr_file,
                          float use_probe,
                          float use_grid,
                          double &volume,
                          double &surf
   ...
   bool setup_vol_surf( const char *xyzr_file,
                        float use_probe,
                        float use_grid,
                        double &volume,
                        double &surf
                        )
   {
      ...
      if (EXCgrid==NULL) { cerr << "GRID IS NULL" << endl; return false; }
