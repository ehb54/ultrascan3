...
void
US_Hydrodyn_Saxs_Hplc::wheel_dec ()
{
...
void
US_Hydrodyn_Saxs_Hplc::wheel_inc ()
{
...
void
US_Hydrodyn_Saxs_Hplc::wheel_enables (bool enable)
{
...
void
US_Hydrodyn_Saxs_Hplc::adjust_wheel (double pos)
{
  ...
  // us_qdebug( QString( "adjust_wheel pos %1 focus %2" ).arg( pos ).arg(
  // (unsigned long)le_last_focus ) );
...
void
US_Hydrodyn_Saxs_Hplc::wheel_cancel (bool from_wheel_save)
{
...
void
US_Hydrodyn_Saxs_Hplc::wheel_save ()
{
  clear_smoothed (); // for now always on cancel or save
  clear_oldstyle (); // for now always on cancel or save
...
void
US_Hydrodyn_Saxs_Hplc::wheel_pressed ()
{
...
void
US_Hydrodyn_Saxs_Hplc::wheel_released ()
{
