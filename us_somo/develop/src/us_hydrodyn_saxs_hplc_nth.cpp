...
void US_Hydrodyn_Saxs_Hplc_Nth::setupGUI() {
  bool started_in_expert_mode =
      ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)->started_in_expert_mode;
  ...
  for (int i = 0;
       i < ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)->lb_files->count();
       ++i) {
      ...
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  {
    QIntValidator *qdv = new QIntValidator(
        1, ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)->lb_files->count(),
        le_n);
  ...
  lbl_start_name = new QLabel(((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
  ...
  {
    QIntValidator *qdv = new QIntValidator(
        2, ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)->lb_files->count(),
        le_end);
  ...
  lbl_end_name = new QLabel(((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
...
void US_Hydrodyn_Saxs_Hplc_Nth::quit() { close(); }
