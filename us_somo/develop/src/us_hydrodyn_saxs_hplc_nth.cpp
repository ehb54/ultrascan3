...
void
US_Hydrodyn_Saxs_Hplc_Nth::setupGUI ()
{
  ...
  for (int i = 0;
       i
       < ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)->lb_files->count ();
       ++i)
    {
      lb_files->addItem (QString ("%1 : %2").arg (i + 1).arg (
          ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
              ->lb_files->item (i)
              ->text ()));
      if (((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
              ->lb_files->item (i)
              ->isSelected ())
        {
  ...
  lbl_start_name
      = new QLabel (((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
  ...
  le_contains->setText (parameters->count ("hplc_nth_contains")
...
void
US_Hydrodyn_Saxs_Hplc_Nth::quit ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Nth::go ()
{
  (*parameters)["go"] = "true";
...
void
US_Hydrodyn_Saxs_Hplc_Nth::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Nth::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Nth::update_enables ()
{
  int fcnt
      = ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)->lb_files->count ();
  ...
  if (ofs >= 1 && ofs <= fcnt)
    {
      lbl_start_name->setText (((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
                                   ->lb_files->item (ofs - 1)
                                   ->text ());
    }
  else
  ...
  if (end >= 1 && end <= fcnt)
    {
      lbl_end_name->setText (((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
                                 ->lb_files->item (end - 1)
                                 ->text ());
    }
  else
  ...
  for (int i = 0; i < lb_files->count (); ++i)
    {
      ...
      {
        QString qs = ((US_Hydrodyn_Saxs_Hplc *)us_hydrodyn_saxs_hplc)
                         ->lb_files->item (i)
                         ->text ();
...
void
US_Hydrodyn_Saxs_Hplc_Nth::nth_only ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Nth::nth_add ()
{
  disconnect (lb_files, SIGNAL (itemSelectionChanged ()), 0, 0);
  int n = le_n->text ().toInt ();
  int ofs = le_start->text ().toInt ();
...
void
US_Hydrodyn_Saxs_Hplc_Nth::contains_only ()
{
  disconnect (lb_files, SIGNAL (itemSelectionChanged ()), 0, 0);
  lb_files->clearSelection ();
  for (int i = 0; i < lb_files->count (); ++i)
...
void
US_Hydrodyn_Saxs_Hplc_Nth::contains_add ()
{
  disconnect (lb_files, SIGNAL (itemSelectionChanged ()), 0, 0);
  for (int i = 0; i < lb_files->count (); ++i)
    {
...
void
US_Hydrodyn_Saxs_Hplc_Nth::pvalues_only ()
{
  disconnect (lb_files, SIGNAL (itemSelectionChanged ()), 0, 0);
  lb_files->clearSelection ();
  for (int i = 0; i < lb_files->count (); ++i)
...
void
US_Hydrodyn_Saxs_Hplc_Nth::pvalues_add ()
{
  disconnect (lb_files, SIGNAL (itemSelectionChanged ()), 0, 0);
  for (int i = 0; i < lb_files->count (); ++i)
    {
...
void
US_Hydrodyn_Saxs_Hplc_Nth::update_files_selected ()
{
  lb_files_sel->clear ();
  for (int i = 0; i < lb_files->count (); ++i)
    {
