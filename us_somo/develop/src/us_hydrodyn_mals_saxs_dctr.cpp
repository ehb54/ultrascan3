...
void
US_Hydrodyn_Mals_Saxs_Dctr::setupGUI ()
{
  int minHeight1 = 30;

  lbl_title = new QLabel (
      us_tr ("US-SOMO: MALS_SAXS : Concentration Detector"), this);
...
void
US_Hydrodyn_Mals_Saxs_Dctr::quit ()
{
  close ();
}

void
US_Hydrodyn_Mals_Saxs_Dctr::save ()
{
...
void
US_Hydrodyn_Mals_Saxs_Dctr::keep ()
{
  (*parameters)["keep"] = "set";
  close ();
}
...
void
US_Hydrodyn_Mals_Saxs_Dctr::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Mals_Saxs_Dctr::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Mals_Saxs_Dctr::set_uv ()
{
...
void
US_Hydrodyn_Mals_Saxs_Dctr::set_ri ()
{
...
void
US_Hydrodyn_Mals_Saxs_Dctr::uv_conv_text (const QString &text)
{
  (*parameters)["uv_conv"] = text;
}

void
US_Hydrodyn_Mals_Saxs_Dctr::ri_conv_text (const QString &text)
{
