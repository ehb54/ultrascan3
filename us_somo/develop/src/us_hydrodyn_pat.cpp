                     ...
                     struct dati1_pat   *out_dt)
{
   ...
   for (i = 0; i < nat; i++)
   {
      ...
      dt[i].x = QString::asprintf( "%f",in_dt[i].x ).toDouble();
      dt[i].y = QString::asprintf( "%f",in_dt[i].y ).toDouble();
      dt[i].z = QString::asprintf( "%f",in_dt[i].z ).toDouble();
      dt[i].r = QString::asprintf( "%f",in_dt[i].r ).toDouble();
      dt[i].m = QString::asprintf( "%f",in_dt[i].m ).toDouble();
