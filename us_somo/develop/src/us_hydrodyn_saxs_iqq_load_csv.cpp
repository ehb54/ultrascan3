...
US_Hydrodyn_Saxs_Iqq_Load_Csv::US_Hydrodyn_Saxs_Iqq_Load_Csv (
    QString msg, QStringList *qsl_names, QStringList *qsl_sel_names,
    QStringList *qsl, QString loaded_filename, bool *create_avg,
    bool *create_std_dev, bool *only_plot_stats, bool *save_to_csv,
    QString *csv_filename, bool *save_original_data, bool *run_nnls,
    bool *nnls_plot_contrib, bool *nnls_csv, bool *run_best_fit, bool *run_ift,
    bool *use_SDs_for_fitting, QString *nnls_target, bool *clear_plot_first,
    bool expert_mode, void *us_hydrodyn, QWidget *p, const char *)
    : QDialog (p)
{
  this->msg = msg;
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::setupGUI ()
{
  int minWidth1 = 600;
  int minHeight1 = 30;
  int minHeight1dl = 40;
  ...
  AUTFBACK (lb_names);
  lb_names->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize + 1, QFont::Bold));
  lb_names->setSelectionMode (QAbstractItemView::MultiSelection);
  lb_names->setEnabled (true);
  connect (lb_names, SIGNAL (itemSelectionChanged ()),
  ...
  cb_create_avg->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cb_create_std_dev->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_create_std_dev->setPalette (PALET_NORMAL);
  AUTFBACK (cb_create_std_dev);
  connect (cb_create_std_dev, SIGNAL (clicked ()), this,
           SLOT (set_create_std_dev ()));
  ...
  cb_only_plot_stats->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  cb_only_plot_stats->setPalette (PALET_NORMAL);
  AUTFBACK (cb_only_plot_stats);
  connect (cb_only_plot_stats, SIGNAL (clicked ()), this,
           SLOT (set_only_plot_stats ()));
  ...
  connect (cb_save_to_csv, SIGNAL (clicked ()), this,
           SLOT (set_save_to_csv ()));
  ...
  connect (le_csv_filename, SIGNAL (textChanged (const QString &)),
           SLOT (update_csv_filename (const QString &)));
  ...
  cb_save_original_data->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_save_original_data->setPalette (PALET_NORMAL);
  AUTFBACK (cb_save_original_data);
  connect (cb_save_original_data, SIGNAL (clicked ()), this,
           SLOT (set_save_original_data ()));
  ...
  if (expert_mode)
    {
      ...
      cb_run_nnls->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
      ...
      cb_nnls_plot_contrib->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
      cb_nnls_plot_contrib->setPalette (PALET_NORMAL);
      AUTFBACK (cb_nnls_plot_contrib);
      connect (cb_nnls_plot_contrib, SIGNAL (clicked ()), this,
               SLOT (set_nnls_plot_contrib ()));
      ...
      cb_nnls_csv->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
      ...
      cb_run_best_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
      cb_run_best_fit->setPalette (PALET_NORMAL);
      AUTFBACK (cb_run_best_fit);
      connect (cb_run_best_fit, SIGNAL (clicked ()), this,
               SLOT (set_run_best_fit ()));
      ...
      cb_use_SDs_for_fitting->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
      cb_use_SDs_for_fitting->setPalette (PALET_NORMAL);
      AUTFBACK (cb_use_SDs_for_fitting);
      connect (cb_use_SDs_for_fitting, SIGNAL (clicked ()), this,
               SLOT (set_use_SDs_for_fitting ()));
      ...
      cb_run_ift->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
      ...
      pb_select_target->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize + 1));
      ...
      lbl_nnls_target->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize + 1,
                                       QFont::Bold));
  ...
  cb_clear_plot_first->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_clear_plot_first->setPalette (PALET_NORMAL);
  AUTFBACK (cb_clear_plot_first);
  connect (cb_clear_plot_first, SIGNAL (clicked ()), this,
           SLOT (set_clear_plot_first ()));
  ...
  pb_transpose->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize + 1));
  ...
  pb_save_as_dat->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize + 1));
  ...
  pb_save_selected->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize + 1));
  ...
  hbl_avg_std->setContentsMargins (0, 0, 0, 0);
  hbl_avg_std->setSpacing (0);
  ...
  if (expert_mode)
    {
      ...
      hbl_nnls_best_fit->setContentsMargins (0, 0, 0, 0);
      hbl_nnls_best_fit->setSpacing (0);
      ...
      hbl_nnls->setContentsMargins (0, 0, 0, 0);
      hbl_nnls->setSpacing (0);
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::select_all ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::ok ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Iqq_Load_Csv::transpose ()
{
  // pick
  QString save_file = loaded_filename;
  save_file.replace (".csv", "_t.csv");
  QString fname = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the transposed csv file"),
      save_file, "*.csv");
              ...
              if ((map_sel_names.count (qsl_tmp[0]) || it == qsl->begin ()))
                {
                  ...
                  // cout << QString("line %1 qsl_tmp.count() %2 size
          ...
          for (unsigned int j = 0; j < array2d_to_save.size (); j++)
            {
              if (array2d_to_save[j].size () <= i
                ...
                {
                  fprintf (of, "%s%s", comma.toLatin1 ().data (),
                           array2d_to_save[j][i].toLatin1 ().data ());
                }
              comma = ",";
            }
          fprintf (of, "\n");
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::save_selected ()
{
  // pick
  QString save_file = loaded_filename;
  save_file.replace (".csv", "_s.csv");
  QString fname = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the new csv file"), save_file,
      "*.csv");
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::cancel ()
{
  qsl_sel_names->clear ();
  close ();
}
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::update_selected ()
{
  qsl_sel_names->clear ();
  for (int i = 0; i < lb_names->count (); i++)
    {
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::update_csv_filename (const QString &str)
{
  *csv_filename = str;
}

void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_create_avg ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_create_std_dev ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_only_plot_stats ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_save_to_csv ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_save_original_data ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_run_nnls ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_nnls_csv ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_nnls_plot_contrib ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_run_ift ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_run_best_fit ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_use_SDs_for_fitting ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::set_clear_plot_first ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::select_target ()
{
...
void
US_Hydrodyn_Saxs_Iqq_Load_Csv::update_enables ()
{
  pb_ok->setText (us_tr (cb_run_ift->isChecked () ? "Run" : "Plot"));

  cb_create_avg->setEnabled (qsl_sel_names->size () > 1);
  cb_create_std_dev->setEnabled (cb_create_avg->isChecked ()
                                 && qsl_sel_names->size () > 2);
  cb_only_plot_stats->setEnabled (cb_create_avg->isChecked ()
                                  && qsl_sel_names->size () > 1);
  cb_save_to_csv->setEnabled (
      (cb_create_avg->isChecked ()
       || (expert_mode
           && (cb_run_nnls->isChecked () || cb_run_best_fit->isChecked ())))
      && qsl_sel_names->size () > 1);
  le_csv_filename->setEnabled (
      (cb_create_avg->isChecked ()
       || (expert_mode
           && (cb_run_nnls->isChecked () || cb_run_best_fit->isChecked ())))
      && cb_save_to_csv->isChecked () && qsl_sel_names->size () > 1);
  cb_save_original_data->setEnabled (cb_create_avg->isChecked ()
                                     && qsl_sel_names->size () > 1);
  if (expert_mode)
    {
  ...
  pb_transpose->setText (
      QString (us_tr ("Transpose") + "%1")
          .arg (qsl_sel_names->size () > 0
                    ? QString (" (%1)").arg (qsl_sel_names->size ())
                    : ""));
  ...
  cb_use_SDs_for_fitting->setEnabled (cb_run_nnls->isChecked ()
                                      || cb_run_best_fit->isChecked ());
  cb_nnls_plot_contrib->setEnabled (cb_run_nnls->isChecked ());
}

void
US_Hydrodyn_Saxs_Iqq_Load_Csv::save_as_dat ()
{
  ...
  /*
     ...
     ), us_tr( "&No, just normally" ), us_tr( "&Yes, compute and save I as
     q*I(q)" ), QString(), 0,
                           1
                           )
     == 1;
  */
  ...
  QString fname = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the DAT file"), save_file,
      "*.dat");
                  ...
                  if (save_qIq && qsl_tmp[0] == sel_name)
                    {
                      ...
                      for (unsigned int i = 2;
                           i < (unsigned int)array2d_to_save[pos].size () - 1;
                           i++)
                        {
                          array2d_to_save[pos][i] = QString ("%1").arg (
                              array2d_to_save[pos][i].toDouble ()
          ...
          for (unsigned int j = 0; j < array2d_to_save.size (); j++)
            {
              if (array2d_to_save[j].size () <= i
                ...
                {
                  fprintf (of, "%s%s", tab.toLatin1 ().data (),
                           QString ("%1")
                               .arg (array2d_to_save[j][i])
                               .replace ("\"", "'")
                               .toLatin1 ()
                               .data ());
                }
