...
void OneLiner::update(const QString &Textstr) { string = Textstr; }
...
US_FitParameter::US_FitParameter(QWidget *parent, const char *)
  ...
  cb_constrained->setGeometry(xpos + (unsigned int)(column5 / 2) - 7, ypos + 5,
                              14, 14);
  ...
  lbl_bounds->setGeometry(xpos + (unsigned int)(column6 / 2) - 7, ypos + 5, 14,
                          14);
...
void US_FitParameter::setUnit(const QString &str) { lbl_unit->setText(str); }
...
void getFooter(QString *footer) {
  ...
  *footer +=
      "Texas Health Science Center at San Antonio</a>.\n<br>UltraScan Home "
      "Page: ";
  *footer +=
      "<a "
      "href=http://www.ultrascan.uthscsa.edu>http://www.ultrascan.uthscsa.edu</"
      "a>\n<p>\n";
...
void view_image(const QString
  ...
  us_imgviewer = new US_ImageViewer(0, "new window",
...
double US_Static::getDouble(const QString &title, const QString &label,
...
int US_Static::getInteger(const QString &title, const QString &label, int value,
...
QString US_Static::getItem(const QString &title, const QString &label,
...
QString US_Static::getText(const QString &title, const QString &label,
                           QLineEdit::EchoMode echo, const QString &text,
                           bool *ok, QWidget *parent, const char *) {
  return QInputDialog::getText(parent, title, label, echo, text, ok);
}

int US_Static::us_message(const QString &title, const QString &text,
