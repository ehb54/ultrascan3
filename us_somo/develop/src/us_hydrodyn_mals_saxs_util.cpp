...
QStringList US_Hydrodyn_Mals_Saxs::get_frames( QStringList files, QString head, QString tail )
{
   QStringList result;
...
void US_Hydrodyn_Mals_Saxs::select_nth()
{
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_nth_contains" ] =
      parameters.count( "mals_saxs_nth_contains" ) ? parameters[ "mals_saxs_nth_contains" ] : "";
...
void US_Hydrodyn_Mals_Saxs::options()
{
   ...
   parameters[ "mals_saxs_bl_linear"             ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_linear"                ];
   parameters[ "mals_saxs_bl_integral"           ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_integral"              ];
   parameters[ "mals_saxs_bl_save"               ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_save"                  ];
   parameters[ "mals_saxs_bl_smooth"             ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_smooth"                ];
   parameters[ "mals_saxs_bl_start_region"       ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_start_region"          ];
   parameters[ "mals_saxs_bl_i_power"            ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_i_power"               ];
   parameters[ "mals_saxs_bl_reps"               ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_reps"                  ];
   parameters[ "mals_saxs_bl_epsilon"            ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_epsilon"               ];
   parameters[ "mals_saxs_cormap_maxq"           ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_maxq"              ];
   parameters[ "mals_saxs_cormap_alpha"          ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_alpha"             ];
   parameters[ "mals_saxs_zi_window"             ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_zi_window"                ];
   parameters[ "mals_saxs_discard_it_sd_mult"    ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_discard_it_sd_mult"       ];
   parameters[ "mals_saxs_cb_discard_it_sd_mult" ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_discard_it_sd_mult"    ];
   parameters[ "mals_saxs_guinier_qrgmax"        ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_guinier_qrgmax"           ];
   parameters[ "mals_saxs_cb_guinier_qrgmax"     ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_guinier_qrgmax"        ];
   parameters[ "mals_saxs_gg_smooth"             ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_gg_smooth"                ];
   parameters[ "mals_saxs_cb_gg_smooth"          ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_gg_smooth"             ];
   parameters[ "mals_saxs_cb_gg_cyclic"          ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_gg_cyclic"             ];
   parameters[ "mals_saxs_cb_gg_oldstyle"        ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_gg_oldstyle"           ];
   parameters[ "mals_saxs_dist_max"              ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_dist_max"                 ];
   ...
   parameters[ "mals_saxs_csv_transposed"        ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_csv_transposed" ];

   parameters[ "mals_saxs_ampl_width_min"        ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_ampl_width_min"           ];
   parameters[ "mals_saxs_ampl_min"              ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_ampl_min"                 ];
   parameters[ "mals_saxs_lock_min_retry"        ] =( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_lock_min_retry"           ];
   parameters[ "mals_saxs_lock_min_retry_mult"   ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_lock_min_retry_mult"      ];
   parameters[ "mals_saxs_maxfpk_restart"        ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_maxfpk_restart"           ];
   parameters[ "mals_saxs_maxfpk_restart_tries"  ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_maxfpk_restart_tries"     ];
   parameters[ "mals_saxs_maxfpk_restart_pct"    ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_maxfpk_restart_pct"       ];

   parameters[ "mals_saxs_makeiq_cutmax_pct"     ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_makeiq_cutmax_pct"        ];
   parameters[ "mals_saxs_cb_makeiq_cutmax_pct"  ] = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_makeiq_cutmax_pct"     ];
   ...
   parameters[ "mals_saxs_csv_transposed" ] = 
      ...
      (( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_csv_transposed" ] : "false";
   
   parameters[ "gaussian_type" ] = QString( "%1" ).arg( gaussian_type );
   mals_saxs_options_widget = 
      new US_Hydrodyn_Mals_Saxs_Options( & parameters, (US_Hydrodyn *) us_hydrodyn, this );
   US_Hydrodyn::fixWinButtons( (US_Hydrodyn_Mals_Saxs_Options*) mals_saxs_options_widget );
   ...
   if (
       ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_linear"    ] != parameters[ "mals_saxs_bl_linear"    ] ||
       ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_integral"  ] != parameters[ "mals_saxs_bl_integral"  ] ||
       ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_maxq"  ] != parameters[ "mals_saxs_cormap_maxq"  ] ||
       ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_alpha" ] != parameters[ "mals_saxs_cormap_alpha" ] 
       ) {
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_linear"             ] = parameters[ "mals_saxs_bl_linear"                ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_integral"           ] = parameters[ "mals_saxs_bl_integral"              ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_save"               ] = parameters[ "mals_saxs_bl_save"                  ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_smooth"             ] = parameters[ "mals_saxs_bl_smooth"                ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_start_region"       ] = parameters[ "mals_saxs_bl_start_region"          ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_i_power"            ] = parameters[ "mals_saxs_bl_i_power"               ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_reps"               ] = parameters[ "mals_saxs_bl_reps"                  ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_bl_epsilon"            ] = parameters[ "mals_saxs_bl_epsilon"               ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_maxq"           ] = parameters[ "mals_saxs_cormap_maxq"              ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_alpha"          ] = parameters[ "mals_saxs_cormap_alpha"             ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_zi_window"             ] = parameters[ "mals_saxs_zi_window"                ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_discard_it_sd_mult"    ] = parameters[ "mals_saxs_discard_it_sd_mult"       ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_discard_it_sd_mult" ] = parameters[ "mals_saxs_cb_discard_it_sd_mult"    ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_guinier_qrgmax"        ] = parameters[ "mals_saxs_guinier_qrgmax"           ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_guinier_qrgmax"     ] = parameters[ "mals_saxs_cb_guinier_qrgmax"        ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_gg_smooth"             ] = parameters[ "mals_saxs_gg_smooth"                ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_gg_smooth"          ] = parameters[ "mals_saxs_cb_gg_smooth"             ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_gg_cyclic"          ] = parameters[ "mals_saxs_cb_gg_cyclic"             ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cb_gg_oldstyle"        ] = parameters[ "mals_saxs_cb_gg_oldstyle"           ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_dist_max"              ] = parameters[ "mals_saxs_dist_max"                 ];
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_csv_transposed"        ] = parameters[ "mals_saxs_csv_transposed"           ];

   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_ampl_width_min"        ] = parameters[ "mals_saxs_ampl_width_min"           ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_ampl_min"              ] = parameters[ "mals_saxs_ampl_min"                 ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_lock_min_retry"        ] =parameters[ "mals_saxs_lock_min_retry"           ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_lock_min_retry_mult"   ] = parameters[ "mals_saxs_lock_min_retry_mult"      ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_maxfpk_restart"        ] = parameters[ "mals_saxs_maxfpk_restart"           ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_maxfpk_restart_tries"  ] = parameters[ "mals_saxs_maxfpk_restart_tries"     ];
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_maxfpk_restart_pct"    ] = parameters[ "mals_saxs_maxfpk_restart_pct"       ];

   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_makeiq_cutmax_pct"     ] = parameters[ "mals_saxs_makeiq_cutmax_pct"        ];
   ...
   pb_save_created_csv->setText( (( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_csv_transposed" ] == "true" ?
...
void US_Hydrodyn_Mals_Saxs::hide_files()
{
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_files_widgets" ]         = files_widgets        [ 0 ]->isVisible() ? "visible" : "hidden";
}
...
void US_Hydrodyn_Mals_Saxs::hide_created_files()
{
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_created_files_widgets" ] = created_files_widgets[ 0 ]->isVisible() ? "visible" : "hidden";
}
...
void US_Hydrodyn_Mals_Saxs::hide_editor()
{
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_editor_widgets" ] = editor_widgets[ 0 ]->isVisible() ? "visible" : "hidden";
}
...
void US_Hydrodyn_Mals_Saxs::line_width()
{
   ...
   ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_line_width" ] = QString( "%1" ).arg( use_line_width );
...
void US_Hydrodyn_Mals_Saxs::movie()
{
   ...
   US_Hydrodyn_Mals_Saxs_Movie *shm = 
      new US_Hydrodyn_Mals_Saxs_Movie( this );
...
double US_Hydrodyn_Mals_Saxs::tot_intensity( QString &file, double q_min, double q_max )
{
...
double US_Hydrodyn_Mals_Saxs::wyatt_errors( QString file, 
                                            double start_q, 
                                            double end_q )
{
   if ( !f_qs.count( file ) )
                                            ...
                                            )
{
   ...
   // compute SVD of M (see: us_hydrodyn_mals_saxs_svd.cpp and us_svd.cpp for usage)
...
void US_Hydrodyn_Mals_Saxs::cormap( map < QString, QString > & parameters )
{
   ...
   if ( !parameters.count( "alpha" ) ) {
      parameters[ "alpha" ] = 
         QString( "%1" )
         .arg( ( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count( "mals_saxs_cormap_alpha" ) ?
               ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_saxs_cormap_alpha" ].toDouble() * 5 : 0.05 );
   }
...
QStringList US_Hydrodyn_Mals_Saxs::vector_qstring_to_qstringlist( vector < QString > vqs ) {
   QStringList qsl;
...
void US_Hydrodyn_Mals_Saxs::gauss_mode()
{
   ...
   US_Hydrodyn_Mals_Saxs_Gauss_Mode *sho = 
      new US_Hydrodyn_Mals_Saxs_Gauss_Mode( & parameters, (US_Hydrodyn *) us_hydrodyn, this );
...
bool US_Hydrodyn_Mals_Saxs::mals_saxs_load( const QString & filename, const QStringList & qsl, QString & errormsg ) {
   errormsg = "";
   ...
   if ( !mals_saxs_angles.mals_saxs_angle.size() ) {
      errormsg = "No MALS_SAXS Angles have been defined.\nLoad them prior to loading MALS_SAXS data";
      return false;
   }

   if ( !mals_saxs_param_lambda || !mals_saxs_param_n ) {
      errormsg = "Options->MALS_SAXS parameters must be defined prior to loading MALS_SAXS data";
      return false;
   }

   switch ( QMessageBox::question(this, 
                                  windowTitle() + us_tr( " : Load MALS_SAXS Data" )
...
#define TIME_DELTA_TOLERANCE  0.0000001 
   ...
   if ( !avg_timedelta_count || !avg_timedelta_sum ) {
      errormsg = "Could not determine a collection interval from the MALS_SAXS data";
      return false;
   }
   ...
   // adjust_times dialog
   {
      ...
      do {
         // US_Vector::printvector( QString( "mals_saxs detector %1 times" ).arg( detector_index[0] ), t[detector_index[0]] );

         QDialog dialog(this);
         dialog.setWindowTitle( windowTitle() + us_tr( ": MALS_SAXS load : Adjust times" ) );
   ...
   for ( auto it = t.begin();
      ...
      if ( mals_saxs_angles.mals_saxs_angle.count( it->first ) &&
         ...
         double q = RI * 4 * M_PI * sin( mals_saxs_angles.mals_saxs_angle[ it->first ].angle_ri_corr * M_PI / 360 ) / ( wavelength * 10 );
   ...
   if ( data.size() && data.front().contains( QRegularExpression( "^\\s*UV absorbance data:" ) ) ) {
      ...
      switch ( QMessageBox::question(this, 
                                     windowTitle() + us_tr( " : Load MALS_SAXS Data" )
                                     ,us_tr( 
                                            "The MALS_SAXS data file contains UV absorbance data.\nDo you wish to load this?"
                                             )
                                     ) )
      {
      case QMessageBox::Yes : 
      ...
      //                                          ,mals_saxs_angles.list_active().indexOf( QRegularExpression( "^\\s*\\d+\\s+90\\s+.*$" ) )
      //                                          ,false
      //                                          ,&ok
      //                                          );
      //    if ( ok ) {
   ...
   if ( mals_saxs_angles.mals_saxs_angle.size() ) {
      ...
      if ( !mals_saxs_angles.save( use_filename, errormsg ) ) {
         QMessageBox::warning( this, 
                               ...
                               QString(
                                       us_tr(
                                             "Error saving MALS_SAXS Angles file %1\n"
                                             "Error : %2\n"
                                             )
                                       )
                               .arg( use_filename )
...
vector < double > US_Hydrodyn_Mals_Saxs::get_time_grid_from_namelist( const QStringList & files ) {
   vector < double > result;
...
void US_Hydrodyn_Mals_Saxs::common_time() {
   ...
   double end_time_max =
      time_grids[0].back() < time_grids[1].back()
      ? time_grids[0].back()
      : time_grids[1].back()
      ;
   ...
   
   {
      QString msg =
         QString( us_tr(
                        "Set one has %1 files begining with\n%2\nand covers times [%3:%4] and q values [%5:%6]"
                        "\n\nSet two has %7 files begining with\n%8\nand covers times [%9:%10] and q values [%11:%12]"
