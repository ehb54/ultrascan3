...
void
US_Hydrodyn_Cluster_Bfnb_Nsa::setupGUI ()
{
  int minHeight1 = 30;
  ...
  lbl_nsaspheres = new QLabel (
      us_tr ("Maximum number of spheres (count, optionally start end) "),
      this);
  ...
  le_nsaspheres->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  lbl_nsaess->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_nsaess->setMinimumWidth (QFontMetrics (lbl_nsaess->font ()).maxWidth ()
                               * 13);
  ...
  AUTFBACK (le_nsaess);
  le_nsaess->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_nsaexcl);
  le_nsaexcl->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  lbl_nsaga->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1, QFont::Bold));
  lbl_nsaga->setMinimumWidth (QFontMetrics (lbl_nsaga->font ()).maxWidth ()
                              * 13);
  ...
  AUTFBACK (le_nsaga);
  le_nsaga->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  lbl_nsasga->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_nsasga->setMinimumWidth (QFontMetrics (lbl_nsasga->font ()).maxWidth ()
                               * 13);
  ...
  AUTFBACK (le_nsasga);
  le_nsasga->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  le_nsaiterations->setText (parameters->count ("nsaiterations")
                                 ? (*parameters)["nsaiterations"]
                                 : "");
  ...
  le_nsaiterations->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  le_nsaepsilon->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  lbl_nsagsm->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_nsagsm->setMinimumWidth (QFontMetrics (lbl_nsagsm->font ()).maxWidth ()
                               * 13);
  ...
  AUTFBACK (le_nsagsm);
  le_nsagsm->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  le_nsagenerations->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  le_nsapopulation->setText (parameters->count ("nsapopulation")
                                 ? (*parameters)["nsapopulation"]
                                 : "");
  ...
  le_nsapopulation->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  le_nsaelitism->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  le_nsamutate->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  le_nsacrossover->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  le_nsaearlytermination->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  lbl_sgpdistancequantum
      = new QLabel (us_tr ("Spheres: Distance quantum"), this);
  ...
  le_sgpdistancequantum->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  le_sgpdistancemin->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  le_sgpdistancemax->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  le_sgpradiusmin->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  le_sgpradiusmax->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Cluster_Bfnb_Nsa::cancel ()
{
  close ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster_Bfnb_Nsa::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaspheres (const QString &)
{
  (*parameters)["nsaspheres"] = le_nsaspheres->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaess (const QString &)
{
  (*parameters)["nsaess"] = le_nsaess->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaexcl (const QString &)
{
  (*parameters)["nsaexcl"] = le_nsaexcl->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaga (const QString &)
{
  (*parameters)["nsaga"] = le_nsaga->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsasga (const QString &)
{
  (*parameters)["nsasga"] = le_nsasga->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaiterations (const QString &)
{
  (*parameters)["nsaiterations"] = le_nsaiterations->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaepsilon (const QString &)
{
  (*parameters)["nsaepsilon"] = le_nsaepsilon->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsagsm (const QString &)
{
  (*parameters)["nsagsm"] = le_nsagsm->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsascale (const QString &)
{
  (*parameters)["nsascale"] = le_nsascale->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsagenerations (const QString &)
{
  (*parameters)["nsagenerations"] = le_nsagenerations->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsapopulation (const QString &)
{
  (*parameters)["nsapopulation"] = le_nsapopulation->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaelitism (const QString &)
{
  (*parameters)["nsaelitism"] = le_nsaelitism->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsamutate (const QString &)
{
  (*parameters)["nsamutate"] = le_nsamutate->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsacrossover (const QString &)
{
  (*parameters)["nsacrossover"] = le_nsacrossover->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_nsaearlytermination (const QString &)
{
  (*parameters)["nsaearlytermination"] = le_nsaearlytermination->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_sgpdistancequantum (const QString &)
{
  (*parameters)["sgpdistancequantum"] = le_sgpdistancequantum->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_sgpdistancemin (const QString &)
{
  (*parameters)["sgpdistancemin"] = le_sgpdistancemin->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_sgpdistancemax (const QString &)
{
  (*parameters)["sgpdistancemax"] = le_sgpdistancemax->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_sgpradiusmin (const QString &)
{
  (*parameters)["sgpradiusmin"] = le_sgpradiusmin->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_sgpradiusmax (const QString &)
{
  (*parameters)["sgpradiusmax"] = le_sgpradiusmax->text ();
}

void
US_Hydrodyn_Cluster_Bfnb_Nsa::save ()
{
      ...
      if (!f.open (QIODevice::WriteOnly))
        {
          QMessageBox::information (
              ...
              us_tr (QString ("%1: Save")
                         .arg ("US-SOMO: BNFB/NSA cluster interface")),
...
void
US_Hydrodyn_Cluster_Bfnb_Nsa::load ()
{
  QString use_dir = ((US_Hydrodyn *)us_hydrodyn)->somo_dir + QDir::separator ()
                    + "cluster" + QDir::separator () + "parameters";
  ((US_Hydrodyn *)us_hydrodyn)
...
void
US_Hydrodyn_Cluster_Bfnb_Nsa::update_fields ()
{
  le_nsaspheres->setText (
      parameters->count ("nsaspheres") ? (*parameters)["nsaspheres"] : "");
  le_nsaess->setText (parameters->count ("nsaess") ? (*parameters)["nsaess"]
