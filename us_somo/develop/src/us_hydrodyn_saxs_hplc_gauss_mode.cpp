...
void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::setupGUI ()
{
  int minHeight1 = 30;
...
void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::quit ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::ok ()
{
  (*parameters)["ok"] = "true";
...
void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::update_enables ()
{
}

void
US_Hydrodyn_Saxs_Hplc_Gauss_Mode::clear_gauss ()
{
  if (QMessageBox::Yes
