...
void US_Hydrodyn_Mals_Saxs_Ciq::quit()
{
   close();
}
...
void US_Hydrodyn_Mals_Saxs_Ciq::set_sd_source()
{
   update_enables();
}

void US_Hydrodyn_Mals_Saxs_Ciq::set_normalize()
{
   update_enables();
}

void US_Hydrodyn_Mals_Saxs_Ciq::set_I0se()
{
   update_enables();
}
