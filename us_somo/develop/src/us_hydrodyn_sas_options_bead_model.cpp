...
void
US_Hydrodyn_SasOptionsBeadModel::setupGUI ()
{
  ...
  cb_compute_saxs_coeff_for_bead_models->setFont (QFont (
  ...
  cb_compute_sans_coeff_for_bead_models->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_bead_model_rayleigh->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  if (started_in_expert_mode)
    {
      ...
      connect (le_bead_models_var_len_sf_max,
               SIGNAL (textChanged (const QString &)), this,
               SLOT (update_bead_models_var_len_sf_max (const QString &)));
      ...
      le_dummy_saxs_name->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
      connect (le_dummy_saxs_name, SIGNAL (textChanged (const QString &)),
               this, SLOT (update_dummy_saxs_name (const QString &)));
    }
  ...
  cb_dummy_atom_pdbs_in_nm->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  ...
  if (started_in_expert_mode)
    {
      ...
      background->addWidget (cb_bead_models_rho0_in_scat_factors, j, 0,
                             1 + (j) - (j), 1 + (1) - (0));
      j++;
      background->addWidget (cb_iq_global_avg_for_bead_models, j, 0,
                             1 + (j) - (j), 1 + (1) - (0));
      j++;
      background->addWidget (cb_bead_models_use_quick_fitting, j, 0,
                             1 + (j) - (j), 1 + (1) - (0));
      j++;
      background->addWidget (cb_bead_models_use_gsm_fitting, j, 0,
                             1 + (j) - (j), 1 + (1) - (0));
      j++;
      background->addWidget (cb_apply_loaded_sf_repeatedly_to_pdb, j, 0,
                             1 + (j) - (j), 1 + (1) - (0));
      j++;
      background->addWidget (cb_bead_models_use_var_len_sf, j, 0,
                             1 + (j) - (j), 1 + (1) - (0));
      j++;
...
void
US_Hydrodyn_SasOptionsBeadModel::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsBeadModel::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsBeadModel::closeEvent (QCloseEvent *e)
{
  *sas_options_bead_model_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsBeadModel::set_compute_saxs_coeff_for_bead_models ()
{
  (*saxs_options).compute_saxs_coeff_for_bead_models
...
void
US_Hydrodyn_SasOptionsBeadModel::set_compute_sans_coeff_for_bead_models ()
{
  (*saxs_options).compute_sans_coeff_for_bead_models
...
void
US_Hydrodyn_SasOptionsBeadModel::set_bead_model_rayleigh ()
{
...
void
US_Hydrodyn_SasOptionsBeadModel::set_bead_models_use_bead_radius_ev ()
{
  (*saxs_options).bead_models_use_bead_radius_ev
...
void
US_Hydrodyn_SasOptionsBeadModel::set_bead_models_rho0_in_scat_factors ()
{
  (*saxs_options).bead_models_rho0_in_scat_factors
...
void
US_Hydrodyn_SasOptionsBeadModel::set_iq_global_avg_for_bead_models ()
{
  (*saxs_options).iq_global_avg_for_bead_models
...
void
US_Hydrodyn_SasOptionsBeadModel::set_bead_models_use_quick_fitting ()
{
  (*saxs_options).bead_models_use_quick_fitting
...
void
US_Hydrodyn_SasOptionsBeadModel::set_bead_models_use_gsm_fitting ()
{
  (*saxs_options).bead_models_use_gsm_fitting
...
void
US_Hydrodyn_SasOptionsBeadModel::set_apply_loaded_sf_repeatedly_to_pdb ()
{
  (*saxs_options).apply_loaded_sf_repeatedly_to_pdb
...
void
US_Hydrodyn_SasOptionsBeadModel::set_bead_models_use_var_len_sf ()
{
  (*saxs_options).bead_models_use_var_len_sf
...
void
US_Hydrodyn_SasOptionsBeadModel::update_bead_models_var_len_sf_max (
    const QString &qs)
{
...
void
US_Hydrodyn_SasOptionsBeadModel::update_dummy_saxs_name (const QString &)
{
  bool ok = false;
  QString qs;
  ...
  disconnect (le_dummy_saxs_name, SIGNAL (textChanged (const QString &)), 0,
              0);
  le_dummy_saxs_name->setText ((*saxs_options).dummy_saxs_name);
...
void
US_Hydrodyn_SasOptionsBeadModel::set_dummy_atom_pdbs_in_nm ()
{
  (*saxs_options).dummy_atom_pdbs_in_nm
      = cb_dummy_atom_pdbs_in_nm->isChecked ();
  //   ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}
