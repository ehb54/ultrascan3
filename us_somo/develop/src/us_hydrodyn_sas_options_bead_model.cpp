...
US_Hydrodyn_SasOptionsBeadModel::US_Hydrodyn_SasOptionsBeadModel(struct saxs_options *saxs_options, bool *sas_options_bead_model_widget, void *us_hydrodyn, QWidget *p, const char *) : QFrame( p )
{
