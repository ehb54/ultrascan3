...
void
US_Hydrodyn_Dad::guinier_scroll_highlight (int pos)
{
...
void
US_Hydrodyn_Dad::guinier_scroll ()
{
...
void
US_Hydrodyn_Dad::guinier_add_marker (QwtPlot *plot, double pos, QColor color,
...
void
US_Hydrodyn_Dad::guinier_plot_rg_toggle ()
{
...
void
US_Hydrodyn_Dad::guinier_plot_mw_toggle ()
{
...
void
US_Hydrodyn_Dad::guinier_residuals (bool reset)
{
  if (reset)
    {
...
void
US_Hydrodyn_Dad::guinier_residuals_update ()
{
  if (rb_guinier_resid_diff->isChecked ())
    {
...
void
US_Hydrodyn_Dad::guinier_analysis ()
{
      ...
      do
        {
          ...
          usu->wave["dad"].q.clear ();
          usu->wave["dad"].r.clear ();
          usu->wave["dad"].s.clear ();
          ...
          for (int j = 0; j < (int)guinier_q[this_name].size (); j++)
            {
              if (guinier_q[this_name][j] >= qstart
                  && guinier_q[this_name][j] <= qend)
                {
                  usu->wave["dad"].q.push_back (guinier_q[this_name][j]);
                  usu->wave["dad"].r.push_back (guinier_I[this_name][j]);
                  if (use_SD_weighting)
                    {
                      usu->wave["dad"].s.push_back (guinier_e[this_name][j]);
                    }
                }
            }
          ...
          if (pts_decrease)
            {
              if ((int)usu->wave["dad"].q.size () - (int)pts_decrease < 5)
                {
                  if (!cb_guinier_scroll->isChecked ()
              ...
              usu->wave["dad"].q.resize (usu->wave["dad"].q.size ()
                                         - pts_decrease);
              usu->wave["dad"].r.resize (usu->wave["dad"].q.size ());
              if (use_SD_weighting)
                {
                  usu->wave["dad"].s.resize (usu->wave["dad"].q.size ());
                }
            }

          unsigned int pstart = 0;
          unsigned int pend = usu->wave["dad"].q.size ()
                                  ? usu->wave["dad"].q.size () - 1
                                  : 0;

          computed_rg
              = usu->guinier_plot ("dadrg", "dad")
                && usu->guinier_fit (this_log, "dadrg", pstart, pend, a, b,
      ...
      if (computed_rg)
        {
          ...
          if (!us_isnan (Rg))
            {
              ...
              if (!count)
              ...
              else
                {
                  ...
                  if (us_isnan (siga)
                      || (unsigned int)usu->wave["dad"].q.size () < 3)
                    {
                      if (rg_sd_min > Rg)
                        {
                          rg_sd_min = Rg;
          ...
          QString report = QString ("%1:%2 ").arg (pos).arg (this_name)
                           + QString ("").sprintf (
                               "Rg %.1f (%.1f) (A) MW %.2e (%.2e) qRg "
                               "[%.3f,%.3f] pts %u chi^2 %.2e r-chi %.2e\n",
                               Rg, sigb, I0, siga, sRgmin, sRgmax,
                               (unsigned int)usu->wave["dad"].q.size (), chi2,
                               sqrt (chi2 / usu->wave["dad"].q.size ()))
...
void
US_Hydrodyn_Dad::guinier_delete_markers ()
{
...
void
US_Hydrodyn_Dad::guinier_range (double minq2, double maxq2, double minI,
                                double maxI)
{
...
void
US_Hydrodyn_Dad::guinier_replot ()
{
...
void
US_Hydrodyn_Dad::guinier_enables ()
{
...
bool
US_Hydrodyn_Dad::guinier_check_qmax (bool show_message)
{
  QString report;
...
void
US_Hydrodyn_Dad::check_mwt_constants (bool force)
{
...
bool
US_Hydrodyn_Dad::guinier_check_qmax (QString &report, bool show_message)
{
  report = "";
...
void
US_Hydrodyn_Dad::guinier_qrgmax ()
{
  disable_all ();
  qApp->processEvents ();
  guinier_analysis ();
...
void
US_Hydrodyn_Dad::guinier_qrgmax_text (const QString &)
{
...
void
US_Hydrodyn_Dad::guinier_q_start_text (const QString &text)
{
...
void
US_Hydrodyn_Dad::guinier_q_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_q_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_q_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_q2_start_text (const QString &text)
{
...
void
US_Hydrodyn_Dad::guinier_q2_end_text (const QString &text)
{
...
void
US_Hydrodyn_Dad::guinier_q2_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_q2_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_delta_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_delta_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_delta_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_delta_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_t_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_t_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_t_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_t_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_rg_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_rg_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_rg_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_rg_rg_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_t_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_t_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_t_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_t_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_mw_start_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_mw_end_text (const QString &text)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_mw_start_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
...
void
US_Hydrodyn_Dad::guinier_mw_mw_end_focus (bool hasFocus)
{
  if (current_mode != MODE_GUINIER)
    {
      return;
