...
QPixmap
US3i_Images::getImage (const QString &bname)
{
...
QPixmap
US3i_Images::getImage (int itype)
{
...
QIcon
US3i_Images::getIcon (const QString &bname)
{
...
const QString
US3i_Images::image_name (int itype)
{
  struct nameMap
  {
    ImagesType itype;
...
const QString
US3i_Images::expanded_name (const QString &bname)
{
  QString iname = bname;
