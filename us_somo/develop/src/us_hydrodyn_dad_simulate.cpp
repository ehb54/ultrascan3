...
void US_Hydrodyn_Dad_Simulate::setupGUI() {
  if (files.size() > 5) {
    QMessageBox::warning(
        this, windowTitle(),
        us_tr(
...
void US_Hydrodyn_Dad_Simulate::cancel() { close(); }

void US_Hydrodyn_Dad_Simulate::help() {
  US_Help *online_help;
  online_help = new US_Help(this);
  online_help->show_help("manual/somo/simulate.html");
}

void US_Hydrodyn_Dad_Simulate::closeEvent(QCloseEvent *e) {
  QMessageBox mb(
      this->windowTitle(),
...
void US_Hydrodyn_Dad_Simulate::displayData() { update_enables(); }

void US_Hydrodyn_Dad_Simulate::update_enables() {
...
void US_Hydrodyn_Dad_Simulate::simulate() {
