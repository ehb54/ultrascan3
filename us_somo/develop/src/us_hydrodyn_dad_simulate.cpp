...
US_Hydrodyn_Dad_Simulate::US_Hydrodyn_Dad_Simulate (
    void *us_hydrodyn, void *dad_win, QStringList files,
...
void
US_Hydrodyn_Dad_Simulate::setupGUI ()
{
  if (files.size () > 5)
    {
...
void
US_Hydrodyn_Dad_Simulate::cancel ()
{
  close ();
}

void
US_Hydrodyn_Dad_Simulate::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Dad_Simulate::closeEvent (QCloseEvent *e)
{
  QMessageBox mb (
      this->windowTitle (),
...
void
US_Hydrodyn_Dad_Simulate::displayData ()
{
  update_enables ();
}

void
US_Hydrodyn_Dad_Simulate::update_enables ()
{
...
#define HW ((US_Hydrodyn_Dad *)dad_win)
...
void
US_Hydrodyn_Dad_Simulate::simulate ()
{
  ...
  // make a bunch of I(t)'s first... then convert to I(q) for output to dad
