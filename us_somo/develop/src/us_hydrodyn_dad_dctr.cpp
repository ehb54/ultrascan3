...
void US_Hydrodyn_Dad_Dctr::setupGUI() {
  int minHeight1 = 30;
...
void US_Hydrodyn_Dad_Dctr::quit() { close(); }

void US_Hydrodyn_Dad_Dctr::save() {
...
void US_Hydrodyn_Dad_Dctr::keep() {
  (*parameters)["keep"] = "set";
  close();
}

void US_Hydrodyn_Dad_Dctr::help() {
  US_Help *online_help;
...
void US_Hydrodyn_Dad_Dctr::set_uv() {
...
void US_Hydrodyn_Dad_Dctr::set_ri() {
...
void US_Hydrodyn_Dad_Dctr::uv_conv_text(const QString &text) {
  (*parameters)["uv_conv"] = text;
}

void US_Hydrodyn_Dad_Dctr::ri_conv_text(const QString &text) {
