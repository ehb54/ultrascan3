...
#include "../include/us_hydrodyn_mals_baseline_best.h"
// Added by qt3to4:
#include <QPixmap>
...
void
US_Hydrodyn_Mals::blanks_enables ()
{
...
// --- baseline ---
void
US_Hydrodyn_Mals::baseline_start (bool from_blanks_mode_save)
{
  if (axis_y_log)
    {
      axis_y ();
  ...
  {
    bool use_i_power
        = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_bl_i_power")
          && ((US_Hydrodyn *)us_hydrodyn)
                     ->gparams["mals_bl_i_power"]
                     .toDouble ()
                 != 1e0;
  ...
  {
    int reps = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_reps"].toInt ();
    if (reps < 5)
      {
        switch (QMessageBox::warning (
            this, windowTitle () + us_tr (" : Baseline"),
...
void
US_Hydrodyn_Mals::baseline_enables ()
{
...
void
US_Hydrodyn_Mals::set_baseline_start_zero ()
{
  if (!cb_baseline_start_zero->isChecked ())
    {
      // QMessageBox::warning(
...
void
US_Hydrodyn_Mals::baseline_init_markers ()
{
...
void
US_Hydrodyn_Mals::replot_baseline_integral ()
{
...
void
US_Hydrodyn_Mals::replot_baseline (QString /* qs */)
{
...
void
US_Hydrodyn_Mals::baseline_apply ()
{
  int smoothing = 0;
  bool integral
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_integral"] == "true";
  if (integral)
    {
      smoothing
          = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_smooth"].toInt ();
    }
  // bool save_bl = ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "mals_bl_save"
  // ] == "true";
  bool save_bl = false;
  unsigned int reps = 0;
  if (integral)
    {
      reps = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_reps"].toInt ();
    }
...
void
US_Hydrodyn_Mals::baseline_apply (QStringList files, bool integral,
                                  int smoothing, bool save_bl,
                                  unsigned int reps, bool do_replot,
                                  bool quiet)
{
  ...
  bool test_alt_integral_bl
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_save"] == "true";
  ...
  bool use_start_region
      = false
        && ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_bl_start_region")
        && ((US_Hydrodyn *)us_hydrodyn)
                   ->gparams["mals_bl_start_region"]
                   .toInt ()
               > 0;

  bool use_i_power
      = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_bl_i_power")
        && ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_i_power"].toDouble ()
               != 1e0
      ...
      if (integral)
        {
          ...
          double alpha_epsilon
              = ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_bl_epsilon")
                    ? ((US_Hydrodyn *)us_hydrodyn)
                          ->gparams["mals_bl_epsilon"]
                          .toDouble ()
                    : 5e-3;
...
void
US_Hydrodyn_Mals::set_baseline_fix_width ()
{
...
int
US_Hydrodyn_Mals::input_double_to_pos (double d)
{
...
void
US_Hydrodyn_Mals::baseline_start_s_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals::baseline_start_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals::baseline_start_e_text (const QString &text)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Mals::baseline_end_s_text (const QString &text)
{
...
void
US_Hydrodyn_Mals::baseline_end_text (const QString &text)
{
...
void
US_Hydrodyn_Mals::baseline_end_e_text (const QString &text)
{
...
void
US_Hydrodyn_Mals::baseline_start_s_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals::baseline_start_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals::baseline_start_e_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals::baseline_end_s_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals::baseline_end_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals::baseline_end_e_focus (bool hasFocus)
{
...
void
US_Hydrodyn_Mals::baseline_width_text (const QString &text)
{
  int blw = text.toInt ();
...
void
US_Hydrodyn_Mals::baseline_width_focus (bool hasFocus)
{
  if (hasFocus)
    {
      le_last_focus = le_baseline_width;
...
void
US_Hydrodyn_Mals::baseline_best ()
{
  disable_all ();
                      ...
                      baseline_hb_brookesmap_sliding_results, this, progress))
        {
          ...
          // plot of results
          {
            ...
            double cormap_maxq = ((US_Hydrodyn *)us_hydrodyn)
                                         ->gparams.count ("mals_cormap_maxq")
                                     ? ((US_Hydrodyn *)us_hydrodyn)
            ...
            if (best_vdparameters["x"].size ())
              {
                US_Hydrodyn_Mals_Baseline_Best *uhsbb
                    = new US_Hydrodyn_Mals_Baseline_Best (
...
void
US_Hydrodyn_Mals::baseline_test ()
{
...
void
US_Hydrodyn_Mals::baseline_test_pos (int pos)
{
  ...
  // )->gparams[ "mals_bl_smooth" ].toInt() ) );

  baseline_apply (
      qsl, true,
      ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_smooth"].toInt (), true,
      ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_bl_reps"].toInt (), false,
      true);
