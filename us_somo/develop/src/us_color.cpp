...
US_Color::US_Color (QWidget *p, const char *) : QFrame (p)
{
  ...
  cmbb_margin = new QComboBox (this);
  cmbb_margin->setObjectName ("Margin Select");
  ...
  cnt->setFont (QFont (USglobal->config_list.fontFamily,
                       USglobal->config_list.fontSize - 1, QFont::Bold));
  connect (cnt, SIGNAL (buttonReleased (double)),
           SLOT (update_widgets (double)));
  connect (cnt, SIGNAL (valueChanged (double)),
           SLOT (update_widgets (double)));
  ...
  QString etc
      = QDir::toNativeSeparators (USglobal->config_list.system_dir + "/etc");
  ...
  for (QStringList::Iterator it = entries2.begin (); it != entries2.end ();
       ++it)
    {
      str = (*it).toLatin1 ().data ();
      entries1 += str; // combine the personal and the system wide color defs
                       // into a single list
    }
  ...
  for (QStringList::Iterator it = entries1.begin (); it != entries1.end ();
       ++it)
    {
      str = (*it).toLatin1 ().data ();
      str.truncate (str.lastIndexOf (
          ".", -1, Qt::CaseInsensitive)); // strip the extension
  ...
  connect (lb_scheme, SIGNAL (highlighted (int)), this,
           SLOT (selected_scheme (int)));
  connect (lb_scheme, SIGNAL (currentRowChanged (int)), this,
           SLOT (selected_scheme (int)));
  ...
  connect (lb_item, SIGNAL (highlighted (int)), this,
           SLOT (selected_item (int)));
  ...
  AUTFBACK (le_save_as);
  connect (le_save_as, SIGNAL (textChanged (const QString &)),
           SLOT (update_save_str (const QString &)));
...
US_Color::setup_GUI ()
{
  ...
  background->setSpacing (spacing * 2);
  background->setContentsMargins (spacing * 2, spacing * 2, spacing * 2,
                                  spacing * 2);
  QGridLayout *subGrid1 = new QGridLayout;
  subGrid1->setContentsMargins (0, 0, 0, 0);
  subGrid1->setSpacing (0);
  subGrid1->setSpacing (spacing);
  subGrid1->setContentsMargins (spacing, spacing, spacing, spacing);
  ...
  */
  ...
  QGridLayout *subGrid2 = new QGridLayout;
  subGrid2->setContentsMargins (0, 0, 0, 0);
  subGrid2->setSpacing (0);
  subGrid2->setSpacing (spacing);
  subGrid2->setContentsMargins (spacing, spacing, spacing, spacing);
  for (int i = 0; i < rows; i++)
    {
  ...
  color1->setContentsMargins (0, 0, 0, 0);
  color1->setSpacing (0);
  ...
  color2->setContentsMargins (0, 0, 0, 0);
  color2->setSpacing (0);
  ...
  color3->setContentsMargins (0, 0, 0, 0);
  color3->setSpacing (0);
  ...
  color4->setContentsMargins (0, 0, 0, 0);
  color4->setSpacing (0);
  ...
  color5->setContentsMargins (0, 0, 0, 0);
  color5->setSpacing (0);
  ...
  color6->setContentsMargins (0, 0, 0, 0);
  color6->setSpacing (0);
...
void
US_Color::closeEvent (QCloseEvent *e)
{
  e->accept ();
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Color::set_default ()
{
  temp_colors
      = USglobal->global_colors; // called when temp_colors are
                                 // initialized with setting from US_Config
  temp_margin = USglobal->config_list.margin;
}

void
US_Color::selected_scheme (int scheme)
{
  ...
  if (scheme == 0)
    ...
    {
      colfile = USglobal->config_list.system_dir + "/etc/" + selected_scheme
                + ".col";
      ...
      if (!f.exists ()) // if we can't find it in the system wide
        ...
        {
          colfile = USglobal->config_list.root_dir + "/" + selected_scheme
                    + ".col";
          colfile = QDir::toNativeSeparators (colfile);
          f.setFileName (colfile);
        }
...
void
US_Color::selected_item (int item)
{
  current_widget = item;
    ...
    case 0:
      {
        ...
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_frame.windowText ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_frame.window ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText (us_tr (" Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (),
                            temp_colors.cg_frame.light ().color ());
          color_field3->setPalette (palette);
        }
        lbl_color4->setText (us_tr (" Medium Shadow Color:"));
        {
          QPalette palette;
          palette.setColor (color_field4->backgroundRole (),
                            temp_colors.cg_frame.dark ().color ());
          color_field4->setPalette (palette);
        }
        lbl_color5->setText (us_tr (" Medium Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field5->backgroundRole (),
                            temp_colors.cg_frame.midlight ().color ());
          color_field5->setPalette (palette);
        }
        lbl_color6->setText (us_tr (" Dark Shadow Color:"));
        {
          QPalette palette;
          palette.setColor (color_field6->backgroundRole (),
                            temp_colors.cg_frame.shadow ().color ());
          color_field6->setPalette (palette);
        }
        break;
      }
    case 1:
      {
        ...
        lbl_color1->setText (us_tr (" Text Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_pushb.text ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Normal Button Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_pushb.button ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText (us_tr (" Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (),
                            temp_colors.cg_pushb.light ().color ());
          color_field3->setPalette (palette);
        }
        lbl_color4->setText (us_tr (" Shadow Color:"));
        {
          QPalette palette;
          palette.setColor (color_field4->backgroundRole (),
                            temp_colors.cg_pushb.dark ().color ());
          color_field4->setPalette (palette);
        }
        lbl_color5->setText (us_tr (" Active Button Color:"));
        {
          QPalette palette;
          palette.setColor (color_field5->backgroundRole (),
                            temp_colors.cg_pushb.mid ().color ());
          color_field5->setPalette (palette);
        }
        lbl_color6->setText ("");
        {
          QPalette palette;
          palette.setColor (color_field6->backgroundRole (), Qt::gray);
          color_field6->setPalette (palette);
        }
        break;
      }
    case 2:
      {
        ...
        lbl_color1->setText (us_tr (" Text Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_pushb_disabled.text ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_pushb_disabled.button ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText (us_tr (" Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (),
                            temp_colors.cg_pushb_disabled.light ().color ());
          color_field3->setPalette (palette);
        }
        lbl_color4->setText (us_tr (" Shadow Color:"));
        {
          QPalette palette;
          palette.setColor (color_field4->backgroundRole (),
                            temp_colors.cg_pushb_disabled.dark ().color ());
          color_field4->setPalette (palette);
        }
        lbl_color5->setText ("");
        {
          QPalette palette;
          palette.setColor (color_field5->backgroundRole (), Qt::gray);
          color_field5->setPalette (palette);
        }
        lbl_color6->setText ("");
        {
    ...
    case 3:
      {
        ...
        lbl_color1->setText (us_tr (" Text Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_plot.text ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_plot.window ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText (us_tr (" Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (),
                            temp_colors.cg_plot.light ().color ());
          color_field3->setPalette (palette);
        }
        lbl_color4->setText (us_tr (" Shadow Color:"));
        {
          QPalette palette;
          palette.setColor (color_field4->backgroundRole (),
                            temp_colors.cg_plot.dark ().color ());
          color_field4->setPalette (palette);
        }
        lbl_color5->setText ("");
        {
    ...
    case 4:
      {
        ...
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (), temp_colors.plot);
          color_field1->setPalette (palette);
        }
        lbl_color2->setText ("");
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (), Qt::gray);
          color_field2->setPalette (palette);
        }
        lbl_color3->setText ("");
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (), Qt::gray);
          color_field3->setPalette (palette);
        }
        lbl_color4->setText ("");
        {
          QPalette palette;
          palette.setColor (color_field4->backgroundRole (), Qt::gray);
          color_field4->setPalette (palette);
        }
        lbl_color5->setText ("");
        {
    ...
    case 7:
      {
        ...
        lbl_color1->setText (us_tr (" Text Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_edit.windowText ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_edit.window ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText ("");
        {
    ...
    case 8:
      {
        ...
        lbl_color1->setText (us_tr (" Text Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_label.windowText ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_label.window ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText ("");
        {
    ...
    case 9:
      {
        ...
        lbl_color1->setText (us_tr (" Text Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_normal.text ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_normal.window ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText (us_tr (" Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (),
                            temp_colors.cg_normal.light ().color ());
          color_field3->setPalette (palette);
        }
        lbl_color4->setText (us_tr (" Shadow Color:"));
        {
          QPalette palette;
          palette.setColor (color_field4->backgroundRole (),
                            temp_colors.cg_normal.dark ().color ());
          color_field4->setPalette (palette);
        }
        lbl_color5->setText (us_tr (" Medium Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field5->backgroundRole (),
                            temp_colors.cg_normal.highlight ().color ());
          color_field5->setPalette (palette);
        }
        lbl_color6->setText (us_tr (" Button Color:"));
        {
          QPalette palette;
          palette.setColor (color_field6->backgroundRole (),
                            temp_colors.cg_normal.button ().color ());
          color_field6->setPalette (palette);
        }
        break;
      }
    case 10:
      {
        ...
        lbl_color1->setText (us_tr (" Text Center Color:"));
        {
          QPalette palette;
          palette.setColor (color_field1->backgroundRole (),
                            temp_colors.cg_lcd.windowText ().color ());
          color_field1->setPalette (palette);
        }
        lbl_color2->setText (us_tr (" Background Color:"));
        {
          QPalette palette;
          palette.setColor (color_field2->backgroundRole (),
                            temp_colors.cg_lcd.window ().color ());
          color_field2->setPalette (palette);
        }
        lbl_color3->setText (us_tr (" Highlight Color:"));
        {
          QPalette palette;
          palette.setColor (color_field3->backgroundRole (),
                            temp_colors.cg_lcd.light ().color ());
          color_field3->setPalette (palette);
        }
        lbl_color4->setText (us_tr (" Shadow Color:"));
        {
...
US_Color::pick_color1 ()
{
  ...
  {
    QPalette palette;
    palette.setColor (color_field1->backgroundRole (), color1);
    color_field1->setPalette (palette);
  }
  temp_color1 = color1;
  //  { QPalette palette; palette.setColor(color_field1->backgroundRole(),
  //  temp_colors.cg_pushb.buttonText().color());
  //  color_field1->setPalette(palette); }
    ...
    case 0:
      {
        ...
        float v = (int)(0.2125 * color1.red () + 0.0721 * color1.blue ()
                        + 0.7154 * color1.green ());
        if (v > 128)
          {
...
void
US_Color::pick_color2 ()
{
  color2 = QColorDialog::getColor (temp_color2, this);
  {
    QPalette palette;
    palette.setColor (color_field2->backgroundRole (), color2);
    color_field2->setPalette (palette);
  }
  temp_color2 = color2;
  switch (current_widget)
...
void
US_Color::pick_color3 ()
{
  color3 = QColorDialog::getColor (temp_color3, this);
  {
    QPalette palette;
    palette.setColor (color_field3->backgroundRole (), color3);
    color_field3->setPalette (palette);
  }
  temp_color3 = color3;
  switch (current_widget)
...
void
US_Color::pick_color4 ()
{
  color4 = QColorDialog::getColor (temp_color4, this);
  {
    QPalette palette;
    palette.setColor (color_field4->backgroundRole (), color4);
    color_field4->setPalette (palette);
  }
  temp_color4 = color4;
  switch (current_widget)
...
void
US_Color::pick_color5 ()
{
  color5 = QColorDialog::getColor (temp_color5, this);
  {
    QPalette palette;
    palette.setColor (color_field5->backgroundRole (), color5);
    color_field5->setPalette (palette);
  }
  temp_color5 = color5;
  switch (current_widget)
...
void
US_Color::pick_color6 ()
{
  color6 = QColorDialog::getColor (temp_color6, this);
  {
    QPalette palette;
    palette.setColor (color_field6->backgroundRole (), color6);
    color_field6->setPalette (palette);
  }
  temp_color6 = color6;
  switch (current_widget)
...
void
US_Color::delete_scheme ()
{
  QString str = us_tr ("Do you really want to delete the\n \"")
                + lb_scheme->item (current_scheme)->text ()
                + us_tr ("\" color scheme?");
  int result
      = QMessageBox::warning (0, us_tr ("Attention:"), str, us_tr ("Yes"),
                              us_tr ("No"), QString (), 1, 1);
  if (result == 0)
    {
      if (current_scheme == 0)
        {
          US_Static::us_message (us_tr ("Attention:"),
      ...
      QString path = QDir::toNativeSeparators (USglobal->config_list.system_dir
                                               + "/etc");
      ...
      QString colfile = QDir::toNativeSeparators (
...
US_Color::save_as ()
{
  ...
  for (int i = 0; i < lb_scheme->count (); i++)
    {
      if (save_str
          == lb_scheme->item (i)->text ()) // if the item is already listed we
                                           // don't need to list it again
  ...
  QString filename;
  filename = QDir::toNativeSeparators (USglobal->config_list.root_dir + "/"
                                       + save_str);
  ...
  if (file.open (QIODevice::WriteOnly))
    ...
    {
      US_Static::us_message (us_tr ("Warning:"),
...
void
US_Color::update_widgets (double newval)
{
  lcd->display (newval);
  progress->reset ();
...
void
US_Color::update_save_str (const QString &temp_str)
{
  save_str = temp_str;
}

void
US_Color::sel_margin (int newval)
{
