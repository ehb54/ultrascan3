...
void US_Hydrodyn_Dad_Baseline_Best::setupGUI() {
  int minHeight1 = 30;
...
void US_Hydrodyn_Dad_Baseline_Best::cancel() { close(); }

void US_Hydrodyn_Dad_Baseline_Best::help() {
  US_Help *online_help;
  online_help = new US_Help(this);
  online_help->show_help("manual/somo/baseline_best.html");
}

void US_Hydrodyn_Dad_Baseline_Best::closeEvent(QCloseEvent *e) {
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget) {
    US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
...
void US_Hydrodyn_Dad_Baseline_Best::editor_hb_msg(QString color, QString msg) {
  return editor_msg(color, msg, hb_editor);
}

void US_Hydrodyn_Dad_Baseline_Best::editor_hb_ec_msg(QString msg) {
  return editor_ec_msg(msg, hb_editor);
}

void US_Hydrodyn_Dad_Baseline_Best::editor_msg(QString color, QString msg,
                                               QTextEdit *e) {
  if (!e) {
    e = editor;
  }
...
void US_Hydrodyn_Dad_Baseline_Best::editor_ec_msg(QString msg, QTextEdit *e) {
  if (!e) {
    e = editor;
  }
  QColor save_color = e->textColor();
...
void US_Hydrodyn_Dad_Baseline_Best::clear_display() {
  editor->clear();
  editor->append("\n\n");
  hb_editor->clear();
  hb_editor->append("\n\n");
...
void US_Hydrodyn_Dad_Baseline_Best::update_font() {
  bool ok;
  QFont newFont;
...
void US_Hydrodyn_Dad_Baseline_Best::save() {
  QString fn;
...
void US_Hydrodyn_Dad_Baseline_Best::displayData() {
  editor->clear();
...
void US_Hydrodyn_Dad_Baseline_Best::set_best() {
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget) {
    US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
...
void US_Hydrodyn_Dad_Baseline_Best::set_hb_best() {
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget) {
    US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
...
void US_Hydrodyn_Dad_Baseline_Best::update_enables() {
  if (!parameters.count("hb")) {
...
void US_Hydrodyn_Dad_Baseline_Best::usp_config_plot(const QPoint &) {
  US_PlotChoices *uspc = new US_PlotChoices(usp_plot);
  uspc->exec();
  delete uspc;
}

void US_Hydrodyn_Dad_Baseline_Best::usp_config_hb_plot(const QPoint &) {
