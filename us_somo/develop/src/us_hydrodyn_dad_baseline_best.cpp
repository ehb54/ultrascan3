...
US_Hydrodyn_Dad_Baseline_Best::US_Hydrodyn_Dad_Baseline_Best (
...
void
US_Hydrodyn_Dad_Baseline_Best::setupGUI ()
{
  int minHeight1 = 30;
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget)
    {
      US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
      dad_win->plot_info[plot_name] = plot;
    }
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget)
    {
      US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
      dad_win->plot_info[hb_plot_name] = hb_plot;
    }
...
void
US_Hydrodyn_Dad_Baseline_Best::cancel ()
{
  close ();
}

void
US_Hydrodyn_Dad_Baseline_Best::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Dad_Baseline_Best::closeEvent (QCloseEvent *e)
{
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget)
    {
      US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
      if (dad_win->plot_info.count (plot_name)
          && dad_win->plot_info[plot_name] == plot)
        {
          dad_win->plot_info.erase (plot_name);
        }
      if (dad_win->plot_info.count (hb_plot_name)
          && dad_win->plot_info[hb_plot_name] == hb_plot)
        {
          dad_win->plot_info.erase (hb_plot_name);
        }
    }
...
void
US_Hydrodyn_Dad_Baseline_Best::editor_hb_msg (QString color, QString msg)
{
  return editor_msg (color, msg, hb_editor);
}

void
US_Hydrodyn_Dad_Baseline_Best::editor_hb_ec_msg (QString msg)
{
  return editor_ec_msg (msg, hb_editor);
}

void
US_Hydrodyn_Dad_Baseline_Best::editor_msg (QString color, QString msg,
                                           QTextEdit *e)
{
  if (!e)
    {
...
void
US_Hydrodyn_Dad_Baseline_Best::editor_ec_msg (QString msg, QTextEdit *e)
{
  if (!e)
    {
      e = editor;
...
void
US_Hydrodyn_Dad_Baseline_Best::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
  hb_editor->clear ();
...
void
US_Hydrodyn_Dad_Baseline_Best::update_font ()
{
  bool ok;
  QFont newFont;
...
void
US_Hydrodyn_Dad_Baseline_Best::save ()
{
  QString fn;
...
void
US_Hydrodyn_Dad_Baseline_Best::displayData ()
{
...
void
US_Hydrodyn_Dad_Baseline_Best::set_best ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget)
    {
      US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;

      if (dad_win->current_mode == US_Hydrodyn_Dad::MODE_BASELINE
          && vdparameters.count ("bestpos") && dparameters.count ("width"))
        {
          ...
          dad_win->le_baseline_end_s->setText (QString ("%1").arg (bestpos));
          dad_win->le_baseline_end_e->setText (
              QString ("%1").arg (bestpos + dparameters["width"] - 1));
          dad_win->le_baseline_width->setText (
              QString ("%1").arg (dparameters["width"]));
          dad_win->cb_baseline_fix_width->setChecked (true);
        }
    }
}

void
US_Hydrodyn_Dad_Baseline_Best::set_hb_best ()
{
  if (((US_Hydrodyn *)us_hydrodyn)->dad_widget)
    {
      US_Hydrodyn_Dad *dad_win = ((US_Hydrodyn *)us_hydrodyn)->dad_window;
...
void
US_Hydrodyn_Dad_Baseline_Best::update_enables ()
{
  if (!parameters.count ("hb"))
    {
...
void
US_Hydrodyn_Dad_Baseline_Best::usp_config_plot (const QPoint &)
{
...
void
US_Hydrodyn_Dad_Baseline_Best::usp_config_hb_plot (const QPoint &)
{
