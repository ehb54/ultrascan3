                                             ...
                                             ) : QFrame( p )
{
   ...
   {
      ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "hplc_cb_discard_it_sd_mult" ] = "true";
   }
   ...
   if ( !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count( "hplc_maxfpk_restart_tries"  ) ||
        !started_in_expert_mode ) {
   ...
   if ( !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count( "hplc_cb_makeiq_avg_peaks_normalize" ) )
   {
      ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "hplc_cb_makeiq_avg_peaks_normalize" ] = "true";
   }
...
bool US_Hydrodyn_Saxs_Hplc::load_file( QString filename, bool load_conc )
{
   ...
   //          saxs_hplc_param_g_conc = rx_saxs_hplc_param_g_conc_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_g_psv.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_g_psv = rx_saxs_hplc_param_g_psv_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_I0_exp.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_I0_exp = rx_saxs_hplc_param_I0_exp_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_I0_theo.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_I0_theo = rx_saxs_hplc_param_I0_theo_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_diffusion_len.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_diffusion_len = rx_saxs_hplc_param_diffusion_len_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_electron_nucleon_ratio.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_electron_nucleon_ratio = rx_saxs_hplc_param_electron_nucleon_ratio_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_nucleon_mass.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_nucleon_mass = rx_saxs_hplc_param_nucleon_mass_m.captured( 1 ).toDouble();
   //          continue;
   //       }
   //       if ( rx_saxs_hplc_param_solvent_electron_density.indexIn( qv[ i ] ) != -1 ) {
   //          saxs_hplc_param_solvent_electron_density = rx_saxs_hplc_param_solvent_electron_density_m.captured( 1 ).toDouble();
   //          continue;
   //       }
