...
void
QListWidgetText::paint (QPainter *painter)
{
  ...
  if (rx.indexIn (text ()) != -1)
    {
      bool highlighted
          = (painter->backgroundColor ().fileName () != "#ffffff");
...
US_Hydrodyn_Batch::US_Hydrodyn_Batch (batch_info *batch, bool *batch_widget,
...
US_Hydrodyn_Batch::~US_Hydrodyn_Batch () { *batch_widget = false; }

void
US_Hydrodyn_Batch::resizeEvent (QResizeEvent *re)
{
...
US_Hydrodyn_Batch::setupGUI ()
{
  ...
  lbl_selection->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  for (unsigned int i = 0; i < batch->file.size (); i++)
    {
      if (batch->file[i].contains (
          ...
          if (!dup)
            {
              ...
              ((US_Hydrodyn *)us_hydrodyn)
                  ->add_to_directory_history (batch->file[i], false);
            }
          else
            {
              load_errors
                  += QString (us_tr ("File skipped: %1 (already in list)\n"))
                         .arg (batch->file[i]);
            }
        }
      else
        {
          load_errors
              += QString (us_tr ("File skipped: %1 (not a valid file name)\n"))
                     .arg (batch->file[i]);
        }
    }
  ...
  connect (lb_files, SIGNAL (itemSelectionChanged ()),
           SLOT (update_enables ()));
  ...
  pb_remove_files->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  pb_load_somo->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  pb_load_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  if (started_in_expert_mode)
    {
      ...
      pb_make_movie->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  lbl_total_files->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize,
                                   QFont::Bold));
  ...
  AUTFBACK (lbl_screen);
  lbl_screen->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION < 0x040000
  bg_residues = new QGroupBox (3, Qt::Vertical,
                               "If non-coded residues are found:", this);
  ...
  cb_residue_stop->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  cb_residue_stop->setPalette (qp_cb);
  ...
  cb_residue_skip->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  cb_residue_skip->setPalette (qp_cb);
  AUTFBACK (cb_residue_skip);

  cb_residue_auto = new QCheckBox (bg_residues);
  cb_residue_auto->setText (
  ...
  cb_residue_auto->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  cb_residue_auto->setPalette (qp_cb);
  ...
  rb_residue_stop->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  rb_residue_stop->setPalette (qp_cb);
  ...
  rb_residue_skip->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  rb_residue_skip->setPalette (qp_cb);
  ...
  rb_residue_auto->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  rb_residue_auto->setPalette (qp_cb);
  ...
  switch (batch->missing_residues)
    ...
    case 2:
      ...
      break;
    default:
      qDebug () << "batch missing residues selection error";
      break;
    }
...
#if QT_VERSION < 0x040000
  bg_atoms = new QGroupBox (
      3, Qt::Vertical, "If missing atoms within a residue are found:", this);
  qf = bg_atoms->font ();
  qf.setPointSize (qf.pointSize () - 1);
  bg_atoms->setFont (qf);
  ...
  cb_atom_stop->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_atom_stop->setPalette (qp_cb);
  AUTFBACK (cb_atom_stop);

  cb_atom_skip = new QCheckBox (bg_atoms);
  cb_atom_skip->setText (
      us_tr (" List them, skip entire residue and proceed"));
  cb_atom_skip->setEnabled (true);
  //   cb_atom_skip->setMinimumHeight(minHeight1);
  cb_atom_skip->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_atom_skip->setPalette (qp_cb);
  ...
  cb_atom_auto->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_atom_auto->setPalette (qp_cb);
  ...
  rb_atom_stop->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  rb_atom_stop->setPalette (qp_cb);
  AUTFBACK (rb_atom_stop);
  AUTFBACK (rb_atom_stop);
  connect (rb_atom_stop, SIGNAL (clicked ()), this, SLOT (atom ()));

  rb_atom_skip = new QRadioButton ();
  rb_atom_skip->setText (
      us_tr (" List them, skip entire residue and proceed"));
  rb_atom_skip->setEnabled (true);
  //   rb_atom_skip->setMinimumHeight(minHeight1);
  rb_atom_skip->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  rb_atom_skip->setPalette (qp_cb);
  ...
  rb_atom_auto->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  rb_atom_auto->setPalette (qp_cb);
  ...
  switch (batch->missing_atoms)
    ...
    case 2:
      ...
      break;
    default:
      qDebug () << "batch missing atoms selection error";
      break;
    }
  ...
  pb_screen->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_mm_first->setText (
      us_tr (" Process Only First Model in PDB's with Multiple Models "));
  cb_mm_first->setChecked (batch->mm_first);
  cb_mm_first->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  cb_mm_first->setPalette (qp_cb);
  AUTFBACK (cb_mm_first);
  connect (cb_mm_first, SIGNAL (clicked ()), this, SLOT (set_mm_first ()));

  cb_mm_all = new QCheckBox (this);
  cb_mm_all->setText (
      us_tr (" Process All Models in PDB's with Multiple Models "));
  cb_mm_all->setChecked (batch->mm_all);
  cb_mm_all->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  cb_mm_all->setPalette (qp_cb);
  AUTFBACK (cb_mm_all);
  ...
  cb_dmd->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  cb_dmd->setPalette (qp_cb);
  AUTFBACK (cb_dmd);
  ...
  cb_fd->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  cb_fd->setPalette (qp_cb);
  AUTFBACK (cb_fd);
  ...
  cb_somo->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  cb_somo->setPalette (qp_cb);
  AUTFBACK (cb_somo);
  ...
  cb_somo_o->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  cb_somo_o->setPalette (qp_cb);
  AUTFBACK (cb_somo_o);
  ...
  cb_grid->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  cb_grid->setPalette (qp_cb);
  AUTFBACK (cb_grid);
  ...
  cb_vdw_beads->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_vdw_beads->setPalette (qp_cb);
  AUTFBACK (cb_vdw_beads);
  ...
  cb_equi_grid->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_equi_grid->setPalette (qp_cb);
  ...
  cb_iqq->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  cb_iqq->setPalette (qp_cb);
  AUTFBACK (cb_iqq);
  ...
  cb_saxs_search->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cb_saxs_search->setPalette (qp_cb);
  AUTFBACK (cb_saxs_search);
  connect (cb_saxs_search, SIGNAL (clicked ()), this,
           SLOT (set_saxs_search ()));

  cb_prr = new QCheckBox (this);
  cb_prr->setText (us_tr ("Compute SAXS P(r) "));
  cb_prr->setChecked (batch->prr);
  cb_prr->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  cb_prr->setPalette (qp_cb);
  AUTFBACK (cb_prr);
  ...
  cb_hydrate->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  cb_hydrate->setPalette (qp_cb);
  AUTFBACK (cb_hydrate);
  ...
  cb_csv_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  cb_csv_saxs->setPalette (qp_cb);
  AUTFBACK (cb_csv_saxs);
  connect (cb_csv_saxs, SIGNAL (clicked ()), this, SLOT (set_csv_saxs ()));

  le_csv_saxs_name = new QLineEdit (this);
  le_csv_saxs_name->setObjectName ("csv_saxs_name Line Edit");
  ...
  le_csv_saxs_name->setPalette (qp_cb);
  AUTFBACK (le_csv_saxs_name);
  le_csv_saxs_name->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  connect (le_csv_saxs_name, SIGNAL (textChanged (const QString &)),
           SLOT (update_csv_saxs_name (const QString &)));

  cb_create_native_saxs = new QCheckBox (this);
  cb_create_native_saxs->setText (
  ...
  cb_create_native_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_create_native_saxs->setPalette (qp_cb);
  AUTFBACK (cb_create_native_saxs);
  connect (cb_create_native_saxs, SIGNAL (clicked ()), this,
  ...
  cb_compute_iq_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_compute_iq_avg->setPalette (qp_cb);
  AUTFBACK (cb_compute_iq_avg);
  connect (cb_compute_iq_avg, SIGNAL (clicked ()), this,
           SLOT (set_compute_iq_avg ()));
  ...
  cb_compute_iq_only_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_compute_iq_only_avg->setPalette (qp_cb);
  AUTFBACK (cb_compute_iq_only_avg);
  connect (cb_compute_iq_only_avg, SIGNAL (clicked ()), this,
           SLOT (set_compute_iq_only_avg ()));

  cb_compute_iq_std_dev = new QCheckBox (this);
  cb_compute_iq_std_dev->setText (
      us_tr (" Compute I(q) std deviation curves"));
  cb_compute_iq_std_dev->setChecked (batch->compute_iq_std_dev);
  cb_compute_iq_std_dev->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_compute_iq_std_dev->setPalette (qp_cb);
  AUTFBACK (cb_compute_iq_std_dev);
  connect (cb_compute_iq_std_dev, SIGNAL (clicked ()), this,
           SLOT (set_compute_iq_std_dev ()));
  ...
  cb_compute_prr_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  cb_compute_prr_avg->setPalette (qp_cb);
  AUTFBACK (cb_compute_prr_avg);
  connect (cb_compute_prr_avg, SIGNAL (clicked ()), this,
           SLOT (set_compute_prr_avg ()));

  cb_compute_prr_std_dev = new QCheckBox (this);
  cb_compute_prr_std_dev->setText (
      us_tr (" Compute P(r) std deviation curves"));
  cb_compute_prr_std_dev->setChecked (batch->compute_prr_std_dev);
  cb_compute_prr_std_dev->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_compute_prr_std_dev->setPalette (qp_cb);
  AUTFBACK (cb_compute_prr_std_dev);
  connect (cb_compute_prr_std_dev, SIGNAL (clicked ()), this,
           SLOT (set_compute_prr_std_dev ()));

  cb_hydro = new QCheckBox (this);
  cb_hydro->setText (us_tr (" Calculate RB Hydrodynamics SMI"));
  cb_hydro->setChecked (batch->hydro);
  cb_hydro->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  cb_hydro->setPalette (qp_cb);
  AUTFBACK (cb_hydro);
  ...
  cb_zeno->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  cb_zeno->setPalette (qp_cb);
  AUTFBACK (cb_zeno);
  ...
  cb_grpy->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  cb_grpy->setPalette (qp_cb);
  AUTFBACK (cb_grpy);
  ...
  cb_hullrad->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  cb_hullrad->setPalette (qp_cb);
  AUTFBACK (cb_hullrad);
  ...
  cb_avg_hydro->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  cb_avg_hydro->setPalette (qp_cb);
  AUTFBACK (cb_avg_hydro);
  connect (cb_avg_hydro, SIGNAL (clicked ()), this, SLOT (set_avg_hydro ()));

  le_avg_hydro_name = new QLineEdit (this);
  le_avg_hydro_name->setObjectName ("avg_hydro_name Line Edit");
  ...
  le_avg_hydro_name->setPalette (qp_cb);
  AUTFBACK (le_avg_hydro_name);
  le_avg_hydro_name->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  connect (le_avg_hydro_name, SIGNAL (textChanged (const QString &)),
           SLOT (update_avg_hydro_name (const QString &)));

  cb_results_dir = new QCheckBox (this);
  cb_results_dir->setText (
      us_tr (" Put individual files in specified results directory:"));
  cb_results_dir->setChecked (batch->results_dir);
  cb_results_dir->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cb_results_dir->setPalette (qp_cb);
  AUTFBACK (cb_results_dir);
  connect (cb_results_dir, SIGNAL (clicked ()), this,
           SLOT (set_results_dir ()));
  cb_results_dir->setToolTip (
      "Currently only available when only Build vdW bead model or Calculate "
      "RB hydrodynamics ZENO are checked");

  le_results_dir_name = new QLineEdit (this);
  le_results_dir_name->setObjectName ("results_dir_name Line Edit");
  ...
  le_results_dir_name->setPalette (qp_cb);
  AUTFBACK (le_results_dir_name);
  le_results_dir_name->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  connect (le_results_dir_name, SIGNAL (textChanged (const QString &)),
           SLOT (update_results_dir_name (const QString &)));
  cb_results_dir->setToolTip (
      "Currently only available when Build vdW bead model & Calculate RB "
      "hydrodynamics ZENO are checked");
  ...
  cb_saveParams->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  cb_saveParams->setPalette (qp_cb);
  ...
  pb_cluster->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  pb_open_saxs_options->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  pb_open_saxs_options->setMinimumHeight (minHeight1);
  pb_open_saxs_options->setPalette (PALET_PUSHB);
  connect (pb_open_saxs_options, SIGNAL (clicked ()),
           SLOT (open_saxs_options ()));
  ...
  editor->setWordWrapMode (
      ((US_Hydrodyn *)us_hydrodyn)->advanced_config.scroll_editor
          ? QTextOption::NoWrap
  ...
  hbl_selection_ops->setContentsMargins (0, 0, 0, 0);
  hbl_selection_ops->setSpacing (0);
  ...
  hbl_counts->setContentsMargins (0, 0, 0, 0);
  hbl_counts->setSpacing (0);
  hbl_counts->addWidget (lbl_total_files);
  hbl_counts->addWidget (lbl_selected);

  QVBoxLayout *vbl_selection = new QVBoxLayout;
  vbl_selection->setContentsMargins (0, 0, 0, 0);
  vbl_selection->setSpacing (0);
  ...
  //   hbl_screen->setContentsMargins( 0, 0, 0, 0 ); hbl_screen->setSpacing( 0
  //   ); hbl_screen->addWidget(bg_residues); hbl_screen->addWidget(bg_atoms);

  // 3rd section - process control
  QHBoxLayout *hbl_hydro = new QHBoxLayout;
  hbl_hydro->setContentsMargins (0, 0, 0, 0);
  hbl_hydro->setSpacing (0);
  hbl_hydro->addWidget (cb_avg_hydro);
  hbl_hydro->addWidget (le_avg_hydro_name);

  QHBoxLayout *hbl_results_dir = new QHBoxLayout;
  hbl_hydro->setContentsMargins (0, 0, 0, 0);
  hbl_hydro->setSpacing (0);
  ...
  hbl_somo_grid->setContentsMargins (0, 0, 0, 0);
  hbl_somo_grid->setSpacing (0);
  ...
  hbl_iqq_prr->setContentsMargins (0, 0, 0, 0);
  hbl_iqq_prr->setSpacing (0);
  ...
  hbl_csv_saxs->setContentsMargins (0, 0, 0, 0);
  hbl_csv_saxs->setSpacing (0);
  ...
  hbl_iq_avg_std_dev->setContentsMargins (0, 0, 0, 0);
  hbl_iq_avg_std_dev->setSpacing (0);
  ...
  hbl_prr_avg_std_dev->setContentsMargins (0, 0, 0, 0);
  hbl_prr_avg_std_dev->setSpacing (0);
  ...
  hbl_save->setContentsMargins (0, 0, 0, 0);
  hbl_save->setSpacing (0);
  hbl_save->addWidget (pb_select_save_params);
  hbl_save->addWidget (cb_saveParams);

  QHBoxLayout *hbl_process = new QHBoxLayout;
  hbl_process->setContentsMargins (0, 0, 0, 0);
  hbl_process->setSpacing (0);
  ...
  hbl_help_cancel->setContentsMargins (0, 0, 0, 0);
  hbl_help_cancel->setSpacing (0);
  ...
  hbl_hydro_zeno->setContentsMargins (0, 0, 0, 0);
  hbl_hydro_zeno->setSpacing (0);
...
void
US_Hydrodyn_Batch::cancel ()
{
  close ();
}

void
US_Hydrodyn_Batch::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Batch::closeEvent (QCloseEvent *e)
{
  if (batch_job_running)
    {
      QMessageBox mb (
          this->windowTitle (),
          us_tr ("Attention:\nThere is a batch job running, do you really "
                 "want to stop it?"),
...
void
US_Hydrodyn_Batch::add_file (QString filename)
{
  QColor save_color = editor->textColor ();
...
void
US_Hydrodyn_Batch::add_files (vector<QString> filenames)
{
  QColor save_color = editor->textColor ();
  disable_updates = true;
      ...
      if (!dup)
        {
          ...
          editor->setTextColor ("dark blue");
          editor->append (
              QString (us_tr ("File loaded: %1")).arg (filenames[i]));
        }
      else
        {
          //         editor->setTextColor("dark red");
          //         editor->append(QString(us_tr("File skipped: %1 (already in
          //         list)")).arg(filenames[i]));
        }
    }
  editor->setTextColor (save_color);
  disable_updates = false;
...
US_Hydrodyn_Batch::add_files ()
{
  ...
  QStringList filenames = QFileDialog::getOpenFileNames (
      this, "Please select a PDB file or files...", use_dir,
      "Structures (*.pdb *.PDB *.bead_model *.BEAD_MODEL *.beams "
      "*.BEAD_MODEL)");
...
void
US_Hydrodyn_Batch::remove_files ()
{
  if (lbl_selected->text ()
      == QString ("Selected: %1").arg (lb_files->count ()))
    {
      status.clear ();
      batch->file.clear ();
      lb_files->clear ();
      ...
      if (lb_files->item (i)->isSelected ())
        {
          ...
          if (file.contains (QRegExp (".(pdb|PDB)$"))
              && !((US_Hydrodyn *)us_hydrodyn)->is_dammin_dammif (file))
            {
              ...
              if (((US_Hydrodyn *)us_hydrodyn)->pdb_parse.missing_residues
                      != batch->missing_residues
                  || ((US_Hydrodyn *)us_hydrodyn)->pdb_parse.missing_atoms
                         != batch->missing_atoms)
                {
                  switch (QMessageBox::question (
                      this, windowTitle () + us_tr (": Notice"),
                      QString (us_tr ("Please note:\n\n"
                                      "You are loading a PDB file and the "
                                      "current Batch Operation\n"
                                      "PDB parsing options don't match SOMO's "
                                      "current settings\n"
                                      "What would you like to do?\n")),
                      us_tr ("Use &Batch current mode settings"),
                      us_tr ("Keep &SOMO's setting"), QString (),
                      0, // Stop == button 0
                      0  // Escape == button 0
                      ))
                    {
          ...
          if (result)
            {
              editor->setTextColor ("dark blue");
              editor->append (
                  QString (us_tr ("Screening: %1 ok.").arg (file)));
            }
          else
            {
              editor->setTextColor ("red");
              editor->append (
                  QString (us_tr ("Screening: %1 FAILED.").arg (file)));
            }
          editor->setTextColor (save_color);
...
void
US_Hydrodyn_Batch::update_enables ()
{
  if (disable_updates)
    {
      return;
  ...
  if (!count_selected)
  ...
  else
    {
      ...
      if (any_pdb_in_list && batch->hullrad)
        ...
        {
          if (any_bead_model_selected || batch->somo || batch->grid
              || batch->somo_o || batch->vdw_beads)
            {
  ...
  bool anything_to_do = cb_somo->isChecked () || cb_somo_o->isChecked ()
                        || cb_grid->isChecked () || cb_vdw_beads->isChecked ()
                        || cb_iqq->isChecked () || cb_prr->isChecked ()
                        || cb_hydro->isChecked () || cb_zeno->isChecked ()
                        || cb_grpy->isChecked () || cb_hullrad->isChecked ()
                        || cb_dmd->isChecked () || cb_fd->isChecked () || 0;

  if ((cb_vdw_beads->isChecked () || cb_somo->isChecked ()
       || cb_somo_o->isChecked () || cb_zeno->isChecked ()
       || cb_grpy->isChecked ())
      && !cb_grid->isChecked () && !cb_iqq->isChecked ()
      && !cb_prr->isChecked () && !cb_hydro->isChecked ()
      && !cb_hullrad->isChecked () && !cb_dmd->isChecked ())
    {
...
void
US_Hydrodyn_Batch::residue (int val)
{
  batch->missing_residues = val;
}

void
US_Hydrodyn_Batch::atom ()
{
...
void
US_Hydrodyn_Batch::atom (int val)
{
  batch->missing_atoms = val;
}

bool
US_Hydrodyn_Batch::screen_pdb (QString file, bool display_pdb)
{
  save_us_hydrodyn_settings ();
  bool result
      = ((US_Hydrodyn *)us_hydrodyn)->screen_pdb (file, display_pdb, true);
  restore_us_hydrodyn_settings ();
  return result;
}

bool
US_Hydrodyn_Batch::screen_bead_model (QString file)
{
...
void
US_Hydrodyn_Batch::save_us_hydrodyn_settings ()
{
  ...
  save_disable_iq_scaling
      = ((US_Hydrodyn *)us_hydrodyn)->saxs_options.disable_iq_scaling;
...
void
US_Hydrodyn_Batch::restore_us_hydrodyn_settings ()
{
...
void
US_Hydrodyn_Batch::set_issue_info (bool as_batch)
{
...
void
US_Hydrodyn_Batch::stop_processing ()
{
  editor_msg ("dark red", "Stopped by user");
  editor_msg ("dark red", "Files selected may have changed, please verify "
                          "before rerunning Start.");
  enable_after_stop ();
  disable_updates = false;
  save_batch_active = false;
      ...
      if (lb_files->item (i)->isSelected ())
        {
          ...
          lb_files->item (i)->setText (
              QString ("%1%2").arg (status_color[status[file]]).arg (file));
...
void
US_Hydrodyn_Batch::set_mm_first ()
{
...
void
US_Hydrodyn_Batch::set_vdw_beads ()
{
  batch->vdw_beads = cb_vdw_beads->isChecked ();
  if (batch->vdw_beads)
    {
...
void
US_Hydrodyn_Batch::set_equi_grid ()
{
...
void
US_Hydrodyn_Batch::set_saxs_search ()
{
      ...
      if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_widget)
        {
          ...
          if (((US_Hydrodyn *)us_hydrodyn)->saxs_search_widget)
            {
              ((US_Hydrodyn *)us_hydrodyn)
                  ->saxs_search_window->editor_msg (
                      "blue",
                      us_tr ("Set search parameters for batch mode and then\n"
                             "close this window or return to the batch window "
                             "when done\n"));
            }
          else
            {
              editor_msg ("red",
                          us_tr ("Could not activate SAXS search window!\n"));
            }
        }
      else
        {
...
void
US_Hydrodyn_Batch::set_csv_saxs ()
{
...
void
US_Hydrodyn_Batch::set_create_native_saxs ()
{
...
void
US_Hydrodyn_Batch::update_csv_saxs_name (const QString &str)
{
  batch->csv_saxs_name = str;
}

void
US_Hydrodyn_Batch::set_hydrate ()
{
...
void
US_Hydrodyn_Batch::set_compute_iq_avg ()
{
...
void
US_Hydrodyn_Batch::set_compute_iq_only_avg ()
{
...
void
US_Hydrodyn_Batch::set_compute_iq_std_dev ()
{
...
void
US_Hydrodyn_Batch::set_compute_prr_avg ()
{
...
void
US_Hydrodyn_Batch::set_compute_prr_std_dev ()
{
...
void
US_Hydrodyn_Batch::set_grpy ()
{
  batch->grpy = cb_grpy->isChecked ();
  // if ( batch->grpy ) {
  //    QMessageBox::warning( this, windowTitle() + ": Calculate RB
  //    Hydrodynamics: GRPY", "GRPY not yet integrated" ); cb_grpy->setChecked(
  //    false ); batch->grpy = cb_grpy->isChecked(); return;
  // }
  if (batch->grpy)
    {
      cb_hullrad->setChecked (false);
...
void
US_Hydrodyn_Batch::set_avg_hydro ()
{
...
void
US_Hydrodyn_Batch::update_avg_hydro_name (const QString &str)
{
  batch->avg_hydro_name = str;
}

void
US_Hydrodyn_Batch::set_results_dir ()
{
...
void
US_Hydrodyn_Batch::update_results_dir_name (const QString &str)
{
  QString fixedstr = str;
  fixedstr.replace (QRegularExpression ("[^A-Za-z0-9-._]"), "");
  if (fixedstr != str)
    {
      disconnect (le_results_dir_name, SIGNAL (textChanged (const QString &)),
                  0, 0);
...
void
US_Hydrodyn_Batch::select_save_params ()
{
  ((US_Hydrodyn *)us_hydrodyn)->select_save_params ();
}

void
US_Hydrodyn_Batch::set_saveParams ()
{
...
void
US_Hydrodyn_Batch::disable_after_start ()
{
...
void
US_Hydrodyn_Batch::enable_after_stop ()
{
  batch_job_running = false;
  lb_files->setEnabled (true);
...
US_Hydrodyn_Batch::start (bool quiet)
{
  ...
  if (batch->fd
      && ((US_Hydrodyn *)us_hydrodyn)
                 ->gparam_value (
                     US_Hydrodyn_Fractal_Dimension_Options::paramname (
                         US_Hydrodyn_Fractal_Dimension_Options::ENABLED))
             != "true")
    {
      switch (QMessageBox::warning (
          this, windowTitle () + us_tr (": Warning"),
          QString (us_tr (
              ...
              "What would you like to do?\n")),
          us_tr ("&Stop"), us_tr ("&Change options now")))
        {
        case 0: // stop
          return;
          break;
  ...
  if (batch->fd
      && ((US_Hydrodyn *)us_hydrodyn)
                 ->gparam_value (
                     US_Hydrodyn_Fractal_Dimension_Options::paramname (
                         US_Hydrodyn_Fractal_Dimension_Options::PLOTS))
             == "true")
    {
      switch (QMessageBox::warning (
          this, windowTitle () + us_tr (": Warning"),
          QString (us_tr ("The Fractal Dimension plots are currently on\n"
                          "This will require a manual intervention for each "
                          "processed PDB\n"
                          "What would you like to do?\n")),
          us_tr ("&Stop"), us_tr ("&Change options now"), us_tr ("C&ontinue"),
          0 // Stop == button 0
          ,
          0 // Escape == button 0
          ))
  ...
  if (batch->fd && cb_saveParams->isChecked ())
    {
      bool ok;
      fd_batch_save_name = QInputDialog::getText (
          this, windowTitle () + us_tr (": Fractal Dimension Results Name"),
          tr ("Enter the file name to save:"), QLineEdit::Normal, "FD_results",
          &ok);
      if (!ok)
        {
          return;
  ...
  bool proceed_anyway = (batch->iqq || batch->prr) && !batch->somo
                        && !batch->grid && !batch->somo_o && !batch->vdw_beads
                        && !batch->hydro && !batch->zeno && !batch->hullrad
                        && !batch->grpy;
      ...
      if (lb_files->item (i)->isSelected ())
        {
          ...
          // get_file_name( i ) ).arg( models.size() );
          progress2->reset ();
          if ((int)models.size ())
            {
              progress2->show ();
          ...
          for (int mindex = 0; mindex < (int)models.size (); ++mindex)
            {
              ...
              int m = models[mindex];
              // ((US_Hydrodyn*)us_hydrodyn)->dammix_remember_mw.erase(
              // QFileInfo(get_file_name( i, m ) ).fileName() ); TSO <<
              // QString( "--> processing index %1 model %2 file %3\n" ).arg(
              // mindex ).arg( m ).arg( get_file_name( i, m ) );

              job_timer.init_timer (
                  QString ("%1 process").arg (get_file_name (i, m)));
              job_timer.start_timer (
                  QString ("%1 process").arg (get_file_name (i, m)));
              ...
              lb_files->item (i)->setText (
                  QString ("%1%2")
                      .arg (status_color[status[get_file_name (i)]])
                      .arg (get_file_name (i)));
              lb_files->item (i)->setSelected (false);
              qApp->processEvents ();
              job_timer.init_timer (
                  QString ("%1 screen").arg (get_file_name (i, m)));
              job_timer.start_timer (
                  QString ("%1 screen").arg (get_file_name (i, m)));
              if (file.contains (QRegExp (".(pdb|PDB)$")))
                {
              ...
              if (result || proceed_anyway)
                {
                  if (result)
                  ...
                  else
                    {
                      ...
                      editor->append (QString (
                          us_tr (
                              "Screening: %1 not ok, but proceeding anyway.")
                              .arg (file)));
                      editor->setTextColor ("dark blue");
                      result = 1;
                    }
                  ...
                  bool pdb_mode = file.contains (QRegExp (".(pdb|PDB)$"))
                                  && !((US_Hydrodyn *)us_hydrodyn)
                                          ->is_dammin_dammif (file);
                  if (pdb_mode)
                    {
                      save_us_hydrodyn_settings ();
                      if (batch->mm_all)
                      ...
                      if (batch->fd)
                        {
                          qDebug () << "batch FD\n";
                          ((US_Hydrodyn *)us_hydrodyn)
                              ->fractal_dimension (true, &fd_save_info);
                        }
                      if (batch->somo)
                        {
                          job_timer.init_timer (
                              QString ("%1 somo").arg (get_file_name (i, m)));
                          job_timer.start_timer (
                              QString ("%1 somo").arg (get_file_name (i, m)));
                          result = ((US_Hydrodyn *)us_hydrodyn)->calc_somo ()
                                       ? false
                                       : true;
                          job_timer.end_timer (
                              QString ("%1 somo").arg (get_file_name (i, m)));
                      ...
                      if (batch->grid)
                        {
                          job_timer.init_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                          job_timer.start_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                          result
                              = ((US_Hydrodyn *)us_hydrodyn)->calc_grid_pdb ()
                                    ? false
                                    : true;
                          job_timer.end_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                      ...
                      if (batch->somo_o)
                        {
                          ...
                          job_timer.start_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                          result = ((US_Hydrodyn *)us_hydrodyn)->calc_somo_o ()
                                       ? false
                                       : true;
                          job_timer.end_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                      ...
                      if (batch->vdw_beads)
                        {
                          ...
                          job_timer.start_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                          result
                              = ((US_Hydrodyn *)us_hydrodyn)->calc_vdw_beads ()
                                    ? false
                                    : true;
                          job_timer.end_timer (
                              QString ("%1 atob").arg (get_file_name (i, m)));
                  ...
                  if (result && batch->iqq)
                    {
                      save_us_hydrodyn_settings ();
                      if (batch->mm_all && lb_model->count () > 1)
                        {
                          // loop through them:
                          unsigned int lb_model_rows
                              = (unsigned int)lb_model->count ();
                          progress2->reset ();
                          progress2->show ();
#if defined(USE_H)
                          // save everything if hydrate on
                          QString hydrated_pdb_nmr_text;
                          QString org_pdb_file
                              = ((US_Hydrodyn *)us_hydrodyn)->pdb_file;
                          if (batch->hydrate)
                            {
                          ...
                          for (unsigned int ii = 0;
                               ii < lb_model_rows && !stopFlag; ii++)
                            {
                              progress2->setValue (ii);
                              progress2->setMaximum (lb_model_rows);
#if defined(USE_H)
                              if (batch->hydrate)
                                {
                                  ((US_Hydrodyn *)us_hydrodyn)
                              ...
                              editor_msg (
                                  "dark gray",
                                  QString (
                                      us_tr ("Processing I(q): %1 from %2"))
                                      .arg (lb_model->item (ii)->text ())
                                      .arg (QFileInfo (get_file_name (i, m))
                                                .fileName ()));
                              qApp->processEvents ();
                              // select only one
                              lb_model->item (ii)->setSelected (true);
                              for (unsigned int j = 0;
                                   j < (unsigned int)lb_model->count (); j++)
                                {
                                  if (ii != j)
                                    {
                              ...
                              lb_model->scrollToItem (
                                  lb_model->currentItem ());
#if defined(USE_H)
                              if (batch->hydrate)
                                {
                                  if (!pdb_mode)
                                    {
                                      // we should never get here since bead
                                      // models normally don't contain multiple
                                      // models but possible some sort of DAM
                                      // model might...
                                      editor_msg (
                                          "dark red",
                                          "Bead models can not be hydrated, "
                                          "continuing without hydration\n");
                                    }
                                  else
                                    {
                                      job_timer.init_timer (
                                          QString ("%1 hydrate")
                                              .arg (get_file_name (i, m)));
                                      job_timer.start_timer (
                                          QString ("%1 hydrate")
                                              .arg (get_file_name (i, m)));
                                      result
                                          = ((US_Hydrodyn *)us_hydrodyn)
                                                        ->pdb_hydrate_for_saxs (
                                                            true)
                                                    != 0
                                                ? false
                                                : true;
                              ...
                              if (result)
                                {
                                  ...
                                  if (((US_Hydrodyn *)us_hydrodyn)
                                    ...
                                    {
                                      ((US_Hydrodyn *)us_hydrodyn)
                                          ->saxs_plot_window->clear_plot_saxs (
                                              true);
                                    }
                                  if (batch->saxs_search)
                                    {
                                      if (activate_saxs_search_window ())
                                        {
                                          job_timer.init_timer (
                                              QString ("%1 saxs_search")
                                                  .arg (get_file_name (i, m)));
                                          job_timer.start_timer (
                                              QString ("%1 saxs_search")
                                                  .arg (get_file_name (i, m)));
                                          ((US_Hydrodyn *)us_hydrodyn)
                                              ->saxs_search_window->start ();
                                          job_timer.end_timer (
                                              QString ("%1 saxs_search")
                                                  .arg (get_file_name (i, m)));
                                          result = true; // probably should
                                                         // grab status
                                        }
                                      else
                                        {
                                  ...
                                  if (batch->hydrate && pdb_mode
                                      ...
                                      && (unsigned int)lb_model->count () > 1)
                                    {
                                      ...
                                      cout << "remove: "
                                           << ((US_Hydrodyn *)us_hydrodyn)
                                                  ->last_hydrated_pdb_name
                                           << endl;
                                      qd.remove (((US_Hydrodyn *)us_hydrodyn)
                                                     ->last_hydrated_pdb_name);
                                    }
#endif
                                  if (batch->csv_saxs)
                          ...
                          if (batch->hydrate)
                            {
                              ...
                              if (!((US_Hydrodyn *)us_hydrodyn)->overwrite
                                  && QFile::exists (fname))
                                {
                                  fname = ((US_Hydrodyn *)us_hydrodyn)
                                              ->fileNameCheck (fname, 0, this);
                                }
                              QFile f (fname);
                              if (!f.open (QIODevice::WriteOnly))
                                {
                                  editor_msg (
                                      "red",
                                      QString (us_tr ("can not open file %1 "
                                                      "for writing"))
                                          .arg (fname));
                                }
                              else
                          ...
                          if (batch->hydrate)
                            {
                              if (!pdb_mode)
                                {
                                  // we should never get here since bead models
                                  // normally don't contain multiple models but
                                  // possible some sort of DAM model might...
                                  editor_msg (
                                      "dark red",
                                      "Bead models can not be hydrated, "
                                      "continuing without hydration\n");
                                ...
                                {
                                  ((US_Hydrodyn *)us_hydrodyn)->save_state ();
                                  result = ((US_Hydrodyn *)us_hydrodyn)
                                                       ->pdb_hydrate_for_saxs (
                                                           true)
                                                   != 0
                                               ? false
                                  ...
                                  if (activate_saxs_search_window ())
                                    {
                                      ((US_Hydrodyn *)us_hydrodyn)
                                          ->saxs_search_window->start ();
                                      result = true; // probably should grab
                                                     // status
                                    }
                                  else
                                    {
...
#if defined(USE_H)
                              if (batch->hydrate && pdb_mode && batch->mm_all
                                  && (unsigned int)lb_model->count () > 1)
                                {
                                  QDir qd;
                                  cout << "remove: "
                                  ...
                                  if (batch->saxs_search)
                                    {
                                      if (result
                                                 ...
                                                 ->saxs_search_widget)
                                        {
                                          ...
                                          saxs_q = ((US_Hydrodyn *)us_hydrodyn)
                                                       ->saxs_search_window
                                                       ->saxs_q;
                                        }
                                    }
                              ...
                              if (result)
                                {
                                  ...
                                  if (!pdb_mode && batch->equi_grid)
                                    {
                                      ((US_Hydrodyn *)us_hydrodyn)
                                          ->dammix_remember_mw.clear ();
                                      ((US_Hydrodyn *)us_hydrodyn)
                                          ->dammix_remember_mw_source.clear ();
                                      ((US_Hydrodyn *)us_hydrodyn)
                                          ->dammix_match_remember_mw.clear ();
                                      ((US_Hydrodyn *)us_hydrodyn)
                                          ->equi_grid_bead_model (-1e0);
                                    }
                                  job_timer.init_timer (
                                      QString ("%1 calc_prr")
                                          .arg (get_file_name (i, m)));
                                  ...
                                  if (batch->csv_saxs)
                                    {
                                      ...
                                      if (batch->hydrate)
                                        {
                                          csv_source_name_prr.push_back (
                                              file + " hydrated "
                                              + ((US_Hydrodyn *)us_hydrodyn)
                                                    ->state_lb_model_rows[ii]);
                                        }
                                      else
                                        {
#endif
                                      ...
                                      saxs_header_prr
                                          = ((US_Hydrodyn *)us_hydrodyn)
                                                ->last_saxs_header;
                                      saxs_header_prr.replace (
                                          QRegExp ("from .* by"), "by");
                                      if (saxs_r.size ()
                                          < ((US_Hydrodyn *)us_hydrodyn)
                                                ->last_saxs_r.size ())
                                        {
                                          saxs_r = ((US_Hydrodyn *)us_hydrodyn)
                                                       ->last_saxs_r;
                                        }
                                      saxs_prr.push_back (
                                          ((US_Hydrodyn *)us_hydrodyn)
                                              ->last_saxs_prr);
                                      saxs_prr_norm.push_back (
                                          ((US_Hydrodyn *)us_hydrodyn)
                                              ->last_saxs_prr_norm);
                                      saxs_prr_mw.push_back (
                                          ((US_Hydrodyn *)us_hydrodyn)
                                              ->last_saxs_prr_mw);
                                    }
#if defined(USE_H)
                  ...
                  if (result && (batch->hydro || batch->zeno || batch->grpy)
                    ...
                    {
                      save_us_hydrodyn_settings ();
                      job_timer.init_timer (QString ("%1 hydrodynamics")
                                                .arg (get_file_name (i, m)));
                      job_timer.start_timer (QString ("%1 hydrodynamics")
                                                 .arg (get_file_name (i, m)));
                      if (batch->mm_all)
                        {
                          lb_model->selectAll ();
                      ...
                      if (batch->hydro)
                        {
                          result = ((US_Hydrodyn *)us_hydrodyn)->calc_hydro ()
                                       ? false
                                       : true;
                        }
                      if (batch->zeno)
                          ...
                          if (result)
                            {
                              ...
                              while (
                                  ((US_Hydrodyn *)us_hydrodyn)->grpy_running)
                                {
                                  qApp->processEvents ();
                                  mQThread::msleep (333);
                                }
                              result
                                  = ((US_Hydrodyn *)us_hydrodyn)->grpy_success;
                              // qDebug() << "grpy finished";
                            }
                        }
                      job_timer.end_timer (QString ("%1 hydrodynamics")
                                               .arg (get_file_name (i, m)));
                      restore_us_hydrodyn_settings ();
                    }
                      ...
                      if (file.contains (QRegExp (".(pdb|PDB)$")))
                        {
                          save_us_hydrodyn_settings ();
                          job_timer.init_timer (
                              QString ("%1 hydrodynamics")
                                  .arg (get_file_name (i, m)));
                          job_timer.start_timer (
                              QString ("%1 hydrodynamics")
                                  .arg (get_file_name (i, m)));
                          result = ((US_Hydrodyn *)us_hydrodyn)
                                       ->calc_hullrad_hydro (file);
                          // us_qdebug( QString( "hullrad call result %1
                          // hullrad_running %2" ).arg( result ? "true" :
                          // "false" ).arg(  ((US_Hydrodyn
                          // *)us_hydrodyn)->hullrad_running ? "true" : "false"
                          // ) );
                          if (result)
                            {
                              // us_qdebug( QString( "hullrad true, so waiting"
                              // ) );
                              while (((US_Hydrodyn *)us_hydrodyn)
                                         ->hullrad_running)
                                {
                                  qApp->processEvents ();
                                  mQThread::msleep (333);
                                }
                              // us_qdebug( QString( "hullrad true and now not
                              // running" ) );
                            }
                          job_timer.end_timer (
                              QString ("%1 hydrodynamics")
                  ...
                  if (result)
                    {
                      ...
                      editor->append (
                          QString (us_tr ("Processing: %1 ok.").arg (file)));
                    }
                  else
                    {
                      ...
                      editor->setTextColor ("red");
                      editor->append (QString (
                          us_tr ("Processing: %1 FAILED.").arg (file)));
                    }
                }
              else
                {
  ...
  if (batch->fd && ((US_Hydrodyn *)us_hydrodyn)->saveParams
      && fd_save_info.data_vector.size ())
    {
      QString fname = ((US_Hydrodyn *)us_hydrodyn)->get_somo_dir ()
                      + QDir::separator () + fd_batch_save_name + ".csv";
          ...
          for (unsigned int i = 0; i < fd_save_info.data_vector.size (); ++i)
            {
              fprintf (
                  of, "%s",
                  ((US_Hydrodyn *)us_hydrodyn)
                      ->save_util->dataString (&fd_save_info.data_vector[i])
                      .toLatin1 ()
                      .data ());
            }
          fclose (of);
          editor_msg ("darkblue",
                      QString (us_tr ("Created file : %1\n")).arg (fname));
        }
    }
  ...
  if (save_batch_active)
    {
      ...
      if (((US_Hydrodyn *)us_hydrodyn)->save_params.data_vector.size () > 1)
        {
          stats = ((US_Hydrodyn *)us_hydrodyn)
                      ->save_util->stats (&((US_Hydrodyn *)us_hydrodyn)
                                               ->save_params.data_vector);
        }
          ...
          if (of)
            {
              ...
              for (unsigned int i = 0;
                   i < ((US_Hydrodyn *)us_hydrodyn)
                           ->save_params.data_vector.size ();
                   i++)
                {
                  fprintf (of, "%s",
                           ((US_Hydrodyn *)us_hydrodyn)
                               ->save_params.data_vector[i]
                               .hydro_res.toLatin1 ()
                               .data ());
                }
              if (stats.size () == 2)
                {
                  ...
                  US_Hydrodyn_Save::HydroTypes hydrotype
                      = US_Hydrodyn_Save::HydroTypes::HYDRO_UNKNOWN;
                  if (batch->hydro)
                    {
                  ...
                  fprintf (of, "%s",
                           ((US_Hydrodyn *)us_hydrodyn)
                               ->save_util->hydroFormatStats (stats, hydrotype)
                               .toLatin1 ()
                               .data ());
                }
              fclose (of);
              ...
              for (unsigned int i = 0;
                   ...
                   i++)
                {
                  fprintf (
                      ...
                      ((US_Hydrodyn *)us_hydrodyn)
                          ->save_util
                          ->dataString (&(((US_Hydrodyn *)us_hydrodyn)
                                              ->save_params.data_vector[i]))
                          .toLatin1 ()
                          .data ());
                }
              if (stats.size () == 2)
                {
                  fprintf (of, "%s",
                           ((US_Hydrodyn *)us_hydrodyn)
                               ->save_util->dataString (&stats[0])
                               .toLatin1 ()
                               .data ());
                  fprintf (of, "%s",
                           ((US_Hydrodyn *)us_hydrodyn)
                               ->save_util->dataString (&stats[1])
                               .toLatin1 ()
                               .data ());
                }
              fclose (of);
    ...
    if (!citation_type.isEmpty ())
      {
        editor_msg ("dark blue",
                    ((US_Hydrodyn *)us_hydrodyn)->info_cite (citation_type));
      }
  }
}

void
US_Hydrodyn_Batch::stop ()
{
...
void
US_Hydrodyn_Batch::clear_display ()
{
  editor->clear ();
  editor->append (
...
void
US_Hydrodyn_Batch::dragEnterEvent (QDragEnterEvent *event)
{
#if QT_VERSION < 0x040000
...
void
US_Hydrodyn_Batch::dropEvent (QDropEvent *event)
{
  disable_updates = true;
      ...
      while (it != fileNames.end ())
        {
          ...
          if (QString (*it).contains (
              ...
              if (!dup)
                {
                  ...
                  editor->setTextColor ("dark blue");
                  editor->append (
                      QString (us_tr ("File loaded: %1")).arg (*it));
                }
              else
                {
                  editor->setTextColor ("dark red");
          ...
          else
            {
              editor->setTextColor ("red");
              editor->append (
                  QString (us_tr ("File ignored: %1 (not a valid file name)"))
                      .arg (*it));
            }
          ++it;
        }
...
vector<int>
US_Hydrodyn_Batch::split_if_mm (int i)
{
  // get file if multi-model, split & create list of 'split' files for start()
  // loop
  ...
  QString file = get_file_name (i);
  if (!batch->mm_all
      || !file.contains (QRegularExpression (
          "\\.pdb$", QRegularExpression::CaseInsensitiveOption)))
    {
  ...
  QStringList contents_qsl;
  {
    ...
    if (contents_qsl
            .filter (QRegularExpression (
                "^MODEL", QRegularExpression::CaseInsensitiveOption))
            .size ()
        <= 1)
      {
...

  {
    ...
    editor_msg ("dark blue",
                QString (us_tr ("Splitting multi model pdb %1").arg (file)));
    ...
    QString fn = split_dir->path () + "/"
                 + QFileInfo (file).fileName ().replace (
                     QRegularExpression (
                         "\\.pdb$", QRegularExpression::CaseInsensitiveOption),
                     "");
                    ...
                    if (!fn_out.open (QIODevice::WriteOnly))
                      {
                        editor_msg (
                            "red",
                            QString (us_tr ("could not create file %1, "
                                            "resorting to single file\n"))
                                .arg (use_fn));
                        models.clear ();
                        models.push_back (-1);
                        return models;
...
QString
US_Hydrodyn_Batch::get_file_name (int i, int m)
{
...
#if defined(BW_LISTBOX)
  return lb_files->item (i)
      ->text ()
      .replace (QRegExp ("^(File missing|"
                         "Screening|"
                         "Screen done|"
                         "Screen failed|"
                         "Processing|"
...
void
US_Hydrodyn_Batch::check_for_missing_files (bool display_messages)
{
  ...
  bool item_selected
      = item >= 0 ? lb_files->item (item)->isSelected () : false;
  unsigned int count = 0;
  for (int i = 0; i < lb_files->count (); i++)
    {
      if (!(count++ % 500))
          ...
          if (display_messages)
            {
              editor->setTextColor ("red");
              editor->append (
                  QString (us_tr ("File does not exist: %1")).arg (f));
              editor->setTextColor (save_color);
            }
        }
      lb_files->item (i)->setText (
          QString ("%1%2").arg (status_color[status[f]]).arg (f));
...
void
US_Hydrodyn_Batch::set_counts ()
{
  lbl_total_files->setText (
      QString ("Total files: %1").arg (lb_files->count ()));
  unsigned int count = 0;
  for (int i = 0; i < lb_files->count (); i++)
    {
      if (lb_files->item (i)->isSelected ())
...
int
US_Hydrodyn_Batch::count_files ()
{
  return lb_files->count ();
}

void
US_Hydrodyn_Batch::clear_files ()
{
  batch->file.clear ();
  status.clear ();
  lb_files->clear ();
...
US_Hydrodyn_Batch::make_movie ()
{
  ...
  US_Hydrodyn_Batch_Movie_Opts *hbmo = new US_Hydrodyn_Batch_Movie_Opts (
      QString (us_tr ("Select parameters for movie file:")), &title, &proc_dir,
      ((US_Hydrodyn *)us_hydrodyn)->somo_dir, &output_file, &fps, &scale,
      &cancel_req, &clean_up, &use_tc, &tc_unit, &tc_start, &tc_delta,
      &tc_pointsize, &black_background, &do_pat);
      ...
      if (!fi.exists ())
        {
          ...
          if (!new_dir.mkdir (proc_dir))
            {
              editor->setTextColor ("red");
              editor->append (us_tr ("Error: Could not create directory "
                                     + proc_dir + "\n"));
              editor->setTextColor (save_color);
              cancel_req = true;
            }
          else
            {
              editor->setTextColor ("dark blue");
              editor->append (
                  us_tr ("Notice: creating directory " + proc_dir + "\n"));
              editor->setTextColor (save_color);
            }
        }
      else
        {
          if (!fi.isDir ())
            {
              editor->setTextColor ("red");
              editor->append (us_tr ("Error: ") + proc_dir
                              + us_tr (" not a directory\n"));
              editor->setTextColor (save_color);
              cancel_req = true;
            }
          else
              ...
              if (!fi.isWritable ())
                {
                  editor->setTextColor ("red");
                  editor->append (
                      us_tr ("Error: ") + proc_dir
                      + us_tr (" not writable (check permissions)\n"));
                  editor->setTextColor (save_color);
                  cancel_req = true;
                }
            }
          ...
          if (file.contains (QRegExp (".(pdb|PDB)$")))
            {
              ...
              editor->append (
                  QString (
                      us_tr ("PDB not yet supported for movie frames: %1"))
                      .arg (file));
            }
          else
            {
              ...
              editor->setTextColor ("dark blue");
              editor->append (
                  QString (us_tr ("Creating movie frame for %1")).arg (file));
              ((US_Hydrodyn *)us_hydrodyn)
                  ->visualize (true, proc_dir, scale, black_background,
                               do_pat);
            }
        }
    }
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->movie_text.size ())
    {
      ...
      QString cmdlog = cd + "cat <<__EOF > " + output_file
                       + ".log\n"
                         "title:           ["
                       + title
                       + "]\n"
                       ...
                       + "]\n"
                         "tc_unit:         ["
                       + QString ("%1").arg (tc_unit)
                       + "]\n"
                         "tc_start:        ["
                       + QString ("%1").arg (tc_start)
                       + "]\n"
                         "tc_delta:        ["
                       + QString ("%1").arg (tc_delta)
                       + "]\n"
                         "tc_pointsize:    ["
                       + QString ("%1").arg (tc_pointsize)
                       + "]\n"
                         "black_background:["
                       + (black_background ? "true" : "false")
                       + "]\n"
                         "__EOF\n";
      QString cmd0 = cd + "rm -f " + output_file + ".list\n";
      vector<QString> cmd1;
      QString cmd2 = cd + "cat " + output_file + ".list | xargs mencoder -o "
                     + output_file + ".avi -ovc lavc -fps "
                     + QString ("%1").arg (fps);
      vector<QString> cmd3;
      for (unsigned int i = 0;
           i < ((US_Hydrodyn *)us_hydrodyn)->movie_text.size (); i++)
        {
          ...
          cmd1.push_back (
              cd + "pnmquant 256 " + fi.fileName () + ".ppm > "
              + fi.fileName () + "-q.ppm\n" + "ppmtogif " + fi.fileName ()
              + "-q.ppm > " + fi.fileName () + ".gif\n" + "echo "
              + fi.fileName () + ".gif >> " + output_file + ".list\n"
              + (use_tc ? QString ("mogrify -gravity southwest -fill %1 -font "
                                   "Courier-10-Pitch-Regular -pointsize %2 "
                                   "-draw 'text 25,25 \"%3 %4\"' ")
                                  .arg (black_background ? "white" : "black")
                                  .arg (tc_pointsize)
                                  .arg (QString ("").sprintf (
                                      qPrintable (tc_format_string), tc_start))
                                  .arg (tc_unit)
                              + fi.fileName () + ".gif\n"
                        : "")
              + (title != ""
                     ? QString ("mogrify -gravity north -fill %1 -pointsize "
                                "%2 -draw 'text 25,0 \"%3\"' ")
                               .arg (black_background ? "white" : "black")
                               .arg (tc_pointsize)
                               .arg (title)
                           + fi.fileName () + ".gif\n"
                     : ""));
          cmd3.push_back (cd + "rm " + fi.fileName ()
                          + ".gif;"
                            "rm "
                          + fi.fileName ()
                          + ".ppm;"
      ...
      editor_msg ("dark blue", QString (us_tr ("Created movie file %1"))
                                   .arg (output_file + ".avi"));
    }
  else
    {
...
QString
US_Hydrodyn_Batch::vector_double_to_csv (vector<double> vd)
{
  QString result;
...
void
US_Hydrodyn_Batch::save_csv_saxs_iqq (bool quiet)
{
  QString fname = ((US_Hydrodyn *)us_hydrodyn)->somo_dir + SLASH + "saxs"
                  + SLASH + batch->csv_saxs_name + "_iqq" + iqq_suffix ()
                  + ".csv";
      ...
      if (batch->compute_iq_avg)
        {
          ...
          for (unsigned int i = 0; i < csv_source_name_iqq.size (); i++)
            {
              // cout << "model: " << i << " " <<
              // vector_double_to_csv(saxs_iqq[i]) << endl;
                  ...
                  for (unsigned int i = 0; i < sum_iq.size (); i++)
                    {
                      double tmp_std_dev
                          = sum_iq2[i]
                            - ((sum_iq[i] * sum_iq[i]) / (double)sum_count);
                      iq_std_dev[i]
                          = tmp_std_dev > 0e0
                                ? sqrt ((1e0 / ((double)sum_count - 1e0))
                                        * tmp_std_dev)
                                : 0e0;
                      // iq_std_dev[i] = sqrt(
                      // ( 1e0 / ((double)sum_count - 1e0) ) *
                      //                   ( sum_iq2[i] - ((sum_iq[i] *
                      //                   sum_iq[i]) / (double)sum_count) ) );
                    }
              ...
              if (saxs_iqqa[i].size ())
                {
                  ...
                  fprintf (
                      of, "\"%s\",\"%s\",%s\n",
                      csv_source_name_iqq[i].toLatin1 ().data (), "Ia(q)",
              ...
              if (saxs_iqqc[i].size ())
                {
                  fprintf (
                      of, "\"%s\",\"%s\",%s\n",
                      csv_source_name_iqq[i].toLatin1 ().data (), "Ic(q)",
          ...
          if (batch->compute_iq_std_dev && sum_count > 2)
            {
              ...
              fprintf (of, "\"%s\",\"%s\",%s\n", "Standard deviation", "I(q)",
                       vector_double_to_csv (iq_std_dev).toLatin1 ().data ());
              fprintf (of, "\"%s\",\"%s\",%s\n",
                       "Average minus 1 standard deviation", "I(q)",
                       vector_double_to_csv (iq_avg_minus_std_dev)
                           .toLatin1 ()
                           .data ());
              fprintf (of, "\"%s\",\"%s\",%s\n",
                       "Average plus 1 standard deviation", "I(q)",
                       vector_double_to_csv (iq_avg_plus_std_dev)
                           .toLatin1 ()
                           .data ());
            }
        }
...
void
US_Hydrodyn_Batch::save_csv_saxs_prr ()
{
  QString fname = ((US_Hydrodyn *)us_hydrodyn)->somo_dir + SLASH + "saxs"
                  + SLASH + batch->csv_saxs_name + "_sprr_"
                  + ((US_Hydrodyn *)us_hydrodyn)->saxs_sans_ext () + ".csv";
  ...
  if (of)
    {
      ...
      if (batch->compute_prr_avg)
        {
          ...
          for (unsigned int i = 0; i < csv_source_name_prr.size (); i++)
            {
              // cout << "model: " << i << " " <<
              // vector_double_to_csv(saxs_prr[i]) << endl;
              ...
              if (batch->compute_prr_std_dev && sum_count > 2)
                {
                  ...
                  for (unsigned int i = 0; i < sum_pr.size (); i++)
                    {
                      double tmp_std_dev
                          = sum_pr2[i]
                            - ((sum_pr[i] * sum_pr[i]) / (double)sum_count);
                      pr_std_dev[i]
                          = tmp_std_dev > 0e0
                                ? sqrt ((1e0 / ((double)sum_count - 1e0))
                                        * tmp_std_dev)
                  ...
                  double pr_std_dev_area
                      = compute_pr_area (pr_std_dev, this_r);
      ...
      fprintf (of,
               "\"Name\",\"MW (Daltons)\",\"Area\",\"Type; r:\",%s,\"%s\"\n",
      ...
      for (unsigned int i = 0; i < csv_source_name_prr.size (); i++)
        {
          ...
          fprintf (of, "\"%s\",%.2f,%.2f,\"%s\",%s\n",
                   csv_source_name_prr[i].toLatin1 ().data (), saxs_prr_mw[i],
                   compute_pr_area (saxs_prr[i], saxs_r), "P(r)",
      ...
      for (unsigned int i = 0; i < csv_source_name_prr.size (); i++)
        {
          fprintf (
              of, "\"%s\",%.2f,%.2f,\"%s\",%s\n",
              csv_source_name_prr[i].toLatin1 ().data (), saxs_prr_mw[i],
              compute_pr_area (saxs_prr_norm[i], saxs_r), "P(r) normed",
              vector_double_to_csv (saxs_prr_norm[i]).toLatin1 ().data ());
        }
      if (batch->compute_prr_avg && sum_count > 1)
        {
          fprintf (of, "\n\"%s\",%.2f,%.2f,\"%s\",%s\n", "Average", pr_mw_avg,
                   compute_pr_area (pr_avg, saxs_r), "P(r)",
                   vector_double_to_csv (pr_avg).toLatin1 ().data ());
          if (batch->compute_prr_std_dev && sum_count > 2)
            {
              fprintf (of, "\"%s\",%.2f,%.2f,\"%s\",%s\n",
                       "Standard deviation", pr_mw_std_dev,
                       compute_pr_area (pr_std_dev, saxs_r), "P(r)",
                       vector_double_to_csv (pr_std_dev).toLatin1 ().data ());
              fprintf (of, "\"%s\",%.2f,%.2f,\"%s\",%s\n",
                       "Average minus 1 standard deviation",
                       pr_mw_avg - pr_mw_std_dev,
                       compute_pr_area (pr_avg_minus_std_dev, saxs_r), "P(r)",
                       vector_double_to_csv (pr_avg_minus_std_dev)
                           .toLatin1 ()
                           .data ());
              fprintf (of, "\"%s\",%.2f,%.2f,\"%s\",%s\n",
                       "Average plus 1 standard deviation",
                       pr_mw_avg + pr_mw_std_dev,
                       compute_pr_area (pr_avg_plus_std_dev, saxs_r), "P(r)",
                       vector_double_to_csv (pr_avg_plus_std_dev)
                           .toLatin1 ()
                           .data ());
            }
        }
...
double
US_Hydrodyn_Batch::compute_pr_area (vector<double> vd, vector<double> r)
{
  double sum = 0e0;
  for (unsigned int i = 0; i < vd.size (); i++)
    {
...
void
US_Hydrodyn_Batch::editor_msg (QString color, QString msg)
{
  QColor save_color = editor->textColor ();
...
void
US_Hydrodyn_Batch::open_saxs_options ()
{
  ((US_Hydrodyn *)us_hydrodyn)->show_saxs_options ();
}

bool
US_Hydrodyn_Batch::activate_saxs_search_window ()
{
  ((US_Hydrodyn *)us_hydrodyn)->pdb_saxs (true, false);
  raise ();
  if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_widget)
...
void
US_Hydrodyn_Batch::cluster ()
{
  // create cluster control files for each model & save
  // check for target file
  US_Hydrodyn_Cluster *hc = new US_Hydrodyn_Cluster (us_hydrodyn, this);
...
bool
US_Hydrodyn_Batch::create_split_dir ()
{
  split_dir = new QTemporaryDir (((US_Hydrodyn *)us_hydrodyn)->somo_tmp_dir
                                 + "/batch_XXXXXX");
...
void
US_Hydrodyn_Batch::remove_split_dir ()
{
  if (split_dir)
    {
      if (split_dir->isValid ())
