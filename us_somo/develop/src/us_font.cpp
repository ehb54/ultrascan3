...
US_Font::US_Font (QString *temp_fontFamily, int *temp_fontSize, QWidget *p,
                  const char *)
    : QDialog (p)
{
...
void
US_Font::closeEvent (QCloseEvent *e)
{
  e->accept ();
  global_Xpos -= 30;
  global_Ypos -= 30;
...
US_Font::selectFont ()
{
  ...
  *fontSize = currentFont.pointSize ();
  //   lbl_info->setFont(QFont(currentFont.family(), currentFont.pointSize(),
  //   QFont::Bold)); pb_font->setFont(QFont(currentFont.family(),
  //   currentFont.pointSize()));
  //   lbl_family1->setFont(QFont(currentFont.family(),
  //   currentFont.pointSize()));
  lbl_family2->setFont (
      QFont (currentFont.family (), currentFont.pointSize ()));
  //   lbl_point1->setFont(QFont(currentFont.family(),
  //   currentFont.pointSize()));
  lbl_point2->setFont (
      QFont (currentFont.family (), currentFont.pointSize ()));
  lbl_font1->setFont (
      QFont (currentFont.family (), currentFont.pointSize () - 1));
  lbl_font2->setFont (QFont (currentFont.family (), currentFont.pointSize ()));
  lbl_font3->setFont (
      QFont (currentFont.family (), currentFont.pointSize (), QFont::Bold));
  lbl_font4->setFont (
      QFont (currentFont.family (), currentFont.pointSize () + 1));
  lbl_font5->setFont (QFont (currentFont.family (),
                             currentFont.pointSize () + 1, QFont::Bold));
  lbl_font6->setFont (QFont (currentFont.family (),
                             currentFont.pointSize () + 2, QFont::Bold));
