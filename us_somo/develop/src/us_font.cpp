...
void US_Font::cancel() { reject(); }

void US_Font::check() { accept(); }
...
void US_Font::selectFont() {
  ...
  *fontSize = currentFont.pointSize();
  ...
  lbl_font5->setFont(
      QFont(currentFont.family(), currentFont.pointSize() + 1, QFont::Bold));
  lbl_font6->setFont(
      QFont(currentFont.family(), currentFont.pointSize() + 2, QFont::Bold));
