    ...
    : QDialog (p)
{
  ...
  options_active = (((US_Hydrodyn *)us_hydrodyn)
...
void
US_Hydrodyn_Cluster_Additional::setupGUI ()
{
  ...
  cb_bfnb->setChecked (options_active.count ("bfnb")
                       && options_active["bfnb"]);
  cb_bfnb->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  pb_bfnb->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  cb_bfnb_nsa->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  pb_bfnb_nsa->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cb_best->setChecked (options_active.count ("best")
                       && options_active["best"]);
  cb_best->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  cb_oned->setChecked (options_active.count ("oned")
                       && options_active["oned"]);
  cb_oned->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  pb_oned->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  cb_csa->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  pb_csa->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  cb_dammin->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  pb_dammin->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_dammif->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  pb_dammif->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_gasbor->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  pb_gasbor->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Cluster_Additional::ok ()
{
...
void
US_Hydrodyn_Cluster_Additional::cancel ()
{
  close ();
}

void
US_Hydrodyn_Cluster_Additional::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster_Additional::closeEvent (QCloseEvent *e)
{
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept ();
...
void
US_Hydrodyn_Cluster_Additional::update_enables ()
{
...
void
US_Hydrodyn_Cluster_Additional::set_bfnb ()
{
...
void
US_Hydrodyn_Cluster_Additional::bfnb ()
{
...
void
US_Hydrodyn_Cluster_Additional::set_bfnb_nsa ()
{
...
void
US_Hydrodyn_Cluster_Additional::bfnb_nsa ()
{
  cout << QString ("current load save path %1\n").arg (load_save_path);
  map<QString, QString> parameters;
...
void
US_Hydrodyn_Cluster_Additional::set_best ()
{
...
void
US_Hydrodyn_Cluster_Additional::best ()
{
  cout << QString ("current load save path %1\n").arg (load_save_path);
  map<QString, QString> parameters;
...
void
US_Hydrodyn_Cluster_Additional::set_oned ()
{
...
void
US_Hydrodyn_Cluster_Additional::oned ()
{
  QDir::setCurrent (load_save_path);
  map<QString, QString> parameters;
...
void
US_Hydrodyn_Cluster_Additional::set_csa ()
{
...
void
US_Hydrodyn_Cluster_Additional::csa ()
{
  QDir::setCurrent (load_save_path);
}

void
US_Hydrodyn_Cluster_Additional::set_dammin ()
{
...
void
US_Hydrodyn_Cluster_Additional::dammin ()
{
  QDir::setCurrent (load_save_path);
  map<QString, QString> parameters;
...
void
US_Hydrodyn_Cluster_Additional::set_dammif ()
{
...
void
US_Hydrodyn_Cluster_Additional::dammif ()
{
  QDir::setCurrent (load_save_path);
}

void
US_Hydrodyn_Cluster_Additional::set_gasbor ()
{
...
void
US_Hydrodyn_Cluster_Additional::gasbor ()
{
  QDir::setCurrent (load_save_path);
}
