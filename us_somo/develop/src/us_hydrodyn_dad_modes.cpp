...
void US_Hydrodyn_Dad::rgc_mw_text( const QString & )
{
   rgc_calc_rg();
}
...
void US_Hydrodyn_Dad::rgc_rho_text( const QString & )
{
   rgc_calc_rg();
}
...
void US_Hydrodyn_Dad::wyatt_apply()
{
...
void US_Hydrodyn_Dad::scale_apply()
{
   ...
   // setup for scale analysis
   {
      ...
      // US_Hydrodyn_Dad_Scale_Trend * uhshst = new US_Hydrodyn_Dad_Scale_Trend( us_hydrodyn,
      //                                                                                     parameters,
      //                                                                                     plots );
      // uhshst->show();
   }
...
void US_Hydrodyn_Dad::timescale()
{
