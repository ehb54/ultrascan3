...
US_Hydrodyn_BD_Load_Results_Opts::US_Hydrodyn_BD_Load_Results_Opts(
    ...
    double *psv, double browflex_temperature, double browflex_solvent_viscosity,
    bool *check_fix_overlaps, QWidget *p, const char *)
    : QDialog(p) {
  this->msg = msg;
...
void US_Hydrodyn_BD_Load_Results_Opts::setupGUI() {
  ...
  lbl_browflex_temperature =
      new QLabel(QString("").sprintf("%4.2f", browflex_temperature), this);
  ...
  lbl_browflex_temperature->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_browflex_solvent_viscosity =
      new QLabel(QString("").sprintf("%f", browflex_solvent_viscosity), this);
  ...
  lbl_browflex_solvent_viscosity->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...
void US_Hydrodyn_BD_Load_Results_Opts::cancel() { close(); }
...
void US_Hydrodyn_BD_Load_Results_Opts::update_solvent_acronym(
    const QString &str) {
...
void US_Hydrodyn_BD_Load_Results_Opts::update_solvent_viscosity(
    const QString &str) {
...
void US_Hydrodyn_BD_Load_Results_Opts::update_solvent_density(
    const QString &str) {
...
int US_Hydrodyn_BD_Load_Results_Opts::write_conditions_to_file(
    QString /* filename */) {
  return -1;
}

void US_Hydrodyn_BD_Load_Results_Opts::read_conditions_from_file(
    QString /* filename */) {}
