...
void
US_Hydrodyn_Mals_Saxs_P3d::setupGUI ()
{
  int minHeight1 = 30;
...
void
US_Hydrodyn_Mals_Saxs_P3d::plot_all ()
{
  for (unsigned int i = 0; i < (unsigned int)cb_plot_curves.size (); i++)
    {
...
void
US_Hydrodyn_Mals_Saxs_P3d::quit ()
{
  close ();
}

void
US_Hydrodyn_Mals_Saxs_P3d::plot ()
{
...
void
US_Hydrodyn_Mals_Saxs_P3d::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Mals_Saxs_P3d::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Mals_Saxs_P3d::update_enables ()
{
