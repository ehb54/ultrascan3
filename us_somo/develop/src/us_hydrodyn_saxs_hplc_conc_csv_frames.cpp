...
void US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames::showhide( vector < QWidget * > & widgets, bool isChecked ) {
...
void US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames::update_starttime( const QString & str )
{
...
void US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames::update_pointcount( const QString & str )
{
...
void US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames::update_time2frame( const QString & str )
{
...
void US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames::update_startframenumber( const QString & str )
{
...
void US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames::update_endframenumber( const QString & str )
{
