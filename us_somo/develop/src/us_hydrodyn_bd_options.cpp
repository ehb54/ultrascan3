...
void
US_Hydrodyn_BD_Options::setupGUI ()
{
  QFont qf;
  QString str;
  ...
  lbl_info_simulation_opts
      = new QLabel (us_tr ("Simulation Parameters:"), this);
  ...
  cnt_bd_threshold_pb_pb->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cnt_bd_threshold_pb_sc->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  cnt_bd_threshold_sc_sc->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  cb_bead_size_type_1st->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  cb_bead_size_type_min->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  cb_bead_size_type_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  rb_bead_size_type_1st->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  rb_bead_size_type_min->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  rb_bead_size_type_avg->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  cnt_npadif->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_nmol);
  le_nmol->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_nconf);
  le_nconf->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_iseed);
  le_iseed->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  cb_do_rr->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  cb_force_chem->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_icdm->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  cb_show_pdb->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cb_run_browflex->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_tprev);
  le_tprev->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_ttraj);
  le_ttraj->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_deltat);
  le_deltat->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_compute_chem_pb_pb_force_constant->setFont (QFont (
  ...
  cb_compute_chem_pb_pb_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_pb_pb_max_elong->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_pb_sc_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_pb_sc_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_pb_sc_max_elong->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_sc_sc_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_sc_sc_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_chem_sc_sc_max_elong->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_pb_pb_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_pb_pb_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_pb_pb_max_elong->setChecked (
  ...
  cb_compute_pb_pb_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  cb_compute_pb_sc_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_pb_sc_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_pb_sc_max_elong->setChecked (
  ...
  cb_compute_pb_sc_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  cb_compute_sc_sc_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_sc_sc_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_compute_sc_sc_max_elong->setChecked (
  ...
  cb_compute_sc_sc_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  cb_inter_no_hi->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  cb_inter_os->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cb_inter_mos->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  rb_inter_no_hi->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  rb_inter_os->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  rb_inter_mos->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  cb_iorder_em->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  cb_iorder_igt->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  rb_iorder_em->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  rb_iorder_igt->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
...
#if QT_VERSION < 0x040000
  bg_chem_pb_pb_bond_types
      = new QGroupBox (4, Qt::Vertical, "Bond type:", this);
  ...
  cb_chem_pb_pb_bond_type_fraenkel->setText (
      us_tr (" Fraenkel (hard Hookean) "));
  cb_chem_pb_pb_bond_type_fraenkel->setEnabled (true);
  //   cb_chem_pb_pb_bond_type_fraenkel->setMinimumHeight(minHeight1);
  cb_chem_pb_pb_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_pb_pb_bond_type_hookean->setText (
      us_tr (" Hookean,Gaussian (soft) "));
  cb_chem_pb_pb_bond_type_hookean->setEnabled (true);
  //   cb_chem_pb_pb_bond_type_hookean->setMinimumHeight(minHeight1);
  cb_chem_pb_pb_bond_type_hookean->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_pb_pb_bond_type_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_pb_pb_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_chem_pb_pb_bond_type_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_chem_pb_pb_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_pb_sc_bond_type_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_pb_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_chem_pb_sc_bond_type_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_chem_pb_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_sc_sc_bond_type_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_chem_sc_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_chem_sc_sc_bond_type_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_chem_sc_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_pb_pb_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_pb_pb_bond_type_hookean->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  cb_pb_pb_bond_type_fene->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  cb_pb_pb_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_pb_pb_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_pb_pb_bond_type_hookean->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  rb_pb_pb_bond_type_fene->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  rb_pb_pb_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_pb_sc_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_pb_sc_bond_type_hookean->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  cb_pb_sc_bond_type_fene->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  cb_pb_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_pb_sc_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_pb_sc_bond_type_hookean->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  rb_pb_sc_bond_type_fene->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  rb_pb_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_sc_sc_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_sc_sc_bond_type_hookean->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  cb_sc_sc_bond_type_fene->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  cb_sc_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_sc_sc_bond_type_fraenkel->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_sc_sc_bond_type_hookean->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  rb_sc_sc_bond_type_fene->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  rb_sc_sc_bond_type_hard_fene->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_chem_pb_pb_force_constant->setAlignment (Qt::AlignLeft
                                               | Qt::AlignVCenter);
  ...
  le_chem_pb_pb_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_chem_pb_pb_force_constant->setEnabled (true);
  connect (le_chem_pb_pb_force_constant,
  ...
  le_chem_pb_pb_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_chem_pb_pb_equilibrium_dist->setEnabled (true);
  connect (le_chem_pb_pb_equilibrium_dist,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_chem_pb_pb_equilibrium_dist (const QString &)));

  lbl_chem_pb_pb_max_elong
      = new QLabel (us_tr (" Maximum elongation: "), this);
  ...
  le_chem_pb_pb_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_chem_pb_sc_force_constant
      = new QLabel (us_tr (" Hookean spring constant: "), this);
  lbl_chem_pb_sc_force_constant->setAlignment (Qt::AlignLeft
                                               | Qt::AlignVCenter);
  ...
  le_chem_pb_sc_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_chem_pb_sc_force_constant->setEnabled (true);
  connect (le_chem_pb_sc_force_constant,
           SIGNAL (textChanged (const QString &)),
  ...
  le_chem_pb_sc_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_chem_pb_sc_equilibrium_dist->setEnabled (true);
  connect (le_chem_pb_sc_equilibrium_dist,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_chem_pb_sc_equilibrium_dist (const QString &)));

  lbl_chem_pb_sc_max_elong
      = new QLabel (us_tr (" Maximum elongation: "), this);
  ...
  le_chem_pb_sc_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_chem_sc_sc_force_constant
      = new QLabel (us_tr (" Hookean spring constant: "), this);
  lbl_chem_sc_sc_force_constant->setAlignment (Qt::AlignLeft
                                               | Qt::AlignVCenter);
  ...
  le_chem_sc_sc_force_constant->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_chem_sc_sc_force_constant->setEnabled (true);
  connect (le_chem_sc_sc_force_constant,
           SIGNAL (textChanged (const QString &)),
  ...
  le_chem_sc_sc_equilibrium_dist->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  le_chem_sc_sc_equilibrium_dist->setEnabled (true);
  connect (le_chem_sc_sc_equilibrium_dist,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_chem_sc_sc_equilibrium_dist (const QString &)));

  lbl_chem_sc_sc_max_elong
      = new QLabel (us_tr (" Maximum elongation: "), this);
  ...
  le_chem_sc_sc_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  le_pb_pb_force_constant->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_pb_pb_equilibrium_dist->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_pb_pb_equilibrium_dist = new QLineEdit (this);
  le_pb_pb_equilibrium_dist->setObjectName (
      "Pb_Pb_Equilibrium_Dist Line Edit");
  ...
  le_pb_pb_equilibrium_dist->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  le_pb_pb_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  le_pb_sc_force_constant->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_pb_sc_equilibrium_dist->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_pb_sc_equilibrium_dist = new QLineEdit (this);
  le_pb_sc_equilibrium_dist->setObjectName (
      "Pb_Sc_Equilibrium_Dist Line Edit");
  ...
  le_pb_sc_equilibrium_dist->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  le_pb_sc_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  le_sc_sc_force_constant->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_sc_sc_equilibrium_dist->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_sc_sc_equilibrium_dist = new QLineEdit (this);
  le_sc_sc_equilibrium_dist->setObjectName (
      "Sc_Sc_Equilibrium_Dist Line Edit");
  ...
  le_sc_sc_equilibrium_dist->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  le_sc_sc_max_elong->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  j++;
  //   gl_simu->addWidget( cb_icdm , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1 ) - (
  //   0 ) ); j++;
...
void
US_Hydrodyn_BD_Options::cancel ()
{
  close ();
}

void
US_Hydrodyn_BD_Options::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_BD_Options::closeEvent (QCloseEvent *e)
{
  *bd_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_BD_Options::update_bd_threshold_pb_pb (double val)
{
...
void
US_Hydrodyn_BD_Options::update_bd_threshold_pb_sc (double val)
{
...
void
US_Hydrodyn_BD_Options::update_bd_threshold_sc_sc (double val)
{
...
void
US_Hydrodyn_BD_Options::set_do_rr ()
{
...
void
US_Hydrodyn_BD_Options::set_force_chem ()
{
...
void
US_Hydrodyn_BD_Options::set_icdm ()
{
...
void
US_Hydrodyn_BD_Options::set_show_pdb ()
{
...
void
US_Hydrodyn_BD_Options::set_run_browflex ()
{
...
void
US_Hydrodyn_BD_Options::set_bead_size_type ()
{
...
void
US_Hydrodyn_BD_Options::set_bead_size_type (int val)
{
...
void
US_Hydrodyn_BD_Options::set_compute_chem_pb_pb_force_constant ()
{
  (*bd_options).compute_chem_pb_pb_force_constant
...
void
US_Hydrodyn_BD_Options::set_compute_chem_pb_pb_equilibrium_dist ()
{
  (*bd_options).compute_chem_pb_pb_equilibrium_dist
...
void
US_Hydrodyn_BD_Options::set_compute_chem_pb_pb_max_elong ()
{
  (*bd_options).compute_chem_pb_pb_max_elong
...
void
US_Hydrodyn_BD_Options::set_compute_chem_pb_sc_force_constant ()
{
  (*bd_options).compute_chem_pb_sc_force_constant
...
void
US_Hydrodyn_BD_Options::set_compute_chem_pb_sc_equilibrium_dist ()
{
  (*bd_options).compute_chem_pb_sc_equilibrium_dist
...
void
US_Hydrodyn_BD_Options::set_compute_chem_pb_sc_max_elong ()
{
  (*bd_options).compute_chem_pb_sc_max_elong
...
void
US_Hydrodyn_BD_Options::set_compute_chem_sc_sc_force_constant ()
{
  (*bd_options).compute_chem_sc_sc_force_constant
...
void
US_Hydrodyn_BD_Options::set_compute_chem_sc_sc_equilibrium_dist ()
{
  (*bd_options).compute_chem_sc_sc_equilibrium_dist
...
void
US_Hydrodyn_BD_Options::set_compute_chem_sc_sc_max_elong ()
{
  (*bd_options).compute_chem_sc_sc_max_elong
...
void
US_Hydrodyn_BD_Options::set_compute_pb_pb_force_constant ()
{
  (*bd_options).compute_pb_pb_force_constant
...
void
US_Hydrodyn_BD_Options::set_compute_pb_pb_equilibrium_dist ()
{
  (*bd_options).compute_pb_pb_equilibrium_dist
...
void
US_Hydrodyn_BD_Options::set_compute_pb_pb_max_elong ()
{
  (*bd_options).compute_pb_pb_max_elong
...
void
US_Hydrodyn_BD_Options::set_compute_pb_sc_force_constant ()
{
  (*bd_options).compute_pb_sc_force_constant
...
void
US_Hydrodyn_BD_Options::set_compute_pb_sc_equilibrium_dist ()
{
  (*bd_options).compute_pb_sc_equilibrium_dist
...
void
US_Hydrodyn_BD_Options::set_compute_pb_sc_max_elong ()
{
  (*bd_options).compute_pb_sc_max_elong
...
void
US_Hydrodyn_BD_Options::set_compute_sc_sc_force_constant ()
{
  (*bd_options).compute_sc_sc_force_constant
...
void
US_Hydrodyn_BD_Options::set_compute_sc_sc_equilibrium_dist ()
{
  (*bd_options).compute_sc_sc_equilibrium_dist
...
void
US_Hydrodyn_BD_Options::set_compute_sc_sc_max_elong ()
{
  (*bd_options).compute_sc_sc_max_elong
...
void
US_Hydrodyn_BD_Options::set_inter ()
{
...
void
US_Hydrodyn_BD_Options::set_inter (int val)
{
...
void
US_Hydrodyn_BD_Options::set_iorder ()
{
...
void
US_Hydrodyn_BD_Options::set_iorder (int val)
{
...
void
US_Hydrodyn_BD_Options::update_tprev (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_ttraj (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_deltat (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_npadif (double val)
{
...
void
US_Hydrodyn_BD_Options::update_nconf (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_nmol (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_iseed (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::set_chem_pb_pb_bond_types ()
{
...
void
US_Hydrodyn_BD_Options::set_chem_pb_pb_bond_types (int val)
{
...
void
US_Hydrodyn_BD_Options::set_chem_pb_sc_bond_types ()
{
...
void
US_Hydrodyn_BD_Options::set_chem_pb_sc_bond_types (int val)
{
...
void
US_Hydrodyn_BD_Options::set_chem_sc_sc_bond_types ()
{
...
void
US_Hydrodyn_BD_Options::set_chem_sc_sc_bond_types (int val)
{
...
void
US_Hydrodyn_BD_Options::set_pb_pb_bond_types ()
{
...
void
US_Hydrodyn_BD_Options::set_pb_pb_bond_types (int val)
{
...
void
US_Hydrodyn_BD_Options::set_pb_sc_bond_types ()
{
...
void
US_Hydrodyn_BD_Options::set_pb_sc_bond_types (int val)
{
...
void
US_Hydrodyn_BD_Options::set_sc_sc_bond_types ()
{
...
void
US_Hydrodyn_BD_Options::set_sc_sc_bond_types (int val)
{
...
void
US_Hydrodyn_BD_Options::update_chem_pb_pb_force_constant (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_pb_pb_equilibrium_dist (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_pb_pb_max_elong (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_pb_sc_force_constant (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_pb_sc_equilibrium_dist (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_pb_sc_max_elong (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_sc_sc_force_constant (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_sc_sc_equilibrium_dist (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_chem_sc_sc_max_elong (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_pb_pb_force_constant (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_pb_pb_equilibrium_dist (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_pb_pb_max_elong (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_pb_sc_force_constant (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_pb_sc_equilibrium_dist (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_pb_sc_max_elong (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_sc_sc_force_constant (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_sc_sc_equilibrium_dist (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_sc_sc_max_elong (const QString &str)
{
...
void
US_Hydrodyn_BD_Options::update_enables ()
{
  switch (bd_options->chem_pb_pb_bond_type)
    {
...
void
US_Hydrodyn_BD_Options::dup_fraenkel ()
{
  update_chem_pb_sc_force_constant (le_chem_pb_pb_force_constant->text ());
  le_chem_pb_sc_force_constant->setText (
      le_chem_pb_pb_force_constant->text ());
  cb_compute_chem_pb_sc_force_constant->setChecked (
      cb_compute_chem_pb_pb_force_constant->isChecked ());
...
void
US_Hydrodyn_BD_Options::update_labels ()
{
  ...
  if (fabs (total_steps * pow (0.1, digits)
            - (double)(int (total_steps * pow (0.1, digits) + 0.5)))
      < TOLERANCE)
    {
      ...
      if (bd_options->nconf > max_conf)
        {
          ...
          lbl_nconf->setText (us_tr (
              QString (" Number of conformations to store (maximum %1)\n"
