...
void US_Hydrodyn_BD_Options::setupGUI()
{
   ...
   lbl_springs = new QLabel(us_tr("Connector Spring Definitions (spring constant in erg/cm^2, distance in cm):"), this);
   ...
   rb_bead_size_type_1st->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_bead_size_type_1st->setPalette( PALET_NORMAL );
   AUTFBACK( rb_bead_size_type_1st );
   connect(rb_bead_size_type_1st, SIGNAL(clicked()), this, SLOT(set_bead_size_type()));
   ...
   rb_bead_size_type_min->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_bead_size_type_min->setPalette( PALET_NORMAL );
   AUTFBACK( rb_bead_size_type_min );
   connect(rb_bead_size_type_min, SIGNAL(clicked()), this, SLOT(set_bead_size_type()));
   ...
   rb_bead_size_type_avg->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_bead_size_type_avg->setPalette( PALET_NORMAL );
   AUTFBACK( rb_bead_size_type_avg );
   connect(rb_bead_size_type_avg, SIGNAL(clicked()), this, SLOT(set_bead_size_type()));
   ...
   case 0 : rb_bead_size_type_1st->setChecked( true ); break;
   case 1 : rb_bead_size_type_min->setChecked( true ); break;
   ...
   lbl_deltat = new QLabel(us_tr(" Duration of each simulation step (s): "), this);
   ...
   rb_inter_no_hi->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   rb_inter_os->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   rb_inter_mos->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   case 0 : rb_inter_no_hi->setChecked( true ); break;
   case 1 : rb_inter_os->setChecked( true ); break;
   ...
   rb_iorder_em->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   rb_iorder_igt->setText(us_tr(" Iniesta-Garcia de la Torre predictor-corrector"));
   rb_iorder_igt->setEnabled(true);
   //   rb_iorder_igt->setMinimumHeight(minHeight1);
   rb_iorder_igt->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   case 0 : rb_iorder_em->setChecked( true ); break;
   ...
   rb_chem_pb_pb_bond_type_fraenkel->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_pb_bond_type_fraenkel->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_pb_bond_type_fraenkel );
   connect(rb_chem_pb_pb_bond_type_fraenkel, SIGNAL(clicked()), this, SLOT(set_chem_pb_pb_bond_types()));
   ...
   rb_chem_pb_pb_bond_type_hookean->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_pb_bond_type_hookean->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_pb_bond_type_hookean );
   connect(rb_chem_pb_pb_bond_type_hookean, SIGNAL(clicked()), this, SLOT(set_chem_pb_pb_bond_types()));
   ...
   rb_chem_pb_pb_bond_type_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_pb_bond_type_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_pb_bond_type_fene );
   connect(rb_chem_pb_pb_bond_type_fene, SIGNAL(clicked()), this, SLOT(set_chem_pb_pb_bond_types()));
   ...
   rb_chem_pb_pb_bond_type_hard_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_pb_bond_type_hard_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_pb_bond_type_hard_fene );
   connect(rb_chem_pb_pb_bond_type_hard_fene, SIGNAL(clicked()), this, SLOT(set_chem_pb_pb_bond_types()));
   ...
   case 0 : rb_chem_pb_pb_bond_type_fraenkel->setChecked( true ); break;
   case 1 : rb_chem_pb_pb_bond_type_hookean->setChecked( true ); break;
   case 2 : rb_chem_pb_pb_bond_type_fene->setChecked( true ); break;
   case 3 : rb_chem_pb_pb_bond_type_hard_fene->setChecked( true ); break;
   ...
   rb_chem_pb_sc_bond_type_fraenkel->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_sc_bond_type_fraenkel->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_sc_bond_type_fraenkel );
   connect(rb_chem_pb_sc_bond_type_fraenkel, SIGNAL(clicked()), this, SLOT(set_chem_pb_sc_bond_types()));
   ...
   rb_chem_pb_sc_bond_type_hookean->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_sc_bond_type_hookean->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_sc_bond_type_hookean );
   connect(rb_chem_pb_sc_bond_type_hookean, SIGNAL(clicked()), this, SLOT(set_chem_pb_sc_bond_types()));
   ...
   rb_chem_pb_sc_bond_type_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_sc_bond_type_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_sc_bond_type_fene );
   connect(rb_chem_pb_sc_bond_type_fene, SIGNAL(clicked()), this, SLOT(set_chem_pb_sc_bond_types()));
   ...
   rb_chem_pb_sc_bond_type_hard_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_pb_sc_bond_type_hard_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_pb_sc_bond_type_hard_fene );
   connect(rb_chem_pb_sc_bond_type_hard_fene, SIGNAL(clicked()), this, SLOT(set_chem_pb_sc_bond_types()));
   ...
   case 0 : rb_chem_pb_sc_bond_type_fraenkel->setChecked( true ); break;
   case 1 : rb_chem_pb_sc_bond_type_hookean->setChecked( true ); break;
   case 2 : rb_chem_pb_sc_bond_type_fene->setChecked( true ); break;
   ...
   rb_chem_sc_sc_bond_type_fraenkel->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_sc_sc_bond_type_fraenkel->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_sc_sc_bond_type_fraenkel );
   connect(rb_chem_sc_sc_bond_type_fraenkel, SIGNAL(clicked()), this, SLOT(set_chem_sc_sc_bond_types()));
   ...
   rb_chem_sc_sc_bond_type_hookean->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_sc_sc_bond_type_hookean->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_sc_sc_bond_type_hookean );
   connect(rb_chem_sc_sc_bond_type_hookean, SIGNAL(clicked()), this, SLOT(set_chem_sc_sc_bond_types()));
   ...
   rb_chem_sc_sc_bond_type_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_sc_sc_bond_type_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_sc_sc_bond_type_fene );
   connect(rb_chem_sc_sc_bond_type_fene, SIGNAL(clicked()), this, SLOT(set_chem_sc_sc_bond_types()));
   ...
   rb_chem_sc_sc_bond_type_hard_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_chem_sc_sc_bond_type_hard_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_chem_sc_sc_bond_type_hard_fene );
   connect(rb_chem_sc_sc_bond_type_hard_fene, SIGNAL(clicked()), this, SLOT(set_chem_sc_sc_bond_types()));
   ...
   case 0 : rb_chem_sc_sc_bond_type_fraenkel->setChecked( true ); break;
   case 1 : rb_chem_sc_sc_bond_type_hookean->setChecked( true ); break;
   case 2 : rb_chem_sc_sc_bond_type_fene->setChecked( true ); break;
   case 3 : rb_chem_sc_sc_bond_type_hard_fene->setChecked( true ); break;
   ...
   rb_pb_pb_bond_type_fraenkel->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_pb_bond_type_fraenkel->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_pb_bond_type_fraenkel );
   connect(rb_pb_pb_bond_type_fraenkel, SIGNAL(clicked()), this, SLOT(set_pb_pb_bond_types()));
   ...
   rb_pb_pb_bond_type_hookean->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_pb_bond_type_hookean->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_pb_bond_type_hookean );
   connect(rb_pb_pb_bond_type_hookean, SIGNAL(clicked()), this, SLOT(set_pb_pb_bond_types()));
   ...
   rb_pb_pb_bond_type_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_pb_bond_type_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_pb_bond_type_fene );
   connect(rb_pb_pb_bond_type_fene, SIGNAL(clicked()), this, SLOT(set_pb_pb_bond_types()));
   ...
   rb_pb_pb_bond_type_hard_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_pb_bond_type_hard_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_pb_bond_type_hard_fene );
   connect(rb_pb_pb_bond_type_hard_fene, SIGNAL(clicked()), this, SLOT(set_pb_pb_bond_types()));
   ...
   switch ( bd_options->chem_pb_pb_bond_type ) {
   case 0 : rb_pb_pb_bond_type_fraenkel->setChecked( true ); break;
   case 1 : rb_pb_pb_bond_type_hookean->setChecked( true ); break;
   case 2 : rb_pb_pb_bond_type_fene->setChecked( true ); break;
   ...
   rb_pb_sc_bond_type_fraenkel->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_sc_bond_type_fraenkel->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_sc_bond_type_fraenkel );
   connect(rb_pb_sc_bond_type_fraenkel, SIGNAL(clicked()), this, SLOT(set_pb_sc_bond_types()));
   ...
   rb_pb_sc_bond_type_hookean->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_sc_bond_type_hookean->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_sc_bond_type_hookean );
   connect(rb_pb_sc_bond_type_hookean, SIGNAL(clicked()), this, SLOT(set_pb_sc_bond_types()));
   ...
   rb_pb_sc_bond_type_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_sc_bond_type_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_sc_bond_type_fene );
   connect(rb_pb_sc_bond_type_fene, SIGNAL(clicked()), this, SLOT(set_pb_sc_bond_types()));
   ...
   rb_pb_sc_bond_type_hard_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_pb_sc_bond_type_hard_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_pb_sc_bond_type_hard_fene );
   connect(rb_pb_sc_bond_type_hard_fene, SIGNAL(clicked()), this, SLOT(set_pb_sc_bond_types()));
   ...
   switch ( bd_options->chem_pb_sc_bond_type ) {
   case 0 : rb_pb_sc_bond_type_fraenkel->setChecked( true ); break;
   case 1 : rb_pb_sc_bond_type_hookean->setChecked( true ); break;
   case 2 : rb_pb_sc_bond_type_fene->setChecked( true ); break;
   ...
   rb_sc_sc_bond_type_fraenkel->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_sc_sc_bond_type_fraenkel->setPalette( PALET_NORMAL );
   AUTFBACK( rb_sc_sc_bond_type_fraenkel );
   connect(rb_sc_sc_bond_type_fraenkel, SIGNAL(clicked()), this, SLOT(set_sc_sc_bond_types()));
   ...
   rb_sc_sc_bond_type_hookean->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_sc_sc_bond_type_hookean->setPalette( PALET_NORMAL );
   AUTFBACK( rb_sc_sc_bond_type_hookean );
   connect(rb_sc_sc_bond_type_hookean, SIGNAL(clicked()), this, SLOT(set_sc_sc_bond_types()));
   ...
   rb_sc_sc_bond_type_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_sc_sc_bond_type_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_sc_sc_bond_type_fene );
   connect(rb_sc_sc_bond_type_fene, SIGNAL(clicked()), this, SLOT(set_sc_sc_bond_types()));
   ...
   rb_sc_sc_bond_type_hard_fene->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   rb_sc_sc_bond_type_hard_fene->setPalette( PALET_NORMAL );
   AUTFBACK( rb_sc_sc_bond_type_hard_fene );
   connect(rb_sc_sc_bond_type_hard_fene, SIGNAL(clicked()), this, SLOT(set_sc_sc_bond_types()));
   ...
   switch ( bd_options->chem_sc_sc_bond_type ) {
   case 0 : rb_sc_sc_bond_type_fraenkel->setChecked( true ); break;
   case 1 : rb_sc_sc_bond_type_hookean->setChecked( true ); break;
   case 2 : rb_sc_sc_bond_type_fene->setChecked( true ); break;
   ...
   lbl_chem_pb_pb_equilibrium_dist = new QLabel(us_tr(" Equilibrium distance: "), this);
   ...
   lbl_chem_pb_sc_force_constant = new QLabel(us_tr(" Hookean spring constant: "), this);
   ...
   lbl_chem_pb_sc_equilibrium_dist = new QLabel(us_tr(" Equilibrium distance: "), this);
   ...
   lbl_chem_sc_sc_force_constant = new QLabel(us_tr(" Hookean spring constant: "), this);
   ...
   lbl_chem_sc_sc_equilibrium_dist = new QLabel(us_tr(" Equilibrium distance: "), this);
   ...
   lbl_pb_pb_force_constant = new QLabel(us_tr(" Hookean spring constant: "), this);
   ...
   lbl_pb_pb_equilibrium_dist = new QLabel(us_tr(" Equilibrium distance: "), this);
   ...
   lbl_pb_sc_force_constant = new QLabel(us_tr(" Hookean spring constant: "), this);
   ...
   lbl_pb_sc_equilibrium_dist = new QLabel(us_tr(" Equilibrium distance: "), this);
   ...
   lbl_sc_sc_force_constant = new QLabel(us_tr(" Hookean spring constant: "), this);
   ...
   lbl_sc_sc_equilibrium_dist = new QLabel(us_tr(" Equilibrium distance: "), this);
   ...
   QHBoxLayout * hbl_method = new QHBoxLayout; hbl_method->setContentsMargins( 0, 0, 0, 0 ); hbl_method->setSpacing( 0 );
   ...
   gl_thresh->addWidget( cb_do_rr , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1 ) - ( 0 ) ); j++;
   gl_thresh->addWidget( cb_force_chem , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1 ) - ( 0 ) ); j++;
   gl_thresh->addWidget( cb_show_pdb , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1 ) - ( 0 ) ); j++;
   gl_thresh->addWidget( cb_run_browflex , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1 ) - ( 0 ) ); j++;
   gl_thresh->addWidget( bg_bead_size_type , j , 0 , 1 + ( j+4 ) - ( j ) , 1 + ( 1 ) - ( 0 ) ); j++;

   hbl_method->addLayout(gl_thresh);
   hbl_method->addSpacing(3);

   QVBoxLayout * vbl_method_group = new QVBoxLayout; vbl_method_group->setContentsMargins( 0, 0, 0, 0 ); vbl_method_group->setSpacing( 0 );
   vbl_method_group->addWidget(lbl_info_simulation_opts);

   QHBoxLayout * hbl_method_group = new QHBoxLayout; hbl_method_group->setContentsMargins( 0, 0, 0, 0 ); hbl_method_group->setSpacing( 0 );

   QVBoxLayout * vbl_method = new QVBoxLayout; vbl_method->setContentsMargins( 0, 0, 0, 0 ); vbl_method->setSpacing( 0 );
   ...
   QGridLayout * gl_simu = new QGridLayout; gl_simu->setContentsMargins( 0, 0, 0, 0 ); gl_simu->setSpacing( 0 );
   j = 0;
   ...
   //   gl_simu->addWidget( cb_icdm , j , 0 , 1 + ( j ) - ( j ) , 1 + ( 1 ) - ( 0 ) ); j++;
   ...
   QHBoxLayout * hbl_bonds = new QHBoxLayout; hbl_bonds->setContentsMargins( 0, 0, 0, 0 ); hbl_bonds->setSpacing( 0 );

   QVBoxLayout * vbl_chem_pb_pb = new QVBoxLayout; vbl_chem_pb_pb->setContentsMargins( 0, 0, 0, 0 ); vbl_chem_pb_pb->setSpacing( 0 );
   ...
   QHBoxLayout * hbl_chem_pb_pb_force_constant = new QHBoxLayout; hbl_chem_pb_pb_force_constant->setContentsMargins( 0, 0, 0, 0 ); hbl_chem_pb_pb_force_constant->setSpacing( 0 );
   ...
   QVBoxLayout * vbl_chem_pb_sc = new QVBoxLayout; vbl_chem_pb_sc->setContentsMargins( 0, 0, 0, 0 ); vbl_chem_pb_sc->setSpacing( 0 );
   ...
   QVBoxLayout * vbl_chem_sc_sc = new QVBoxLayout; vbl_chem_sc_sc->setContentsMargins( 0, 0, 0, 0 ); vbl_chem_sc_sc->setSpacing( 0 );
   ...
   QVBoxLayout * vbl_pb_pb = new QVBoxLayout; vbl_pb_pb->setContentsMargins( 0, 0, 0, 0 ); vbl_pb_pb->setSpacing( 0 );
   ...
   QVBoxLayout * vbl_pb_sc = new QVBoxLayout; vbl_pb_sc->setContentsMargins( 0, 0, 0, 0 ); vbl_pb_sc->setSpacing( 0 );
   ...
   QVBoxLayout * vbl_sc_sc = new QVBoxLayout; vbl_sc_sc->setContentsMargins( 0, 0, 0, 0 ); vbl_sc_sc->setSpacing( 0 );
...
void US_Hydrodyn_BD_Options::update_labels()
{
   ...
   if ( fabs( check_nconf  - int( check_nconf + 0.5 ) ) < TOLERANCE )
   {
      ...
      if ( bd_options->nconf > max_conf )
      {
         ...
         lbl_nconf->setText(us_tr(QString(" Number of conformations to store (maximum %1)\n"
                                       " WARNING: greater than maximum: ").arg((int)max_conf)));
      } else {
         lbl_nconf->setPalette(label_font_ok);
         lbl_nconf->setText(us_tr(QString(" Number of conformations to store (max %1): ").arg((int)max_conf)));
      }
   } else {
      lbl_nconf->setPalette(label_font_warning);
      lbl_nconf->setText(us_tr(QString(" Number of conformations to store (maximum %1)\n"
