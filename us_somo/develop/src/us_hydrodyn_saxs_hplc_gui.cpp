...
void
US_Hydrodyn_Saxs_Hplc::setupGUI ()
{
  int minHeight1 = 22;
  int minHeight3 = 24;
  ...
  */
  ...
  lbl_title
      = new QLabel ("Developed by Emre Brookes, Javier P\u00e9rez, Patrice "
                    "Vachette and Mattia Rocco (see J. App. Cryst. "
                    "46:1823-1833, 2013; J. App. Cryst. 49:1827-1841, 2016 )",
                    this);
  ...
  pb_create_ihashq->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  //    pb_set_hplc->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  //    lbl_hplc->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  pb_save_created_csv->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("hplc_csv_transposed")
              && ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_csv_transposed"]
                     == "true"
          ? us_tr ("Save CSV Tr")
          : us_tr (" Save CSV "));
  ...
  cb_guinier_qrgmax->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("hplc_cb_guinier_qrgmax")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_cb_guinier_qrgmax"]
             == "true");
  ...
  le_guinier_qrgmax->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("hplc_guinier_qrgmax")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["hplc_guinier_qrgmax"]
          : "1.3");
  ...
  guinier_plot->setAxisTitle (QwtPlot::yLeft,
                              us_tr ("Intensity [a.u.] (log scale)"));
#if QT_VERSION < 0x040000
  ...
  //    hbl_hplc->setContentsMargins( 0, 0, 0, 0 ); hbl_hplc->setSpacing( 0 );
  ...
  //                 "hplc_files_widgets" ) || ( ( US_Hydrodyn * ) us_hydrodyn
  //                 )->gparams[ "hplc_files_widgets" ] == "false" ? false :
  //                 true );
  //   hide_widgets( editor_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "hplc_editor_widgets" ) || ( ( US_Hydrodyn * ) us_hydrodyn
  //                 )->gparams[ "hplc_editor_widgets" ] == "false" ? false :
  //                 true );
  //   hide_widgets( created_files_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "hplc_created_files_widgets" ) || ( ( US_Hydrodyn * )
  //                 us_hydrodyn )->gparams[ "hplc_creaded_files_widgets" ] ==
  //                 "false" ? false : true );
...
void
US_Hydrodyn_Saxs_Hplc::mode_setup_widgets ()
{
...
void
US_Hydrodyn_Saxs_Hplc::mode_select ()
{
  ...
  switch (current_mode)
    ...
    case MODE_GAUSSIAN:
      {
        ...
        switch (gaussian_type_size)
          {
          case 4:
            ShowHide::hide_widgets (gaussian_4var_widgets, false);
            break;
          case 5:
            ShowHide::hide_widgets (gaussian_5var_widgets, false);
            break;
          default:
            break;
          }
    ...
    case MODE_GGAUSSIAN:
      {
        ...
        switch (gaussian_type_size)
          {
          case 4:
            ShowHide::hide_widgets (ggaussian_4var_widgets, false);
            break;
          case 5:
            ShowHide::hide_widgets (ggaussian_5var_widgets, false);
            break;
          default:
            break;
          }
    ...
    case MODE_WYATT:
      ...
      ShowHide::hide_widgets (wyatt_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0);
      break;
    case MODE_BLANKS:
      mode_title (pb_blanks_start->text ());
      ShowHide::hide_widgets (blanks_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0);
      break;
    case MODE_BASELINE:
      mode_title (pb_baseline_start->text ());
      ShowHide::hide_widgets (baseline_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0);
      break;
    case MODE_TIMESHIFT:
      mode_title (pb_timeshift->text ());
      ShowHide::hide_widgets (timeshift_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 0);
      break;
    case MODE_SCALE:
      mode_title (pb_scale->text ());
      ShowHide::hide_widgets (scale_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1);
      break;
    case MODE_TESTIQ:
      mode_title (pb_testiq->text ());
      ShowHide::hide_widgets (testiq_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1);
      break;
    case MODE_GUINIER:
      mode_title (pb_guinier->text ());
      ShowHide::hide_widgets (guinier_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1);
      break;
    case MODE_RGC:
      mode_title (pb_rgc->text ());
      ShowHide::hide_widgets (rgc_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1);
      break;
    case MODE_PM:
      mode_title (pb_pm->text ());
      ShowHide::hide_widgets (pm_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1);
      break;
    default:
...
void
US_Hydrodyn_Saxs_Hplc::mode_select (modes mode)
{
  current_mode = mode;
  mode_select ();
}
...
void
US_Hydrodyn_Saxs_Hplc::mode_title (QString title)
{
...
void
US_Hydrodyn_Saxs_Hplc::update_enables ()
{
  ...
  pb_svd->setEnabled (files_selected_count > 1
                      && files_compatible); // && !files_are_time );
  pb_create_ihashq->setEnabled (files_selected_count && files_compatible
                                && !files_are_time & !any_ihash);
...
void
US_Hydrodyn_Saxs_Hplc::model_enables ()
{
...
void
US_Hydrodyn_Saxs_Hplc::disable_all ()
{
  // cout << "disable all\n";
  // qwtw_wheel            ->setEnabled( false );
  pb_wheel_inc->setEnabled (false);
...
void
US_Hydrodyn_Saxs_Hplc::model_select_all ()
{
...
void
US_Hydrodyn_Saxs_Hplc::model_save ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::model_text ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::model_view ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::model_remove ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::model_remove (QStringList files)
{
  disable_updates = true;
...
void
US_Hydrodyn_Saxs_Hplc::model_view (QStringList files)
{
...
void
US_Hydrodyn_Saxs_Hplc::model_text (QStringList files)
{
...
bool
US_Hydrodyn_Saxs_Hplc::model_save (QStringList files)
{
  bool errors = false;
...
bool
US_Hydrodyn_Saxs_Hplc::model_save (QString file, bool &cancel,
                                   bool &overwrite_all)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_plot_dist (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_plot_ref (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_ggqfit_plot (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_guinier_plot (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_guinier_plot_rg (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_guinier_plot_mw (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_guinier_plot_summary (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::usp_config_guinier_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Saxs_Hplc::set_pbmode_main ()
{
  pbmode_select (PBMODE_MAIN);
}

void
US_Hydrodyn_Saxs_Hplc::set_pbmode_sel ()
{
  pbmode_select (PBMODE_SEL);
}

void
US_Hydrodyn_Saxs_Hplc::set_pbmode_crop ()
{
  pbmode_select (PBMODE_CROP);
}

void
US_Hydrodyn_Saxs_Hplc::set_pbmode_conc ()
{
  pbmode_select (PBMODE_CONC);
}

void
US_Hydrodyn_Saxs_Hplc::set_pbmode_sd ()
{
  pbmode_select (PBMODE_SD);
}

void
US_Hydrodyn_Saxs_Hplc::set_pbmode_fasta ()
{
  pbmode_select (PBMODE_FASTA);
}

void
US_Hydrodyn_Saxs_Hplc::set_pbmode_none ()
{
  pbmode_select (PBMODE_NONE);
}

void
US_Hydrodyn_Saxs_Hplc::pbmode_select (pbmodes mode)
{
...
void
US_Hydrodyn_Saxs_Hplc::fasta_file ()
{
  // load file
