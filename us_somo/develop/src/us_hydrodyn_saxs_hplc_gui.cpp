...
void US_Hydrodyn_Saxs_Hplc::setupGUI() {
  ...
  */
  ...
  lbl_title = new QLabel(
      "Developed by Emre Brookes, Javier P\u00e9rez, Patrice Vachette and "
      "Mattia Rocco (see J. App. Cryst. 46:1823-1833, 2013; J. App. Cryst. "
      "49:1827-1841, 2016 )",
      this);
  ...
  //    QBoxLayout * hbl_hplc = new QHBoxLayout(); hbl_hplc->setContentsMargins(
  //    0, 0, 0, 0 ); hbl_hplc->setSpacing( 0 ); hbl_hplc->addWidget (
  //    pb_set_hplc ); hbl_hplc->addWidget ( lbl_hplc );
...
bool US_Hydrodyn_Saxs_Hplc::model_save(QString file, bool &cancel,
                                       bool &overwrite_all) {
...
void US_Hydrodyn_Saxs_Hplc::set_pbmode_main() { pbmode_select(PBMODE_MAIN); }

void US_Hydrodyn_Saxs_Hplc::set_pbmode_sel() { pbmode_select(PBMODE_SEL); }

void US_Hydrodyn_Saxs_Hplc::set_pbmode_crop() { pbmode_select(PBMODE_CROP); }

void US_Hydrodyn_Saxs_Hplc::set_pbmode_conc() { pbmode_select(PBMODE_CONC); }

void US_Hydrodyn_Saxs_Hplc::set_pbmode_sd() { pbmode_select(PBMODE_SD); }

void US_Hydrodyn_Saxs_Hplc::set_pbmode_fasta() { pbmode_select(PBMODE_FASTA); }

void US_Hydrodyn_Saxs_Hplc::set_pbmode_none() { pbmode_select(PBMODE_NONE); }
...
void US_Hydrodyn_Saxs_Hplc::fasta_file() {
  // load file
