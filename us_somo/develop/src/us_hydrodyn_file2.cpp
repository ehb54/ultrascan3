...
void
US_Hydrodyn_File2::closeEvent (QCloseEvent *event)
{
  if (ok_to_close)
    {
      event->accept ();
...
US_Hydrodyn_File2::US_Hydrodyn_File2 (QString *dir, QString *base,
                                      QString *ext, bool &cancel,
                                      bool &overwrite_all, int *result,
...
void
US_Hydrodyn_File2::do_overwrite_all ()
{
  *result = 0;
  *overwrite_all = true;
  ok_to_close = true;
...
void
US_Hydrodyn_File2::update_base (const QString &str)
{
  *base = str;
}
