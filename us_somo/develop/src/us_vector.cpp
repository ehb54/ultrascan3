...
void US_Vector::printvector2(QString qs, vector<double> x, vector<double> y,
  ...
  for (unsigned int i = 0; i < max_size; i++) {
    cout << QString("\t%1 %2\n")
                .arg((x.size() > i) ? QString("%1").arg(x[i], 0, 'g', digits)
                                    : QString("n/a"))
                .arg((y.size() > i) ? QString("%1").arg(y[i], 0, 'g', digits)
                                    : QString("n/a"));
  }
}

void US_Vector::printvector3(QString qs, vector<double> x, vector<double> y,
  ...
  for (unsigned int i = 0; i < max_size; i++) {
    cout << QString("\t%1 %2 %3\n")
                ...
                .arg((y.size() > i) ? QString("%1").arg(y[i], 0, 'g', digits)
                                    : QString("n/a"))
                .arg((z.size() > i) ? QString("%1").arg(z[i], 0, 'g', digits)
                                    : QString("n/a"));
  }
}

void US_Vector::printvector4(QString qs, vector<double> x, vector<double> y,
  ...
  for (unsigned int i = 0; i < max_size; i++) {
    cout << QString("\t%1 %2 %3 %4\n")
                ...
                .arg((z.size() > i) ? QString("%1").arg(z[i], 0, 'g', digits)
                                    : QString("n/a"))
                .arg((s.size() > i) ? QString("%1").arg(s[i], 0, 'g', digits)
                                    : QString("n/a"));
  }
}

void US_Vector::printvector5(QString qs, vector<double> x, vector<double> y,
                             vector<double> z, vector<double> s,
                             vector<double> t, int digits, unsigned int limit) {
  ...
  for (unsigned int i = 0; i < max_size; i++) {
    cout << QString("\t%1 %2 %3 %4 %5\n")
                ...
                .arg((s.size() > i) ? QString("%1").arg(s[i], 0, 'g', digits)
                                    : QString("n/a"))
                .arg((t.size() > i) ? QString("%1").arg(t[i], 0, 'g', digits)
                                    : QString("n/a"));
  }
}

void US_Vector::printvector7(QString qs, vector<double> x, vector<double> y,
                             vector<double> z, vector<double> s,
                             vector<double> t, vector<double> u,
                             vector<double> v, int digits, unsigned int limit) {
  cout << QString("%1: size %2 %3 %4 %5 %6")
              .arg(qs)
              .arg(x.size())
              .arg(y.size())
  ...
  for (unsigned int i = 0; i < max_size; i++) {
    cout << QString("\t%1 %2 %3 %4 %5 %6 %7\n")
                ...
                .arg((t.size() > i) ? QString("%1").arg(t[i], 0, 'g', digits)
                                    : QString("n/a"))
                .arg((u.size() > i) ? QString("%1").arg(u[i], 0, 'g', digits)
                                    : QString("n/a"))
                .arg((v.size() > i) ? QString("%1").arg(v[i], 0, 'g', digits)
                                    : QString("n/a"));
  }
}
...
QString US_Vector::qs_vector2(QString qs, vector<double> x, vector<double> y,
                              int digits) {
  QString result;
...
QString US_Vector::qs_vector2(QString qs, vector<int> x, vector<double> y,
                              int digits) {
  QString result;
  result += QString("%1: size %2 %3:\n").arg(qs).arg(x.size()).arg(y.size());
  unsigned int max_size =
...
QString US_Vector::qs_vector2(QString qs, vector<QString> x,
                              vector<QString> y) {
  QString result;
  result += QString("%1: size %2 %3:\n").arg(qs).arg(x.size()).arg(y.size());
  unsigned int max_size =
...
QString US_Vector::qs_vector3(QString qs, vector<double> x, vector<double> y,
...
QString US_Vector::qs_vector4(QString qs, vector<double> x, vector<double> y,
                              vector<double> z, vector<double> s, int digits) {
  QString result;
  unsigned int max_size =
      (unsigned int)(x.size() > y.size() ? x.size() : y.size());
...
QString US_Vector::qs_vector_vector(QString qs, vector<vector<double> > m,
                                    int digits) {
  QString result;
...
bool US_Stat::has_accum() { return accum_ok; }
...
int US_Stat::count() { return (int)pts.size(); }

double US_Stat::min() { return pmin; }

double US_Stat::max() { return pmax; }
