...
US_Hydrodyn_Vdw_Overlap::~US_Hydrodyn_Vdw_Overlap () { *misc_widget = false; }

void
US_Hydrodyn_Vdw_Overlap::setupGUI ()
{
  int minHeight1 = 22;
...
void
US_Hydrodyn_Vdw_Overlap::update_vdw_ot_mult (const QString &str)
{
...
void
US_Hydrodyn_Vdw_Overlap::update_vdw_ot_dpct (const QString &str)
{
...
void
US_Hydrodyn_Vdw_Overlap::set_vdw_ot_alt ()
{
...
void
US_Hydrodyn_Vdw_Overlap::set_vdw_saxs_water_beads ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_saxs_water_beads"]
...
void
US_Hydrodyn_Vdw_Overlap::set_vdw_saxs_skip_pr0pair ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_saxs_skip_pr0pair"]
...
void
US_Hydrodyn_Vdw_Overlap::cancel ()
{
  close ();
}

void
US_Hydrodyn_Vdw_Overlap::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Vdw_Overlap::closeEvent (QCloseEvent *e)
{
  *misc_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
