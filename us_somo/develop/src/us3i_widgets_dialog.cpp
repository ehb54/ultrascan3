...
QLabel* US3i_widgetsDialog::us_textlabel(const QString& labelString,
                                         int fontAdjust, int weight) {
...
QLabel* US3i_widgetsDialog::us_banner(const QString& labelString,
                                      int fontAdjust, int weight) {
  QLabel* newLabel = us_label(labelString, fontAdjust, weight);
...
// pushbutton
QPushButton* US3i_widgetsDialog::us_pushbutton(const QString& labelString,
...
// checkbox
QGridLayout* US3i_widgetsDialog::us_checkbox(const QString& text,
                                             QCheckBox*& cb, bool state) {
...
// radiobutton
QGridLayout* US3i_widgetsDialog::us_radiobutton(const QString& text,
...
QwtPlot* US3i_widgetsDialog::us3i_plot(const QString& title,
...
QwtPlotCurve* US3i_widgetsDialog::us_curve(QwtPlot* plot,
                                           const QString& title) {
...
// tabWidget
QTabWidget* US3i_widgetsDialog::us_tabwidget(int fontAdjust, int weight) {
...
// TimeEdit
QHBoxLayout* US3i_widgetsDialog::us_timeedit(QTimeEdit*& tedt,
                                             const int fontAdjust,
                                             QSpinBox** sbox) {
...
// day-hh-mm-ss layout
QHBoxLayout* US3i_widgetsDialog::us_ddhhmmsslay(const int fontAdjust,
                                                QSpinBox** dd, QSpinBox** hh,
