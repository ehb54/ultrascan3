...
US3i_widgetsDialog::US3i_widgetsDialog (QWidget *w) : QDialog (w)
{
...
QLabel *
US3i_widgetsDialog::us_label (const QString &labelString, int fontAdjust,
                              int weight)
{
...
QLabel *
US3i_widgetsDialog::us_textlabel (const QString &labelString, int fontAdjust,
                                  int weight)
{
...
QLabel *
US3i_widgetsDialog::us_banner (const QString &labelString, int fontAdjust,
                               int weight)
{
  QLabel *newLabel = us_label (labelString, fontAdjust, weight);
...
// pushbutton
QPushButton *
US3i_widgetsDialog::us_pushbutton (const QString &labelString, bool enabled,
                                   int fontAdjust)
{
...
// textedit
QTextEdit *
US3i_widgetsDialog::us_textedit (void)
{
...
// lineedit
QLineEdit *
US3i_widgetsDialog::us_lineedit (const QString &text, int fontAdjust,
                                 bool readonly)
{
...
void
US3i_widgetsDialog::us_setReadOnly (QLineEdit *le, bool readonly)
{
  if (readonly)
    {
...
void
US3i_widgetsDialog::us_setReadOnly (QTextEdit *te, bool readonly)
{
  if (readonly)
    {
...
// List Widget
QListWidget *
US3i_widgetsDialog::us_listwidget (int fontAdjust)
{
...
// checkbox
QGridLayout *
US3i_widgetsDialog::us_checkbox (const QString &text, QCheckBox *&cb,
                                 bool state)
{
...
// radiobutton
QGridLayout *
US3i_widgetsDialog::us_radiobutton (const QString &text, QRadioButton *&rb,
                                    bool state)
{
  QPalette p = US3i_GuiSettings::normalColor ();
  QFont font = QFont (US3i_GuiSettings::fontFamily (),
...
// Progress Bar
QProgressBar *
US3i_widgetsDialog::us_progressBar (int low, int high, int value)
{
...
// Combo Box
QComboBox *
US3i_widgetsDialog::us_comboBox (void)
{
...
// LCD
QLCDNumber *
US3i_widgetsDialog::us_lcd (int digits, int value)
{
...
// QwtCounter
QwtCounter *
US3i_widgetsDialog::us_counter (int buttons, double low, double high,
                                double value)
{
...
QwtPlot *
US3i_widgetsDialog::us3i_plot (const QString &title, const QString &x_axis,
...
QwtPlotGrid *
US3i_widgetsDialog::us_grid (QwtPlot *plot)
{
...
QwtPlotCurve *
US3i_widgetsDialog::us_curve (QwtPlot *plot, const QString &title)
{
...
QwtPlotPicker *
US3i_widgetsDialog::us_picker (QwtPlot *plot)
{
  QwtPlotPicker *pick
...
// tabWidget
QTabWidget *
US3i_widgetsDialog::us_tabwidget (int fontAdjust, int weight)
{
...
// TimeEdit
QHBoxLayout *
US3i_widgetsDialog::us_timeedit (QTimeEdit *&tedt, const int fontAdjust,
                                 QSpinBox **sbox)
{
...
// day-hh-mm-ss layout
QHBoxLayout *
US3i_widgetsDialog::us_ddhhmmsslay (const int fontAdjust, QSpinBox **dd,
...
// SpinBox
QSpinBox *
US3i_widgetsDialog::us_spinbox (const int fontAdjust)
{
