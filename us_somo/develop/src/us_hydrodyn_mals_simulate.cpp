...
US_Hydrodyn_Mals_Simulate::US_Hydrodyn_Mals_Simulate (
    void *us_hydrodyn, void *mals_win, QStringList files,
    map<QString, vector<double> > q, map<QString, vector<double> > I,
    map<QString, vector<double> > e, QWidget *p, const char *)
    : QFrame (p)
{
...
void
US_Hydrodyn_Mals_Simulate::setupGUI ()
{
  if (files.size () > 5)
    {
      QMessageBox::warning (this, windowTitle (),
                            us_tr ("A maximum of 5 intensity curves may be "
  ...
  le_name->setObjectName ("le_name Line Edit");
  ...
  AUTFBACK (lbl_frames);
  lbl_frames->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));

  le_frames = new QLineEdit (this);
  le_frames->setObjectName ("le_frames Line Edit");
  ...
  AUTFBACK (le_frames);
  le_frames->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  cb_noise->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  cb_noise->setPalette (PALET_NORMAL);
  AUTFBACK (cb_noise);
  connect (cb_noise, SIGNAL (clicked ()), SLOT (update_enables ()));

  le_noise = new QLineEdit (this);
  le_noise->setObjectName ("le_noise Line Edit");
  le_noise->setText (".05");
  le_noise->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_noise->setPalette (PALET_NORMAL);
  AUTFBACK (le_noise);
  le_noise->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  cb_slope->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  cb_alpha->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  cb_i_power->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  cb_gamma->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  cb_gamma->setPalette (PALET_NORMAL);
  AUTFBACK (cb_gamma);
  connect (cb_gamma, SIGNAL (clicked ()), SLOT (update_enables ()));

  le_gamma = new QLineEdit (this);
  le_gamma->setObjectName ("le_gamma Line Edit");
  le_gamma->setText ("0");
  le_gamma->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_gamma->setPalette (PALET_NORMAL);
  AUTFBACK (le_gamma);
  le_gamma->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  cb_exponent->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  cb_exponent->setPalette (PALET_NORMAL);
  AUTFBACK (cb_exponent);
  connect (cb_exponent, SIGNAL (clicked ()), SLOT (update_enables ()));

  le_exponent = new QLineEdit (this);
  le_exponent->setObjectName ("le_exponent Line Edit");
  ...
  le_exponent->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  for (int i = 0; i < (int)files.size (); ++i)
    {
      ...
      this_data.lbl_name->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1,
                                          QFont::Bold));
      ...
      this_data.lbl_i_mult->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));

      this_data.le_i_mult = new QLineEdit (this);
      this_data.le_i_mult->setObjectName ("this_data.le_i_mult Line Edit");
      ...
      this_data.le_i_mult->setFont (
          QFont (USglobal->config_list.fontFamily,
                 USglobal->config_list.fontSize - 1));
      this_data.le_i_mult->setValidator (
          new QDoubleValidator (1e-3, 1e50, 3, this_data.le_i_mult));
      ...
      this_data.lbl_center->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));

      this_data.le_center = new QLineEdit (this);
      this_data.le_center->setObjectName ("this_data.le_center Line Edit");
      ...
      this_data.le_center->setFont (
          QFont (USglobal->config_list.fontFamily,
                 USglobal->config_list.fontSize - 1));
      this_data.le_center->setValidator (
          new QDoubleValidator (this_data.le_center));
      ...
      this_data.lbl_width->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 1,
                                           QFont::Bold));

      this_data.le_width = new QLineEdit (this);
      this_data.le_width->setObjectName ("this_data.le_width Line Edit");
      ...
      this_data.le_width->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
      this_data.le_width->setValidator (
          new QDoubleValidator (this_data.le_width));
      ...
      this_data.cb_alpha->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
      this_data.cb_alpha->setPalette (PALET_NORMAL);
      connect (this_data.cb_alpha, SIGNAL (clicked ()),
               SLOT (update_enables ()));

      this_data.le_alpha = new QLineEdit (this);
      this_data.le_alpha->setObjectName ("this_data.le_width Line Edit");
      ...
      this_data.le_alpha->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
      this_data.le_alpha->setValidator (
          new QDoubleValidator (this_data.le_alpha));
...
void
US_Hydrodyn_Mals_Simulate::cancel ()
{
  close ();
}

void
US_Hydrodyn_Mals_Simulate::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Mals_Simulate::closeEvent (QCloseEvent *e)
{
  QMessageBox mb (
      this->windowTitle (),
      us_tr ("Attention:\nAre you sure you want to exit the HPLC SAXS "
             "Simulation window?"),
...
void
US_Hydrodyn_Mals_Simulate::displayData ()
{
  update_enables ();
}

void
US_Hydrodyn_Mals_Simulate::update_enables ()
{
  ...
  le_i_power->setEnabled (cb_i_power->isEnabled ()
                          && cb_i_power->isChecked ());

  cb_exponent->setEnabled (cb_alpha->isChecked ());
  le_exponent->setEnabled (cb_exponent->isEnabled ()
                           && cb_exponent->isChecked ());
...
#define HW ((US_Hydrodyn_Mals *)mals_win)
...
static double_pair
random_normal (double mean1, double sd1, double mean2, double sd2)
{
  double s;
  double_pair v;
  do
...
void
US_Hydrodyn_Mals_Simulate::simulate ()
{
  ...
  // make a bunch of I(t)'s first... then convert to I(q) for output to mals
  ...
  us_qdebug (QString ("gaussian type size %1 qpoints %2")
                 .arg (HW->gaussian_type_size)
                 .arg (qpoints));
              ...
              for (int j = 0; j < (int)Itt.size (); ++j)
                {
                  ...
                  for (int k = 0; k < (int)t.size (); ++k)
                    {
                      // accum += pow( accum, exponent ) + pow( Itt[ j ][ k ] *
                      // alpha, i_power ); accum += ( accum + pow( Itt[ j ][ k
                      // ] * alpha, i_power ) ) * exponent;
                      accum += (accum * alpha * pow (Itt[j][k], i_power))
                               * exponent;
                      Itt[j][k] += accum;
                    }
                }
              ...
              for (int j = 0; j < (int)Itt.size (); ++j)
                {
                  ...
                  for (int k = 0; k < (int)t.size (); ++k)
                    {
                      // accum += accum * pow( accum, exponent ) + Itt[ j ][ k
                      // ] * alpha; accum += (accum + Itt[ j ][ k ] * alpha ) *
                      // exponent;
    ...
    for (int j = 0; j < qpoints; ++j)
      {
        ...
        for (int k = 0; k < (int)Itt[j].size (); ++k)
          {
            if (us_isinf (Itt[j][k]) || us_isnan (Itt[j][k]))
              {
                skip = true;
                break;
              }
        ...
        if (skip)
          {
            HW->editor_msg (
                "red",
                QString ("Could not add %1 due to nan or inf intensities")
                    .arg (use_name));
          }
        else
          {
