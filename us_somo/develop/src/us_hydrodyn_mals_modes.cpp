...
void US_Hydrodyn_Mals::rgc_mw_text( const QString & )
{
   rgc_calc_rg();
}
...
void US_Hydrodyn_Mals::rgc_rho_text( const QString & )
{
   rgc_calc_rg();
}
...
void US_Hydrodyn_Mals::wyatt_apply()
{
...
void US_Hydrodyn_Mals::scale_apply()
{
   ...
   // setup for scale analysis
   {
      ...
      // US_Hydrodyn_Mals_Scale_Trend * uhshst = new US_Hydrodyn_Mals_Scale_Trend( us_hydrodyn,
      //                                                                                     parameters,
      //                                                                                     plots );
      // uhshst->show();
   }
...
void US_Hydrodyn_Mals::timescale()
{
