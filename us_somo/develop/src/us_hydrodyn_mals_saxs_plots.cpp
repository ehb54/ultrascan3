...
void
US_Hydrodyn_Mals_Saxs::update_plot_errors_group ()
{
...
void
US_Hydrodyn_Mals_Saxs::update_plot_errors (vector<double> &grid,
                                           ...
                                           QColor use_color)
{
  ...
  // if ( !plot_errors_zoomer )
  {
...
#if defined(DEBUG_RESCALE)
    {
      ...
      tso << QString ("").sprintf ("mals_saxs_plots::update_plot_errors\n"
                                   "\tminx %e maxx %e\n"
                                   "\tminy %e maxy %e\n",
...
void
US_Hydrodyn_Mals_Saxs::redo_plot_errors ()
{
  if (current_mode == MODE_GGAUSSIAN || current_mode == MODE_GAUSSIAN)
    {
      plot_errors->setAxisTitle (
...
void
US_Hydrodyn_Mals_Saxs::set_plot_errors_rev ()
{
...
void
US_Hydrodyn_Mals_Saxs::set_plot_errors_sd ()
{
...
void
US_Hydrodyn_Mals_Saxs::set_plot_errors_pct ()
{
...
void
US_Hydrodyn_Mals_Saxs::set_plot_errors_group ()
{
  redo_plot_errors ();
}

void
US_Hydrodyn_Mals_Saxs::plot_errors_jump_markers ()
{
...
void
US_Hydrodyn_Mals_Saxs::resize_plots ()
{
...
void
US_Hydrodyn_Mals_Saxs::resize_guinier_plots ()
{
...
bool
US_Hydrodyn_Mals_Saxs::compatible_grids (QStringList files)
{
...
void
US_Hydrodyn_Mals_Saxs::errors_multi_file (QStringList files)
{
  // check
...
void
US_Hydrodyn_Mals_Saxs::set_dots ()
{
  set_eb ();
}

void
US_Hydrodyn_Mals_Saxs::set_eb ()
{
...
void
US_Hydrodyn_Mals_Saxs::plot_files (bool save_zoom_state)
{
  qDebug () << "plot files";
  if (suppress_plot)
    {
...
#if defined(DEBUG_RESCALE)
  {
    ...
    tso << QString ("").sprintf ("mals_saxs_plots::plot_files\n"
                                 "\tminx %e maxx %e\n"
                                 "\tminy %e maxy %e\n",
                                 minx, maxx, miny, maxy);
...
bool
US_Hydrodyn_Mals_Saxs::get_min_max (QString file, double &minx, double &maxx,
...
bool
US_Hydrodyn_Mals_Saxs::plot_file (QString file, double &minx, double &maxx,
                                  double &miny, double &maxy)
{
  if (!f_qs_string.count (file) || !f_qs.count (file) || !f_Is.count (file)
      || !f_pos.count (file))
...
US_Hydrodyn_Mals_Saxs::rescale ()
{
...
#if defined(DEBUG_RESCALE)
  {
    ...
    tso << QString ("").sprintf ("mals_saxs_plots::rescale\n"
                                 "\tminx %e maxx %e\n"
                                 "\tminy %e maxy %e\n",
                                 minx, maxx, miny, maxy);
    tso << "zoomrect " << plot_dist_zoomer->zoomRect ().left () << " , "
...
void
US_Hydrodyn_Mals_Saxs::rescale_y ()
{
...
void
US_Hydrodyn_Mals_Saxs::rescale_y_plot_errors ()
{
