...
void US_Hydrodyn_Mals_Cistarq::quit()
{
   close();
}
...
void US_Hydrodyn_Mals_Cistarq::set_sd_source()
{
   update_enables();
}

void US_Hydrodyn_Mals_Cistarq::set_normalize()
{
   update_enables();
}

void US_Hydrodyn_Mals_Cistarq::set_I0se()
{
   update_enables();
}
