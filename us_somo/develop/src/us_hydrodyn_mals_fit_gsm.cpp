...
void US_Hydrodyn_Mals_Fit::add_our_vector_vvv(our_vector *vd, our_vector *v1, our_vector *v2) {
   int i;
#if !defined(SUPRESS_ERROR_CHECKING)
...
void US_Hydrodyn_Mals_Fit::add_our_vector_vvs(our_vector *vd, our_vector *v1, double s) {
   int i;
   for(i = 0; i < v1->len; i++) {
      vd->d[i] = v1->d[i] + s;
   }
...
void US_Hydrodyn_Mals_Fit::sub_our_vector_vvv(our_vector *vd, our_vector *v1, our_vector *v2) {
   int i;
#if !defined(SUPRESS_ERROR_CHECKING)
   if(v1->len != v2->len || vd->len != v1->len) {
      fputs("add_our_vector_vvv incompatable", stderr);
...
void US_Hydrodyn_Mals_Fit::sub_our_vector_vvs(our_vector *vd, our_vector *v1, double s) {
   int i;
   for(i = 0; i < v1->len; i++) {
      vd->d[i] = v1->d[i] - s;
   }
...
void US_Hydrodyn_Mals_Fit::mult_our_vector_vvv(our_vector *vd, our_vector *v1, our_vector *v2) {
   int i;
#if !defined(SUPRESS_ERROR_CHECKING)
   if(v1->len != v2->len || vd->len != v1->len) {
...
void US_Hydrodyn_Mals_Fit::mult_our_vector_vvs(our_vector *vd, our_vector *v1, double s) {
   int i;
   for(i = 0; i < v1->len; i++) {
      vd->d[i] = v1->d[i] * s;
   }
...
void US_Hydrodyn_Mals_Fit::mult_our_matrix_vmv(our_vector *vd, our_matrix *m, our_vector *vs) {
   int i, j;
...
long US_Hydrodyn_Mals_Fit::min_gsm_5_1( our_vector *i, double epsilon, long max_iter ) 
{
...
long US_Hydrodyn_Mals_Fit::min_fr_pr_cgd(our_vector *i, double epsilon, long max_iter) 
{
...
long US_Hydrodyn_Mals_Fit::min_hessian_bfgs(our_vector *ip, double epsilon, long max_iter) 
{
