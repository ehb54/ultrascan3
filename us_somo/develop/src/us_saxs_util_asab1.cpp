                         ...
                         bool use_recheck)
{
  ...
  float sommarc, Dz, d1z, zz, temp, asamin, asalevel = 10, asapep, asatot,
                                            perc, voltot;
  char azoto[2];
  char carbonio0[3];
  char carbonio1[3];
      ...
      if (strcmp (dd1->elm, "CA") == 0)
        {
          ...
          /*            printf("\n%s\n","Ora passo in asapep CA");
                        printf("\n%s\t%d\t%s\t%f\t%s\t%f\n","indCA=
             ",indCA,"asapep: ",asapep,"asa[l]",asa[l]); if ( 1 ==
      ...
      if (strcmp (dd1->elm, "C") == 0)
        {
          ...
          /*             printf("\n%s\n","Ora passo in asapep C");
                         printf("\n%s\t%d\t%s\t%f\t%s\t%f\n","indC=
             ",indC,"asapep: ",asapep,"asa[l]",asa[l]); if ( 1 ==
             scanf("%d",&topolino);    ) {}; getchar(); */
        }
                  ...
                  if (dd2->col == 10)
                    {
                      ...
                      /*   printf("\n%d\t%s\t%s\t%s\t%d\t%s\t%s\n",i,"Minni
                         ...
                         ",dd2->col,"dd2->descr: ",dd2->descr); if ( 1 ==
                         scanf("%s",pluto) ) {}; getchar();   */
                    }
                  else
                    {
                          ...
                          else
                            {
                               ...
                               * CA, C, O ATOMS OF THE PEPTIDE BOND */
                              ...
                              else
                                {
                                  ...
                                  /*   printf("\n%d\t%s\t%s\t%s\t%d\t%s\t%s\n",i,"Pippo
                                     dd2->elm: ",dd2->elm,"dd2->col:
                                     ",dd2->col,"dd2->descr: ",dd2->descr); if
...
//                      dd->m = 12;
//                   }
//                   else if (strcmp(dd->amin, "OG2") == 0)   /* OCTYL
//                   GLUCOSIDE C10 C4H2 */
//                   {
//                      /*                  strcpy(dd->amin,"OG2"); */
//                      flrad = (float) 1.87;
...
//                      dd->m = 15;
//                   }
//                   else if (strcmp(dd->amin, "OG3") == 0)   /* OCTYL
//                   GLUCOSIDE C11 C4H2 */
//                   {
//                      /*                  strcpy(dd->amin,"OG3"); */
//                      flrad = (float) 1.87;
...
//                   dd->m = 12;
//                }
//                else if (strcmp(dd->amin, "OG1") == 0)   /* OCTYL GLUCOSIDE
//                C1 C4H1 */
//                {
//                   /*               strcpy(dd->amin,"OG1");  */
//                   flrad = (float) 1.87;
...
//       Ox  */
//       {
//          if ((dd->elm[1] == 'D') || (dd->elm[1] == 'E'))   /* selects OD &
//          OE  O1H0 */
//          {
//             flrad = (float) 1.42;
//             dd->m = 16;
...
//          else if ((dd->elm[1] == 'G') || (dd->elm[1] == 'H'))   /* selects
//          OG & OH  O2H1 */
//          {
//             flrad = (float) 1.46;
//             dd->m = 17;
...
//          /*      flrad=(float) 1.8;      */
//       {
//          if ((dd->elm[1] == 'D') || (dd->elm[1] == 'E'))   /* selects ND &
//          NE  */
//          {
...
//    if (rprobe > 0.001)      /* 25/6/02 CONTROLLO, E' STRANO! LA FORMULA È
//    PER L'AREA DEL CERCHIO, NON PER LA SUPERFICE DELLA SFERA!!!!!
//    IMPLEMENTATA QUELLA GIUSTA SOTTO, E RICALCOLATI I PARAMETRI PER LA
//    TABELLA */
//    {
