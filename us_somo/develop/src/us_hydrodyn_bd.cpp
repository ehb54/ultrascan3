...
US_Hydrodyn_BD::setupGUI ()
{
  ...
  lbl_credits = new QLabel ("SIMUFLEX BD suite, by J. Garcia de la Torre et "
                            "al. (JCTC 5:2606-18, 2009)",
                            this);
...
void
US_Hydrodyn_BD::closeEvent (QCloseEvent *e)
{
  *bd_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
