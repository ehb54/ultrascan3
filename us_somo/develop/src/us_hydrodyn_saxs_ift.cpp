...
US_Hydrodyn_Saxs_Ift::US_Hydrodyn_Saxs_Ift (void *us_hydrodyn,
...
void
US_Hydrodyn_Saxs_Ift::closeEvent (QCloseEvent *e)
{
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept ();
...
void
US_Hydrodyn_Saxs_Ift::showhide (vector<QWidget *> &widgets, bool isChecked)
{
...
US_Hydrodyn_Saxs_Ift::setupGUI ()
{
  ...
  lbl_label_0->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  col = 1 + 1;
  background->addWidget (lbl_label_0, row, 0, 1 + (row) - (row),
                         1 + (col++) - (0));
  if (colmax < col)
    {
      colmax = col;
  ...
  lbl_qmin->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_qmin);
  lbl_qmin->setToolTip (
      us_tr ("Optionally enter q min in inverse Angstroms."));
#endif
  ...
  le_qmin->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  le_qmin->setPalette (PALET_NORMAL);
  connect (le_qmin, SIGNAL (textChanged (const QString &)),
           SLOT (update_qmin (const QString &)));
  ...
  lbl_qmax->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_qmax);
  lbl_qmax->setToolTip (
      us_tr ("Qptionally Enter q max in inverse Angstroms."));
#endif
  ...
  le_qmax->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  le_qmax->setPalette (PALET_NORMAL);
  connect (le_qmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_qmax (const QString &)));
  ...
  cb_fitbackground->setChecked (
      parameters->count ("fitbackground")
          ? ((*parameters)["fitbackground"] == "true" ? true : false)
          : false);
  cb_fitbackground->setEnabled (true);
  cb_fitbackground->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_fitbackground->setPalette (PALET_NORMAL);
#if QT_VERSION > 0x040000
  AUTFBACK (cb_fitbackground);
  cb_fitbackground->setToolTip (
      us_tr ("A constant (flat) background is fitted to the data."));
#endif
  ...
  if (col == 0)
    {
      background->addWidget (cb_fitbackground, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  lbl_dmax->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_dmax);
  lbl_dmax->setToolTip (
      us_tr ("Optionally enter starting value for the maximum diameter of the "
             "scatterer in Angstroms."));
#endif
  ...
  le_dmax->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  le_dmax->setPalette (PALET_NORMAL);
  connect (le_dmax, SIGNAL (textChanged (const QString &)),
           SLOT (update_dmax (const QString &)));
  ...
  cb_dmaxfixed->setChecked (
      parameters->count ("dmaxfixed")
          ? ((*parameters)["dmaxfixed"] == "true" ? true : false)
          : false);
  cb_dmaxfixed->setEnabled (true);
  cb_dmaxfixed->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  if (col == 0)
    {
      background->addWidget (cb_dmaxfixed, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  lbl_alpha = new QLabel (
      us_tr (" Starting value for the Lagrange multiplier (Alpha) :"), this);
  lbl_alpha->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_alpha->setPalette (PALET_LABEL);
  lbl_alpha->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_alpha);
  lbl_alpha->setToolTip (
      us_tr ("<p>Optionally enter the starting value for the logarithm of the "
             "Lagrange multiplier (usually between -10 and 20).</p><p>Larger "
             "values will give smoother distributions or - for the MaxEnt "
             "constraint:</p><p>an estimate which is closer to the prior "
             "ellipsoid of revolution.</p>"));
#endif
  ...
  connect (le_alpha, SIGNAL (textChanged (const QString &)),
           SLOT (update_alpha (const QString &)));
  ...
  cb_alphafixed->setChecked (
      parameters->count ("alphafixed")
          ? ((*parameters)["alphafixed"] == "true" ? true : false)
          : false);
  cb_alphafixed->setEnabled (true);
  cb_alphafixed->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  if (col == 0)
    {
      background->addWidget (cb_alphafixed, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  lbl_smearing->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_smearing);
  lbl_smearing->setToolTip (
      us_tr ("<p>Optionally enter a correction for slit smearing. Default is "
             "no smearing.</p><p>Enter value for constant c as given by the "
             "expression</p><p>I_smear(q) = integrate P(t)*I(sqrt(q**2 + "
             "t**2)) dt with the</p><p>primary beam length profile: P(t) = "
             "c/sqrt(pi) * exp(-c**2*t**2).</p><p>The fit and the "
             "deconvolution are both given in the ouput file fit.d</p>"));
#endif
  ...
  le_smearing->setText (
      parameters->count ("smearing") ? (*parameters)["smearing"] : "");
  le_smearing->setEnabled (true);
  le_smearing->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  le_smearing->setPalette (PALET_NORMAL);
  connect (le_smearing, SIGNAL (textChanged (const QString &)),
           SLOT (update_smearing (const QString &)));
  ...
  lbl_prpoints->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_prpoints);
  lbl_prpoints->setToolTip (
      us_tr ("<p>Optionally enter the number of points in the estimated "
             "function p(r): more points increase the "
             "cpu-time.</p><p>Default: 50, Maximum 500</p>"));
#endif
  ...
  le_prpoints->setText (
      parameters->count ("prpoints") ? (*parameters)["prpoints"] : "");
  le_prpoints->setEnabled (true);
  le_prpoints->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  le_prpoints->setPalette (PALET_NORMAL);
  connect (le_prpoints, SIGNAL (textChanged (const QString &)),
           SLOT (update_prpoints (const QString &)));

#if QT_VERSION > 0x040000
  le_prpoints->setToolTip (
      us_tr ("<p>Optionally enter the number of points in the estimated "
             "function p(r): more points increase the "
             "cpu-time.</p><p>Default: 50, Maximum 500</p>"));
#endif
  ...
  lbl_noextracalc
      = new QLabel (us_tr (" Number of extra error calculations :"), this);
  lbl_noextracalc->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_noextracalc->setPalette (PALET_LABEL);
  lbl_noextracalc->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize,
                                   QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_noextracalc);
  lbl_noextracalc->setToolTip (us_tr (
      "<p>Optionally Input number of extra error calculations (max "
      "1000).</p><p>Entering a large number will improve the error "
      "estimate,</p><p>but require more cpu time.</p><p>In some cases it may "
      "be a little tricky to obtain a decent</p><p>error estimate. Try "
      "testing a couple of values to see the effect. </p>"));
#endif
  ...
  le_noextracalc->setText (
      parameters->count ("noextracalc") ? (*parameters)["noextracalc"] : "");
  le_noextracalc->setEnabled (true);
  le_noextracalc->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  le_noextracalc->setPalette (PALET_NORMAL);
  connect (le_noextracalc, SIGNAL (textChanged (const QString &)),
           SLOT (update_noextracalc (const QString &)));

#if QT_VERSION > 0x040000
  le_noextracalc->setToolTip (us_tr (
      "<p>Optionally Input number of extra error calculations (max "
      "1000).</p><p>Entering a large number will improve the error "
      "estimate,</p><p>but require more cpu time.</p><p>In some cases it may "
      "be a little tricky to obtain a decent</p><p>error estimate. Try "
  ...
  lbl_transform
      = new QLabel (us_tr (" Transformation/Regularization :"), this);
  lbl_transform->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_transform->setPalette (PALET_LABEL);
  lbl_transform->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_transform);
  lbl_transform->setToolTip (us_tr (
      "<p>[D]ebye (default -> returning p(r) with positivity constraint)      "
      "                                  sin(q*r)/(q*r) * dr</p><p>[N]egative "
      "(Debye transformation -> returning p(r) without positivity constraint) "
      "      sin(q*r)/(q*r) * dr</p><p>[M]axEnt using an ellipsoid of "
      "revolution as prior ( -> p(r) -positivity constraint)       "
      "sin(q*r)/(q*r) * dr</p><p>     The axial ratio for the ellipsoid is "
      "optimized using the posterior probability.</p><p>     The axial ratio "
      "may be initialized or fixed using the box <i>Estimate axial "
      "ratio</i></p><p>     (leave the box <i>Fit axial ratio</i> "
      "empty).</p><p>[B]essel (for cylindrical scatterers -> cross section "
      "distribution)        J_0(q*r)/q * dr</p><p>[C]osine (lamellae -> "
      "thickness distribution)                                    "
      "cos(q*r)/q**2 * dr</p><p>[S]ize (using spheres only -> size "
      "distribution)        (3*sin(q*r)-q*r*cos(q*r))/(q*r)**3)**2 * dr "
      "</p>"));
#endif
  ...
  lb_transform->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  lb_transform->setPalette (PALET_NORMAL);
#if QT_VERSION > 0x040000
  lb_transform->setToolTip (us_tr (
      "<p>[D]ebye (default -> returning p(r) with positivity constraint)      "
      "                                  sin(q*r)/(q*r) * dr</p><p>[N]egative "
      "(Debye transformation -> returning p(r) without positivity constraint) "
      "      sin(q*r)/(q*r) * dr</p><p>[M]axEnt using an ellipsoid of "
  ...
  connect (lb_transform, SIGNAL (itemSelectionChanged ()),
           SLOT (set_transform ()));

  {
    QStringList qsl
        = QString ("Debye (default -> returning p(r) with positivity "
                   "constraint)~D~Negative (Debye transformation -> returning "
                   "p(r) without positivity constraint)~N~MaxEnt using an "
                   "ellipsoid of revolution as prior ( -> p(r) -positivity "
                   "constraint)~M~Bessel (for cylindrical scatterers -> cross "
                   "section distribution)~B~Cosine (lamellae -> thickness "
                   "distribution)~C~Size (using spheres only -> size "
                   "distribution)~S")
              .split ("~");
  ...
  cb_nondilute->setChecked (
      parameters->count ("nondilute")
          ? ((*parameters)["nondilute"] == "true" ? true : false)
          : false);
  cb_nondilute->setEnabled (true);
  cb_nondilute->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  if (col == 0)
    {
      background->addWidget (cb_nondilute, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  lbl_eta->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_eta);
  lbl_eta->setToolTip (
      us_tr ("<p>The exact value entered here may influence the result when "
             "the information content of the data is low.</p><p>Start with a "
             "small number e.g. 0.01 to avoid numerical instabilities and "
             "long cpu times.</p>"));
#endif
  ...
  le_eta->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_eta->setPalette (PALET_NORMAL);
  connect (le_eta, SIGNAL (textChanged (const QString &)),
           SLOT (update_eta (const QString &)));
  ...
  repeats[cb_nondilute].push_back (lbl_eta);
  repeats[cb_nondilute].push_back (le_eta);
  ...
  lbl_fitratio->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize, QFont::Bold));
  ...
  lb_fitratio->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  connect (lb_fitratio, SIGNAL (itemSelectionChanged ()),
           SLOT (set_fitratio ()));

  {
    QStringList qsl
        = QString (
              "No concentration "
              "effects~noconceffects~Moment~moment~No~no~Evidence~evidence")
              .split ("~");
    bool any_selected = false;
    for (int i = 0; i < (int)qsl.size (); i += 2)
      {
  ...
  repeats[cb_nondilute].push_back (lbl_fitratio);
  repeats[cb_nondilute].push_back (lb_fitratio);
  ...
  lbl_estimateratio->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize,
                                     QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_estimateratio);
  lbl_estimateratio->setToolTip (
      us_tr ("Optionally enter an estimate of the axial ratio"));
#endif
  ...
  le_estimateratio->setText (parameters->count ("estimateratio")
                                 ? (*parameters)["estimateratio"]
                                 : "");
  le_estimateratio->setEnabled (true);
  le_estimateratio->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  le_estimateratio->setPalette (PALET_NORMAL);
  connect (le_estimateratio, SIGNAL (textChanged (const QString &)),
           SLOT (update_estimateratio (const QString &)));

#if QT_VERSION > 0x040000
  le_estimateratio->setToolTip (
      us_tr ("Optionally enter an estimate of the axial ratio"));
#endif
  ...
  repeats[cb_nondilute].push_back (lbl_estimateratio);
  repeats[cb_nondilute].push_back (le_estimateratio);
  cb_estimateratiofixed = new QCheckBox (this);
  cb_estimateratiofixed->setText (us_tr ("Fix "));
  cb_estimateratiofixed->setChecked (
      parameters->count ("estimateratiofixed")
          ? ((*parameters)["estimateratiofixed"] == "true" ? true : false)
          : false);
  cb_estimateratiofixed->setEnabled (true);
  cb_estimateratiofixed->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  connect (cb_estimateratiofixed, SIGNAL (clicked ()),
           SLOT (set_estimateratiofixed ()));

  if (col == 0)
    {
      background->addWidget (cb_estimateratiofixed, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  if (0 == 10)
    {
      if (col == 0)
        {
          background->addWidget (pb_go, row, 0, 1 + (row) - (row),
                                 1 + (1) - (0));
          col = 2;
        }
      else
...

  {
    ...
    background->addLayout (hbl, row, 0, 1 + (row) - (row),
                           1 + (colmax - 1) - (0));
  }
...
void
US_Hydrodyn_Saxs_Ift::update_qmin (const QString &str)
{
  (*parameters)["qmin"] = str;
}

void
US_Hydrodyn_Saxs_Ift::update_qmax (const QString &str)
{
  (*parameters)["qmax"] = str;
}

void
US_Hydrodyn_Saxs_Ift::set_fitbackground ()
{
  (*parameters)["fitbackground"]
      = cb_fitbackground->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Saxs_Ift::update_dmax (const QString &str)
{
  (*parameters)["dmax"] = str;
}

void
US_Hydrodyn_Saxs_Ift::set_dmaxfixed ()
{
  (*parameters)["dmaxfixed"] = cb_dmaxfixed->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Saxs_Ift::update_alpha (const QString &str)
{
  (*parameters)["alpha"] = str;
}

void
US_Hydrodyn_Saxs_Ift::set_alphafixed ()
{
  (*parameters)["alphafixed"] = cb_alphafixed->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Saxs_Ift::update_smearing (const QString &str)
{
  (*parameters)["smearing"] = str;
}

void
US_Hydrodyn_Saxs_Ift::update_prpoints (const QString &str)
{
  (*parameters)["prpoints"] = str;
}

void
US_Hydrodyn_Saxs_Ift::update_noextracalc (const QString &str)
{
  (*parameters)["noextracalc"] = str;
}

void
US_Hydrodyn_Saxs_Ift::set_transform ()
{
  (*parameters)["transform"] =
      ...
      !lb_transform->selectedItems ().isEmpty ()
              && value_map_transform.count (
                  lb_transform->selectedItems ().first ()->text ())
          ? value_map_transform
                [lb_transform->selectedItems ().first ()->text ()]
          :
#endif
...
void
US_Hydrodyn_Saxs_Ift::set_nondilute ()
{
...
void
US_Hydrodyn_Saxs_Ift::update_eta (const QString &str)
{
  (*parameters)["eta"] = str;
}

void
US_Hydrodyn_Saxs_Ift::set_fitratio ()
{
  (*parameters)["fitratio"] =
#if QT_VERSION < 0x040000
      ...
      !lb_fitratio->selectedItems ().isEmpty ()
              && value_map_fitratio.count (
                  lb_fitratio->selectedItems ().first ()->text ())
...
void
US_Hydrodyn_Saxs_Ift::update_estimateratio (const QString &str)
{
  (*parameters)["estimateratio"] = str;
}

void
US_Hydrodyn_Saxs_Ift::set_estimateratiofixed ()
{
  (*parameters)["estimateratiofixed"]
      = cb_estimateratiofixed->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Saxs_Ift::go ()
{
