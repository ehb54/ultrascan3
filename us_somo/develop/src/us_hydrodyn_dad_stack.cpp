...
dad_stack_data
US_Hydrodyn_Dad::current_data (bool selected_only)
{
...
void
US_Hydrodyn_Dad::stack_push_all ()
{
  disable_all ();
...
void
US_Hydrodyn_Dad::stack_push_sel ()
{
  disable_all ();
...
void
US_Hydrodyn_Dad::set_current_data (dad_stack_data &tmp_stack)
{
  lb_files->clear ();
...
void
US_Hydrodyn_Dad::stack_rot_down ()
{
  vector<dad_stack_data> new_stack;
...
void
US_Hydrodyn_Dad::stack_join ()
{
  stack_join (stack_data.back ());
}

void
US_Hydrodyn_Dad::stack_join (dad_stack_data &tmp_stack)
{
