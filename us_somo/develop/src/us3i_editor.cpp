    ...
    : QMainWindow (parent)
{
  ...
  currentFont
      = QFont ("monospace", US3i_GuiSettings::fontSize () - 1, QFont::Bold);
...
void
US3i_Editor::load (void)
{
  QString fn;
  QString text;

  fn = QFileDialog::getOpenFileName (this, tr ("Open File"), file_directory,
                                     file_extension);
