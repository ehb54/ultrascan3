...
void
US_Hydrodyn_Batch_Movie_Opts::setupGUI ()
{
  int minHeight1 = 30;
  int minHeight2 = 30;
  ...
  AUTFBACK (le_title);
  le_title->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  lbl_file = new QLabel (
      us_tr (" Name of movie file (.avi will be appended):"), this);
  ...
  AUTFBACK (le_file);
  le_file->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_fps);
  le_fps->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_scale);
  le_scale->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  cb_use_tc->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_tc_unit);
  le_tc_unit->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  le_tc_start->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  le_tc_delta->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  le_tc_pointsize->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_black_background->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  cb_do_pat->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_clean_up->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Batch_Movie_Opts::cancel ()
{
  close ();
}

void
US_Hydrodyn_Batch_Movie_Opts::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Batch_Movie_Opts::update_title (const QString &str)
{
  *title = str;
}

void
US_Hydrodyn_Batch_Movie_Opts::update_dir (const QString &str)
{
  *dir = str;
  if (str == "")
    {
...
void
US_Hydrodyn_Batch_Movie_Opts::update_file (const QString &str)
{
  *file = str;
}

void
US_Hydrodyn_Batch_Movie_Opts::update_fps (const QString &str)
{
  *fps = str.toDouble ();
}

void
US_Hydrodyn_Batch_Movie_Opts::update_scale (const QString &str)
{
  *scale = str.toDouble ();
}

void
US_Hydrodyn_Batch_Movie_Opts::update_tc_unit (const QString &str)
{
  *tc_unit = str;
}

void
US_Hydrodyn_Batch_Movie_Opts::update_tc_start (const QString &str)
{
  *tc_start = str.toDouble ();
}

void
US_Hydrodyn_Batch_Movie_Opts::update_tc_delta (const QString &str)
{
  *tc_delta = str.toDouble ();
}

void
US_Hydrodyn_Batch_Movie_Opts::update_tc_pointsize (const QString &str)
{
  *tc_pointsize = str.toDouble ();
}

void
US_Hydrodyn_Batch_Movie_Opts::set_clean_up ()
{
  *clean_up = cb_clean_up->isChecked ();
}

void
US_Hydrodyn_Batch_Movie_Opts::set_use_tc ()
{
...
void
US_Hydrodyn_Batch_Movie_Opts::set_black_background ()
{
  *black_background = cb_black_background->isChecked ();
}

void
US_Hydrodyn_Batch_Movie_Opts::set_do_pat ()
{
  *do_pat = cb_do_pat->isChecked ();
}

void
US_Hydrodyn_Batch_Movie_Opts::update_enables ()
{
...
void
US_Hydrodyn_Batch_Movie_Opts::update_dir_msg ()
{
  QFileInfo fi (*dir);
  if (!fi.exists ())
    {
