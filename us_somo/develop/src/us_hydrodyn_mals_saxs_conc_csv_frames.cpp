...
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames (
    ...
    : QDialog (p)
{
  ...
  setWindowTitle (
      us_tr ("US-SOMO MALS_SAXS: Concentration CSV Time -> Frame conversion"));
...
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::
    ~US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames ()
{
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::cancel ()
{
  parameters->clear ();
  close ();
}
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::help ()
{
  US_Help *online_help;
  online_help = new US_Help (this);
  online_help->show_help ("manual/somo/mals_saxs_conc_csv_frames.html");
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::closeEvent (QCloseEvent *e)
{
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept ();
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::showhide (vector<QWidget *> &widgets,
                                                 bool isChecked)
{
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::setupGUI ()
{
  ...
  int col = 0;
  int colmax = 0;
  lbl_label_0 = new QLabel (
      us_tr ("Concentration CSV in Time to Frames conversion"), this);
  ...
  lbl_starttime->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_starttime);
  lbl_starttime->setToolTip (
      us_tr ("The starting time of the first point in dataset"));
#endif
  ...
  le_starttime->setText (
      parameters->count ("starttime") ? (*parameters)["starttime"] : "");
  le_starttime->setEnabled (true);
  le_starttime->setReadOnly (true);
  le_starttime->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_starttime->setPalette (PALET_NORMAL);
  connect (le_starttime, SIGNAL (textChanged (const QString &)),
           SLOT (update_starttime (const QString &)));

#if QT_VERSION > 0x040000
  le_starttime->setToolTip (
      us_tr ("The starting time of the first point in dataset"));
#endif
  ...
  lbl_endtime->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));

#if QT_VERSION > 0x040000
  AUTFBACK (lbl_endtime);
  lbl_endtime->setToolTip (
      us_tr ("The starting time of the last point in dataset"));
#endif
  ...
  le_endtime->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_endtime->setPalette (PALET_NORMAL);
  connect (le_endtime, SIGNAL (textChanged (const QString &)),
           SLOT (update_endtime (const QString &)));

#if QT_VERSION > 0x040000
  le_endtime->setToolTip (
      us_tr ("The starting time of the last point in dataset"));
#endif
  ...
  lbl_pointcount->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize,
                                  QFont::Bold));
  ...
  le_pointcount->setText (
      parameters->count ("pointcount") ? (*parameters)["pointcount"] : "");
  le_pointcount->setEnabled (true);
  le_pointcount->setReadOnly (true);
  le_pointcount->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  le_pointcount->setPalette (PALET_NORMAL);
  connect (le_pointcount, SIGNAL (textChanged (const QString &)),
           SLOT (update_pointcount (const QString &)));
  ...
  lbl_frame1t->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize, QFont::Bold));
  ...
  le_frame1t->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_frame1t->setPalette (PALET_NORMAL);
  connect (le_frame1t, SIGNAL (textChanged (const QString &)),
           SLOT (update_frame1t (const QString &)));
  ...
  lbl_time2frame->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize,
                                  QFont::Bold));
  ...
  le_time2frame->setText (
      parameters->count ("time2frame") ? (*parameters)["time2frame"] : "");
  le_time2frame->setEnabled (true);

  le_time2frame->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  le_time2frame->setPalette (PALET_NORMAL);
  connect (le_time2frame, SIGNAL (textChanged (const QString &)),
           SLOT (update_time2frame (const QString &)));
  ...
  cb_startframe->setChecked (
      parameters->count ("startframe")
          ? ((*parameters)["startframe"] == "true" ? true : false)
          : false);
  cb_startframe->setEnabled (true);
  cb_startframe->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  cb_startframe->setPalette (PALET_NORMAL);
#if QT_VERSION > 0x040000
  AUTFBACK (cb_startframe);
  cb_startframe->setToolTip (
      us_tr ("Optionally specify the starting frame number to extract, "
             "default is frame number 1 if not checked"));
#endif
  ...
  if (col == 0)
    {
      background->addWidget (cb_startframe, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  lbl_startframenumber->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize,
                                        QFont::Bold));
  ...
  le_startframenumber->setText (parameters->count ("startframenumber")
                                    ? (*parameters)["startframenumber"]
                                    : "");
  le_startframenumber->setEnabled (true);
  le_startframenumber->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  le_startframenumber->setPalette (PALET_NORMAL);
  connect (le_startframenumber, SIGNAL (textChanged (const QString &)),
           SLOT (update_startframenumber (const QString &)));
  ...
  repeats[cb_startframe].push_back (lbl_startframenumber);
  repeats[cb_startframe].push_back (le_startframenumber);
  cb_endframe = new QCheckBox (this);
  cb_endframe->setText (us_tr ("Specify ending frame number to extract "));
  cb_endframe->setChecked (
      parameters->count ("endframe")
          ? ((*parameters)["endframe"] == "true" ? true : false)
          : false);
  cb_endframe->setEnabled (true);
  cb_endframe->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  cb_endframe->setPalette (PALET_NORMAL);
#if QT_VERSION > 0x040000
  AUTFBACK (cb_endframe);
  cb_endframe->setToolTip (
      us_tr ("Optionally specify the ending frame number to extract, default "
             "is last frame number available"));
#endif
  ...
  if (col == 0)
    {
      background->addWidget (cb_endframe, row, 0, 1 + (row) - (row),
                             1 + (1) - (0));
      col = 2;
    }
  else
  ...
  lbl_endframenumber->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize,
                                      QFont::Bold));
  ...
  le_endframenumber->setText (parameters->count ("endframenumber")
                                  ? (*parameters)["endframenumber"]
                                  : "");
  le_endframenumber->setEnabled (true);
  le_endframenumber->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  le_endframenumber->setPalette (PALET_NORMAL);
  connect (le_endframenumber, SIGNAL (textChanged (const QString &)),
           SLOT (update_endframenumber (const QString &)));
  ...
  repeats[cb_endframe].push_back (lbl_endframenumber);
  repeats[cb_endframe].push_back (le_endframenumber);
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_starttime (const QString &str)
{
  (*parameters)["starttime"] = str;
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_endtime (const QString &str)
{
  (*parameters)["endtime"] = str;
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_pointcount (const QString &str)
{
  (*parameters)["pointcount"] = str;
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_frame1t (const QString &str)
{
  (*parameters)["frame1t"] = str;
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_time2frame (const QString &str)
{
  (*parameters)["time2frame"] = str;
}

void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::set_startframe ()
{
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_startframenumber (
    const QString &str)
{
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::set_endframe ()
{
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::update_endframenumber (
    const QString &str)
{
...
void
US_Hydrodyn_Mals_Saxs_Conc_Csv_Frames::go ()
{
