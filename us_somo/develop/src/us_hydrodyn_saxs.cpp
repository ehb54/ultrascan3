...
#define SET_WIDTH_FROM_TEXT_LEN_PAD(widget, pad)                             \
  (widget->setMaximumWidth(QFontMetrics(widget->font()).averageCharWidth() * \
                           1.4 * (pad + widget->text().length())))
...
US_Hydrodyn_Saxs::US_Hydrodyn_Saxs(
  ...
  *saxs_widget = true;
  ...
  switch (source) {
    ...
    default:  // undefined
    {
      ...
      //                us_tr("The source file has not been defined, please try
      //                again..."), QMessageBox::Critical,
  ...
  */
...
#if defined(TEST_PR_SD_ZEROS)
  {
    ...
    US_Vector::printvector3("test_pr_sd_zeros after set_pr_sd r, pr, pr_error",
                            r, pr, pr_error);
...
#if defined(TEST_SPLINE)
  {
    ...
    vector<double> pr{
        0,       214.113, 2899.98, 4356.94, 5064.47, 5996.28, 8773.47,
        9142.83, 11972.1, 14382.3, 16433.9, 17822.1, 19401.3, 21125.9,
        22991.6, 23459.2, 23826.9, 24262.5, 24312,   24970.1, 23414.5,
        24176.2, 22509,   21580.1, 18877.5, 16910.8, 14819.3, 12569.9,
        11300.5, 9325.03, 8177.13, 6942.54, 6054.87, 4466.99, 3982.04,
        2886.17, 2360.64, 2167.71, 1586.22, 1371.81, 913.865, 626.773,
        388.171, 268.683, 103.848, 83.4387, 42.6576, 8.68127, 6.99182};
    vector<double> npr;
...
void US_Hydrodyn_Saxs::refresh(QString filename, QString filepathname,
...
void US_Hydrodyn_Saxs::setupGUI() {
  ...
  rb_saxs_iq_native_debye->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  if (started_in_expert_mode) {
    ...
    rb_saxs_iq_native_hybrid->setFont(QFont(USglobal->config_list.fontFamily,
    ...
    rb_saxs_iq_native_hybrid2->setFont(QFont(USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
    ...
    rb_saxs_iq_native_hybrid3->setFont(QFont(USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  rb_saxs_iq_native_fast->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  rb_sans_iq_native_debye->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  if (started_in_expert_mode) {
    ...
    rb_sans_iq_native_hybrid->setFont(QFont(USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
    ...
    rb_sans_iq_native_hybrid2->setFont(QFont(USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
    ...
    rb_sans_iq_native_hybrid3->setFont(QFont(USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  rb_sans_iq_native_fast->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...
#warning restore info2 when back to vdw tests
  ...
  plot_pr->setTitleFont(QFont(USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize + 2, QFont::Bold));
  plot_pr->setAxisTitleFont(QwtPlot::yLeft,
                            QFont(USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize, QFont::Bold));
#endif
  ...
  cb_resid_show_errorbars->setChecked(
      ...
      ((US_Hydrodyn *)us_hydrodyn)->gparams["saxs_cb_resid_show_errorbars"] ==
          "1");
  cb_resid_show_errorbars->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_manual_guinier_fit_start->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_manual_guinier_fit_end->setObjectName("manual_guinier_fit_end Line Edit");
  ...
  le_manual_guinier_fit_end->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  pb_manual_guinier_process->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  // ) - ( 2 ) ); background->addWidget( plot_pr , j , 2 , 1 + ( j ) - ( j ) , 1
  // + ( 2 ) - ( 2 ) );
  j++;
...
void US_Hydrodyn_Saxs::cancel() { close(); }
...
void saxs_pr_thr_t::saxs_pr_thr_setup(vector<saxs_atom> *atoms,
  ...
  while (1) {
    ...
    for (unsigned int i = thread; i < as1; i += threads) {
      ...
      for (unsigned int k = i + 1; k < as; k++) {
        ...
        cout << "dist atoms:  " << i << " " << (*atoms)[i].saxs_name << "," << k
             << " " << (*atoms)[k].saxs_name << " " << rik << endl;
#endif
...
void US_Hydrodyn_Saxs::update_guinier_lowq2(const QString &) { set_guinier(); }

void US_Hydrodyn_Saxs::update_guinier_highq2(const QString &) { set_guinier(); }

void US_Hydrodyn_Saxs::update_user_lowq(const QString &) { set_guinier(); }

void US_Hydrodyn_Saxs::update_user_highq(const QString &) { set_guinier(); }

void US_Hydrodyn_Saxs::update_user_lowI(const QString &) { set_guinier(); }

void US_Hydrodyn_Saxs::update_user_highI(const QString &) { set_guinier(); }
...
void US_Hydrodyn_Saxs::show_plot_pr() {
  ...
  if ((double)our_saxs_options->water_e_density) {
    atom_map["OW~O2H2"].saxs_excl_vol =
        10 / ((double)our_saxs_options->water_e_density +
...
#warning pr_to_iq off except for bead model source
...
#endif
    editor_msg("black",
               QString("\n\nPreparing file %1 model %2 for p(r) vs r plot in "
                       "%3 mode%4.\n\n")
    ...
    if (source) {
      ...
      bool saxs_water_beads =
          ...
          ((US_Hydrodyn *)us_hydrodyn)->gparams["vdw_saxs_water_beads"] ==
              "true";
      ...
      for (unsigned int j = 0; j < bead_models[current_model].size(); j++) {
        ...
        new_atom.b = this_atom->num_elect
        ...
        if (this_atom->bead_hydration && saxs_water_beads) {
          ...
          QTextStream(stdout) << QString(
                                     "pr calc bead model : atom %1 %2 e %3 "
      ...
      if (rb_curve_sans->isChecked()) {
        ...
        for (map<QString, hybridization>::iterator it = hybrid_map.begin();
          ...
          if (it->first == "N3H1") {
            b[it->first + "-aa"] = it->second.scat_len +
      ...
      if (rb_curve_saxs->isChecked()
        ...
        // if ( !saxs_map.count("H") )
        // {
        // US_Static::us_message(us_tr("No Hydrogens:"), us_tr("No Hydrogen
        // defined in SAXS Atom table")); return;
        // }
...
// #define DEBUG_PR_COEFF
          ...
          QTextStream(stdout)
              ...
              << it->second.hydrogens << " exch_prot " << it->second.exch_prot
              << " num elect " << it->second.num_elect << " saxs_name "
              << it->second.saxs_name << " saxs_excl_vol noH "
              << saxs_map[it->second.saxs_name].volume
              // << " saxs_excl_vol  " << (
              // saxs_map[it->second.saxs_name].volume + it->second.hydrogens *
              // excl_volH )
              << endl;
#endif
      ...
      for (unsigned int j = 0; j < model_vector[current_model].molecule.size();
        ...
        for (unsigned int k = 0;
          ...
          if (rb_curve_sans->isChecked()) {
            ...
            double solvent_b = our_saxs_options->h2o_scat_len_dens *
            ...
            if (!atom_map.count(this_atom_name + "~" + hybrid_name)) {
              ...
              //                           QString( us_tr("Atom %1 not defined")
              //                           ).arg( this_atom_name ) );
              // }
              // progress_pr->reset();
              // lbl_core_progress->setText("");
            ...
            printf(
                "atom %d %d hybrid name %s, atom name %s b %e mapkey %s hybrid "
                "name %s\n",
                j, k, hybrid_name.toLatin1().data(),
                this_atom_name.toLatin1().data(), new_atom.b,
                mapkey.toLatin1().data(), hybrid_name.toLatin1().data());
#endif
          }
            ...
            if (rb_curve_saxs->isChecked()) {
              if (!hybrid_map.count(hybrid_name)) {
                ...
                editor_msg(
                    "red",
                    QString(
                        "%1Molecule %2 Residue %3 %4 Hybrid %5 name missing "
                        "from Hybrid file. Assuming zero radius!.\n")
...
#if defined(DEBUG_PR_COEFF)
            QTextStream(stdout)
                << "atom " << this_atom_name << " hybrid " << hybrid_name
...
#if defined(BUG_DEBUG)
            printf(
                "atom %d %d hybrid name %s, atom name %s b %e correction %e "
    ...
    if (!rb_curve_raw->isChecked()) {
      ...
      if (b_bar) {
        ...
        rb_curve_saxs->setChecked(false);
        rb_curve_sans->setChecked(false);
        editor_msg("red", us_tr("WARNING: < b > is zero! Reverting to RAW mode "
                                "for p(r) vs r computation."));
      }
    }
    ...
    if (0) {
      for (auto it = atoms.begin(); it != atoms.end(); ++it) {
        //    // QTextStream( stdout ) << QString( "saxs_name %1 hybrid_name %2
        //    residue_name %3 atom_name %4 b %5\n" )
        //    //    .arg( it->saxs_name )
        //    //    .arg( it->hybrid_name )
        //    //    .arg( it->residue_name )
        //    //    .arg( it->atom_name )
              ...
              if (atoms[i].atom_name == "OW") {
                for (unsigned int j = 0; j < atoms.size(); ++j) {
                  if (i != j && atoms[j].atom_name != "OW") {
                    double rik2 = (atoms[i].pos[0] - atoms[j].pos[0]) *
              ...
              switch (QMessageBox::question(
                ...
                case QMessageBox::Yes: {
                  ...
                  for (unsigned int j = 0;
                    ...
                    for (unsigned int k = 0;
                         k <
                         model_vector[current_model].molecule[j].atom.size();
                         k++) {
                      PDB_atom *this_atom =
                          &(model_vector[current_model].molecule[j].atom[k]);
                  ...
                  }
                  {
                    ...
                    if (((US_Hydrodyn *)us_hydrodyn)
                            ->write_pdb_from_model(
                                ...
                                QString(" WATs further than %1 [A] removed")
                                    .arg(ow_cutoff),
                      ...
                      editor_msg("red",
                                 QString(us_tr("Error writing File %1. %2\n"))
                                     .arg(writtenname)
                                     .arg(errors));
                    }
                  }
        ...
        }
        {
          ...
          if (!ow_wats_kept) {
            ...
            ow_cutoff = QInputDialog::getDouble(
                this, windowTitle() + " : WAT cutoff",
                tr("Cutoff WAT to non-WAT distance [A] (0 or CANCEL for no "
                   "cutoff) : "),
                    ...
                    }
                    {
                      ...
                      if (((US_Hydrodyn *)us_hydrodyn)
                              ->write_pdb_from_model(
                                  ...
                                  QString(" WATs further than %1 [A] removed")
                                      .arg(ow_cutoff),
                                  QString("_co%1").arg(ow_cutoff).replace(".",
                                                                          "_"),
                                  model_filepathname)) {
          ...
          if (spec_wat_check) {
            for (unsigned int j = i + 1; j < atoms.size(); j++) {
              if (atoms[i].atom_name != "OW" || atoms[j].atom_name != "OW") {
                rik = sqrt((atoms[i].pos[0] - atoms[j].pos[0]) *
                               (atoms[i].pos[0] - atoms[j].pos[0]) +
                           (atoms[i].pos[1] - atoms[j].pos[1]) *
                               (atoms[i].pos[1] - atoms[j].pos[1]) +
                           (atoms[i].pos[2] - atoms[j].pos[2]) *
                ...
                if (include_0_dist_pairs || rik) {
                  ...
                  if (rb_curve_raw->isChecked()) {
                    ...
                    double this_pr =
                        (double)atoms[i].b * atoms[j].b * b_bar_inv2;
                    hist[pos] += this_pr;
                    // if ( cb_guinier->isChecked() )
                    // {
    ...
    if (create_native_saxs) {
      ...
      QString fpr_name = USglobal->config_list.root_dir + SLASH + "somo" +
                         SLASH + "saxs" + SLASH + sprr_filestring(append);

      bool ok_to_write = true;
      if (QFile::exists(fpr_name) && !((US_Hydrodyn *)us_hydrodyn)->overwrite) {
        fpr_name =
            ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck(fpr_name, 0, this);
        ok_to_write = true;
#if defined(OLD_WAY)
      ...
      if (ok_to_write) {
        ...
        if (fpr) {
          ...
          normalize_pr(r, &pr_n, &pr_error,
                       get_mw(te_filename2->text(), false));
          ((US_Hydrodyn *)us_hydrodyn)->last_saxs_header = QString("").sprintf(
              "SOMO p(r) vs r data generated from %s by US_SOMO %s %s bin size "
              "%f mw %.2f Daltons area %.2f\n",
              model_filename.toLatin1().data(), US_Version.toLatin1().data(),
              REVISION, delta, get_mw(te_filename2->text(), false),
...
#endif
          editor->append(us_tr("WARNING: Could not create PR curve file: ") +
                         fpr_name + "\n");
          // QMessageBox mb(us_tr("UltraScan Warning"),
          //                us_tr("The output file ") + fpr_name + us_tr(" could
          //                not be created."), QMessageBox::Critical,
          //                QMessageBox::NoButton, QMessageBox::NoButton,
          //                QMessageBox::NoButton, 0, 0, 1);
          // mb.exec();
          QMessageBox::critical(this, us_tr("UltraScan Warning"),
...
void US_Hydrodyn_Saxs::load_plot_pr() { load_pr(true); }
...
void saxs_Iq_thr_t::saxs_Iq_thr_setup(
    ...
    vector<vector<double> > *fc, vector<vector<double> > *fp, vector<double> *I,
    vector<double> *Ia, vector<double> *Ic, vector<double> *q,
    unsigned int threads, mQProgressBar *progress, QLabel *lbl_core_progress,
    bool *stopFlag) {
  /* this starts up a new work load for the thread */
  this->atoms = atoms;
  this->f = f;
...
#if defined(DEBUG_THREAD)
    cerr << "thread " << thread << " as1 = " << as1 << " q_points " << q_points
         << endl;
#endif
...
void US_Hydrodyn_Saxs::show_plot_saxs() {
  ...
  if (our_saxs_options->saxs_iq_native_debye) {
    ...
    if (f.exists() && f.open(QIODevice::ReadOnly)) {
      ...
      while (!ts.atEnd()) {
        ...
        if (qsl[0] == "pos" && qsl.size() == 7) {
          ...
          if (model_vector.size() > nmodel &&
            ...
            model_vector[nmodel]
                .molecule[nchain]
                .atom[natom]
                .coordinate.axis[0] = qsl[4].toFloat();
            model_vector[nmodel]
                .molecule[nchain]
                .atom[natom]
                .coordinate.axis[1] = qsl[5].toFloat();
            model_vector[nmodel]
                .molecule[nchain]
                .atom[natom]
                .coordinate.axis[2] = qsl[6].toFloat();
            ...
            editor_msg(
                "red",
                QString("atom not found line %1, running once & quitting\n")
                    .arg(line));
            source ? calc_saxs_iq_native_debye_bead_model()
                   : calc_saxs_iq_native_debye();
            specname = "";
        ...
        editor_msg("red", QString("unrecogized or misformatted command in "
  ...
  for (unsigned int i = 0; i < selected_models.size(); i++) {
    ...
    for (unsigned int j = 0; j < model_vector[current_model].molecule.size();
      ...
      for (unsigned int k = 0;
        ...
        if (hybrid_name.isEmpty() || !hybrid_name.length()) {
          cout << "error: hybrid name missing for " << this_atom->resName << "|"
               << this_atom->name << endl;
          editor_msg("red",
                     QString("%1Molecule %2 Residue %3 %4 Hybrid name missing. "
                             "Atom skipped.\n")
                         .arg(this_atom->chainID == " "
                                  ? ""
                                  : ("Chain " + this_atom->chainID + " "))
        ...
        if (!atom_map.count(this_atom_name + "~" + hybrid_name)) {
          cout << "error: (saxs 1) atom_map missing for hybrid_name "
               << hybrid_name << " atom name " << this_atom_name << endl;
          editor_msg("red",
        ...
        if (!saxs_map.count(hybrid_map[hybrid_name].saxs_name)) {
          cout << "error: saxs_map missing for hybrid_name " << hybrid_name
               << " saxs name " << hybrid_map[hybrid_name].saxs_name << endl;
          editor_msg(
              "red",
              QString("%1Molecule %2 Residue %3 %4 Hybrid %5 Saxs name %6 name "
                      "missing from SAXS atom file. Atom skipped.\n")
                  .arg(this_atom->chainID == " "
                           ? ""
                           : ("Chain " + this_atom->chainID + " "))
                  .arg(j + 1)
        ...
        cout << "Atom: " << this_atom->name
             ...
             << " Coordinates: " << new_atom.pos[0] << " , " << new_atom.pos[1]
             << " , " << new_atom.pos[2] << " Excl vol: " << new_atom.excl_vol
             << endl;
#endif
        atoms.push_back(new_atom);
      }
    ...
    QString fsaxs_atoms_name = USglobal->config_list.root_dir + SLASH "somo" +
                               ...
                               QString("_%1").arg(current_model + 1) + ".atoms";
    ...
    cout << "start q:" << our_saxs_options->start_q
         ...
         << " delta q:" << our_saxs_options->delta_q << " q points:" << q_points
         << endl;
#endif
    ...
    for (unsigned int i = 0; i < atoms.size(); i++) {
      ...
      cout << QString("").sprintf(
          ...
          saxs.b[0], saxs.a[1], saxs.b[1], saxs.a[2], saxs.b[2], saxs.a[3],
          saxs.b[3], saxs.c);
#endif
      ...
      for (unsigned int j = 0; j < q_points; j++) {
        ...
        // possibly saving time... but this isn't our most computationally
        // intensive step so I'm holding off for now.
    ...
    plot_saxs->setCurvePen(
        Iq, QPen(plot_colors[p % plot_colors.size()], pen_width, SolidLine));
#else
    curve->setSamples(cb_guinier->isChecked() ? (double *)&(plotted_q2[p][0])
                                              : (double *)&(plotted_q[p][0]),
                      (double *)&(plotted_I[p][0]), q_points);
    curve->setPen(
        QPen(plot_colors[p % plot_colors.size()], pen_width, Qt::SolidLine));
    ...
    if (create_native_saxs) {
      ...
      if (QFile::exists(fsaxs_name) &&
        ...
        fsaxs_name =
            ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck(fsaxs_name, 0, this);
        ok_to_write = true;
      ...
      if (ok_to_write) {
        ...
        if (fsaxs) {
          ...
          ((US_Hydrodyn *)us_hydrodyn)->last_saxs_header = QString("").sprintf(
              ...
              "q(%.3f:%.3f) step %.3f\n",
              model_filename.toLatin1().data(), US_Version.toLatin1().data(),
              REVISION, our_saxs_options->start_q, our_saxs_options->end_q,
              our_saxs_options->delta_q);
          fprintf(
              fsaxs, "%s",
              ((US_Hydrodyn *)us_hydrodyn)->last_saxs_header.toLatin1().data());
...
#endif
          editor->append(us_tr("WARNING: Could not create SAXS curve file: ") +
                         fsaxs_name + "\n");
          // QMessageBox mb(us_tr("UltraScan Warning"),
          //                us_tr("The output file ") + fsaxs_name + us_tr("
          //                could not be created."), QMessageBox::Critical,
          //                QMessageBox::NoButton, QMessageBox::NoButton,
          //                QMessageBox::NoButton, 0, 0, 1);
          // mb.exec();
          QMessageBox::critical(this, us_tr("UltraScan Warning"),
      ...
      ((US_Hydrodyn *)us_hydrodyn)->last_saxs_iqqc.clear();
      ((US_Hydrodyn *)us_hydrodyn)->last_saxs_header = QString("").sprintf(
          "Simulated SAXS data generated from %s by US_SOMO %s %s q(%.3f:%.3f) "
          "step %.3f\n",
          model_filename.toLatin1().data(), US_Version.toLatin1().data(),
          REVISION, our_saxs_options->start_q, our_saxs_options->end_q,
          our_saxs_options->delta_q);
  ...
  if (printer.setup(this)) {  // opens printer dialog
    ...
    for (int i = 0; i < editor->lines(); i++) {
      ...
      p.drawText(MARGIN, MARGIN + yPos, printer.width(), fm.lineSpacing(),
                 ExpandTabs | DontClip, editor->toPlainText(i));
  ...
  if (everything_plotted_has_same_grid_as_set()) {
    if (plotted_q.size()) {
      QMessageBox::information(
          ...
          QString(
              us_tr("NOTE: Everything plotted already matches the set grid")));
    } else {
...
void US_Hydrodyn_Saxs::select_atom_file() {
  ...
  atom_filename = QFileDialog::getOpenFileName(
      this, windowTitle(), US_Config::get_home_dir() + "etc", "*.atom *.ATOM");
...
void US_Hydrodyn_Saxs::select_atom_file(const QString &filename) {
  ...
  // add generic ABB
  {
    ...
    abb_atom.saxs_excl_vol =
        (4 / 3) * M_PI * pow(((US_Hydrodyn *)us_hydrodyn)->misc.avg_radius, 3);
  ...
  if (f.open(QIODevice::ReadOnly | QIODevice::Text)) {
    ...
    while (!ts.atEnd()) {
      ...
      editor_msg(
          ...
          QString(
              us_tr(
                  "Warning: %1 on line %2, invalid number of tokens, ignoring"))
              .arg(filename)
              .arg(line));
    }
    ...
    for (map<QString, saxs>::iterator it =
      ...
      if (saxs_map.count(it->first)) {
        editor_msg("dark red",
                   QString(us_tr("NOTICE: saxs coefficients for %1 replaced by "
                                 "newly loaded values\n"))
                       .arg(it->first));
      } else {
        saxs_list.push_back(it->second);
        editor_msg("dark blue", QString(us_tr("NOTICE: added coefficients for "
    ...
    if (!saxs_map.count(our_saxs_options->dummy_saxs_name)) {
      if (our_saxs_options->dummy_saxs_names.size()) {
        editor_msg(
            ...
            QString(
                us_tr(
                    "WARNING: default dummy atom name %1 was not defined in %2."
                    " Set now to %3"))
        ...
        editor_msg(
            "red",
            QString(us_tr("ERROR: no saxs structure factors found in %1."))
                .arg(filename));
      }
    }
  }
    ...
    for (unsigned int i = 0; i < (unsigned int)it->second.size(); i++) {
      for (unsigned int j = 0; j < (unsigned int)it->second.size(); j++) {
        hybrid_r[it->first][i][j] =
            sqrt((it->second[i].axis[0] - it->second[j].axis[0]) *
...
QString US_Hydrodyn_Saxs::sprr_filestring(const QString &append) {
  ...
  result +=
      QString(".sprr_%1").arg(((US_Hydrodyn *)us_hydrodyn)->saxs_sans_ext());
...
void US_Hydrodyn_Saxs::saxs_buffer() {
  ...
  for (unsigned int i = 0; i < plotted_q.size(); i++) {
    if (plotted_I_error[i].size() == plotted_I[i].size()) {
      ((US_Hydrodyn *)us_hydrodyn)
          ->saxs_buffer_window->add_plot(qsl_plotted_iq_names[i], plotted_q[i],
                                         plotted_I[i], plotted_I_error[i]);
    } else {
      ((US_Hydrodyn *)us_hydrodyn)
          ->saxs_buffer_window->add_plot(qsl_plotted_iq_names[i], plotted_q[i],
                                         plotted_I[i]);
...
void US_Hydrodyn_Saxs::saxs_hplc() {
  ...
  for (unsigned int i = 0; i < plotted_q.size(); i++) {
    ...
    if (plotted_I_error[i].size() == plotted_I[i].size()) {
      ((US_Hydrodyn *)us_hydrodyn)
          ->saxs_hplc_window->add_plot(qsl_plotted_iq_names[i], plotted_q[i],
                                       plotted_I[i], plotted_I_error[i]);
    } else {
      ((US_Hydrodyn *)us_hydrodyn)
          ->saxs_hplc_window->add_plot(qsl_plotted_iq_names[i], plotted_q[i],
...
bool US_Hydrodyn_Saxs::interpolate(vector<double> to_r, vector<double> from_r,
                                   vector<double> from_pr,
                                   vector<double> &to_data) {
  US_Saxs_Util usu;
  ...
  if (cb_user_range->isChecked() &&
    ...
    plot_saxs->setAxisTitle(
        ...
        cb_kratky->isChecked()
            ...
            : (cb_cs_guinier->isChecked()
                   ? us_tr("q*I(q) (log scale)")
                   : (cb_Rt_guinier->isChecked() ? us_tr("q^2*I(q) (log scale)")
                                                 : us_tr("I(q) (log scale)"))));
    plot_saxs->setAxisScaleEngine(
        QwtPlot::yLeft,
        cb_kratky->isChecked() ? new QwtLogScaleEngine(10) :  // fix this
...
// guinier)
void US_Hydrodyn_Saxs::plot_domain(double &lowq, double &highq) {
  if (cb_guinier->isChecked()) {
    // arbitrary defaults
  ...
  if (cb_user_range->isChecked()) {
    lowq = le_user_lowq->text().toDouble() ? le_user_lowq->text().toDouble()
                                           : lowq;
    highq = le_user_highq->text().toDouble() ? le_user_highq->text().toDouble()
                                             : highq;
  }
...
void US_Hydrodyn_Saxs::plot_range(double lowq, double highq, double &lowI,
                                  double &highI) {
  // arbitrary defaults
  lowI = 1e-3;
  highI = 1;
          ...
          for (unsigned int j = 0; j < plotted_q2[i].size(); j++) {
            if (plotted_q2[i][j] >= lowq && plotted_q2[i][j] <= highq &&
              ...
              if (!any_plots) {
                ...
                if (lowI >
                    plotted_q[i][j] * plotted_q[i][j] * plotted_I[i][j]) {
                  lowI = plotted_q[i][j] * plotted_q[i][j] * plotted_I[i][j];
                }
                if (highI <
                    plotted_q[i][j] * plotted_q[i][j] * plotted_I[i][j]) {
  ...
  if (cb_user_range->isChecked()) {
    lowI = le_user_lowI->text().toDouble() ? le_user_lowI->text().toDouble()
                                           : lowI;
    highI = le_user_highI->text().toDouble() ? le_user_highI->text().toDouble()
                                             : highI;
  }
...
void US_Hydrodyn_Saxs::crop_iq_data(vector<double> &q, vector<double> &I) {
  vector<double> new_q;
  vector<double> new_I;
...
void US_Hydrodyn_Saxs::display_iqq_residuals(QString title, vector<double> q,
                                             vector<double> I1,
                                             vector<double> I2,
                                             QColor plot_color,
                                             vector<double> I_errors) {
  ...
  if (saxs_iqq_residuals_widgets.count(title) &&
    ...
    // cout << "residuals add\n";
    saxs_iqq_residuals_windows[title]->add(plot_saxs->width(), q, difference,
                                           difference_no_errors, I2,
  ...
  if (rb_saxs->isChecked()) {
    if (our_saxs_options->saxs_iq_crysol) {
      ...
      if (U_EXPT &&
          ...
          ((US_Hydrodyn *)us_hydrodyn)->gparams["sas_crysol_ra"].toDouble() >
              0e0) {
        qs += QString("_ra%1")
      ...
      if (U_EXPT &&
          ...
          ((US_Hydrodyn *)us_hydrodyn)->gparams["sas_crysol_vol"].toDouble() >
              0e0) {
        qs += QString("_ev%1")
      ...
      if (our_saxs_options->saxs_iq_foxs) {
          ...
          qs +=
              QString("_%1__h%2_g%3_hs%4")
                  ...
                  .arg(
                      QString("%1")
                          .arg(
                              our_saxs_options->crysol_hydration_shell_contrast)
                          .replace(".", "_"));
        }
        if (our_saxs_options->saxs_iq_native_sh) {
          qs += "sh";
        ...
        if (our_saxs_options->scale_excl_vol != 1e0) {
          qs += QString("_evs%1").arg(QString("%1")
        ...
        if (our_saxs_options->swh_excl_vol != 0e0) {
          qs += QString("_swh%1").arg(QString("%1")
                                          .arg(our_saxs_options->swh_excl_vol)
                                          .replace(".", "_"));
        }
      }
  ...
  if (rb_sans->isChecked()) {
    ...
    if (our_saxs_options->sans_iq_cryson) {
      ...
      qs += QString("_h%1_g%2_hs%3")
                ...
                .arg(QString("%1")
                         .arg(our_saxs_options->cryson_hydration_shell_contrast)
                         .replace(".", "_"));
    }
    ...
    if (our_saxs_options->swh_excl_vol != 0e0) {
      qs += QString("_swh%1").arg(
          QString("%1").arg(our_saxs_options->swh_excl_vol).replace(".", "_"));
    }
  }
...
void US_Hydrodyn_Saxs::ask_iq_target_grid(bool force) {
  ...
  if (plotted_q[pos].size() < 2) {
    QMessageBox::warning(this, "Set I(q) grid",
                         QString(us_tr("Error: Too few data points (%!) to set "
                                       "the grid for target %2"))
    ...
    switch (QMessageBox::question(
      ...
      case QMessageBox::Yes: {
        ...
        int intervals = US_Static::getInteger(
            ...
            QString(us_tr("Enter the number of log bins")), 100, 10, 10000, 1,
            &ok, this);
        if (ok) {
          ...
          if (log_rebin(intervals, plotted_q[pos], plotted_I[pos],
            ...
            plot_one_iqq(rebin_q, rebin_I, rebin_e,
                         QString("%1-lb%2").arg(new_target).arg(intervals));
            set_guinier();
          } else {
            QMessageBox::critical(this, windowTitle() + " : Log Rebin Rebin",
                                  errors);
          }
        }
        return;
  ...
  do {
    ...
    if (delta_q <= 0e0) {
      editor_msg(
          "red",
          "NOTICE: plotted delta q is negative or zero: delta q set to 1e-6");
      delta_q = (float)1e-6;
    }
    ...
    our_saxs_options->start_angle =
        floor((asin(our_saxs_options->wavelength * our_saxs_options->start_q /
                    (4.0 * M_PI)) *
               360.0 / M_PI) *
                  SAXS_Q_ROUNDING +
              0.5) /
    ...
    our_saxs_options->end_angle =
        floor((asin(our_saxs_options->wavelength * our_saxs_options->end_q /
                    (4.0 * M_PI)) *
               360.0 / M_PI) *
                  SAXS_Q_ROUNDING +
              0.5) /
    ...
    our_saxs_options->delta_angle =
        floor((asin(our_saxs_options->wavelength * our_saxs_options->delta_q /
                    (4.0 * M_PI)) *
               360.0 / M_PI) *
                  SAXS_Q_ROUNDING +
              0.5) /
    ...
    int res = US_Static::getInteger(
        "SOMO: Confirm grid",
        QString(
            us_tr("Original number of grid points %1\n"
    ...
    if (ok) {
      ...
      if (!((US_Hydrodyn *)us_hydrodyn)->gui_script) {
        US_Static::us_message(
            ...
            QString(us_tr("Reverted to orignal grid containing %1 points"))
                .arg(grid_points));
      }
      ok = true;
    }
...
void US_Hydrodyn_Saxs::check_mwt_constants(bool force) {
  ...
  if (((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_mwt_k"].toDouble() != 1 ||
      ...
      ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_mwt_qmax"].toDouble() !=
          0.2) {
    QString msg = us_tr(
        "The MW calculations by the Rambo & Tainer method [Nature 496:477-81] "
        "appear to\n"
        "provide consistent results for proteins when using the default values "
        "for k, c and qmax.\n"
...
bool US_Hydrodyn_Saxs::write_temp_pdb_selected_models(QString &error_msg) {
  ...
  for (int h = 0; h < (int)selected_models.size(); ++h) {
    ...
    for (unsigned int j = 0; j < (unsigned int)model_vector[i].molecule.size();
         j++) {
      for (unsigned int k = 0;
        ...
        pdb_text += QString("").sprintf(
            ...
            this_atom->chainID.toLatin1().data(), this_atom->resSeq.toUInt(),
            this_atom->coordinate.axis[0], this_atom->coordinate.axis[1],
            this_atom->coordinate.axis[2], this_atom->occupancy,
            this_atom->tempFactor, this_atom->element.toLatin1().data());
      }
    }
