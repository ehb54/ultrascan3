...
void
US_Hydrodyn_Cluster_Bfnb::setupGUI ()
{
  int minHeight1 = 30;
  ...
  AUTFBACK (le_pmtypes);
  le_pmtypes->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_pmincrementally = new QCheckBox (
      us_tr ("Compute models for all lengths upto above"), this);
  ...
  cb_pmincrementally->setChecked (parameters->count ("pmincrementally")
                                      ...
                                      ? true
                                      : false);
  connect (cb_pmincrementally, SIGNAL (clicked ()),
           SLOT (set_pmincrementally ()));

  cb_pmallcombinations = new QCheckBox (
      us_tr ("Compute models for all unique combinations"), this);
  ...
  cb_pmallcombinations->setChecked (
      parameters->count ("pmallcombinations")
              && (*parameters)["pmallcombinations"] == "true"
          ? true
          : false);
  ...
  le_pmrayleighdrho->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  le_pmbufferedensity->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  le_pmoutname->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  le_pmgridsize->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_pmapproxmaxdimension = new QCheckBox (
      us_tr ("Automatically compute maximum dimension"), this);
  ...
  lbl_pmminq->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_pmminq->setMinimumWidth (QFontMetrics (lbl_pmminq->font ()).maxWidth ()
                               * 21);
  ...
  AUTFBACK (le_pmminq);
  le_pmminq->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  lbl_pmmaxq->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_pmmaxq->setMinimumWidth (QFontMetrics (lbl_pmmaxq->font ()).maxWidth ()
                               * 21);
  ...
  AUTFBACK (le_pmmaxq);
  le_pmmaxq->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  cb_pmlogqbin->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  cb_pmlogqbin->setMinimumWidth (
      QFontMetrics (cb_pmlogqbin->font ()).maxWidth () * 21);
  ...
  le_pmqpoints->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  lbl_pmharmonics
      = new QLabel (us_tr ("Maximum harmonics (default: 15)"), this);
  ...
  le_pmharmonics->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  lbl_pmseed->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));
  lbl_pmseed->setMinimumWidth (QFontMetrics (lbl_pmseed->font ()).maxWidth ()
                               * 21);
  ...
  AUTFBACK (le_pmseed);
  le_pmseed->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  lbl_pmmemory = new QLabel (
      us_tr ("Maximum memory per core in MB (default: 1024)"), this);
  ...
  lbl_pmmemory->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1,
                                QFont::Bold));
  lbl_pmmemory->setMinimumWidth (
      QFontMetrics (lbl_pmmemory->font ()).maxWidth () * 21);
  ...
  lbl_pmbestfinestconversion = new QLabel (
      us_tr ("Finest grid size (default: same as Grid size)"), this);
  ...
  lbl_pmbestfinestconversion->setFont (
  ...
  le_pmbestfinestconversion->setObjectName (
      "pmbestfinestconversion Line Edit");
  ...
  le_pmbestfinestconversion->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  lbl_pmbestcoarseconversion->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  le_pmbestcoarseconversion->setObjectName (
      "pmbestcoarseconversion Line Edit");
  ...
  le_pmbestcoarseconversion->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  lbl_pmbestconversiondivisor->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  le_pmbestconversiondivisor->setText (
      parameters->count ("pmbestconversiondivisor")
          ...
          : "");
  le_pmbestconversiondivisor->setAlignment (Qt::AlignCenter
                                            | Qt::AlignVCenter);
  le_pmbestconversiondivisor->setPalette (PALET_NORMAL);
  AUTFBACK (le_pmbestconversiondivisor);
  le_pmbestconversiondivisor->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
  ...
  lbl_pmbestrefinementrangepct->setAlignment (Qt::AlignLeft
                                              | Qt::AlignVCenter);
  ...
  le_pmbestrefinementrangepct->setText (
      parameters->count ("pmbestrefinementrangepct")
          ...
          : "");
  le_pmbestrefinementrangepct->setAlignment (Qt::AlignCenter
                                             | Qt::AlignVCenter);
  le_pmbestrefinementrangepct->setPalette (PALET_NORMAL);
  AUTFBACK (le_pmbestrefinementrangepct);
  le_pmbestrefinementrangepct->setFont (QFont (
  ...
  lbl_pmmaxdimension = new QLabel (
      us_tr ("Maximum dimension (default & max: 32767 A)"), this);
  ...
  le_pmmaxdimension->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  le_pmgapopulation->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  le_pmgagenerations->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  le_pmgamutate->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  le_pmgasamutate->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  le_pmgacrossover->setText (parameters->count ("pmgacrossover")
                                 ? (*parameters)["pmgacrossover"]
                                 : "");
  ...
  le_pmgacrossover->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  le_pmgaelitism->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  le_pmgaearlytermination->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  lbl_pmgapointsmax = new QLabel (
      us_tr ("GA maximum points per parameter (default: 100)"), this);
  ...
  le_pmgapointsmax->setText (parameters->count ("pmgapointsmax")
                                 ? (*parameters)["pmgapointsmax"]
                                 : "");
  ...
  le_pmgapointsmax->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  le_pmbestdeltastart->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  le_pmbestdeltadivisor->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  ...
  lbl_pmbestdeltamin
      = new QLabel (us_tr ("Delta minimum (default .01)"), this);
  ...
  le_pmbestdeltamin->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  cb_pmcsv
      = new QCheckBox (us_tr ("Produce csv containing result curves"), this);
  ...
  cb_pmcsv->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1, QFont::Bold));
  cb_pmcsv->setMinimumWidth (QFontMetrics (cb_pmcsv->font ()).maxWidth ()
                             * 21);
  ...
  AUTFBACK (le_pmdebug);
  le_pmdebug->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Cluster_Bfnb::cancel ()
{
  close ();
}

void
US_Hydrodyn_Cluster_Bfnb::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster_Bfnb::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Cluster_Bfnb::hide_main_label ()
{
  hide_widgets (widgets_main_label,
                widgets_main_label.size ()
                    && widgets_main_label[0]->isVisible ());
}

void
US_Hydrodyn_Cluster_Bfnb::hide_widgets (vector<QWidget *> w, bool do_hide,
                                        bool do_resize)
{
...
void
US_Hydrodyn_Cluster_Bfnb::update_pmtypes (const QString &)
{
  (*parameters)["pmtypes"] = le_pmtypes->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::set_pmincrementally ()
{
  (*parameters)["pmincrementally"]
...
void
US_Hydrodyn_Cluster_Bfnb::set_pmallcombinations ()
{
...
void
US_Hydrodyn_Cluster_Bfnb::update_pmrayleighdrho (const QString &)
{
  (*parameters)["pmrayleighdrho"] = le_pmrayleighdrho->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbufferedensity (const QString &)
{
  (*parameters)["pmbufferedensity"] = le_pmbufferedensity->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmoutname (const QString &)
{
  (*parameters)["pmoutname"] = le_pmoutname->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgridsize (const QString &)
{
  (*parameters)["pmgridsize"] = le_pmgridsize->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::set_pmapproxmaxdimension ()
{
  (*parameters)["pmapproxmaxdimension"]
      = cb_pmapproxmaxdimension->isChecked () ? "true" : "false";
}
void
US_Hydrodyn_Cluster_Bfnb::hide_q_label ()
{
...
void
US_Hydrodyn_Cluster_Bfnb::update_pmminq (const QString &)
{
  (*parameters)["pmminq"] = le_pmminq->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmmaxq (const QString &)
{
  (*parameters)["pmmaxq"] = le_pmmaxq->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::set_pmlogqbin ()
{
  (*parameters)["pmlogqbin"] = cb_pmlogqbin->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmqpoints (const QString &)
{
  (*parameters)["pmqpoints"] = le_pmqpoints->text ();
}
void
US_Hydrodyn_Cluster_Bfnb::hide_supp_label ()
{
  hide_widgets (widgets_supp_label,
                widgets_supp_label.size ()
                    && widgets_supp_label[0]->isVisible ());
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmharmonics (const QString &)
{
  (*parameters)["pmharmonics"] = le_pmharmonics->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmseed (const QString &)
{
  (*parameters)["pmseed"] = le_pmseed->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmmemory (const QString &)
{
  (*parameters)["pmmemory"] = le_pmmemory->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestfinestconversion (const QString &)
{
  (*parameters)["pmbestfinestconversion"] = le_pmbestfinestconversion->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestcoarseconversion (const QString &)
{
  (*parameters)["pmbestcoarseconversion"] = le_pmbestcoarseconversion->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestconversiondivisor (const QString &)
{
  (*parameters)["pmbestconversiondivisor"]
      = le_pmbestconversiondivisor->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestrefinementrangepct (const QString &)
{
  (*parameters)["pmbestrefinementrangepct"]
...
void
US_Hydrodyn_Cluster_Bfnb::update_pmmaxdimension (const QString &)
{
  (*parameters)["pmmaxdimension"] = le_pmmaxdimension->text ();
}
void
US_Hydrodyn_Cluster_Bfnb::hide_ga_label ()
{
...
void
US_Hydrodyn_Cluster_Bfnb::update_pmgapopulation (const QString &)
{
  (*parameters)["pmgapopulation"] = le_pmgapopulation->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgagenerations (const QString &)
{
  (*parameters)["pmgagenerations"] = le_pmgagenerations->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgamutate (const QString &)
{
  (*parameters)["pmgamutate"] = le_pmgamutate->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgasamutate (const QString &)
{
  (*parameters)["pmgasamutate"] = le_pmgasamutate->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgacrossover (const QString &)
{
  (*parameters)["pmgacrossover"] = le_pmgacrossover->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgaelitism (const QString &)
{
  (*parameters)["pmgaelitism"] = le_pmgaelitism->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgaearlytermination (const QString &)
{
  (*parameters)["pmgaearlytermination"] = le_pmgaearlytermination->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmgapointsmax (const QString &)
{
  (*parameters)["pmgapointsmax"] = le_pmgapointsmax->text ();
}
void
US_Hydrodyn_Cluster_Bfnb::hide_misc_label ()
{
  hide_widgets (widgets_misc_label,
                widgets_misc_label.size ()
                    && widgets_misc_label[0]->isVisible ());
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestdeltastart (const QString &)
{
  (*parameters)["pmbestdeltastart"] = le_pmbestdeltastart->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestdeltadivisor (const QString &)
{
  (*parameters)["pmbestdeltadivisor"] = le_pmbestdeltadivisor->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmbestdeltamin (const QString &)
{
  (*parameters)["pmbestdeltamin"] = le_pmbestdeltamin->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::set_pmcsv ()
{
  (*parameters)["pmcsv"] = cb_pmcsv->isChecked () ? "true" : "false";
}

void
US_Hydrodyn_Cluster_Bfnb::update_pmdebug (const QString &)
{
  (*parameters)["pmdebug"] = le_pmdebug->text ();
}

void
US_Hydrodyn_Cluster_Bfnb::save ()
{
      ...
      if (!f.open (QIODevice::WriteOnly))
        {
          QMessageBox::information (
              this,
              us_tr (
                  QString ("%1: Save").arg ("US-SOMO: Parsimonious Modeling")),
      ...
      if (!f.open (QIODevice::ReadOnly))
        {
          QMessageBox::information (
              this,
              us_tr (
                  QString ("%1: Open").arg ("US-SOMO: Parsimonious Modeling")),
...
void
US_Hydrodyn_Cluster_Bfnb::update_fields ()
{
  le_pmtypes->setText (parameters->count ("pmtypes") ? (*parameters)["pmtypes"]
                                                     : "");
  cb_pmincrementally->setChecked (parameters->count ("pmincrementally")
