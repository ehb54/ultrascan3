...
void
US_Hydrodyn_SaxsOptions::setupGUI ()
{
  ...
  connect (pb_sas_options_saxs, SIGNAL (clicked ()),
           SLOT (sas_options_saxs ()));
  ...
  connect (pb_sas_options_sans, SIGNAL (clicked ()),
           SLOT (sas_options_sans ()));
  ...
  connect (pb_sas_options_curve, SIGNAL (clicked ()),
           SLOT (sas_options_curve ()));

  pb_sas_options_bead_model
      = new QPushButton (us_tr ("Bead model options"), this);
  pb_sas_options_bead_model->setFont (QFont (
  ...
  if (started_in_expert_mode)
    {
      ...
      pb_sas_options_hydration->setFont (
  ...
  if (started_in_expert_mode)
    {
      ...
      connect (pb_sas_options_xsr, SIGNAL (clicked ()),
               SLOT (sas_options_xsr ()));
    }

  pb_sas_options_misc
      = new QPushButton (us_tr ("Miscellaneous options"), this);
  ...
  connect (pb_sas_options_misc, SIGNAL (clicked ()),
           SLOT (sas_options_misc ()));

  if (started_in_expert_mode)
    {
      pb_sas_options_experimental
          = new QPushButton (us_tr ("Experimental code options"), this);
      pb_sas_options_experimental->setFont (
          QFont (USglobal->config_list.fontFamily,
                 USglobal->config_list.fontSize + 1));
...
void
US_Hydrodyn_SaxsOptions::cancel ()
{
  close ();
}

void
US_Hydrodyn_SaxsOptions::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SaxsOptions::closeEvent (QCloseEvent *e)
{
  *saxs_options_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SaxsOptions::sas_options_saxs ()
{
  if (*sas_options_saxs_widget)
  ...
  else
    {
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_saxs_window
          = new US_Hydrodyn_SasOptionsSaxs (
              saxs_options, sas_options_saxs_widget, us_hydrodyn);
...
void
US_Hydrodyn_SaxsOptions::sas_options_sans ()
{
  if (*sas_options_sans_widget)
  ...
  else
    {
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_sans_window
          = new US_Hydrodyn_SasOptionsSans (
              saxs_options, sas_options_sans_widget, us_hydrodyn);
      US_Hydrodyn::fixWinButtons (
          ((US_Hydrodyn *)us_hydrodyn)->sas_options_sans_window);
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_sans_window->show ();
    }
...
void
US_Hydrodyn_SaxsOptions::sas_options_curve ()
{
  if (*sas_options_curve_widget)
  ...
  else
    {
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_curve_window
          = new US_Hydrodyn_SasOptionsCurve (
              saxs_options, sas_options_curve_widget, us_hydrodyn);
      US_Hydrodyn::fixWinButtons (
          ((US_Hydrodyn *)us_hydrodyn)->sas_options_curve_window);
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_curve_window->show ();
    }
...
void
US_Hydrodyn_SaxsOptions::sas_options_bead_model ()
{
      ...
      if (((US_Hydrodyn *)us_hydrodyn)
              ->sas_options_bead_model_window->isVisible ())
        {
          ((US_Hydrodyn *)us_hydrodyn)
              ->sas_options_bead_model_window->raise ();
        }
      else
        {
...
void
US_Hydrodyn_SaxsOptions::sas_options_hydration ()
{
...
void
US_Hydrodyn_SaxsOptions::sas_options_guinier ()
{
...
void
US_Hydrodyn_SaxsOptions::sas_options_xsr ()
{
  ...
  else
    {
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_xsr_window
          = new US_Hydrodyn_SasOptionsXsr (
              saxs_options, sas_options_xsr_widget, us_hydrodyn);
      US_Hydrodyn::fixWinButtons (
          ((US_Hydrodyn *)us_hydrodyn)->sas_options_xsr_window);
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_xsr_window->show ();
    }
...
void
US_Hydrodyn_SaxsOptions::sas_options_misc ()
{
  if (*sas_options_misc_widget)
  ...
  else
    {
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_misc_window
          = new US_Hydrodyn_SasOptionsMisc (
              saxs_options, sas_options_misc_widget, us_hydrodyn);
      US_Hydrodyn::fixWinButtons (
          ((US_Hydrodyn *)us_hydrodyn)->sas_options_misc_window);
      ((US_Hydrodyn *)us_hydrodyn)->sas_options_misc_window->show ();
    }
...
void
US_Hydrodyn_SaxsOptions::sas_options_experimental ()
{
  if (*sas_options_experimental_widget)
    {
      if (((US_Hydrodyn *)us_hydrodyn)
        ...
        {
          ((US_Hydrodyn *)us_hydrodyn)
              ->sas_options_experimental_window->raise ();
        }
      else
        {
          ((US_Hydrodyn *)us_hydrodyn)
              ->sas_options_experimental_window->show ();
        }
      return;
    }
  else
