    ...
    : QDialog (p)
{
  ...
  last_show_gauss
      = ush_win->gparams.count ("dad_movie_show_gauss")
...
void
US_Hydrodyn_Dad_Movie::setupGUI ()
{
  int minHeight1 = 24;
  int minHeight3 = 25;
...
void
US_Hydrodyn_Dad_Movie::cancel ()
{
  close ();
}

void
US_Hydrodyn_Dad_Movie::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Dad_Movie::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Dad_Movie::set_save ()
{
  update_enables ();
}

void
US_Hydrodyn_Dad_Movie::set_show_gauss ()
{
  update_plot ();
}

void
US_Hydrodyn_Dad_Movie::set_show_ref ()
{
  update_plot ();
}

void
US_Hydrodyn_Dad_Movie::set_mono ()
{
...
void
US_Hydrodyn_Dad_Movie::update_enables ()
{
  le_save->setEnabled (cb_save->isChecked ());
}

void
US_Hydrodyn_Dad_Movie::update_plot ()
{
...
void
US_Hydrodyn_Dad_Movie::save_plot ()
{
  if (dad_win->plot_errors->isVisible ())
    {
      if (dad_win->plot_ref->isVisible ())
        {
          save_plot (dad_win->plot_dist, dad_win->plot_ref,
                     dad_win->plot_errors, le_save->text ());
        }
      else
        {
          save_plot (dad_win->plot_dist, dad_win->plot_errors,
                     le_save->text ());
        }
    }
  else
...
void
US_Hydrodyn_Dad_Movie::save_plot (QWidget *plot, QString tag)
{
  int mypos = pos;
...
void
US_Hydrodyn_Dad_Movie::join_maps (QPixmap &m1, QPixmap &m2)
{
  int m1h = m1.height ();
  int m2h = m2.height ();
...
void
US_Hydrodyn_Dad_Movie::save_plot (QWidget *plot, QWidget *plot2,
...
void
US_Hydrodyn_Dad_Movie::save_plot (QWidget *plot, QWidget *plot2, QString tag)
{
  int mypos = pos;
  QPixmap qPix = plot->grab ();
  QPixmap qPix2 = plot2->grab ();
...
void
US_Hydrodyn_Dad_Movie::save_plot (QPixmap &qPix, QString tag, int mypos)
{
  QPainter paint (&qPix);
