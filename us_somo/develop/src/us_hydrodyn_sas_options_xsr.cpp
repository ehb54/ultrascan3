...
void
US_Hydrodyn_SasOptionsXsr::setupGUI ()
{
  int minHeight1 = 30;
  int minHeight2 = 50;

  lbl_info = new QLabel (
      us_tr ("US-SOMO SAS Cross Sectional Fitting Options:"), this);
  ...
  le_xsr_symmop->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  AUTFBACK (le_xsr_nx);
  le_xsr_nx->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  AUTFBACK (le_xsr_ny);
  le_xsr_ny->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  ...
  le_xsr_griddistance->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  le_xsr_ncomponents->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  ...
  lbl_xsr_compactness_weight->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_xsr_compactness_weight = new QLineEdit (this);
  le_xsr_compactness_weight->setObjectName (
      "xsr_compactness_weight Line Edit");
  ...
  le_xsr_compactness_weight->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  ...
  le_xsr_looseness_weight->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  le_xsr_temperature->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
...
void
US_Hydrodyn_SasOptionsXsr::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsXsr::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsXsr::closeEvent (QCloseEvent *e)
{
  *sas_options_xsr_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsXsr::update_xsr_symmop (const QString &str)
{
  saxs_options->xsr_symmop = str.toUInt ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_nx (const QString &str)
{
  saxs_options->xsr_nx = str.toUInt ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_ny (const QString &str)
{
  saxs_options->xsr_ny = str.toUInt ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_griddistance (const QString &str)
{
  saxs_options->xsr_griddistance = str.toDouble ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_ncomponents (const QString &str)
{
  saxs_options->xsr_ncomponents = str.toUInt ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_compactness_weight (const QString &str)
{
  saxs_options->xsr_compactness_weight = str.toDouble ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_looseness_weight (const QString &str)
{
  saxs_options->xsr_looseness_weight = str.toDouble ();
}

void
US_Hydrodyn_SasOptionsXsr::update_xsr_temperature (const QString &str)
{
