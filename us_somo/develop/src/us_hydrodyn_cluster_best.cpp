...
void
US_Hydrodyn_Cluster_Best::setupGUI ()
{
  int minHeight1 = 30;
  ...
  le_bestmsrprober->setText (parameters->count ("bestmsrprober")
                                 ? (*parameters)["bestmsrprober"]
                                 : "");
  ...
  le_bestmsrprober->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  le_bestmsrfinenessangle->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  ...
  le_bestmsrmaxtriangles->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  cb_bestrcoalautominmax = new QCheckBox (
      us_tr (
          "COALESCE: automatically determine the minimum and maximum number "
  ...
  le_bestrcoalnmin->setText (parameters->count ("bestrcoalnmin")
                                 ? (*parameters)["bestrcoalnmin"]
                                 : "");
  ...
  le_bestrcoalnmin->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  le_bestrcoalnmax->setText (parameters->count ("bestrcoalnmax")
                                 ? (*parameters)["bestrcoalnmax"]
                                 : "");
  ...
  le_bestrcoalnmax->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  ...
  le_bestrcoaln->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  lbl_bestbestmw
      = new QLabel (us_tr ("BEST: override computed molecular weight "
  ...
  le_bestbestmw->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  le_bestexpand->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_bestbestvc = new QCheckBox (
      us_tr ("BEST: Compute the Viscosity Factor in the Center of Viscosity "
             "{longer calculation} (default:checked)"),
      this);
  ...
  le_bestmsrcoalescer->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  lbl_bestmsrradiifile
      = new QLabel (us_tr ("MSROLL: manual radii file"), this);
  ...
  le_bestmsrradiifile->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  ...
  lbl_bestmsrpatternfile
      = new QLabel (us_tr ("MSROLL: manual name pattern file (must also "
  ...
  le_bestmsrpatternfile->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Cluster_Best::cancel ()
{
  close ();
}

void
US_Hydrodyn_Cluster_Best::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Cluster_Best::closeEvent (QCloseEvent *e)
{
  if (parameters->count ("bestmsrprober")
...
void
US_Hydrodyn_Cluster_Best::update_bestmsrprober (const QString &)
{
  (*parameters)["bestmsrprober"] = le_bestmsrprober->text ();
}

void
US_Hydrodyn_Cluster_Best::update_bestmsrfinenessangle (const QString &)
{
  (*parameters)["bestmsrfinenessangle"] = le_bestmsrfinenessangle->text ();
}

void
US_Hydrodyn_Cluster_Best::update_bestmsrmaxtriangles (const QString &)
{
  (*parameters)["bestmsrmaxtriangles"] = le_bestmsrmaxtriangles->text ();
}

void
US_Hydrodyn_Cluster_Best::set_bestrcoalautominmax ()
{
...
void
US_Hydrodyn_Cluster_Best::update_bestrcoalnmin (const QString &)
{
  (*parameters)["bestrcoalnmin"] = le_bestrcoalnmin->text ();
}

void
US_Hydrodyn_Cluster_Best::update_bestrcoalnmax (const QString &)
{
  (*parameters)["bestrcoalnmax"] = le_bestrcoalnmax->text ();
}

void
US_Hydrodyn_Cluster_Best::update_bestrcoaln (const QString &)
{
  (*parameters)["bestrcoaln"] = le_bestrcoaln->text ();
}

void
US_Hydrodyn_Cluster_Best::update_bestbestmw (const QString &)
{
  (*parameters)["bestbestmw"] = le_bestbestmw->text ();
}

void
US_Hydrodyn_Cluster_Best::update_bestexpand (const QString &)
{
  (*parameters)["bestexpand"] = le_bestexpand->text ();
}

void
US_Hydrodyn_Cluster_Best::set_bestbestvc ()
{
  (*parameters)["bestbestvc"] = cb_bestbestvc->isChecked () ? "true" : "false";
}
void
US_Hydrodyn_Cluster_Best::hide_opt_label ()
{
  hide_widgets (widgets_opt_label, widgets_opt_label.size ()
                                       && widgets_opt_label[0]->isVisible ());
}

void
US_Hydrodyn_Cluster_Best::hide_widgets (vector<QWidget *> w, bool do_hide,
                                        bool do_resize)
{
...
void
US_Hydrodyn_Cluster_Best::update_bestmsrcoalescer (const QString &)
{
  (*parameters)["bestmsrcoalescer"] = le_bestmsrcoalescer->text ();
}

void
US_Hydrodyn_Cluster_Best::set_bestmsrusesomoradii ()
{
...
void
US_Hydrodyn_Cluster_Best::update_bestmsrradiifile (const QString &)
{
  QString use_dir;
  ...
  disconnect (le_bestmsrradiifile, SIGNAL (textChanged (const QString &)), 0,
              0);
...
void
US_Hydrodyn_Cluster_Best::update_bestmsrpatternfile (const QString &)
{
  QString use_dir;
  ((US_Hydrodyn *)us_hydrodyn)->select_from_directory_history (use_dir, this);
  QString filename = QFileDialog::getOpenFileName (
  ...
  disconnect (le_bestmsrpatternfile, SIGNAL (textChanged (const QString &)), 0,
              0);
      ...
      if (!f.open (QIODevice::WriteOnly))
        {
          QMessageBox::information (
              ...
              us_tr (QString ("%1: Save")
                         .arg ("US-SOMO: BEST cluster interface")),
...
void
US_Hydrodyn_Cluster_Best::update_fields ()
{
  le_bestmsrprober->setText (parameters->count ("bestmsrprober")
                                 ? (*parameters)["bestmsrprober"]
                                 : "");
