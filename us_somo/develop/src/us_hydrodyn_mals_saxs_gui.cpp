...
void
US_Hydrodyn_Mals_Saxs::setupGUI ()
{
  int minHeight1 = 22;
  int minHeight3 = 24;
  ...
  */
  ...
  cg_fit_1.setBrush (QPalette::Base,
                     QBrush (scale_pair_color_q1, Qt::SolidPattern));
  QPalette cg_fit_2 = cg_magenta;
  cg_fit_2.setBrush (QPalette::Base,
                     QBrush (scale_pair_color_q2, Qt::SolidPattern));
  ...
  pb_common_time = new QPushButton (us_tr ("I#,*(q) common time"), this);
  pb_common_time->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  pb_common_time->setMinimumHeight (minHeight1);
  ...
  pb_scroll_pair->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  lbl_scale_pair_msg
      = new QLabel (" Chi^2 of this fit: XXX Global Chi^2: YYY", this);
  ...
  lbl_scale_pair_msg->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));

  pb_scale_pair = new QPushButton (us_tr ("Scale"), this);
  pb_scale_pair->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_scale_pair_fit->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  lbl_scale_pair_fit_curve->setFont (QFont (
  ...
  // cb_scale_pair_fit_alg_use_errors->setFont(QFont(
  ...
  // connect( cb_scale_pair_fit_alg_use_errors, SIGNAL( clicked() ), SLOT(
  // scale_pair_fit_alg_use_errors() ) );
  ...
  cb_scale_pair_scale_saxs->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 2));
  cb_scale_pair_scale_saxs->setPalette (PALET_NORMAL);
  AUTFBACK (cb_scale_pair_scale_saxs);
  cb_scale_pair_scale_saxs->setChecked (false);
  connect (cb_scale_pair_scale_saxs, SIGNAL (clicked ()),
           SLOT (scale_pair_scale_saxs ()));
  ...
  cb_scale_pair_fit_curve->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  cb_scale_pair_fit_curve->addItem (us_tr ("2nd degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P2);
  cb_scale_pair_fit_curve->addItem (us_tr ("3rd degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P3);
  cb_scale_pair_fit_curve->addItem (us_tr ("4th degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P4);
  cb_scale_pair_fit_curve->addItem (us_tr ("5th degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P5);
  cb_scale_pair_fit_curve->addItem (us_tr ("6th degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P6);
  cb_scale_pair_fit_curve->addItem (us_tr ("7th degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P7);
  cb_scale_pair_fit_curve->addItem (us_tr ("8th degree Polynomial"),
                                    SCALE_PAIR_FIT_CURVE_P8);
  connect (cb_scale_pair_fit_curve, SIGNAL (currentIndexChanged (QString)),
           SLOT (scale_pair_fit_curve_index ()));
  ...
  cb_scale_pair_fit_alg->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1));
  ...
  cb_scale_pair_fit_alg->addItem (us_tr ("SVD Jacobi"),
                                  US_Eigen::EIGEN_SVD_JACOBI);
  cb_scale_pair_fit_alg->addItem (us_tr ("QR Householder full pivoting"),
                                  US_Eigen::EIGEN_HOUSEHOLDER_QR_PIVOT_FULL);
  cb_scale_pair_fit_alg->addItem (us_tr ("QR Householder column pivoting"),
                                  US_Eigen::EIGEN_HOUSEHOLDER_QR_PIVOT_COL);
  cb_scale_pair_fit_alg->addItem (us_tr ("QR Householder"),
                                  US_Eigen::EIGEN_HOUSEHOLDER_QR);
  cb_scale_pair_fit_alg->addItem (us_tr ("LR"), US_Eigen::EIGEN_NORMAL);
  connect (cb_scale_pair_fit_alg, SIGNAL (currentIndexChanged (QString)),
           SLOT (scale_pair_fit_alg_index ()));
  ...
  cb_scale_pair_fit_alg_weight->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  ...
  connect (cb_scale_pair_fit_alg_weight,
           SIGNAL (currentIndexChanged (QString)),
           SLOT (scale_pair_fit_alg_weight_index ()));
  cb_scale_pair_fit_alg_weight->setCurrentIndex (
      3); // US_Eigen::EIGEN_1_OVER_SD

  pb_scale_pair_minimize = new QPushButton (us_tr ("Minimize"), this);
  pb_scale_pair_minimize->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  pb_scale_pair_minimize->setMinimumHeight (minHeight1);
  pb_scale_pair_minimize->setPalette (PALET_PUSHB);
  connect (pb_scale_pair_minimize, SIGNAL (clicked ()),
           SLOT (scale_pair_minimize ()));

  pb_scale_pair_reset = new QPushButton (us_tr ("Reset"), this);
  pb_scale_pair_reset->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  pb_scale_pair_reset->setMinimumHeight (minHeight1);
  pb_scale_pair_reset->setPalette (PALET_PUSHB);
  connect (pb_scale_pair_reset, SIGNAL (clicked ()),
           SLOT (scale_pair_reset ()));

  pb_scale_pair_create_scaled_curves
      = new QPushButton (us_tr ("Make scaled"), this);
  pb_scale_pair_create_scaled_curves->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_scale_pair_create_scaled_curves->setMinimumHeight (minHeight1);
  pb_scale_pair_create_scaled_curves->setPalette (PALET_PUSHB);
  connect (pb_scale_pair_create_scaled_curves, SIGNAL (clicked ()),
           SLOT (scale_pair_create_scaled_curves ()));
  ...
  lbl_scale_pair_time->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  lbl_scale_pair_time->hide ();

  le_scale_pair_time = new mQLineEdit (this);
  le_scale_pair_time->setObjectName ("le_scale_pair_time Line Edit");
  le_scale_pair_time->setText ("");
  le_scale_pair_time->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_scale_pair_time->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  le_scale_pair_time->setMaximumWidth (
      QFontMetrics (le_scale_pair_time->font ()).averageCharWidth ()
      * le_scale_pair_time->maxLength ());
  le_scale_pair_time->hide ();
  connect (le_scale_pair_time, SIGNAL (focussed (bool)),
           SLOT (scale_pair_time_focus (bool)));
  ...
  lbl_scale_pair_scale->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  lbl_scale_pair_scale->hide ();

  le_scale_pair_scale = new mQLineEdit (this);
  le_scale_pair_scale->setObjectName ("le_scale_pair_scale Line Edit");
  le_scale_pair_scale->setText ("1");
  le_scale_pair_scale->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_scale_pair_scale->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  le_scale_pair_scale->setPalette (PALET_NORMAL);
  AUTFBACK (le_scale_pair_scale);
  le_scale_pair_scale->setEnabled (false);
  le_scale_pair_scale->setValidator (
      new QDoubleValidator (le_scale_pair_scale));
  le_scale_pair_scale->setMaxLength (16);
  le_scale_pair_scale->setMaximumWidth (
      QFontMetrics (le_scale_pair_scale->font ()).averageCharWidth ()
      * le_scale_pair_scale->maxLength ());
  le_scale_pair_scale->hide ();
  connect (le_scale_pair_scale, SIGNAL (textChanged (const QString &)),
           SLOT (scale_pair_scale (const QString &)));
  connect (le_scale_pair_scale, SIGNAL (focussed (bool)),
           SLOT (scale_pair_scale_focus (bool)));
  ...
  lbl_scale_pair_sd_scale->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_scale_pair_sd_scale->hide ();

  le_scale_pair_sd_scale = new mQLineEdit (this);
  le_scale_pair_sd_scale->setObjectName ("le_scale_pair_sd_scale Line Edit");
  le_scale_pair_sd_scale->setText ("1");
  le_scale_pair_sd_scale->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  le_scale_pair_sd_scale->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_scale_pair_sd_scale->setPalette (PALET_NORMAL);
  AUTFBACK (le_scale_pair_sd_scale);
  le_scale_pair_sd_scale->setEnabled (false);
  le_scale_pair_sd_scale->setValidator (
      new QDoubleValidator (le_scale_pair_sd_scale));
  le_scale_pair_sd_scale->setMaxLength (16);
  le_scale_pair_sd_scale->setMaximumWidth (
      QFontMetrics (le_scale_pair_sd_scale->font ()).averageCharWidth ()
      * le_scale_pair_sd_scale->maxLength ());
  le_scale_pair_sd_scale->hide ();
  connect (le_scale_pair_sd_scale, SIGNAL (textChanged (const QString &)),
           SLOT (scale_pair_sd_scale (const QString &)));

  lbl_scale_pair_q1_range
      = new QLabel (us_tr (" Fit range 1 (scales): "), this);
  ...
  lbl_scale_pair_q1_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_scale_pair_q1_range->hide ();

  le_scale_pair_q1_start = new mQLineEdit (this);
  le_scale_pair_q1_start->setObjectName ("le_scale_pair_q1_start Line Edit");
  ...
  le_scale_pair_q1_start->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_scale_pair_q1_start->setEnabled (false);
  le_scale_pair_q1_start->setValidator (
      new QDoubleValidator (le_scale_pair_q1_start));
  le_scale_pair_q1_start->hide ();
  connect (le_scale_pair_q1_start, SIGNAL (textChanged (const QString &)),
           SLOT (scale_pair_q1_start_text (const QString &)));
  connect (le_scale_pair_q1_start, SIGNAL (focussed (bool)),
           SLOT (scale_pair_q1_start_focus (bool)));

  le_scale_pair_q1_end = new mQLineEdit (this);
  le_scale_pair_q1_end->setObjectName ("le_scale_pair_q1_end Line Edit");
  ...
  le_scale_pair_q1_end->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  le_scale_pair_q1_end->setEnabled (false);
  le_scale_pair_q1_end->setValidator (
      new QDoubleValidator (le_scale_pair_q1_end));
  le_scale_pair_q1_end->hide ();
  connect (le_scale_pair_q1_end, SIGNAL (textChanged (const QString &)),
           SLOT (scale_pair_q1_end_text (const QString &)));
  connect (le_scale_pair_q1_end, SIGNAL (focussed (bool)),
           SLOT (scale_pair_q1_end_focus (bool)));

  lbl_scale_pair_q2_range
      = new QLabel (us_tr (" Fit range 2 (fixed): "), this);
  ...
  lbl_scale_pair_q2_range->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_scale_pair_q2_range->hide ();

  le_scale_pair_q2_start = new mQLineEdit (this);
  le_scale_pair_q2_start->setObjectName ("le_scale_pair_q2_start Line Edit");
  ...
  le_scale_pair_q2_start->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1));
  le_scale_pair_q2_start->setEnabled (false);
  le_scale_pair_q2_start->setValidator (
      new QDoubleValidator (le_scale_pair_q2_start));
  le_scale_pair_q2_start->hide ();
  connect (le_scale_pair_q2_start, SIGNAL (textChanged (const QString &)),
           SLOT (scale_pair_q2_start_text (const QString &)));
  connect (le_scale_pair_q2_start, SIGNAL (focussed (bool)),
           SLOT (scale_pair_q2_start_focus (bool)));

  le_scale_pair_q2_end = new mQLineEdit (this);
  le_scale_pair_q2_end->setObjectName ("le_scale_pair_q2_end Line Edit");
  ...
  le_scale_pair_q2_end->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  le_scale_pair_q2_end->setEnabled (false);
  le_scale_pair_q2_end->setValidator (
      new QDoubleValidator (le_scale_pair_q2_end));
  le_scale_pair_q2_end->hide ();
  connect (le_scale_pair_q2_end, SIGNAL (textChanged (const QString &)),
           SLOT (scale_pair_q2_end_text (const QString &)));
  connect (le_scale_pair_q2_end, SIGNAL (focussed (bool)),
           SLOT (scale_pair_q2_end_focus (bool)));

  // scale pair end

  pb_join_by_time = new QPushButton (us_tr ("Join I#,*(q) by time"), this);
  pb_join_by_time->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  pb_join_by_time->setMinimumHeight (minHeight1);
  pb_join_by_time->setPalette (PALET_PUSHB);
  connect (pb_join_by_time, SIGNAL (clicked ()), SLOT (join_by_time ()));
  ...
  //    pb_set_mals_saxs = new QPushButton(us_tr("Set buffer"), this);
  //    pb_set_mals_saxs->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  //    pb_set_mals_saxs->setMinimumHeight(minHeight1);
  //    pb_set_mals_saxs->setPalette( PALET_PUSHB );
  //    connect(pb_set_mals_saxs, SIGNAL(clicked()), SLOT(set_mals_saxs()));

  //    lbl_mals_saxs = new QLabel("", this );
  //    lbl_mals_saxs->setMinimumHeight(minHeight1);
  //    lbl_mals_saxs->setAlignment(Qt::AlignCenter|Qt::AlignVCenter);
  //    lbl_mals_saxs->setPalette( PALET_NORMAL );
  //    lbl_mals_saxs->setFont(QFont( USglobal->config_list.fontFamily,
  //    USglobal->config_list.fontSize - 1));
  ...
  pb_save_created_csv->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_saxs_csv_transposed")
              && ((US_Hydrodyn *)us_hydrodyn)
                         ->gparams["mals_saxs_csv_transposed"]
                     == "true"
          ? us_tr ("Save CSV Tr")
          : us_tr (" Save CSV "));
  ...
  cb_guinier_qrgmax->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)
          ->gparams.count ("mals_saxs_cb_guinier_qrgmax")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_saxs_cb_guinier_qrgmax"]
             == "true");
  ...
  le_guinier_qrgmax->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("mals_saxs_guinier_qrgmax")
          ? ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_saxs_guinier_qrgmax"]
          : "1.3");
  ...
  // mals_saxs
  pb_mals_saxs_angles_save
      = new QPushButton (us_tr ("Save Angles as CSV"), this);
  pb_mals_saxs_angles_save->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_mals_saxs_angles_save->setMinimumHeight (minHeight1);
  pb_mals_saxs_angles_save->setPalette (PALET_PUSHB);
  connect (pb_mals_saxs_angles_save, SIGNAL (clicked ()),
           SLOT (mals_saxs_angles_save ()));

  lbl_mals_saxs_angles_data = new QLabel (mals_saxs_angles.list_rich ());
  lbl_mals_saxs_angles_data->setAlignment (Qt::AlignCenter | Qt::AlignVCenter);
  lbl_mals_saxs_angles_data->setPalette (PALET_NORMAL);
  AUTFBACK (lbl_mals_saxs_angles_data);
  lbl_mals_saxs_angles_data->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  lbl_mals_saxs_angles_data->setTextInteractionFlags (
      Qt::TextSelectableByMouse);
  lbl_mals_saxs_angles_data->setCursor (QCursor (Qt::IBeamCursor));
  ...
  rb_pbmode_mals_saxs = new QRadioButton ("MALS_SAXS info.", this);
  rb_pbmode_mals_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  rb_pbmode_mals_saxs->setMinimumHeight (minHeight3);
  rb_pbmode_mals_saxs->setPalette (PALET_NORMAL);
  AUTFBACK (rb_pbmode_mals_saxs);
  connect (rb_pbmode_mals_saxs, SIGNAL (clicked ()),
           SLOT (set_pbmode_mals_saxs ()));
  ...
  QBoxLayout *l_pbmode_mals_saxs = new QHBoxLayout ();
  {
    l_pbmode_mals_saxs->setContentsMargins (0, 0, 0, 0);
  ...
  QBoxLayout *hbl_file_buttons_3a = new QHBoxLayout ();
  hbl_file_buttons_3a->setContentsMargins (0, 0, 0, 0);
  hbl_file_buttons_3a->setSpacing (0);
  ...
  //    QBoxLayout * hbl_mals_saxs = new QHBoxLayout();
  //    hbl_mals_saxs->setContentsMargins( 0, 0, 0, 0 );
  //    hbl_mals_saxs->setSpacing( 0 ); hbl_mals_saxs->addWidget (
  //    pb_set_mals_saxs ); hbl_mals_saxs->addWidget ( lbl_mals_saxs );
  ...
  gl_files->setSpacing (0);
  {
    ...
    j++;
    gl_files->addLayout (hbl_file_buttons_3a, j, 0);
    j++;
    ...
    //       gl_files->addLayout( hbl_mals_saxs, j, 0 ); j++;
  ...
  QBoxLayout *vbl_scale_pair = new QVBoxLayout (0);
  vbl_scale_pair->setContentsMargins (0, 0, 0, 0);
  vbl_scale_pair->setSpacing (0);
  {
    QBoxLayout *hbl = new QHBoxLayout ();
    hbl->setContentsMargins (0, 0, 0, 0);
    hbl->setSpacing (0);
  ...
  // vbl_plot_group->addWidget ( lbl_mals_saxs_angles_data, 0, Qt::AlignCenter
  // ); // don't like this
  ...
  //                 "mals_saxs_files_widgets" ) || ( ( US_Hydrodyn * )
  //                 us_hydrodyn )->gparams[ "mals_saxs_files_widgets" ] ==
  //                 "false" ? false : true );
  //   hide_widgets( editor_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "mals_saxs_editor_widgets" ) || ( ( US_Hydrodyn * )
  //                 us_hydrodyn )->gparams[ "mals_saxs_editor_widgets" ] ==
  //                 "false" ? false : true );
  //   hide_widgets( created_files_widgets,
  //                 !( ( US_Hydrodyn * ) us_hydrodyn )->gparams.count(
  //                 "mals_saxs_created_files_widgets" ) || ( ( US_Hydrodyn * )
  //                 us_hydrodyn )->gparams[ "mals_saxs_creaded_files_widgets"
  //                 ] == "false" ? false : true );

  always_hide_widgets.insert (
      { pb_load_conc, pb_conc, rb_pbmode_conc, rb_pbmode_sd, pb_normalize,
        pb_create_i_of_t, pb_test_i_of_t, pb_create_istar_q, pb_create_ihash_t,
        pb_ref, pb_blanks_start, pb_baseline_start, pb_baseline_apply,
        pb_gauss_mode, pb_gauss_start, pb_ggauss_start, pb_testiq });
...
void
US_Hydrodyn_Mals_Saxs::mode_setup_widgets ()
{
...
void
US_Hydrodyn_Mals_Saxs::mode_select ()
{
  ...
  ShowHide::hide_widgets (scroll_pair_widgets, always_hide_widgets);
  ShowHide::hide_widgets (scale_pair_widgets, always_hide_widgets);
  ...
  switch (current_mode)
    ...
    case MODE_GGAUSSIAN:
      ...
      // only_widgets note: row 0 currently is blanks analysis, row 1 gauss
      // mode buttons+scale+testiq could add more rows...
    ...
    case MODE_SCROLL_PAIR:
      mode_title (us_tr ("Scroll Pairs"));
      ShowHide::hide_widgets (scroll_pair_widgets, always_hide_widgets, false);
      ShowHide::only_widgets (pb_row_widgets, 1, always_hide_widgets);
      break;
    case MODE_SCALE_PAIR:
      mode_title (pb_scale_pair->text ());
      ShowHide::hide_widgets (scale_pair_widgets, always_hide_widgets, false);
...
void
US_Hydrodyn_Mals_Saxs::mode_select (modes mode)
{
  current_mode = mode;
  mode_select ();
}
...
void
US_Hydrodyn_Mals_Saxs::mode_title (QString title)
{
...
void
US_Hydrodyn_Mals_Saxs::update_enables ()
{
  ...
  // unsigned int non_mals_saxs_non_empty_files_selected_count = 0;
      ...
      if (lb_files->item (i)->isSelected ())
        {
          ...
          //          if ( lb_files->item( i )->text() != lbl_mals_saxs->text()
          //          &&
          //               lb_files->item( i )->text() != lbl_empty->text() )
          //          {
          //             non_mals_saxs_non_empty_files_selected_count++;
          //          }
        }
    }
  ...
  bool all_t_ = files_selected_count
                && files_selected_count
                       == (unsigned int)selected_files.filter ("_t").size ();
  bool half_common
      = files_selected_count
        && files_selected_count
               == 2 * (unsigned int)selected_files.filter ("_common").size ();
  ...
  baseline_integral
      = ((US_Hydrodyn *)us_hydrodyn)->gparams["mals_saxs_bl_integral"]
        == "true";
  ...
  pb_baseline_start->setEnabled (
      files_are_time && files_compatible
      && ((baseline_integral && files_selected_count > 1)
          || (!baseline_integral && files_selected_count == 1)));
  ...
  pb_common_time->setEnabled (files_selected_count > 2 && files_compatible
                              && !files_are_time && (all_istarq || all_ihashq)
                              && all_t_);
  pb_scroll_pair->setEnabled (files_selected_count > 2 && files_compatible
                              && !files_are_time && (all_istarq || all_ihashq)
                              && all_t_);
  pb_scale_pair->setEnabled (files_selected_count > 2 && files_compatible
                             && !files_are_time && (all_istarq || all_ihashq)
                             && all_t_ && half_common);
  pb_join_by_time->setEnabled (files_selected_count > 2 && files_compatible
                               && !files_are_time && (all_istarq || all_ihashq)
                               && all_t_ && half_common);
  ...
  pb_create_i_of_q->setEnabled (files_selected_count > 1 && files_compatible
                                && files_are_time /* && gaussians.size() */);
  pb_create_ihash_t->setEnabled (
      files_selected_count > 1 && files_compatible && files_are_time
      && mals_saxs_param_n && mals_saxs_param_lambda && mals_saxs_param_g_dndc
  ...
  //                                        );
  //    pb_set_mals_saxs           ->setEnabled( files_selected_count == 1 &&
  //                                        lb_files->item( last_selected_pos
  //                                        )->text() != lbl_mals_saxs->text()
  //                                        && lb_files->item(
  //                                        last_selected_pos )->text() !=
  //                                        lbl_empty ->text() &&
  //                                        lb_files->item( last_selected_pos
  ...
  pb_mals_saxs_angles_save->setEnabled (
      mals_saxs_angles.mals_saxs_angle.size ());
...
void
US_Hydrodyn_Mals_Saxs::model_enables ()
{
...
void
US_Hydrodyn_Mals_Saxs::disable_all ()
{
  // cout << "disable all\n";
  // qwtw_wheel            ->setEnabled( false );
  pb_wheel_inc->setEnabled (false);
  ...
  //    pb_set_mals_saxs           ->setEnabled( false );
...
void
US_Hydrodyn_Mals_Saxs::model_select_all ()
{
...
void
US_Hydrodyn_Mals_Saxs::model_save ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals_Saxs::model_text ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals_Saxs::model_view ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals_Saxs::model_remove ()
{
  disable_all ();
...
void
US_Hydrodyn_Mals_Saxs::model_remove (QStringList files)
{
  disable_updates = true;
...
void
US_Hydrodyn_Mals_Saxs::model_view (QStringList files)
{
...
void
US_Hydrodyn_Mals_Saxs::model_text (QStringList files)
{
...
bool
US_Hydrodyn_Mals_Saxs::model_save (QStringList files)
{
  bool errors = false;
...
bool
US_Hydrodyn_Mals_Saxs::model_save (QString file, bool &cancel,
                                   bool &overwrite_all)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_plot_dist (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_plot_ref (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_ggqfit_plot (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_guinier_plot (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_guinier_plot_rg (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_guinier_plot_mw (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_guinier_plot_summary (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::usp_config_guinier_plot_errors (const QPoint &)
{
...
void
US_Hydrodyn_Mals_Saxs::set_pbmode_main ()
{
  pbmode_select (PBMODE_MAIN);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_sel ()
{
  pbmode_select (PBMODE_SEL);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_crop ()
{
  pbmode_select (PBMODE_CROP);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_conc ()
{
  pbmode_select (PBMODE_CONC);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_sd ()
{
  pbmode_select (PBMODE_SD);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_fasta ()
{
  pbmode_select (PBMODE_FASTA);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_mals_saxs ()
{
  pbmode_select (PBMODE_MALS_SAXS);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_q_exclude ()
{
  pbmode_select (PBMODE_Q_EXCLUDE);
}

void
US_Hydrodyn_Mals_Saxs::set_pbmode_none ()
{
  pbmode_select (PBMODE_NONE);
}

void
US_Hydrodyn_Mals_Saxs::pbmode_select (pbmodes mode)
{
  ...
  ShowHide::hide_widgets (pbmode_mals_saxs_widgets, always_hide_widgets, true);
  ...
  switch (mode)
    ...
    case PBMODE_MALS_SAXS:
      ShowHide::hide_widgets (pbmode_mals_saxs_widgets, always_hide_widgets,
                              false);
      break;
...
void
US_Hydrodyn_Mals_Saxs::fasta_file ()
{
  // load file
...
void
US_Hydrodyn_Mals_Saxs::q_exclude_update_lbl ()
{
...
void
US_Hydrodyn_Mals_Saxs::q_exclude_clear ()
{
  q_exclude.clear ();
  q_exclude_update_lbl ();
}
...
void
US_Hydrodyn_Mals_Saxs::q_exclude_vis ()
{
...
void
US_Hydrodyn_Mals_Saxs::q_exclude_left ()
{
  // find curves within zoomRect
  double minx = plot_dist_zoomer->zoomRect ().left ();
  double maxx = plot_dist_zoomer->zoomRect ().right ();
...
void
US_Hydrodyn_Mals_Saxs::q_exclude_right ()
{
  // find curves within zoomRect
  double minx = plot_dist_zoomer->zoomRect ().left ();
  double maxx = plot_dist_zoomer->zoomRect ().right ();
...
void
US_Hydrodyn_Mals_Saxs::q_exclude_opt_remove_unreferenced ()
{
