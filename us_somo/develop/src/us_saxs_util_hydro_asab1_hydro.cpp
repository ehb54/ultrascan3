...
// extern char nome[10][SMAX]; /* array for the name of the molecule to be
// drawn */ extern char ragcol[SMAX];       /* array for the file name of the
// radii, masses and colors file */
//
...
static char ragcol[SMAX]; /* array for the file name where radii, masses and
                             colors of the beads are stored */
                                                ...
                                                // )
{
  ...
  float sommarc, Dz, d1z, zz, temp, asamin, asalevel, asapep, asatot, perc,
      voltot;
  char azoto[2];
  char carbonio0[3];
  char carbonio1[3];
  ...
  */
  ...
  if (ini == 2)
    ...
    {
      // printf("\n\n- Insert the ASA threshold level in Angstroms^2 [usually
      // 10] : ");
      scanf ("%f", &asalevel);
      // em("s1");
      initarray ();
  ...
  else if (ini == 3)
    {
      ...
      while (min_asa < 0.0)
        {
          // printf("\n\nASA RE-CHECK  - Insert the minimum ASA %% threshold
          // level [0-99] : ");
          scanf ("%f", &min_asa);
  ...
  for (l = 1; l < nat; l++) /* GROUPING ASA OF ATOMS INTO ASA OF RESIDUES */
    {
      ...
      /*   printf("\n%d\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",l,"dd1->descr, dd1->elm,
         ...
         ",dd1->descr,dd1->elm,azoto,carbonio0,carbonio1,carbonio2);
           scanf("%s",pluto);
           getchar(); */
      ...
      /*   if(strcmp(dd1->elm,azoto)!=0)
         ...
         %.1f\n",kkk,dt[l-1].amin,asamin,dt[l-1].tab,perc); asamin=asa[l];
           kkk++;
           } */
      ...
      if ((strcmp (dd1->elm, azoto) == 0)
              ...
              && (strcmp (dd1->amin, "OG3") == 0)))
        {
          ...
          /*      printf("\n%s\n","Ora passo");
                  printf("\n%d\t%s%d%s\t%f\t%s\t%f\n",l-1,"dt[",l-1,"].tab:
             ",dt[l-1].tab,"asamin: ",asamin); scanf("%d",&topolino);
                  getchar(); */
          ...
          fprintf (pippa, "[ %d\t%s ]  %5.0f %5.0f  %.1f\n", kkk,
                   dt[l - 1].descr, asamin, dt[l - 1].tab, perc);
          asamin = asa[l];
          kkk++;
        }
      else
  ...
  for (l = 1; l < nat; l++)
    {
      ...
      dd1 += l;
      /*    printf("\n%d\t%s\t%s\t%s\t%d\t%s\t%s\n",l,"dd1->elm:
         ",dd1->elm,"dd1->col: ",dd1->col,"dd1->descr: ",dd1->descr);
            scanf("%s",pluto);
            getchar(); */
      if (strcmp (dd1->elm, "CA") == 0)
        {
          ...
          /*            printf("\n%s\n","Ora passo in asapep CA");
                        printf("\n%s\t%d\t%s\t%f\t%s\t%f\n","indCA=
             ",indCA,"asapep: ",asapep,"asa[l]",asa[l]); scanf("%d",&topolino);
                        getchar(); */
        }
      ...
      if (strcmp (dd1->elm, "C") == 0)
        {
          ...
          /*             printf("\n%s\n","Ora passo in asapep C");
                         printf("\n%s\t%d\t%s\t%f\t%s\t%f\n","indC=
             ",indC,"asapep: ",asapep,"asa[l]",asa[l]); scanf("%d",&topolino);
                         getchar(); */
        }
      if (strcmp (dd1->elm, "O") == 0)
        {
          ...
          /*            printf("\n%s\n","Ora passo in asapep O");
                        printf("\n%s\t%d\t%s\t%f\t%s\t%f\n","indO=
             ",indO,"asapep: ",asapep,"asa[l]",asa[l]); scanf("%d",&topolino);
                        getchar(); */
        }
          ...
          if (strcmp (dd1->amin, "PRO")
              != 0) /* IF NOT A PROLINE, COUNTING "N" FOR THE ASA */
            {
              ...
              /*             printf("\n%s\n","Ora passo in N no PRO");
                             printf("\n%d\t%s\t%s\t%s\t%s\n",l,"dd1->amin,
                 azoto, carbonio0: ",dd1->amin,azoto,carbonio0);
                             printf("\n%s\t%d\t%s\t%f\t%s\t%f\n","indO=
                 ",indO,"asapep: ",asapep,"asa[l]",asa[l]);
                             scanf("%d",&topolino);
                             getchar(); */
              if (asapep <= asalevel)
                {
                  ...
                  dd2->col = 10;
                  /*     printf("\n%d\t%s\t%s\t%s\t%d\t%s\t%s\n",indCA,"dd2->elm:
                   * ",dd2->elm,"dd2->col: ",dd2->col,"dd2->descr:
                   * ",dd2->descr); */
                  /*                      dd2++; */
                  dd2 = dt;
                  dd2 += indC;
                  ...
                  dd1->col = 10;
                  /*     printf("\n%d\t%s\t%s\t%s\t%d\t%s\t%s\n",indO,"dd1->elm:
                     ",dd1->elm,"dd1->col: ",dd1->col,"dd1->descr:
                     ",dd1->descr); scanf("%s",pluto); getchar(); */
                }
            }
          else
            {
                  ...
                  if (dd2->col == 10)
                    {
                      fprintf (mol1, "%d\n", 10);
                      /*   printf("\n%d\t%s\t%s\t%s\t%d\t%s\t%s\n",i,"Minni
                         dd2->elm: ",dd2->elm,"dd2->col:
                         ",dd2->col,"dd2->descr: ",dd2->descr);
                           scanf("%s",pluto);
                           getchar();   */
                    }
                  else
                      ...
                      if (asamin < asalevel)
                        {
                          if ((strcmp (dd2->amin, "MAN") == 0)
                              ...
                              || (strcmp (dd2->amin, "OG3")
                                  == 0)) /* COLOR CODING DIFFERENTLY THE
                                            CARBOHYDRATES AND OG */
                            {
                              fprintf (mol1, "%d\n",
                          ...
                          else
                            {
                              ...
                              /* FIXED 27/2/2003 TO AVOID PRINTING '6' FOR THE
                               * CA, C, O ATOMS OF THE PEPTIDE BOND */
  ...
  if (check_asa == 1)
    {
      ...
      for (l = 0; l < nat; l++)
        {
          // printf("%d %.2f\n", l, asa[l]);
          //  float sa = 4.0f * M_PI * active_atoms[l]->radius *
          //  active_atoms[l]->radius;
          float sapp = 4.0f * M_PI * (rprobe + active_atoms[l]->radius)
                       * (rprobe + active_atoms[l]->radius);

          if (isnan (asa[l]))
            {
              // printf("ASA WARNING NAN begin replaced by zero: atom %u asa %f
              // > sa+p %f (sa %f)\n",
              //        l,
              //        asa[l],
              //        sapp,
              ...
              if (temp >= min_asa)
                {
                  countb = countb + 1;
                  dt[l].col = 8;
                  // printf("\n #%d [bead %4d] - Surf_%6.2f - ASA_%6.2f
                  // o/oASA_%6.2f - Threshold_%6.2f", countb, l + 1, zz,
...
init ()
{
  ...
  init1_rmc = us_fopen (
      ragcol,
      "r"); /* opening the file containing the radii, masses and colors */
...
a55:
  ...
  if (init2_mol1 != NULL)
    {
      ...
      // ridotto_rmc); printf("\t  Select one option:\n\n"); printf("\t 1)
      // Overwrite existing .rmc file\n"); printf("\t 2) Create new .rmc
      // file\n\n"); printf("\t** Select (1/2) :___ ");
      scanf ("%d", &fe1);
      getchar ();
      fclose (init2_mol1);
      ...
      if (fe1 == 2)
        {
          // printf("\n\n\t%s", "Insert the filename for the rmc file of the
          // re-checked bead model: ");
          scanf ("%s", ridotto_rmc);
          goto a55;
        }
    }
  ...
  /*   printf("\n\n\t%s","Insert the filename for the rmc file of the
     re-checked bead model: "); scanf("%s",ridotto_rmc); */
...
initarray ()
{
  ...
  /* IMPORTING FROM A TABLE (tabella.cor) THE VALUES FOR THE ACCESSIBLE SURFACE
   * AREA OF RESIDUES */
  /* THE VALUES IN ROWS 1-25 HAVE BEEN CALCULATED FOR A PROBE RADIUS OF 0 FROM
   * THOSE IN ROWS 29-48 (WRONG VALUES!) */
  /* THE VALUES IN ROWS 29-48 ARE ASA FROM TRIPEPTIDES GLY-XXX-GLY TAKEN FROM
   * TABLE 4.4 OF CREIGHTON */
  /* IN ROWS 21-26 AND 49-54 ARE THE VALUES FOR GAL, NAG, FUC, MAN, SIA AND
   * GLUC (OG1) DEDUCED FROM KALIANNAN 2001 */
  /* IN ROWS 27-28 AND 55-56 ARE THE SUPPOSED VALUES FOR OG2 AND OG3 (TAIL OF
   * OCTYL GLUCOSIDE) */
  // em("i3_6");
  for (i = 0; i < 56; i++)
    {
  ...
  // printf("\n\n\t%s", "Output files: Enter '0' for default (provaly,
  // provaly1, provaly2, asaris)"); printf("\n\t%s", "                    '1'
  // for new filenames\n\n\t\t\t-->");
  scanf ("%d", &fe2);
  getchar ();
  if (fe2 == 0)
...
a50:
  fscanf (init3_brook, "%6s", arr_temp);
...
readline (int ind)
{
  ...
  for (j = 0; j < 24; j++)
    fscanf (init3_brook, "%c", &(stringa[j]));

  nat++;

  sscanf (stringa + 7, "%s", dd->elm);
  /*      printf("\n%s\t%s\n","dd->elm  ",dd->elm);
          printf("\n%s\t%d\n","flagr1 atom",flagr1);
          scanf("%s",pluto);
          getchar(); */
  ...
  fscanf (init3_brook, "%f", &(dd->x));
  fscanf (init3_brook, "%f", &(dd->y));
  fscanf (init3_brook, "%f", &(dd->z));
...
assignrad (int xx)
{
  ...
  switch (dd->elm[0])
    {
    case 'C':
      if (isalpha (dd->elm[1]) != 0
          || isdigit (dd->elm[1]) != 0) /* selects c alpha etc. */
        {
          if (dd->elm[1] == 'A') /* C alpha C4H1 */
            ...
            {
              if ((strcmp (dd->amin, "VAL") == 0)
                  || (strcmp (dd->amin, "THR") == 0)) /* C4H3 */
                {
                  flrad = (float)1.87;
                  dd->m = 15;
                }
              ...
              else if ((strcmp (dd->amin, "PRO") == 0)
                       || (strcmp (dd->amin, "MET") == 0)) /* C4H2 */
                {
                  flrad = (float)1.87;
                  dd->m = 14;
                }
              else if ((strcmp (dd->amin, "GLU") == 0)
                       || (strcmp (dd->amin, "GLN") == 0)) /* C4H2 */
                {
                  flrad = (float)1.87;
                  dd->m = 14;
                }
              else if ((strcmp (dd->amin, "ARG") == 0)
                       || (strcmp (dd->amin, "LYS") == 0)) /* C4H2 */
                {
                  flrad = (float)1.87;
                  dd->m = 14;
                }
              else if ((strcmp (dd->amin, "PHE") == 0)
                       || (strcmp (dd->amin, "TRP") == 0)) /* C3H0 */
                {
                  flrad = (float)1.76;
                  dd->m = 12;
                }
              else if ((strcmp (dd->amin, "ASP") == 0)
                       || (strcmp (dd->amin, "ASN") == 0)) /* C3H0 */
                {
                  flrad = (float)1.76;
                  dd->m = 12;
                }
              else if ((strcmp (dd->amin, "HIS") == 0)
                       || (strcmp (dd->amin, "TYR") == 0)) /* C3H0 */
                {
                  flrad = (float)1.76;
                  dd->m = 12;
                }
          ...
          else if (dd->elm[1] == 'D') /* C delta  */
            {
              ...
              else if ((strcmp (dd->amin, "ILE") == 0)
                       || (strcmp (dd->amin, "LEU") == 0)) /* C4H3 */
                {
                  flrad = (float)1.87;
                  dd->m = 15;
                }
              else if ((strcmp (dd->amin, "GLU") == 0)
                       || (strcmp (dd->amin, "GLN") == 0)) /* C3H0 */
                {
                  flrad = (float)1.76;
                  dd->m = 12;
                }
            ...
            {
              if ((strcmp (dd->amin, "PHE") == 0)
                  || (strcmp (dd->amin, "TRP") == 0)) /* C3H1 */
                {
                  flrad = (float)1.76;
                  dd->m = 13;
                }
              else if ((strcmp (dd->amin, "TYR") == 0)
                       || (strcmp (dd->amin, "ARG") == 0)) /* C3H0 */
                {
                  flrad = (float)1.76;
                  dd->m = 12;
                }
            ...
            {
              if (isalpha (dd->elm[2]) != 0
                  || isdigit (dd->elm[2]) != 0) /* selects c >= 10  */
                {
                  if (dd->elm[2] == '0') /* C10 of sugar or detergent */
                    {
                      ...
                      else if (strcmp (dd->amin, "OG2")
                               == 0) /* OCTYL GLUCOSIDE C10 C4H2 */
                        {
                          /*                  strcpy(dd->amin,"OG2"); */
                          flrad = (float)1.87;
                          dd->m = 14;
                  ...
                  else if (dd->elm[2] == '1') /* C11 of sugar or detergent */
                    {
                      ...
                      else if (strcmp (dd->amin, "OG3")
                               == 0) /* OCTYL GLUCOSIDE C11 C4H2 */
                        {
                          /*                  strcpy(dd->amin,"OG3"); */
                          flrad = (float)1.87;
                          dd->m = 14;
                    ...
                    {
                      if (strcmp (dd->amin, "OG3")
                          == 0) /* OCTYL GLUCOSIDE C12 C4H2 */
                        {
                          /*                  strcpy(dd->amin,"OG3"); */
                          flrad = (float)1.87;
                          dd->m = 14;
              ...
              else /* selects C1 */
                {
                  ...
                  else if (strcmp (dd->amin, "OG1")
                           == 0) /* OCTYL GLUCOSIDE C1 C4H1 */
                    {
                      /*               strcpy(dd->amin,"OG1");  */
                      flrad = (float)1.87;
                      dd->m = 13;
    ...
    case 'O':
      if (isalpha (dd->elm[1]) != 0
          || isdigit (dd->elm[1]) != 0) /* selects Ox  */
        {
          if ((dd->elm[1] == 'D')
              || (dd->elm[1] == 'E')) /* selects OD & OE  O1H0 */
            {
              flrad = (float)1.42;
              dd->m = 16;
            }
          ...
          else if (dd->elm[1] == '1') /* O1X of sugar */
            {
              if (isalpha (dd->elm[2]) != 0
                  || isdigit (dd->elm[2])
                         != 0) /* selects O >= 10 or O1A/O1B  */
                {
                  if ((dd->elm[2] == 'A')
                      || (dd->elm[2] == 'B')) /* selects O1A and O1B of SIA */
                    {
      ...
      if (isalpha (dd->elm[1]) != 0 || isdigit (dd->elm[1]) != 0)
        /*      flrad=(float) 1.8;      */
        {
          if ((dd->elm[1] == 'D') || (dd->elm[1] == 'E')) /* selects ND & NE */
            {
              if ((strcmp (dd->amin, "GLN") == 0)
                  || (strcmp (dd->amin, "ASN") == 0)) /* N3H2 */
                {
                  flrad = (float)1.64;
                  dd->m = 16;
                }
              else if ((strcmp (dd->amin, "TRP") == 0)
                       || (strcmp (dd->amin, "HIS") == 0)) /* N3H2 */
                {
...
assigntab (int xx)
{
  ...
  if (rprobe > 0.001) /* 25/6/02 CONTROLLO, E' STRANO! LA FORMULA È PER L'AREA
                         DEL CERCHIO, NON PER LA SUPERFICE DELLA SFERA!!!!!
                         IMPLEMENTATA QUELLA GIUSTA SOTTO, E RICALCOLATI I
                         PARAMETRI PER LA TABELLA */
    {
      ...
      if (form1 == 0)
        {
          ...
          fprintf (plotter_pl, "%s%d%c%d%c%d%c%d%c", "IP", 200, ',', 1830, ',',
                   7400, ',', 9030, ';');
        ...
        {
          fprintf (plotter_pl, "%s%d%c%d%c%d%c%d%c", "IP", 1830, ',', 200, ',',
                   9030, ',', 7400, ';');
          fprintf (plotter_pl, "%s%f%c%f%c%f%c%f%c\n", "SC", xp1, ',', xp2,
                   ',', yp1, ',', yp2, ';');
        }
...
formato ()
{
  ...
  pulisci ();
  //   printf("\n\n%s%f%s", "Molecule's extension along the z-axis = ",
  //   fabs(maxz - minz), " [angstrom]");
  ...
  while (conferma == 0)
    {
      ...
      // ceil(fabs(maxz - minz) / passo)); printf("%s", "Confirm ? [yes=1;no=0]
      // "); scanf("%d", &conferma);
      conferma = 1;
    }
