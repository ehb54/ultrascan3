...
public:
  ...
  QTreeWidgetItem *lvi;
  bool
  operator< (const sortable_qli_double &objIn) const
  {
    return (d < objIn.d);
  }
};
...
public:
  ...
  bool
  operator< (const lvipair &objIn) const
  {
...
public:
  ...
  lvipair lvip;
  bool
  operator< (const sortable_qlipair_double &objIn) const
  {
    return (d < objIn.d);
  }
};
...
public:
  ...
  QString name;
  bool
  operator< (const sortable_dist_name &objIn) const
  {
...
double
US_Hydrodyn_Pdb_Tool::pair_dist (QTreeWidgetItem *item1,
...
US_Hydrodyn_Pdb_Tool::US_Hydrodyn_Pdb_Tool (csv csv1, void *us_hydrodyn,
                                            QWidget *p)
    : QFrame (p)
{
  this->csv1 = csv1;
  ...
  if (!usu->load_mw_json (USglobal->config_list.system_dir + QDir::separator ()
                          + "etc" + QDir::separator () + "mw.json"))
    {
      // us_qdebug( "no mw.json load" );
      bm_active = false;
    }

  if (!usu->load_vdw_json (USglobal->config_list.system_dir
  ...
  setGeometry (global_Xpos, global_Ypos, 0,
               0); // csv_width, 100 + csv_height );
}

US_Hydrodyn_Pdb_Tool::~US_Hydrodyn_Pdb_Tool () {}

void
US_Hydrodyn_Pdb_Tool::setupGUI ()
{
  int minHeight1 = 22;
  ...
  pb_split_pdb->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  pb_join_pdbs->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_merge->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize - 1));
  ...
  pb_renum_pdb->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_hybrid_split->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_h_to_chainX->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  AUTFBACK (lbl_csv);
  lbl_csv->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  AUTFBACK (lv_csv);
  lv_csv->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  connect (lv_csv, SIGNAL (itemSelectionChanged ()),
           SLOT (csv_selection_changed ()));
  ...
  pb_csv_load_1->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv_load->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv_visualize->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_csv_save->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv_undo->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv_clear->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv_cut->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_csv_copy->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv_paste->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv_paste_new->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_csv_merge->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv_angle->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sol2wat->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_csv_reseq->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv_check->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sort->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv_find_alt
      = new QPushButton (us_tr ("Find alternate matching residues"), this);
  pb_csv_find_alt->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_csv_bm->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1));
  ...
  pb_csv_clash_report->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1));
  pb_csv_clash_report->setMinimumHeight (minHeight1);
  pb_csv_clash_report->setPalette (PALET_PUSHB);
  connect (pb_csv_clash_report, SIGNAL (clicked ()),
           SLOT (csv_clash_report ()));

  panel1_widgets.push_back (pb_csv_clash_report);

  pb_csv_sel = new QPushButton (us_tr ("Select"), this);
  pb_csv_sel->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sel_clear->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sel_clean->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sel_invert->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sel_chain->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_csv_sel_nearest_atoms->setFont (QFont (
  ...
  connect (pb_csv_sel_nearest_atoms, SIGNAL (clicked ()),
           SLOT (csv_sel_nearest_atoms ()));

  panel1_widgets.push_back (pb_csv_sel_nearest_atoms);

  pb_csv_sel_nearest_residues
      = new QPushButton (us_tr ("Nearest Residues"), this);
  pb_csv_sel_nearest_residues->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_csv_sel_nearest_residues->setMinimumHeight (minHeight1);
  pb_csv_sel_nearest_residues->setPalette (PALET_PUSHB);
  connect (pb_csv_sel_nearest_residues, SIGNAL (clicked ()),
           SLOT (csv_sel_nearest_residues ()));
  ...
  lbl_csv_sel_msg->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  AUTFBACK (lbl_csv2);
  lbl_csv2->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize, QFont::Bold));
  ...
  AUTFBACK (lv_csv2);
  lv_csv2->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  connect (lv_csv2, SIGNAL (itemSelectionChanged ()),
           SLOT (csv2_selection_changed ()));
  ...
  pb_csv2_load_1->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_load->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_visualize->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_dup->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_save->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_undo->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_clear->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_cut->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_copy->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_paste->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_paste_new->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_merge->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_angle->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sol2wat->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_reseq->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_check->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sort->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_find_alt
      = new QPushButton (us_tr ("Find alternate matching residues"), this);
  pb_csv2_find_alt->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_bm->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_clash_report->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1));
  pb_csv2_clash_report->setMinimumHeight (minHeight1);
  pb_csv2_clash_report->setPalette (PALET_PUSHB);
  connect (pb_csv2_clash_report, SIGNAL (clicked ()),
           SLOT (csv2_clash_report ()));

  panel2_widgets.push_back (pb_csv2_clash_report);

  pb_csv2_sel = new QPushButton (us_tr ("Select"), this);
  pb_csv2_sel->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sel_clear->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sel_clean->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sel_invert->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sel_chain->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1));
  ...
  pb_csv2_sel_nearest_atoms->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_csv2_sel_nearest_atoms->setMinimumHeight (minHeight1);
  pb_csv2_sel_nearest_atoms->setPalette (PALET_PUSHB);
  connect (pb_csv2_sel_nearest_atoms, SIGNAL (clicked ()),
           SLOT (csv2_sel_nearest_atoms ()));

  panel2_widgets.push_back (pb_csv2_sel_nearest_atoms);

  pb_csv2_sel_nearest_residues
      = new QPushButton (us_tr ("Nearest Residues"), this);
  pb_csv2_sel_nearest_residues->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
  pb_csv2_sel_nearest_residues->setMinimumHeight (minHeight1);
  pb_csv2_sel_nearest_residues->setPalette (PALET_PUSHB);
  connect (pb_csv2_sel_nearest_residues, SIGNAL (clicked ()),
           SLOT (csv2_sel_nearest_residues ()));
  ...
  lbl_csv2_sel_msg->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize,
                                    QFont::Bold));
  ...
  lbl_pos_range->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize + 1,
                                 QFont::Bold));
  ...
  // build layout
  QGridLayout *gl_panes = new QGridLayout;
  gl_panes->setContentsMargins (0, 0, 0, 0);
  gl_panes->setSpacing (0);
  gl_panes->setSpacing (1);
  gl_panes->setContentsMargins (1, 1, 1, 1);
  ...
  hbl_left_buttons_row_1->setContentsMargins (0, 0, 0, 0);
  hbl_left_buttons_row_1->setSpacing (0);
  ...
  hbl_left_buttons_row_2->setContentsMargins (0, 0, 0, 0);
  hbl_left_buttons_row_2->setSpacing (0);
  ...
  hbl_left_buttons_row_3->setContentsMargins (0, 0, 0, 0);
  hbl_left_buttons_row_3->setSpacing (0);
  ...
  hbl_left_buttons_row_4->setContentsMargins (0, 0, 0, 0);
  hbl_left_buttons_row_4->setSpacing (0);
  ...
  vbl_left_buttons->setContentsMargins (0, 0, 0, 0);
  vbl_left_buttons->setSpacing (0);
  ...
  vbl_center_top->setContentsMargins (0, 0, 0, 0);
  vbl_center_top->setSpacing (0);
  ...
  hbl_center_buttons_row_1->setContentsMargins (0, 0, 0, 0);
  hbl_center_buttons_row_1->setSpacing (0);
  ...
  hbl_center_buttons_row_2->setContentsMargins (0, 0, 0, 0);
  hbl_center_buttons_row_2->setSpacing (0);
  ...
  hbl_center_buttons_row_3->setContentsMargins (0, 0, 0, 0);
  hbl_center_buttons_row_3->setSpacing (0);
  ...
  hbl_center_buttons_row_4->setContentsMargins (0, 0, 0, 0);
  hbl_center_buttons_row_4->setSpacing (0);
  ...
  vbl_center_buttons->setContentsMargins (0, 0, 0, 0);
  vbl_center_buttons->setSpacing (0);
  ...
  hbl_right_buttons_row_1->setContentsMargins (0, 0, 0, 0);
  hbl_right_buttons_row_1->setSpacing (0);
  ...
  hbl_right_buttons_row_2->setContentsMargins (0, 0, 0, 0);
  hbl_right_buttons_row_2->setSpacing (0);
  ...
  hbl_right_buttons_row_3->setContentsMargins (0, 0, 0, 0);
  hbl_right_buttons_row_3->setSpacing (0);
  ...
  hbl_right_buttons_row_4->setContentsMargins (0, 0, 0, 0);
  hbl_right_buttons_row_4->setSpacing (0);
  ...
  vbl_right_buttons->setContentsMargins (0, 0, 0, 0);
  vbl_right_buttons->setSpacing (0);
...
void
US_Hydrodyn_Pdb_Tool::cancel ()
{
  close ();
}

void
US_Hydrodyn_Pdb_Tool::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Pdb_Tool::closeEvent (QCloseEvent *e)
{
  global_Xpos -= 30;
  global_Ypos -= 30;
  delete usu;
...
void
US_Hydrodyn_Pdb_Tool::clear_display ()
{
  editor->clear ();
  editor->append ("\n\n");
}
...
void
US_Hydrodyn_Pdb_Tool::update_font ()
{
  bool ok;
  QFont newFont;
...
void
US_Hydrodyn_Pdb_Tool::save ()
{
  QString use_dir = ((US_Hydrodyn *)us_hydrodyn)->somo_pdb_dir;
  ((US_Hydrodyn *)us_hydrodyn)->select_from_directory_history (use_dir, this);

  QString fn;
  fn = QFileDialog::getSaveFileName (this, windowTitle () + us_tr (": Save"),
                                     use_dir, "*.pdb *.PDB");
  if (!fn.isEmpty ())
    {
...
void
US_Hydrodyn_Pdb_Tool::update_enables_csv ()
{
  ...
  pb_csv_sel_clean->setEnabled (selection_since_clean_csv1
                                && any_csv_selected);
  pb_csv_sel_invert->setEnabled (csv1.data.size ());
  pb_csv_sel_chain->setEnabled (counts.chains > 1);
  pb_csv_sel_nearest_atoms->setEnabled (any_csv_selected
                                        && counts.not_selected_atoms > 1);
  pb_csv_sel_nearest_residues->setEnabled (any_csv_selected
                                           && counts.not_selected_atoms > 1);
...
void
US_Hydrodyn_Pdb_Tool::update_enables_csv2 ()
{
  bool any_csv_selected = any_selected (lv_csv);
  bool any_csv2_selected = any_selected (lv_csv2);
  ...
  pb_csv2_undo->setEnabled (csv2_undos.size () > csv2_pos
                            && csv2_undos[csv2_pos].size ());
  pb_csv2_clear->setEnabled (csv2.size () > 1
                             || (csv2.size () == 1 && csv2[0].data.size ()));
  ...
  pb_csv2_sel_clean->setEnabled (selection_since_clean_csv2
                                 && any_csv2_selected);
  pb_csv2_sel_invert->setEnabled (csv2[csv2_pos].data.size ());
  pb_csv2_sel_chain->setEnabled (counts.chains > 1);
  pb_csv2_sel_nearest_atoms->setEnabled (any_csv2_selected
                                         && counts.not_selected_atoms > 1);
  pb_csv2_sel_nearest_residues->setEnabled (any_csv2_selected
                                            && counts.not_selected_atoms > 1);
...
void
US_Hydrodyn_Pdb_Tool::update_enables ()
{
  update_enables_csv ();
  update_enables_csv2 ();
}
...
void
US_Hydrodyn_Pdb_Tool::editor_msg (QString color, QString msg)
{
...
void
US_Hydrodyn_Pdb_Tool::csv_msg (QString color, QString msg)
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_msg (QString color, QString msg)
{
...
void
US_Hydrodyn_Pdb_Tool::csv_load_1 ()
{
  QString f;
  load (lv_csv, f, true);
}
...
void
US_Hydrodyn_Pdb_Tool::csv_save ()
{
  save_csv (lv_csv);
}

void
US_Hydrodyn_Pdb_Tool::csv_undo ()
{
  if (!csv_undos.size ())
    {
...
void
US_Hydrodyn_Pdb_Tool::csv_paste ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv_paste_new ()
{
  csv_undos.push_back (to_csv (lv_csv, csv1, false));
  csv1 = csv_clipboard;
  csv_to_lv (csv1, lv_csv);
...
void
US_Hydrodyn_Pdb_Tool::csv_merge ()
{
}

void
US_Hydrodyn_Pdb_Tool::csv_reseq ()
{
}

csv
US_Hydrodyn_Pdb_Tool::reseq_csv (QTreeWidget * /* lv           */,
                                 csv &ref_csv, bool /* only_selected */
)
{
  return ref_csv;
}
...
void
US_Hydrodyn_Pdb_Tool::csv_visualize ()
{
  visualize (lv_csv);
}

void
US_Hydrodyn_Pdb_Tool::csv2_load ()
{
  QString f;
  load (lv_csv2, f);
}
...
void
US_Hydrodyn_Pdb_Tool::csv2_load_1 ()
{
  QString f;
  load (lv_csv2, f, true);
}
...
void
US_Hydrodyn_Pdb_Tool::csv2_save ()
{
  save_csv (lv_csv2);
}

void
US_Hydrodyn_Pdb_Tool::save_csv (QTreeWidget *lv, QString filename)
{
  csv csv_to_save;
  if (lv == lv_csv)
    {
  ...
  QString use_dir = ((US_Hydrodyn *)us_hydrodyn)->path_view_pdb.isEmpty ()
                        ? ((US_Hydrodyn *)us_hydrodyn)->somo_pdb_dir
                        : ((US_Hydrodyn *)us_hydrodyn)->path_view_pdb;

  us_qdebug (QString ("csv_to_save.name %1 csv_to_save.filename %2")
                 .arg (csv_to_save.name)
                 .arg (csv_to_save.filename));
  ...
  if (filename.isEmpty ())
    {
      ...
      filename = QFileDialog::getSaveFileName (
          this, us_tr ("Choose a filename to save the pdb"),
          use_dir + "/" + QFileInfo (csv_to_save.name).fileName (),
          "*.pdb *.PDB");
      ...
      if (QFile::exists (filename))
        {
          filename = ((US_Hydrodyn *)us_hydrodyn)
                         ->fileNameCheck (filename, 0, this);
        }
    }
...
void
US_Hydrodyn_Pdb_Tool::csv2_undo ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_copy ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_paste ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_paste_new ()
{
  if (csv2[csv2_pos].data.size ())
    {
      csv2_push (true);
...
void
US_Hydrodyn_Pdb_Tool::csv2_merge ()
{
}

void
US_Hydrodyn_Pdb_Tool::csv2_reseq ()
{
}

void
US_Hydrodyn_Pdb_Tool::csv2_visualize ()
{
  visualize (lv_csv2);
}

void
US_Hydrodyn_Pdb_Tool::adjust_wheel (double pos)
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_push (bool save_current)
{
  if (save_current)
    {
  ...
  {
    double rs = (csv2.size () * csv2.size () * 0.1 < 1.0)
                    ? csv2.size () * csv2.size () * 0.05
                    : 1.0;
    qwtw_wheel->setRange (csv2.size () - 0.5, -0.5);
    qwtw_wheel->setSingleStep (rs);
  }
  lbl_pos_range->setText (
      QString ("%1\nof\n%2").arg (csv2_pos + 1).arg (csv2.size ()));
}

void
US_Hydrodyn_Pdb_Tool::csv2_redisplay (unsigned int pos)
{
...
pdb_sel_count
US_Hydrodyn_Pdb_Tool::count_selected (QTreeWidget *lv)
{
          ...
          if (is_selected (item) || child_selected (item))
            {
              switch (US_Static::lvi_depth (item))
                ...
                default:
                  editor_msg (
                      "red",
                      "internal error: unexpected depth in count_selected()");
                  break;
                }
            }
        }
                  ...
                  if (!csv1.key.count (key (item)))
                    {
                      editor_msg (
                          "red",
                          QString (us_tr ("Internal error: missing key %1"))
                              .arg (key (item)));
                    }
                  else
                    {
                      vector<QString> *csvdata
                          = &csv1.data[csv1.key[key (item)]];
                      // csv_selected_element_counts [ csv1.data[ csv1.key[
                      // key( item ) ] ][ 13 ] ]++;
              ...
              else
                {
                  if (!csv2[csv2_pos].key.count (key (item)))
                  ...
                  else
                    {
                      vector<QString> *csvdata
                          = &csv2[csv2_pos]
                                 .data[csv2[csv2_pos].key[key (item)]];
                      // csv2_selected_element_counts[ csv2[ csv2_pos ].data[
                      // csv2[ csv2_pos ].key[ key( item ) ] ][ 13 ] ]++;
                      csv_selected_element_counts[(*csvdata)[13]]++;
                      if ((*csvdata)[2] == "SOL")
                        {
                          counts.SOLs++;
...
bool
US_Hydrodyn_Pdb_Tool::any_selected (QTreeWidget *lv)
{
...
void
US_Hydrodyn_Pdb_Tool::csv_selection_changed ()
{
  // csv_msg("black", QString("selection changed # selected %1").arg(
  // count_selected( lv_csv ).atoms ) );
  selection_since_count_csv1 = true;
  selection_since_clean_csv1 = true;
...
void
US_Hydrodyn_Pdb_Tool::csv2_selection_changed ()
{
  // csv2_msg("black", QString("selection changed # selected %1").arg(
  // count_selected( lv_csv2 ).atoms ) );
  selection_since_count_csv2 = true;
  selection_since_clean_csv2 = true;
...
csv
US_Hydrodyn_Pdb_Tool::to_csv (QTreeWidget *lv, csv &ref_csv,
                              bool only_selected)
{
  QTreeWidgetItemIterator it (lv);
  csv csv1;
              ...
              if (!ref_csv.key.count (key (item)))
                {
                  editor_msg (
                      ...
                      QString (
                          us_tr (
                              "Error: Can not find reference key %1 in %2\n"))
                          .arg (key (item))
                          .arg (ref_csv.name));
                }
              else
...
bool
US_Hydrodyn_Pdb_Tool::is_selected (QTreeWidgetItem *lvi)
{
  if (lvi->isSelected ())
    {
      return true;
...
bool
US_Hydrodyn_Pdb_Tool::child_selected (QTreeWidgetItem *lvi)
{
  if (lvi->isSelected ())
    {
      return true;
  ...
  if (lvi->childCount ())
    {
      ...
      while (myChild)
        {
          if (myChild->isSelected () || child_selected (myChild))
            {
              return true;
            }
...
bool
US_Hydrodyn_Pdb_Tool::all_children_selected (QTreeWidgetItem *lvi)
{
#if QT_VERSION < 0x040000
  if (lvi->childCount ())
    {
...
QString
US_Hydrodyn_Pdb_Tool::key (QTreeWidgetItem *lvi)
{
...
QString
US_Hydrodyn_Pdb_Tool::data_to_key (vector<QString> &data)
{
...
void
US_Hydrodyn_Pdb_Tool::csv_setup_keys (csv &csv1)
{
  csv1.key.clear ();
...
void
US_Hydrodyn_Pdb_Tool::list_csv_keys (csv &csv1)
{
  for (map<QString, unsigned int>::iterator it = csv1.key.begin ();
       it != csv1.key.end (); it++)
    {
      editor_msg (
          "green",
          QString ("key <%1> value <%2>").arg (it->first).arg (it->second));
    }
}

void
US_Hydrodyn_Pdb_Tool::csv_to_lv (csv &csv1, QTreeWidget *lv)
{
  bool lv_is_csv = (lv == lv_csv);
  ...
  for (map<QString, unsigned int>::iterator it = csv1.nd_key.begin ();
       it != csv1.nd_key.end (); it++)
    {
      // qDebug() << "nd_key:" << it->first << " index:" << it->second << " "
      //          << ( csv1.nd_selected.size() > it->second ? (
      //          csv1.nd_selected[ it->second ] ? " isSelected" : "" ) : "
      //          missing_selected" )
      //          << ( csv1.nd_open.size() > it->second ? ( csv1.nd_open[
      //          it->second ] ? " isExpanded" : "" ) : " missing_expanded" )
      //    ;
      if (csv1.nd_selected.size () > it->second
          && csv1.nd_selected[it->second])
        {
  ...
  for (int i = (int)csv1.data.size () - 1; i >= 0; i--)
    {
      if (csv1.data[i].size () < 6)
        {
          editor_msg (
              "red",
              QString (
                  us_tr ("Error: data row %1 too few tokens (%2), skipping"))
                  .arg (i + 1)
      ...
      QString model_chain_residue_atom
      ...
      if (last_model != model)
        {
          ...
          if (models.count (model))
            {
              editor_msg ("red", QString (us_tr ("Error: data row %1, model "
                                                 "%2 duplicated , skipping"))
                                     .arg (i + 1)
                                     .arg (model));
              continue;
            }
          ...
          {
            QTreeWidgetItem *lvi
                = new QTreeWidgetItem (QStringList () << model);
            models[model] = lvi;
...
#endif
              models[model]->setSelected (
                  csv1.nd_selected[csv1.nd_key[model]]);
              models[model]->setExpanded (csv1.nd_open[csv1.nd_key[model]]);
            }
          else
            {
              // editor_msg("red", QString( "Error: model %1 visi/sel/open not
              // key not found" ).arg( model ) );
            }
          last_chain = "none";
          last_residue = "none";
        }
      if (last_chain != chain)
        {
          ...
          if (model_chains.count (model_chain))
            {
              editor_msg ("red",
                          QString (us_tr ("Error: data row %1, model~chain %2 "
                                          "duplicated , skipping"))
                              .arg (i + 1)
                              .arg (model_chain));
              continue;
          ...
          if (!models.count (model))
            {
              editor_msg ("red",
                          QString (us_tr ("Error: data row %1, model %2 not "
                                          "found int models! , skipping"))
                              .arg (i + 1)
                              .arg (model));
              continue;
            }
...
#if QT_VERSION < 0x040000
          model_chains[model_chain]
              = new QTreeWidgetItem (models[model], chain);
#else
          model_chains[model_chain]
              = new QTreeWidgetItem (QStringList () << chain);
          ...
          if (csv1.nd_key.count (model_chain))
            {
#if QT_VERSION < 0x040000
              model_chains[model_chain]->setVisible (
                  csv1.nd_visible[csv1.nd_key[model_chain]]);
#endif
              model_chains[model_chain]->setSelected (
                  csv1.nd_selected[csv1.nd_key[model_chain]]);
              model_chains[model_chain]->setExpanded (
                  csv1.nd_open[csv1.nd_key[model_chain]]);
            }
          else
            {
              // editor_msg("red", QString( "Error: model_chain %1
              // visi/sel/open not key not found" ).arg( model_chain ) );
            }
      ...
      if (last_residue != residue)
        {
          ...
          if (model_chain_residues.count (model_chain_residue))
            {
              editor_msg (
                  "red",
                  QString (us_tr ("Error: data row %1, model~chain~residue %2 "
                                  "duplicated , skipping"))
                      .arg (i + 1)
          ...
          if (!model_chains.count (model_chain))
            {
              editor_msg ("red",
                          QString (us_tr ("Error: data row %1, model~chain %2 "
                                          "not found int models! , skipping"))
                              .arg (i + 1)
                              .arg (model_chain));
              continue;
            }
#if QT_VERSION < 0x040000
          model_chain_residues[model_chain_residue]
              = new QTreeWidgetItem (model_chains[model_chain], residue);
#else
          model_chain_residues[model_chain_residue]
              = new QTreeWidgetItem (QStringList () << residue);
          model_chains[model_chain]->insertChild (
              0, model_chain_residues[model_chain_residue]);
#endif
          ...
          if (csv1.nd_key.count (model_chain_residue))
            {
#if QT_VERSION < 0x040000
              model_chain_residues[model_chain_residue]->setVisible (
                  csv1.nd_visible[csv1.nd_key[model_chain_residue]]);
#endif
              model_chain_residues[model_chain_residue]->setSelected (
                  csv1.nd_selected[csv1.nd_key[model_chain_residue]]);
              model_chain_residues[model_chain_residue]->setExpanded (
                  csv1.nd_open[csv1.nd_key[model_chain_residue]]);
            }
          else
            {
              // editor_msg("red", QString( "Error: model_chain_residue %1
              // visi/sel/open not key not found" ).arg( model_chain_residue)
              // );
            }
        }
      if (!model_chain_residues.count (model_chain_residue))
        {
          editor_msg (
              "red", QString (us_tr ("Error: data row %1, model~chain~residue "
                                     "%2 not found int models! , skipping"))
                         .arg (i + 1)
                         .arg (model_chain_residue));
          continue;
        }
      ...
      model_chain_residue_atoms[model_chain_residue_atom]
          = new QTreeWidgetItem (model_chain_residues[model_chain_residue],
                                 atom, csv1.data[i][6], csv1.data[i][7],
                                 csv1.data[i][8], csv1.data[i][9],
                                 csv1.data[i][10], csv1.data[i][11],
                                 // csv1.data[ i ][ 12 ],
                                 csv1.data[i][13]);
#else
      model_chain_residue_atoms[model_chain_residue_atom]
          = new QTreeWidgetItem (QStringList ()
                                 ...
                                 // << csv1.data[ i ][ 12 ]
                                 << csv1.data[i][13]);
      model_chain_residues[model_chain_residue]->insertChild (
          0, model_chain_residue_atoms[model_chain_residue_atom]);
#endif
      ...
      if (csv1.key.count (model_chain_residue_atom))
        {
          ...
          model_chain_residue_atoms[model_chain_residue_atom]->setVisible (
              (unsigned int)csv1.visible.size ()
                      > csv1.key[model_chain_residue_atom]
                  ? csv1.visible[csv1.key[model_chain_residue_atom]]
                  : false);
#endif
          model_chain_residue_atoms[model_chain_residue_atom]->setSelected (
              (unsigned int)csv1.selected.size ()
                      > csv1.key[model_chain_residue_atom]
                  ? csv1.selected[csv1.key[model_chain_residue_atom]]
                  : false);
          model_chain_residue_atoms[model_chain_residue_atom]->setExpanded (
              (unsigned int)csv1.open.size ()
                      > csv1.key[model_chain_residue_atom]
                  ? csv1.open[csv1.key[model_chain_residue_atom]]
                  : false);
        }
      else
        {
          // editor_msg("red", QString( "Error: model_chain_residue_atom %1
          // visi/sel/open not key not found" ).arg( model_chain_residue_atom )
          // );
        }
    }
  ...
  if (lv_is_csv)
  ...
  else
    {
      ...
      connect (lv_csv2, SIGNAL (itemSelectionChanged ()),
               SLOT (csv2_selection_changed ()));
      lbl_csv2->setText ((unsigned int)csv2.size () > csv2_pos
                             ? csv2[csv2_pos].name
                             : us_tr ("Panel 2"));
      selection_since_count_csv2 = true;
    }
...
US_Hydrodyn_Pdb_Tool::merge_ok ()
{
  ...
  for (map<QString, unsigned int>::iterator it
       = csv_selected_element_counts.begin ();
       it != csv_selected_element_counts.end (); it++)
    {
...
QString
US_Hydrodyn_Pdb_Tool::csv_to_pdb (csv &csv1, bool only_atoms)
{
  QString s;
  ...
  for (unsigned int i = 0; i < (unsigned int)csv1.data.size (); i++)
    {
      ...
      s += QString ("").sprintf (
          ...
          csv1.data[i][5].toUInt (), csv1.data[i][4].toLatin1 ().data (),
          csv1.data[i][2].toLatin1 ().data (),
          csv1.data[i][1].toLatin1 ().data (), csv1.data[i][3].toUInt (),
          csv1.data[i][8].toFloat (), csv1.data[i][9].toFloat (),
          csv1.data[i][10].toFloat (), csv1.data[i][11].toFloat (),
          csv1.data[i][12].toFloat (), csv1.data[i][13].toLatin1 ().data ());
    }
  if (!only_atoms)
    {
      s += "ENDMDL\nEND\n";
...
QStringList
US_Hydrodyn_Pdb_Tool::csv_to_pdb_qsl (csv &csv1, bool only_atoms)
{
  QStringList qsl;
...
void
US_Hydrodyn_Pdb_Tool::visualize (QTreeWidget *lv)
{
  csv tmp_csv;
  ...
  if (!f_spt.open (QIODevice::WriteOnly))
    {
      QMessageBox::warning (this, "UltraScan",
                            QString (us_tr ("Could not open %1 for writing!"))
                                .arg (spt_filename));
      return;
    }
...
void
US_Hydrodyn_Pdb_Tool::load (QTreeWidget *lv, QString &filename,
                            bool only_first_nmr)
{
  QString use_dir = ((US_Hydrodyn *)us_hydrodyn)->somo_pdb_dir;
  ...
  if (filename.isEmpty ())
    {
      ...
      filename = QFileDialog::getOpenFileName (this, windowTitle (), use_dir,
                                               "*.pdb *.PDB");
    }
  ...
  if (!QFile::exists (filename))
    {
      QMessageBox::warning (
          this, us_tr ("Could not open file"),
  ...
  while (!ts.atEnd ())
    {
      ...
      if ((left5 == "ATOM " || left5 == "HETAT") && last_was_ENDMDL)
        {
          model++;
          last_was_ENDMDL = false;
        }
     ...
     13 - 16        Atom            name          Atom name. (sometimes starts
     at 12) 17             Character       altLoc        Alternate location
     ...
     Orthogonal coordinates for Y in Angstroms. 47 - 54        Real(8.3) z
     Orthogonal coordinates for Z in Angstroms. 55 - 60        Real(6.2)
     occupancy     Occupancy. 61 - 66        Real(6.2)       tempFactor
     Temperature factor. 73 - 76        LString(4)      segID         Segment
     identifier, left-justified. 77 - 78        LString(2)      element Element
     symbol, right-justified. 79 - 80        LString(2)      charge Charge on
     the atom.
      */
  ...
  if (lv == lv_csv)
  ...
  else
    {
      if (csv2[csv2_pos].data.size ())
        {
          csv2_push (true);
          // csv2_undos[ csv2_pos ].push_back( to_csv( lv_csv2, csv2[ csv2_pos
          // ], false ) );
        }
...
void
US_Hydrodyn_Pdb_Tool::load_from_qsl (QTreeWidget *lv, QStringList &pdb_text,
                                     QString title)
{
  csv new_csv;
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_clear ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_clean ()
{
  clean_selection (lv_csv);
  update_enables_csv ();
}
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_invert ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_chain ()
{
  select_chain (lv_csv);
  update_enables_csv ();
}
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_nearest_atoms ()
{
  sel_nearest_atoms (lv_csv);
}

void
US_Hydrodyn_Pdb_Tool::sel_nearest_atoms (QTreeWidget *lv)
{
  ...
  unsigned int atoms = (unsigned int)US_Static::getInteger (
      ...
      1, 1, counts.not_selected_atoms, 1, &ok, this);
  if (!ok)
    {
      return;
    }
          ...
          while ((*it2))
            {
              ...
              if (item1 != item2 && !item2->childCount ()
                  && !is_selected (item2))
                {
      ...
      if (distmap.count (item))
        {
          ...
          editor_msg ("blue", QString ("size setting for dist %1 key %2")
                                  .arg (distmap[item])
                                  .arg (key (item)));
        }
      ++it;
...
void
US_Hydrodyn_Pdb_Tool::select_model (QTreeWidget *lv, QString model)
{
  lv->clearSelection ();
  QTreeWidgetItemIterator it1 (lv);
  while ((*it1))
...
void
US_Hydrodyn_Pdb_Tool::select_model (QTreeWidget *lv,
                                    const set<QString> &models)
{
  lv->clearSelection ();
  QTreeWidgetItemIterator it1 (lv);
  while ((*it1))
...
void
US_Hydrodyn_Pdb_Tool::select_chain (QTreeWidget *lv, QString chain)
{
  QStringList chains;
  chains << chain;
...
void
US_Hydrodyn_Pdb_Tool::select_chain (QTreeWidget *lv, QStringList chains)
{
  lv->clearSelection ();
  update_enables_csv ();
  if (!chains.size ())
...
void
US_Hydrodyn_Pdb_Tool::select_chain (QTreeWidget *lv)
{
  pdb_sel_count counts = count_selected (lv);
  if (counts.chains <= 1)
    {
  ...
  do
    {
      QString chain
          = US_Static::getItem (us_tr ("US-SOMO: PDB editor : Select chain"),
                                us_tr ("Select a chain or CANCEL when done"),
                                chains, 0, false, &ok, this);
      if (ok)
        {
  ...
  while ((*it1))
    {
      QTreeWidgetItem *item1 = (*it1);
      if (US_Static::lvi_depth (item1) == 1 && selected.count (item1)
          && chains_to_select.count (item1->text (0)))
        {
          item1->setSelected (true);
        }
...
void
US_Hydrodyn_Pdb_Tool::distances (QTreeWidget *lv)
{
  ...
  unsigned int atoms = (unsigned int)US_Static::getInteger (
      ...
      QString (us_tr (
          "Enter the of number of minimum pairwise distances to find:")),
      1, 1, counts.atoms * counts.atoms, 1, &ok, this);
  ...
  double dist_thresh = US_Static::getDouble (
      us_tr ("US-SOMO: PDB editor : Pairwise Distances"),
      QString (us_tr ("Enter a maximum threshold distance or press CANCEL for "
                      "no threshold limit:")),
      0, 0, 1e99, 4, &ok, this);
...

  {
    ...
    restrict_atom = US_Static::getItem (
        us_tr ("US-SOMO: PDB editor : Pairwise Distances"),
        us_tr ("Restrict search to pairs with selected atom or CANCEL to "
               "compare all"),
        qsl, use_pos, false, &ok, this);
    if (!ok)
      {
        // user pressed Cancel
        restrict_atom = "";
  ...
  if (counts.models > 1)
    {
      ...
      QMessageBox::information (
          this, us_tr ("US-SOMO: PDB editor : Pairwise Distances"),
          QString (us_tr ("%1 models are selected, the operation will be "
                          "performed on each model independently."))
              .arg (models.size ()));
      ...
      for (unsigned int i = 0; i < (unsigned int)models.size (); i++)
        {
          editor_msg (
              "black",
              QString (us_tr ("Selecting model %1\n")).arg (models[i]));
          qApp->processEvents ();

          select_model (lv, models[i]);
          editor_msg (
              "black",
              QString (us_tr ("Processing model %1\n")).arg (models[i]));
          qApp->processEvents ();
          ...
          if (dist_thresh != 1e99)
            {
              editor_msg ("brown",
                          QString (us_tr ("using threshold limit %1")
                                       .arg (dist_thresh, 0, 'f', 3)));
              qApp->processEvents ();
              unsigned int count = 0;
              while ((*it1))
                {
                  QTreeWidgetItem *item1 = (*it1);
                  if (restrict_atom.isEmpty ()
                      || get_atom_name (item1) == restrict_atom)
                    {
                      if (!item1->childCount () && is_selected (item1))
                        {
                          if (!(++count % 500))
                          ...
                          while ((*it2))
                            {
                              ...
                              if (item1 != item2 && !item2->childCount ()
                                ...
                                {
                                  double dx
                                      = fabs (item1->text (3).toDouble ()
                                              - item2->text (3).toDouble ());
                                  if (dx <= dist_thresh)
                                    {
                                      double dy = fabs (
                                          item1->text (4).toDouble ()
                                          - item2->text (4).toDouble ());
                                      if (dy <= dist_thresh)
                                        {
                                          double dz = fabs (
                                              item1->text (5).toDouble ()
                                              - item2->text (5).toDouble ());
                                          if (dz <= dist_thresh)
                                            {
                                              double d = sqrt (
                                                  dx * dx + dy * dy + dz * dz);
                          ...
                          while ((*it2))
                            {
                              ...
                              if (item1 != item2 && !item2->childCount ()
                                  ...
                                  && !distmap.count (lvp))
                                {
                                  double dx = item1->text (3).toDouble ()
                                              - item2->text (3).toDouble ();
                                  double dy = item1->text (4).toDouble ()
                                              - item2->text (4).toDouble ();
                                  double dz = item1->text (5).toDouble ()
                                              - item2->text (5).toDouble ();
                                  double d
          ...
          for (list<sortable_qlipair_double>::iterator it = lsqd.begin ();
               it != lsqd.end (); it++)
            {
              ...
              editor_msg ("blue", QString (us_tr ("pw distance %1 %2 %3\n"))
      ...
      editor_msg ("black", QString (us_tr (
                               "Global model pairwise distance summary\n")));
      ...
      editor_msg (
          "blue",
          QString (us_tr ("Pairwise distance report for %1 atoms done"))
              .arg (atoms));
      return;
    }
  ...
  if (dist_thresh != 1e99)
    {
      editor_msg ("brown", QString (us_tr ("using threshold limit %1")
                                        .arg (dist_thresh, 0, 'f', 3)));
      qApp->processEvents ();
      unsigned int count = 0;
      while ((*it1))
                  ...
                  while ((*it2))
                    {
                      ...
                      lvp.lvi2 = item1;
                      if (item1 != item2 && !item2->childCount ()
                          && is_selected (item2) && !distmap.count (lvp))
                        {
                          double dx = item1->text (3).toDouble ()
                                      - item2->text (3).toDouble ();
                          if (dx <= dist_thresh)
...
bool
US_Hydrodyn_Pdb_Tool::sol2wat (QTreeWidget *lv, double use_radius,
                               QString filepath, int frame, QString reportpath)
{
  // get threshold

  bool ok;
  double theo_hydroradius = pow (
      (3.0 / (4.0 * M_PI)) * ((US_Hydrodyn *)us_hydrodyn)->misc.hydrovol,
      1.0 / 3.0);
  ...
  if (hydroradius == 0e0)
    {
      ...
      hydroradius = US_Static::getDouble (
          ...
          QString (us_tr ("Enter a radius in Angstrom for water.\n"
                          "This will be used as a threshold to determine if "
                          "the SOL is converted to WAT.\n"
                          "The radius will be added to the vdW radius of the "
                          "nearest non-water and\n"
                          "if the distance between centers is less than or "
                          "equal to the sum of the\n"
                          "radii, the water will be kept.\n")),
          theo_hydroradius, 0.0001, 10, 4, &ok, this);
      ...
      editor_msg ("brown", QString (us_tr ("SOL->WAT using radius %1 [A]")
                                        .arg (hydroradius, 0, 'f', 3)));

      // editor_msg( "brown", QString( us_tr( "SOL->WAT water radius %1 [A]"
      // ).arg( hydroradius, 0, 'f', 3 ) ) );
      qApp->processEvents ();
    }
          ...
          if (residue != "WAT")
            {
              ...
              QString res_idx = QString ("%1|%2")
                                    .arg (atom != "OXT" ? residue : "OXT")
                                    .arg (atom);
              if (((US_Hydrodyn *)us_hydrodyn)->vdwf.count (res_idx))
                {
                  compare_vdw.push_back (
                      ((US_Hydrodyn *)us_hydrodyn)->vdwf[res_idx].r);
                }
              else
                {
                  compare_vdw.push_back (0);
                  editor_msg ("red",
                              QString (us_tr ("SOL->WAT: %1 missing vdW "
                                              "radius, using a value of zero")
                                           .arg (res_idx)));
                }
            }
        }
  ...
  map<QString, map<QString, set<int> > >
      res_SOL_used; // map of residue names and SOLs used // rname, rnum, SOL

  map<QString, map<QString, double> >
      chosen_radius_for_SOLs; // map of residue number, atom number to chosen
                              // radius for SOL
  ...
  for (int j = 0; j < (int)compares.size (); ++j)
    {
      ...
      us_qdebug (
          QString ("atom %1 hydroradius %2 vdw radius %3 use thresh %4\n")
              .arg (j)
              .arg (hydroradius)
              .arg (compare_vdw[j])
              .arg (use_thresh));
                  ...
                  if (dz <= use_thresh)
                    {
                      ...
                      if (d2 <= use_thresh2)
                        {
                          // us_qdebug( QString( "accepted SOL between %1
                          // [%2,%3,%4] %5 [%6,%7,%8] distance %9" )
                          //         .arg( i )
                          //         .arg( t.axis[ 0 ] )
                          //         .arg( t.axis[ 1 ] )
                          //         .arg( t.axis[ 2 ] )
                            ...
                            report_SOLs[csvi]
                                += QString (
                                   ...
                                   + QString ("").sprintf (
                                       ...
                                       tmp_csv.data[csvj][13]
                                           .toLatin1 ()
                                           .data ())
                                   + QString ("").sprintf (
                                       "Distance                              "
                                       ": %8.4f\n"
                                       "vdW radius of non-SOL                 "
                                       ": %8.2f\n"
                                       "computed vdW radius of SOL if tangent "
                                       ": %8.4f\n",
                                       d, compare_vdw[j], d - compare_vdw[j]);
...

      {
        ...
        for (map<double, int>::iterator it = paired_sols_by_distance.begin ();
             it != paired_sols_by_distance.end (); ++it)
          {
            ...
            tmp_data.push_back (
                QString ("%1").arg (it->first - compare_vdw[j]));
            ...
            // pick minimum radius for SOL
            {
              ...
              if (chosen_radius_for_SOLs.count (wrnum)
            ...
            hydration_summary_res_atom[rname][aname][rnum][frame].push_back (
                hi);
            if (!hydration_header.count (csvj))
              ...
              {
                if (hydration_header[csvj].vdw != compare_vdw[j]
                    ...
                    || hydration_header[csvj].anum != tmp_csv.data[csvj][5])
                  {
                    editor_msg (
                        "red",
                        us_tr ("Error: pdbs don't have identical structure"));
                  }
              }
          }
      }
  ...
  editor_msg ("blue", QString (us_tr ("Found %1 of %2 SOLs to Convert"))
                          .arg (sol2wat_csv_index.size ())
                          .arg (SOLs.size ()));
  report_header += QString (us_tr ("Found %1 of %2 SOLs to Convert\n"))
                       .arg (sol2wat_csv_index.size ())
                       .arg (SOLs.size ());
  report_header += QString (us_tr ("Minimum computed vdW radius of SOL if "
                                   "tangent: %1 occurs between:\n")
  ...
  report_header
      += QString ("").sprintf (
             ...
             tmp_csv.data[minimum_computed_radius_posi][13]
                 .toLatin1 ()
                 .data ())
         + QString ("").sprintf (
             "ATOM  %5d%5s%4s %1s%4d    %8.3f%8.3f%8.3f%6.2f%6.2f          "
             ...
             tmp_csv.data[minimum_computed_radius_posj][13]
                 .toLatin1 ()
                 .data ());
  ...
  if ((int)sol2wat_csv_index.size () == SOL_report_adds)
    {
      report_header
          += QString (us_tr ("Only one SOL atom per non SOL found.\n"));
    }
  else
    {
      report_header
          += QString (us_tr ("N.B.: Some SOL atoms were within the threshold "
                             "of multiple non-SOL atoms.\n"));
      for (map<int, int>::iterator it = SOL_nonSOL_hits.begin ();
           it != SOL_nonSOL_hits.end (); ++it)
        {
          if (it->second > 1)
            {
              report_header += QString ("").sprintf (
                  ...
                  tmp_csv.data[it->first][3].toUInt (), it->second);
            }
        }
    }
          ...
          if (sol2wat_csv_index.count (i))
            {
              ...
              if (chosen_radius_for_SOLs.count (tmp_csv.data[i][3])
                  && chosen_radius_for_SOLs[tmp_csv.data[i][3]].count (
                      tmp_csv.data[i][5]))
                {
                  tmp_csv.data[i][12] = QString ("").sprintf (
                      "%6.2f", chosen_radius_for_SOLs[tmp_csv.data[i][3]]
                                                     [tmp_csv.data[i][5]]);
                  // QTextStream( stderr ) <<
                  //    QString( us_tr( "WAT pdb Tf radius for WAT %1 OW %2 is
                  //    %3 but chosen_radius is %4\n" ) ) .arg( tmp_csv.data[ i
                  //    ][ 3 ] ) .arg( tmp_csv.data[ i ][ 5 ] ) .arg(
                  //    tmp_csv.data[ i ][ 12 ] ) .arg( chosen_radius_for_SOLs[
                  //    tmp_csv.data[ i ][ 3 ] ][ tmp_csv.data[ i ][ 5 ] ] )
                  //    ;
                }
              else
                {
                  editor_msg (
                      "red",
                      QString (
                          us_tr ("Warning, missing radius for WAT %1 OW %2\n"))
                          .arg (tmp_csv.data[i][3])
                          .arg (tmp_csv.data[i][5]));
                  // QTextStream( stderr ) <<
                  //    QString( us_tr( "Warning, missing radius for WAT %1 OW
                  //    %2\n" ) ) .arg( tmp_csv.data[ i ][ 3 ] ) .arg(
                  //    tmp_csv.data[ i ][ 5 ] )
                  //    ;
                }
              new_csv.data.push_back (tmp_csv.data[i]);
    ...
    if (filepath.isEmpty ())
      {
        ...
        QString fn = new_name.replace (QRegExp ("\\.(pdb|PDB)$"), "")
                     + "_sol2wat_report.txt";

        filename = QFileDialog::getSaveFileName (
            this, us_tr ("Choose a filename to save the SOL->WAT report"),
            use_dir + "/" + fn, "TXT (*.txt *.TXT)");
      ...
      {
        filename = reportpath + "/" + QFileInfo (filepath).baseName ()
                   + "_sol2wat_detail.txt";
      }
    ...
    if (filepath.isEmpty ())
      {
        ...
        filename = QFileDialog::getSaveFileName (
            this, us_tr ("Choose a filename to save the SOL->WAT detail csv"),
            use_dir + "/" + fn, "CSV (*.csv *.CSV)");
...
void
US_Hydrodyn_Pdb_Tool::compute_angle (QTreeWidget *lv)
{
  ...
  if (atom_names.size () != 3)
    {
      editor_msg ("red",
                  QString (us_tr ("Error: compute angle: exactly 3 atoms must "
                                  "be selected, %1 are selected"))
                      .arg (atom_names.size ()));
      return;
    }
  ...
  // base atom[ 0 ]
  {
    float a = acosf (
        ((US_Hydrodyn *)us_hydrodyn)
            ->dot (((US_Hydrodyn *)us_hydrodyn)
                       ->normal (
                           ((US_Hydrodyn *)us_hydrodyn)->minus (p[1], p[0])),
                   ((US_Hydrodyn *)us_hydrodyn)
                       ->normal (
                           ((US_Hydrodyn *)us_hydrodyn)->minus (p[2], p[0]))));

    res += QString (us_tr ("Angle %1,%2,%3 = %4 or %5 degrees\n"))
               .arg (atom_names[1])
               .arg (atom_names[0])
               .arg (atom_names[2])
               .arg (a)
  ...
  // base atom[ 1 ]
  {
    float a = acosf (
        ((US_Hydrodyn *)us_hydrodyn)
            ->dot (((US_Hydrodyn *)us_hydrodyn)
                       ->normal (
                           ((US_Hydrodyn *)us_hydrodyn)->minus (p[0], p[1])),
                   ((US_Hydrodyn *)us_hydrodyn)
                       ->normal (
                           ((US_Hydrodyn *)us_hydrodyn)->minus (p[2], p[1]))));
    res += QString (us_tr ("Angle %1,%2,%3 = %4 or %5 degrees\n"))
               .arg (atom_names[0])
               .arg (atom_names[1])
               .arg (atom_names[2])
  ...
  // base atom[ 2 ]
  {
    float a = acosf (
        ((US_Hydrodyn *)us_hydrodyn)
            ->dot (((US_Hydrodyn *)us_hydrodyn)
                       ->normal (
                           ((US_Hydrodyn *)us_hydrodyn)->minus (p[0], p[2])),
                   ((US_Hydrodyn *)us_hydrodyn)
                       ->normal (
                           ((US_Hydrodyn *)us_hydrodyn)->minus (p[1], p[2]))));
    res += QString (us_tr ("Angle %1,%2,%3 = %4 or %5 degrees\n"))
               .arg (atom_names[0])
               .arg (atom_names[2])
               .arg (atom_names[1])
...
QString
US_Hydrodyn_Pdb_Tool::get_atom_name (QTreeWidgetItem *lvi)
{
  QString atom = QString ("%1")
                     .arg (lvi->text (0))
                     .replace (QRegExp ("^\\S+"), "")
                     .replace (QRegExp ("\\S+$"), "")
                     .trimmed ();
...
QString
US_Hydrodyn_Pdb_Tool::get_atom_number (QTreeWidgetItem *lvi)
{
  QString atom = QString ("%1")
                     .arg (lvi->text (0))
                     .trimmed ()
...
QString
US_Hydrodyn_Pdb_Tool::get_chain_id (QTreeWidgetItem *lvi)
{
...
QString
US_Hydrodyn_Pdb_Tool::get_model_id (QTreeWidgetItem *lvi)
{
...
QString
US_Hydrodyn_Pdb_Tool::get_residue_name (QTreeWidgetItem *lvi)
{
...
QString
US_Hydrodyn_Pdb_Tool::get_residue_number (QTreeWidgetItem *lvi)
{
  if (US_Static::lvi_depth (lvi) < 2)
    {
      return "unknown";
...
QStringList
US_Hydrodyn_Pdb_Tool::atom_set (QTreeWidget *lv)
{
  ...
  QStringList qsl;
  for (map<QString, bool>::iterator it = atoms.begin (); it != atoms.end ();
       it++)
    {
      qsl << it->first;
    }
...
QStringList
US_Hydrodyn_Pdb_Tool::atom_sel_rasmol (QTreeWidget *lv)
{
  map<QString, bool> atoms;
...
QStringList
US_Hydrodyn_Pdb_Tool::model_set (QTreeWidget *lv)
{
  ...
  QStringList qsl;
  for (map<QString, bool>::iterator it = models.begin (); it != models.end ();
       it++)
    {
      qsl << it->first;
    }
...
QStringList
US_Hydrodyn_Pdb_Tool::chain_set (QTreeWidget *lv)
{
  ...
  QStringList qsl;
  for (map<QString, bool>::iterator it = chains.begin (); it != chains.end ();
       it++)
    {
      qsl << it->first;
    }
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_nearest_residues ()
{
  sel_nearest_residues (lv_csv);
}

void
US_Hydrodyn_Pdb_Tool::csv_clash_report ()
{
  distances (lv_csv);
}

void
US_Hydrodyn_Pdb_Tool::csv_angle ()
{
  compute_angle (lv_csv);
}

void
US_Hydrodyn_Pdb_Tool::csv_sol2wat ()
{
  pdb_sel_count counts = count_selected (lv_csv);

  if (!counts.SOLs
      || QMessageBox::question (
             this, us_tr ("US-SOMO: PDB Editor : Sol2wat "),
             QString (us_tr ("What do you want to process?")),
             us_tr ("A &single file that is already loaded"),
             us_tr ("A &trajectory"), QString (), 0, 1)
             == 1)
    {
      sol2wat_traj (lv_csv);
    }
...
void
US_Hydrodyn_Pdb_Tool::sol2wat_traj (QTreeWidget *lv)
{
  // select a directory
  ...
  if (!not_ok)
    {
      ...
      dirname = QFileDialog::getExistingDirectory (
          this, "Add all .pdb files in directory", up_one.canonicalPath (),
  ...
  if (filenames.size () > 5)
    {
      ...
      unsigned int decimate = (unsigned int)US_Static::getInteger (
          ...
          QString (us_tr ("You have %1 files, enter the decimation value\n(1 "
                          "= no decimation, 2 = every second, etc:"))
              .arg (filenames.size ()),
          1, 1, filenames.size (), 1, &ok, this);
      if (!ok)
        {
          return;
        }
  ...
  double hydroradius = US_Static::getDouble (
      us_tr ("US-SOMO: PDB editor : SOL->WAT"),
      QString (us_tr ("Enter a radius in Angstrom for water.\n"
                      "This will be used as a threshold to determine if the "
                      "SOL is converted to WAT.\n"
                      "The radius will be added to the vdW radius of the "
                      "nearest non-water and\n"
                      "if the distance between centers is less than or equal "
                      "to the sum of the\n"
                      "radii, the water will be kept.\n")),
      theo_hydroradius, 0.0001, 10, 4, &ok, this);
  ...
  QString reportpath
      = QFileInfo (filenames[0]).path ()
        + QString ("/Hr_%1").arg (hydroradius).replace (".", "_");
  qDebug () << "report dir path " << reportpath;
  {
    ...
    if (!tmp_dir.mkpath (reportpath))
      {
        editor_msg ("red",
                    QString (us_tr ("Could not create report directory %1"))
                        .arg (reportpath));
      }
  }
  ...
  for (int i = 0; i < (int)filenames.size (); ++i)
    {
      ...
      if (match.hasMatch ())
        {
          qDebug () << QString ("file %1 has match value %2")
                           .arg (filenames[i])
                           .arg (match.captured (1).toUInt ());
          ...
          if (!counts.SOLs)
            {
              editor_msg (
                  ...
                  QString (
                      us_tr (
                          "Warning: no SOLs defined for file '%1', skipped"))
                      .arg (filenames[i]));
            }
          else
            {
              if (sol2wat (lv, hydroradius, filenames[i],
                           match.captured (1).toUInt (), reportpath))
                {
                  save_csv (
                      lv_csv2,
                      reportpath + "/" + QFileInfo (filenames[i]).baseName ()
                          + "_Hr_"
                          + QString ("%1").arg (hydroradius).replace (".", "_")
                          + ".pdb");
                }
            }
        }
  ...
  // atom, frame, hydration_info loop thru lv_csv, process all frames of each,
  // produce summary report global info later

  // find max rank (maximum number of waters)

  int max_rank = 0;

  for (map<int, map<int, vector<hydration_info> > >::iterator it1
       = hydration_summary.begin ();
       it1 != hydration_summary.end (); ++it1)
    {
      int csvj = it1->first;
      if (!hydration_header.count (csvj))
        {
          editor_msg (
              "red",
              QString (
                  us_tr ("Internal Error: no header info for '%1', quitting!"))
                  .arg (csvj));
          return;
        }

      for (map<int, vector<hydration_info> >::iterator it2
           = hydration_summary[csvj].begin ();
           it2 != hydration_summary[csvj].end (); ++it2)
        {
  ...
  for (map<QString,
           map<QString, map<int, vector<hydration_info> > > >::iterator it1
       = hydration_summary_res.begin ();
       it1 != hydration_summary_res.end (); ++it1)
    {
      QString rname = it1->first;
      for (map<QString, map<int, vector<hydration_info> > >::iterator it2
           = it1->second.begin ();
           it2 != it1->second.end (); ++it2)
        {
          for (map<int, vector<hydration_info> >::iterator it3
               = it2->second.begin ();
  ...
  for (map<QString,
           ...
           iterator it1
       = hydration_summary_res_atom.begin ();
       it1 != hydration_summary_res_atom.end (); ++it1)
    {
      QString rname = it1->first;
      for (map<QString,
               map<QString, map<int, vector<hydration_info> > > >::iterator it2
           = it1->second.begin ();
           it2 != it1->second.end (); ++it2)
        {
          for (map<QString, map<int, vector<hydration_info> > >::iterator it3
               = it2->second.begin ();
               it3 != it2->second.end (); ++it3)
            {
              for (map<int, vector<hydration_info> >::iterator it4
                   = it3->second.begin ();
  ...
  QString base_name = QFileInfo (filenames[0])
                          .baseName ()
                          .replace (QRegularExpression ("_F_\\d+$"), "");

  // header info
  {
    vector<QString> tmp_data;
    tmp_data.push_back (QFileInfo (filenames[0]).path () + "/" + base_name
                        + ".gro");
    tmp_data.push_back (QFileInfo (filenames[0]).path () + "/" + base_name
                        + ".xtc");
    tmp_data.push_back ("?");
  ...
  QString name_prefix = base_name + "_Hr_"
                        + QString ("%1").arg (hydroradius).replace (".", "_");
  ...
  summary_res_atom_csv.filename
      = reportpath + "/" + summary_res_atom_name + ".csv";
  ...
  for (int i = 1; i <= max_rank; ++i)
    {
      summary_csv.header.push_back (
          QString ("Minimum distance to rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("Maximum distance to rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("Average distance to rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("S.D. of distance to rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("Skew of distance to rank %1 waters").arg (i));

      summary_csv.header.push_back (
          QString ("Minimum radius of rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("Maximum radius of rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("Average radius of rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("S.D. of radius of rank %1 waters").arg (i));
      summary_csv.header.push_back (
          QString ("Skew of radius of rank %1 waters").arg (i));
    }

  for (int i = 1; i <= max_rank_res; ++i)
    {
      summary_res_csv.header.push_back (
          QString ("Minimum distance to rank %1 waters").arg (i));
      summary_res_csv.header.push_back (
          QString ("Maximum distance to rank %1 waters").arg (i));
      summary_res_csv.header.push_back (
  ...
  for (int i = 1; i <= max_rank_res_atom; ++i)
    {
      summary_res_atom_csv.header.push_back (
          QString ("Minimum distance to rank %1 waters").arg (i));
      summary_res_atom_csv.header.push_back (
          QString ("Maximum distance to rank %1 waters").arg (i));
      summary_res_atom_csv.header.push_back (
  ...
  for (int rank = 0; rank < max_rank; ++rank)
    {
      stat_headers << QString ("d_min %1").arg (rank)
  ...
  // map < int, map < int, vector < hydration_info > > > hydration_summary_res;
  // // residue#, frame, hydration_info map < QString, map < QString, map <
  // int, vector < hydration_info > > > >
           ...
           it2 != it1->second.end (); ++it2)
        {
          for (map<int, vector<hydration_info> >::iterator it3
               ...
               it3 != it2->second.end (); ++it3)
            {
              ...
              for (int this_max_rank = 1; this_max_rank <= max_rank_res;
                   ++this_max_rank)
                {
                  QString qsrank = QString (" %1").arg (this_max_rank);
                  for (int rank = 0; rank < (int)this_max_rank
                                     && rank < (int)it3->second.size ();
                       ++rank)
                    {
      ...
      for (int rank = 1; rank <= max_rank_res; ++rank)
        {
          ...
          tmp_data.push_back (
              QString ("%1").arg (us_stats["d" + qsrank].min ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["d" + qsrank].max ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["d" + qsrank].avg ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["d" + qsrank].sd ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["d" + qsrank].skew ()));

          tmp_data.push_back (
              QString ("%1").arg (us_stats["r" + qsrank].min ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["r" + qsrank].max ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["r" + qsrank].avg ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["r" + qsrank].sd ()));
          tmp_data.push_back (
              QString ("%1").arg (us_stats["r" + qsrank].skew ()));
        }
  ...
  //   map < QString, map < QString, map < QString, map < int, vector <
  //   hydration_info > > > > >
               ...
               it3 != it2->second.end (); ++it3)
            {
              for (map<int, vector<hydration_info> >::iterator it4
                   ...
                   it4 != it3->second.end (); ++it4)
                {
                  ...
                  for (int this_max_rank = 1;
                       this_max_rank <= max_rank_res_atom; ++this_max_rank)
                    {
                      QString qsrank = QString (" %1").arg (this_max_rank);
                      for (int rank = 0; rank < (int)this_max_rank
                                         && rank < (int)it4->second.size ();
                           ++rank)
                        {
                          us_stats["d" + qsrank].add_point (
                              it4->second[rank].d);
                          us_stats["r" + qsrank].add_point (
                              it4->second[rank].r);
                        }
                    } // this_max_rank
                } // frames
       ...
       it1 != hydration_summary.end (); ++it1)
    {
      ...
      for (map<int, vector<hydration_info> >::iterator it2
           ...
           it2 != hydration_summary[csvj].end (); ++it2)
        {
          ...
          for (int this_max_rank = 1; this_max_rank <= max_rank;
               ++this_max_rank)
            {
              QString qsrank = QString (" %1").arg (this_max_rank);
              for (int rank = 0; rank < (int)this_max_rank
                                 && rank < (int)it2->second.size ();
                   ++rank)
                {
                  us_stats["d" + qsrank].add_point (it2->second[rank].d);
                  us_stats["r" + qsrank].add_point (it2->second[rank].r);

                  bins2[0.01 * round (it2->second[rank].r * 100)]
                       [this_max_rank - 1]++;
                  bins3[0.001 * round (it2->second[rank].r * 1000)]
                       [this_max_rank - 1]++;
                  binds2[0.01 * round (it2->second[rank].d * 100)]
                        [this_max_rank - 1]++;
                  binds3[0.001 * round (it2->second[rank].d * 1000)]
                        [this_max_rank - 1]++;
                }
            } // this_max_rank
      ...
      if (us_stats["w"].count () < (int)filenames.size ())
        {
          vector<double> x ((int)filenames.size () - us_stats["w"].count (),
                            0e0);
        ...
        for (int i = 0; i < (int)binda_atoms.size (); ++i)
          {
            if (it->second.count (binda_atoms[i]))
              {
                tmp_data.push_back (
                    QString ("%1").arg (it->second[binda_atoms[i]]));
              }
            else
              {
                tmp_data.push_back ("0");
  ...
  editor_msg (
      "dark blue",
      QString (us_tr ("SOL2WAT done. All produced files in directory %1"))
          .arg (reportpath));
}

bool
US_Hydrodyn_Pdb_Tool::csv_write (csv &header_csv, csv &detail_csv)
{
...
bool
US_Hydrodyn_Pdb_Tool::csv_write (csv &detail_csv)
{
  QString filename = detail_csv.filename;
...
void
US_Hydrodyn_Pdb_Tool::csv_sel_msg ()
{
  pdb_sel_count counts = count_selected (lv_csv);
...
void
US_Hydrodyn_Pdb_Tool::csv2_sel_clear ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_sel_clean ()
{
  clean_selection (lv_csv2);
  update_enables_csv2 ();
}
...
void
US_Hydrodyn_Pdb_Tool::csv2_sel_invert ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_sel_chain ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_sel_nearest_atoms ()
{
  sel_nearest_atoms (lv_csv2);
}

void
US_Hydrodyn_Pdb_Tool::csv2_sel_nearest_residues ()
{
  sel_nearest_residues (lv_csv2);
}

void
US_Hydrodyn_Pdb_Tool::csv2_clash_report ()
{
  distances (lv_csv2);
}

void
US_Hydrodyn_Pdb_Tool::csv2_angle ()
{
  compute_angle (lv_csv2);
}

void
US_Hydrodyn_Pdb_Tool::csv2_sol2wat ()
{
  pdb_sel_count counts = count_selected (lv_csv2);
  if (!counts.SOLs
      || QMessageBox::question (
...
void
US_Hydrodyn_Pdb_Tool::csv2_sel_msg ()
{
  pdb_sel_count counts = count_selected (lv_csv2);
...
QString
US_Hydrodyn_Pdb_Tool::pdb_sel_count_msg (pdb_sel_count &counts)
{
  QString qs = "";
  if (counts.models > 1)
    {
...
void
US_Hydrodyn_Pdb_Tool::invert_selection (QTreeWidget *lv)
{
...
void
US_Hydrodyn_Pdb_Tool::clean_selection (QTreeWidget *lv)
{
...
QString
US_Hydrodyn_Pdb_Tool::list_keys (csv &csv1)
{
  QString out;
  for (map<QString, unsigned int>::iterator it = csv1.key.begin ();
       it != csv1.key.end (); it++)
...
bool
US_Hydrodyn_Pdb_Tool::no_dup_keys (csv &csv1, csv &csv2)
{
  for (map<QString, unsigned int>::iterator it = csv1.key.begin ();
       it != csv1.key.end (); it++)
    {
...
csv
US_Hydrodyn_Pdb_Tool::merge_csvs (csv &csv1, csv &csv2)
{
  // cout << "csv1 keys:\n";
  // cout << list_keys( csv1 );
  // cout << "csv2 keys:\n";
  ...
  if (merged.current_item_key.isEmpty ()
          ...
          if (merged.key.count (data_to_key (csv2.data[i])))
            {
              dups_msg
                  += QString (
                         us_tr ("Warning: duplicate atoms not pasted <%1>\n"))
                         .arg (data_to_key (csv2.data[i]));
            }
          else
            {
              merged.key[data_to_key (csv2.data[i])]
                  = (unsigned int)merged.data.size ();
  ...
  else
    {
          ...
          if (csv1.key.count (data_to_key (csv2.data[i])))
            {
              dups_msg
                  += QString (
                         us_tr ("Warning: duplicate atom not pasted <%1>\n"))
                         .arg (data_to_key (csv2.data[i]));
            }
          else
            {
      ...
      for (unsigned int i = insert_after; i < (unsigned int)csv1.data.size ();
           i++)
        {
          merged.key[data_to_key (csv1.data[i])]
              = (unsigned int)merged.data.size ();
...
void
US_Hydrodyn_Pdb_Tool::split_pdb ()
{
  ...
  QString filename = QFileDialog::getOpenFileName (this, windowTitle (),
                                                   use_dir, "*.pdb *.PDB");
  ...
  if (QMessageBox::question (
          this, us_tr ("US-SOMO: PDB Editor : Split by model"),
          QString (us_tr ("How do you want to split the file %1?"))
              .arg (QFileInfo (filename).fileName ()),
          us_tr ("&Normally (by model)"),
          us_tr (
              "Residues into models for saxs structure facture computation"),
          QString (), 0, 1)
      == 1)
    {
  ...
  editor_msg ("dark blue",
              QString (us_tr ("Checking file %1").arg (f.fileName ())));
    ...
    while (!ts.atEnd ())
      {
        ...
        if (line_count && !(line_count % 100000))
          {
            editor_msg ("dark blue",
                        QString (us_tr ("Lines read %1").arg (line_count)));
            qApp->processEvents ();
          }
        ...
        if (qs.contains (rx_model))
          {
            found_model = true;
            model_count++;
            // QStringList qsl = (qs.left(20).split( QRegExp("\\s+") ,
            // Qt::SkipEmptyParts ) );
            QStringList qsl;
            {
                ...
                if (!dup_model_name_msg_done)
                  {
                    ...
                    editor_msg ("red",
                                us_tr ("Duplicate or missing model names "
                                       "found, -# extensions added"));
                  }
              }
  ...
  editor_msg ("dark blue", QString (us_tr ("File %1 contains %2 models"))
                               .arg (f.fileName ())
                               .arg (model_count));

  if (model_count == 1)
    {
      QMessageBox::warning (this, us_tr ("US-SOMO: PDB Editor - Split"),
                            QString ("The file"
                                     "%1\n"
  ...
  fn = QFileDialog::getSaveFileName (this,
                                     "Choose a name to save the files, the "
                                     "X's will be replaced by the model name",
                                     fn, "PDB (*.pdb *.PDB)");
  ...
  if (!((US_Hydrodyn *)us_hydrodyn)->overwrite)
    {
      switch (QMessageBox::warning (
          this, us_tr ("US-SOMO: PDB Editor - overwrite question"),
                  ...
                  if (!(pos % res))
                    {
                      ...
                      while ((unsigned int)use_ext.length ()
                             < max_model_name_len)
                        {
                          use_ext = "0" + use_ext;
                        }
                      ...
                      if (QFile::exists (use_fn)
                        ...
                        {
                          use_fn = ((US_Hydrodyn *)us_hydrodyn)
                                       ->fileNameCheck (use_fn, 0, this);
                        }
                      ...
                      if (!fn_out.open (QIODevice::WriteOnly))
                        {
                          QMessageBox::warning (
                              this, "US-SOMO: PDB Editor : Split",
                              QString (
                                  us_tr ("Could not open %1 for writing!"))
                                  .arg (use_fn));
                          pb_split_pdb->setEnabled (true);
                          return;
                        }
                      ...
                      tso << QString (
                                 "HEADER    split from %1: Model %2 of %3\n")
                                 .arg (f.fileName ())
                                 .arg (pos + 1)
                                 .arg (model_count);
                      tso << model_header;
                      ...
                      fn_out.close ();
                      editor_msg ("dark blue",
                                  QString (us_tr ("File %1 written"))
                                      .arg (fn_out.fileName ()));
                      qApp->processEvents ();
                    }
                  else
                    {
                      // editor_msg( "dark red", QString("model %1
                      // skipped").arg( model_name_vector[ pos ] ) );
                    }
                  in_model = false;
                  model_lines = "";
                  pos++;
...
void
US_Hydrodyn_Pdb_Tool::hybrid_split ()
{
  // read through a pdb
  ...
  if (!QFile::exists (filename))
    {
      QMessageBox::warning (
          this, us_tr ("US-SOMO: PDB Editor - Hybrid Extract"),
          QString (us_tr ("An error occured when trying to open file\n"
                          "%1\n"
                          "The file does not exist"))
              .arg (filename));
  ...
  editor_msg (
      "dark blue",
      QString (
          us_tr ("Hybrid extract: processing file %1").arg (f.fileName ())));
      ...
      if (qs.contains (rx_atom))
        {
          ...
          if (!this_residue.count (atom_hmap))
            {
              // cout << QString( "hmap does not contain <%1>, trying
              // alternate\n" ).arg( atom_hmap );
          ...
          if (!last_residue_seq.isEmpty ()
              && (residue_seq != last_residue_seq || residue != last_residue))
            {
              ...
              for (map<QString, QString>::iterator it
                   = this_residue_hydrogens.begin ();
                   it != this_residue_hydrogens.end (); it++)
                {
                  ...
                  if (!this_residue.count (href))
                    {
                      editor_msg ("red",
                                  QString (us_tr ("Error: hydrogen ref <%1> "
                                                  "but no atom with ref"))
                                      .arg (href));
                      return;
                    }
                  this_residue[href] += "\n" + it->second;
              ...
              for (map<QString, unsigned int>::iterator it
                   = used_residues.begin ();
                   it != used_residues.end (); it++)
                {
                  QString atom_hybrid
                      = QString ("%1H%2")
                            .arg (this_residue[it->first].mid (77, 1))
                            .arg (it->second);
                  atoms_with_hydrogens[atom_hybrid].push_back (
                      this_residue[it->first]);
                }
              this_residue.clear ();
  ...
  if (!last_residue_seq.isEmpty ())
    {
          ...
          if (!this_residue.count (href))
            {
              editor_msg (
                  "red",
                  QString (
                      us_tr ("Error: hydrogen ref <%1> but no atom with ref"))
                      .arg (href));
              return;
            }
          this_residue[href] += "\n" + it->second;
      ...
      for (map<QString, unsigned int>::iterator it = used_residues.begin ();
           it != used_residues.end (); it++)
        {
          QString atom_hybrid = QString ("%1H%2")
                                    .arg (this_residue[it->first].mid (77, 1))
                                    .arg (it->second);
          atoms_with_hydrogens[atom_hybrid].push_back (
              this_residue[it->first]);
  ...
  QString fbase = QFileInfo (filename).path () + SLASH
                  + QFileInfo (filename).baseName ();

  for (map<QString, vector<QString> >::iterator it
       = atoms_with_hydrogens.begin ();
       it != atoms_with_hydrogens.end (); it++)
    {
      ...
      if (!f_out.open (QIODevice::WriteOnly))
        {
          QMessageBox::warning (
              this, us_tr ("US-SOMO: PDB editor : Hybrid Extract"),
              QString (us_tr ("Error: Can not open file %1 for writing"))
                  .arg (f_out.fileName ()));
          return;
        }

      editor_msg ("blue", QString (us_tr ("Creating %1 with %2 models"))
                              .arg (f_out.fileName ())
                              .arg (it->second.size ()));
      ...
      for (unsigned int i = 0; i < (unsigned int)it->second.size (); i++)
        {
              ...
              if (atom_names != names)
                {
                  editor_msg (
                      "dark red",
                      QString (
                          us_tr ("WARNING: atom names inconsistance for %1"))
                          .arg (it->first));
                }
            }
          ...
          for (unsigned int j = 1; j < (unsigned int)names.size (); j++)
            {
              double distance = sqrt ((p[0].axis[0] - p[j].axis[0])
                                          * (p[0].axis[0] - p[j].axis[0])
                                      + (p[0].axis[1] - p[j].axis[1])
                                            * (p[0].axis[1] - p[j].axis[1])
                                      + (p[0].axis[2] - p[j].axis[2])
                                            * (p[0].axis[2] - p[j].axis[2]));
              if (!i)
                {
          ...
          if (names.size () > 2)
            {
              // angle H1-X-H2
              angle_count++;
              for (unsigned int j = 0; j < (unsigned int)names.size () - 2;
                   j++)
                {
                  double angle = acos (
                      ((US_Hydrodyn *)us_hydrodyn)
                          ->dot (((US_Hydrodyn *)us_hydrodyn)
                                     ->normal (((US_Hydrodyn *)us_hydrodyn)
                                                   ->minus (p[1], p[0])),
                                 ((US_Hydrodyn *)us_hydrodyn)
                                     ->normal (((US_Hydrodyn *)us_hydrodyn)
                                                   ->minus (p[j + 2], p[0]))));
      ...
      for (unsigned int i = 1; i < (unsigned int)atom_names.size (); i++)
        {
          remark += QString (
                        "REMARK     distance %1-%2%3 average of %4 pairs %5 A")
                        .arg (atom_names[0])
                        .arg (atom_names[i])
                        .arg (i)
                        .arg (count)
          ...
          if (count > 1)
            {
              remark += QString (", standard deviation %1")
                            .arg (sqrt ((count * distance_sum2[i]
                                         - distance_sum[i] * distance_sum[i])
                                        / (count * (count - 1))));
            }
          remark += "\n";
        }
      ...
      if (atom_names.size () > 2)
        {
          ...
          if (gcount > 1)
            {
              remark += QString (", standard deviation %1")
                            .arg (sqrt ((gcount * gdistance_sum2
                                         - gdistance_sum * gdistance_sum)
                                        / (gcount * (gcount - 1))));
            }
          remark += "\n";
        }
      ...
      for (unsigned int i = 0; i < (unsigned int)atom_names.size () - 2; i++)
        {
          remark += QString ("REMARK     angle H1-%1-H%2 average of %3 pairs "
                             "%4 degrees")
                        .arg (atom_names[0])
                        .arg (i + 2)
                        .arg (angle_count)
                        .arg ((angle_sum[i] / (double)angle_count) * 180.0
                              / M_PI);

          if (angle_count > 1)
            {
              remark += QString (", standard deviation %1")
                            .arg (sqrt ((angle_count * angle_sum2[i]
                                         - angle_sum[i] * angle_sum[i])
      ...
      if (atom_names.size () > 3)
        {
          remark
              += QString ("REMARK     angle H1-%1-H* average of %2 pairs %3 "
                          "degrees")
                     .arg (atom_names[0])
                     .arg (gangle_count)
          ...
          if (gangle_count > 1)
            {
              remark += QString (", standard deviation %1")
                            .arg (sqrt ((gangle_count * gangle_sum2
                                         - gangle_sum * gangle_sum)
      ...
      ts_out << QString (
                    "HEADER    US-SOMO PDB Editor hybrid extract from %1\n")
                    .arg (filename);
      ts_out << remark;
      for (unsigned int i = 0; i < (unsigned int)it->second.size (); i++)
        {
...
void
US_Hydrodyn_Pdb_Tool::h_to_chainX ()
{
  // read through a pdb
  // match hydrogens to atom
  // collect up into output pdb(s)
  ...
  if (!QFile::exists (filename))
    {
      QMessageBox::warning (
          this, us_tr ("US-SOMO: PDB Editor - H to chain X"),
          QString (us_tr ("An error occured when trying to open file\n"
                          "%1\n"
                          "The file does not exist"))
              .arg (filename));
  ...
  editor_msg (
      "dark blue",
      QString (
          us_tr ("H to Chain X: processing file %1").arg (f.fileName ())));
          ...
          if (qs.contains (rx_end) && hydrogens.size ())
            {
              ...
              out += "TER\n";
              for (unsigned int i = 0; i < (unsigned int)hydrogens.size ();
                   i++)
                {
                  hydrogens[i]
                      .replace (12, 4, " XH ")
...
void
US_Hydrodyn_Pdb_Tool::join_pdbs ()
{
  ...
  do
    {
      ...
      files = US_Pdb_Util::sort_pdbs (QFileDialog::getOpenFileNames (
          this, us_tr ("Select PDB files to join, Cancel when done"), use_dir,
          "PDB files (*.pdb *.PDB)"));
          ...
          if (!already_listed.count (files[i]))
            {
              ...
              ((US_Hydrodyn *)us_hydrodyn)
                  ->add_to_directory_history (files[i]);
            }
        }
    }
  while (files.size ());
  ...
  if (join_files.size () == 1)
    {
      QMessageBox::warning (this, us_tr ("US-SOMO: PDB editor : Join"),
                            us_tr ("Error: Only one file selected to join."));
      return;
    }

  QString save_file = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a name to save the joined PDBs"),
      QFileInfo (join_files.back ()).path (), "PDB (*.pdb *.PDB)");
  ...
  if (QFile::exists (save_file))
    {
      save_file
          = ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck (save_file, 0, this);
    }

  editor_msg ("dark blue", QString ("Joining %1 as %2")
                               .arg (join_files.join ("\n"))
                               .arg (save_file));
  ...
  if (!f_out.open (QIODevice::WriteOnly))
    {
      QMessageBox::warning (
          this, us_tr ("US-SOMO: PDB editor : Join"),
          QString (us_tr ("Error: Can not open file %1 for writing"))
              .arg (save_file));
      return;
    }
  ...
  ts_out << QString ("HEADER    US-SOMO: join of %1 pdbs: %2 %3 etc\n")
                .arg (join_files.size ())
  ...
  for (unsigned int i = 0; i < (unsigned int)join_files.size (); i++)
    {
      editor_msg ("dark gray",
                  QString (us_tr ("Processing %1")).arg (join_files[i]));
      qApp->processEvents ();
      ...
      if (!f_in.open (QIODevice::ReadOnly))
        {
          QMessageBox::warning (
              this, us_tr ("US-SOMO: PDB editor : Join"),
              QString (us_tr ("Error: Can not open file %1 for reading"))
                  .arg (join_files[i]));
          f_out.close ();
          f_out.remove ();
          return;
      ...
      while (!ts_in.atEnd ())
        {
                  ...
                  if (used_model.count (last_model))
                    {
                      unsigned int ext = 0;
                      QString use_model
                          = QString ("%1-%2").arg (last_model).arg (++ext);
          ...
          if (!line_written && atom_or_model_found
              && rx_end.indexIn (qs) == -1)
            {
              ts_out << qs << "\n";
            }
  ...
  ts_out << "END\n";
  f_out.close ();
  QMessageBox::information (this, us_tr ("US-SOMO: PDB editor : Join"),
                            QString (us_tr ("File %1 created with %2 models"))
                                .arg (save_file)
                                .arg (actual_model_count));
}

void
US_Hydrodyn_Pdb_Tool::merge ()
{
  if (pdb_tool_merge_widget)
    {
    ...
    {
      pdb_tool_merge_window
          = new US_Hydrodyn_Pdb_Tool_Merge (us_hydrodyn, this);
      pdb_tool_merge_window->show ();
    }
}

void
US_Hydrodyn_Pdb_Tool::renum_pdb ()
{
  // read through a multi model pdb & create a file one per model
  ...
  US_Hydrodyn_Pdb_Tool_Renum *uhptr
      = new US_Hydrodyn_Pdb_Tool_Renum (us_hydrodyn, &parameters, this);
  ...
  unsigned int startatom
      = parameters.count ("startatom") ? parameters["startatom"].toUInt () : 1;
  unsigned int startresidue = parameters.count ("startresidue")
                                  ? parameters["startresidue"].toUInt ()
                                  : 1;
  bool chainrestartatom
      = parameters.count ("chainrestartatom")
                && parameters["chainrestartatom"].contains (QRegExp ("^(Y|y)"))
            ? true
            : false;
  bool chainrestartresidue
      = parameters.count ("chainrestartresidue")
                && parameters["chainrestartresidue"].contains (
                    QRegExp ("^(Y|y)"))
            ? true
            : false;
  ...
  bool modelrestartatom
      = parameters.count ("modelrestartatom")
                && parameters["modelrestartatom"].contains (QRegExp ("^(Y|y)"))
            ? true
            : false;
  bool modelrestartresidue
      = parameters.count ("modelrestartresidue")
                && parameters["modelrestartresidue"].contains (
                    QRegExp ("^(Y|y)"))
            ? true
            : false;
  bool reseqatom
      = parameters.count ("reseqatom")
                && parameters["reseqatom"].contains (QRegExp ("^(Y|y)"))
            ? true
            : false;
  bool reseqresidue
      = parameters.count ("reseqresidue")
                && parameters["reseqresidue"].contains (QRegExp ("^(Y|y)"))
            ? true
            : false;
  bool striphydrogens
      = parameters.count ("striphydrogens")
                && parameters["striphydrogens"].contains (QRegExp ("^(Y|y)"))
            ? true
            : false;
  bool itassertemplate
      = parameters.count ("itassertemplate")
                && parameters["itassertemplate"].contains (QRegExp ("^(Y|y)"))
            ? true
            : false;
  ...
  QString foutname = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the renumbered pdb"), QString (),
      "*.pdb *.PDB");
  ...
  if (foutname == filename)
    {
      QMessageBox::warning (
          ...
          QString (
              us_tr (
                  "The output file must not be the same as the inpufile %1!"))
              .arg (foutname));
      pb_renum_pdb->setEnabled (true);
      return;
    }
  ...
  if (QFile::exists (foutname))
    {
      foutname
          = ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck (foutname, 0, this);
    }
  ...
  while (!tsi.atEnd ())
    {
      ...
      if (rx_atom.indexIn (line) != -1)
        {
          if (striphydrogens
              && line.mid (12, 2).contains (QRegExp ("^((\\d| )H|H)")))
            {
              continue;
            }
              ...
              if (reseqatom)
                {
                  if (atomno > 99999)
                    {
                      editor_msg ("dark red",
                                  us_tr ("Warning: more than 99,999 atoms, "
                                         "numbering restarted at 1"));
                      atomno = 1;
                    }
                  line = line.replace (6, 5,
                                       QString ("").sprintf ("%5d", atomno++));
                      ...
                      if (residueno > 9999)
                        {
                          editor_msg (
                              "dark red",
                              us_tr ("Warning: more than 9,999 residues, "
                                     "numbering restarted at 1"));
                          residueno = 1;
                        }
                    }
                  line = line.replace (
                      22, 4, QString ("").sprintf ("%4d", residueno));
                  last_residue_id = residue_id;
                }
            }
          if (itassertemplate)
            {
              ...
              // Column 31-54: Coordinates of atoms in query copied from
              // corresponding atoms in template. Column 55-59: Corresponding
              // residue number in template based on alignment Column 60-64:
              // Corresponding residue name in template
              /* sequences, e.g.
  ...
  ATOM   2005  CA  GLY     5      29.121 -25.194   8.602  133 ARG
              */
              ...
              line = line.left (55)
                     + QString ("").sprintf ("%4d ", residue_seq.toUInt ())
                     + residue_name;
  ...
  editor_msg ("dark blue",
              QString ("Renumber done, written file %1").arg (foutname));
  pb_renum_pdb->setEnabled (true);
  return;
}

void
US_Hydrodyn_Pdb_Tool::csv_clear ()
{
  lv_csv->clear ();
  csv new_csv;
  csv1 = new_csv;
...
void
US_Hydrodyn_Pdb_Tool::csv2_clear ()
{
  lv_csv2->clear ();
  csv new_csv;
  csv2.resize (1);
...
QString
US_Hydrodyn_Pdb_Tool::key_to_bottom_key (csv &csv1)
{
...
void
US_Hydrodyn_Pdb_Tool::csv_check ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_sort ()
{
  do_sort (lv_csv2);
  update_enables_csv2 ();
}
...
void
US_Hydrodyn_Pdb_Tool::do_sort (QTreeWidget *lv)
{
  map<QString, QString> parameters;
  US_Hydrodyn_Pdb_Tool_Sort *uhpts
      = new US_Hydrodyn_Pdb_Tool_Sort (us_hydrodyn, &parameters, this);
  ...
  int reportcount = parameters.count ("reportcount")
                        ? parameters["reportcount"].toInt ()
                        : 99999;
  ...
  if (!residuesa.length () || !residuesb.length ())
    {
      ...
      lv == lv_csv ? csv_msg ("red", msg) : csv2_msg ("red", msg);
      return;
    }
    ...
    QString msg
        = QString (us_tr ("Residues a: %1\n")).arg (residuesa)
          ...
          + QString (us_tr ("Report count: %1\n"))
                .arg (reportcount == 99999 ? QString ("\"All\"")
                                           : QString ("%1").arg (reportcount))
          + QString (us_tr ("Order: %1\n"))
                .arg (QString (us_tr ((order ? "Maximum" : "Minimum"))
                               + " aggregate distance"))
          + QString (us_tr ("CA Only: %1\n")).arg (caonly ? "True" : "False");
    lv == lv_csv ? csv_msg ("blue", msg) : csv2_msg ("blue", msg);
  }

  // validate residues, take selected models and compute aggregrate pairwise
  // distance of residues and select the report count number of models and
  // report on the distances
  ...
  for (int i = 0; i < (int)tmp_csv.data.size (); ++i)
    {
      ...
      // us_qdebug( QString( "check <%1> atom <%2>" ).arg( check ).arg(
      // tmp_csv.data[ i ][ 4 ] ) );
      ...
      for (int j = 0; j < (int)pointsa.size (); ++j)
        {
          for (int k = 0; k < (int)pointsb.size (); ++k)
            {
              sdn.dist
                  += sqrt (((pointsa[j].axis[0] - pointsb[k].axis[0])
                            * (pointsa[j].axis[0] - pointsb[k].axis[0]))
                           + ((pointsa[j].axis[1] - pointsb[k].axis[1])
                              * (pointsa[j].axis[1] - pointsb[k].axis[1]))
                           + ((pointsa[j].axis[2] - pointsb[k].axis[2])
  ...
  for (list<sortable_dist_name>::iterator it = model_distances.begin ();
       it != model_distances.end (); it++)
    {
      QString msg = QString ("model %1 distances %2 pairs %3")
                        .arg (it->name)
                        .arg (it->dist)
                        .arg (it->pairs);
      lv == lv_csv ? csv_msg ("dark blue", msg) : csv2_msg ("dark blue", msg);
...
void
US_Hydrodyn_Pdb_Tool::select_these (QTreeWidget *lv,
                                    vector<QString> &error_keys)
{
  lv->clearSelection ();
...
void
US_Hydrodyn_Pdb_Tool::csv_find_alt ()
{
  ...
  if (self_included)
    {
      if (QMessageBox::question (
              ...
              us_tr (
                  QString (
                      "The current residue is ok, but there %1\n"
                      "Do you want to change the residue in the loaded pdb?")
                      .arg (alt_residues.size () > 2 ? "are alternatives"
                                                     : "is an alternative")),
              us_tr ("&Yes"), us_tr ("&No"), QString (), 0, 1))
        {
          return;
        }
      else
        {
          if (alt_residues.size () == 2)
            {
              csv_undos.push_back (to_csv (lv_csv, csv1, false));
              csv_msg ("black", QString (us_tr ("Residue %1 replaced with %2"))
                                    .arg (tmp_csv.data[0][2])
                                    .arg (alt_residues_no_self[0]));
              replace_selected_residues (lv_csv, csv1, tmp_csv.data[0][2],
                                         alt_residues_no_self[0]);
              update_enables_csv ();
              return;
            }
        }
  ...
  bool ok;
  QString res = US_Static::getItem (us_tr ("US-SOMO: PDB Editor"),
                                    us_tr ("Select a replacement residue\n"
                                           "or press Cancel\n"),
                                    alt_residues_no_self, 0, true, &ok, this);
  if (ok)
    {
      csv_undos.push_back (to_csv (lv_csv, csv1, false));
...
void
US_Hydrodyn_Pdb_Tool::csv2_check ()
{
...
void
US_Hydrodyn_Pdb_Tool::csv2_find_alt ()
{
  ...
  if (self_included)
    {
      if (QMessageBox::question (
      ...
      else
        {
          if (alt_residues.size () == 2)
            {
              csv2_undos[csv2_pos].push_back (
                  to_csv (lv_csv2, csv2[csv2_pos], false));
              replace_selected_residues (lv_csv2, csv2[csv2_pos],
                                         tmp_csv.data[0][2],
                                         alt_residues_no_self[0]);
              csv2_msg ("black",
                        QString (us_tr ("Residue %1 replaced with %2"))
                            .arg (tmp_csv.data[0][2])
                            .arg (alt_residues_no_self[0]));
              update_enables_csv2 ();
              return;
  ...
  if (ok)
    {
      csv2_undos[csv2_pos].push_back (to_csv (lv_csv2, csv2[csv2_pos], false));
      replace_selected_residues (lv_csv2, csv2[csv2_pos], tmp_csv.data[0][2],
                                 res);
      csv2_msg ("black", QString (us_tr ("Residue %1 replaced with %2"))
                             .arg (tmp_csv.data[0][2])
                             .arg (res));
    }
...
void
US_Hydrodyn_Pdb_Tool::replace_selected_residues (QTreeWidget *lv, csv &csv_use,
              ...
              while (myChild)
                {
                  if (csv_use.key.count (previous_keys[myChild]))
                    {
                      if (csv_use.data[csv_use.key[previous_keys[myChild]]]
                              .size ()
                          < 3)
                        {
                          editor_msg (
                              "red",
                              QString (us_tr ("Internal error: insufficient "
                                              "data for %1"))
                                  .arg (previous_keys[myChild]));
                        }
                      else
                        {
                          csv_use.data[csv_use.key[previous_keys[myChild]]][2]
                              = to;
                        }
                      csv_use.key[key (myChild)]
                          = csv_use.key[previous_keys[myChild]];
                  ...
                  else
                    {
                      ...
                      editor_msg (
                          "red",
                          us_tr ("Internal error: expected key match 2"));
                    }
                  myChild = myChild->nextSibling ();
                }
            }
                    ...
                    if (myChild)
                      {
                        if (csv_use.key.count (previous_keys[myChild]))
                          {
                            if (csv_use
                                    .data[csv_use.key[previous_keys[myChild]]]
                                    .size ()
                                < 3)
                              {
                                editor_msg (
                                    "red",
                                    QString (
                                        us_tr ("Internal error: insufficient "
                                               "data for %1"))
                                        .arg (previous_keys[myChild]));
                              }
                            else
                          ...
                          {
                            cout << QString (
                                        "child org key:<%1> new_key:<%2>\n")
                                        .arg (previous_keys[myChild])
                                        .arg (key (myChild));
                            editor_msg (
                                "red",
                                us_tr (
                                    "Internal error: expected key match 2"));
                          }
                      }
                  }
              }
...
QString
US_Hydrodyn_Pdb_Tool::check_csv_for_alt (csv &csv1, QStringList &alt_residues)
{
  alt_residues.clear ();
  if (!usu->select_residue_file (
          ((US_Hydrodyn *)us_hydrodyn)->residue_filename))
    {
  ...
  usu->control_parameters["saxsfile"]
      = ((US_Hydrodyn *)us_hydrodyn)->saxs_options.default_saxs_filename;
  usu->control_parameters["hybridfile"]
      = ((US_Hydrodyn *)us_hydrodyn)->saxs_options.default_hybrid_filename;
  usu->control_parameters["atomfile"]
      = ((US_Hydrodyn *)us_hydrodyn)->saxs_options.default_atom_filename;
  ...
  for (map<QString, bool>::iterator it = residue_names.begin ();
       it != residue_names.end (); it++)
    {
      ...
      // usu->model_vector.size() );

      error_keys.clear ();

      for (unsigned int i = 0; i < (unsigned int)usu->model_vector.size ();
           i++)
        {
          usu->errormsg = "";
...
QString
US_Hydrodyn_Pdb_Tool::check_csv (csv &csv1, vector<QString> &error_keys)
{
  errormsg = "";
  QString qs;
  if (!usu->select_residue_file (
  ...
  if (!usu->select_atom_file (
          ((US_Hydrodyn *)us_hydrodyn)->saxs_options.default_atom_filename))
    {
      errormsg = usu->errormsg;
      return "";
    }
  if (!usu->select_hybrid_file (
          ((US_Hydrodyn *)us_hydrodyn)->saxs_options.default_hybrid_filename))
    {
      errormsg = usu->errormsg;
      return "";
    }
  if (!usu->select_saxs_file (
          ((US_Hydrodyn *)us_hydrodyn)->saxs_options.default_saxs_filename))
    {
      errormsg = usu->errormsg;
      return "";
  ...
  usu->control_parameters["pdbmissingatoms"] = QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->pdb_parse.missing_atoms);
  usu->control_parameters["pdbmissingresidues"] = QString ("%1").arg (
      ((US_Hydrodyn *)us_hydrodyn)->pdb_parse.missing_residues);
      ...
      if (!usu->check_for_missing_atoms (&usu->model_vector[i], qsl))
        {
          errormsg
              += QString (
                     us_tr ("Model %1: Errors with your PDB structure %2\n"))
                     .arg (i + 1)
                     .arg (usu->errormsg);
        }
      else
...
double
US_Hydrodyn_Pdb_Tool::minimum_pair_distance (QTreeWidget *lv, QString chain_1,
                                             QString chain_2, QString &key_1,
                                             QString &key_2)
{
...
void
US_Hydrodyn_Pdb_Tool::split_pdb_by_residue (QFile &f)
{
  ...
  bool skip_waters
      = QMessageBox::question (
            this, us_tr ("US-SOMO: PDB Editor : Split by residue"),
            QString (us_tr ("Do you want to skip waters?")), us_tr ("&Yes"),
            us_tr ("&No"), QString (), 1)
        == 0;

  bool waters_as_onezies
      = skip_waters
            ? false
            : (QMessageBox::question (
                   this, us_tr ("US-SOMO: PDB Editor : Split by residue"),
                   QString (us_tr (
                       "Do you want to keep the waters as singletons?")),
                   us_tr ("&Yes"), us_tr ("&No"), QString (), 0)
               == 0);
            ...
            if (!skip_waters || !is_water)
              {
                ...
                if (resSeq != last_resSeq || chainId != last_chainId
  ...
  //    for ( unsigned int i = 0; i < ( unsigned int ) chain_residues.size();
  //    i++ )
  //    {
  //       for ( unsigned int j = 0; j < ( unsigned int ) chain_residues[ i
  //       ].size(); j++ )
  //       {
  //          cout << QString( "split_by_residue(): chain %1 residue %2 atoms
  //          %2\n" )
  //             .arg( i )
  //             .arg( j )
  ...
  do
    {
      window_size = (unsigned int)US_Static::getInteger (
          ...
          QString (us_tr ("The maximum chain length in residues is %1 in the "
                          "1st model in the PDB file %2\n"
                          "Enter the number of resdues per output model:"))
              .arg (max_chain_length)
              .arg (f.fileName ()),
          1, 1, max_chain_length / 2, 1, &ok, this);
      if (ok)
        {
          step_size = (unsigned int)US_Static::getInteger (
              us_tr ("US-SOMO: PDB Editor : Split by residue"),
              QString (us_tr ("The maximum chain length in residues is %1 in "
                              "the 1st model in the PDB file %2\n"
                              "The number of resdues per output model is %3\n"
                              "Enter the step size:"))
                  .arg (max_chain_length)
                  .arg (f.fileName ())
                  .arg (window_size),
              1, 1, window_size, 1, &ok, this);
        }
      if (ok)
        {
          switch (QMessageBox::question (
              ...
              QString (us_tr ("The maximum chain length in residues is %1 in "
                  ...
                  .arg (window_size)
                  .arg (step_size),
              us_tr ("&Re-enter values"), us_tr ("&Proceed"),
              us_tr ("&Cancel"), 0, 2))
            {
            case 0: // reenter
              ok = false;
  ...
  QString fn = f.fileName ().replace (QRegExp ("\\.(pdb|PDB)$"), "")
               + QString ("_ws%1_ss%2%3%4_sr.pdb")
                     .arg (window_size)
                     .arg (step_size)
                     .arg (skip_waters ? "_nw" : "")
                     .arg (waters_as_onezies ? "_ww" : "");

  fn = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a name to save the multiple model output file"), fn,
      "PDB (*.pdb *.PDB)");
  ...
  if (QFile::exists (fn) && !((US_Hydrodyn *)us_hydrodyn)->overwrite)
    {
  ...
  if (!fn_out.open (QIODevice::WriteOnly))
    {
      QMessageBox::warning (
          this, "US-SOMO: PDB Editor : Split by residue",
  ...
  tso << QString ("HEADER    split by residue from %1: window size %2 step "
                  "size %3\n")
             .arg (f.fileName ())
             .arg (window_size)
             .arg (step_size);
  ...
  for (unsigned int i = 0; i < (unsigned int)chain_residues.size (); i++)
    {
      for (int j = 1 - window_size; j < (int)chain_residues[i].size ();
           j += step_size)
        {
          // create a model
          ...
          for (int k = j;
               k < j + (int)window_size && k < (int)chain_residues[i].size ();
               k++)
            {
              if (k >= 0)
                {
                  for (unsigned int l = 0;
                       l < (unsigned int)chain_residues[i][k].size (); l++)
                    {
                      if (waters_as_onezies)
                        {
                          QString resName
                              = chain_residues[i][k][l].mid (17, 3).trimmed ();
                          if (resName == "HOH" || resName == "WAT")
                            {
                              if (!water_done)
                                {
                                  {
                                    tso << QString ("REMARK Multiply water Iq "
                                                    "by %1\n")
                                               .arg (water_count
                                                     * window_size);
                                  }
...
void
US_Hydrodyn_Pdb_Tool::hide_widgets (vector<QWidget *> w, bool hide)
{
...
void
US_Hydrodyn_Pdb_Tool::do_bm (QTreeWidget *lv)
{
  // 1st find atoms
  ...
  double psv = US_Static::getDouble (
      ...
      QString (us_tr ("Enter an estimated PSV")), 7e-1, 1e-3, 2e0, 3, &ok,
      this);
  if (!ok)
    {
      return;
  ...
  double expansion = US_Static::getDouble (
      us_tr ("US-SOMO: PDB editor : Bead model from atoms"),
      QString (us_tr ("Enter a vDW multiplier:")), 1, 5e-1, 5e1, 4, &ok, this);
      ...
      if (!item1->childCount () && is_selected (item1))
        {
          ...
          if (!usu->atom_mw.count (atom))
            {
              QString msg = QString (us_tr ("Atom '%1' not found in loaded "
                                            "molecular weights (mw.json)"))
                                .arg (atom);
              lv == lv_csv ? csv_msg ("red", msg) : csv2_msg ("red", msg);
              return;
            }
          if (!usu->atom_vdw.count (atom))
            {
              QString msg = QString (us_tr ("Atom '%1' not found in loaded "
                                            "molecular vdw radii (vdw.json)"))
                                .arg (atom);
              lv == lv_csv ? csv_msg ("red", msg) : csv2_msg ("red", msg);
              return;
            }
          out << QString ("%1 %2 %3 %4 %5 1 %6 0")
                     .arg (item1->text (3))
                     .arg (item1->text (4))
                     .arg (item1->text (5))
                     .arg (usu->atom_vdw[atom] * expansion)
                     .arg (usu->atom_mw[atom])
                     .arg (item1->parent ()->text (0).trimmed ().replace (
                               QRegExp ("\\s+"), ":")
                           + ":"
                           + item1->text (0).trimmed ().replace (
                               QRegExp ("\\s+"), ":"));
        }
      ++it1;
    }
  ...
  QString filename = QFileDialog::getSaveFileName (
      this, us_tr ("Choose a filename to save the bead model"),
      use_dir + QDir::separator ()
          + QFileInfo (lv == lv_csv ? csv1.name : csv2[csv2_pos].name)
                .baseName (),
  ...
  filename.replace (
      QRegExp ("(_e\\d+_\\d+|)\\.bead_model$", Qt::CaseInsensitive), "");
  if (expansion != 1e0)
    {
      filename
          += QString ("_e%1").arg (expansion, 0, 'f', 4).replace (".", "_");
    }
  filename += ".bead_model";
  ...
  if (QFile::exists (filename))
    {
      filename
          = ((US_Hydrodyn *)us_hydrodyn)->fileNameCheck (filename, 0, this);
    }
  ...
  f.close ();
  {
    ...
    QString msg = QString (us_tr ("Created beam model output file %1"))
                      .arg (f.fileName ());
    lv == lv_csv ? csv_msg ("blue", msg) : csv2_msg ("blue", msg);
  }
  return;
