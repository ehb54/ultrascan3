...
US_Hydrodyn_Grid::setupGUI ()
{
  ...
  cnt_cube_side->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  connect (bg_center, SIGNAL (clicked (int)), this,
           SLOT (select_center (int)));

  cb_center_mass = new QCheckBox (bg_center);
  cb_center_mass->setText (us_tr (" Center of Mass "));
  cb_center_mass->setEnabled (true);
  cb_center_mass->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  cb_center_cubelet->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  cb_center_si->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  rb_center_mass->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  rb_center_cubelet->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  rb_center_cubelet->setPalette (PALET_NORMAL);
  AUTFBACK (rb_center_cubelet);
  connect (rb_center_cubelet, SIGNAL (clicked ()), this,
           SLOT (select_center ()));
  ...
  rb_center_si->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  ...
  cb_cubic->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  cb_tangency->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cb_enable_asa->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_create_nmr_bead_pdb->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  ...
  cb_equalize_radii_constant_volume->setFont (QFont (
...
void
US_Hydrodyn_Grid::update_cube_side (double val)
{
  (*grid).cube_side = val;
...
void
US_Hydrodyn_Grid::select_center ()
{
...
void
US_Hydrodyn_Grid::select_center (int val)
{
  (*grid).center = val;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}
...
void
US_Hydrodyn_Grid::set_enable_asa ()
{
...
void
US_Hydrodyn_Grid::set_create_nmr_bead_pdb ()
{
...
void
US_Hydrodyn_Grid::set_equalize_radii_constant_volume ()
{
  (*grid).equalize_radii_constant_volume
...
void
US_Hydrodyn_Grid::cancel ()
{
  close ();
}

void
US_Hydrodyn_Grid::overlaps ()
{
  if (overlap_widget)
    {
...
void
US_Hydrodyn_Grid::closeEvent (QCloseEvent *e)
{
  if (overlap_widget)
    {
