...
unsigned int
US_Saxs_Util::nsa_pop_selection (unsigned int size)
{
...
bool
US_Saxs_Util::nsa_ga_fitness (nsa_ga_individual &individual)
{

#if defined(USUNG_DEBUG)
#if defined(USE_MPI)
  debug_mpi (
      QString ("%1: entering nsa_ga_fitness individual size %2, var size %3\n")
          .arg (myrank)
...
#endif
#endif
  nsa_gsm (individual.fitness, vi, method);
...
bool
US_Saxs_Util::nsa_ga (double &nrmsd)
{
