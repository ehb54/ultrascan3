...
hplc_stack_data
US_Hydrodyn_Saxs_Hplc::current_data (bool selected_only)
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_push_all ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::stack_push_sel ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::set_current_data (hplc_stack_data &tmp_stack)
{
  lb_files->clear ();
...
void
US_Hydrodyn_Saxs_Hplc::stack_drop ()
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_rot_up ()
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_rot_down ()
{
  vector<hplc_stack_data> new_stack;
...
void
US_Hydrodyn_Saxs_Hplc::stack_swap ()
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_join ()
{
  stack_join (stack_data.back ());
}

void
US_Hydrodyn_Saxs_Hplc::stack_join (hplc_stack_data &tmp_stack)
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_copy ()
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_pcopy ()
{
...
void
US_Hydrodyn_Saxs_Hplc::stack_paste ()
{
  disable_all ();
...
void
US_Hydrodyn_Saxs_Hplc::stack_clear ()
{
  disable_all ();
