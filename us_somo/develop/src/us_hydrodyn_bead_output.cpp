...
void
US_Hydrodyn_Bead_Output::setupGUI ()
{
  int minHeight1 = 30;
  ...
  connect (bg_output, SIGNAL (clicked (int)), this,
           SLOT (select_output (int)));
  ...
  cb_somo_output->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cb_beams_output->setChecked ((*bead_output).output
                               & US_HYDRODYN_OUTPUT_BEAMS);
  cb_beams_output->setMinimumHeight (minHeight1);
  cb_beams_output->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_hydro_output->setChecked ((*bead_output).output
                               & US_HYDRODYN_OUTPUT_HYDRO);
  cb_hydro_output->setMinimumHeight (minHeight1);
  cb_hydro_output->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_grpy_output->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  ...
  cb_somo_output->setPalette (PALET_NORMAL);
  AUTFBACK (cb_somo_output);
  connect (cb_somo_output, SIGNAL (clicked ()), this,
           SLOT (select_output_somo ()));
  ...
  cb_grpy_output->setPalette (PALET_NORMAL);
  AUTFBACK (cb_grpy_output);
  connect (cb_grpy_output, SIGNAL (clicked ()), this,
           SLOT (select_output_grpy ()));
  cb_grpy_output->hide ();
  ...
  connect (bg_sequence, SIGNAL (clicked (int)), this,
           SLOT (select_sequence (int)));
  ...
  cb_pdb_sequence->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cb_chain_sequence->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  ...
  rb_pdb_sequence->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  rb_pdb_sequence->setPalette (PALET_NORMAL);
  AUTFBACK (rb_pdb_sequence);
  connect (rb_pdb_sequence, SIGNAL (clicked ()), this,
           SLOT (select_sequence ()));
  ...
  rb_chain_sequence->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  rb_chain_sequence->setPalette (PALET_NORMAL);
  AUTFBACK (rb_chain_sequence);
  connect (rb_chain_sequence, SIGNAL (clicked ()), this,
           SLOT (select_sequence ()));
  ...
  cb_correspondence->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
...
void
US_Hydrodyn_Bead_Output::select_output_somo ()
{
  select_output (0);
}

void
US_Hydrodyn_Bead_Output::select_output_beams ()
{
  select_output (1);
}

void
US_Hydrodyn_Bead_Output::select_output_hydro ()
{
  select_output (2);
}

void
US_Hydrodyn_Bead_Output::select_output_grpy ()
{
  select_output (3);
}

void
US_Hydrodyn_Bead_Output::select_output (int val)
{
...
void
US_Hydrodyn_Bead_Output::select_sequence ()
{
...
void
US_Hydrodyn_Bead_Output::select_sequence (int val)
{
...
void
US_Hydrodyn_Bead_Output::select_correspondence ()
{
...
void
US_Hydrodyn_Bead_Output::cancel ()
{
  close ();
}

void
US_Hydrodyn_Bead_Output::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Bead_Output::closeEvent (QCloseEvent *e)
{
  *bead_output_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
