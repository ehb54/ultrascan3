...
US_Hydrodyn_AdvancedConfig::US_Hydrodyn_AdvancedConfig (
    struct advanced_config *advanced_config, bool *advanced_config_widget,
...
void
US_Hydrodyn_AdvancedConfig::setupGUI ()
{
  int minHeight1 = 30;
  ...
  cb_auto_view_pdb->setText (
      us_tr (" Automatically view PDB structure upon loading"));
  cb_auto_view_pdb->setEnabled (true);
  cb_auto_view_pdb->setChecked ((*advanced_config).auto_view_pdb);
  cb_auto_view_pdb->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_auto_view_pdb->setPalette (PALET_NORMAL);
  AUTFBACK (cb_auto_view_pdb);
  connect (cb_auto_view_pdb, SIGNAL (clicked ()), this,
           SLOT (set_auto_view_pdb ()));
  ...
  cb_scroll_editor->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_scroll_editor->setPalette (PALET_NORMAL);
  AUTFBACK (cb_scroll_editor);
  connect (cb_scroll_editor, SIGNAL (clicked ()), this,
           SLOT (set_scroll_editor ()));

  cb_auto_calc_somo = new QCheckBox (this);
  cb_auto_calc_somo->setText (
      us_tr (" Automatically build somo bead model upon loading pdb"));
  cb_auto_calc_somo->setEnabled (true);
  cb_auto_calc_somo->setChecked ((*advanced_config).auto_calc_somo);
  cb_auto_calc_somo->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_auto_calc_somo->setPalette (PALET_NORMAL);
  AUTFBACK (cb_auto_calc_somo);
  connect (cb_auto_calc_somo, SIGNAL (clicked ()), this,
           SLOT (set_auto_calc_somo ()));

  cb_auto_show_hydro = new QCheckBox (this);
  cb_auto_show_hydro->setText (
      us_tr (" Automatically show hydrodynamic calculations"));
  cb_auto_show_hydro->setEnabled (true);
  cb_auto_show_hydro->setChecked ((*advanced_config).auto_show_hydro);
  cb_auto_show_hydro->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  cb_auto_show_hydro->setPalette (PALET_NORMAL);
  AUTFBACK (cb_auto_show_hydro);
  connect (cb_auto_show_hydro, SIGNAL (clicked ()), this,
           SLOT (set_auto_show_hydro ()));

#if defined(DEBUG_CTLS)
  cb_pbr_broken_logic = new QCheckBox (this);
  cb_pbr_broken_logic->setText (
      us_tr (" Enable logic for broken chains with peptide bond rule"));
  cb_pbr_broken_logic->setEnabled (true);
  cb_pbr_broken_logic->setChecked ((*advanced_config).pbr_broken_logic);
  cb_pbr_broken_logic->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_pbr_broken_logic->setPalette (PALET_NORMAL);
  AUTFBACK (cb_pbr_broken_logic);
  connect (cb_pbr_broken_logic, SIGNAL (clicked ()), this,
           SLOT (set_pbr_broken_logic ()));
#endif
  ...
  cb_use_sounds->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cb_expert_mode->setText (us_tr (" Expert mode (skip some warning messages, "
                                  "add some developmental features)"));
  cb_expert_mode->setEnabled (true);
  cb_expert_mode->setChecked ((*advanced_config).expert_mode);
  cb_expert_mode->setFont (QFont (USglobal->config_list.fontFamily,
                                  USglobal->config_list.fontSize));
  cb_expert_mode->setPalette (PALET_NORMAL);
  AUTFBACK (cb_expert_mode);
  connect (cb_expert_mode, SIGNAL (clicked ()), this,
           SLOT (set_expert_mode ()));

  cb_experimental_renum = new QCheckBox (this);
  cb_experimental_renum->setText (
      us_tr (" Renumber PDB residues on load (experimental)"));
  cb_experimental_renum->setEnabled (true);
  cb_experimental_renum->setChecked ((*advanced_config).experimental_renum);
  cb_experimental_renum->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  cb_experimental_renum->setPalette (PALET_NORMAL);
  AUTFBACK (cb_experimental_renum);
  connect (cb_experimental_renum, SIGNAL (clicked ()), this,
           SLOT (set_experimental_renum ()));

  lbl_temp_dir_threshold_mb = new QLabel (
      us_tr ("Temporary directory clear size threshold [MB]:"), this);
  lbl_temp_dir_threshold_mb->setAlignment (Qt::AlignLeft | Qt::AlignVCenter);
  lbl_temp_dir_threshold_mb->setPalette (PALET_LABEL);
  lbl_temp_dir_threshold_mb->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  AUTFBACK (lbl_temp_dir_threshold_mb);

  le_temp_dir_threshold_mb = new QLineEdit (this);
  le_temp_dir_threshold_mb->setObjectName (
      "le_temp_dir_threshold_mb Line Edit");
  le_temp_dir_threshold_mb->setText (
  ...
  le_temp_dir_threshold_mb->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
  {
    QIntValidator *qdv
        = new QIntValidator (1, 10000, le_temp_dir_threshold_mb);
    le_temp_dir_threshold_mb->setValidator (qdv);
  }
  connect (le_temp_dir_threshold_mb, SIGNAL (textChanged (const QString &)),
           SLOT (set_temp_dir_threshold_mb (const QString &)));
  ...
  cb_experimental_threads->setChecked (
      (*advanced_config).experimental_threads);
  cb_experimental_threads->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  cb_experimental_threads->setPalette (PALET_NORMAL);
  AUTFBACK (cb_experimental_threads);
  connect (cb_experimental_threads, SIGNAL (clicked ()), this,
           SLOT (set_experimental_threads ()));
  ...
  cb_debug_1->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_debug_2->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_debug_3->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  cb_debug_4->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  ...
  j++;
  background->addWidget (cb_auto_calc_somo, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
  j++;
  background->addWidget (cb_auto_show_hydro, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
  j++;
...
#if defined(DEBUG_CTLS)
  background->addWidget (cb_pbr_broken_logic, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
  j++;
#endif
  ...
  j++;
  background->addWidget (cb_experimental_renum, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
  j++;
#if defined(DEBUG_CTLS)
  background->addWidget (cb_experimental_threads, j, 0, 1 + (j) - (j),
                         1 + (1) - (0));
  j++;
...
void
US_Hydrodyn_AdvancedConfig::cancel ()
{
  close ();
}

void
US_Hydrodyn_AdvancedConfig::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_AdvancedConfig::closeEvent (QCloseEvent *e)
{
  *advanced_config_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_AdvancedConfig::set_auto_view_pdb ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_scroll_editor ()
{
  (*advanced_config).scroll_editor = cb_scroll_editor->isChecked ();
  ((US_Hydrodyn *)us_hydrodyn)
      ->editor->setWordWrapMode (cb_scroll_editor->isChecked ()
                                     ? QTextOption::NoWrap
...
void
US_Hydrodyn_AdvancedConfig::set_auto_calc_somo ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_auto_show_hydro ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_pbr_broken_logic ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_use_sounds ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_expert_mode ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_experimental_threads ()
{
  (*advanced_config).experimental_threads
      = cb_experimental_threads->isChecked ();
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_AdvancedConfig::set_experimental_renum ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_temp_dir_threshold_mb (const QString &str)
{
  (*advanced_config).temp_dir_threshold_mb = str.toInt ();
  qDebug () << "threshold mb set to " << str << " " << str.toInt () << " "
            << advanced_config->temp_dir_threshold_mb;
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_AdvancedConfig::set_debug_1 ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_debug_2 ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_debug_3 ()
{
...
void
US_Hydrodyn_AdvancedConfig::set_debug_4 ()
{
