...
void US_Hydrodyn_SasOptionsMisc::setupGUI() {
  ...
  pb_default_atom_filename->setFont(QFont(USglobal->config_list.fontFamily,
  ...
  le_default_atom_filename->setFont(
  ...
  le_default_saxs_filename->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_default_ff_filename->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_iqq_ask_target_grid->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_iqq_expt_data_contains_variances->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_disable_nnls_scaling->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_iqq_scale_chi2_fitting->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  (*saxs_options).iqq_scale_minq ? le_iqq_scale_minq->setText(QString("%1").arg(
  ...
  (*saxs_options).iqq_scale_maxq ? le_iqq_scale_maxq->setText(QString("%1").arg(
  ...
  cb_trunc_pr_dmax_target->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_guinier_mwc_mw_per_N =
      new QLabel(us_tr(" Protein average MW per residue (for MW[C])): "), this);
  ...
  le_guinier_mwc_mw_per_N->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...
void US_Hydrodyn_SasOptionsMisc::cancel() { close(); }
...
void US_Hydrodyn_SasOptionsMisc::update_guinier_mwc_mw_per_N(
    const QString &str) {
  ((US_Hydrodyn *)us_hydrodyn)->gparams["guinier_mwc_mw_per_N"] =
...
void US_Hydrodyn_SasOptionsMisc::set_use_iq_target_ev() {
  ...
  if (!cb_use_iq_target_ev->isChecked() &&
    ...
    QMessageBox::information(
        this, us_tr("US-SOMO SAS Miscellaneous Options - Reset target scaling"),
        QString(us_tr("The Excluded Volume Scaling which was %1 has been reset "
                      "to 1.0"))
