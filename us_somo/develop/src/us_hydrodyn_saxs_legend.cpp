...
void
US_Hydrodyn_Saxs::plot_saxs_clicked (long
      ...
      if (plot_saxs_zoomer != 0)
        {
          ...
          editor_msg ("black",
                      QString (us_tr ("Currently visible %1 points in "
                                      "(%2:%3), s.d. average %4 %"))
                          .arg (count)
                          .arg (minx)
                          .arg (maxx)
...
void
US_Hydrodyn_Saxs::plot_saxs_item_clicked (
...
void
US_Hydrodyn_Saxs::plot_pr_clicked (long
#if QT_VERSION < 0x040000
                                       key
#endif
)
...
void
US_Hydrodyn_Saxs::plot_pr_item_clicked (
#if QT_VERSION >= 0x050000 || QT_VERSION < 0x040000
    const QVariant &iteminfo, int /* index */
#else
    QwtPlotItem *
...
void
US_Hydrodyn_Saxs::set_saxs_legend ()
{
#if QT_VERSION >= 0x040000
  if (saxs_legend_vis)
    {
...
void
US_Hydrodyn_Saxs::set_pr_legend ()
{
#if QT_VERSION >= 0x040000
  if (pr_legend_vis)
    {
