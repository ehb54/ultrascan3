...
void
US_Hydrodyn_SasOptionsCurve::setupGUI ()
{
  int minHeight1 = 30;
  lbl_info
      = new QLabel (us_tr ("US-SOMO SAS Curve Generation Options:"), this);
  ...
  cnt_wavelength->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cnt_start_angle->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cnt_end_angle->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize));
  ...
  cnt_delta_angle->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  ...
  cnt_start_q->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cnt_end_q->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize));
  cnt_end_q->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_end_q);
  connect (cnt_end_q, SIGNAL (valueChanged (double)),
           SLOT (update_end_q (double)));
  ...
  cnt_delta_q->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  cb_normalize_by_mw->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
...
void
US_Hydrodyn_SasOptionsCurve::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsCurve::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsCurve::closeEvent (QCloseEvent *e)
{
  *sas_options_curve_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsCurve::update_wavelength (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::update_start_angle (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::update_end_angle (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::update_delta_angle (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::update_q ()
{
...
void
US_Hydrodyn_SasOptionsCurve::update_start_q (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::update_end_q (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::update_delta_q (double val)
{
...
void
US_Hydrodyn_SasOptionsCurve::set_normalize_by_mw ()
{
