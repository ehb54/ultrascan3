...
bool US_Hydrodyn_Dad::gg_fit_vector(
                                          vector < double > & fit,
                                          vector < double > & pfit
                                          )
{
   ...
   double alpha        = 
      ...
      ? ( ( US_Hydrodyn * ) us_hydrodyn )->gparams[ "dad_cormap_alpha" ].toDouble() * 5e0 
      : 0.05;
...
bool US_Hydrodyn_Dad::pvalue( const vector < double > &q, vector < double > &I, vector < double > &G, double &P, QString &errormsg ) {
   errormsg = "";
...
bool US_Hydrodyn_Dad::pvalue( const QString & file, double &P, QString &errormsg ) {
   errormsg = "";
