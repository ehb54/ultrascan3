    ...
    : QDialog (p)
{
  ...
  setWindowTitle (us_tr ("US-SOMO: HPLC/KIN : Concentration Detector"));
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::setupGUI ()
{
  int minHeight1 = 30;

  lbl_title = new QLabel (us_tr ("US-SOMO: HPLC/KIN : Concentration Detector"),
                          this);
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::quit ()
{
  close ();
}

void
US_Hydrodyn_Saxs_Hplc_Dctr::save ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::keep ()
{
  (*parameters)["keep"] = "set";
  close ();
}
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::closeEvent (QCloseEvent *e)
{
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::set_uv ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::set_ri ()
{
...
void
US_Hydrodyn_Saxs_Hplc_Dctr::uv_conv_text (const QString &text)
{
  (*parameters)["uv_conv"] = text;
}

void
US_Hydrodyn_Saxs_Hplc_Dctr::ri_conv_text (const QString &text)
{
