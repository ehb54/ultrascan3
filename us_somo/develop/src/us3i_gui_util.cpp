...
int
US3i_GuiUtil::save_plot (const QString &filename, const QwtPlot *plot)
{
  int status = 0;
...
// Save SVG file
int
US3i_GuiUtil::save_svg (const QString &filename, const QwtPlot *plot)
{
  int status = 0;
...
// Save PNG file
int
US3i_GuiUtil::save_png (const QString &filename, const QwtPlot *plot)
{
  int status = 0;
