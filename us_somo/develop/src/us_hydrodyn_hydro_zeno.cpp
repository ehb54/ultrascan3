...
void US_Hydrodyn_Hydro_Zeno::setupGUI() {
  ...
  lbl_info =
      new QLabel(us_tr("SOMO Hydrodynamic Calculation Zeno Options:"), this);
  ...
  le_zeno_interior_steps->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  lbl_zeno_surface_thickness->setFont(QFont(USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize - 1,
                                            QFont::Bold));
  ...
  le_zeno_surface_thickness->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  cb_zeno_surface_thickness_from_rg->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_zeno_surface_thickness_from_rg_a->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_zeno_surface_thickness_from_rg_b->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  ...
  le_zeno_surface_thickness_from_rg_c->setFont(
      QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
...
void US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness_from_rg_a(
    const QString &str) {
  (*hydro).zeno_surface_thickness_from_rg_a = str.toFloat();
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness_from_rg_b(
    const QString &str) {
  (*hydro).zeno_surface_thickness_from_rg_b = str.toFloat();
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness_from_rg_c(
    const QString &str) {
...
void US_Hydrodyn_Hydro_Zeno::cancel() { close(); }
