...
void
US_Hydrodyn_Hydro_Zeno::setupGUI ()
{
  int minHeight1 = 30;
  QString str;

  lbl_info = new QLabel (us_tr ("SOMO Hydrodynamic Calculation Zeno Options:"),
                         this);
  ...
  cb_zeno_zeno->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  lbl_zeno_zeno_steps->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));

  le_zeno_zeno_steps = new QLineEdit (this);
  le_zeno_zeno_steps->setObjectName ("Zeno_Zeno_Steps Line Edit");
  ...
  le_zeno_zeno_steps->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize));
  connect (le_zeno_zeno_steps, SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_zeno_steps (const QString &)));

  cb_zeno_max_cap = new QCheckBox (this);
  cb_zeno_max_cap->setText (us_tr ("Early termination:"));
  cb_zeno_max_cap->setEnabled (true);
  cb_zeno_max_cap->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("zeno_max_cap")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_max_cap"] == "true");
  cb_zeno_max_cap->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  cb_zeno_max_cap->setPalette (PALET_NORMAL);
  AUTFBACK (cb_zeno_max_cap);
  connect (cb_zeno_max_cap, SIGNAL (clicked ()), this,
           SLOT (set_zeno_max_cap ()));

  lbl_zeno_max_cap
      = new QLabel (us_tr (" Stokes Radius S.D./Mean in percent:"), this);
  ...
  lbl_zeno_max_cap->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1,
                                    QFont::Bold));

  le_zeno_max_cap = new QLineEdit (this);
  le_zeno_max_cap->setObjectName ("Zeno_Max_Cap Line Edit");
  le_zeno_max_cap->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_max_cap_pct"]);
  le_zeno_max_cap->setAlignment (Qt::AlignVCenter);
  le_zeno_max_cap->setPalette (PALET_NORMAL);
  AUTFBACK (le_zeno_max_cap);
  le_zeno_max_cap->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  {
    QDoubleValidator *qdv
        = new QDoubleValidator (0.01, 10, 2, le_zeno_max_cap);
    le_zeno_max_cap->setValidator (qdv);
  }
  connect (le_zeno_max_cap, SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_max_cap (const QString &)));
  ...
  cb_zeno_interior->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize));
  cb_zeno_interior->setPalette (PALET_NORMAL);
  AUTFBACK (cb_zeno_interior);
  connect (cb_zeno_interior, SIGNAL (clicked ()), this,
           SLOT (set_zeno_interior ()));

  lbl_zeno_interior_steps
      = new QLabel (us_tr (" Interior Steps (Thousands):"), this);
  ...
  lbl_zeno_interior_steps->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize - 1,
                                           QFont::Bold));

  le_zeno_interior_steps = new QLineEdit (this);
  le_zeno_interior_steps->setObjectName ("Zeno_Interior_Steps Line Edit");
  le_zeno_interior_steps->setText (
      str.sprintf ("%u", (*hydro).zeno_interior_steps));
  ...
  le_zeno_interior_steps->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  connect (le_zeno_interior_steps, SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_interior_steps (const QString &)));
  ...
  cb_zeno_surface->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  cb_zeno_surface->setPalette (PALET_NORMAL);
  AUTFBACK (cb_zeno_surface);
  connect (cb_zeno_surface, SIGNAL (clicked ()), this,
           SLOT (set_zeno_surface ()));

  lbl_zeno_surface_steps
      = new QLabel (us_tr (" Surface Steps (Thousands):"), this);
  ...
  lbl_zeno_surface_steps->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize - 1,
                                          QFont::Bold));

  le_zeno_surface_steps = new QLineEdit (this);
  le_zeno_surface_steps->setObjectName ("Zeno_Surface_Steps Line Edit");
  le_zeno_surface_steps->setText (
      str.sprintf ("%u", (*hydro).zeno_surface_steps));
  ...
  le_zeno_surface_steps->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
  connect (le_zeno_surface_steps, SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_surface_steps (const QString &)));

  lbl_zeno_surface_thickness
      = new QLabel (us_tr (" Skin Thickness (current units):"), this);
  ...
  lbl_zeno_surface_thickness->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_zeno_surface_thickness = new QLineEdit (this);
  le_zeno_surface_thickness->setObjectName ("Zeno_Skin_Thickness Line Edit");
  le_zeno_surface_thickness->setText (
      str.sprintf ("%.3f", (*hydro).zeno_surface_thickness));
  ...
  le_zeno_surface_thickness->setFont (QFont (USglobal->config_list.fontFamily,
                                             USglobal->config_list.fontSize));
  connect (le_zeno_surface_thickness, SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_surface_thickness (const QString &)));

  cb_zeno_surface_thickness_from_rg = new QCheckBox (this);
  cb_zeno_surface_thickness_from_rg->setText (
      us_tr ("Compute Skin Thickness from sigmoid fit of Rg-dependence:"));
  cb_zeno_surface_thickness_from_rg->setEnabled (true);
  cb_zeno_surface_thickness_from_rg->setChecked (
      (*hydro).zeno_surface_thickness_from_rg);
  cb_zeno_surface_thickness_from_rg->setFont (QFont (
  ...
  connect (cb_zeno_surface_thickness_from_rg, SIGNAL (clicked ()), this,
           SLOT (set_zeno_surface_thickness_from_rg ()));

  lbl_zeno_surface_thickness_from_rg_a = new QLabel (
      us_tr ("Skin Thickness from sigmoid fit of Rg-dep. coeff. a:"), this);
  lbl_zeno_surface_thickness_from_rg_a->setAlignment (Qt::AlignLeft
                                                      | Qt::AlignVCenter);
  lbl_zeno_surface_thickness_from_rg_a->setPalette (PALET_LABEL);
  AUTFBACK (lbl_zeno_surface_thickness_from_rg_a);
  lbl_zeno_surface_thickness_from_rg_a->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_zeno_surface_thickness_from_rg_a = new QLineEdit (this);
  le_zeno_surface_thickness_from_rg_a->setObjectName (
      "Zeno_Skin_Thickness_From_Rg_A Line Edit");
  le_zeno_surface_thickness_from_rg_a->setText (
      str.sprintf ("%.4f", (*hydro).zeno_surface_thickness_from_rg_a));
  ...
  le_zeno_surface_thickness_from_rg_a->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  connect (le_zeno_surface_thickness_from_rg_a,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_surface_thickness_from_rg_a (const QString &)));

  lbl_zeno_surface_thickness_from_rg_b = new QLabel (
      us_tr ("Skin Thickness from sigmoid fit of Rg-dep. coeff. b:"), this);
  lbl_zeno_surface_thickness_from_rg_b->setAlignment (Qt::AlignLeft
                                                      | Qt::AlignVCenter);
  lbl_zeno_surface_thickness_from_rg_b->setPalette (PALET_LABEL);
  AUTFBACK (lbl_zeno_surface_thickness_from_rg_b);
  lbl_zeno_surface_thickness_from_rg_b->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_zeno_surface_thickness_from_rg_b = new QLineEdit (this);
  le_zeno_surface_thickness_from_rg_b->setObjectName (
      "Zeno_Skin_Thickness_From_Rg_B Line Edit");
  le_zeno_surface_thickness_from_rg_b->setText (
      str.sprintf ("%.4f", (*hydro).zeno_surface_thickness_from_rg_b));
  ...
  le_zeno_surface_thickness_from_rg_b->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  connect (le_zeno_surface_thickness_from_rg_b,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_surface_thickness_from_rg_b (const QString &)));

  lbl_zeno_surface_thickness_from_rg_c = new QLabel (
      us_tr ("Skin Thickness from sigmoid fit of Rg-dep. coeff. c:"), this);
  lbl_zeno_surface_thickness_from_rg_c->setAlignment (Qt::AlignLeft
                                                      | Qt::AlignVCenter);
  lbl_zeno_surface_thickness_from_rg_c->setPalette (PALET_LABEL);
  AUTFBACK (lbl_zeno_surface_thickness_from_rg_c);
  lbl_zeno_surface_thickness_from_rg_c->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  le_zeno_surface_thickness_from_rg_c = new QLineEdit (this);
  le_zeno_surface_thickness_from_rg_c->setObjectName (
      "Zeno_Skin_Thickness_From_Rg_C Line Edit");
  le_zeno_surface_thickness_from_rg_c->setText (
      str.sprintf ("%.4f", (*hydro).zeno_surface_thickness_from_rg_c));
  ...
  le_zeno_surface_thickness_from_rg_c->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  connect (le_zeno_surface_thickness_from_rg_c,
           SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_surface_thickness_from_rg_c (const QString &)));

  cb_zeno_cxx = new QCheckBox (this);
  cb_zeno_cxx->setText (us_tr ("Test experimental new Zeno version"));
  cb_zeno_cxx->setEnabled (true);
  cb_zeno_cxx->setChecked (
      ((US_Hydrodyn *)us_hydrodyn)->gparams.count ("zeno_cxx")
      && ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_cxx"] == "true");
  cb_zeno_cxx->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize));
  ...
  lbl_zeno_repeats->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1,
                                    QFont::Bold));

  le_zeno_repeats = new QLineEdit (this);
  le_zeno_repeats->setObjectName ("Zeno_Repeats Line Edit");
  le_zeno_repeats->setText (
      ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_repeats"]);
  le_zeno_repeats->setAlignment (Qt::AlignVCenter);
  le_zeno_repeats->setPalette (PALET_NORMAL);
  AUTFBACK (le_zeno_repeats);
  le_zeno_repeats->setFont (QFont (USglobal->config_list.fontFamily,
                                   USglobal->config_list.fontSize));
  connect (le_zeno_repeats, SIGNAL (textChanged (const QString &)),
           SLOT (update_zeno_repeats (const QString &)));
...
void
US_Hydrodyn_Hydro_Zeno::set_zeno_zeno ()
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_zeno_steps (const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::set_zeno_max_cap ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_max_cap"]
      = (cb_zeno_max_cap->isChecked () ? "true" : "false");
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
  update_enables ();
}

void
US_Hydrodyn_Hydro_Zeno::update_zeno_max_cap (const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::set_zeno_interior ()
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_interior_steps (const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::set_zeno_surface ()
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_surface_steps (const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness (const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::set_zeno_surface_thickness_from_rg ()
{
  (*hydro).zeno_surface_thickness_from_rg
      = cb_zeno_surface_thickness_from_rg->isChecked ();
  update_enables ();
}

void
US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness_from_rg_a (
    const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness_from_rg_b (
    const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_surface_thickness_from_rg_c (
    const QString &str)
{
...
void
US_Hydrodyn_Hydro_Zeno::update_zeno_repeats (const QString &str)
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_repeats"]
      = QString ("%1").arg (str.toUInt ());
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
}

void
US_Hydrodyn_Hydro_Zeno::set_zeno_cxx ()
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["zeno_cxx"]
      = cb_zeno_cxx->isChecked () ? "true" : "false";
...
void
US_Hydrodyn_Hydro_Zeno::cancel ()
{
  close ();
}

void
US_Hydrodyn_Hydro_Zeno::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_Hydro_Zeno::closeEvent (QCloseEvent *e)
{
  *hydro_zeno_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_Hydro_Zeno::update_enables ()
{
  ...
  le_zeno_surface_thickness->setEnabled (
      !cb_zeno_surface_thickness_from_rg->isChecked ());
  le_zeno_surface_thickness_from_rg_a->setEnabled (
      cb_zeno_surface_thickness_from_rg->isChecked ());
  le_zeno_surface_thickness_from_rg_b->setEnabled (
      cb_zeno_surface_thickness_from_rg->isChecked ());
  le_zeno_surface_thickness_from_rg_c->setEnabled (
      cb_zeno_surface_thickness_from_rg->isChecked ());
}
