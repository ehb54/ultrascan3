...
long US_Saxs_Util::nsa_min_gsm_5_1(our_vector *i, double epsilon,
                                   long max_iter) {
...
long US_Saxs_Util::nsa_min_fr_pr_cgd(our_vector *i, double epsilon,
                                     long max_iter) {
...
long US_Saxs_Util::nsa_min_hessian_bfgs(our_vector *ip, double epsilon,
                                        long max_iter) {
#if defined(SHOW_TIMING)
  struct timeval tv1, tv2;
#endif
