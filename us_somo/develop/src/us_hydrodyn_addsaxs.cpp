...
US_AddSaxs::US_AddSaxs (bool *widget_flag, QWidget *p, const char *)
    : QWidget (p)
{
...
US_AddSaxs::setupGUI ()
{
  ...
  pb_select_file->setFont (QFont (USglobal->config_list.fontFamily,
  ...
  cmb_saxs = new QComboBox (this);
  cmb_saxs->setObjectName ("SAXS Entry Listing");
  cmb_saxs->setPalette (PALET_NORMAL);
  AUTFBACK (cmb_saxs);
  cmb_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                            USglobal->config_list.fontSize));
  ...
  lbl_number_of_saxs
      = new QLabel (us_tr (" Number of SAXS Entries in File: 0"), this);
  ...
  lbl_number_of_saxs->setFont (QFont (USglobal->config_list.fontFamily,
                                      USglobal->config_list.fontSize - 1,
                                      QFont::Bold));
  ...
  lbl_saxs_name->setFont (QFont (USglobal->config_list.fontFamily,
                                 USglobal->config_list.fontSize - 1,
                                 QFont::Bold));

  le_saxs_name = new QLineEdit (this);
  le_saxs_name->setObjectName ("SAXS name Line Edit");
  le_saxs_name->setPalette (PALET_NORMAL);
  AUTFBACK (le_saxs_name);
  le_saxs_name->setFont (QFont (USglobal->config_list.fontFamily,
                                USglobal->config_list.fontSize));
  le_saxs_name->setMinimumHeight (minHeight1);
  connect (le_saxs_name, SIGNAL (textChanged (const QString &)),
           SLOT (update_saxs_name (const QString &)));
  ...
  AUTFBACK (lbl_4term);
  lbl_4term->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  AUTFBACK (lbl_5term);
  lbl_5term->setFont (QFont (USglobal->config_list.fontFamily,
                             USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  AUTFBACK (lbl_a1);
  lbl_a1->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_a1 = new QLineEdit (this);
  le_a1->setObjectName ("Coefficient a(1) Line Edit");
  le_a1->setPalette (PALET_NORMAL);
  AUTFBACK (le_a1);
  le_a1->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_a1->setMinimumHeight (minHeight1);
  connect (le_a1, SIGNAL (textChanged (const QString &)),
           SLOT (update_a1 (const QString &)));
  ...
  AUTFBACK (lbl_a2);
  lbl_a2->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_a2 = new QLineEdit (this);
  le_a2->setObjectName ("Coefficient a(2) Line Edit");
  le_a2->setPalette (PALET_NORMAL);
  AUTFBACK (le_a2);
  le_a2->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_a2->setMinimumHeight (minHeight1);
  connect (le_a2, SIGNAL (textChanged (const QString &)),
           SLOT (update_a2 (const QString &)));
  ...
  AUTFBACK (lbl_a3);
  lbl_a3->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_a3 = new QLineEdit (this);
  le_a3->setObjectName ("Coefficient a(3) Line Edit");
  le_a3->setPalette (PALET_NORMAL);
  AUTFBACK (le_a3);
  le_a3->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_a3->setMinimumHeight (minHeight1);
  connect (le_a3, SIGNAL (textChanged (const QString &)),
           SLOT (update_a3 (const QString &)));
  ...
  AUTFBACK (lbl_a4);
  lbl_a4->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_a4 = new QLineEdit (this);
  le_a4->setObjectName ("Coefficient a(4) Line Edit");
  le_a4->setPalette (PALET_NORMAL);
  AUTFBACK (le_a4);
  le_a4->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_a4->setMinimumHeight (minHeight1);
  connect (le_a4, SIGNAL (textChanged (const QString &)),
           SLOT (update_a4 (const QString &)));
  ...
  AUTFBACK (lbl_a5);
  lbl_a5->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  AUTFBACK (lbl_b1);
  lbl_b1->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_b1 = new QLineEdit (this);
  le_b1->setObjectName ("Coefficient b(1) Line Edit");
  le_b1->setPalette (PALET_NORMAL);
  AUTFBACK (le_b1);
  le_b1->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_b1->setMinimumHeight (minHeight1);
  connect (le_b1, SIGNAL (textChanged (const QString &)),
           SLOT (update_b1 (const QString &)));
  ...
  AUTFBACK (lbl_b2);
  lbl_b2->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_b2 = new QLineEdit (this);
  le_b2->setObjectName ("Coefficient b(2) Line Edit");
  le_b2->setPalette (PALET_NORMAL);
  AUTFBACK (le_b2);
  le_b2->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_b2->setMinimumHeight (minHeight1);
  connect (le_b2, SIGNAL (textChanged (const QString &)),
           SLOT (update_b2 (const QString &)));
  ...
  AUTFBACK (lbl_b3);
  lbl_b3->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_b3 = new QLineEdit (this);
  le_b3->setObjectName ("Coefficient b(3) Line Edit");
  le_b3->setPalette (PALET_NORMAL);
  AUTFBACK (le_b3);
  le_b3->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_b3->setMinimumHeight (minHeight1);
  connect (le_b3, SIGNAL (textChanged (const QString &)),
           SLOT (update_b3 (const QString &)));
  ...
  AUTFBACK (lbl_b4);
  lbl_b4->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_b4 = new QLineEdit (this);
  le_b4->setObjectName ("Coefficient b(4) Line Edit");
  le_b4->setPalette (PALET_NORMAL);
  AUTFBACK (le_b4);
  le_b4->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_b4->setMinimumHeight (minHeight1);
  connect (le_b4, SIGNAL (textChanged (const QString &)),
           SLOT (update_b4 (const QString &)));
  ...
  AUTFBACK (lbl_b5);
  lbl_b5->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));
  ...
  AUTFBACK (lbl_c);
  lbl_c->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 1, QFont::Bold));

  le_c = new QLineEdit (this);
  le_c->setObjectName ("Coefficient c Line Edit");
  le_c->setPalette (PALET_NORMAL);
  AUTFBACK (le_c);
  le_c->setFont (QFont (USglobal->config_list.fontFamily,
                        USglobal->config_list.fontSize));
  le_c->setMinimumHeight (minHeight1);
  connect (le_c, SIGNAL (textChanged (const QString &)),
           SLOT (update_c (const QString &)));
  ...
  le_volume->setObjectName ("Atomic Volume Line Edit");
  ...
  le_5a1 = new QLineEdit (this);
  le_5a1->setObjectName ("Coefficient a(1) Line Edit");
  le_5a1->setPalette (PALET_NORMAL);
  AUTFBACK (le_5a1);
  le_5a1->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5a1->setMinimumHeight (minHeight1);
  connect (le_5a1, SIGNAL (textChanged (const QString &)),
           SLOT (update_5a1 (const QString &)));

  le_5a2 = new QLineEdit (this);
  le_5a2->setObjectName ("Coefficient a(1) Line Edit");
  le_5a2->setPalette (PALET_NORMAL);
  AUTFBACK (le_5a2);
  le_5a2->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5a2->setMinimumHeight (minHeight1);
  connect (le_5a2, SIGNAL (textChanged (const QString &)),
           SLOT (update_5a2 (const QString &)));

  le_5a3 = new QLineEdit (this);
  le_5a3->setObjectName ("Coefficient a(1) Line Edit");
  le_5a3->setPalette (PALET_NORMAL);
  AUTFBACK (le_5a3);
  le_5a3->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5a3->setMinimumHeight (minHeight1);
  connect (le_5a3, SIGNAL (textChanged (const QString &)),
           SLOT (update_5a3 (const QString &)));

  le_5a4 = new QLineEdit (this);
  le_5a4->setObjectName ("Coefficient a(1) Line Edit");
  le_5a4->setPalette (PALET_NORMAL);
  AUTFBACK (le_5a4);
  le_5a4->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5a4->setMinimumHeight (minHeight1);
  connect (le_5a4, SIGNAL (textChanged (const QString &)),
           SLOT (update_5a4 (const QString &)));

  le_5a5 = new QLineEdit (this);
  le_5a5->setObjectName ("Coefficient a(1) Line Edit");
  le_5a5->setPalette (PALET_NORMAL);
  AUTFBACK (le_5a5);
  le_5a5->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5a5->setMinimumHeight (minHeight1);
  connect (le_5a5, SIGNAL (textChanged (const QString &)),
           SLOT (update_5a5 (const QString &)));

  le_5b1 = new QLineEdit (this);
  le_5b1->setObjectName ("Coefficient a(1) Line Edit");
  le_5b1->setPalette (PALET_NORMAL);
  AUTFBACK (le_5b1);
  le_5b1->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5b1->setMinimumHeight (minHeight1);
  connect (le_5b1, SIGNAL (textChanged (const QString &)),
           SLOT (update_5b1 (const QString &)));

  le_5b2 = new QLineEdit (this);
  le_5b2->setObjectName ("Coefficient a(1) Line Edit");
  le_5b2->setPalette (PALET_NORMAL);
  AUTFBACK (le_5b2);
  le_5b2->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5b2->setMinimumHeight (minHeight1);
  connect (le_5b2, SIGNAL (textChanged (const QString &)),
           SLOT (update_5b2 (const QString &)));

  le_5b3 = new QLineEdit (this);
  le_5b3->setObjectName ("Coefficient a(1) Line Edit");
  le_5b3->setPalette (PALET_NORMAL);
  AUTFBACK (le_5b3);
  le_5b3->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5b3->setMinimumHeight (minHeight1);
  connect (le_5b3, SIGNAL (textChanged (const QString &)),
           SLOT (update_5b3 (const QString &)));

  le_5b4 = new QLineEdit (this);
  le_5b4->setObjectName ("Coefficient a(1) Line Edit");
  le_5b4->setPalette (PALET_NORMAL);
  AUTFBACK (le_5b4);
  le_5b4->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5b4->setMinimumHeight (minHeight1);
  connect (le_5b4, SIGNAL (textChanged (const QString &)),
           SLOT (update_5b4 (const QString &)));

  le_5b5 = new QLineEdit (this);
  le_5b5->setObjectName ("Coefficient a(1) Line Edit");
  le_5b5->setPalette (PALET_NORMAL);
  AUTFBACK (le_5b5);
  le_5b5->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize));
  le_5b5->setMinimumHeight (minHeight1);
  connect (le_5b5, SIGNAL (textChanged (const QString &)),
           SLOT (update_5b5 (const QString &)));

  le_5c = new QLineEdit (this);
  le_5c->setObjectName ("Coefficient c Line Edit");
  le_5c->setPalette (PALET_NORMAL);
  AUTFBACK (le_5c);
  le_5c->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize));
  le_5c->setMinimumHeight (minHeight1);
  connect (le_5c, SIGNAL (textChanged (const QString &)),
           SLOT (update_5c (const QString &)));

  le_5volume = new QLineEdit (this);
  le_5volume->setObjectName ("Atomic Volume Line Edit");
  le_5volume->setPalette (PALET_NORMAL);
  AUTFBACK (le_5volume);
  le_5volume->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize));
  le_5volume->setMinimumHeight (minHeight1);
  connect (le_5volume, SIGNAL (textChanged (const QString &)),
           SLOT (update_5volume (const QString &)));
...
US_AddSaxs::add ()
{
  ...
  for (int i = 0; i < (int)saxs_list.size (); i++)
    {
      if (saxs_list[i].saxs_name.toUpper ()
          == current_saxs.saxs_name.toUpper ())
        {
          item = i;
  ...
  if (f.open (QIODevice::WriteOnly | QIODevice::Text))
    {
      cmb_saxs->clear ();
      str1 = QString (us_tr (" Number of SAXS Entries in File: %1"))
                 .arg (saxs_list.size ());
      QTextStream ts (&f);
      ts << qSetRealNumberPrecision (8);
      for (unsigned int i = 0; i < saxs_list.size (); i++)
        {
          ts << saxs_list[i].saxs_name.toUpper () << "\t" << saxs_list[i].a[0]
             << "\t" << saxs_list[i].b[0] << "\t" << saxs_list[i].a[1] << "\t"
             << saxs_list[i].b[1] << "\t" << saxs_list[i].a[2] << "\t"
             << saxs_list[i].b[2] << "\t" << saxs_list[i].a[3] << "\t"
             << saxs_list[i].b[3] << "\t" << saxs_list[i].c << "\t"
             << saxs_list[i].volume << Qt::endl;
          if (saxs_list[i].a5[0] && saxs_list[i].b5[0])
            {
              ts << saxs_list[i].saxs_name.toUpper () << "\t"
                 << saxs_list[i].a5[0] << "\t" << saxs_list[i].b5[0] << "\t"
                 << saxs_list[i].a5[1] << "\t" << saxs_list[i].b5[1] << "\t"
                 << saxs_list[i].a5[2] << "\t" << saxs_list[i].b5[2] << "\t"
                 << saxs_list[i].a5[3] << "\t" << saxs_list[i].b5[3] << "\t"
                 << saxs_list[i].a5[4] << "\t" << saxs_list[i].b5[4] << "\t"
                 << saxs_list[i].c5 << "\t" << saxs_list[i].volume << Qt::endl;
            }
          str1.sprintf ("%d: ", i + 1);
      ...
      f.close ();
      lbl_number_of_saxs->setText (
          QString (us_tr (" Number of SAXS Entries in File: %1"))
              .arg (saxs_list.size ()));
    }
  else
    {
      US_Static::us_message ("Attention:",
                             "Could not open the SAXS Coefficient file:\n\n"
                                 + saxs_filename);
    }
}

void
US_AddSaxs::select_file ()
{
  ...
  if (saxs_filename.isEmpty ())
  ...
  else
    {
      ...
      for (auto it = saxs_map.begin (); it != saxs_map.end (); ++it)
        {
          if (!it->first.isEmpty ())
            {
...
void
US_AddSaxs::info_saxs (const QString &msg, const struct saxs &saxs)
{
  TSO << LEQ << "info_saxs(): " << saxs.saxs_name << " " << msg << Qt::endl;
  TSO << LD << "4 term gaussians:\n";
  for (int i = 0; i < 4; ++i)
    {
      TSO << "\ta & b [" << i << "] = " << saxs.a[i] << " & " << saxs.b[i]
          << Qt::endl;
    }
...
void
US_AddSaxs::update_saxs_name (const QString &str)
{
  current_saxs.saxs_name = str;
}

void
US_AddSaxs::update_a1 (const QString &str)
{
  current_saxs.a[0] = str.toFloat ();
}

void
US_AddSaxs::update_a2 (const QString &str)
{
  current_saxs.a[1] = str.toFloat ();
}

void
US_AddSaxs::update_a3 (const QString &str)
{
  current_saxs.a[2] = str.toFloat ();
}

void
US_AddSaxs::update_a4 (const QString &str)
{
  current_saxs.a[3] = str.toFloat ();
}

void
US_AddSaxs::update_b1 (const QString &str)
{
  current_saxs.b[0] = str.toFloat ();
}

void
US_AddSaxs::update_b2 (const QString &str)
{
  current_saxs.b[1] = str.toFloat ();
}

void
US_AddSaxs::update_b3 (const QString &str)
{
  current_saxs.b[2] = str.toFloat ();
}

void
US_AddSaxs::update_b4 (const QString &str)
{
  current_saxs.b[3] = str.toFloat ();
}

void
US_AddSaxs::update_c (const QString &str)
{
  current_saxs.c = str.toFloat ();
}

void
US_AddSaxs::update_volume (const QString &str)
{
  current_saxs.volume = str.toFloat ();
}

void
US_AddSaxs::update_5a1 (const QString &str)
{
  current_saxs.a5[0] = str.toFloat ();
}

void
US_AddSaxs::update_5a2 (const QString &str)
{
  current_saxs.a5[1] = str.toFloat ();
}

void
US_AddSaxs::update_5a3 (const QString &str)
{
  current_saxs.a5[2] = str.toFloat ();
}

void
US_AddSaxs::update_5a4 (const QString &str)
{
  current_saxs.a5[3] = str.toFloat ();
}

void
US_AddSaxs::update_5a5 (const QString &str)
{
  current_saxs.a5[4] = str.toFloat ();
}

void
US_AddSaxs::update_5b1 (const QString &str)
{
  current_saxs.b5[0] = str.toFloat ();
}

void
US_AddSaxs::update_5b2 (const QString &str)
{
  current_saxs.b5[1] = str.toFloat ();
}

void
US_AddSaxs::update_5b3 (const QString &str)
{
  current_saxs.b5[2] = str.toFloat ();
}

void
US_AddSaxs::update_5b4 (const QString &str)
{
  current_saxs.b5[3] = str.toFloat ();
}

void
US_AddSaxs::update_5b5 (const QString &str)
{
  current_saxs.b5[4] = str.toFloat ();
}

void
US_AddSaxs::update_5c (const QString &str)
{
  current_saxs.c5 = str.toFloat ();
}

void
US_AddSaxs::update_5volume (const QString &str)
{
  current_saxs.volume = str.toFloat ();
}

void
US_AddSaxs::select_saxs (int val)
{
  QString str;
...
void
US_AddSaxs::closeEvent (QCloseEvent *e)
{
  global_Xpos -= 30;
  global_Ypos -= 30;
