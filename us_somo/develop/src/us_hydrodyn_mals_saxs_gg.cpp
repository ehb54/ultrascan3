...
bool US_Hydrodyn_Mals_Saxs::gg_fit_vector(vector<double> &fit,
                                          vector<double> &pfit) {
  if (!unified_ggaussian_ok) {
...
bool US_Hydrodyn_Mals_Saxs::data_point_window(vector<double> &q,
                                              vector<double> &I) {
...
bool US_Hydrodyn_Mals_Saxs::pvalue(const vector<double> &q, vector<double> &I,
                                   vector<double> &G, double &P,
                                   QString &errormsg) {
  errormsg = "";
...
bool US_Hydrodyn_Mals_Saxs::pvalue(const QString &file, double &P,
                                   QString &errormsg) {
  errormsg = "";
