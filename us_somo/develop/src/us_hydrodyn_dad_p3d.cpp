...
US_Hydrodyn_Dad_P3d::US_Hydrodyn_Dad_P3d(void *us_hydrodyn_dad,
  ...
  setWindowTitle(us_tr("US-SOMO: UV-Vis : Plot 3D"));
...
US_Hydrodyn_Dad_P3d::~US_Hydrodyn_Dad_P3d() {}

void US_Hydrodyn_Dad_P3d::setupGUI() {
  int minHeight1 = 30;

  lbl_title = new QLabel(us_tr("US-SOMO: UV-Vis : Plot 3D"), this);
...
void US_Hydrodyn_Dad_P3d::plot_all() {
  for (unsigned int i = 0; i < (unsigned int)cb_plot_curves.size(); i++) {
...
void US_Hydrodyn_Dad_P3d::quit() { close(); }

void US_Hydrodyn_Dad_P3d::plot() {
...
void US_Hydrodyn_Dad_P3d::help() {
  US_Help *online_help;
  online_help = new US_Help(this);
  online_help->show_help("manual/somo/dad_p3d.html");
}

void US_Hydrodyn_Dad_P3d::closeEvent(QCloseEvent *e) {
  global_Xpos -= 30;
  global_Ypos -= 30;
  e->accept();
}

void US_Hydrodyn_Dad_P3d::update_enables() {
