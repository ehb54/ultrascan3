...
US_Hydrodyn_SasOptionsSaxs::US_Hydrodyn_SasOptionsSaxs (
    struct saxs_options *saxs_options, bool *sas_options_saxs_widget,
...
void
US_Hydrodyn_SasOptionsSaxs::setupGUI ()
{
  ...
  lbl_water_e_density
      = new QLabel (us_tr (" Water electron density (e / A^3): "), this);
  ...
  lbl_water_e_density->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));

  cnt_water_e_density = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_water_e_density);
  cnt_water_e_density->setRange (0, 10);
  cnt_water_e_density->setSingleStep (0.001);
  ...
  cnt_water_e_density->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cnt_water_e_density->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_water_e_density);
  connect (cnt_water_e_density, SIGNAL (valueChanged (double)),
           SLOT (update_water_e_density (double)));
  ...
  lbl_saxs_iq->setFont (QFont (USglobal->config_list.fontFamily,
                               USglobal->config_list.fontSize - 1,
                               QFont::Bold));
  ...
  cb_saxs_iq_native_debye->setFont (QFont (USglobal->config_list.fontFamily,
                                           USglobal->config_list.fontSize));
  cb_saxs_iq_native_debye->setPalette (PALET_NORMAL);
  AUTFBACK (cb_saxs_iq_native_debye);
  connect (cb_saxs_iq_native_debye, SIGNAL (clicked ()), this,
           SLOT (set_saxs_iq_native_debye ()));
  ...
  cb_saxs_iq_native_sh->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_saxs_iq_native_sh->setPalette (PALET_NORMAL);
  AUTFBACK (cb_saxs_iq_native_sh);
  connect (cb_saxs_iq_native_sh, SIGNAL (clicked ()), this,
           SLOT (set_saxs_iq_native_sh ()));
  ...
  if (started_in_expert_mode)
    {
      ...
      cb_saxs_iq_native_hybrid->setChecked (
          (*saxs_options).saxs_iq_native_hybrid);
      cb_saxs_iq_native_hybrid->setFont (QFont (
      ...
      connect (cb_saxs_iq_native_hybrid, SIGNAL (clicked ()), this,
               SLOT (set_saxs_iq_native_hybrid ()));
      ...
      cb_saxs_iq_native_hybrid2->setChecked (
          (*saxs_options).saxs_iq_native_hybrid2);
      cb_saxs_iq_native_hybrid2->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
      cb_saxs_iq_native_hybrid2->setPalette (PALET_NORMAL);
      AUTFBACK (cb_saxs_iq_native_hybrid2);
      connect (cb_saxs_iq_native_hybrid2, SIGNAL (clicked ()), this,
               SLOT (set_saxs_iq_native_hybrid2 ()));
      ...
      cb_saxs_iq_native_hybrid3->setChecked (
          (*saxs_options).saxs_iq_native_hybrid3);
      cb_saxs_iq_native_hybrid3->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
      cb_saxs_iq_native_hybrid3->setPalette (PALET_NORMAL);
      AUTFBACK (cb_saxs_iq_native_hybrid3);
      connect (cb_saxs_iq_native_hybrid3, SIGNAL (clicked ()), this,
               SLOT (set_saxs_iq_native_hybrid3 ()));
      ...
      cb_saxs_iq_hybrid_adaptive->setChecked (
          (*saxs_options).saxs_iq_hybrid_adaptive);
      cb_saxs_iq_hybrid_adaptive->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
      cb_saxs_iq_hybrid_adaptive->setPalette (PALET_NORMAL);
      AUTFBACK (cb_saxs_iq_hybrid_adaptive);
      connect (cb_saxs_iq_hybrid_adaptive, SIGNAL (clicked ()), this,
               SLOT (set_saxs_iq_hybrid_adaptive ()));
    }
  ...
  cb_saxs_iq_native_fast->setFont (QFont (USglobal->config_list.fontFamily,
                                          USglobal->config_list.fontSize));
  cb_saxs_iq_native_fast->setPalette (PALET_NORMAL);
  AUTFBACK (cb_saxs_iq_native_fast);
  connect (cb_saxs_iq_native_fast, SIGNAL (clicked ()), this,
           SLOT (set_saxs_iq_native_fast ()));
  ...
  cb_saxs_iq_native_fast_compute_pr->setChecked (
      (*saxs_options).saxs_iq_native_fast_compute_pr);
  cb_saxs_iq_native_fast_compute_pr->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cb_saxs_iq_native_fast_compute_pr->setPalette (PALET_NORMAL);
  AUTFBACK (cb_saxs_iq_native_fast_compute_pr);
  connect (cb_saxs_iq_native_fast_compute_pr, SIGNAL (clicked ()), this,
           SLOT (set_saxs_iq_native_fast_compute_pr ()));
  ...
  if (started_in_expert_mode)
    {
      ...
      cb_saxs_iq_foxs->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
      cb_saxs_iq_foxs->setPalette (PALET_NORMAL);
      AUTFBACK (cb_saxs_iq_foxs);
      connect (cb_saxs_iq_foxs, SIGNAL (clicked ()), this,
               SLOT (set_saxs_iq_foxs ()));
    }
  ...
  cb_saxs_iq_crysol->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cb_saxs_iq_crysol->setPalette (PALET_NORMAL);
  AUTFBACK (cb_saxs_iq_crysol);
  connect (cb_saxs_iq_crysol, SIGNAL (clicked ()), this,
           SLOT (set_saxs_iq_crysol ()));
  ...
  if (started_in_expert_mode)
    {
      ...
      cb_saxs_iq_sastbx->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize));
      cb_saxs_iq_sastbx->setPalette (PALET_NORMAL);
      AUTFBACK (cb_saxs_iq_sastbx);
      connect (cb_saxs_iq_sastbx, SIGNAL (clicked ()), this,
               SLOT (set_saxs_iq_sastbx ()));
    }
  ...
  lbl_fast_bin_size->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize - 1,
                                     QFont::Bold));

  cnt_fast_bin_size = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_fast_bin_size);
  cnt_fast_bin_size->setRange (0.01, 100);
  cnt_fast_bin_size->setSingleStep (0.01);
  ...
  cnt_fast_bin_size->setFont (QFont (USglobal->config_list.fontFamily,
                                     USglobal->config_list.fontSize));
  cnt_fast_bin_size->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_fast_bin_size);
  connect (cnt_fast_bin_size, SIGNAL (valueChanged (double)),
           SLOT (update_fast_bin_size (double)));
  ...
  lbl_fast_modulation->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize - 1,
                                       QFont::Bold));

  cnt_fast_modulation = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_fast_modulation);
  cnt_fast_modulation->setRange (0.1, 0.5);
  cnt_fast_modulation->setSingleStep (0.001);
  ...
  cnt_fast_modulation->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cnt_fast_modulation->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_fast_modulation);
  connect (cnt_fast_modulation, SIGNAL (valueChanged (double)),
           SLOT (update_fast_modulation (double)));

  lbl_hybrid2_q_points
      = new QLabel (us_tr (" Hybrid, H2, H3: q points"), this);
  ...
  lbl_hybrid2_q_points->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1,
                                        QFont::Bold));

  cnt_hybrid2_q_points = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_hybrid2_q_points);
  cnt_hybrid2_q_points->setRange (3, 100);
  cnt_hybrid2_q_points->setSingleStep (1);
  ...
  cnt_hybrid2_q_points->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cnt_hybrid2_q_points->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_hybrid2_q_points);
  connect (cnt_hybrid2_q_points, SIGNAL (valueChanged (double)),
           SLOT (update_hybrid2_q_points (double)));

  lbl_sh_max_harmonics = new QLabel (
  ...
  lbl_sh_max_harmonics->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize - 1,
                                        QFont::Bold));

  cnt_sh_max_harmonics = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_sh_max_harmonics);
  cnt_sh_max_harmonics->setRange (1, 75);
  cnt_sh_max_harmonics->setSingleStep (1);
  ...
  cnt_sh_max_harmonics->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cnt_sh_max_harmonics->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_sh_max_harmonics);
  connect (cnt_sh_max_harmonics, SIGNAL (valueChanged (double)),
           SLOT (update_sh_max_harmonics (double)));

  lbl_sh_fibonacci_grid_order
      = new QLabel (started_in_expert_mode
  ...
  lbl_sh_fibonacci_grid_order->setFont (
  ...
  cnt_sh_fibonacci_grid_order->setRange (2, 75);
  cnt_sh_fibonacci_grid_order->setSingleStep (1);
  cnt_sh_fibonacci_grid_order->setValue (
  ...
  cnt_sh_fibonacci_grid_order->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cnt_sh_fibonacci_grid_order->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_sh_fibonacci_grid_order);
  connect (cnt_sh_fibonacci_grid_order, SIGNAL (valueChanged (double)),
           SLOT (update_sh_fibonacci_grid_order (double)));

  lbl_crysol_hydration_shell_contrast = new QLabel (
      started_in_expert_mode
          ? us_tr (" Crysol/Sastbx: Contrast of hydration shell (e / A^3):")
          : us_tr (" Crysol: Contrast of hydration shell (e / A^3):"),
      this);
  lbl_crysol_hydration_shell_contrast->setAlignment (Qt::AlignLeft
                                                     | Qt::AlignVCenter);
  ...
  lbl_crysol_hydration_shell_contrast->setFont (
      QFont (USglobal->config_list.fontFamily,
             USglobal->config_list.fontSize - 1, QFont::Bold));

  cnt_crysol_hydration_shell_contrast = new QwtCounter (this);
  US_Hydrodyn::sizeArrows (cnt_crysol_hydration_shell_contrast);
  cnt_crysol_hydration_shell_contrast->setRange (-1, 1);
  cnt_crysol_hydration_shell_contrast->setSingleStep (0.001);
  cnt_crysol_hydration_shell_contrast->setValue (
  ...
  cnt_crysol_hydration_shell_contrast->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cnt_crysol_hydration_shell_contrast->setPalette (PALET_NORMAL);
  AUTFBACK (cnt_crysol_hydration_shell_contrast);
  connect (cnt_crysol_hydration_shell_contrast, SIGNAL (valueChanged (double)),
           SLOT (update_crysol_hydration_shell_contrast (double)));
  ...
  AUTFBACK (lbl_crysol);
  lbl_crysol->setFont (QFont (USglobal->config_list.fontFamily,
                              USglobal->config_list.fontSize - 1,
                              QFont::Bold));

  cb_crysol_default_load_difference_intensity = new QCheckBox (this);
  cb_crysol_default_load_difference_intensity->setText (
      us_tr (" Automatically load difference intensity"));
  cb_crysol_default_load_difference_intensity->setEnabled (true);
  cb_crysol_default_load_difference_intensity->setChecked (
      (*saxs_options).crysol_default_load_difference_intensity);
  cb_crysol_default_load_difference_intensity->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cb_crysol_default_load_difference_intensity->setPalette (PALET_NORMAL);
  AUTFBACK (cb_crysol_default_load_difference_intensity);
  connect (cb_crysol_default_load_difference_intensity, SIGNAL (clicked ()),
           this, SLOT (set_crysol_default_load_difference_intensity ()));
  ...
  cb_crysol_version_26->setFont (QFont (USglobal->config_list.fontFamily,
                                        USglobal->config_list.fontSize));
  cb_crysol_version_26->setPalette (PALET_NORMAL);
  AUTFBACK (cb_crysol_version_26);
  connect (cb_crysol_version_26, SIGNAL (clicked ()), this,
           SLOT (set_crysol_version_26 ()));
  ...
  cb_crysol_version_3->setFont (QFont (USglobal->config_list.fontFamily,
                                       USglobal->config_list.fontSize));
  cb_crysol_version_3->setPalette (PALET_NORMAL);
  AUTFBACK (cb_crysol_version_3);
  connect (cb_crysol_version_3, SIGNAL (clicked ()), this,
           SLOT (set_crysol_version_3 ()));
  ...
  cb_crysol_water_dummy_beads->setChecked (
      (*saxs_options).crysol_water_dummy_beads);
  cb_crysol_water_dummy_beads->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cb_crysol_water_dummy_beads->setPalette (PALET_NORMAL);
  AUTFBACK (cb_crysol_water_dummy_beads);
  connect (cb_crysol_water_dummy_beads, SIGNAL (clicked ()), this,
           SLOT (set_crysol_water_dummy_beads ()));
  ...
  cb_crysol_explicit_hydrogens->setChecked (
      (*saxs_options).crysol_explicit_hydrogens);
  cb_crysol_explicit_hydrogens->setFont (QFont (
      USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
  cb_crysol_explicit_hydrogens->setPalette (PALET_NORMAL);
  AUTFBACK (cb_crysol_explicit_hydrogens);
  connect (cb_crysol_explicit_hydrogens, SIGNAL (clicked ()), this,
           SLOT (set_crysol_explicit_hydrogens ()));
  ...
  AUTFBACK (lbl_ra);
  lbl_ra->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1, QFont::Bold));

  le_ra = new mQLineEdit (this);
  le_ra->setObjectName ("le_ra Line Edit");
  le_ra->setText (((US_Hydrodyn *)us_hydrodyn)->gparams.count ("sas_crysol_ra")
  ...
  AUTFBACK (le_ra);
  le_ra->setFont (QFont (USglobal->config_list.fontFamily,
                         USglobal->config_list.fontSize - 1));
  le_ra->setEnabled (true);
  le_ra->setValidator (new QDoubleValidator (0, 9, 3, le_ra));
  connect (le_ra, SIGNAL (textChanged (const QString &)),
           SLOT (set_ra (const QString &)));
  ...
  AUTFBACK (lbl_vol);
  lbl_vol->setFont (QFont (USglobal->config_list.fontFamily,
                           USglobal->config_list.fontSize - 1, QFont::Bold));

  le_vol = new mQLineEdit (this);
  le_vol->setObjectName ("le_vol Line Edit");
  le_vol->setText (
  ...
  AUTFBACK (le_vol);
  le_vol->setFont (QFont (USglobal->config_list.fontFamily,
                          USglobal->config_list.fontSize - 1));
  le_vol->setEnabled (true);
  le_vol->setValidator (new QDoubleValidator (0, 1e15, 2, le_vol));
  connect (le_vol, SIGNAL (textChanged (const QString &)),
           SLOT (set_vol (const QString &)));
  ...
  pb_crysol_target
      = new QPushButton (us_tr ("Crysol target experimental data"), this);
  pb_crysol_target->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize + 1));
  ...
  le_crysol_target->setObjectName ("");
  ...
  le_crysol_target->setFont (QFont (USglobal->config_list.fontFamily,
                                    USglobal->config_list.fontSize - 1));
  le_crysol_target->setText (
  ...
  if (started_in_expert_mode)
    {
      ...
      lbl_sastbx_method->setFont (QFont (USglobal->config_list.fontFamily,
                                         USglobal->config_list.fontSize - 1,
                                         QFont::Bold));

      rb_sastbx_method_she
          = new QRadioButton (us_tr ("Spherical harmonics"), this);
      rb_sastbx_method_she->setEnabled (true);
      rb_sastbx_method_she->setChecked (saxs_options->sastbx_method == 0);
      rb_sastbx_method_she->setFont (QFont (USglobal->config_list.fontFamily,
                                            USglobal->config_list.fontSize));
      ...
      rb_sastbx_method_debye->setFont (QFont (USglobal->config_list.fontFamily,
                                              USglobal->config_list.fontSize));
      ...
      rb_sastbx_method_zernike->setFont (QFont (
          USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
      ...
      connect (bg_sastbx_method, SIGNAL (buttonClicked (int)),
               SLOT (set_sastbx_method (int)));
#else
      bg_sastbx_method = new QGroupBox ();
      connect (rb_sastbx_method_she, SIGNAL (clicked ()),
               SLOT (set_sastbx_method ()));
      connect (rb_sastbx_method_debye, SIGNAL (clicked ()),
               SLOT (set_sastbx_method ()));
      connect (rb_sastbx_method_zernike, SIGNAL (clicked ()),
               SLOT (set_sastbx_method ()));
  ...
  hbl_crysol->setContentsMargins (0, 0, 0, 0);
  hbl_crysol->setSpacing (0);
  ...
  if (started_in_expert_mode)
    {
      ...
      hbl_sastbx_method->setContentsMargins (0, 0, 0, 0);
      hbl_sastbx_method->setSpacing (0);
...
void
US_Hydrodyn_SasOptionsSaxs::cancel ()
{
  close ();
}

void
US_Hydrodyn_SasOptionsSaxs::help ()
{
  US_Help *online_help;
...
void
US_Hydrodyn_SasOptionsSaxs::closeEvent (QCloseEvent *e)
{
  *sas_options_saxs_widget = false;
  global_Xpos -= 30;
  global_Ypos -= 30;
...
void
US_Hydrodyn_SasOptionsSaxs::update_water_e_density (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_debye ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_sh ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_hybrid ()
{
  (*saxs_options).saxs_iq_native_hybrid
      = cb_saxs_iq_native_hybrid->isChecked ();
  (*saxs_options).saxs_iq_native_sh = false;
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_hybrid2 ()
{
  (*saxs_options).saxs_iq_native_hybrid2
      = cb_saxs_iq_native_hybrid2->isChecked ();
  (*saxs_options).saxs_iq_native_sh = false;
  (*saxs_options).saxs_iq_native_debye
      = !cb_saxs_iq_native_hybrid2->isChecked ();
  (*saxs_options).saxs_iq_native_fast = false;
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_hybrid3 ()
{
  (*saxs_options).saxs_iq_native_hybrid3
      = cb_saxs_iq_native_hybrid3->isChecked ();
  (*saxs_options).saxs_iq_native_sh = false;
  (*saxs_options).saxs_iq_native_debye
      = !cb_saxs_iq_native_hybrid3->isChecked ();
  (*saxs_options).saxs_iq_native_fast = false;
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_hybrid_adaptive ()
{
  (*saxs_options).saxs_iq_hybrid_adaptive
      = cb_saxs_iq_hybrid_adaptive->isChecked ();
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
  // ((US_Hydrodyn *)us_hydrodyn)->display_default_differences();
  if (((US_Hydrodyn *)us_hydrodyn)->saxs_plot_widget)
    {
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_fast ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_native_fast_compute_pr ()
{
  (*saxs_options).saxs_iq_native_fast_compute_pr
      = cb_saxs_iq_native_fast_compute_pr->isChecked ();
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_crysol ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_foxs ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_saxs_iq_sastbx ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::update_sh_max_harmonics (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::update_sh_fibonacci_grid_order (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::update_crysol_hydration_shell_contrast (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_crysol_default_load_difference_intensity ()
{
  (*saxs_options).crysol_default_load_difference_intensity
      = cb_crysol_default_load_difference_intensity->isChecked ();
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_SasOptionsSaxs::set_crysol_version_26 ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_crysol_version_3 ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_crysol_water_dummy_beads ()
{
  (*saxs_options).crysol_water_dummy_beads
      = cb_crysol_water_dummy_beads->isChecked ();
}

void
US_Hydrodyn_SasOptionsSaxs::set_crysol_explicit_hydrogens ()
{
  (*saxs_options).crysol_explicit_hydrogens
      = cb_crysol_explicit_hydrogens->isChecked ();
  ((US_Hydrodyn *)us_hydrodyn)->display_default_differences ();
}

void
US_Hydrodyn_SasOptionsSaxs::update_fast_modulation (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::update_hybrid2_q_points (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::update_fast_bin_size (double val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_sastbx_method ()
{
...
void
US_Hydrodyn_SasOptionsSaxs::set_sastbx_method (int val)
{
...
void
US_Hydrodyn_SasOptionsSaxs::crysol_target ()
{
  QString use_dir
  ...
  QString filename = QFileDialog::getOpenFileName (
      this,
      windowTitle ()
          + us_tr ("Select a file for CRYSOL experimental data target"),
      use_dir, "*.dat *.DAT");
...
void
US_Hydrodyn_SasOptionsSaxs::set_ra (const QString &str)
{
  ((US_Hydrodyn *)us_hydrodyn)->gparams["sas_crysol_ra"] = str;
}

void
US_Hydrodyn_SasOptionsSaxs::set_vol (const QString &str)
{
