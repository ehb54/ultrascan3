#ifndef US_HYDRODYN_DAD_CISTARQ_H
#define US_HYDRODYN_DAD_CISTARQ_H
...
class US_EXTERN US_Hydrodyn_Dad_Cistarq : public QDialog {
      Q_OBJECT

   public:
      US_Hydrodyn_Dad_Cistarq(
         void *us_hydrodyn_dad, map<QString, QString> *parameters, QWidget *p = 0, const char *name = 0);
