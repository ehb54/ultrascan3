...
#define zlib_version zlibVersion ()
  ...
  */
  ...
  /*
    ...
    be called again with Z_FINISH and more output space (updated avail_out) but
    no more input data, until it returns with Z_STREAM_END or an error. After
  ...
  */
  ...
  the version assumed by the caller.  msg is set to null if there is no error
     message. inflateInit does not perform any decompression apart from reading
     the zlib header if present: this will be done by inflate().  (So next_in
  and avail_in may be modified, but next_out and avail_out are unchanged.)
  */
  ...
  /*
    ...
    output as possible to the output buffer. The flushing behavior of inflate
    is not specified for values of the flush parameter other than Z_SYNC_FLUSH
    and Z_FINISH, but the current implementation actually flushes as much
    output as possible anyway.
    ...
    to the zlib format or incorrect adler32 checksum), Z_STREAM_ERROR if the
  ...
  */
  ...
  this version of the library. Larger values of this parameter result in better
  ...
  a filter (or predictor), or Z_HUFFMAN_ONLY to force Huffman encoding only (no
  ...
  */
  ...
  /*
     ...
     freed by calling deflateEnd.  Note that deflateCopy duplicates the
  ...
  */
  ...
  for this version of the library. The default value is 15 if inflateInit is
  ...
  enough memory, Z_STREAM_ERROR if a parameter is invalid (such as a negative
  ...
  */
  ...
  /*
     ...
     inflate if this call returned Z_NEED_DICT. The dictionary chosen by the
     compressor can be determined from the Adler32 value returned by this call
  ...
  */
  ...
  /*
     ...
     of uncompressed bytes actually written (0 in case of error).
  */
