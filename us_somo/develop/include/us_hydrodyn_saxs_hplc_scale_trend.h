#ifndef US_HYDRODYN_SAXS_HPLC_SCALE_TREND_H
#define US_HYDRODYN_SAXS_HPLC_SCALE_TREND_H
...
class US_EXTERN US_Hydrodyn_Saxs_Hplc_Scale_Trend : public QFrame {
 ...
 public:
  US_Hydrodyn_Saxs_Hplc_Scale_Trend(
      void* us_hydrodyn, map<QString, QString> parameters,
      map<QString, vector<vector<double> > > plots, QWidget* p = 0,
      const char* name = 0);
