...
#ifndef US_HYDRODYN_MALS_CONC_CSV_FRAMES_H
#define US_HYDRODYN_MALS_CONC_CSV_FRAMES_H
...
class US_EXTERN US_Hydrodyn_Mals_Conc_Csv_Frames : public QDialog
{
   Q_OBJECT

   public:
      US_Hydrodyn_Mals_Conc_Csv_Frames(
                       void                     *              us_hydrodyn,
