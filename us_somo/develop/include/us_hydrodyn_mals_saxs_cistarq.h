#ifndef US_HYDRODYN_MALS_SAXS_CISTARQ_H
#define US_HYDRODYN_MALS_SAXS_CISTARQ_H
...
class US_EXTERN US_Hydrodyn_Mals_Saxs_Cistarq : public QDialog {
      Q_OBJECT

   public:
      US_Hydrodyn_Mals_Saxs_Cistarq(
         void *us_hydrodyn_mals_saxs, map<QString, QString> *parameters, QWidget *p = 0, const char *name = 0);
