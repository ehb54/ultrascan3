#ifndef US_HYDRODYN_MALS_CONC_LOAD_H
#define US_HYDRODYN_MALS_CONC_LOAD_H
...
class US_EXTERN US_Hydrodyn_Mals_Conc_Load : public QDialog {
      Q_OBJECT
   ...
   public:
      ...
      US_Hydrodyn_Mals_Conc_Load(QStringList &qsl_text, csv &csv1, QWidget *p = 0, const char *name = 0);
      ~US_Hydrodyn_Mals_Conc_Load();
