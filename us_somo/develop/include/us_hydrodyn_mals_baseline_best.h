#ifndef US_HYDRODYN_MALS_BASELINE_BEST_H
#define US_HYDRODYN_MALS_BASELINE_BEST_H
...
class US_EXTERN US_Hydrodyn_Mals_Baseline_Best : public QFrame {
      Q_OBJECT

   public:
      US_Hydrodyn_Mals_Baseline_Best(
         void *us_hydrodyn, map<QString, QString> parameters, map<QString, double> dparameters,
         map<QString, vector<double>> vdparameters, QWidget *p = 0, const char *name = 0);
