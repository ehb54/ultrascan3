...
class ShowHide {
   public:
      static void hide_widgets(
         const std::set<QWidget *> &widgets, bool hide = true, QWidget *do_resize = ( QWidget * ) 0);
      static void hide_widgets(
         const std::vector<QWidget *> &widgets, bool hide = true, QWidget *do_resize = ( QWidget * ) 0);
      static void hide_widgets(
         const std::vector<std::vector<QWidget *>> &widgets, int row, bool hide = true,
         QWidget *do_resize = ( QWidget * ) 0);
      static void only_widgets(
         const std::vector<std::vector<QWidget *>> &widgets, int row, bool hide = true,
         QWidget *do_resize = ( QWidget * ) 0);
      static void hide_widgets(
         const std::set<QWidget *> &widgets, const std::set<QWidget *> &always_hide_widgets, bool hide = true,
         QWidget *do_resize = ( QWidget * ) 0);
      static void hide_widgets(
         const std::vector<QWidget *> &widgets, const std::set<QWidget *> &always_hide_widgets, bool hide = true,
         QWidget *do_resize = ( QWidget * ) 0);
      static void hide_widgets(
         const std::vector<std::vector<QWidget *>> &widgets, int row, const std::set<QWidget *> &always_hide_widgets,
         bool hide = true, QWidget *do_resize = ( QWidget * ) 0);
      static void only_widgets(
         const std::vector<std::vector<QWidget *>> &widgets, int row, const std::set<QWidget *> &always_hide_widgets,
         bool hide = true, QWidget *do_resize = ( QWidget * ) 0);
};
