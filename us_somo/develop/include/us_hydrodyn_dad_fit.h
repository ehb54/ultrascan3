#ifndef US_HYDRODYN_DAD_FIT_H
#define US_HYDRODYN_DAD_FIT_H
...
class US_EXTERN US_Hydrodyn_Dad_Fit : public QDialog {
  Q_OBJECT

  friend class US_Hydrodyn_Dad;

 public:
  US_Hydrodyn_Dad_Fit(US_Hydrodyn_Dad *dad_win, bool set_comm_dist = true,
