...
template <size_t Ndims>
inline arr_and_str_indices<Ndims> arr_index_data<Ndims>::operator()(
...
inline std::string file_and_line_as_string_with_backtrace(const char* file,
                                                          long line) {
  std::ostringstream o;
...
struct dims<5> : dim_data<5> {
  size_t index_1d(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4,
                  ssize_t i5) const {
...
struct dims<6> : dim_data<6> {
  size_t index_1d(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4, ssize_t i5,
                  ssize_t i6) const {
...
inline dim_chain dim1(star_type const&) { return dim_chain(star_type()); }

inline dim_chain dim1(size_t n) { return dim_chain(n); }
...
inline dims<5> dimension(size_t n1, size_t n2, size_t n3, size_t n4,
                         star_type const&) {
  dims<5> result;
  result.all[0] = n1;
  result.all[1] = n2;
...
inline dims<6> dimension(size_t n1, size_t n2, size_t n3, size_t n4, size_t n5,
                         star_type const&) {
  dims<6> result;
  result.all[0] = n1;
  result.all[1] = n2;
...
struct arr_cref {
 ...
 public:
  ...
  arr_cref(arr_cref<T, OtherNdims> const& other, dims<BufferNdims> const& dims)
      : elems_(other.begin()) {
    (*this)(dims);
  }
  ...
  T const& operator()(ssize_t i1, ssize_t i2) const {
    return elems_[dims_.index_1d(i1, i2)];
  }

  T const& operator()(ssize_t i1, ssize_t i2, ssize_t i3) const {
  ...
  T const& operator()(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4,
                      ssize_t i5) const {
    return elems_[dims_.index_1d(i1, i2, i3, i4, i5)];
  }

  T const& operator()(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4,
                      ssize_t i5, ssize_t i6) const {
...
struct arr_ref : arr_cref<T, Ndims> {
 ...
 public:
  ...
  T& operator()(ssize_t i1) const {
    return this->begin()[this->dims_.index_1d(i1)];
  }

  T& operator()(ssize_t i1, ssize_t i2) const {
  ...
  T& operator()(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4, ssize_t i5,
                ssize_t i6) const {
...
inline bool is_end_of_line(int c) { return (c == '\n'); }
...
//! Assumes ASCII or similar.
inline int digit_as_int(int c) { return c - '0'; }

inline char int_as_digit(int i) { return "0123456789"[i]; }
...
//! To avoid locale environment surprises (assumes ASCII or similar).
inline bool is_upper_a_through_z(int c) { return (c >= 'A' && c <= 'Z'); }

//! To avoid locale environment surprises (assumes ASCII or similar).
inline bool is_lower_a_through_z(int c) { return (c >= 'a' && c <= 'z'); }
...
inline bool starts_with(char const* str, unsigned start, unsigned stop,
                        char const* substr) {
...
inline int unsigned_integer_scan(char const* code, unsigned start,
                                 unsigned stop) {
  unsigned i = start;
  for (; i < stop; i++) {
    int c = code[i];
...
//! Assumes ASCII or similar.
inline unsigned unsigned_integer_value(char const* str, unsigned start,
                                       unsigned stop) {
  unsigned result = 0;
  unsigned i = start;
  for (; i < stop; i++) {
...
inline int signed_integer_value(char const* str, unsigned start,
                                unsigned stop) {
  bool negative;
  if (str[start] == '-') {
    negative = true;
...
inline void copy_with_blank_padding(char const* src, size_t src_size,
...
inline void copy_with_blank_padding(char const* src, char* dest,
                                    size_t dest_size) {
  size_t i;
...
inline int string_compare_lexical(char const* lhs, size_t lhs_size,
                                  char const* rhs, size_t rhs_size) {
...
inline size_t_2 find_leading_and_trailing_blank_padding(char const* str,
                                                        size_t stop) {
  return size_t_2(find_leading_blank_padding(str, stop),
                  find_trailing_blank_padding(str, stop));
}

inline std::string strip_leading_and_trailing_blank_padding(
...
inline int keyword_index(char const* valid_vals[], std::string const& val,
...
//! Assumes ASCII or similar.
inline int int_to_string(char* buffer, int buffer_size, int width, int value,
...
struct str_cref {
 ...
 public:
  ...
  str_cref operator()(int first, int last) const {
...
struct str_ref : str_cref {
  ...
  void operator=(str_cref const& rhs) {
  ...
  void operator=(str_addends const& addends) {
    ...
    if (n_from_rhs <= 0) {
      ...
      utils::copy_with_blank_padding(addends.rhs.elems(), addends.rhs.len(),
                                     buffer.space + ll, n_from_rhs);
  ...
  str_ref operator()(int first, int last) const {
...
struct str {
  ...
  str(str_cref const& other) {
    utils::copy_with_blank_padding(other.elems(), other.len(), elems, StrLen);
  }
  ...
  str_ref operator()(int first, int last) {
...
struct str_arr_cref {
 ...
 public:
  ...
  str_cref operator[](size_t i) const {
    return str_cref(&elems_[len_ * i], len_);
  }

  str_cref operator()(ssize_t i1) const {
  ...
  str_cref operator()(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4,
                      ssize_t i5) const {
...
struct str_arr_ref : str_arr_cref<Ndims> {
 ...
 public:
  ...
  str_ref operator()(ssize_t i1, ssize_t i2) const {
    return str_ref(&this->begin()[this->len() * this->dims_.index_1d(i1, i2)],
                   this->len());
  }
  ...
  str_ref operator()(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4,
                     ssize_t i5) const {
    return str_ref(
  ...
  str_ref operator()(ssize_t i1, ssize_t i2, ssize_t i3, ssize_t i4, ssize_t i5,
                     ssize_t i6) const {
    return str_ref(&this->begin()[this->len() *
...
struct tokenizer : utils::noncopyable {
 ...
 protected:
  ...
  int unsigned_integer_scan(unsigned start) {
...
inline float sqrt(float const& x) { return std::sqrt(x); }

inline double sqrt(double const& x) { return std::sqrt(x); }

inline double dsqrt(double const& x) { return std::sqrt(x); }

inline float cos(float const& angle) { return std::cos(angle); }

inline double cos(double const& angle) { return std::cos(angle); }

inline float acos(float const& angle) { return std::acos(angle); }

inline double dacos(double const& angle) { return std::acos(angle); }

inline double acos(double const& angle) { return dacos(angle); }

inline float sin(float const& angle) { return std::sin(angle); }

inline double sin(double const& angle) { return std::sin(angle); }

inline float asin(float const& angle) { return std::asin(angle); }

inline double dasin(double const& angle) { return std::asin(angle); }

inline double asin(double const& angle) { return dasin(angle); }

inline float tan(float const& angle) { return std::tan(angle); }

inline double dtan(double const& angle) { return std::tan(angle); }

inline double tan(double const& angle) { return dtan(angle); }

inline float atan(float const& angle) { return std::atan(angle); }

inline double datan(double const& angle) { return std::atan(angle); }

inline double atan(double const& angle) { return datan(angle); }

inline float atan2(float const& y, float const& x) { return std::atan2(y, x); }

inline double datan2(double const& y, double const& x) {
  return std::atan2(y, x);
}

inline double atan2(double const& y, double const& x) { return datan2(y, x); }

inline float exp(float const& x) { return std::exp(x); }

inline double exp(double const& x) { return std::exp(x); }

inline double dexp(double const& x) { return std::exp(x); }

inline float alog10(float const& x) { return std::log10(x); }

inline double alog10(double const& x) { return std::log10(x); }

inline float alog(float const& x) { return std::log(x); }

inline double dlog(double const& x) { return std::log(x); }
...
inline int mod(int const& v1, int const& v2) { return v1 % v2; }

inline float amod(float const& v1, float const& v2) {
  return std::fmod(v1, v2);
}

inline float mod(float const& v1, float const& v2) { return std::fmod(v1, v2); }
...
inline int iabs(int const& v) { return std::abs(v); }

inline double dabs(double const& v) { return std::abs(v); }

inline int min0(int const& v1, int const& v2) { return std::min(v1, v2); }

inline int min(int const& v1, int const& v2) { return std::min(v1, v2); }
...
inline float amin1(float const& v1, float const& v2, float const& v3,
                   float const& v4, float const& v5) {
  return amin1(amin1(v1, v2, v3, v4), v5);
}

inline float min(float const& v1, float const& v2) { return std::min(v1, v2); }
...
inline int max0(int const& v1, int const& v2) { return std::max(v1, v2); }

inline int max(int const& v1, int const& v2) { return std::max(v1, v2); }
...
inline float max(float const& v1, float const& v2) { return std::max(v1, v2); }
...
inline str<1> fchar(int i) { return str<1>(static_cast<char>(i)); }
...
inline int lnblnk(str_cref c) { return len_trim(c); }
...
//! Assumes ASCII or similar.
inline bool llt(str_cref a, str_cref b) { return a < b; }

//! Assumes ASCII or similar.
inline bool lle(str_cref a, str_cref b) { return a <= b; }

//! Assumes ASCII or similar.
inline bool lgt(str_cref a, str_cref b) { return a > b; }

//! Assumes ASCII or similar.
inline bool lge(str_cref a, str_cref b) { return a >= b; }
...
inline void cpu_time(double& result) { result = user_plus_system_time(); }
...
inline int main_with_catch(int argc, char const* argv[],
...
struct dynamic_parameters_from {
  ...
  dynamic_parameters_from(command_line_arguments const& command_line_args_,
    ...
    int n_flds =
        static_cast<int>(command_line_args.dynamic_parameters_fields.size());
  ...
  data_values& operator,(str_ref val) {
    ...
    if (tab_val.content->type() == typeid(std::string)) {
      std::string const& tab_str =
          static_cast<datum::holder<std::string>*>(tab_val.content)->held;
      val = tab_str.c_str();
    } else {
...
inline bool is_stream_end(int c) { return c == stream_end; }

inline bool is_stream_err(int c) { return c == stream_err; }

inline bool is_stream_end_or_err(int c) { return c >= stream_end; }
...
struct io_unit {
  ...
  */
  ...
  std::string get_file_name_set_default_if_necessary() {
    if (file_name.size() == 0 && !is_std_io_unit(number)) {
      if (status != st_scratch) {
        char buffer[64];
        int actual_width = utils::int_to_string(buffer, sizeof(buffer),
                                                /*width*/ 3,
                                                /*value*/ number,
  ...
  void open(int* iostat_ptr) {
    ...
    bool file_exists =
        utils::path::exists(get_file_name_set_default_if_necessary().c_str());
    if (status == st_old) {
      if (!file_exists) {
        iostat = 1;
        if (iostat_ptr != 0) {
...
struct io : utils::noncopyable {
  ...
  inline struct inquire_chain inquire_file(
      std::string file, bool blank_padding_removed_already = false);
...
inline close_chain io::close(int unit) { return close_chain(this, unit); }
...
inline inquire_chain io::inquire_file(std::string file,
...
inline open_chain io::open(int unit, std::string file,
                           bool blank_padding_removed_already) {
  if (!blank_padding_removed_already) {
    file = utils::strip_leading_and_trailing_blank_padding(file);
  }
...
class optional_container : public optional_copy<ContainerType> {
 public:
  ...
  typename ContainerType::value_type& operator[](
      typename ContainerType::size_type const& i) {
    return (*this->ptr_)[i];
  }

  typename ContainerType::value_type const& operator[](
      typename ContainerType::size_type const& i) const {
    return (*this->ptr_)[i];
  }
};
...
static const double one_e_two_pow_0_8[] = {1e1,  1e2,  1e4,   1e8,  1e16,
 ...
 public:
      ...
      if (t->type == "string") {
        ...
        if (utils::ends_with_char(tv, 'x')) {
          if (tv.size() == 1) {
            ...
            process_fmt_x(
                utils::signed_integer_value(tv.data(), 0, tv.size() - 1));
          }
  ...
  read_loop& operator,(float& val) {
    if (io_mode == io_unformatted) {
      ...
      val = static_cast<float>(
          (io_mode == io_formatted ? read_fmt_double() : read_star_double()));
    }
    return *this;
  }
...
struct equivalence {
  ...
  equivalence& with(size_t index_1d = 0, size_t str_offset = 0) {
    array_alignment.add_anchor(
        align_i_mbr, align_byte_offset, Jmbr - 1,
        members[Jmbr - 1].type_size * index_1d + str_offset);
    return *this;
  }
...
struct variant_bind_chain {
  ...
  variant_allocate_chain allocate() {
...
struct save_equivalences : variant_bind_chain {
  save_equivalences(variant_core_and_bindings& core_and_bindings)
      : variant_bind_chain(&core_and_bindings.core, &core_and_bindings.bindings,
...
struct double_to_string_scientific_notation {
  ...
  double_to_string_scientific_notation(
    ...
    static const double multipliers_dbl[] = {1e0,  1e1,  1e2,  1e3,  1e4,  1e5,
...
// TODO copy-constructor potential performance problem
{
  ...
  std::string const& next_edit_descriptor(bool final = false) {
    while (true) {
      ...
      if (t->type == "string") {
        ...
        if (utils::ends_with_char(tv, 'x')) {
          unsigned n = tv.size();
          if (n != 1) n = utils::unsigned_integer_value(tv.data(), n - 1);
          number_of_x_held += n;
        } else if (std::strchr("adefgilz", tv[0]) != 0) {
          return tv;
        } else if (utils::ends_with_char(tv, 'p')) {
 ...
 protected:  // implementation detail
  void to_stream_fmt_double(double const& val) {
    ...
    if (ed[0] == 'f') {
      ...
      utils::double_to_string_scientific_notation conv(val, w, d, exp_scale,
                                                       utils::to_upper(ed[0]));
 ...
 private:
  ...
  void to_stream_star_complex(char const* buf_re, unsigned n_re,
                              char const* buf_im, unsigned n_im) {
    to_stream_star("(", 1);
    {
      to_stream_star_strip_leading_and_trailing_blank_padding(buf_re, n_re,
                                                              /*space*/ false);
    }
    to_stream_star(",", 1, /*space*/ false);
    {
      to_stream_star_strip_leading_and_trailing_blank_padding(buf_im, n_im,
                                                              /*space*/ false);
    }
    to_stream_star(")", 1, /*space*/ false);
    prev_was_string = false;
...
struct common_write {
  ...
  template <size_t Ndims>
  write_loop operator()(str_arr_ref<Ndims> const& internal_file,
                        star_type const&) {
    write_loop result(internal_file, star);
    return result;
  }
