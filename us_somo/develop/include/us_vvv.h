...
#define CITATION                                                               \
  fprintf(                                                                     \
      ...
      "http://dx.doi.org/10.1016/j.jmb.2006.05.023", "mark.gerstein@yale.edu", \
      "vossman77@yahoo.com")

#define COMPILE_INFO                                                         \
  fprintf(stderr,                                                            \
          "Program: %s at line %d in source %s,\n which was compiled on %s " \
          "at %s.\n\n",                                                      \
...
int subt_Grids(gridpt biggrid[],
               gridpt smgrid[]);  // Modifies biggrid; returns difference
int intersect_Grids(gridpt grid1[],
                    gridpt grid2[]);  // Modifies grid1; returns final vox num
