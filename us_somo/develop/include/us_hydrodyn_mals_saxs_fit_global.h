#ifndef US_HYDRODYN_MALS_SAXS_FIT_GLOBAL_H
#define US_HYDRODYN_MALS_SAXS_FIT_GLOBAL_H
...
class US_EXTERN US_Hydrodyn_Mals_Saxs_Fit_Global : public QDialog {
  Q_OBJECT

  friend class US_Hydrodyn_Mals_Saxs;

 public:
  US_Hydrodyn_Mals_Saxs_Fit_Global(US_Hydrodyn_Mals_Saxs *mals_saxs_win,
                                   QWidget *p = 0, const char *name = 0);
  ~US_Hydrodyn_Mals_Saxs_Fit_Global();
