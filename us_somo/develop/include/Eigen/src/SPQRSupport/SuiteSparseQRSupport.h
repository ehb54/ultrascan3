...
namespace Eigen {
  ...
  */
   ...
   class SPQR : public SparseSolverBase<SPQR<_MatrixType>> {
      ...
      public:
         SPQR() :
             m_analysisIsOk(false), m_factorizationIsOk(false), m_isRUpToDate(false), m_ordering(SPQR_ORDERING_DEFAULT),
             m_allow_tol(SPQR_DEFAULT_TOL), m_tolerance(NumTraits<Scalar>::epsilon()), m_cR(0), m_E(0), m_H(0),
       ...
       */
            ...
            m_rank
               = SuiteSparseQR<Scalar>(m_ordering, pivotThreshold, col, &A, &m_cR, &m_E, &m_H, &m_HPinv, &m_HTau, &m_cc);
