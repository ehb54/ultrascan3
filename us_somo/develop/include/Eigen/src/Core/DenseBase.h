  ...
  */
...
#endif // not EIGEN_PARSED_BY_DOXYGEN
   {
     ...
     */
      ...
      * \sa PlainObject */
         typedef Matrix<
            typename internal::traits<Derived>::Scalar, internal::traits<Derived>::RowsAtCompileTime,
      ...
      */
         typedef typename internal::conditional<
            internal::is_same<typename internal::traits<Derived>::XprKind, MatrixXpr>::value, PlainMatrix,
...
#else
         typedef typename internal::conditional<
            (Flags & DirectAccessBit) == DirectAccessBit, internal::pointer_based_stl_iterator<Derived>,
