...
namespace Eigen {
   ...
   namespace internal {
      ...
      template<
         typename Scalar, typename Index, int Side, int Mode, bool Conjugate, int TriStorageOrder,
      ...
      struct triangular_solver_selector<Lhs, Rhs, Side, Mode, NoUnrolling, 1> {
            ...
            static EIGEN_DEVICE_FUNC void run(const Lhs &lhs, Rhs &rhs) {
               ...
               triangular_solve_vector<
                  LhsScalar, RhsScalar, Index, Side, Mode, LhsProductTraits::NeedToConjugate,
      ...
      struct triangular_solver_selector<Lhs, Rhs, Side, Mode, NoUnrolling, Dynamic> {
            ...
            static EIGEN_DEVICE_FUNC void run(const Lhs &lhs, Rhs &rhs) {
               ...
               typedef internal::gemm_blocking_space<
                  (Rhs::Flags & RowMajorBit) ? RowMajor : ColMajor, Scalar, Scalar, Rhs::MaxRowsAtCompileTime,
                  Rhs::MaxColsAtCompileTime, Lhs::MaxRowsAtCompileTime, 4>
                  BlockingType;
               ...
               triangular_solve_matrix<
                  ...
                  run(
                     size, othersize, &actualLhs.coeffRef(0, 0), actualLhs.outerStride(), &rhs.coeffRef(0, 0),
      ...
      struct triangular_solver_selector<Lhs, Rhs, OnTheRight, Mode, CompleteUnrolling, 1> {
            static EIGEN_DEVICE_FUNC void run(const Lhs &lhs, Rhs &rhs) {
               ...
               triangular_solver_unroller<
                  Transpose<const Lhs>, Transpose<Rhs>, ((Mode & Upper) == Upper ? Lower : Upper) | (Mode & UnitDiag),
...
***************************************************************************/
   ...
   EIGEN_DEVICE_FUNC void TriangularViewImpl<MatrixType, Mode, Dense>::solveInPlace(
      ...
      typedef typename internal::conditional<
         copy, typename internal::plain_matrix_type_column_major<OtherDerived>::type, OtherDerived &>::type OtherCopy;
