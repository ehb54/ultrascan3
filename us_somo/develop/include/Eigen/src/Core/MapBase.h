 ...
 * coeffRef) of dense Map and Block objects with direct access. Typical users
 * do not have to directly deal with this class.
 *
...
protected:
      ...
      = 0) const
  {
    ...
    eigen_assert (
        (((internal::UIntPtr (m_data) % internal::traits<Derived>::Alignment)
          == 0)
