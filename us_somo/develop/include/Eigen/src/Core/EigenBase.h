...
template <typename Derived> struct EigenBase
{
   ...
   * instead. Deprecation is not marked with a doxygen comment because there
   * are too many existing usages to add the deprecation attribute.
   */
 ...
 * const function which does the actual job. In practice, this allows any user
 * to write its own special matrix without having to modify MatrixBase
 *
