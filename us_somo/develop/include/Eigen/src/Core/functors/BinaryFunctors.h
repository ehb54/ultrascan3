...
struct scalar_pow_op : binary_op_base<Scalar, Exponent>
{
  ...
  EIGEN_DEVICE_FUNC
  inline result_type
  operator() (const Scalar &a, const Exponent &b) const
  {
...
// The following two classes permits to turn any binary functor into a unary
// one with one argument bound to a constant value. They are analogues to
