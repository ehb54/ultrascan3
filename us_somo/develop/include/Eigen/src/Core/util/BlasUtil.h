...
{
  EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE To
  run (const From &x)
  {
    return To (x);
  }
...
public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE PacketType
...
public:
  ...
  template <typename SubPacket>
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE SubPacket
  gatherPacket (Index i, Index j) const
  {
...
public:
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE
  BlasLinearMapper (Scalar *data, Index incr)
