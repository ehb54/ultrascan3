...
// where `long long` doesn't exist in some compilers for C++03. We therefore
// add the specialization for these platforms only.
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static float
  epsilon ()
  {
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static double
  epsilon ()
  {
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned int
  epsilon ()
  {
    return 0;
  }
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static long
  epsilon ()
  {
    return 0;
  }
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned long
  epsilon ()
  {
    return 0;
  }
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static long long
  epsilon ()
  {
    return 0;
  }
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static unsigned long long
  epsilon ()
  {
    return 0;
  }
...
{
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR static bool
  epsilon ()
  {
    return false;
  }
...
/** \internal Computes the least common multiple of two positive integer A and
 * B at compile-time.
 */
...
/** \internal determines whether the product of two numeric types is allowed
...
#if !defined(EIGEN_GPU_COMPILE_PHASE)                                         \
    || (!defined(EIGEN_CUDA_ARCH)                                             \
        && defined(EIGEN_CONSTEXPR_ARE_DEVICE_FUNC))
template <>
EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC bool
