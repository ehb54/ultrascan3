...
pcast<Packet8f, Packet8i> (const Packet8f &a)
{
...
pcast<Packet8i, Packet8f> (const Packet8i &a)
{
...
template <>
EIGEN_STRONG_INLINE Packet8f
pcast<Packet8h, Packet8f> (const Packet8h &a)
{
  return half2float (a);
}
...
template <>
EIGEN_STRONG_INLINE Packet8f
pcast<Packet8bf, Packet8f> (const Packet8bf &a)
{
  return Bf16ToF32 (a);
}
...
pcast<Packet8f, Packet8h> (const Packet8f &a)
{
  return float2half (a);
}
