...
#undef SYCL_PLOADT
      ...
      ploadt(const Eigen::TensorSycl::internal::RangeAccess<
             cl::sycl::access::mode::read_write, typename unpacket_traits<packet_type>::type> &from) {
...
#undef SYCL_PSET1
      ...
      struct get_base_packet<cl::sycl::cl_float4> {
            ...
            static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE cl::sycl::cl_float4 set_plset(const float &a) {
               return cl::sycl::cl_float4(
                  static_cast<float>(a), static_cast<float>(a + 1), static_cast<float>(a + 2),
      ...
      struct get_base_packet<cl::sycl::cl_double2> {
            template<typename sycl_multi_pointer>
            static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE cl::sycl::cl_double2 get_ploaddup(
...
#define SYCL_PSCATTER(address_space_target) \
   ...
   EIGEN_DEVICE_FUNC inline void pscatter( \
      typename cl::sycl::multi_ptr< \
         typename unpacket_traits<packet_type>::type, cl::sycl::access::address_space::address_space_target>::pointer_t \
         to, \
...
#define SYCL_PMAD(packet_type) \
   template<> \
   EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE packet_type \
   pmadd(const packet_type &a, const packet_type &b, const packet_type &c) { \
...
#undef SYCL_PMAD
      ...
      EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE cl::sycl::cl_float4 pabs<cl::sycl::cl_float4>(const cl::sycl::cl_float4 &a) {
         return cl::sycl::cl_float4(
            cl::sycl::fabs(a.x()), cl::sycl::fabs(a.y()), cl::sycl::fabs(a.z()), cl::sycl::fabs(a.w()));
      }
      template<>
      EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE cl::sycl::cl_double2 pabs<cl::sycl::cl_double2>(
      ...
      EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE Packet sycl_pcmp_le(const Packet &a, const Packet &b) {
         return (
            (a <= b).template convert<typename unpacket_traits<Packet>::type, cl::sycl::rounding_mode::automatic>());
      }
...
#undef SYCL_PANDNOT
      ...
      EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE cl::sycl::cl_float4 pblend(
         ...
         cl::sycl::cl_int4 condition(
            ifPacket.select[ 0 ] ? 0 : -1, ifPacket.select[ 1 ] ? 0 : -1, ifPacket.select[ 2 ] ? 0 : -1,
      ...
      inline cl::sycl::cl_double2 pblend(
         const Selector<unpacket_traits<cl::sycl::cl_double2>::size> &ifPacket, const cl::sycl::cl_double2 &thenPacket,
...
#define SYCL_PSTORE(alignment) \
   ...
   EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void pstore##alignment( \
      const Eigen::TensorSycl::internal::RangeAccess< \
         cl::sycl::access::mode::read_write, typename unpacket_traits<packet_type>::type> &to, \
      const packet_type &from) { \
