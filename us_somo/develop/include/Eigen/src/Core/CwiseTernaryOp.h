   ...
   class CwiseTernaryOp : public CwiseTernaryOpImpl<
      ...
      public:
         ...
         typedef typename CwiseTernaryOpImpl<
            TernaryOp, Arg1Type, Arg2Type, Arg3Type, typename internal::traits<Arg1Type>::StorageKind>::Base Base;
         ...
         EIGEN_STRONG_INLINE CwiseTernaryOp(
            const Arg1 &a1, const Arg2 &a2, const Arg3 &a3, const TernaryOp &func = TernaryOp()) :
         ...
         EIGEN_STRONG_INLINE Index rows() const {
            ...
            // optimizations
            if (
               internal::traits<typename internal::remove_all<Arg1Nested>::type>::RowsAtCompileTime == Dynamic
         ...
         EIGEN_STRONG_INLINE Index cols() const {
            ...
            // optimizations
            if (
               internal::traits<typename internal::remove_all<Arg1Nested>::type>::ColsAtCompileTime == Dynamic
