...
#include EIGEN_PLAINOBJECTBASE_PLUGIN
      ...
      */
         ...
         EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void _resize_to_match(const EigenBase<OtherDerived> &other) {
            ...
            eigen_assert(
               (this->size() == 0
                || (IsVectorAtCompileTime ? (this->size() == other.size()) : (rows() == other.rows() && cols() == other.cols())))
      ...
      */
         ...
         EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void _init2(
            ...
            EIGEN_STATIC_ASSERT(
               t0_is_integer_alike && t1_is_integer_alike, FLOATING_POINT_ARGUMENT_PASSED__INTEGER_WAS_EXPECTED)
            resize(rows, cols);
         }
         ...
         EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void _init2(
            ...
            typename internal::enable_if<
               (!internal::is_same<Index, Scalar>::value) && (internal::is_same<T0, Index>::value)
