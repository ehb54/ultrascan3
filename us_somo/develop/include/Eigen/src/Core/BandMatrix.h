...
namespace Eigen {
  ...
  */
      ...
      struct traits<BandMatrix<_Scalar, _Rows, _Cols, _Supers, _Subs, _Options>> {
            ...
            typedef Matrix<
               Scalar, DataRowsAtCompileTime, ColsAtCompileTime, int(Options) & int(RowMajor) ? RowMajor : ColMajor>
               CoefficientsType;
      };
      ...
      class BandMatrixWrapper
         ...
         public:
            ...
            explicit inline BandMatrixWrapper(
               const CoefficientsType &coeffs, Index rows = _Rows, Index cols = _Cols, Index supers = _Supers,
               Index subs = _Subs) : m_coeffs(coeffs), m_rows(rows), m_supers(supers), m_subs(subs) {
