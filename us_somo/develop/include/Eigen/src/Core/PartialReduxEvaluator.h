...
packetwise_redux_empty_value (const Func &)
{
    ...
    : evaluator_base<PartialReduxExpr<ArgType, MemberOp, Direction> >
{
  ...
  template <int LoadMode, typename PacketType>
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC PacketType
  packet (Index idx) const
  {
    ...
    PacketType p = internal::packetwise_redux_impl<BinaryOp, PanelEvaluator>::
