      ...
      struct redux_vec_unroller {
            ...
            EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE PacketType run(const Evaluator &eval, const Func &func) {
               ...
               return func.packetOp(
                  ...
                  redux_vec_unroller<Func, Evaluator, Start + HalfLength, Length - HalfLength>::template run<
...
***************************************************************************/
      ...
      template<
         typename Func, typename Evaluator, int Traversal = redux_traits<Func, Evaluator>::Traversal,
                  ...
                  if (alignedSize > packetSize) // we have at least two packets to partly unroll the loop
                  {
                     ...
                     for (Index index = alignedStart + 2 * packetSize; index < alignedEnd2; index += 2 * packetSize) {
                        ...
                        packet_res1 = func.packetOp(
                           packet_res1, eval.template packet<alignment, PacketScalar>(index + packetSize));
                     }
