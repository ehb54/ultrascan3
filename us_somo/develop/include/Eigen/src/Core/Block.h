   ...
   namespace internal {
      ...
      struct traits<Block<XprType, BlockRows, BlockCols, InnerPanel>> : traits<XprType> {
            ...
            enum {
               ...
               Flags = (traits<XprType>::Flags & (DirectAccessBit | (InnerPanel ? CompressedAccessBit : 0)))
  ...
  */
   ...
   class Block
       : public BlockImpl<XprType, BlockRows, BlockCols, InnerPanel, typename internal::traits<XprType>::StorageKind> {
         typedef BlockImpl<XprType, BlockRows, BlockCols, InnerPanel, typename internal::traits<XprType>::StorageKind>
            Impl;
      ...
      */
         EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Block(XprType &xpr, Index i) : Impl(xpr, i) {
            eigen_assert(
               (i >= 0)
               && (((BlockRows == 1) && (BlockCols == XprType::ColsAtCompileTime) && i < xpr.rows()) || ((BlockRows == XprType::RowsAtCompileTime) && (BlockCols == 1) && i < xpr.cols())));
         }
      ...
      */
         EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Block(XprType &xpr, Index startRow, Index startCol) :
            ...
            eigen_assert(
               startRow >= 0 && BlockRows >= 0 && startRow + BlockRows <= xpr.rows() && startCol >= 0 && BlockCols >= 0
      ...
      */
         ...
         Block(XprType &xpr, Index startRow, Index startCol, Index blockRows, Index blockCols) :
            ...
            eigen_assert(
               startRow >= 0 && blockRows >= 0 && startRow <= xpr.rows() - blockRows && startCol >= 0 && blockCols >= 0
   ...
   namespace internal {
      ...
      */
            ...
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE EIGEN_CONSTEXPR Index outerStride() const EIGEN_NOEXCEPT {
               return internal::traits<BlockType>::HasSameStorageOrderAsXprType ? m_xpr.outerStride()
                                                                                : m_xpr.innerStride();
            }
         ...
         protected:
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void init() {
               m_outerStride = internal::traits<BlockType>::HasSameStorageOrderAsXprType ? m_xpr.outerStride()
                                                                                         : m_xpr.innerStride();
            }
