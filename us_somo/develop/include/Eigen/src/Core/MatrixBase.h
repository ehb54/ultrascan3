   ...
   class MatrixBase : public DenseBase<Derived> {
      ...
      * \sa rows(), cols(), SizeAtCompileTime. */
         ...
         typedef typename internal::conditional<
            NumTraits<Scalar>::IsComplex, CwiseUnaryOp<internal::scalar_conjugate_op<Scalar>, ConstTransposeReturnType>,
...
#undef EIGEN_DOC_UNARY_ADDONS
      ...
      * \sa ArrayBase::matrix() */
         ...
         enum {
            HomogeneousReturnTypeDirection = ColsAtCompileTime == 1 && RowsAtCompileTime == 1
         ...
         typedef Block<
            const Derived, internal::traits<Derived>::ColsAtCompileTime == 1 ? SizeMinusOne : 1,
