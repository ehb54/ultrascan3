  ...
  */
   ...
   namespace internal {
      ...
      struct matrix_type_times_scalar_type {
            typedef
               typename ScalarBinaryOpTraits<OtherScalarType, typename MatrixType::Scalar>::ReturnType ResultScalar;
            typedef Matrix<
   ...
   class HouseholderSequence : public EigenBase<HouseholderSequence<VectorsType, CoeffsType, Side>> {
      ...
      public:
         ...
         typedef HouseholderSequence<
            typename internal::conditional<
               ...
               typename internal::remove_all<typename VectorsType::ConjugateReturnType>::type, VectorsType>::type,
            typename internal::conditional<
               NumTraits<Scalar>::IsComplex,
               typename internal::remove_all<typename CoeffsType::ConjugateReturnType>::type, CoeffsType>::type,
            Side>
            ConjugateReturnType;
         ...
         typedef HouseholderSequence<
            typename internal::add_const<VectorsType>::type, typename internal::add_const<CoeffsType>::type, Side>
      ...
      */
         ...
         HouseholderSequence(const HouseholderSequence &other) :
             m_vectors(other.m_vectors), m_coeffs(other.m_coeffs), m_reverse(other.m_reverse), m_length(other.m_length),
     ...
     */
         ...
         EIGEN_DEVICE_FUNC inline
            typename internal::conditional<Cond, ConjugateReturnType, ConstHouseholderSequence>::type
            conjugateIf() const {
            typedef
               typename internal::conditional<Cond, ConjugateReturnType, ConstHouseholderSequence>::type ReturnType;
            ...
            if (m_length >= BlockSize && dst.cols() > 1) {
               ...
               for (Index i = 0; i < m_length; i += blockSize) {
                  ...
                  SubVectorsType sub_vecs1(
                     m_vectors.const_cast_derived(), Side == OnTheRight ? k : start, Side == OnTheRight ? start : k,
