...
****************************/
      ...
      struct compute_inverse_and_det_with_check<MatrixType, ResultType, 1> {
            ...
            static inline void run(
               const MatrixType &matrix, const typename MatrixType::RealScalar &absDeterminantThreshold,
...
****************************/
      ...
      EIGEN_DEVICE_FUNC inline void compute_inverse_size2_helper(
         const MatrixType &matrix, const typename ResultType::Scalar &invdet, ResultType &result) {
...
*************************/
   ...
   namespace internal {
      ...
      struct Assignment<
         DstXprType, Inverse<XprType>, internal::assign_op<typename DstXprType::Scalar, typename XprType::Scalar>,
         Dense2Dense> {
            ...
            static void run(
               ...
               eigen_assert(
                  ((Size <= 1) || (Size > 4) || (extract_data(src.nestedExpression()) != extract_data(dst)))
  ...
  */
   ...
   inline void MatrixBase<Derived>::computeInverseWithCheck(
      ResultType &inverse, bool &invertible, const RealScalar &absDeterminantThreshold) const {
      Scalar determinant;
      // i'd love to put some static assertions there, but SFINAE means that they have no effect...
      eigen_assert(rows() == cols());
