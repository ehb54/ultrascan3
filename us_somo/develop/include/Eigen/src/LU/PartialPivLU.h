...
namespace Eigen {
  ...
  */
   ...
   namespace internal {
      ...
      struct partial_lu_impl {
            ...
            static const bool UnBlockedAtCompileTime = SizeAtCompileTime != Dynamic
                                                       && SizeAtCompileTime <= UnBlockedBound;
    ...
    */
            static Index unblocked_lu(MatrixTypeRef &lu, PivIndex *row_transpositions, PivIndex &nb_transpositions) {
               ...
               for (Index k = 0; k < endk; ++k) {
                  ...
                  Score biggest_in_corner = lu.col(k).tail(rows - k).unaryExpr(Scoring()).maxCoeff(
    ...
    */
            static Index blocked_lu(
               Index rows, Index cols, Scalar *lu_data, Index luStride, PivIndex *row_transpositions,
               ...
               for (Index k = 0; k < size; k += blockSize) {
                  ...
                  Index ret = blocked_lu(
                     trows + bs, bs, &lu.coeffRef(k, k), luStride, row_transpositions + k, nb_transpositions_in_panel,
                     16);
  ...
  */
      ...
      void partial_lu_inplace(
         ...
         eigen_assert(
            row_transpositions.size() < 2 || (&row_transpositions.coeffRef(1) - &row_transpositions.coeffRef(0)) == 1);
         ...
         partial_lu_impl<
            ...
            blocked_lu(
               lu.rows(), lu.cols(), &lu.coeffRef(0, 0), lu.outerStride(), &row_transpositions.coeffRef(0),
               nb_transpositions);
      }
 ...
 * This function is provided for debug purpose. */
   ...
   namespace internal {
      ...
      struct Assignment<
         ...
         internal::assign_op<typename DstXprType::Scalar, typename PartialPivLU<MatrixType>::Scalar>, Dense2Dense> {
