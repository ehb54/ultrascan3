  ...
  */
   ...
   void FullPivLU<MatrixType>::computeInPlace() {
      ...
      for (Index k = 0; k < size; ++k) {
         ...
         if (k < size - 1)
            m_lu.block(k + 1, k + 1, rows - k - 1, cols - k - 1).noalias() -= m_lu.col(k).tail(rows - k - 1)
 ...
 * This function is provided for debug purposes. */
   ...
   namespace internal {
      ...
      */
               ...
               Matrix<
                  typename MatrixType::Scalar, Dynamic, Dynamic, MatrixType::Options, MaxSmallDimAtCompileTime,
   ...
   */
   ...
   namespace internal {
      ...
      struct Assignment<
         ...
         internal::assign_op<typename DstXprType::Scalar, typename FullPivLU<MatrixType>::Scalar>, Dense2Dense> {
