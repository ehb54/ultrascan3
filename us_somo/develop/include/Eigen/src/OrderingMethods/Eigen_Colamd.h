...
template <typename IndexType>
static IndexType find_ordering (IndexType n_row, IndexType n_col,
                                IndexType Alen, RowStructure<IndexType> Row[],
                                ColStructure<IndexType> Col[], IndexType A[],
...
static inline void
set_defaults (double knobs[NKnobs])
{
  /* === Local variables ================================================== */
...
template <typename IndexType>
static bool
compute_ordering (IndexType n_row, IndexType n_col, IndexType Alen,
