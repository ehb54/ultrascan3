 ...
 * scaling transformation, but rather to make easier the constructions and
 * updates of Transform objects.
 *
...
public:
  ...
  operator* (const UniformScaling &other) const
  {
  ...
  inline UniformScaling<NewScalarType>
  cast () const
  {
  ...
  bool
  isApprox (const UniformScaling &other,
