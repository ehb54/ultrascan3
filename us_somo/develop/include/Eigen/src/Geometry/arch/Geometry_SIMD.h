...
struct quat_product<Architecture::Target, Derived, OtherDerived, float>
{
       ...
       const QuaternionBase<OtherDerived> &_b)
  {
    ...
    Packet4f s1 = pmul (vec4f_swizzle1 (a, 1, 2, 0, 2),
                        vec4f_swizzle1 (b, 2, 0, 1, 2));
    Packet4f s2 = pmul (vec4f_swizzle1 (a, 3, 3, 3, 1),
...
struct cross3_impl<Architecture::Target, VectorLhs, VectorRhs, float, true>
{
  ...
  run (const VectorLhs &lhs, const VectorRhs &rhs)
  {
    ...
    Packet4f mul1 = pmul (vec4f_swizzle1 (a, 1, 2, 0, 3),
                          vec4f_swizzle1 (b, 2, 0, 1, 3));
    Packet4f mul2 = pmul (vec4f_swizzle1 (a, 2, 0, 1, 3),
