...
namespace Eigen {
  ...
  */
   ...
   namespace internal {
      ...
      template<
         int Arch, typename VectorLhs, typename VectorRhs, typename Scalar = typename VectorLhs::Scalar,
         bool Vectorizable = bool((VectorLhs::Flags & VectorRhs::Flags) & PacketAccessBit)>
      struct cross3_impl {
            EIGEN_DEVICE_FUNC static inline typename internal::plain_matrix_type<VectorLhs>::type run(
