...
***************************************************************************/
  ...
  */
   ...
   class QuaternionBase : public RotationBase<Derived, 3> {
      public:
         ...
         typedef typename internal::conditional<
            bool(internal::traits<Derived>::Flags &LvalueBit), Scalar &, CoeffReturnType>::type NonConstCoeffReturnType;
    ...
    */
         ...
         EIGEN_DEVICE_FUNC inline typename internal::cast_return_type<Derived, Quaternion<NewScalarType>>::type cast()
            const;
...
***************************************************************************/
   ...
   QuaternionBase<Derived>::operator*(const QuaternionBase<OtherDerived> &other) const {
      ...
      return internal::quat_product<
         Architecture::Target, Derived, OtherDerived, typename internal::traits<Derived>::Scalar>::run(*this, other);
   }
