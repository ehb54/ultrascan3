  ...
  */
   ...
   void SparseLU<MatrixType, OrderingType>::factorize(const MatrixType &matrix) {
      ...
      for (jcol = 0; jcol < n;) {
         ...
         Base::panel_dfs(
            m, panel_size, jcol, m_mat, m_perm_r.indices(), nseg1, dense, panel_lsub, segrep, repfnz, xprune, marker,
            parent, xplore, m_glu);
         ...
         for (jj = jcol; jj < jcol + panel_size; jj++) {
            ...
            info = Base::column_dfs(
               m, jj, m_perm_r.indices(), m_perfv.maxsuper, nseg, panel_lsubk, segrep, repfnz_k, xprune, marker, parent,
               xplore, m_glu);
            if (info) {
         ...
         void solveInPlace(MatrixBase<Dest> &X) const {
            ...
            for (Index k = m_mapL.nsuper(); k >= 0; k--) {
               ...
               if (nsupc == 1) {
                  ...
                  Map<Matrix<Scalar, Dynamic, Dest::ColsAtCompileTime, ColMajor>, 0, OuterStride<>>
