      ...
      class SparseLUImpl {
         ...
         protected:
            ...
            void relax_snode(
               ...
               IndexVector &relax_end);
            Index snode_dfs(
               const Index jcol, const Index kcol, const MatrixType &mat, IndexVector &xprune, IndexVector &marker,
               GlobalLU_t &glu);
            Index snode_bmod(const Index jcol, const Index fsupc, ScalarVector &dense, GlobalLU_t &glu);
            Index pivotL(
               const Index jcol, const RealScalar &diagpivotthresh, IndexVector &perm_r, IndexVector &iperm_c,
               Index &pivrow, GlobalLU_t &glu);
            template<typename Traits>
            void dfs_kernel(
               const StorageIndex jj, IndexVector &perm_r, Index &nseg, IndexVector &panel_lsub, IndexVector &segrep,
            ...
            void panel_bmod(
               const Index m, const Index w, const Index jcol, const Index nseg, ScalarVector &dense,
            ...
            Index copy_to_ucol(
               const Index jcol, const Index nseg, IndexVector &segrep, BlockIndexVector repfnz, IndexVector &perm_r,
