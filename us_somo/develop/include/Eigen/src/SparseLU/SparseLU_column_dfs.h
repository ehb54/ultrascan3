...
namespace Eigen {
   ...
   namespace internal {
      ...
      struct column_dfs_traits : no_assignment_operator {
            ...
            column_dfs_traits(
               Index jcol, Index &jsuper, typename SparseLUImpl<Scalar, StorageIndex>::GlobalLU_t &glu,
 ...
 */
      ...
      Index SparseLUImpl<Scalar, StorageIndex>::column_dfs(
         const Index m, const Index jcol, IndexVector &perm_r, Index maxsuper, Index &nseg, BlockIndexVector lsub_col,
         IndexVector &segrep, BlockIndexVector repfnz, IndexVector &xprune, IndexVector &marker, IndexVector &parent,
         ...
         for (Index k = 0; ((k < m) ? lsub_col[ k ] != emptyIdxLU : false); k++) {
            ...
            dfs_kernel(
               StorageIndex(jcol), perm_r, nseg, glu.lsub, segrep, repfnz, xprune, marker2, parent, xplore, glu, nextl,
               krow, traits);
         } // for each nonzero ...
