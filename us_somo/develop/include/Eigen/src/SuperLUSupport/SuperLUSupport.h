...
#define DECL_GSSVX(PREFIX, FLOATTYPE, KEYTYPE) \
   ...
   extern void PREFIX##gssvx( \
      superlu_options_t *, SuperMatrix *, int *, int *, int *, char *, FLOATTYPE *, FLOATTYPE *, SuperMatrix *, \
      SuperMatrix *, void *, int, SuperMatrix *, SuperMatrix *, FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, \
      GlobalLU_t *, mem_usage_t *, SuperLUStat_t *, int *); \
   } \
   inline float SuperLU_gssvx( \
      superlu_options_t *options, SuperMatrix *A, int *perm_c, int *perm_r, int *etree, char *equed, FLOATTYPE *R, \
      FLOATTYPE *C, SuperMatrix *L, SuperMatrix *U, void *work, int lwork, SuperMatrix *B, SuperMatrix *X, \
      FLOATTYPE *recip_pivot_growth, FLOATTYPE *rcond, FLOATTYPE *ferr, FLOATTYPE *berr, SuperLUStat_t *stats, \
      int *info, KEYTYPE) { \
      mem_usage_t mem_usage; \
      GlobalLU_t gLU; \
      PREFIX##gssvx( \
         options, A, perm_c, perm_r, etree, equed, R, C, L, U, work, lwork, B, X, recip_pivot_growth, rcond, ferr, \
...
#define DECL_GSISX(PREFIX, FLOATTYPE, KEYTYPE) \
   ...
   extern void PREFIX##gsisx( \
      superlu_options_t *, SuperMatrix *, int *, int *, int *, char *, FLOATTYPE *, FLOATTYPE *, SuperMatrix *, \
      SuperMatrix *, void *, int, SuperMatrix *, SuperMatrix *, FLOATTYPE *, FLOATTYPE *, mem_usage_t *, \
      SuperLUStat_t *, int *); \
   } \
   inline float SuperLU_gsisx( \
      superlu_options_t *options, SuperMatrix *A, int *perm_c, int *perm_r, int *etree, char *equed, FLOATTYPE *R, \
      FLOATTYPE *C, SuperMatrix *L, SuperMatrix *U, void *work, int lwork, SuperMatrix *B, SuperMatrix *X, \
      FLOATTYPE *recip_pivot_growth, FLOATTYPE *rcond, SuperLUStat_t *stats, int *info, KEYTYPE) { \
      mem_usage_t mem_usage; \
      PREFIX##gsisx( \
         options, A, perm_c, perm_r, etree, equed, R, C, L, U, work, lwork, B, X, recip_pivot_growth, rcond, \
  ...
  */
   ...
   void SuperLU<MatrixType>::factorize(const MatrixType &a) {
      ...
      StatInit(&m_sluStat);
      SuperLU_gssvx(
         &m_sluOptions, &m_sluA, m_q.data(), m_p.data(), &m_sluEtree[ 0 ], &m_sluEqued, &m_sluRscale[ 0 ],
   ...
   void SuperLU<MatrixType>::_solve_impl(const MatrixBase<Rhs> &b, MatrixBase<Dest> &x) const {
      ...
      SuperLU_gssvx(
         &m_sluOptions, &m_sluA, m_q.data(), m_p.data(), &m_sluEtree[ 0 ], &m_sluEqued, &m_sluRscale[ 0 ],
         &m_sluCscale[ 0 ], &m_sluL, &m_sluU, NULL, 0, &m_sluB, &m_sluX, &recip_pivot_growth, &rcond, &m_sluFerr[ 0 ],
         &m_sluBerr[ 0 ], &m_sluStat, &info, Scalar());
      StatFree(&m_sluStat);
   ...
   void SuperLUBase<MatrixType, Derived>::extractData() const {
      eigen_assert(
         m_factorizationIsOk
         && "The decomposition is not in a valid state for extracting factors, you must first call either compute() or "
            "analyzePattern()/factorize()");
      if (m_extractedDataAreDirty) {
         int upper;
...
#define EIGEN_SUPERLU_HAS_ILU
  ...
  */
   ...
   void SuperILU<MatrixType>::factorize(const MatrixType &a) {
      ...
      SuperLU_gsisx(
         &m_sluOptions, &m_sluA, m_q.data(), m_p.data(), &m_sluEtree[ 0 ], &m_sluEqued, &m_sluRscale[ 0 ],
         &m_sluCscale[ 0 ], &m_sluL, &m_sluU, NULL, 0, &m_sluB, &m_sluX, &recip_pivot_growth, &rcond, &m_sluStat, &info,
         Scalar());
      StatFree(&m_sluStat);
