...
public:
  ...
  void
  grab (const EigenBase<MatrixDerived> &mat)
  {
  ...
  void
  grab (const Ref<const MatrixType> &mat)
  {
...
public:
  ...
  void
  _solve_with_guess_impl (const Rhs &b,
                          SparseMatrixBase<DestDerived> &aDest) const
  {
    ...
    // of aliasing issue. For non square least-square problems, b and dest
    // might not have the same size whereas they might alias each-other.
