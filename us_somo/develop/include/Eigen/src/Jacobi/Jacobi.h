...
****************************************************************************************/
  ...
  */
      ...
      EIGEN_DEVICE_FUNC void apply_rotation_in_the_plane(
         DenseBase<VectorX> &xpr_x, DenseBase<VectorY> &xpr_y, const JacobiRotation<OtherScalar> &j);
   } // namespace internal
  ...
  */
   ...
   namespace internal {
      ...
      struct apply_rotation_in_the_plane_selector {
            static EIGEN_DEVICE_FUNC inline void run(
               Scalar *x, Index incrx, Scalar *y, Index incry, Index size, OtherScalar c, OtherScalar s) {
            ...
            static inline void run(
               ...
               /*** non-vectorized path ***/
                  ...
                  apply_rotation_in_the_plane_selector<
                     Scalar, OtherScalar, SizeAtCompileTime, MinAlignment, false>::run(x, incrx, y, incry, size, c, s);
               }
            }
      };
