...
namespace Eigen {
  ...
  */
   ...
   inline int klu_solve(
      klu_symbolic *Symbolic, klu_numeric *Numeric, Index ldim, Index nrhs, std::complex<double> B[],
      klu_common *Common, std::complex<double>) {
      return klu_z_solve(
         Symbolic, Numeric, internal::convert_index<int>(ldim), internal::convert_index<int>(nrhs),
   ...
   inline klu_numeric *klu_factor(
      int Ap[], int Ai[], std::complex<double> Ax[], klu_symbolic *Symbolic, klu_common *Common, std::complex<double>) {
      ...
      protected:
         ...
         void analyzePattern_impl() {
            ...
            m_symbolic = klu_analyze(
               internal::convert_index<int>(mp_matrix.rows()), const_cast<StorageIndex *>(mp_matrix.outerIndexPtr()),
         ...
         void factorize_impl() {
            m_numeric = klu_factor(
               ...
               const_cast<StorageIndex *>(mp_matrix.innerIndexPtr()), const_cast<Scalar *>(mp_matrix.valuePtr()),
