...
inline int
klu_solve (klu_symbolic *Symbolic, klu_numeric *Numeric, Index ldim,
...
inline int
klu_tsolve (klu_symbolic *Symbolic, klu_numeric *Numeric, Index ldim,
            Index nrhs, double B[], klu_common *Common, double)
{
...
inline klu_numeric *
klu_factor (int Ap[], int Ai[], double Ax[], klu_symbolic *Symbolic,
...
inline klu_numeric *
klu_factor (int Ap[], int Ai[], std::complex<double> Ax[],
            klu_symbolic *Symbolic, klu_common *Common, std::complex<double>)
{
...
template <typename BDerived, typename XDerived>
bool
KLU<MatrixType>::_solve_impl (const MatrixBase<BDerived> &b,
                              MatrixBase<XDerived> &x) const
{
