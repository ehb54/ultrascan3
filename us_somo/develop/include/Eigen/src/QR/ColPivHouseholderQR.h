   ...
   class ColPivHouseholderQR : public SolverBase<ColPivHouseholderQR<_MatrixType>> {
      public:
         ...
         typedef HouseholderSequence<
            MatrixType, typename internal::remove_all<typename HCoeffsType::ConjugateReturnType>::type>
    ...
    */
      ...
      */
         ColPivHouseholderQR(Index rows, Index cols) :
             ...
             m_colsTranspositions(cols), m_temp(cols), m_colNormsUpdated(cols), m_colNormsDirect(cols),
      ...
      */
         ...
         explicit ColPivHouseholderQR(const EigenBase<InputType> &matrix) :
             ...
             m_colsPermutation(PermIndexType(matrix.cols())), m_colsTranspositions(matrix.cols()),
             m_temp(matrix.cols()), m_colNormsUpdated(matrix.cols()), m_colNormsDirect(matrix.cols()),
             m_isInitialized(false), m_usePrescribedThreshold(false) {
  ...
  */
   ...
   namespace internal {
      ...
      struct Assignment<
         ...
         internal::assign_op<typename DstXprType::Scalar, typename ColPivHouseholderQR<MatrixType>::Scalar>, Dense2Dense> {
