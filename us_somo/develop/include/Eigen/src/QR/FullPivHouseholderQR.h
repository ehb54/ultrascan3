  ...
  */
   ...
   class FullPivHouseholderQR : public SolverBase<FullPivHouseholderQR<_MatrixType>> {
      public:
         ...
         typedef Matrix<
            StorageIndex, 1, EIGEN_SIZE_MIN_PREFER_DYNAMIC(ColsAtCompileTime, RowsAtCompileTime), RowMajor, 1,
      ...
      */
         FullPivHouseholderQR(Index rows, Index cols) :
             ...
             m_cols_transpositions((std::min)(rows, cols)), m_cols_permutation(cols), m_temp(cols),
             m_isInitialized(false), m_usePrescribedThreshold(false) {}
      ...
      struct FullPivHouseholderQRMatrixQReturnType
         ...
         public:
            ...
            FullPivHouseholderQRMatrixQReturnType(
               const MatrixType &qr, const HCoeffsType &hCoeffs, const IntDiagSizeVectorType &rowsTranspositions) :
