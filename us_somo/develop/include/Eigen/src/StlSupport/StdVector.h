...
/**
 * This section contains a convenience MACRO which allows an easy
 * specialization of std::vector such that for data types with alignment issues
 * the correct allocator is used automatically.
 */
                        ...
                        EIGEN_WORKAROUND_MSVC_STL_SUPPORT (T)> >
{
  ...
  void
  insert (const_iterator position, size_type new_size, const value_type &x)
  {
   ...
   * still needed to make the above EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION
   * trick to work. */
  void
  resize (size_type new_size, const value_type &x)
  {
