...
// Report info
inline void
umfpack_report_info (double control[UMFPACK_CONTROL],
...
inline void
umfpack_report_info (double control[UMFPACK_CONTROL],
                     double info[UMFPACK_INFO], std::complex<double>, int)
{
...
inline void
umfpack_report_info (double control[UMFPACK_CONTROL],
                     double info[UMFPACK_INFO], double, SuiteSparse_long)
{
...
// Report status
inline void
umfpack_report_status (double control[UMFPACK_CONTROL], int status, double,
                       int)
{
...
inline void
umfpack_report_status (double control[UMFPACK_CONTROL], int status,
...
inline void
umfpack_report_control (double control[UMFPACK_CONTROL], std::complex<double>,
                        int)
{
...
inline void
umfpack_report_control (double control[UMFPACK_CONTROL], double,
                        SuiteSparse_long)
{
...
// Symbolic
inline int
umfpack_symbolic (int n_row, int n_col, const int Ap[], const int Ai[],
...
inline int
umfpack_numeric (const int Ap[], const int Ai[],
                 const std::complex<double> Ax[], void *Symbolic,
...
inline SuiteSparse_long
umfpack_numeric (const SuiteSparse_long Ap[], const SuiteSparse_long Ai[],
...
inline int
umfpack_solve (int sys, const int Ap[], const int Ai[],
               ...
               double Info[UMFPACK_INFO])
{
  return umfpack_zi_solve (
      sys, Ap, Ai, &numext::real_ref (Ax[0]), 0, &numext::real_ref (X[0]), 0,
      &numext::real_ref (B[0]), 0, Numeric, Control, Info);
}

inline SuiteSparse_long
umfpack_solve (int sys, const SuiteSparse_long Ap[],
...
// Get Lunz
inline int
umfpack_get_lunz (int *lnz, int *unz, int *n_row, int *n_col, int *nz_udiag,
                  void *Numeric, double)
{
...
// Get Numeric
inline int
umfpack_get_numeric (int Lp[], int Lj[], double Lx[], int Up[], int Ui[],
                     double Ux[], int P[], int Q[], double Dx[], int *do_recip,
...
inline int
umfpack_get_numeric (int Lp[], int Lj[], std::complex<double> Lx[], int Up[],
                     int Ui[], std::complex<double> Ux[], int P[], int Q[],
                     std::complex<double> Dx[], int *do_recip, double Rs[],
                     void *Numeric)
{
...
umfpack_get_numeric (SuiteSparse_long Lp[], SuiteSparse_long Lj[],
                     std::complex<double> Lx[], SuiteSparse_long Up[],
                     SuiteSparse_long Ui[], std::complex<double> Ux[],
                     SuiteSparse_long P[], SuiteSparse_long Q[],
                     std::complex<double> Dx[], SuiteSparse_long *do_recip,
                     double Rs[], void *Numeric)
{
  double &lx0_real = numext::real_ref (Lx[0]);
  double &ux0_real = numext::real_ref (Ux[0]);
...
// Get Determinant
inline int
umfpack_get_determinant (double *Mx, double *Ex, void *NumericHandle,
...
inline int
umfpack_get_determinant (std::complex<double> *Mx, double *Ex,
 ...
 * and full rank. The vectors or matrices X and B can be either dense or
 * sparse.
 *
...
template <typename BDerived, typename XDerived>
bool
UmfPackLU<MatrixType>::_solve_impl (const MatrixBase<BDerived> &b,
                                    MatrixBase<XDerived> &x) const
{
  ...
  for (int j = 0; j < rhsCols; ++j)
    {
      ...
      StorageIndex errorCode = umfpack_solve (
          ...
          mp_matrix.valuePtr (), x_ptr,
          &b.const_cast_derived ().col (j).coeffRef (0), m_numeric,
