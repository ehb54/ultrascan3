...
protected:
   ...
   */
  internal::LowerBoundIndex
  lower_bound (Index row, Index col) const
  {
...
public:
  ...
  InnerIterator &
  operator= (const InnerIterator &other)
  {
  ...
  explicit InnerIterator (const SparseCompressedBase &mat)
      : m_values (mat.valuePtr ()), m_indices (mat.innerIndexPtr ()),
        m_outer (0), m_id (0), m_end (mat.nonZeros ())
  {
...
public:
  ...
  explicit ReverseInnerIterator (const SparseCompressedBase &mat)
      : m_values (mat.valuePtr ()), m_indices (mat.innerIndexPtr ()),
        m_outer (0), m_start (0), m_id (mat.nonZeros ())
  {
    EIGEN_STATIC_ASSERT_VECTOR_ONLY (Derived);
  }
...
protected:
  Index
  find (Index row, Index col) const
  {
