...
#define EIGEN_DOC_UNARY_ADDONS( \
   METHOD, \
   OP) /** <p>This method does not change the sparsity of \c *this: the OP is applied to explicitly stored coefficients only. \sa SparseCompressedBase::coeffs() </p> */
...
#define EIGEN_DOC_BLOCK_ADDONS_INNER_PANEL_IF( \
   COND) /** <p> \warning This method returns a read-write expression for COND sparse matrices only. Otherwise, the returned expression is read-only. \sa \ref TutorialSparse_SubMatrices "Sparse block operations" </p> */
#else
...
#undef EIGEN_DOC_BLOCK_ADDONS_INNER_PANEL_IF
      ...
      * i.e., the number of rows for a columns major matrix, and the number of cols otherwise */
      ...
      public:
         ...
         template<typename OtherDerived>
         bool isApprox(
            const MatrixBase<OtherDerived> &other, const RealScalar &prec = NumTraits<Scalar>::dummy_precision()) const {
