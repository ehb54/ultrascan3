...
// This is tricky because implementing an inner iterator on top of an
// IndexBased evaluator is not easy because the evaluators do not expose the
// sizes of the underlying expression.
...
public:
  ...
  public:
    EIGEN_STRONG_INLINE
    InnerIterator (const unary_evaluator &sve, Index outer)
