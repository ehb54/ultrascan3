   ...
   namespace internal {
      ...
      void assign_sparse_to_sparse(DstXprType &dst, const SrcXprType &src) {
         ...
         if ((!transpose) && src.isRValue()) {
            ...
            eigen_assert(
               (((internal::traits<DstXprType>::SupportedAccessPatterns & OuterRandomAccessPattern)
      ...
      struct Assignment<DstXprType, SrcXprType, Functor, Sparse2Dense, Weak> {
            static void run(DstXprType &dst, const SrcXprType &src, const Functor &func) {
               if (internal::is_same<
                      Functor, internal::assign_op<typename DstXprType::Scalar, typename SrcXprType::Scalar>>::value)
                  dst.setZero();
      ...
      struct assignment_from_dense_op_sparse {
            ...
            run(
               DstXprType &dst, const CwiseBinaryOp<internal::scalar_sum_op<Scalar, Scalar>, const Lhs, const Rhs> &src,
            ...
            run(
               ...
               call_assignment_no_alias(
                  dst, src.lhs(), add_assign_op<typename DstXprType::Scalar, typename Lhs::Scalar>());
            }
      };
   ...
   struct Assignment< \
      ...
      typename internal::enable_if< \
       ...
       : assignment_from_dense_op_sparse< \
            DstXprType, internal::ASSIGN_OP<typename DstXprType::Scalar, typename Lhs::Scalar>, \
      ...
      struct Assignment<DstXprType, SrcXprType, Functor, Diagonal2Sparse> {
            ...
            static void run(
               SparseMatrix<Scalar, Options, StorageIndex> &dst, const SrcXprType &src, const AssignFunc &func) {
