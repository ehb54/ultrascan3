...
namespace Eigen {
  ...
  */
   ...
   class SparseMapBase<Derived, ReadOnlyAccessors> : public SparseCompressedBase<Derived> {
      ...
      protected:
         typedef
            typename internal::conditional<bool(internal::is_lvalue<Derived>::value), Scalar *, const Scalar *>::type
               ScalarPointer;
         typedef typename internal::conditional<
            bool(internal::is_lvalue<Derived>::value), StorageIndex *, const StorageIndex *>::type IndexPointer;
      ...
      public:
         ...
         inline SparseMapBase(
            Index rows, Index cols, Index nnz, IndexPointer outerIndexPtr, IndexPointer innerIndexPtr,
  ...
  */
   ...
   class SparseMapBase<Derived, WriteAccessors> : public SparseMapBase<Derived, ReadOnlyAccessors> {
      ...
      public:
         ...
         inline SparseMapBase(
            Index rows, Index cols, Index nnz, StorageIndex *outerIndexPtr, StorageIndex *innerIndexPtr,
...
/** \ingroup SparseCore_Module
  ...
  */
   ...
   class Map<const SparseMatrix<MatScalar, MatOptions, MatIndex>, Options, StrideType>
      ...
      */
         inline Map(
            Index rows, Index cols, Index nnz, const StorageIndex *outerIndexPtr, const StorageIndex *innerIndexPtr,
