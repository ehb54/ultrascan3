      ...
      class sparse_matrix_block_impl
         ...
         public:
            ...
            inline BlockType &operator=(const SparseMatrixBase<OtherDerived> &other) {
               ...
               Index free_size = m_matrix.isCompressed() ? Index(matrix.data().allocatedSize()) + block_size
                                                         : block_size;
               ...
               if (nnz > free_size) {
                  ...
                  internal::smart_copy(
                     matrix.innerIndexPtr() + end, matrix.innerIndexPtr() + end + tail_size,
                  ...
                  internal::smart_copy(
                     tmp.innerIndexPtr() + tmp_start, tmp.innerIndexPtr() + tmp_start + nnz,
            ...
            const Scalar &lastCoeff() const {
               ...
               if (m_matrix.isCompressed())
                  ...
                  return m_matrix.valuePtr()
                     [ m_matrix.outerIndexPtr()[ m_outerStart ] + m_matrix.innerNonZeroPtr()[ m_outerStart ] - 1 ];
            }
   ...
   namespace internal {
      ...
      struct unary_evaluator<Block<ArgType, BlockRows, BlockCols, InnerPanel>, IteratorBased>
         ...
         public:
            ...
            typedef
               typename internal::conditional<OuterVector, OuterVectorInnerIterator, InnerVectorInnerIterator>::type
                  InnerIterator;
      ...
      class unary_evaluator<Block<ArgType, BlockRows, BlockCols, InnerPanel>, IteratorBased>::InnerVectorInnerIterator
         ...
         public:
            EIGEN_STRONG_INLINE InnerVectorInnerIterator(const unary_evaluator &aEval, Index outer) :
                EvalIterator(
                   aEval.m_argImpl, outer + (XprIsRowMajor ? aEval.m_block.startRow() : aEval.m_block.startCol())),
                m_block(aEval.m_block), m_end(
         ...
         public:
            ...
            inline StorageIndex index() const {
               return convert_index<StorageIndex>(
                  m_outerPos - (XprIsRowMajor ? m_eval.m_block.startCol() : m_eval.m_block.startRow()));
            }
      ...
      struct unary_evaluator<
         Block<SparseMatrix<_Scalar, _Options, _StorageIndex>, BlockRows, BlockCols, true>, IteratorBased>
          : evaluator<
               SparseCompressedBase<Block<SparseMatrix<_Scalar, _Options, _StorageIndex>, BlockRows, BlockCols, true>>> {
      ...
      template<typename _Scalar, int _Options, typename _StorageIndex, int BlockRows, int BlockCols>
      struct unary_evaluator<
         Block<const SparseMatrix<_Scalar, _Options, _StorageIndex>, BlockRows, BlockCols, true>, IteratorBased>
