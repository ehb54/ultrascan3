...
namespace Eigen {
  ...
  * */
      ...
      struct generic_product_impl<Lhs, Rhs, SparseShape, SparseShape, ProductType> {
            ...
            static void addTo(
               ...
               internal::sparse_sparse_to_dense_product_selector<
                  typename remove_all<LhsNested>::type, typename remove_all<RhsNested>::type,
   ...
   SparseMatrix<Scalar, _Options, _StorageIndex> &SparseMatrix<Scalar, _Options, _StorageIndex>::operator=(
