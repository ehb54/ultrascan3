...
//  4 - dense op dense
// Finally, we also need to distinguish between the product and other
// operations :
...
//                         generic      dense
//
// TODO to ease compiler job, we could specialize product/quotient with a
// scalar
...
public:
  ...
  public:
    EIGEN_STRONG_INLINE
    InnerIterator (const binary_evaluator &aEval, Index outer)
  ...
  explicit binary_evaluator (const XprType &xpr)
      : m_functor (xpr.functor ()), m_lhsImpl (xpr.lhs ()),
        m_rhsImpl (xpr.rhs ())
  {
