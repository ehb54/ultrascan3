...
namespace Eigen {
   ...
   namespace internal {
      ...
      static void sparse_sparse_product_with_pruning_impl(
         const Lhs &lhs, const Rhs &rhs, ResultType &res, const typename ResultType::RealScalar &tolerance) {
      ...
      template<
         typename Lhs, typename Rhs, typename ResultType, int LhsStorageOrder = traits<Lhs>::Flags & RowMajorBit,
      ...
      struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, RowMajor, ColMajor, RowMajor> {
            ...
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance) {
               ...
               sparse_sparse_product_with_pruning_selector<
                  Lhs, RowMajorMatrixRhs, ResultType, RowMajor, RowMajor, RowMajor>(lhs, rowRhs, res, tolerance);
            }
      };
