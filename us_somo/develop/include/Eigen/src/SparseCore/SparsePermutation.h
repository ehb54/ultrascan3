   ...
   namespace internal {
      ...
      struct permutation_matrix_product<ExpressionType, Side, Transposed, SparseShape> {
            ...
            typedef typename internal::conditional<
               ...
               SparseMatrix<Scalar, int(SrcStorageOrder) == RowMajor ? ColMajor : RowMajor, StorageIndex>>::type
               ReturnType;
   ...
   namespace internal {
      ...
      struct product_evaluator<Product<Lhs, Rhs, AliasFreeProduct>, ProductTag, PermutationShape, SparseShape>
          : public evaluator<typename permutation_matrix_product<Rhs, OnTheLeft, false, SparseShape>::ReturnType> {
            ...
            explicit product_evaluator(const XprType &xpr) : m_result(xpr.rows(), xpr.cols()) {
               ...
               generic_product_impl<Lhs, Rhs, PermutationShape, SparseShape, ProductTag>::evalTo(
      ...
      struct product_evaluator<Product<Lhs, Rhs, AliasFreeProduct>, ProductTag, SparseShape, PermutationShape>
          : public evaluator<typename permutation_matrix_product<Lhs, OnTheRight, false, SparseShape>::ReturnType> {
            ...
            explicit product_evaluator(const XprType &xpr) : m_result(xpr.rows(), xpr.cols()) {
               ::new (static_cast<Base *>(this)) Base(m_result);
               generic_product_impl<Lhs, Rhs, SparseShape, PermutationShape, ProductTag>::evalTo(
                  m_result, xpr.lhs(), xpr.rhs());
            }
