#ifndef US_HYDRODYN_DAD_MOVIE_H
#define US_HYDRODYN_DAD_MOVIE_H
...
class US_EXTERN US_Hydrodyn_Dad_Movie : public QDialog {
   ...
   public:
      US_Hydrodyn_Dad_Movie(US_Hydrodyn_Dad *dad_win, QWidget *p = 0, const char *name = 0);

      ~US_Hydrodyn_Dad_Movie();
