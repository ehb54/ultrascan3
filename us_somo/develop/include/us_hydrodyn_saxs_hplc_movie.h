#ifndef US_HYDRODYN_SAXS_HPLC_MOVIE_H
#define US_HYDRODYN_SAXS_HPLC_MOVIE_H
...
class US_EXTERN US_Hydrodyn_Saxs_Hplc_Movie : public QDialog {
      Q_OBJECT

   public:
      US_Hydrodyn_Saxs_Hplc_Movie(US_Hydrodyn_Saxs_Hplc *hplc_win, QWidget *p = 0, const char *name = 0);

      ~US_Hydrodyn_Saxs_Hplc_Movie();
   ...
   private:
      ...
      vector<int> hplc_selected_files;
