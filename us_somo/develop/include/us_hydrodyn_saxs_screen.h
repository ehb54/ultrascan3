...
class US_EXTERN US_Hydrodyn_Saxs_Screen : public QFrame {
   ...
   public:
      US_Hydrodyn_Saxs_Screen(csv csv1, void *us_hydrodyn, QWidget *p = 0, const char *name = 0);
...
#pragma warning(default : 4251)
      ...
      void plot_one(
         QString message, QString message2, QString message3, QString message4, vector<double> radii,
         vector<double> intensity, double best_fit_radius, double best_fit_delta_rho, double average_radius,
         double average_delta_rho, double rg, bool use_chi2, double chi2_best, double chi2_nnls);
