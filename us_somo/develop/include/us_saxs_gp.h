...
public:
  ...
  // could be kept separately, as they really only belong to the root node of
  // an individual and would save a a bit of wasted memory
...
public:
  sgp_node *node;
  bool
  operator< (const sortable_sgp_node &objIn) const
  {
