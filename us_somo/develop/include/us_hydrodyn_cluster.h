...
class US_EXTERN US_Hydrodyn_Cluster : public QDialog {
 ...
 private:
  ...
  QString dmd_file_addition(QString inputfile, QString outputfile,
                            int use_entry = -1);
  unsigned int dmd_entry_count(
      QString inputfile);  // count entries for this file
  ...
  void create_additional_methods_pkg(QString base_dir, QString filename,
                                     QString common_prefix, bool use_extension);
  ...
  bool additional_processing(QString &out, QStringList &source_files,
                             const QString &type, const QString &method,
                             const QString &file = "");
