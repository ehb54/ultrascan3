...
public:
  ...
  void load (const QString &f, QString title = "", bool ourfmt = false,
             Qt::TextFormat fmt = Qt::RichText);
...
private:
  ...
  QAction *actionTextBold, *actionTextUnderline, *actionTextItalic,
      *actionTextColor, *actionAlignLeft, *actionAlignCenter,
      *actionAlignRight, *actionAlignJustify;
...
public:
  TextEdit (QWidget *parent = 0, const char *name = 0);
  TextEdit (int id, QWidget *parent = 0, const char *name = 0);
  void load (const QString &f, QString title = "",
             bool ourfmt = false /*, TextFormat fmt = RichText */);
  void load_text (QString text, QString title = "");
};
#endif
