...
class US_EXTERN US_File_Util {
 public:
  ...
  static bool writeuniq(QString &outname, QString &msg, QString basename,
...
class US_EXTERN US_Log {
 public:
  US_Log(QString name, bool autoflush = true,
         OpenMode mode = (OpenMode)0);  // mode will be OR'd with IO_WriteOnly
  ~US_Log();
