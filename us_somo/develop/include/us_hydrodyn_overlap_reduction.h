...
class US_EXTERN US_Hydrodyn_OR : public QFrame {
 ...
 public:
  US_Hydrodyn_OR(struct overlap_reduction *, bool *replicate_o_r_method,
                 vector<void *> *, void *, QWidget *p = 0,
                 const char *name = 0);
  ~US_Hydrodyn_OR();
 ...
 public:
  ...
  vector<void *>
      *other_ORs;  // this is to reference all _OR's when replication is used
