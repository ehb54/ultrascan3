#ifndef US_HYDRODYN_MALS_FIT_H
#define US_HYDRODYN_MALS_FIT_H
...
class US_EXTERN US_Hydrodyn_Mals_Fit : public QDialog {
  Q_OBJECT

  friend class US_Hydrodyn_Mals;

 public:
  US_Hydrodyn_Mals_Fit(US_Hydrodyn_Mals *mals_win, bool set_comm_dist = true,
                       QWidget *p = 0, const char *name = 0);
  ~US_Hydrodyn_Mals_Fit();
