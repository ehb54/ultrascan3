...
class US_Vector {
 public:
  ...
  static void printvector2(QString qs, vector<double> x, vector<double> y,
                           int digits = 8, unsigned int limit = 0);
  static void printvector3(QString qs, vector<double> x, vector<double> y,
                           vector<double> z, int digits = 8,
                           unsigned int limit = 0);
  static void printvector4(QString qs, vector<double> x, vector<double> y,
                           vector<double> z, vector<double> s, int digits = 8,
                           unsigned int limit = 0);
  static void printvector5(QString qs, vector<double> x, vector<double> y,
                           vector<double> z, vector<double> s, vector<double> t,
                           int digits = 8, unsigned int limit = 0);
  static void printvector7(QString qs, vector<double> x, vector<double> y,
                           vector<double> z, vector<double> s, vector<double> t,
                           vector<double> u, vector<double> v, int digits = 8,
                           unsigned int limit = 0);
  ...
  static QString qs_vector2(QString qs, vector<double> x, vector<double> y,
                            int digits = 8);
  static QString qs_vector2(QString qs, vector<int> x, vector<double> y,
                            int digits = 8);
  ...
  static QString qs_vector3(QString qs, vector<double> x, vector<double> y,
                            vector<double> z, int digits = 8);
  static QString qs_vector4(QString qs, vector<double> x, vector<double> y,
                            vector<double> z, vector<double> s, int digits = 8);
  static QString qs_vector_vector(QString qs, vector<vector<double> > m,
                                  int digits = 8);
