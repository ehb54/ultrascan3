...
class US_EXTERN US_Hydrodyn_Mals_Saxs : public QFrame {
 ...
 public:
  US_Hydrodyn_Mals_Saxs(csv csv1, void *us_hydrodyn, QWidget *p = 0);
 ...
 private:
  ...
  bool mals_saxs_load(const QString &filename, const QStringList &qsl,
                      QString &errormsg);
 ...
 private:
  ...
  void scale_pair_add_marker(QwtPlot *plot, double pos, QColor color,
                             QString text,
 ...
 private slots:
  ...
  bool scale_pair_fit_at_time(double time, int degree, const set<double> &q1,
                              const set<double> &q2, double &chi2);
