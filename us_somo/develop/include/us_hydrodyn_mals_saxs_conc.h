#ifndef US_HYDRODYN_MALS_SAXS_CONC_H
#define US_HYDRODYN_MALS_SAXS_CONC_H
...
class US_EXTERN US_Hydrodyn_Mals_Saxs_Conc : public QFrame {
      Q_OBJECT

      friend class US_Hydrodyn_Mals_Saxs;

   public:
      US_Hydrodyn_Mals_Saxs_Conc(csv &csv1, void *mals_saxs_window, QWidget *p = 0, const char *name = 0);
      ~US_Hydrodyn_Mals_Saxs_Conc();
