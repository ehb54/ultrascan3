...
class US_Hydrodyn_Zeno {
   public:
      US_Hydrodyn_Zeno(
         hydro_options *options, hydro_results *results, US_Log *us_log, US_Udp_Msg *us_udp_msg,
         QString *accumulated_msgs);
      /* US_Hydrodyn *           us_hydrodyn */
      /* ); */

      static bool test();
      bool run(QString filename, vector<PDB_atom> *bead_model, bool keep_files = false);
      bool run(
         QString filename, vector<PDB_atom> *bead_model, double &sum_mass, double &sum_volume, bool keep_files,
