...
void get_2d_limits(double ***, double *, double *, int, int,
                   int start_count1 = 0, int start_count2 = 0);
void get_2d_limits(float ***, float *, float *, int, int, int start_count1 = 0,
                   int start_count2 = 0);
void get_2d_limits(int ***, int *, int *, int, int, int start_count1 = 0,
                   int start_count2 = 0);

// Take an array of floats and returns it smoothed by a gaussian kernel with
// with width of smoothing level:
void US_EXTERN gaussian_smoothing(float **, unsigned int /*smoothing level*/,
                                  unsigned int /*number of datapoints*/);
...
float calc_bottom(int /* rotor */, int /* centerpiece */, int /* channel */,
                  unsigned int /* rpm */);
float calc_bottom(vector<struct rotorInfo>,
                  vector<struct centerpieceInfo> cp_list,
                  int /* rotor list index */, int /* centerpiece list index */,
