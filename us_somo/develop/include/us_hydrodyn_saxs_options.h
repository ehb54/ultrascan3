...
class US_EXTERN US_Hydrodyn_SaxsOptions : public QFrame {
   ...
   public:
      ...
      US_Hydrodyn_SaxsOptions(
         struct saxs_options *, bool *saxs_options_widget, bool *sas_options_saxs_widget, bool *sas_options_sans_widget,
         bool *sas_options_curve_widget, bool *sas_options_bead_model_widget, bool *sas_options_hydration_widget,
         bool *sas_options_guinier_widget, bool *sas_options_xsr_widget, bool *sas_options_misc_widget,
         bool *sas_options_experimental_widget, void *us_hydrodyn, QWidget *p = 0, const char *name = 0);
      ~US_Hydrodyn_SaxsOptions();
