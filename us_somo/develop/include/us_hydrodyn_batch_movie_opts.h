...
public:
  US_Hydrodyn_Batch_Movie_Opts (QString msg, QString *title, QString *dir,
                                ...
                                double *scale, bool *cancel_req,
                                bool *clean_up, bool *use_tc, QString *tc_unit,
                                double *tc_start, double *tc_delta,
                                float *tc_pointsize, bool *black_background,
                                bool *do_pat, QWidget *p = 0,
                                const char *name = 0);
