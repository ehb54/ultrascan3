#ifndef US_HYDRODYN_DAD_SVD_H
#define US_HYDRODYN_DAD_SVD_H
...
class US_EXTERN US_Hydrodyn_Dad_Svd : public QFrame {
  Q_OBJECT

 public:
  US_Hydrodyn_Dad_Svd(US_Hydrodyn_Dad *dad_win,
                      vector<QString> dad_selected_files, QWidget *p = 0);
 ...
 private:
  ...
  QPushButton *pb_efa_decomp_to_dad_saxs;
