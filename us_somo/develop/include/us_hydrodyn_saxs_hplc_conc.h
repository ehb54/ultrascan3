#ifndef US_HYDRODYN_SAXS_HPLC_CONC_H
#define US_HYDRODYN_SAXS_HPLC_CONC_H
...
class US_EXTERN US_Hydrodyn_Saxs_Hplc_Conc : public QFrame {
      Q_OBJECT

      friend class US_Hydrodyn_Saxs_Hplc;

   public:
      US_Hydrodyn_Saxs_Hplc_Conc(csv &csv1, void *saxs_hplc_window, QWidget *p = 0, const char *name = 0);
      ~US_Hydrodyn_Saxs_Hplc_Conc();
