#ifndef US_HYDRODYN_MALS_MOVIE_H
#define US_HYDRODYN_MALS_MOVIE_H
...
class US_EXTERN US_Hydrodyn_Mals_Movie : public QDialog {
      Q_OBJECT

   public:
      US_Hydrodyn_Mals_Movie(US_Hydrodyn_Mals *mals_win, QWidget *p = 0, const char *name = 0);

      ~US_Hydrodyn_Mals_Movie();
   ...
   private:
      ...
      vector<int> mals_selected_files;
