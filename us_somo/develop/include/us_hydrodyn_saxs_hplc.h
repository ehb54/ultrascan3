...
class ga_individual {
 public:
  ...
  bool operator==(const ga_individual &objIn) const { return v == objIn.v; }
  bool operator!=(const ga_individual &objIn) const { return v != objIn.v; }
};
...
class US_EXTERN US_Hydrodyn_Saxs_Hplc : public QFrame {
 ...
 public:
  US_Hydrodyn_Saxs_Hplc(csv csv1, void *us_hydrodyn, QWidget *p = 0);
 ...
 private:
  ...
  enum istarq_modes { ISTARQ_NONE, ISTARQ_CONC_GLOBAL, ISTARQ_CONC_POINTWISE };
 ...
 private:
  ...
  bool create_i_of_q_ng(set<QString> &fileset, double t_min = -1e99,
                        double t_max = 1e99);
  bool create_ihashq(QStringList files, double t_min = -1e99,
                     double t_max = 1e99);
  bool create_ihashq(set<QString> &fileset, double t_min = -1e99,
                     double t_max = 1e99);
