...
class ga_individual {
   public:
      vector<double> v;
      double fitness;
      bool operator<(const ga_individual &objIn) const { return fitness < objIn.fitness; }
...
class US_EXTERN US_Hydrodyn_Saxs_Hplc : public QFrame {
   ...
   private:
      ...
      enum pbmodes { PBMODE_MAIN, PBMODE_SEL, PBMODE_CROP, PBMODE_CONC, PBMODE_SD, PBMODE_FASTA, PBMODE_NONE };
   ...
   private:
      ...
      bool create_ihashq(QStringList files, double t_min = -1e99, double t_max = 1e99);
      bool create_ihashq(set<QString> &fileset, double t_min = -1e99, double t_max = 1e99);
