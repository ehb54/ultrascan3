...
int us_hydrodyn_supc_main_hydro(
   bool bead_model_from_file, misc_options misc, hydro_results *hydro_results, hydro_options *hydro,
   double use_overlap_tolerance, vector<vector<PDB_atom>> *bead_models, vector<int> *somo_processed,
