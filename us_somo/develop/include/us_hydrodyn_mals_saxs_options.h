#ifndef US_HYDRODYN_MALS_SAXS_OPTIONS_H
#define US_HYDRODYN_MALS_SAXS_OPTIONS_H
...
class US_EXTERN US_Hydrodyn_Mals_Saxs_Options : public QDialog {
      Q_OBJECT

      friend class US_Hydrodyn;

   public:
      US_Hydrodyn_Mals_Saxs_Options(map<QString, QString> *parameters, US_Hydrodyn *us_hydrodyn, QWidget *p = 0);
