...
public:
  ...
  // double radius;
  bool
  operator< (const pointmass &objIn) const
  {
...
public:
  ...
  bool compute (enum US_Fractal_Dimension::methods method,
  ...
  static QString
  method_name (enum US_Fractal_Dimension::methods method)
  {
    switch (method)
      {
      case USFD_BOX_MODEL:
...
private:
  ...
  bool
  compute_enright (const vector<pointmass> &points, double angstrom_start,
                   double angstrom_end, double angstrom_steps,
                   double enright_ca_pct_start, double enright_ca_pct_end,
                   double &fd // computed fractal dimension
                   ,
