...
class US_EXTERN US_Hydrodyn_Saxs : public QFrame {
 ...
 private:
  ...
  QString info_remember_mw(
      const QString &msg = "");  // report contents of remember_mw maps
  ...
  void plot_one_pr(vector<double> r, vector<double> pr, vector<double> pr_error,
                   QString name, bool skip_mw = false, bool do_replot = true);
  ...
  void plot_one_iqq(vector<double> q, vector<double> I, vector<double> I_error,
                    QString name);
  bool plotted;
  bool save_to_csv;
  ...
  void display_iqq_residuals(QString title, vector<double> q, vector<double> I1,
                             vector<double> I2, QColor plot_color,
                             vector<double> I_errors);
 ...
 private:
  ...
  bool compute_rg_to_progress(const vector<double> &r, const vector<double> &pr,
