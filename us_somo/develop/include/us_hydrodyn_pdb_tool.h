...
class US_EXTERN US_Hydrodyn_Pdb_Tool : public QFrame {
   ...
   private:
      ...
      double minimum_pair_distance(QTreeWidget *lv, QString chain_1, QString chain_2, QString &key_1, QString &key_2);
      ...
      bool sol2wat(
         QTreeWidget *lv, double use_radius = 0e0, QString filepath = "", int frame = 0, QString reportpath = "");
      ...
      set<QTreeWidgetItem *> get_exposed_set(QTreeWidget *lv, double max_asa, bool only_selected = false);
      set<QTreeWidgetItem *> get_exposed_set_naccess(
         QTreeWidget *lv, double max_asa, bool either_sc_or_mc, bool only_selected = false);
      ...
      map<QString, map<QString, map<int, vector<hydration_info>>>> hydration_summary_res;
      // rname, rnum, frame, hydration_info

      map<QString, map<QString, map<QString, map<int, vector<hydration_info>>>>> hydration_summary_res_atom;
