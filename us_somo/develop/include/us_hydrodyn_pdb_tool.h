...
private:
  ...
  void select_model (QTreeWidget *lv,
                     QString model); // selects just that model
  ...
  bool sol2wat (QTreeWidget *lv, double use_radius = 0e0,
                QString filepath = "", int frame = 0, QString reportpath = "");
