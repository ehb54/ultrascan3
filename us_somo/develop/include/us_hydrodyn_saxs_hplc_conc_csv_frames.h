...
#ifndef US_HYDRODYN_SAXS_HPLC_CONC_CSV_FRAMES_H
#define US_HYDRODYN_SAXS_HPLC_CONC_CSV_FRAMES_H
...
class US_EXTERN US_Hydrodyn_Saxs_Hplc_Conc_Csv_Frames : public QDialog
{
   Q_OBJECT
