#ifndef US_HYDRODYN_SAXS_IQQ_LOAD_CSV_H
#define US_HYDRODYN_SAXS_IQQ_LOAD_CSV_H
...
class US_EXTERN US_Hydrodyn_Saxs_Iqq_Load_Csv : public QDialog {
  Q_OBJECT

 public:
  US_Hydrodyn_Saxs_Iqq_Load_Csv(
      ...
      bool *run_ift, bool *use_SDs_for_fitting, QString *nnls_target,
      bool *clear_plot_first, bool expert_mode, void *us_hydrodyn,
