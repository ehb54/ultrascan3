...
#pragma warning(disable : 4251)
  ...
  void
  csv_merge_loaded_selected();  // takes all loaded selected pdbs, merges them
                                // and puts it on the loaded list and selects it
  ...
  //                            and you must enable_updates() afterwards. (there
  //                            are potential gui issues without this behaviour)
  ...
  QStringList csv_model_names(
      csv &csv1);  // returns a list of the names (primarily for updating
                   // lb_selected)
  ...
  bool csv_get_min_max(double &min, double &max, unsigned int &rows_used_count,
