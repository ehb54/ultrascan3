...
class US_EXTERN US_Hydrodyn_Saxs_Load_Csv : public QDialog {
 ...
 public:
  US_Hydrodyn_Saxs_Load_Csv(QString msg, QStringList *qsl_names,
                            QStringList *qsl_sel_names, QStringList *qsl,
                            QString loaded_filename, bool *create_avg,
                            bool *create_std_dev, bool *only_plot_stats,
                            bool *save_to_csv, QString *csv_filename,
                            bool *save_original_data, bool *run_nnls,
                            bool *nnls_plot_contrib, bool *nnls_csv,
                            bool *run_best_fit, bool *use_SDs_for_fitting,
                            QString *nnls_target, bool *clear_plot_first,
                            bool expert_mode, void *us_hydrodyn, QWidget *p = 0,
                            const char *name = 0);
