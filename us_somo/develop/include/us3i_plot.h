...
class US_EXTERN US_Plot : public QHBoxLayout {
 ...
 public:
  ...
  US_Plot(mQwtPlot*& plot, const QString&, const QString&, const QString&,
          QWidget* parent = 0);
...
class US_Plot_Colors {
 public:
  US_Plot_Colors(const QColor& background_color);  // background_color to try
                                                   // and avoid low contrast
