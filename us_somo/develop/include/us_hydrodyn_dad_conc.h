#ifndef US_HYDRODYN_DAD_CONC_H
#define US_HYDRODYN_DAD_CONC_H
...
class US_EXTERN US_Hydrodyn_Dad_Conc : public QFrame {
      Q_OBJECT

      friend class US_Hydrodyn_Dad;

   public:
      US_Hydrodyn_Dad_Conc(csv &csv1, void *dad_window, QWidget *p = 0, const char *name = 0);
      ~US_Hydrodyn_Dad_Conc();
