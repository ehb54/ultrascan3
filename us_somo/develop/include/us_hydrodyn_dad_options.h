#ifndef US_HYDRODYN_DAD_OPTIONS_H
#define US_HYDRODYN_DAD_OPTIONS_H
...
class US_EXTERN US_Hydrodyn_Dad_Options : public QDialog {
      Q_OBJECT

      friend class US_Hydrodyn;

   public:
      US_Hydrodyn_Dad_Options(map<QString, QString> *parameters, US_Hydrodyn *us_hydrodyn, QWidget *p = 0);
      ~US_Hydrodyn_Dad_Options();
