...
{
bool
plegendre (int l, int m, shd_double x, shd_double &result)
{
  shd_double fact;
  shd_double oldfact;
  shd_double pll = 0e0;
...
bool
chebev (shd_double a, shd_double b, shd_double c[], int m, shd_double x,
        shd_double &res)
{
  shd_double d = 0e0;
  shd_double dd = 0e0;
...
bool
beschb (shd_double x, shd_double &gam1, shd_double &gam2, shd_double &gampl,
        shd_double &gammi)
{
  shd_double xx;
  static shd_double c1[] = {
    -1.142022680371172e0, 6.516511267076e-3, 3.08709017308e-4, -3.470626964e-6,
    6.943764e-9,          3.6780e-11,        -1.36e-13
  };
...
bool
bessj (shd_double x, shd_double xnu, shd_double *rj)
{
  int isign;
  int i;
  int l;
  ...
  if (i > MAXIT)
    {
      std::cout << "nr::bessj x too large; try asymptotic expansion"
                << std::endl;
      return false;
    }
...
bool
sphbes (int n, shd_double x, shd_double &sj)
{
  shd_double order;
  shd_double rj;
...
{
bool
spherical_harmonic (int l, int m, shd_double theta, shd_double phi,
                    std::complex<shd_double> &result)
{
  ...
  /*
     printf( "sh pl l %d m %d theta %g p %g phi %g mphi %g cosmphi %g sinmphi
     %g p*cosmphi %g p*sinmphi %g\n", l, m, theta, p, phi, mphi, cos( mphi ),
     sin( mphi ),
     p * cos( mphi ),
     p * sin( mphi )
     );
...
bool
conj_spherical_harmonic (int l, int m, shd_double theta, shd_double phi,
                         std::complex<shd_double> &result)
{
  bool r_sign = false;
  bool i_sign = false;
...
bool
alt_conj_sh (int max_harmonics, float theta, float phi,
...
void
build_grid (std::vector<std::vector<shd_double> > &fib_grid, unsigned int size)
{
