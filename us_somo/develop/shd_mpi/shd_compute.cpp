...
bool
SHD::compute_amplitudes (vector<complex<float> > &Av)
{
      ...
      else
        {
          ...
          if (modelp->x[0] == 0 && modelp->x[1] == 0)
          ...
          else
            {
              ...
              //    ] << " " << datap->rtp[ 2 ] << endl; cout << "coord " <<
              //    modelp->x[ 0 ] << " " << modelp->x[ 1 ] << " " <<
              //    modelp->x[ 2 ] << endl; cout << "x^2 + y^2 " << (
              //    modelp->x[ 0 ] *
              //                              modelp->x[ 0 ] +
              //                              modelp->x[ 1 ] *
              //                              modelp->x[ 1 ] ) << endl;

              //    cout << "y / x^2 + y^2 " << ( modelp->x[ 1 ] / sqrt(
              //    modelp->x[ 0 ] *
              //                                                         modelp->x[
              //                                                         0 ] +
              //                                                         modelp->x[
              ...
              //    cout << "y / x^2 + y^2 " << ( modelp->x[ 1 ] / sqrt(
              //    (shd_double) ( modelp->x[ 0 ] *
              //                                                                        modelp->x[ 0 ] +
              //                                                                        modelp->x[ 1 ] *
              //                                                                        modelp->x[ 1 ] ) ) ) << endl;

              //    cout << "asin( y / x^2 + y^2 ) " << asin( ( modelp->x[ 1 ]
              //    / sqrt( modelp->x[ 0 ] *
              //                                                                       modelp->x[ 0 ] +
              //                                                                       modelp->x[ 1 ] *
              //                                                                       modelp->x[ 1 ] ) ) ) << endl;
              ...
              //    cout << "direct recompute: " << (M_PI - asin( ( modelp->x[
              //    1 ] / sqrt( (shd_double) ( modelp->x[ 0 ] *
              //                                                                                          modelp->x[ 0 ] +
              //                                                                                          modelp->x[ 1 ] *
              //                                                                                          modelp->x[ 1 ] ) ) ) ) ) << endl;
      ...
      for (unsigned int l = 0; l <= max_harmonics; ++l)
        {
          for (int m = -(int)l; m <= (int)l; ++m)
            {
              if (!sh::conj_spherical_harmonic (l, m, datap->rtp[1],
                                                datap->rtp[2], tmp_cd))
                {
...
#define ALT_SPHBES
  ...
  printf ("%d of %d: compute amplitudes model size %d rtp %gms %.2f leg %gms "
          "%.2f shbes %gms %.2f other %gms %.2f tot %gms\n",
          ...
          1e2 * (total_time - rtp_time - legendre_time - shbes_time)
              / total_time,
          total_time * 1e3);
#endif
