...
class SHS
{
 ...
 public:
   ...
   void build( int         max_harmonics,
               shd_double  delta,
               shd_double  max_x );
   
   bool  apply_natural_spline( vector < shd_double > &xa, 
                               vector < shd_double > &ya,
                               vector < shd_double > &y2a,
                               shd_double            x,
                               shd_double            &y );
   
   void natural_spline( vector < shd_double > &x, 
                        vector < shd_double > &y,
   ...
   bool apply_natural_spline( shd_double              x,
