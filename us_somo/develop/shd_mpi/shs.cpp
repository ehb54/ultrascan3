...
void
SHS::build (int max_harmonics, shd_double delta, shd_double max_x)
{
...
bool
SHS::apply_natural_spline (vector<shd_double> &xa, vector<shd_double> &ya,
...
void
SHS::natural_spline (vector<shd_double> &x, vector<shd_double> &y,
...
bool
SHS::apply_natural_spline (shd_double x, vector<shd_double> &yv)
{
  shd_double *xp;
  shd_double *yp;
...
bool
SHS::write_c_table (string oname)
{
  ...
  ofs << "static shd_double shbes_y[ " << y_t.size () << " ][ "
      << y_t[0].size () << " ] =" << endl;
  ofs << "  {" << endl;
