...
private slots:
  ...
  void
  http_readyRead (const Q3HttpResponseHeader &resp)
  {
  ...
  void
  http_stateChanged (int state)
  {
    std::cout << QString ("http state %1\n").arg (state);
  }

  void
  http_responseHeaderReceived (const Q3HttpResponseHeader &resp)
  {
  ...
  void
  http_dataSendProgress (int done, int total)
  {
    std::cout << "http: datasendprogress " << done << " " << total << "\n";
  }
  void
  http_dataReadProgress (int done, int total)
  {
    std::cout << "http: datareadprogress " << done << " " << total << "\n";
  }

  void
  http_requestStarted (int id)
  {
    std::cout << "http: requestStarted " << id << "\n";
  }

  void
  http_requestFinished (int id, bool error)
  {
