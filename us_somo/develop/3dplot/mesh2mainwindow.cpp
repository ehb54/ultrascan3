...
Mesh2MainWindow::Mesh2MainWindow(
   bool *widget_flag, QString tmp_xtitle, QString tmp_ytitle, vector<struct element_3D> tmp_solutes,
   SA2d_control_variables *tmp_sa2d_ctrl_vars, QWidget *parent, const char *name, Qt::WFlags f) :
   ...
   *widget_flag = true;
   ...
   /*
     ...
     {
     cout << "i: " << i << ", " << solutes[i].x << ", " << solutes[i].y << ", " << solutes[i].z << endl;
     }
   */
...
Mesh2MainWindow::Mesh2MainWindow(
   bool *widget_flag, QString tmp_xtitle, QString tmp_ytitle, QString tmp_ztitle, double **data,
   SA2d_control_variables *tmp_sa2d_ctrl_vars, QWidget *parent, const char *name, Qt::WFlags f) :
    Mesh2MainWindowBase(parent, name, f) {
   this->widget_flag = widget_flag;
   *widget_flag = true;
   ...
   dataWidget->loadFromData(
      data, (*sa2d_ctrl_vars).meshx, (*sa2d_ctrl_vars).meshy, (*sa2d_ctrl_vars).miny, (*sa2d_ctrl_vars).maxy,
      (*sa2d_ctrl_vars).minx, (*sa2d_ctrl_vars).maxx);
...
void Mesh2MainWindow::setParameters(
   QString xtitle, QString ytitle, QString ztitle, double **data, SA2d_control_variables *sa2d_ctrl_vars) {
...
void Mesh2MainWindow::setParameters(
   QString title_3d, QString xtitle, QString ytitle, QString ztitle, double **data,
...
Mesh2MainWindow::Mesh2MainWindow(
   bool *widget_flag, QString title_3d, QString tmp_xtitle, QString tmp_ytitle, QString tmp_ztitle, double **data,
   SA2d_control_variables *tmp_sa2d_ctrl_vars, QWidget *parent, const char *name, Qt::WFlags f) :
    Mesh2MainWindowBase(parent, name, f) {
   this->widget_flag = widget_flag;
   *widget_flag = true;
...
void Mesh2MainWindow::setParameters(
   QString xtitle, QString ytitle, vector<struct element_3D> solutes, SA2d_control_variables *sa2d_ctrl_vars) {
   this->sa2d_ctrl_vars = sa2d_ctrl_vars;
   this->solutes = solutes;
   this->xtitle = xtitle;
   this->ytitle = ytitle;
...
void Mesh2MainWindow::open() {
   QString s(Q3FileDialog::getOpenFileName("../../data", "GridData Files (*.mes *.MES)", this));
...
void Mesh2MainWindow::openMesh() {
   QString data(Q3FileDialog::getOpenFileName("../../data", "nodes (*.nod)", this));
   QString edges(Q3FileDialog::getOpenFileName("../../data", "connectivities (*.cel)", this));
