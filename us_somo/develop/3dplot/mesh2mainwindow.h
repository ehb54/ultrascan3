...
class Mesh2MainWindow : public Mesh2MainWindowBase {
   ...
   public:
      Mesh2MainWindow(
         bool *, QString, QString, vector<struct element_3D>, SA2d_control_variables *, QWidget *parent = 0,
         const char *name = 0, Qt::WFlags f = Qt::WType_TopLevel);
      Mesh2MainWindow(
         bool *, QString, QString, QString, double **, SA2d_control_variables *, QWidget *parent = 0,
         const char *name = 0, Qt::WFlags f = Qt::WType_TopLevel);
      Mesh2MainWindow(
         bool *, QString, QString, QString, QString, double **, SA2d_control_variables *, QWidget *parent = 0,
         const char *name = 0, Qt::WFlags f = Qt::WType_TopLevel);
      ~Mesh2MainWindow();
