...
Plot::Plot(QWidget *parent) : SurfacePlot(parent) {
   ...
   reset();
   assignMouse(
      Qt::LeftButton, Qt::RightButton, Qt::LeftButton, Qt::NoButton, Qt::NoButton, Qt::NoButton, Qt::NoButton,
...
LightingDlg::LightingDlg(QWidget *parent) : lightingdlgbaseBase(parent) {
