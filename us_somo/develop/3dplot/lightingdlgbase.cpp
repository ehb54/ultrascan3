 ...
 */
lightingdlgbaseBase::lightingdlgbaseBase(QWidget* parent, const char* name,
                                         bool modal, Qt::WFlags fl)
    : QDialog(parent, name, modal, fl) {
  if (!name) setName("lightingdlgbaseBase");
  ...
  lightingdlgbaseBaseLayout =
      new Q3GridLayout(this, 1, 1, 11, 6, "lightingdlgbaseBaseLayout");
  ...
  Horizontal_Spacing2 =
      new QSpacerItem(16, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
