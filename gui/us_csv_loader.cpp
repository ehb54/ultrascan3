...
bool CSVSortFilterProxyModel::lessThan(const QModelIndex &left, const QModelIndex &right) const {
...
US_CSV_Loader::US_CSV_Loader(const QString &filePath, const QString &note, bool editable, QWidget *parent) :
...
void US_CSV_Loader::save_csv_clicked() {
   ...
   QString file_path = QFileDialog::getSaveFileName(this, "Save CSV File", US_Settings::workBaseDir(), "(CSV)(*.csv)");
