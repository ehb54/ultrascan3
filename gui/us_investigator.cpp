...
void
US_Investigator::override_permit (bool is_enab)
{
  user_permit = is_enab;
...
void
US_Investigator::limit_names (const QString &s)
{
  lw_names->clear ();
...
void
US_Investigator::get_inv_data (QListWidgetItem *item)
{
...
bool
US_Investigator::check_fields (void)
{
  QString missing = "";
  QRegExp strip ("^\\s*(.*)\\s*$");
