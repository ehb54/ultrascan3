...
US_ResidsBitmap::US_ResidsBitmap(QVector<QVector<double>> &resids, QWidget *wparent) : US_WidgetsDialog(wparent, 0) {
...
void US_ResidsBitmap::replot(QVector<QVector<double>> &resids) {
   ...
   for (int ii = 0; ii < scanCount; ii++) { // get sum of squares for sigma (std.dev.)
