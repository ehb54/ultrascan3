...
class US_GUI_EXTERN US_Widgets : public QFrame {
   public:
      ...
      //! * Color is set to US_GuiSettings::normalColor()
      QHBoxLayout *us_timeedit(QTimeEdit *&, const int = 0, QSpinBox ** = ( QSpinBox ** ) NULL);
      ...
      QHBoxLayout *us_ddhhmmss(
         const int = 0, QSpinBox ** = ( QSpinBox ** ) NULL, QSpinBox ** = ( QSpinBox ** ) NULL,
         QSpinBox ** = ( QSpinBox ** ) NULL, QSpinBox ** = ( QSpinBox ** ) NULL);
      ...
      //! \param mm         - Optional pointer to min  QSpinBox pointer
      //! \param ss         - Optional pointer to sec  QSpinBox pointer
      QHBoxLayout *us_ddhhmmsslay(
         const int = 0, const int = 0, const int = 0, const int = 0, const int = 0, QSpinBox ** = ( QSpinBox ** ) NULL,
         QSpinBox ** = ( QSpinBox ** ) NULL, QSpinBox ** = ( QSpinBox ** ) NULL, QSpinBox ** = ( QSpinBox ** ) NULL);
