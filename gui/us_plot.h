...
class US_GUI_EXTERN US_Plot : public QHBoxLayout {
   ...
   public:
      ...
      US_Plot(
         QwtPlot *&plot, const QString &, const QString &, const QString &, const bool = false,
...
class US_PlotCurveConfig : public US_WidgetsDialog {
   ...
   public:
      US_PlotCurveConfig(QwtPlot *, const QStringList &, QWidget * = 0, Qt::WindowFlags = Qt::Dialog);
