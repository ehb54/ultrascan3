...
US_Passwd::getPasswd (void)
{
  ...
  while (true)
    {
      bool ok;
      pw = QInputDialog::getText (this, tr ("Master Password"),
      ...
      // Check the hash
      QByteArray hash = QCryptographicHash::hash (pw.toLatin1 (),
...
US_Passwd::getPasswd_auditTrail (QString title, QString i_text, QString user_s)
{
  // // If the pw is in global memory, return it
  // QString pw = g.passwd();
  ...
  while (true)
    {
      ...
      QMessageBox::critical (
          this, tr ("No Comment and/or Password Error"),
          tr ("<font color='red'><b>ERROR:</b></font> The Comment field is "
              "empty, or the password is incorrect."));
    }
