...
QString US_Passwd::getPasswd(void) {
   ...
   if (currentHash.isEmpty()) {
      QMessageBox::information(this, tr("Password Error"), tr("The Master Password has not been set."));
   ...
   while (true) {
      ...
      pw = QInputDialog::getText(
         this, tr("Master Password"), tr("Please input your Master Password"), QLineEdit::Password, QString(), &ok);
      ...
      // Check the hash
      QByteArray hash = QCryptographicHash::hash(pw.toLatin1(), QCryptographicHash::Sha1);

      if (hash == currentHash)
         break;

      QMessageBox::information(this, tr("Password Error"), tr("The password is incorrect."));
   }
