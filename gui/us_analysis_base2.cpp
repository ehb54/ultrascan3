...
US_AnalysisBase2::US_AnalysisBase2 () : US_Widgets ()
{
  ...
  // Plots
  plotLayout1 = new US_Plot (data_plot1, tr ("Plot 1 Title"),
                             tr ("X-Axis Title"), tr ("Y-Axis Title"));

  data_plot1->setMinimumSize (600, 150);

  plotLayout2
      = new US_Plot (data_plot2, tr ("Plot 2 Title"), tr ("X-Axis Title"),
                     tr ("Y-Axis Title"), true, ".*in range", "rainbow");
...
void
US_AnalysisBase2::update_disk_db (bool db)
{
  (db) ? disk_controls->set_db () : disk_controls->set_disk ();
}

void
US_AnalysisBase2::load (void)
{
  ...
  US_DataLoader *dialog = new US_DataLoader (edlast, dbdisk, rawList, dataList,
                                             triples, description, etype_filt);
...
void
US_AnalysisBase2::update (int selection)
{
  ...
  bool bufin = US_SolutionVals::values (dbP, d, solID, svbar, bdens, bvisc,
                                        bcomp, bmanu, errmsg);
...
void
US_AnalysisBase2::data_plot (void)
{
...
void
US_AnalysisBase2::boundary_pct (double percent)
{
...
void
US_AnalysisBase2::boundary_pos (double percent)
{
...
void
US_AnalysisBase2::exclude_from (double from)
{
...
void
US_AnalysisBase2::exclude_to (double to)
{
...
void
US_AnalysisBase2::reset_excludes (void)
{
  int index = lw_triples->currentRow ();
  US_DataIO::EditedData *d = &dataList[index];
  int totalScans = d->scanData.size ();
...
void
US_AnalysisBase2::smoothing (double smoothCount)
{
  if (!dataLoaded)
    return;
  ...
  if (smoothPoints > 1)
    {
      ...
      // Only calculate half a Gaussian curve, since the other side is
      // symmetric
...
double
US_AnalysisBase2::smooth_point (int scan, int point, int type,
                                int smoothPoints, int scanPoints)
{
...
void
US_AnalysisBase2::new_triple (int index)
{
...
double
US_AnalysisBase2::calc_baseline (void) const
{
  int row = lw_triples->currentRow ();
...
QString
US_AnalysisBase2::indent (const int spaces) const
{
...
QString
US_AnalysisBase2::table_row (const QString &s1, const QString &s2) const
{
...
QString
US_AnalysisBase2::table_row (const QString &s1, const QString &s2,
...
QString
US_AnalysisBase2::html_header (const QString &title,
...
// Compose HTML header string
QString
US_AnalysisBase2::html_header (const QString &title, const QString &head1,
                               US_DataIO::EditedData *edata) const
{
  QString ss = QString ("<?xml version=\"1.0\"?>\n");
  ss += "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"\n";
  ss += "                      \"http://www.w3.org/TR/xhtml1/DTD"
...
QString
US_AnalysisBase2::run_details (void) const
{
  int index = lw_triples->currentRow ();
...
QString
US_AnalysisBase2::hydrodynamics (void) const
{
  ...
  solution.vbar
      = US_Math2::calcCommonVbar ((US_Solution &)solution_rec, avgTemp);
  US_Math2::data_correction (avgTemp, solution);
...
QString
US_AnalysisBase2::analysis (const QString &extra) const
{
...
QString
US_AnalysisBase2::scan_info (void) const
{
  int index = lw_triples->currentRow ();
  const US_DataIO::EditedData *d = &dataList[index];
...
bool
US_AnalysisBase2::mkdir (const QString &baseDir, const QString &subdir)
{
  QDir folder (baseDir);
...
void
US_AnalysisBase2::set_progress (const QString message)
{
...
void
US_AnalysisBase2::load_noise (int index)
{
  ...
  te_desc->setHtml (
      tr ("<b>Scanning noise for %1 ...</b>").arg (triples[index]));
  qApp->processEvents ();
...
void
US_AnalysisBase2::updateSolution (US_Solution solution_sel)
{
...
bool
US_AnalysisBase2::query_noise_retain ()
{
  QString msg
      = tr ("Noise has previously been applied to this triple.<br/>"
...
void
US_AnalysisBase2::back_out_noise (int index)
{
...
void
US_AnalysisBase2::reportFilesToDB (QStringList &files)
{
  US_Passwd pw;
  US_DB2 db (pw.getPasswd ());
  US_DB2 *dbP = &db;
...
bool
US_AnalysisBase2::write_dset_report (QString &dsfname)
{
  QFile f_rep (dsfname);
...
void
US_AnalysisBase2::update_filelist (QStringList &flist, const QString fname)
{
  flist << fname;
...
bool
US_AnalysisBase2::has_intensity_profile (const QString &runID,
                                         const bool in_db)
{
  QString ripxml;
