...
//! \brief A class to perform extinction fitting using the US_Minimize
//! framework.
class US_GUI_EXTERN US_ExtinctFitter : public US_Minimize {
 ...
 public:
   ...
   */
  US_ExtinctFitter(QVector<struct WavelengthScan> *wls_v, double *&params,
                   unsigned int &order, unsigned int &maxOrder,
                   QString &projectName, bool *fitDone);
  ...
  US_ExtinctFitter(QVector<struct WavelengthScan> *wls_v, double *&params,
                   unsigned int &order, unsigned int &maxOrder,
                   QString &projectName, bool *fitDone, bool silentMode);

 private:
  QVector<struct WavelengthScan>
      *wls_v;          /*!< Vector of WavelengthScan structures. */
 ...
 signals:
   ...
   */
  void get_yfit(QVector<QVector<double>> &yfit,
