...
QPixmap
US_Images::getImage (const QString &bname)
{
...
QIcon
US_Images::getIcon (const QString &bname)
{
...
const QString
US_Images::image_name (int itype)
{
  struct nameMap
  {
    ImagesType itype;
...
const QString
US_Images::expanded_name (const QString &bname)
{
  QString iname = bname;
