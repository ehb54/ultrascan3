...
void
US_NoiseLoader::itemsSelected (void)
{
      ...
      if (nurnois > 0)
        {
          QString msg = tr (
              ...
              "<ul><li><b>Yes</b> to proceed, anyway, with selected "
              "noise;</li>"
...
US_NoiseLoader::view_details ()
{
  ...
  detaild->editor->e->setFont (
      QFont ("monospace", US_GuiSettings::fontSize ()));
