...
// Fonts
QString
US_GuiSettings::fontFamily (void)
{
...
void
US_GuiSettings::set_fontFamily (const QString &fontFamily)
{
  QSettings settings (US3, "UltraScan");
...
void
US_GuiSettings::set_fontSize (int fontSize)
{
  QSettings settings (US3, "UltraScan");
  if (fontSize == 10)
...
void
US_GuiSettings::set_guiStyle (const QString &style)
{
#ifdef Q_OS_LINUX
#if QT_VERSION < 0x050000
  const QString defaultStyle ("Plastique");
...
// Misc
int
US_GuiSettings::plotMargin (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_GuiSettings::set_plotMargin (int fontSize)
{
  QSettings settings (US3, "UltraScan");
  if (fontSize == 10)
...
// Label
QPalette
US_GuiSettings::labelColor (void)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::labelColorDefault (void)
{
  QPalette p;
...
void
US_GuiSettings::set_labelColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::editColorDefault (void)
{
  QPalette p;
  p.setColor (QPalette::Active, QPalette::WindowText,
...
void
US_GuiSettings::set_editColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::frameColor (void)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::frameColorDefault (void)
{
  QPalette p;
  p.setColor (QPalette::Active, QPalette::WindowText,
              c_white); // windowText/foreground
...
void
US_GuiSettings::set_frameColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::pushbColor (void)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::pushbColorDefault (void)
{
  QPalette p;
  p.setColor (QPalette::Active, QPalette::ButtonText,
              c_black); // windowText/foreground
...
void
US_GuiSettings::set_pushbColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::normalColor (void)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::normalColorDefault (void)
{
  QPalette p;
  p.setColor (QPalette::Active, QPalette::WindowText,
              c_black); // windowText/foreground
...
void
US_GuiSettings::set_normalColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::lcdColorDefault (void)
{
  QPalette p;
...
void
US_GuiSettings::set_lcdColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
QPalette
US_GuiSettings::plotColorDefault (void)
{
  QPalette p;
...
void
US_GuiSettings::set_plotColor (const QPalette &palette)
{
  QSettings settings (US3, "UltraScan");
...
void
US_GuiSettings::set_plotCurve (const QColor &color)
{
  QSettings settings (US3, "UltraScan");
  if (color == Qt::yellow)
...
// Canvas background
QColor
US_GuiSettings::plotCanvasBG (void)
{
  QSettings settings (US3, "UltraScan");
  // return settings.value( "palettes/normalColor", c_darkBlue
  // ).value<QColor>();
  return settings.value ("palettes/plotCanvasBG", c_darkBlue).value<QColor> ();
}

void
US_GuiSettings::set_plotCanvasBG (const QColor &color)
{
  QSettings settings (US3, "UltraScan");
...
QColor
US_GuiSettings::plotMajGrid (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_GuiSettings::set_plotMajGrid (const QColor &color)
{
  QSettings settings (US3, "UltraScan");
  if (color == c_white)
...
QColor
US_GuiSettings::plotMinGrid (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_GuiSettings::set_plotMinGrid (const QColor &color)
{
  QSettings settings (US3, "UltraScan");
...
QColor
US_GuiSettings::plotPicker (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_GuiSettings::set_plotPicker (const QColor &color)
{
  QSettings settings (US3, "UltraScan");
  if (color == c_white)
