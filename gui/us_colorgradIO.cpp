...
int
US_ColorGradIO::read_color_gradient (QString xmlfilename,
...
int
US_ColorGradIO::read_color_steps (QString xmlfilename, QList<QColor> &scolors,
...
int
US_ColorGradIO::read_color_step_params (QString xmlfilename,
                                        QList<int> &cparams)
{
  int rc = XFS_OK;
