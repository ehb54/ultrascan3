...
void
US_Help::show_help (const QString &helpFile)
{
...
void
US_Help::show_URL (const QString &location)
{
...
void
US_Help::show_html_file (const QString &location)
{
...
void
US_Help::openBrowser (const QString &location)
{
