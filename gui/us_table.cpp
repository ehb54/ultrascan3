...
US_Table::US_Table (QMap<double, double> &map, const QString &type,
                    bool &change, QWidget *parent, Qt::WindowFlags f)
...
void
US_Table::delete_row (QListWidgetItem *item)
{
  int response = QMessageBox::question (this, tr ("Delete Entry?"),
                                        tr ("Delete the current entry?"),
