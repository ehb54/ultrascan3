...
public:
  ...
  US_RunDetails2 (const QVector<US_DataIO::RawData> &, const QString &,
...
private:
  ...
  public:
    ...
    bool
    operator< (const graphValue &other) const
    {
  ...
  void draw_plot (const double *, const double *, const double *,
                  const double *, int);
