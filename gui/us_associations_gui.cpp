...
void
US_PushButton::mousePressEvent (QMouseEvent *e)
{
  emit pushed (index);
  e->accept ();
}
...
void
US_AssociationsGui::disable_gui (void)
{
  pb_accept->setEnabled (false);
}

void
US_AssociationsGui::populate (void)
{
...
void
US_AssociationsGui::set_component (int index, int row, int col)
{
...
void
US_AssociationsGui::changed (int row, int col)
{
  tw->disconnect ();
...
void
US_AssociationsGui::new_row (void)
{
...
void
US_AssociationsGui::del (int index)
{
...
void
US_AssociationsGui::complete (void)
{
      ...
      if (moles_right != moles_left)
        {
          QMessageBox::information (
              this, tr ("Equations do not balance"),
...
bool
US_AssociationsGui::combine_reactants (US_Model::Association *as)
{
  bool combined = false;
