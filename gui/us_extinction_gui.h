...
class CustomListWidgetItem : public QListWidgetItem {
   public:
      ...
      CustomListWidgetItem(QListWidget *parent = nullptr) : QListWidgetItem(parent) {}
...
class US_GUI_EXTERN US_Extinction : public US_Widgets {
   ...
   private:
      ...
      float odCutoff, lambdaLimitLeft, lambdaLimitRight, lambda_min, lambda_max, pathlength, extinction_coefficient,
         factor, selected_wavelength; //!< Various parameters for calculations.
