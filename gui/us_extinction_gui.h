...
public:
  ...
  US_Extinction (QString temp_mode, const QString &text,
...
private:
  ...
  QVector<WavelengthScan>
      v_wavelength_original;       //!< Vector of original wavelength scans.
  ...
  float odCutoff, lambdaLimitLeft, lambdaLimitRight, lambda_min, lambda_max,
      pathlength, extinction_coefficient, factor,
      selected_wavelength;       //!< Various parameters for calculations.
