...
// of all interpreters.
int
US_WindowMessage::findAllInterps (void)
{
  char nameints[512];
  int nintrp = 0;
...
int
US_WindowMessage::findAllInterps (QList<Interpreter> &interps)
{
...
int
US_WindowMessage::findLiveInterps ()
{
  live_interps.clear ();
  zombie_list.clear ();
...
int
US_WindowMessage::findLiveInterps (QList<Interpreter> &interps)
{
...
int
US_WindowMessage::zombieList (QStringList &zlist)
{
...
ulong
US_WindowMessage::addInterp (const QString filename)
{
  ulong id = 0;
...
int
US_WindowMessage::interpIDs (QList<ulong> &ids)
{
...
int
US_WindowMessage::interpNames (QStringList &names)
{
  int nntrp = live_interps.size ();
  names.clear ();
...
int
US_WindowMessage::interpFiles (QStringList &fnames)
{
  int nntrp = live_interps.size ();
  fnames.clear ();
...
ulong
US_WindowMessage::interpId (const QString filename)
{
  ulong id = 0;
...
ulong
US_WindowMessage::interpIdByName (const QString iname)
{
  ulong id = 0;
...
QString
US_WindowMessage::interpName (const ulong id)
{
  QString iname = "";
...
QString
US_WindowMessage::interpName (const QString filename)
{
  QString iname = "";
...
QString
US_WindowMessage::interpFileName (const ulong id)
{
  QString fname = "";
...
QString
US_WindowMessage::interpFileName (const QString iname)
{
  QString fname = "";
...
int
US_WindowMessage::sendMessage (const ulong id, const QString wmsg)
{
...
int
US_WindowMessage::sendMessage (const QString iname, const QString wmsg)
{
...
QString
US_WindowMessage::sendQuery (const ulong id, const QString wmsg)
{
  char resp[1024];
  QString iname = interpName (id);
  SendQuery (id, iname.toLatin1 ().data (), wmsg.toLatin1 ().data (), resp,
             1024);
  return QString (resp);
}
...
QString
US_WindowMessage::sendQuery (const QString iname, const QString wmsg)
{
  char resp[1024];
  ulong id = interpIdByName (iname);
  SendQuery (id, iname.toLatin1 ().data (), wmsg.toLatin1 ().data (), resp,
...
bool
US_WindowMessage::isLive (Interpreter &interp)
{
...
//  send action.
QString
US_WindowMessage::lastSendResult (void)
{
...
//  of interpreters.
int
US_WindowMessage::fill_interps (int nchar, char *wiresult,
