...
US_Sassoc::US_Sassoc(double eq0, double eq1, double stoich1, double stoich2,
                     ...
                     bool position_win, QWidget* parent, Qt::WindowFlags flags)
  ...
  // Graph
  plot1 =
      new US_Plot(plot, tr("Self-Association Profile for") + project,
                  tr("Total Concentration"), tr("% of Total Concentration"));
...
void US_Sassoc::new_value(const QwtDoublePoint& p) { update_legend(p.x()); }

void US_Sassoc::mouseU(const QwtDoublePoint& /* p */) { update_legend(-1.0); }
