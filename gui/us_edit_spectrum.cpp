...
US_EditSpectrum::US_EditSpectrum( QString tmp_type, QString tmp_exists, const QString& tmp_text, const QString &tmp_text_e280, US_Buffer *tmp_buffer ) : US_Widgets()
{
   buffer      = tmp_buffer;
   text        = tmp_text;
   type        = tmp_type;
   ...
   QLabel* bn_info_new     = us_banner( tr( " %1 has NO spectrum data: Choose among the options to enter new spectrum" ).arg(type) );
   bn_info_new->setSizePolicy( QSizePolicy::Preferred, QSizePolicy::Fixed );
   QLabel* bn_info_exists     = us_banner( tr( " %1 has spectrum data: Choose among the options to edit the spectrum" ).arg(type) );
...
US_EditSpectrum::US_EditSpectrum( QString tmp_type, QString tmp_exists, const QString& tmp_text, const QString &tmp_text_e280, US_Analyte *tmp_analyte ) : US_Widgets()
{
   analyte     = tmp_analyte;
   text        = tmp_text;
   type        = tmp_type;
