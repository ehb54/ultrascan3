//! \file us_analyte_manager.h
#ifndef US_ANALYTE_MNGR_H
#define US_ANALYTE_MNGR_H
...
class US_GUI_EXTERN US_ASequenceEditor : public US_WidgetsDialog
{
   Q_OBJECT
   public:
      //! Constructor
      //! \param sequence - The sequence to edit
      US_ASequenceEditor( const QString& );
...
class US_GUI_EXTERN US_AnalyteManager : public US_WidgetsDialog
{
   Q_OBJECT
   ...
   signals:
      ...
      //! \param density of the analyte
      //! \param viscosity of the analyte
      void valueChanged( double density, double viscosity );

      //! Return all values associated with the analyte
      //! \param analyte  Return the entire class.
