...
QwtDoubleInterval
US_SpectrogramData::range () const
{
...
void
US_SpectrogramData::initRaster (QRectF &drect, QSize &rsiz)
{
...
QwtInterval
US_SpectrogramData::interval (Qt::Axis axis)
{
...
void
US_SpectrogramData::setRastRanges (double a_xres, double a_yres, double a_reso,
                                   double a_zfloor, QRectF a_drecti)
{
  xreso = a_xres;
  yreso = a_yres;
  resol = a_reso;
...
void
US_SpectrogramData::setZRange (double a_zmin, double a_zmax)
{
  zmin = a_zmin;
  zmax = a_zmax;
...
double
US_SpectrogramData::value (double x, double y) const
{
...
void
US_SpectrogramData::setRaster (QList<S_Solute> *solu)
{
  double xval;
  double yval;
  double zval;
...
void
US_SpectrogramData::value (int x, int y, double &x_out, double &y_out,
                           double &z_out) const
{
