...
/*! \class US_ProjectGuiGeneral
           This class forms the content of the general tab in the US_Project
   GUI. Most management of the information itself takes place here.
*/
...
/*! \class US_ProjectGuiMolecules
    \brief This class forms the content of the molecules tab in the US_Project
   GUI.
*/
...
/*! \class US_ProjectGuiPurity
    \brief This class forms the content of the purity tab in the US_Project
   GUI.
*/
...
/*! \class US_ProjectGuiExpense
    \brief This class forms the content of the expense tab in the US_Project
   GUI.
*/
...
/*! \class US_ProjectGuiBufferComponents
    \brief This class forms the content of the buffer components tab in the
   US_Project GUI.
*/
...
/*! \class US_ProjectGuiSaltInformation
    \brief This class forms the content of the salt information tab in the
   US_Project GUI.
*/
...
/*! \class US_ProjectGuiAUC_questions
    \brief This class forms the content of the AUC_questions tab in the
   US_Project GUI.
*/
...
/*! \class US_ProjectGuiExpDesign
    \brief This class forms the content of the expDesign tab in the US_Project
   GUI.
*/
...
public:
  ...
  */
  US_ProjectGui (bool = false, int = US_Disk_DB_Controls::Default,
  ...
  QMap<QListWidgetItem *, int>
      projectMap; //!< Maps the IDs with the listwidget items
