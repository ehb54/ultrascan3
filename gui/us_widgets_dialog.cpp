...
US_WidgetsDialog::US_WidgetsDialog(QWidget *w, Qt::WindowFlags f, bool set_style) : QDialog(w, f) {
   if (set_style)
...
QLabel *US_WidgetsDialog::us_label(const QString &labelString, int fontAdjust, int weight) {
...
QLabel *US_WidgetsDialog::us_textlabel(const QString &labelString, int fontAdjust, int weight) {
...
QLabel *US_WidgetsDialog::us_banner(const QString &labelString, int fontAdjust, int weight) {
   QLabel *newLabel = us_label(labelString, fontAdjust, weight);
...
// pushbutton
QPushButton *US_WidgetsDialog::us_pushbutton(const QString &labelString, bool enabled, int fontAdjust) {
...
// lineedit
QLineEdit *US_WidgetsDialog::us_lineedit(const QString &text, int fontAdjust, bool readonly) {
...
// checkbox
QGridLayout *US_WidgetsDialog::us_checkbox(const QString &text, QCheckBox *&cb, bool state) {
...
// radiobutton
QGridLayout *US_WidgetsDialog::us_radiobutton(const QString &text, QRadioButton *&rb, bool state) {
   QPalette p = US_GuiSettings::normalColor();
   QFont font = QFont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize(), QFont::Bold);
...
//QwtCounter
QwtCounter *US_WidgetsDialog::us_counter(int buttons, double low, double high, double value) {
...
QwtPlot *US_WidgetsDialog::us_plot(const QString &title, const QString &x_axis, const QString &y_axis) {
...
// tabWidget
QTabWidget *US_WidgetsDialog::us_tabwidget(int fontAdjust, int weight) {
...
// TimeEdit
QHBoxLayout *US_WidgetsDialog::us_timeedit(QTimeEdit *&tedt, const int fontAdjust, QSpinBox **sbox) {
