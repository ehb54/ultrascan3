...
// checkbox
QGridLayout* US_WidgetsDialog::us_checkbox(const QString& text, QCheckBox*& cb,
                                           bool state) {
...
// TimeEdit
QHBoxLayout* US_WidgetsDialog::us_timeedit(QTimeEdit*& tedt,
...
QHBoxLayout* US_WidgetsDialog::us_ddhhmmsslay(
    const int fontAdjust, const int dd_hide, const int hh_hide,
    const int mm_hide, const int ss_hide, QSpinBox** dd, QSpinBox** hh,
