    ...
    : QDialog (w, f)
{
  if (set_style)
    QApplication::setStyle (
        QStyleFactory::create (US_GuiSettings::guiStyle ()));
...
QLabel *
US_WidgetsDialog::us_label (const QString &labelString, int fontAdjust,
                            int weight)
{
...
QLabel *
US_WidgetsDialog::us_textlabel (const QString &labelString, int fontAdjust,
                                int weight)
{
...
QLabel *
US_WidgetsDialog::us_banner (const QString &labelString, int fontAdjust,
                             int weight)
{
  QLabel *newLabel = us_label (labelString, fontAdjust, weight);
...
// pushbutton
QPushButton *
US_WidgetsDialog::us_pushbutton (const QString &labelString, bool enabled,
                                 int fontAdjust)
{
...
// textedit
QTextEdit *
US_WidgetsDialog::us_textedit (void)
{
...
// lineedit
QLineEdit *
US_WidgetsDialog::us_lineedit (const QString &text, int fontAdjust,
                               bool readonly)
{
...
void
US_WidgetsDialog::us_setReadOnly (QLineEdit *le, bool readonly)
{
  if (readonly)
    {
...
void
US_WidgetsDialog::us_setReadOnly (QTextEdit *te, bool readonly)
{
  if (readonly)
    {
...
// List Widget
QListWidget *
US_WidgetsDialog::us_listwidget (int fontAdjust)
{
...
// checkbox
QGridLayout *
US_WidgetsDialog::us_checkbox (const QString &text, QCheckBox *&cb, bool state)
{
...
// radiobutton
QGridLayout *
US_WidgetsDialog::us_radiobutton (const QString &text, QRadioButton *&rb,
                                  bool state)
{
  QPalette p = US_GuiSettings::normalColor ();
  QFont font = QFont (US_GuiSettings::fontFamily (),
...
// Progress Bar
QProgressBar *
US_WidgetsDialog::us_progressBar (int low, int high, int value)
{
...
// Combo Box
QComboBox *
US_WidgetsDialog::us_comboBox (void)
{
...
// LCD
QLCDNumber *
US_WidgetsDialog::us_lcd (int digits, int value)
{
...
// QwtCounter
QwtCounter *
US_WidgetsDialog::us_counter (int buttons, double low, double high,
                              double value)
{
...
QwtPlot *
US_WidgetsDialog::us_plot (const QString &title, const QString &x_axis,
...
QwtPlotGrid *
US_WidgetsDialog::us_grid (QwtPlot *plot)
{
...
QwtPlotCurve *
US_WidgetsDialog::us_curve (QwtPlot *plot, const QString &title)
{
...
QwtPlotPicker *
US_WidgetsDialog::us_picker (QwtPlot *plot)
{
  QwtPlotPicker *pick
...
// tabWidget
QTabWidget *
US_WidgetsDialog::us_tabwidget (int fontAdjust, int weight)
{
...
// TimeEdit
QHBoxLayout *
US_WidgetsDialog::us_timeedit (QTimeEdit *&tedt, const int fontAdjust,
                               QSpinBox **sbox)
{
...
// day-hh-mm-ss layout
QHBoxLayout *
US_WidgetsDialog::us_ddhhmmsslay (const int fontAdjust, const int dd_hide,
...
// SpinBox
QSpinBox *
US_WidgetsDialog::us_spinbox (const int fontAdjust)
{
