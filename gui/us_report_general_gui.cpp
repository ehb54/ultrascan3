...
US_ReportGenGui::US_ReportGenGui(QString reportMask) : US_Widgets() {
  ...
  QLabel* bn_detail = us_banner(
      QString(tr("Define Report's Representation of the Protocol Settings: ")),
      1);
...
// get Item's children
void US_ReportGenGui::get_item_childs(QList<QTreeWidgetItem*>& children_list,
      ...
      if ( parent_item )
        {
          ...
          //qDebug() << " Current item, " << item->text( 1 ) << ", has a parent:
" << parent_item->text( 1 );
...
//
void US_ReportGenGui::get_children_to_json(QString& mask_edited,
                                           QTreeWidgetItem* item) {
...
QString US_ReportGenGui::tree_to_json(
...
void US_ReportGenGui::cancel_selection(void) { close(); }
