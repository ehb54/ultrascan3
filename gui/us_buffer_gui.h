...
public:
  ...
  //! \param load_id        The buffer ID to load from the filesystem or
  //! database
...
private slots:
  ...
  help (void)
  {
    showHelp.show_help ("buffer_select.html");
  };
...
private slots:
  ...
  help (void)
  {
    showHelp.show_help ("buffer_new.html");
  };
...
private slots:
  ...
  help (void)
  {
    showHelp.show_help ("buffer_edit.html");
  };
...
private slots:
  ...
  help (void)
  {
    showHelp.show_help ("buffer_settings.html");
  };
};
...
public:
  ...
  US_BufferGui (bool = false, const US_Buffer & = US_Buffer (),
...
public:
  US_BufferComponentRequerster (US_BufferComponent *comp_,
                                QMap<QString, US_BufferComponent> &);
