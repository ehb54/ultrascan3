...
US_NewSpectrum::US_NewSpectrum(
   QString tmp_type, const QString &tmp_text, const QString &tmp_text_e280, US_Buffer *tmp_buffer) : US_Widgets() {
   buffer = tmp_buffer;
   text = tmp_text;
   type = tmp_type;
...
US_NewSpectrum::US_NewSpectrum(
   QString tmp_type, const QString &tmp_text, const QString &tmp_text_e280, US_Analyte *tmp_analyte) : US_Widgets() {
   analyte = tmp_analyte;
   text = tmp_text;
   type = tmp_type;
   text_e280 = tmp_text_e280;
...
US_NewSpectrum::US_NewSpectrum(
   QString tmp_type, const QString &tmp_text, const QString &tmp_text_e280, US_Solution *tmp_solution) : US_Widgets() {
...
void US_ViewSpectrum::save_csv() {
   QString fileName = QFileDialog::getSaveFileName(this, tr("Save File"), US_Settings::reportDir(), tr("CSV (*.csv)"));
   if (fileName.isEmpty())
      return;
