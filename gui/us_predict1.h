...
class US_GUI_EXTERN US_Predict1 : public US_WidgetsDialog {
 ...
 public:
  ...
  US_Predict1(US_Hydrosim&, US_Analyte = US_Analyte(),
              int = US_Disk_DB_Controls::Default, bool = false);
 ...
 private slots:
  ...
  void calc_column(const QString&, const QString&, int, double, double, double,
                   double, double = 1.0);
  ...
  void help(void) { showHelp.show_help("manual/predict1.html"); };
};
#endif
