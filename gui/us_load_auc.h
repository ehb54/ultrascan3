...
class US_GUI_EXTERN US_LoadAUC : public US_WidgetsDialog {
   ...
   public:
      ...
      US_LoadAUC(bool, QString, QVector<US_DataIO::RawData> &, QStringList &, QString &);

      US_LoadAUC(bool, QMap<QString, QString> &, QVector<US_DataIO::RawData> &, QStringList &, QString &);
   ...
   private slots:
      ...
      void help(void) { showHelp.show_help("load_auc.html"); };
