...
//! \brief A class to provide a GUI for editing spectra for buffers, analytes,
//! and solutions.
class US_GUI_EXTERN US_EditSpectrum : public US_Widgets {
 ...
 public:
   ...
   */
  US_EditSpectrum(QString type, QString exists, const QString& text,
                  const QString& text_e280, US_Buffer* buffer);
   ...
   */
  US_EditSpectrum(QString type, QString exists, const QString& text,
                  const QString& text_e280, US_Analyte* analyte);
   ...
   */
  US_EditSpectrum(QString type, QString exists, const QString& text,
                  const QString& text_e280, US_Solution* solution);
