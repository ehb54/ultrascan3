...
{
    my ($stdout, $workdir);
    my $iquery="select ExperimentMessage from NotificationDetails  where ExperimentID='$experimentID' and NotificationType = 'ComputationDuration' and ExperimentMessage like '%( executable =%'";
