...
class US_UTIL_EXTERN US_XpnData : public QObject {
   ...
   public:
      ...
      bool connect_data(
         const QString, const int = 5432, const QString = QString("AUC_DATA_DB"), const QString = QString("aucuser"),
      ...
      void load_auc(QVector<US_DataIO::RawData> &, const QStringList);
   ...
   private slots:
      ...
      void interp_rvalues(QVector<double> &, QVector<double> &, QVector<double> &, QVector<double> &);
