...
class US_UTIL_EXTERN US_Rotor {
  ...
  */
  ...
  /*! \brief    Function to retrieve all the calibration profiles about a
      ...
      \param    db  For database access, an open database connection
  */
  static Status readCalibrationProfilesDB(QVector<US_Rotor::RotorCalibration>&,
                                          int, US_DB2* db);
  ...
  /*! \brief    Function to retrieve all the calibration profiles about a
      ...
      \param    rotorID  The ID of the rotor
  */
  static Status readCalibrationProfilesDisk(
      QVector<US_Rotor::RotorCalibration>&, int);
 ...
 private:
  ...
  static QString get_filename(const QString&, const QString&, const QString&,
                              const int&, bool&);
