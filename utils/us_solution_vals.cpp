...
bool
US_SolutionVals::values (US_DB2 *dbP, US_DataIO::EditedData *edata,
                         QString &soluID, QString &cvbar20, QString &density,
  ...
  if (dbP != 0)
    {
      ...
      got_ok = got_ok ? got_ok
                      : solinfo_disk (edata, cvbar20, soluID, bufID, bguid,
                                      bdesc, errmsg);
    ...
    {
      got_ok
          = solinfo_disk (edata, cvbar20, soluID, bufID, bguid, bdesc, errmsg);
...
bool
US_SolutionVals::solinfo_db (US_DB2 *dbP, US_DataIO::EditedData *edata,
                             QString &cvbar20, QString &soluID, QString &bufId,
                             QString &bufGuid, QString &bufDesc,
                             QString &errmsg)
{
  bool bufinfo = false;
...
bool
US_SolutionVals::solinfo_disk (US_DataIO::EditedData *edata, QString &cvbar20,
                               QString &soluID, QString &bufId,
                               QString &bufGuid, QString &bufDesc,
                               QString &errmsg)
{
  bool bufinfo = false;
...
bool
US_SolutionVals::bufvals_db (US_DB2 *dbP, QString &bufId, QString &bufGuid,
...
bool
US_SolutionVals::bufvals_disk (QString &bufId, QString &bufGuid,
                               QString &bufDesc, QString &density,
                               QString &viscosity, QString &compress,
                               QString &manual, QString &errmsg)
{
