...
class US_UTIL_EXTERN US_SolveSim : public QObject {
 ...
 public slots:
  ...
  void calc_residuals(int, int, Simulation&, bool = false, QVector<double>* = 0,
 ...
 private slots:
  ...
  // Compute "L"
  void compute_L(int, int, QVector<double>&, const QVector<double>&,
                 const QVector<double>&);

  // Compute "small_a" and "small_b" matrices for RI noise
  void ri_small_a_and_b(int, int, int, QVector<double>&, QVector<double>&,
                        const QVector<double>&, const QVector<double>&,
                        const QVector<double>&, const QVector<double>&);

  // Compute "small_a" and "small_b" matrices for TI noise
  void ti_small_a_and_b(int, int, int, QVector<double>&, QVector<double>&,
                        const QVector<double>&, const QVector<double>&,
                        const QVector<double>&, const QVector<double>&);

  // Compute "L_bar"
  void compute_L_bar(QVector<double>&, const QVector<double>&,
                     const QVector<double>&);

  // Compute "a_bar"
  void compute_a_bar(QVector<double>&, const QVector<double>&,
                     const QVector<double>&);

  // Compute "L_bar-s"
  void compute_L_bars(int, int, int, int, QVector<double>&,
                      const QVector<double>&, const QVector<double>&);
