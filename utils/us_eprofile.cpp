...
int
US_ExtProfile::fetch_eprofile (US_DB2 *dbP, const int compID,
...
bool
US_ExtProfile::parse_eprofile (QString &epxml, int *compID, QString *compType,
                               QString *valType,
                               QMap<double, double> &extinction)
{
  int xCompID; // Values from XML
...
int
US_ExtProfile::create_eprofile (US_DB2 *dbP, const int compID,
...
bool
US_ExtProfile::xml_eprofile (const int compID, QString &compType,
                             QString &valueType,
                             QMap<double, double> &extinction, QString &xmlout)
{
  bool create_ok = true;
...
bool
US_ExtProfile::update_eprofile (US_DB2 *dbP, const int profileID,
...
bool
US_ExtProfile::delete_eprofile (US_DB2 *dbP, const int compID,
                                QString &compType)
{
  QStringList qry;
  qry.clear ();
