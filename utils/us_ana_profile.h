   ...
   public:
      ...
      class US_UTIL_EXTERN AnaProf2DSA {
         public:
            ...
            inline bool operator!=(const AnaProf2DSA &p) const { return !operator==(p); }
      ...
      class US_UTIL_EXTERN AnaProfPCSA {
         public:
            ...
            inline bool operator!=(const AnaProfPCSA &p) const { return !operator==(p); }
      ...
      //! Inequality operator
      inline bool operator!=(const US_AnaProfile &p) const { return !operator==(p); }
