...
//! A class to define an Ana Profile object for US_AnalysisProfileGui and
//! related classes
...
public:
  ...
  public:
    ...
    public:
      ...
      //! Inequality operator
      inline bool
      operator!= (const Parm2DSA &p) const
      {
        return !operator== (p);
      }
    };
    ...
    inline bool
    operator!= (const AnaProf2DSA &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    public:
      ...
      //! Inequality operator
      inline bool
      operator!= (const ParmPCSA &p) const
      {
        return !operator== (p);
      }
    };
    ...
    inline bool
    operator!= (const AnaProfPCSA &p) const
    {
      return !operator== (p);
    }
  ...
  //! Inequality operator
  inline bool
  operator!= (const US_AnaProfile &p) const
  {
    return !operator== (p);
  }
  ...
  QStringList
      chndescs_alt; //!< Alt Channel descriptions for ch_wvls && ch_reports
  ...
  QMap<int, QStringList>
      replicates_to_channdesc_main; //!< Replicates to channel descriptions
  QMap<QString, QStringList>
      channdesc_to_overlapping_wvls_main; //!< Channel descriptions to
