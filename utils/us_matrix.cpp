...
bool
US_Matrix::lsfit (double *c, double *x, double *y, int N, int order)
{
  bool status = true;
...
bool
US_Matrix::Cholesky_Decomposition (double **a, int n)
{
  double sum;
  double diff;
...
*/
bool
US_Matrix::Cholesky_SolveSystem (double **L, double *b, int n)
{
  QString t;
...
bool
US_Matrix::Cholesky_Invert (double **AA, double **AI, int nn)
{
...
double **
US_Matrix::construct (QVector<double *> &QVm, QVector<double> &QVd, int rows,
                      int columns)
{
...
void
US_Matrix::tmm (double **AA, double **CC, int rows, int columns)
{
...
// Compute product of a matrix-transpose and the matrix, with optional full
// fill
void
US_Matrix::tmm (double **AA, double **CC, int rows, int columns, bool fill)
{
...
void
US_Matrix::mvv (double **AA, double *bb, double *cc, int rows, int columns)
{
  for (int ii = 0; ii < rows; ii++)
    {
      double dotp = 0.0;
...
void
US_Matrix::tvv (double **AA, double *bb, double *cc, int rows, int columns)
{
  for (int jj = 0; jj < columns; jj++)
    {
      double dotp = 0.0;
...
void
US_Matrix::mmm (double **AA, double **BB, double **CC, int rows, int size,
                int columns)
{
  for (int ii = 0; ii < rows; ii++)
    {
...
void
US_Matrix::msum (double **AA, double **BB, double **CC, int rows, int columns)
{
  for (int ii = 0; ii < rows; ii++)
    for (int jj = 0; jj < columns; jj++)
...
void
US_Matrix::vsum (double *aa, double *bb, double *cc, int size)
{
...
void
US_Matrix::mident (double **CC, int size)
{
  for (int ii = 0; ii < size; ii++)
...
void
US_Matrix::mcopy (double **AA, double **CC, int rows, int columns)
{
  for (int ii = 0; ii < rows; ii++)
    for (int jj = 0; jj < columns; jj++)
      CC[ii][jj] = AA[ii][jj];
...
void
US_Matrix::vcopy (double *aa, double *cc, int size)
{
  for (int ii = 0; ii < size; ii++)
    cc[ii] = aa[ii];
}
...
void
US_Matrix::add_diag (double **CC, double ss, int size)
{
  for (int ii = 0; ii < size; ii++)
    CC[ii][ii] += ss;
}
...
void
US_Matrix::add (double **CC, double ss, int rows, int columns)
{
  for (int ii = 0; ii < rows; ii++)
    for (int jj = 0; jj < columns; jj++)
      CC[ii][jj] += ss;
...
void
US_Matrix::scale (double **CC, double ss, int rows, int columns)
{
  for (int ii = 0; ii < rows; ii++)
    for (int jj = 0; jj < columns; jj++)
      CC[ii][jj] *= ss;
...
double
US_Matrix::dotproduct (double *aa, double *bb, int size)
{
  double dotp = 0.0;
...
double
US_Matrix::dotproduct (double *aa, int size)
{
  double dotp = 0.0;
...
// Print a vector
void
US_Matrix::print_vector (double *v, int n)
{
  QString s;
  QString t;
  for (int i = 0; i < n; i++)
...
// Print a matrix
void
US_Matrix::print_matrix (double **A, int rows, int columns)
{
...
void
US_Matrix::LU_Decomposition (double **matrix, int *index, bool parity, int n)
{
...
void
US_Matrix::LU_BackSubstitute (double **A, double *&b, int *index, int n)
{
  int ip;
  int ii = -1;
...
void
US_Matrix::LU_SolveSystem (double **A, double *&b, int n)
{
  bool parity = true;
...
void
US_Matrix::mmv (float **result, double **vector, float ***matrix, int row,
                int column)
{
  int i, j;
  for (i = 0; i < row; i++)
...
void
US_Matrix::mmv (float **result, double **vector, double ***matrix, int row,
                int column)
{
  int i, j;
  for (i = 0; i < row; i++)
...
void
US_Matrix::mmv (float **result, float **vector, double ***matrix, int row,
                int column)
{
  int i, j;
  for (i = 0; i < row; i++)
...
void
US_Matrix::mmv (float **result, float **vector, float ***matrix, int row,
                int column)
{
  int i, j;
  for (i = 0; i < row; i++)
...
float
US_Matrix::dotproduct (float **v1, float **v2, int size)
{
  float result = 0;
...
void
US_Matrix::vvt (float ***result, float **v1, float **v2, int size)
{
  for (int i = 0; i < size; i++)
    {
...
/*
  ...
  void US_Matrix::calc_A_transpose_A(double ***A, double ***product, unsigned
  int rows, unsigned int columns, bool flag)
  {
  CATA_D_Thread *dt;
              ...
              if (i <= j)
                {
                  ...
                  m = (*dataarray)[i];
                  n = (*dataarray)[j];
                  while ((k < (unsigned int)m.size ())
                         && (l < (unsigned int)n.size ()))
                    {
...
void
US_Matrix::calc_A_transpose_A (double ***A, double ***product,
...
/*
  ...
  void US_Matrix::calc_A_transpose_A(float ***A, float ***product, unsigned int
  rows, unsigned int columns, bool flag)
  {
  CATA_F_Thread *ft;
...
*/
void
US_Matrix::calc_A_transpose_A (float ***A, float ***product, unsigned int rows,
