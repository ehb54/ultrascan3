...
void US_Matrix::tmm(double **AA, double **CC, int rows, int columns) {
   ...
   for (int ii = 0; ii < columns; ii++) { // Loop for A' rows, A columns and P columns
      double dotp = 0.0;
...
void ata_d_thr_t::ata_d_thr_setup(
   unsigned int a_columns, unsigned int a_c_start, unsigned int a_c_end, double ***a_product,
...
void US_Matrix::calc_A_transpose_A(
   double ***A, double ***product, unsigned int rows, unsigned int columns, unsigned int threads) {
