...
public:
  ...
  void
  setTimeCorrection (bool flag)
  {
    time_correction = flag;
  };
  ...
  //!              or omega_square_t
  void
  setTimeInterpolation (bool flag)
  {
    use_time = flag;
  };
...
//---------------------------Not used-------------------------------
#ifdef NEVER
  void GlobalStiff_ellam (QVector<double> *, double **, double **, double,
                          double);
