...
class US_UTIL_EXTERN US_Astfem_RSA : public QObject {
   ...
   private:
      ...
      int calculate_ni(double, double, int, US_AstfemMath::MfemInitial &, US_AstfemMath::MfemData &, bool);
      ...
      bool iszero(const double, const double, const double, const double, const double, const double);
