...
class US_UTIL_EXTERN US_Model {
   public:
      ...
      //! Store CUSTOMGRID metadata
      CustomGridMetadata customGridData;
      ...
      class US_UTIL_EXTERN SimulationComponent {
         public:
            ...
            inline bool operator!=(const SimulationComponent &sc) const { return !operator==(sc); }
      ...
      class US_UTIL_EXTERN Association {
         public:
            ...
            inline bool operator!=(const Association &a) const { return !operator==(a); }
      };
   ...
   private:
      ...
      //! \brief Parse the metadata part of a model XML
      void get_metadata(QXmlStreamReader &);
