...
QString
US_Util::getToken (QString &s, const QString &separator)
{
  QString token;
...
QString
US_Util::md5sum_file (QString filename)
{
  QFile f (filename);
...
QString
US_Util::toUTCDatetimeText (QString dttext, bool knownUTC)
{
...
QString
US_Util::toISODatetimeText (QString dttext)
{
...
QString
US_Util::uuid_unparse (unsigned char *uu)
{
...
QString
US_Util::compressed_triple (const QString &ccw)
{
...
// Convert a triple string from expanded to compressed form
QString
US_Util::expanded_triple (const QString &ccw, bool spaces)
{
...
unsigned char
US_Util::hex2int (unsigned char c)
{
  if (c <= '9')
...
void
US_Util::uuid_parse (const QString &in, unsigned char *uu)
{
...
bool
US_Util::bool_flag (const QString xmlattr)
{
...
QString
US_Util::bool_string (const bool boolval)
{
...
int
US_Util::listlistBuild (QList<QStringList> &lsl, QString &llstring)
{
...
//   each stringlist.
int
US_Util::listlistParse (QList<QStringList> &lsl, QString &llstring)
{
  int nlelem = 0;
