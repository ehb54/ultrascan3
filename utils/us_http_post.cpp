...
US_HttpPost::US_HttpPost(const QString &url, const QString &request) : QObject() {
   ...
   httpPost.setHeader(QNetworkRequest::ContentTypeHeader, QString("application/x-www-form-urlencoded"));
   ...
   connect(reply, SIGNAL(error(QNetworkReply::NetworkError)), this, SLOT(postError(QNetworkReply::NetworkError)));
}
