...
public:
  ata_d_thr_t (int);
  void ata_d_thr_setup (unsigned int, unsigned int, unsigned int, double ***,
...
public:
  ...
  */
  ...
  static void calc_A_transpose_A (double *** /*original matrix*/,
                                  double *** /*product matrix*/,
                                  unsigned int /*rows*/,
                                  unsigned int /*columns*/,
                                  unsigned int /*threads*/);
  static void calc_A_transpose_A (float *** /*original matrix*/,
...
void generalLeastSquares (float **, unsigned int, unsigned int, float *,
                          float **);
void print_matrix (double **, int, int);
void print_vector (double **, unsigned int, const char *);
void calc_A_transpose_A (double *** /*original matrix*/,
                         double *** /*product matrix*/, unsigned int /*rows*/,
                         unsigned int /*columns*/, unsigned int /*threads*/);
void calc_A_transpose_A (float *** /*original matrix*/,
                         float *** /*product matrix*/, unsigned int /*rows*/,
                         unsigned int /*columns*/);
void calc_matrix_times_matrix (double ***, double ***, double ***,
                               unsigned int, unsigned int);
void calc_matrix_times_matrix (float ***, float ***, float ***, unsigned int,
                               unsigned int);
void calc_matrix_times_vector (double ***, double **, double **, unsigned int,
                               unsigned int);
void calc_matrix_times_vector (float ***, float **, float **, unsigned int,
                               unsigned int);
double calc_vector_transpose_times_vector (unsigned int /*rows*/,
                                           double ** /*vector1*/,
                                           double ** /*vector2*/);
float calc_vector_transpose_times_vector (unsigned int /*rows*/,
                                          float ** /*vector1*/,
                                          float ** /*vector2*/);
...
void conc_dep_s (float, double **, double **, double ***, float temp1,
                 unsigned int points);
void conc_dep_s (float, float **, float **, float ***, float temp1,
                 unsigned int points);
#ifdef ADOLC
void conc_dep_s (adouble, adouble **, adouble **, double ***, adouble,
                 unsigned int points);
void conc_dep_s (adouble, adouble **, adouble **, float ***, adouble,
                 unsigned int points);
#endif
void conc_dep_d (float, double **, double **, double ***, double ***,
                 double ***, float, unsigned int, double **, double **,
                 double **);
void conc_dep_d (float, float **, float **, float ***, float ***, float ***,
                 float, unsigned int, float **, float **, float **);
#ifdef ADOLC
void conc_dep_d (adouble, adouble **, adouble **, float ***, float ***,
                 float ***, adouble, unsigned int, adouble **, adouble **,
                 adouble **);
void conc_dep_d (adouble, adouble **, adouble **, double ***, double ***,
                 double ***, adouble, unsigned int, adouble **, adouble **,
                 adouble **);
#endif
