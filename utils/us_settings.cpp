...
void
US_Settings::set_browser (const QString &browser)
{
  QSettings settings (US3, "UltraScan");
...
QString
US_Settings::workBaseDir (void)
{
  QSettings settings (US3, "UltraScan");
  return settings.value ("workBaseDir", QDir::homePath () + "/ultrascan")
      .toString ();
}

void
US_Settings::set_workBaseDir (const QString &dir)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_importDir (const QString &dir)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_tmpDir (const QString &dir)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_license (const QStringList &license)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_UltraScanPW (const QByteArray &hash)
{
  QSettings settings (US3, "UltraScan");
...
double
US_Settings::tempTolerance (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_tempTolerance (double tempTolerance)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_beckmanBug (bool setBug)
{
  QSettings settings (US3, "UltraScan");
  if (!setBug)
...
int
US_Settings::default_data_location (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_default_data_location (int location)
{
  QSettings settings (US3, "UltraScan");
  if (location == 2)
...
void
US_Settings::set_us_debug (int level)
{
  QSettings settings (US3, "UltraScan");
  if (level == 0)
...
#ifndef NO_DB
void
US_Settings::set_debug_text (QStringList debuglist)
{
  QSettings settings (US3, "UltraScan");
...
bool
US_Settings::debug_match (QString match)
{
  return debug_text ().contains (match, Qt::CaseInsensitive);
}

QString
US_Settings::debug_value (QString match)
{
...
void
US_Settings::set_us_inv_name (const QString &name)
{
  QSettings settings (US3, "UltraScan");
  if (name == "")
...
void
US_Settings::set_us_inv_ID (int id)
{
  QSettings settings (US3, "UltraScan");
  if (id == -1)
...
void
US_Settings::set_us_inv_level (int level)
{
  QSettings settings (US3, "UltraScan");
  if (level == 0)
...
// advanced level
int
US_Settings::advanced_level (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_advanced_level (int level)
{
  QSettings settings (US3, "UltraScan");
  if (level == 0)
...
void
US_Settings::set_threads (int threads)
{
  QSettings settings (US3, "UltraScan");
  if (threads == 1)
...
void
US_Settings::set_noise_dialog (int diagflag)
{
  QSettings settings (US3, "UltraScan");
  if (diagflag == 0)
...
void
US_Settings::set_databases (const QList<QStringList> &dblist)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_defaultDB (const QStringList &defaultDB)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_xpn_db_hosts (const QList<QStringList> &xhlist)
{
  QSettings settings (US3, "UltraScan");
...
QStringList
US_Settings::defaultXpnHost (void)
{
  QSettings settings (US3, "UltraScan");
...
void
US_Settings::set_def_xpn_host (const QStringList &defXpnHost)
{
  QSettings settings (US3, "UltraScan");
...
/***************** DA status related **************************/
void
US_Settings::set_DA_status (const QString &status)
{
  QSettings settings (US3, "UltraScan");
...
bool
US_Settings::get_DA_status (const QString &da_type)
{
  QSettings settings (US3, "UltraScan");
...
US_Settings::status ()
{
  ...
  switch (settings.status ())
    ...
    case QSettings::AccessError:
      return QString ("Access error. Check permissions and ownership of %1")
          .arg (settings.fileName ());
      break;
    case QSettings::FormatError:
      return QString ("Settings format error. The file %1 is garbled")
          .arg (settings.fileName ());
      break;
    default:
      return QString ("Unknown settings error %1. Perhaps remove the file %2 "
                      "and try again.")
          .arg (settings.status ())
          .arg (settings.fileName ());
      break;
