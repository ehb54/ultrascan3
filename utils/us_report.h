...
class US_UTIL_EXTERN US_Report {
   public:
      ...
      */
      ...
      Status saveDocumentFromFile_auto(int, const QString &, const QString &, US_DB2 *, int = 1, const QString = "");
      ...
      Status saveFileDocuments_auto(int, const QString &, const QStringList &, US_DB2 *, int = 1, const QString = "");
