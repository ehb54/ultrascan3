...
class US_UTIL_EXTERN US_ModelRecord {
 ...
 public slots:
  ...
  static int compute_slines(double&, double&, double&, double&, int&, int&,
                            double*, QVector<US_ModelRecord>&);
  ...
  //! \param mrecs   Reference for generated model records vector
  //! \returns       Number of model line records generated
  static int compute_sigmoids(int&, double&, double&, double&, double&, int&,
  ...
  //! \param mrecs   Reference for generated model records vector
  //! \returns       Number of model line records generated
  static int compute_hlines(double&, double&, double&, double&, int&, int&,
                            double*, QVector<US_ModelRecord>&);
  ...
  //! \param mrecs   Reference for generated model records vector
  //! \returns       Number of model line records generated
  static int compute_2ndorder(double&, double&, double&, double&, int&, int&,
                              double*, QVector<US_ModelRecord>&);
  ...
  //! \returns       Number of model line records generated
  static int load_modelrecs(QXmlStreamReader& xml, QVector<US_ModelRecord>&,
                            QString&, int&, double&, double&, double&, double&,
                            int&);
  ...
  //! \param stype   Ref. for solute type flag (e.g., 0013 for s,k,v)
  //! \returns       Number of model line records generated
  static int write_modelrecs(QXmlStreamWriter& xml, QVector<US_ModelRecord>&,
                             QString&, int&, double&, double&, double&, double&,
                             int&);
  ...
  static void elite_limits(QVector<US_ModelRecord>&, int&, double&, double&,
  ...
  static int recompute_mrecs(int&, double&, double&, double&, double&, int&,
                             int&, double*, QVector<US_ModelRecord>&);
