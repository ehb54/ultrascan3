...
class US_UTIL_EXTERN US_ZSolute
{
   public:
      ...
      US_ZSolute( double = 0.0, double = 0.0, double = 0.0,
                  double = 0.0 );
      ...
      static void put_mcomp_attr ( US_Model::SimulationComponent&,
                                   double&, const int );
      ...
      static void put_solute_attr( US_ZSolute&,
                                   double&, const int );
      ...
      static void get_mcomp_attr ( US_Model::SimulationComponent&,
                                   double&, const int );
      ...
      static void get_solute_attr( US_ZSolute&,
                                   double&, const int );
      ...
      //! \param s_type Solute type mask
      static void set_solute_values( US_Model::SimulationComponent&,
                                     US_ZSolute&, const int );
      ...
      //!                  list of vectors.
      static void init_grid_solutes( double, double, int,
   ...
   private:
      ...
      static QVector< US_ZSolute > create_grid_solutes(
