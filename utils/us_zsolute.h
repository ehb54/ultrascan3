...
class US_UTIL_EXTERN US_ZSolute {
   public:
      ...
      bool operator==(const US_ZSolute &solute) { return (x == solute.x && y == solute.y && z == solute.z); }
      ...
      //!                  list of vectors.
      static void init_grid_solutes(
         double, double, int, double, double, int, int, double *, QList<QVector<US_ZSolute>> &);
