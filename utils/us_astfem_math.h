...
class US_UTIL_EXTERN US_AstfemMath {
 public:
  ...
  static bool low_acceleration(
      const QVector<US_SimulationParameters::SpeedProfile>&, const double,
      double&);
  ...
  static void QuadSolver(double*, double*, double*, double*, double*, double*,
                         int);
  ...
  static void BasisTR(double*, double*, double, double, double*, double*,
                      double*);
  ...
  static void BasisQR(double*, double, double, double*, double*, double*,
                      double);
  ...
  static void initSimData(US_DataIO::RawData&, US_DataIO::EditedData&,
                          double = 0.0);
  ...
  //! \param concval1 Optional constant concentration value for first scan.
  static void initSimData(US_DataIO::RawData&, QList<US_DataIO::EditedData*>&,
                          double = 0.0);
