...
public:
  ...
  static bool
  low_acceleration (const QVector<US_SimulationParameters::SpeedProfile> &,
                    const double, double &);
  ...
  static void QuadSolver (double *, double *, double *, double *, double *,
                          double *, int);
  ...
  static void initSimData (US_DataIO::RawData &,
                           QList<US_DataIO::EditedData *> &, double = 0.0);
