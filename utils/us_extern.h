/**
 * @file us_extern.h
 * @brief Defines macros for exporting and importing symbols in shared
 * libraries.
 */
 ...
 *
 * Defined as US_EXPORT if US_MAKE_UTIL_DLL is defined, otherwise defined as
 * US_IMPORT.
 */
 ...
 *
 * Defined as US_EXPORT if US_MAKE_GUI_DLL is defined, otherwise defined as
 * US_IMPORT.
 */
 ...
 *
 * Defined as US_EXPORT if US_MAKE_DLL is defined, otherwise defined as
 * US_IMPORT.
 */
