 ...
 *
 * This class handles connecting to, disconnecting from, and communicating with
 * a server using SSL.
 */
...
public:
  ...
  bool connectToServer_init_check (const QString &serverAddress,
                                   const int port);
  ...
  bool disconnected_itself; ///< Indicates if the disconnection was initiated
                            ///< by the client.
  bool connected_itself; ///< Indicates if the connection was initiated by the
                         ///< client.
