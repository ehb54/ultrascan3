 ...
 *
 * This class provides functionality to initialize, start, end, and list
 * timers, allowing for time tracking of various events.
 */
...
private:
  ...
  map<QString, unsigned long>
      times2; ///< Map of timer names to secondary recorded times.
};
