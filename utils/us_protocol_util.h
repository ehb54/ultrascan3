...
class US_UTIL_EXTERN US_ProtocolUtil {
 public:
  ...
  static int read_record(const QString protname, QString* xml, QStringList*,
                         US_DB2*);

  static int read_record_auto(const QString protname, int invID_passed,
                              QString* xml, QStringList*, US_DB2*);
