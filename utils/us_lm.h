   ...
   public:
      ...
      class US_UTIL_EXTERN LM_Control {
         public:
            ...
            LM_Control(
               double = LM_USRTOL, double = LM_USRTOL, double = LM_USRTOL, double = LM_USRTOL, double = 100.0,
               int = 100, int = 1, int = 0);
      };
      ...
      static void lmmin(
         ...
         LM_Status *status,
         void (*printout)(
            int n_par, double *par, int m_dat, const void *data, const double *fvec, int printflags, int iflag,
            int iter, int nfev));
      ...
      //! Evaluate functions
      static void lmcurve_evaluate(double *par, int m_dat, const void *data, double *fvec, int * /* info */);

      //! LM Curve Fit
      static void lmcurve_fit(
      ...
      static void lm_lmpar(
         int n, double *r, int ldr, int *ipvt, double *diag, double *qtb, double delta, double *par, double *x,
