   ...
   public:
      ...
      class US_UTIL_EXTERN RunProtoRotor {
         public:
            ...
            inline bool operator!=(const RunProtoRotor &p) const { return !operator==(p); }
         ...
         public:
            class US_UTIL_EXTERN SpeedStep {
               public:
                  ...
                  inline bool operator!=(const SpeedStep &p) const { return !operator==(p); }
            };
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoSpeed &p) const { return !operator==(p); }
         ...
         public:
            class US_UTIL_EXTERN CellUse {
               public:
                  ...
                  inline bool operator!=(const CellUse &p) const { return !operator==(p); }
            };
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoCells &p) const { return !operator==(p); }
         ...
         public:
            class US_UTIL_EXTERN ChanSolu {
               public:
                  ...
                  inline bool operator!=(const ChanSolu &c) const { return !operator==(c); }
            };
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoSolutions &p) const { return !operator==(p); }
         ...
         public:
            class US_UTIL_EXTERN OpticSys {
               public:
                  ...
                  inline bool operator!=(const OpticSys &s) const { return !operator==(s); }
            };
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoOptics &p) const { return !operator==(p); }
         ...
         public:
            class US_UTIL_EXTERN Ranges {
               public:
                  ...
                  inline bool operator!=(const Ranges &s) const { return !operator==(s); }
            };
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoRanges &p) const { return !operator==(p); }
      ...
      class US_UTIL_EXTERN RunProtoAProfile {
         public:
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoAProfile &p) const { return !operator==(p); }
      ...
      class US_UTIL_EXTERN RunProtoUpload {
         public:
            ...
            //! A test for unequal components
            inline bool operator!=(const RunProtoUpload &p) const { return !operator==(p); }
      ...
      inline bool operator!=(const US_RunProtocol &p) const { return !operator==(p); }
