...
public:
  ...
  public:
    ...
    inline bool
    operator!= (const RunProtoRotor &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    public:
      ...
      inline bool
      operator!= (const SpeedStep &p) const
      {
        return !operator== (p);
      }
    };
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoSpeed &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    public:
      ...
      inline bool
      operator!= (const CellUse &p) const
      {
        return !operator== (p);
      }
    };
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoCells &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    public:
      ...
      inline bool
      operator!= (const ChanSolu &c) const
      {
        return !operator== (c);
      }
    };
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoSolutions &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    public:
      ...
      inline bool
      operator!= (const OpticSys &s) const
      {
        return !operator== (s);
      }
    };
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoOptics &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoRanges &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoAProfile &p) const
    {
      return !operator== (p);
    }
  ...
  public:
    ...
    //! A test for unequal components
    inline bool
    operator!= (const RunProtoUpload &p) const
    {
      return !operator== (p);
    }
  ...
  inline bool
  operator!= (const US_RunProtocol &p) const
  {
    return !operator== (p);
  }
