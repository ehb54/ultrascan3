   ...
   public:
      ...
      class US_UTIL_EXTERN Band_Forming_Gradient {
         public:
            ...
            QList<QString> bessel_types; //!< Bessel function types
            ...
            //! \param scn_hint The pointer to the hint where to start
            void interpolateCCodiff(int N, const double *x, double t, double *DensCosed, double *ViscCosed, const int* scn_hint);
            ...
            //! \param scn_hint The pointer to the hint where to start
            void interpolateCCodiff(int N, const double *x, double t, double *DensCosed, double *ViscCosed, double *ConcCosed, const int* scn_hint);
