...
void Link::rx(void) {
   ...
   if (parseerror.error) {
      ...
      if (
         rootObj.contains("elapsedTime") && rootObj.contains("omega2T") && rootObj.contains("speed")
         && rootObj.contains("temperature") && rootObj.contains("vacuum") && rootObj.contains("stage")
