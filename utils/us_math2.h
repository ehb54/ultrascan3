...
public:
  ...
  static bool intersect (double &, double &, double &, double &, double *,
                         double *);
  ...
  static double
  adjust_vbar20 (double vbar, double degC)
  ...
  static double
  adjust_vbar (double vbar, double degC)
...
private:
  ...
  static int _nnls_h12 (int, int, int, int m, double *, int, double *,
                        double *, int, int, int);
};
#endif
