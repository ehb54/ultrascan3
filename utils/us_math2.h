...
class US_UTIL_EXTERN US_Math2 {
 public:
  ...
  //! \param sigma       Pointer to location to return the square root of the
  //! population variance (not related to the fit result)
  //! \param correlation Pointer to location to return the correlation
  //! \param arraysize   Input array size
  static double linefit(double**, double**, double*, double*, double*, double*,
                        int);
  ...
  static int nearest_curve_point(double*, double*, const int, bool, double&,
  ...
  static bool intersect(double*, double*, int, double*, double*, int, double*,
                        double*);
  ...
  */
  ...
  static int nnls(double* a, int a_dim1, int m, int n, double* b, double* x,
                  double* rnorm = NULL, double* wp = NULL, double* zzp = NULL,
                  int* indexp = NULL);
 ...
 private:
  ...
  static int _nnls_h12(int, int, int, int m, double*, int, double*, double*,
                       int, int, int);
};
#endif
