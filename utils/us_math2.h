...
class US_UTIL_EXTERN US_Math2 {
   public:
      ...
      static int nearest_curve_point(
         double *, double *, const int, bool, double &, double &, double *, double *, double *, double *);
      ...
      */
      ...
      static int nnls(
         double *a, int a_dim1, int m, int n, double *b, double *x, double *rnorm = NULL, double *wp = NULL,
         double *zzp = NULL, int *indexp = NULL);
