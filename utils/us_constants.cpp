...
QStringList
US_Constants::modelStrings (void)
{
  QStringList constants;

  constants
      << QObject::tr ("1-Component, Ideal")                    // model 0
      ...
      << QObject::tr (
             "User-Defined Monomer - N-mer - M-mer Equilibrium")      //  13
      << QObject::tr ("2-Component Hetero-Association: A + B <=> AB") //  14
      << QObject::tr ("User-defined self/Hetero-Association: A + B <=> AB, nA "
                      "<=> An") // 15
      << QObject::tr (
             "User-Defined Monomer-Nmer, some monomer is incompetent") // 16
      << QObject::tr (
             "User-Defined Monomer-Nmer, some Nmer is incompetent")  // 17
