...
void US_ZSolute::put_solute_attr(US_ZSolute& solute, double& aval,
                                 const int a_type) {
  switch (a_type) {
    default:
    case 0:  // X value
...
void US_ZSolute::get_solute_attr(US_ZSolute& solute, double& aval,
                                 const int a_type) {
  switch (a_type) {
    default:
    case 0:  // X value
...
QVector<US_ZSolute> US_ZSolute::create_grid_solutes(double x_min, double x_max,
                                                    double x_step, double y_min,
                                                    double y_max, double y_step,
                                                    double* z_coeffs) {
