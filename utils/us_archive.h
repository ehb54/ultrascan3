...
public:
  ...
  //! \param sourcePathList List of all files and folders need to be
  //! compressed. No need to list the contents of folders.
  //! \param archivePath    If only the filename is given, the output path is
  //! taken from the first one. Otherwise, the archive file will be saved in
  //! the given path. After compression is complete, this parameter stores the
  //! path to the archive file. Supported files: tar, tar.gz, tgz, tar.bz2,
  //! tar.xz, .zip
