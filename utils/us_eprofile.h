...
class US_UTIL_EXTERN US_ExtProfile {
   public:
      ...
      static int fetch_eprofile(US_DB2 *, const int, QString &, QString &, QMap<double, double> &);
      ...
      static bool parse_eprofile(QString &, int *, QString *, QString *, QMap<double, double> &);
      ...
      static int create_eprofile(US_DB2 *, const int, QString &, QString &, QMap<double, double> &);
      ...
      static bool xml_eprofile(const int, QString &, QString &, QMap<double, double> &, QString &);
      ...
      static bool update_eprofile(US_DB2 *, const int, const int, QString &, QString &, QMap<double, double> &);
