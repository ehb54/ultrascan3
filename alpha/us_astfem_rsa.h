...
class US_UTIL_EXTERN US_Astfem_RSA : public QObject
{
   ...
   public:
      ...
      //-------------------------------------------------------------------- 
      //! \used for keeping information in each second during the experiment
      //! \US_TimeState is defined in us_time_state.h 
      ...
      //! \It takes experimental data as input and gives back the finite element
      //! \simulation solution on experimental grid.
      //! Input : Experimental data set
      //! Output: Updated experimental data set with concentration values
      //          at grid points
      ...
      //! \used for choice of interpolation either w.r.t. time or 
      //! \omega_square_t
