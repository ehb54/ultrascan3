...
class US_UTIL_EXTERN US_XpnData : public QObject
{
   ...
   public:
      ...
      //! \brief Write timestat files
      //! \param allData    Vector of AUC raw data
      //! \param speedsteps Vector of speed steps
      //! \param cur_dir    Current directory for timestate
     void     write_timestate( QVector< US_DataIO::RawData >&,
   ...
   private:
      ...
      int       etimoff;             //!< Experiment time offset
