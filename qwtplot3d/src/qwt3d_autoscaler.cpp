...
\endverbatim
*/
int LinearAutoScaler::segments(int& l_intervals, int& r_intervals, double start,
...
/*!
        ...
        \return Number of intervals after rescaling. This will in the most cases
  differ from the requested interval number!  Always >0.
...
*/
int LinearAutoScaler::execute(double& a, double& b, double start, double stop,
                              int ivals) {
