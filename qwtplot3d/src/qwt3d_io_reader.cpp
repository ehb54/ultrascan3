...
//! set to data begin
bool extract_info(FILE* fp, unsigned int& xmesh, unsigned int& ymesh,
...
bool NativeReader::collectInfo(FILE*& file, QString const& fname,
                               unsigned& xmesh, unsigned& ymesh, double& minx,
