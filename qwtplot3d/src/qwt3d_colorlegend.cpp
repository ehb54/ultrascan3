...
void
ColorLegend::setTitleFont (QString const &family, int pointSize, int weight,
                           bool italic)
{
...
void
ColorLegend::setScale (SCALETYPE val)
{
  axis_.setScale (val);
}

void
ColorLegend::setScale (Scale *val)
{
  axis_.setScale (val);
}

void
ColorLegend::setOrientation (ORIENTATION orientation, SCALEPOSITION pos)
{
