...
Plot3D::Plot3D (QWidget *parent, const char *name) : QGLWidget (parent, name)
#else
...
#endif
{
  ...
  assignMouse (
      Qt::LeftButton, Qt::LeftButton | Qt::ShiftButton, Qt::LeftButton,
      Qt::LeftButton | Qt::AltButton, Qt::LeftButton | Qt::AltButton,
      Qt::LeftButton | Qt::AltButton | Qt::ShiftButton,
      Qt::LeftButton | Qt::AltButton | Qt::ControlButton,
      Qt::LeftButton | Qt::ControlButton, Qt::LeftButton | Qt::ControlButton);

  assignKeyboard (
      Qt::Key_Down, Qt::Key_Up, Qt::ShiftButton + Qt::Key_Right,
      Qt::ShiftButton + Qt::Key_Left, Qt::Key_Right, Qt::Key_Left,
      Qt::AltButton + Qt::Key_Right, Qt::AltButton + Qt::Key_Left,
      Qt::AltButton + Qt::Key_Down, Qt::AltButton + Qt::Key_Up,
      Qt::AltButton + Qt::ShiftButton + Qt::Key_Down,
      Qt::AltButton + Qt::ShiftButton + Qt::Key_Up,
      Qt::AltButton + Qt::ControlButton + Qt::Key_Down,
      Qt::AltButton + Qt::ControlButton + Qt::Key_Up,
      Qt::ControlButton + Qt::Key_Right, Qt::ControlButton + Qt::Key_Left,
      Qt::ControlButton + Qt::Key_Down, Qt::ControlButton + Qt::Key_Up);
#else
  setFocusPolicy (Qt::StrongFocus);
  assignMouse (
      Qt::LeftButton, MouseState (Qt::LeftButton, Qt::ShiftModifier),
      Qt::LeftButton, MouseState (Qt::LeftButton, Qt::AltModifier),
  ...
  assignKeyboard (
      ...
      KeyboardState (Qt::Key_Left, Qt::ShiftModifier), Qt::Key_Right,
      Qt::Key_Left, KeyboardState (Qt::Key_Right, Qt::AltModifier),
  ...
  if (beg != end)
    {
      if (ortho_)
        ...
        {
          glFrustum (-radius, +radius, -radius, +radius, 5 * radius,
                     400 * radius);
        }
    }
  else
...
*/
QPixmap
Plot3D::renderPixmap (int w /* =0 */, int h /* =0 */,
...
/*!
  Set plotstyle for the standard plotting types. An argument of value
  Qwt3D::USER is ignored.
*/
void
...
*/
Qwt3D::Enrichment *
Plot3D::setPlotStyle (Qwt3D::Enrichment const &obj)
{
...
/*!
  Set number of isolines. The lines are equidistant between minimal and maximal
  Z value
*/
void
...
/*!
  Set Polygon offset. The function affects the OpenGL rendering process.
        Try different values for surfaces with polygons only and with mesh and
  polygons
*/
void
...
/*!
Set relative caption position (0.5,0.5) means, the anchor point lies in the
...
*/
void
Plot3D::setTitleFont (const QString &family, int pointSize, int weight,
                      bool italic)
{
...
Enrichment *
Plot3D::addEnrichment (Enrichment const &e)
{
