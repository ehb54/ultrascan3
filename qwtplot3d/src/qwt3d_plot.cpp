...
#endif
{
  ...
  assignMouse(Qt::LeftButton, Qt::LeftButton | Qt::ShiftButton, Qt::LeftButton,
  ...
  assignMouse(Qt::LeftButton, MouseState(Qt::LeftButton, Qt::ShiftModifier),
  ...
  assignKeyboard(
      Qt::Key_Down, Qt::Key_Up, KeyboardState(Qt::Key_Right, Qt::ShiftModifier),
...
Set caption font
*/
void Plot3D::setTitleFont(const QString& family, int pointSize, int weight,
                          bool italic) {
