...
void
ParametricSurface::setPeriodic (bool u, bool v)
{
  uperiodic_ = u;
  vperiodic_ = v;
}
...
void
ParametricSurface::assign (SurfacePlot &plotWidget)
{
...
/**
For plotWidget != 0 the function permanently assigns her argument (In fact,
assign(plotWidget) is called)
*/
bool
ParametricSurface::create ()
{
...
bool
ParametricSurface::create (SurfacePlot &pl)
{
  assign (pl);
  return create ();
}
