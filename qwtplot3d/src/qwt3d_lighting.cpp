...
void
Plot3D::enableLighting (bool val)
{
...
void
Plot3D::disableLighting (bool val)
{
  enableLighting (!val);
}

bool
Plot3D::lightingEnabled () const
{
...
*/
void
Plot3D::illuminate (unsigned light)
{
  if (light > 7)
    return;
...
*/
void
Plot3D::setMaterialComponent (GLenum property, double r, double g, double b,
                              double a)
{
...
/**
  This function is for convenience. It sets GL material properties with the
  equal r,g,b values and a blending alpha with value 1.0
*/
void
Plot3D::setMaterialComponent (GLenum property, double intensity)
{
...
*/
void
Plot3D::setShininess (double exponent)
{
  makeCurrent ();
...
*/
void
Plot3D::setLightComponent (GLenum property, double r, double g, double b,
                           double a, unsigned light)
{
  GLfloat rgba[4] = { (GLfloat)r, (GLfloat)g, (GLfloat)b, (GLfloat)a };
  makeCurrent ();
...
/**
  This function is for convenience. It sets GL light properties with the equal
  r,g,b values and a blending alpha with value 1.0
*/
void
Plot3D::setLightComponent (GLenum property, double intensity, unsigned light)
{
  setLightComponent (property, intensity, intensity, intensity, 1.0,
                     lightEnum (light));
}

/**
  Set the rotation angle of the light source. If you look along the respective
  axis towards ascending values, the rotation is performed in mathematical \e
  negative sense
...
*/
void
Plot3D::setLightRotation (double xVal, double yVal, double zVal,
                          unsigned light)
{
  if (light > 7)
    return;
...
*/
void
Plot3D::setLightShift (double xVal, double yVal, double zVal, unsigned light)
{
  if (light > 7)
    return;
...
void
Plot3D::applyLight (unsigned light)
{
  ...
  GLfloat lightPos[4]
      = { (GLfloat)lights_[light].shift.x, (GLfloat)lights_[light].shift.y,
          (GLfloat)lights_[light].shift.z, (GLfloat)1.0 };
