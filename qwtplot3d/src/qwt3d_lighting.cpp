...
*/
void Plot3D::setMaterialComponent(GLenum property, double r, double g, double b,
                                  double a) {
...
*/
void Plot3D::setLightComponent(GLenum property, double r, double g, double b,
...
*/
void Plot3D::setLightComponent(GLenum property, double intensity,
                               unsigned light) {
...
*/
void Plot3D::setLightRotation(double xVal, double yVal, double zVal,
                              unsigned light) {
  if (light > 7) return;
...
*/
void Plot3D::setLightShift(double xVal, double yVal, double zVal,
                           unsigned light) {
  if (light > 7) return;
...
void Plot3D::applyLight(unsigned light) {
  ...
  GLfloat lightPos[4] = {(GLfloat)lights_[light].shift.x,
                         (GLfloat)lights_[light].shift.y,
