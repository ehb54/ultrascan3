...
void SurfacePlot::readIn(GridData& gdata, Triple** data, unsigned int columns,
                         unsigned int rows) {
...
void SurfacePlot::readIn(GridData& gdata, double** data, unsigned int columns,
...
*/
bool SurfacePlot::loadFromData(Triple** data, unsigned int columns,
                               unsigned int rows, bool uperiodic,
                               bool vperiodic) {
  actualDataC_->clear();
...
/*!
        ...
        See also NativeReader::read() and Function::create()
*/
bool SurfacePlot::loadFromData(double** data, unsigned int columns,
                               unsigned int rows, double minx, double maxx,
                               double miny, double maxy) {
  actualDataC_->clear();
  actualData_p = actualDataG_;
...
void SurfacePlot::Data2FloorG() {
  ...
  for (int i = 0; i < actualDataG_->columns() - step; i += step) {
    ...
    glVertex3d(actualDataG_->vertices[i][0][0], actualDataG_->vertices[i][0][1],
               zshift);
