...
/**
        A Function encapsulates a mathematical function with rectangular domain.
   The user has to adapt the pure virtual operator() to get a working object.
   Also, the client code should call setDomain, setMesh and create for
...
class QWT3D_EXPORT Function : public GridMapping {
 public:
  ...
  explicit Function(
      Qwt3D::SurfacePlot& plotWidget);  //!< Constructs Function object and
                                        //!< assigns a SurfacePlot
  explicit Function(
      Qwt3D::SurfacePlot* plotWidget);  //!< Constructs Function object and
                                        //!< assigns a SurfacePlot
  ...
  virtual bool create();
  //! Assigns the object to another widget. To see the changes, you have to call
  //! this function before create().
