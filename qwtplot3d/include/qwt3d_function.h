...
/**
        A Function encapsulates a mathematical function with rectangular
   domain. The user has to adapt the pure virtual operator() to get a working
   object. Also, the client code should call setDomain, setMesh and create for
...
public:
  ...
  virtual bool create ();
  //! Assigns the object to another widget. To see the changes, you have to
