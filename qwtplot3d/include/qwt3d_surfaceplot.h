...
class QWT3D_EXPORT SurfacePlot : public Plot3D {
 ...
 public:
  ...
  std::pair<int, int> facets()
      const;  //!< Returns the number of mesh cells for the ORIGINAL data
  ...
  */
  bool createDataRepresentation(Qwt3D::Triple** data, unsigned int columns,
                                unsigned int rows, bool uperiodic = false,
                                bool vperiodic = false) {
  ...
  \deprecated  Use loadFromData instead
  */
  bool createDataRepresentation(double** data, unsigned int columns,
  ...
  */
  ...
  void setNormalQuality(
      int val);  //!< Increases plotting quality of normal arrows
