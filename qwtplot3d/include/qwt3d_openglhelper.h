...
*/
inline void getMatrices(GLdouble* modelMatrix, GLdouble* projMatrix,
                        GLint* viewport) {
...
/**
        Don't rely on (use) this in display lists !
*/
inline bool ViewPort2World(double& objx, double& objy, double& objz,
...
/**
        Don't rely on (use) this in display lists !
*/
inline bool World2ViewPort(double& winx, double& winy, double& winz,
