...
Mesh2MainWindow::Mesh2MainWindow(QWidget* parent) : DummyBase(parent) {
...
#if QT_VERSION < \
    0x040000  // todo - restore, when Qt4 re-implements preview functionality
  ...
  if (!pmhandler)
    pmhandler =
        (PixmapWriter*)IO::outputHandler("jpeg");  // Qt4 naming scheme change
...
void Mesh2MainWindow::openMesh() {
  ...
  QString edges(QFileDialog::getOpenFileName("../../data",
