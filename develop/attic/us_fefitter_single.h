#ifndef US_FEFITTER_SINGLE_H
#define US_FEFITTER_SINGLE_H
...
class US_EXTERN US_FeFitter_Single : public US_Minimize
{
	Q_OBJECT
	
	public:
		US_FeFitter_Single(bool * /* fitting_widget */,
							bool /* GUI */,
		...
		double *cu, *cv, *cw, sigma, delta, *ad_par, *right, *right_old, **b_orig;
		double *s_bar, *D_bar, **partial_c, **concentration, **left, *c_current, **left_temp;
		...
		struct veloc_parameterIndex ParameterIndex;
