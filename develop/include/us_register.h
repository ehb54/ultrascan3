...
/*!
	When you first time to use this software after you install it in a new machine. 
	This class will check your register information. To find whether you are registered,
	whether your license is valid, whether your license is expired. If some error occurs,
...
class US_EXTERN US_Register : public QFrame
{
	...
	public:
		...
		struct US_RegisterData register_list;	/*!< A struct US_RegisterData for storing register information. */
