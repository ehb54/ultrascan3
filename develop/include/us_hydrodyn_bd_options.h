...
class US_EXTERN US_Hydrodyn_BD_Options : public QFrame
{
   ...
   public:
      ...
      QButtonGroup  *bg_chem_pb_sc_bond_types;
      ...
      QButtonGroup  *bg_chem_sc_sc_bond_types;
      ...
      QLabel        *lbl_pb_pb;
      QButtonGroup  *bg_pb_pb_bond_types;
      ...
      QLabel        *lbl_pb_sc;
      QButtonGroup  *bg_pb_sc_bond_types;
      ...
      QLabel        *lbl_sc_sc;
      QButtonGroup  *bg_sc_sc_bond_types;
