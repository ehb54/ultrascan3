...
//!
//! 1) QIcon check = US3i_Images::getIcon( US3i_Images::CHECK );
//!
//! 2) QIcon check = US3i_Images::getIcon( "check" );
//!
//! 3) QIcon check = US3i_Images::getIcon( ":/images/check.png" );
//!
//! 4) QIcon check = US3i_Images::getIcon(
//!                     US3i_Settings::usHomeDir() + "/etc/check.png" );
//!
//! 5) QPixmap cpix = US3i_Images::getImage( US3i_Images::CHECK );
...
class US_GUI_EXTERN US3i_Images
{
   public:
