#ifndef US_FINITE_AD_H
#define US_FINITE_AD_H
...
class US_EXTERN US_Finite_ad : public Data_Control_W
{
	Q_OBJECT
	
	public:
	
		US_Finite_ad(QWidget *p = 0, const char *name = 0);
		~US_Finite_ad();
		US_Editor *e;
