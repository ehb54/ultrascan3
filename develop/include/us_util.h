...
struct centerpieceInfo
{
	...
	float bottom_position[4];	// bottom position of each channel, max 4., if sector==3: position for synth. boundary
	int sector;						// 0 sector shaped, 1 for rectangular, 2 for circular, 3 for synthetic boundary cells
