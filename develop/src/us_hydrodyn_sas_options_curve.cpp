...
US_Hydrodyn_SasOptionsCurve::US_Hydrodyn_SasOptionsCurve(struct saxs_options *saxs_options, bool *sas_options_curve_widget, void *us_hydrodyn, QWidget *p, const char *name) : QFrame( p )
{
...
void US_Hydrodyn_SasOptionsCurve::setupGUI()
{
   ...
   cb_normalize_by_mw->setText(us_tr(" Normalize P(r) vs r curve by molecular weight"));
