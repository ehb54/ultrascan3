...
US_Hydrodyn_SasOptionsCurve::US_Hydrodyn_SasOptionsCurve(struct saxs_options *saxs_options, bool *sas_options_curve_widget, void *us_hydrodyn, QWidget *p, const char *name) : QFrame(p, name)
{
