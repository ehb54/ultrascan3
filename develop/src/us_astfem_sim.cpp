...
void US_Astfem_Sim::new_model()
{
	...
	SelectModel = new US_SelectModel(&system.model, false);
	system.description = "Default ASTFEM Model";
	...
	if (SelectModel->exec())
	{
		switch (system.model)
		{
			case 0:
			{
				system.component_vector.resize(1);
				system.component_vector[0].name = "Component 1";
				break;
			}
			case 1:
			{
				system.component_vector.resize(2);
				system.component_vector[0].name = "Component 1";
				system.component_vector[1].name = "Component 2";
				break;
			}
			case 2:
			{
				system.component_vector.resize(3);
				system.component_vector[0].name = "Component 1";
				system.component_vector[1].name = "Component 2";
				system.component_vector[2].name = "Component 3";
				break;
			}
			case 3:	// fixed molecular weight distribution, we need some addtl. info from the user
			{
				...
				{
					system.component_vector.resize(species);
					QString str;
			...
			{
				system.component_vector.resize(2);
				system.component_vector[0].shape = "not defined";
				system.component_vector[1].shape = "not defined";
				system.component_vector[0].show_component.clear();
				system.component_vector[1].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Dimer";
				system.assoc_vector.resize(1);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
				system.assoc_vector[0].component1 = 0;
				system.assoc_vector[0].component2 = 1;
				system.assoc_vector[0].component3 = -1;
			...
			case 5: // Monomer-Trimer Equilibrium
			{
				...
				system.component_vector[1].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Trimer";
				system.assoc_vector.resize(1);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
			...
			case 6: // Monomer-Tetramer Equilibrium
			{
				...
				system.component_vector[1].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Tetramer";
				system.assoc_vector.resize(1);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
			...
			case 7: // Monomer-Pentamer Equilibrium
			{
				...
				system.component_vector[1].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Pentamer";
				system.assoc_vector.resize(1);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
			...
			case 8: // Monomer-Hexamer Equilibrium
			{
				...
				system.component_vector[1].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Hexamer";
				system.assoc_vector.resize(1);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
			...
			case 9: // Monomer-Heptamer Equilibrium
			{
				...
				system.component_vector[1].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Heptamer";
				system.assoc_vector.resize(1);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
			...
			case 10:	// User-Defined Monomer - N-mer Equilibrium, we need some addtl. info from the user
			{
				...
				else
				{
					...
					system.component_vector[1].show_component.clear();
					system.component_vector[0].name = "Monomer";
					system.component_vector[1].name = str.sprintf("N-mer (%d)", (unsigned int) stoich);
					system.assoc_vector.resize(1);
					system.assoc_vector[0].keq = 1.0;
					system.assoc_vector[0].k_off = 1.0;
					system.assoc_vector[0].units = "OD";
			...
			case 11: // Monomer-Dimer-Trimer Equilibrium
			{
				...
				system.component_vector[0].shape = "not defined";
				system.component_vector[1].shape = "not defined";
				system.component_vector[2].shape = "not defined";
				system.component_vector[0].show_component.clear();
				system.component_vector[1].show_component.clear();
				system.component_vector[2].show_component.clear();
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Dimer";
				system.component_vector[2].name = "Trimer";
				system.assoc_vector.resize(2);
				system.assoc_vector[0].keq = 1.0;
				system.assoc_vector[0].k_off = 1.0;
				system.assoc_vector[0].units = "OD";
				system.assoc_vector[0].component1 = 0;
				...
				system.assoc_vector[0].stoichiometry2 = 2;
				system.assoc_vector[0].stoichiometry3 = 0;
				system.assoc_vector[1].keq = 1.0;
				system.assoc_vector[1].k_off = 1.0;
				system.assoc_vector[1].units = "OD";
			...
			case 12: // Monomer-Dimer-Tetramer Equilibrium
			{
				...
				system.component_vector[0].name = "Monomer";
				system.component_vector[1].name = "Dimer";
				system.component_vector[2].name = "Tetramer";
				system.component_vector[0].show_component.clear();
				system.component_vector[1].show_component.clear();
				system.component_vector[2].show_component.clear();
				system.assoc_vector.resize(2);
			...
			case 13:	// User-Defined Monomer - N-mer - M-mer Equilibrium, we need some addtl. info from the user
			{
				...
				else
				{
					...
					system.component_vector[2].show_component.clear();
					system.component_vector[0].name = "Monomer";
					system.component_vector[1].name = str.sprintf("N-mer (%d)", (unsigned int) stoich1);
					system.component_vector[2].name = str.sprintf("M-mer (%d)", (unsigned int) stoich2);
					system.assoc_vector.resize(2);
					system.assoc_vector[0].keq = 1.0;
					system.assoc_vector[0].k_off = 1.0;
					system.assoc_vector[0].units = "OD";
					...
					system.assoc_vector[0].component3 = -1;
					system.assoc_vector[0].stoichiometry1 = 1;
					system.assoc_vector[0].stoichiometry2 = (unsigned int) stoich1;
					system.assoc_vector[0].stoichiometry3 = 0;
					system.assoc_vector[1].keq = 1.0;
					system.assoc_vector[1].k_off = 1.0;
					system.assoc_vector[1].units = "OD";
			...
			case 14:	// 2 component hetero association.
			{
				...
				system.component_vector[1].shape = "not defined";
				system.component_vector[2].shape = "not defined";
				system.component_vector[0].name = "Component A";
				system.component_vector[1].name = "Component B";
				system.component_vector[2].name = "Component AB";
				system.component_vector[0].show_component.clear();
				system.component_vector[1].show_component.clear();
				system.component_vector[2].show_component.clear();
				system.assoc_vector.resize(1);
				...
				system.assoc_vector[0].component1 = 0;
				system.assoc_vector[0].component2 = 1;
				system.assoc_vector[0].component3 = 2;
				system.assoc_vector[0].stoichiometry1 = 1; // for hetero-associating systems the stoichiometry is zero
				system.assoc_vector[0].stoichiometry2 = 1;
				system.assoc_vector[0].stoichiometry3 = 1;
				initializeAssociation2();
				system.component_vector[0].show_conc = true;
				system.component_vector[0].show_stoich = 0;
				system.component_vector[0].show_keq = false;
				system.component_vector[0].show_koff = false;
				system.component_vector[0].show_component.push_back(1);
				system.component_vector[0].show_component.push_back(2);

				system.component_vector[1].show_conc = true;
				system.component_vector[1].show_stoich = 0;
				system.component_vector[1].show_keq = false;
				system.component_vector[1].show_koff = false;
				system.component_vector[1].show_component.push_back(0);
				system.component_vector[1].show_component.push_back(2);

				system.component_vector[2].show_conc = false;
				system.component_vector[2].show_stoich = -1; // -1 means hetero - association
				system.component_vector[2].show_keq = true;
				system.component_vector[2].show_koff = true;
				system.component_vector[2].show_component.push_back(0);
				system.component_vector[2].show_component.push_back(1);
				break;
			}
			case 15:	// 2 component hetero association, one of the components self-associates.
			{
				...
				{
					system.component_vector.resize(4);
					system.component_vector[0].shape = "not defined";
					system.component_vector[1].shape = "not defined";
					system.component_vector[2].shape = "not defined";
					system.component_vector[3].shape = "not defined";
					system.component_vector[0].name = "Component A";
					system.component_vector[1].name = "Component B";
					system.component_vector[2].name = "Component AB";
					system.component_vector[3].name = str.sprintf("N-mer of component A (%d)", (unsigned int) stoich);
					system.component_vector[0].show_component.clear();
					system.component_vector[1].show_component.clear();
					system.component_vector[2].show_component.clear();
					system.component_vector[3].show_component.clear();
					system.assoc_vector.resize(2);
// Hetero-Association:
					system.assoc_vector[0].keq = 1.0;
					system.assoc_vector[0].k_off = 1.0;
...
// Self-Association:
					...
					system.assoc_vector[1].units = "OD";
					system.assoc_vector[1].component1 = 0;
					system.assoc_vector[1].component2 = 3;
					system.assoc_vector[1].component3 = -1;
					system.assoc_vector[1].stoichiometry1 = 1;
					...
					system.component_vector[3].show_conc = false;
					system.component_vector[3].show_stoich = (int) stoich;
					system.component_vector[3].show_keq = true;
					system.component_vector[3].show_koff = true;
				}
				break;
			}
			case 16:	// User-Defined Monomer - N-mer Equilibrium, some incompetent monomer, we need some addtl. info from the user
			{
				...
				else
				{
					...
					system.component_vector[0].name = "Monomer";
					system.component_vector[1].name = str.sprintf("N-mer (%d)", (unsigned int) stoich);
					system.component_vector[2].name = "Incompetent Monomer";
					system.component_vector[0].show_component.clear();
					system.component_vector[1].show_component.clear();
					system.component_vector[2].show_component.clear();
					system.assoc_vector.resize(2);
					...
					system.assoc_vector[1].keq = 0.0;     // irreversible components have zero equilibrium constant
					system.assoc_vector[1].k_off = 0.0;
					system.assoc_vector[1].units = "OD";
					system.assoc_vector[1].component1 = 0;
					system.assoc_vector[1].component2 = 2;
					system.assoc_vector[1].component3 = -1;
					...
					system.component_vector[2].mw = system.component_vector[0].mw;
					system.component_vector[2].s = system.component_vector[0].s;
					system.component_vector[2].D = system.component_vector[0].D;
					system.component_vector[2].f_f0 = system.component_vector[0].f_f0;
					system.component_vector[2].vbar20 = system.component_vector[0].vbar20;
					system.component_vector[2].sigma = system.component_vector[0].sigma;
					system.component_vector[2].delta = system.component_vector[0].delta;
					system.component_vector[2].shape = "";
					system.component_vector[2].concentration = 0.3;
					system.component_vector[2].extinction = system.component_vector[0].extinction;
					system.component_vector[2].show_conc = true;
					system.component_vector[2].show_stoich = 1;
					system.component_vector[2].show_keq = false;
					system.component_vector[2].show_koff = false;
					system.component_vector[2].show_component.push_back(0);
					system.component_vector[0].show_component.push_back(2);
				}
				break;
			...
			case 17:	// User-Defined Monomer - N-mer Equilibrium, some incompetent N-mer, we need some addtl. info from the user
			{
				...
				else
				{
					...
					system.component_vector[0].name = "Monomer";
					system.component_vector[1].name = str.sprintf("N-mer (%d)", (unsigned int) stoich);
					system.component_vector[2].name = "Incompetent N-mer";
					system.assoc_vector.resize(2);
					system.assoc_vector[0].keq = 1.0;
					system.assoc_vector[0].k_off = 1.0;
					system.assoc_vector[0].units = "OD";
					...
					system.assoc_vector[1].keq = 0.0;   // irreversible components have zero equilibrium constants
					system.assoc_vector[1].k_off = 0.0;
					system.assoc_vector[1].units = "OD";
					system.assoc_vector[1].component1 = 0;
					system.assoc_vector[1].component2 = 2;
					...
					system.component_vector[2].f_f0 = system.component_vector[1].f_f0;
					system.component_vector[2].vbar20 = system.component_vector[1].vbar20;
					system.component_vector[2].sigma = system.component_vector[1].sigma;
					system.component_vector[2].delta = system.component_vector[1].delta;
					system.component_vector[2].shape = "";
					system.component_vector[2].concentration = 0.3;
					system.component_vector[2].extinction = system.component_vector[1].extinction;
					system.component_vector[2].show_conc = true;
					system.component_vector[2].show_stoich = (int) stoich;
					system.component_vector[2].show_keq = false;
					system.component_vector[2].show_koff = false;
					system.component_vector[2].show_component.push_back(0);
					system.component_vector[0].show_component.push_back(2);
			...
			case 18:	// User-Defined irreversible Monomer - N-mer
			{
				...
				else
				{
					...
					system.component_vector[1].name = str.sprintf("N-mer (%d)", (unsigned int) stoich);
					system.assoc_vector.resize(1);
					system.assoc_vector[0].keq = 0.0;  // irreversible components have zero equilibrium constants
					system.assoc_vector[0].k_off = 0.0;
					system.assoc_vector[0].units = "OD";
					system.assoc_vector[0].component1 = 0;
					system.assoc_vector[0].component2 = 1;
					system.assoc_vector[0].component3 = -1;
					...
					system.component_vector[1].concentration = 0.3;
					system.component_vector[0].show_conc = true;
					system.component_vector[0].show_stoich = 0;
					system.component_vector[0].show_keq = false;
					system.component_vector[0].show_koff = false;
					system.component_vector[1].show_conc = true;
					system.component_vector[1].show_stoich = (int) stoich;
					system.component_vector[1].show_keq = false;
					system.component_vector[1].show_koff = false;
				}
				break;
			...
			case 19:	// User-Defined Monomer - N-mer Equilibrium, plus some contaminant, we need some addtl. info from the user
			{
				...
				else
				{
					...
					system.component_vector[0].name = "Monomer";
					system.component_vector[1].name = str.sprintf("N-mer (%d)", (unsigned int) stoich);
					system.component_vector[2].name = "Contaminant";
					system.component_vector[0].shape = "not defined";
					system.component_vector[1].shape = "not defined";
					system.component_vector[2].shape = "not defined";
					system.assoc_vector.resize(1);
					...
					system.component_vector[2].s = 1.9802e-13;
					system.component_vector[2].D = 7.7981e-7;
					system.component_vector[2].f_f0 = 1.4893;
					system.component_vector[2].vbar20 = 0.72;
					system.component_vector[2].sigma = 0.0;
					system.component_vector[2].delta = 0.0;
					system.component_vector[2].shape = "prolate";
					system.component_vector[2].concentration = 0.3;
					system.component_vector[2].extinction = 0.5;
					system.component_vector[2].show_conc = true;
					system.component_vector[2].show_stoich = 0;
					system.component_vector[2].show_keq = false;
					system.component_vector[2].show_koff = false;
				}
				break;
	...
	if (system.model >= 0 && system.model < 4) // noninteracting multicomponent system
	{
		QString str;
		for (unsigned int i=0; i<system.component_vector.size(); i++)
		{
			...
			system.component_vector[i].show_component.clear();
			system.component_vector[i].shape = "";
			system.component_vector[i].s = 0.0;
			system.component_vector[i].D = 0.0;
			system.component_vector[i].concentration = 0.0;
			system.component_vector[i].mw = 0.0;
			system.component_vector[i].c0.radius.clear();
			system.component_vector[i].c0.concentration.clear();

			if(system.model <= 3 && model3_vbar != 0.0)
			{
				system.component_vector[i].vbar20 = model3_vbar;
				if (system.component_vector.size() == 1)
				{
			...
			system.component_vector[i].sigma = 0.0;
			system.component_vector[i].delta = 0.0;
			system.component_vector[i].extinction = 1.0;
			system.component_vector[i].shape = "not defined";
		}
	}
	assign_model();
}
...
void US_Astfem_Sim::initializeAssociation1(unsigned int comp1, unsigned int comp2, unsigned stoich1)
{
	system.component_vector[comp1].show_conc = true;
	system.component_vector[comp1].show_stoich = 0;
	system.component_vector[comp1].show_keq = false;
	system.component_vector[comp1].show_koff = false;
	system.component_vector[comp1].show_component.push_back(comp2);
	system.component_vector[comp2].show_conc = false;
	system.component_vector[comp2].show_stoich = stoich1;
	system.component_vector[comp2].show_keq = true;
	system.component_vector[comp2].show_koff = true;
	system.component_vector[comp2].show_component.push_back(comp1);
	system.component_vector[comp1].mw = 5.0e4;
	system.component_vector[comp2].mw = 5.0e4 * stoich1;
	system.component_vector[comp1].f_f0 = 1.25;
	system.component_vector[comp1].vbar20 = 0.72;
	system.component_vector[comp2].vbar20 = 0.72;
	system.component_vector[comp1].sigma = 0.0;
	system.component_vector[comp2].delta = 0.0;
	system.component_vector[comp1].shape = "not defined";
	system.component_vector[comp2].shape = "not defined";
	system.component_vector[comp1].concentration = 1.0;
	system.component_vector[comp2].concentration = 0.0;
	system.component_vector[comp1].extinction = 1.0;
	system.component_vector[comp2].extinction = stoich1;
	system.component_vector[comp1].c0.radius.clear();
	system.component_vector[comp1].c0.concentration.clear();
	system.component_vector[comp2].c0.radius.clear();
...
void US_Astfem_Sim::initializeAssociation2()
{
// Component A:
	system.component_vector[0].mw = 5.0e4;
	system.component_vector[0].f_f0 = 1.25;
	system.component_vector[0].vbar20 = 0.72;
	system.component_vector[0].sigma = 0.0;
	system.component_vector[0].shape = "not defined";
...
// Component B:
	system.component_vector[1].mw = 22000.0;
	system.component_vector[1].s = 1.9802e-13;
	system.component_vector[1].D = 7.7981e-7;
	system.component_vector[1].f_f0 = 1.4893;
	system.component_vector[1].vbar20 = 0.72;
	system.component_vector[1].sigma = 0.0;
	system.component_vector[1].delta = 0.0;
	system.component_vector[1].shape = "prolate";
	system.component_vector[1].concentration = 0.3;
	system.component_vector[1].extinction = 0.5;

// Component AB:
	system.component_vector[2].mw = 72000.0;
	system.component_vector[2].s = 4.7276e-13;
	system.component_vector[2].D = 5.6886e-7;
	system.component_vector[2].f_f0 = 1.3751;
	system.component_vector[2].vbar20 = 0.72;
	system.component_vector[2].sigma = 0.0;
	system.component_vector[2].delta = 0.0;
	system.component_vector[2].shape = "prolate";
	system.component_vector[2].concentration = 0.0;
	system.component_vector[2].extinction = 1.5;
