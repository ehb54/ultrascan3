                                                                     ...
                                                                     ) : QDialog(p, name)
{
   ...
   setCaption( tr( "US-SOMO: SAXS Hplc: File Concentration Loader"));
...
void US_Hydrodyn_Saxs_Hplc_Conc_Load::setupGUI()
{
   ...
   t_csv = new QTable(disp_csv.data.size(), disp_csv.header.size(), this);
   ...
   pb_del_row->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   pb_set_name->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   lbl_name->setPalette(QPalette(USglobal->global_colors.cg_label, USglobal->global_colors.cg_normal, USglobal->global_colors.cg_normal));
   ...
   pb_adjust->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   pb_set_conc->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   lbl_conc->setPalette(QPalette(USglobal->global_colors.cg_label, USglobal->global_colors.cg_normal, USglobal->global_colors.cg_normal));
   ...
   lbl_trial->setPalette(QPalette(USglobal->global_colors.cg_label, USglobal->global_colors.cg_normal, USglobal->global_colors.cg_normal));
...
void US_Hydrodyn_Saxs_Hplc_Conc_Load::cancel()
{
   close();
}
...
void US_Hydrodyn_Saxs_Hplc_Conc_Load::help()
{
   ...
   online_help->show_help("manual/somo_saxs_hplc_conc_load.html");
}
...
void US_Hydrodyn_Saxs_Hplc_Conc_Load::adjust()
{
   ...
   int res = QInputDialog::getInteger(
                                      tr( "US-SOMO: SAXS Hplc: File Concentration Loader: Adjust timecode" ),
...
{
   t_csv->clearSelection();
   QTableSelection qts( 0, col, t_csv->numRows(), col );
