...
void US_Hydrodyn_Pdb_Tool::sel_nearest_residues( QListView *lv )
{
...
set < QListViewItem * > US_Hydrodyn_Pdb_Tool::get_exposed_set( QListView * lv, 
                                                               double max_asa, 
                                                               bool only_selected )
{
   set < QListViewItem * > result;
...
vector < QString > US_Hydrodyn_Pdb_Tool::get_models( QListView *lv )
{
...
vector < vector < QListViewItem * > > US_Hydrodyn_Pdb_Tool::separate_models( QListView *lv )
{
   vector < QListViewItem * >            vlvi;
   vector < vector < QListViewItem * > > vvlvi;
...
void US_Hydrodyn_Pdb_Tool::select_residues_with_atoms_selected( QListView *lv )
{
   QListViewItemIterator it( lv );
   while ( it.current() ) 
   {
