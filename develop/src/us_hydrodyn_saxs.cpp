...
US_Hydrodyn_Saxs::US_Hydrodyn_Saxs(bool *saxs_widget, QWidget *p, const char *name) : QFrame(p, name)
{
...
void US_Hydrodyn_Saxs::plot_pr()
{
}

void US_Hydrodyn_Saxs::plot_saxs()
{
}
