...
void US_Hydrodyn_Batch_Movie_Opts::setupGUI()
{
   ...
   le_title = new QLineEdit( this );    le_title->setObjectName( "Title Line Edit" );
   ...
   lbl_file = new QLabel(us_tr(" Name of movie file (.avi will be appended):"), this);
   ...
   le_file = new QLineEdit( this );    le_file->setObjectName( "File Line Edit" );
   ...
   le_fps = new QLineEdit( this );    le_fps->setObjectName( "Fps Line Edit" );
   ...
   le_scale = new QLineEdit( this );    le_scale->setObjectName( "Scale Line Edit" );
   ...
   le_tc_unit = new QLineEdit( this );    le_tc_unit->setObjectName( "Tc_Unit Line Edit" );
   ...
   le_tc_start = new QLineEdit( this );    le_tc_start->setObjectName( "Tc_Start Line Edit" );
   ...
   le_tc_delta = new QLineEdit( this );    le_tc_delta->setObjectName( "Tc_Delta Line Edit" );
   ...
   le_tc_pointsize = new QLineEdit( this );    le_tc_pointsize->setObjectName( "Tc_Pointsize Line Edit" );
...
void US_Hydrodyn_Batch_Movie_Opts::update_dir_msg()
{
   ...
   if ( !fi.exists() )
   {
      ...
      lbl_dir->setText(us_tr(" Directory for movie file (Warning: does not exist):"));
   } else {
      if ( !fi.isDir() )
      {
         lbl_dir->setPalette(label_font_warning);
         lbl_dir->setText(us_tr(" Directory for movie file (Error: not a directory!):"));
      } else {
         if ( !fi.isWritable() )
         {
            lbl_dir->setPalette(label_font_warning);
            lbl_dir->setText(us_tr(" Directory for movie file (Error: not writable!):"));
         } else {
