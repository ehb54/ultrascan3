...
US_Color::US_Color(QWidget *p, const char* name) : QFrame(p, name)
{
	...
	lbl_background->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize, QFont::Bold));
	...
	lbl_margin->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	cmbb_margin->setFont(QFont(USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1));
	QString str_number;
	...
	lbl_example->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	progress->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	lbl_lcd->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	lcd->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	lbl_counter->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	cnt->setValue(35);
	cnt->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_normal->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	pb_active->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	pb_disabled->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	pb_reset->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb));	connect(pb_reset, SIGNAL(clicked()), SLOT(reset()));
	...
	pb_apply->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_assign->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize, QFont::Bold));
	...
	lbl_select->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	lbl_choice->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	lbl_color1->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_color1->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_color2->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_color2->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_color3->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_color3->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_color4->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_color4->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_color5->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_color5->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_color6->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_color6->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	lbl_choices->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize, QFont::Bold));
	...
	lbl_select_scheme->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	lbl_select_element->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	scheme_dir1.setPath(USglobal->config_list.system_dir + "/etc");	// system wide color defs
	...
	lb_scheme->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	current_scheme = 0;
	...
	lb_item->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
	...
	pb_save_as->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
	...
	le_save_as->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize - 1, QFont::Bold));
...
{
	temp_colors = USglobal->global_colors;		// called when temp_colors are initialized with setting from US_Config
...
void US_Color::selected_scheme(int scheme)
{
	...
	else
	{
		...
		f.setName(colfile);
		if (!f.exists())		// if we can't find it in the system wide shared directory, check the home directory
		{
...
void US_Color::delete_scheme()
{
	...
	int result = QMessageBox::warning(0, tr("Attention:"), str, tr("Yes"), tr("No"), QString::null, 1, 1);
	if (result == 0)
	{
		if (current_scheme == 0)
		{
			QMessageBox::message(tr("Attention:"), tr("Sorry, the current scheme cannot\n"
														  "be deleted. Please try again..."));
			return;
		}
		if (current_scheme == 1)
		{
			QMessageBox::message(tr("Attention:"), tr("Sorry, you cannot delete the\n"
		...
		scheme_dir1.setNameFilter(filter);
		entries1 = scheme_dir1.entryList();
		for (QStringList::Iterator it = entries1.begin(); it != entries1.end(); ++it ) // make sure it's not a system color definition
		{
			str = (*it).latin1();
			str.truncate(str.findRev(".", -1, false));	// strip the extension
			if (str == lb_scheme->text(current_scheme))
			{
				QMessageBox::message(tr("Attention:"), tr("Sorry, this color definition\n"
															  "is a system resource and cannot\n"
															  "be deleted. Please try again..."));
				return;
			}
		}
		QFile f(USglobal->config_list.root_dir + "/" + lb_scheme->text(current_scheme) + ".col");
		if (!f.remove())
		{
			QMessageBox::message(tr("Attention:"), tr("Sorry, couldn't delete the\n"
...
// update widgets:
	...
	QFile f;
	QString colfile, home = (getenv("HOME"));
	if (home != "/")
	{
		home.append("/");
	}
...
// Apply current setting before saving it:
	...
	QStringList entries;
	system_dir.setPath(USglobal->config_list.system_dir + "/etc");	// system wide color defs
	...
	if (problem)
	{
		QMessageBox::message(tr("Attention:"), tr("Sorry - \n\nthis name is reserved for a system-\n"
													  "wide color scheme.\n\n"
	...
	QString filename;
	filename = USglobal->config_list.root_dir + "/" + save_str;
	...
	{
		QMessageBox::message(tr("Warning:"), tr("Unable to open color file for output!\n"
