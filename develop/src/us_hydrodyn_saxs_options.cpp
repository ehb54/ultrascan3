...
void US_Hydrodyn_SaxsOptions::setupGUI()
{
   ...
   pb_sas_options_saxs->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   pb_sas_options_sans->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   pb_sas_options_curve->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
   ...
   pb_sas_options_misc->setPalette( QPalette(USglobal->global_colors.cg_pushb, USglobal->global_colors.cg_pushb_disabled, USglobal->global_colors.cg_pushb_active));
...
void US_Hydrodyn_SaxsOptions::sas_options_bead_model()
{
   ...
   {
      if ( ((US_Hydrodyn *)us_hydrodyn)->sas_options_bead_model_window->isVisible() )
      {
...
void US_Hydrodyn_SaxsOptions::sas_options_hydration()
{
   ...
   {
      if ( ((US_Hydrodyn *)us_hydrodyn)->sas_options_hydration_window->isVisible() )
      {
...
void US_Hydrodyn_SaxsOptions::sas_options_experimental()
{
   ...
   {
      if ( ((US_Hydrodyn *)us_hydrodyn)->sas_options_experimental_window->isVisible() )
      {
