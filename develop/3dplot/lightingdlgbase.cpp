 ...
 */
lightingdlgbaseBase::lightingdlgbaseBase( QWidget* parent, const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    ...
    lightingdlgbaseBaseLayout = new QGridLayout( this, 1, 1, 11, 6, "lightingdlgbaseBaseLayout"); 
    ...
    ambdiffSL->setOrientation( QSlider::Horizontal );
    ...
    specSL->setValue( 30 );
    specSL->setOrientation( QSlider::Horizontal );
    ...
    shinSL->setValue( 500 );
    shinSL->setOrientation( QSlider::Horizontal );
    ...
    emissSL->setOrientation( QSlider::Horizontal );
    ...
    distSL->setValue( 100 );
    distSL->setOrientation( QSlider::Horizontal );
