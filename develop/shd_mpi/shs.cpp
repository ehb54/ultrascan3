...
void SHS::build( int         max_harmonics,
                 shd_double  delta,
                 shd_double  max_x )
{
...
bool SHS::apply_natural_spline( vector < shd_double > &xa, 
...
void SHS::natural_spline( vector < shd_double > &x, 
                          vector < shd_double > &y,
...
bool SHS::apply_natural_spline( shd_double              x,
...
bool SHS::write_c_table( string oname )
{
   ...
   ofs << "static shd_double shbes_y[ " << y_t.size() << " ][ " << y_t[ 0 ].size() << " ] =" << endl;
   ofs << "  {" << endl;
   ...
   ofs << "static shd_double shbes_y2[ " << y2_t.size() << " ][ " << y2_t[ 0 ].size() << " ] =" << endl;
   ofs << "  {" << endl;
