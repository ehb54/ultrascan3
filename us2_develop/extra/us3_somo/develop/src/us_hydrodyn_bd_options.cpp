...
US_Hydrodyn_BD_Options::US_Hydrodyn_BD_Options(BD_Options *bd_options, bool *bd_widget, void *us_hydrodyn, QWidget *p, const char *name) : Q3Frame(p, name)
{
...
void US_Hydrodyn_BD_Options::setupGUI()
{
   ...
   lbl_info_simulation_opts->setFrameStyle(Q3Frame::WinPanel|Q3Frame::Raised);
   ...
   lbl_springs->setFrameStyle(Q3Frame::WinPanel|Q3Frame::Raised);
   ...
   bg_bead_size_type = new Q3ButtonGroup(3, Qt::Vertical, " Bead sizes determined ", this);
   ...
   bg_inter = new Q3ButtonGroup(3, Qt::Vertical, "Type of simulation algorithm:", this);
   ...
   bg_iorder = new Q3ButtonGroup(3, Qt::Vertical, "Order of the simulation algorithm:", this);
   ...
   bg_chem_pb_pb_bond_types = new Q3ButtonGroup(4, Qt::Vertical, "Bond type:", this);
   ...
   bg_chem_pb_sc_bond_types = new Q3ButtonGroup(4, Qt::Vertical, "Bond type:", this);
   ...
   bg_chem_sc_sc_bond_types = new Q3ButtonGroup(4, Qt::Vertical, "Bond type:", this);
   ...
   bg_pb_pb_bond_types = new Q3ButtonGroup(4, Qt::Vertical, "Bond type:", this);
   ...
   bg_pb_sc_bond_types = new Q3ButtonGroup(4, Qt::Vertical, "Bond type:", this);
   ...
   bg_sc_sc_bond_types = new Q3ButtonGroup(4, Qt::Vertical, "Bond type:", this);
   ...
   Q3HBoxLayout *hbl_method = new Q3HBoxLayout;
   ...
   Q3VBoxLayout *vbl_method_group = new Q3VBoxLayout;
   vbl_method_group->addWidget(lbl_info_simulation_opts);

   Q3HBoxLayout *hbl_method_group = new Q3HBoxLayout;

   Q3VBoxLayout *vbl_method = new Q3VBoxLayout;
   ...
   Q3GridLayout *gl_simu = new Q3GridLayout( 0, 0 );
   j = 0;
   ...
   Q3HBoxLayout *hbl_bonds = new Q3HBoxLayout;

   Q3VBoxLayout *vbl_chem_pb_pb = new Q3VBoxLayout;
   ...
   Q3HBoxLayout *hbl_chem_pb_pb_force_constant = new Q3HBoxLayout;
   ...
   Q3VBoxLayout *vbl_chem_pb_sc = new Q3VBoxLayout;
   ...
   Q3VBoxLayout *vbl_chem_sc_sc = new Q3VBoxLayout;
   ...
   Q3VBoxLayout *vbl_pb_pb = new Q3VBoxLayout;
   ...
   Q3VBoxLayout *vbl_pb_sc = new Q3VBoxLayout;
   ...
   Q3VBoxLayout *vbl_sc_sc = new Q3VBoxLayout;
