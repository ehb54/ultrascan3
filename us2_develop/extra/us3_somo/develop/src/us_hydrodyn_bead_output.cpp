...
US_Hydrodyn_Bead_Output::US_Hydrodyn_Bead_Output(struct bead_output_options *bead_output,
                                                 bool *bead_output_widget, void *us_hydrodyn, QWidget *p, const char *name) : Q3Frame(p, name)
{
...
void US_Hydrodyn_Bead_Output::setupGUI()
{
   ...
   bg_output = new Q3ButtonGroup(3, Qt::Horizontal, "Output Format:", this);
   ...
   bg_sequence = new Q3ButtonGroup(2, Qt::Vertical, "Bead Sequence Format:", this);
   ...
   bg_beams = new Q3ButtonGroup(1, Qt::Vertical, "BEAMS Format:", this);
