     ...
     image5( (const char **) image5_data )
{
   ...
   normalsquality->setOrientation( QSlider::Vertical );
   normalsquality->setTickmarks( QSlider::Above );
   ...
   normalslength->setOrientation( QSlider::Vertical );
   normalslength->setTickmarks( QSlider::Above );
   ...
   frame = new QFrame( centralWidget(), "frame" );
   ...
   offsSlider->setTickmarks( QSlider::Above );
   ...
   resSlider->setTickmarks( QSlider::Above );
   ...
   openFile->setIconSet( QIconSet( image0 ) );
   ...
   floornone->setIconSet( QIconSet( image14 ) );
   openMeshFile = new QAction( this, "openMeshFile" );
   openMeshFile->setIconSet( QIconSet( image15 ) );
   normals = new QAction( this, "normals" );
   normals->setToggleAction( TRUE );
   normals->setIconSet( QIconSet( image16 ) );
...
void Mesh2MainWindowBase::languageChange()
{
   ...
   QWhatsThis::add( autoscale, tr( "Autoscale axes" ) );
   ...
   QWhatsThis::add( shader, tr( "Checked means Gouraud (smooth) shading, flat else" ) );
