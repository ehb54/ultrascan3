#include "../include/us_edeabs.h"

EditAbsEquil_Win::EditAbsEquil_Win(QWidget *p , const char *name) 
   : EditData_Win(p, name)
{
   edit_type = 2;
   extension1 = "RA";
...
EditAbsEquil_Win::~EditAbsEquil_Win()
{
}

void EditAbsEquil_Win::setup_GUI()
{
   int j=0;
...
void EditAbsEquil_Win::help()
{
   US_Help *online_help; online_help = new US_Help(this);
   online_help->show_help("manual/edit_equil_abs.html");
}

void EditAbsEquil_Win::get_x(const QMouseEvent &e)
{
