 ...
 *
 * This file contains the declaration of the TestUS_SimulationParameters class,
 * which includes unit tests for various functions defined in the
 * US_SimulationParameters class.
 */
 ...
 * US_SimulationParameters class. The tests are implemented using the QtTest
 * framework.
 */
class TestUS_SimulationParameters : public QObject {
 ...
 private slots:
  ...
  /**
   * @brief Test case for load_simparams for file with all properties except
   * speedstep.
   */
