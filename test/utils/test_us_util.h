 ...
 *
 * This class contains unit tests for various utility functions defined in the
 * US_Util class. The tests are implemented using the QtTest framework.
 */
class TestUSUtil : public QObject {
 ...
 private slots:
   ...
   * It verifies that the function correctly converts date-time strings to UTC
   * format.
   */
