...
private slots:
   ...
   *
   * This function tests the behavior of US_DataFiles when there are no
   * existing files. It verifies that the function correctly creates a new
   * file.
   */
   ...
   *
   * This function tests the behavior of US_DataFiles when there is a gap in
   * the numbering of files. It verifies that the function correctly fills the
   * gap with a new file.
   */
