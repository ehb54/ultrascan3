 ...
 *
 * This file contains the declaration of the TestUSDataFiles class, which
 * includes unit tests for various functions defined in the US_DataFiles class.
 */
 ...
 *
 * This class contains unit tests for various functions defined in the
 * US_DataFiles class. The tests are implemented using the QtTest framework.
 */
class TestUSDataFiles : public QObject {
 ...
 private slots:
   ...
   *
   * This function tests the behavior of US_DataFiles when there are no existing
   * files. It verifies that the function correctly creates a new file.
   */
   ...
   *
   * This function tests the behavior of US_DataFiles when there is an existing
   * file with a matching GUID. It verifies that the function correctly returns
   * the existing file.
   */
   ...
   *
   * This function tests the behavior of US_DataFiles when there are existing
   * files without a matching GUID. It verifies that the function correctly
   * creates a new file.
   */
   ...
   *
   * This function tests the behavior of US_DataFiles when there is a gap in the
   * numbering of files. It verifies that the function correctly fills the gap
   * with a new file.
   */
