...
#define _GRID_STRUCT
   ...
   int fill_AccessGrid_fromFile (int numatoms, const float probe, const char file[], gridpt grid[]);
   int get_ExcludeGrid_fromFile (int numatoms, const float probe, const char file[], gridpt EXCgrid[]);
