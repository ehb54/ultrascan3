/****************************************************************************
** US_Hydrodyn_Saxs_Load_Csv meta object code from reading C++ file 'us_hydrodyn_saxs_load_csv.h'
**
...
const char *US_Hydrodyn_Saxs_Load_Csv::className() const
{
    return "US_Hydrodyn_Saxs_Load_Csv";
}

QMetaObject *US_Hydrodyn_Saxs_Load_Csv::metaObj = 0;
static QMetaObjectCleanUp cleanUp_US_Hydrodyn_Saxs_Load_Csv( "US_Hydrodyn_Saxs_Load_Csv", &US_Hydrodyn_Saxs_Load_Csv::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString US_Hydrodyn_Saxs_Load_Csv::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "US_Hydrodyn_Saxs_Load_Csv", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString US_Hydrodyn_Saxs_Load_Csv::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "US_Hydrodyn_Saxs_Load_Csv", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* US_Hydrodyn_Saxs_Load_Csv::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    ...
    static const QUMethod slot_12 = {"save_selected", 0, 0 };
    static const QUMethod slot_13 = {"ok", 0, 0 };
	...
	{ "save_selected()", &slot_12, QMetaData::Private },
	{ "ok()", &slot_13, QMetaData::Private },
	{ "cancel()", &slot_14, QMetaData::Private },
	{ "help()", &slot_15, QMetaData::Private }
    };
    metaObj = QMetaObject::new_metaobject(
	"US_Hydrodyn_Saxs_Load_Csv", parentObject,
	slot_tbl, 16,
	0, 0,
	...
	0, 0 );
    cleanUp_US_Hydrodyn_Saxs_Load_Csv.setMetaObject( metaObj );
    return metaObj;
}

void* US_Hydrodyn_Saxs_Load_Csv::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "US_Hydrodyn_Saxs_Load_Csv" ) )
	return this;
    return QDialog::qt_cast( clname );
}

bool US_Hydrodyn_Saxs_Load_Csv::qt_invoke( int _id, QUObject* _o )
{
...
bool US_Hydrodyn_Saxs_Load_Csv::qt_emit( int _id, QUObject* _o )
{
    return QDialog::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool US_Hydrodyn_Saxs_Load_Csv::qt_property( int id, int f, QVariant* v)
{
    return QDialog::qt_property( id, f, v);
}

bool US_Hydrodyn_Saxs_Load_Csv::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
