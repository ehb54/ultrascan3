...
void US_Hydrodyn_Anaflex_Options::setupGUI()
{
   ...
   cb_run_mode_1_5->setText(us_tr(" Gxy, Gxz, Gyz components of gyration tensor "));
   ...
   cb_run_mode_1_8->setText(us_tr(" Extension along x and y, and thier squares "));
   ...
   cb_run_mode_1_12->setText(us_tr(" Birefringence in FENE chains (soft springs) "));
   ...
   cb_run_mode_1_13->setText(us_tr(" P_2 average over connectors (hard springs) "));
   ...
   // cb_run_mode_1_20->setText(us_tr(" Powers of distance Rij between beads I and J "));
   ...
   // cb_run_mode_1_24->setText(us_tr(" Dihedral (torsion) angle (rad) subtended by beads I, J, K & L "));
   ...
   cb_run_mode_2_5->setText(us_tr(" Gxy, Gxz, Gyz components of gyration tensor "));
   ...
   cb_run_mode_2_8->setText(us_tr(" Extension along x and y, and thier squares "));
   ...
   cb_run_mode_2_12->setText(us_tr(" Birefringence in FENE chains (soft springs) "));
   ...
   cb_run_mode_2_13->setText(us_tr(" P_2 average over connectors (hard springs) "));
   ...
   // cb_run_mode_2_20->setText(us_tr(" Powers of distance Rij between beads I and J "));
   ...
   // cb_run_mode_2_24->setText(us_tr(" Dihedral (torsion) angle (rad) subtended by beads I, J, K & L "));
   ...
   le_run_mode_3_5_iii = new QLineEdit( this );    le_run_mode_3_5_iii->setObjectName( "Run_Mode_3_5_Iii Line Edit" );
   ...
   le_run_mode_3_5_jjj = new QLineEdit( this );    le_run_mode_3_5_jjj->setObjectName( "Run_Mode_3_5_Jjj Line Edit" );
   ...
   le_run_mode_3_10_theta = new QLineEdit( this );    le_run_mode_3_10_theta->setObjectName( "Run_Mode_3_10_Theta Line Edit" );
   ...
   lbl_run_mode_3_10_refractive_index = new QLabel(us_tr(" Refractive_Index: "), this);
   ...
   le_run_mode_3_10_refractive_index = new QLineEdit( this );    le_run_mode_3_10_refractive_index->setObjectName( "Run_Mode_3_10_Refractive_Index Line Edit" );
   ...
   le_run_mode_3_10_lambda = new QLineEdit( this );    le_run_mode_3_10_lambda->setObjectName( "Run_Mode_3_10_Lambda Line Edit" );
   ...
   le_run_mode_3_14_iii = new QLineEdit( this );    le_run_mode_3_14_iii->setObjectName( "Run_Mode_3_14_Iii Line Edit" );
   ...
   le_run_mode_3_14_jjj = new QLineEdit( this );    le_run_mode_3_14_jjj->setObjectName( "Run_Mode_3_14_Jjj Line Edit" );
   ...
   lbl_nfrec = new QLabel(us_tr(" Trajectory sampling frequency:         "), this);
   ...
   le_nfrec = new QLineEdit( this );    le_nfrec->setObjectName( "Nfrec Line Edit" );
   ...
   lbl_ntimc = new QLabel(us_tr(" Number of points of the\n correlation function: "), this);
   ...
   le_ntimc = new QLineEdit( this );    le_ntimc->setObjectName( "Ntimc Line Edit" );
   ...
   le_tmax = new QLineEdit( this );    le_tmax->setObjectName( "Tmax Line Edit" );
   ...
   le_deltat = new QLineEdit( this );    le_deltat->setObjectName( "Deltat Edit" );
   ...
   //   QHBoxLayout * hbl_opts = new QHBoxLayout; hbl_opts->setContentsMargins( 0, 0, 0, 0 ); hbl_opts->setSpacing( 0 );
   //   QVBoxLayout * vbl_opts = new QVBoxLayout; vbl_opts->setContentsMargins( 0, 0, 0, 0 ); vbl_opts->setSpacing( 0 );
   ...
   QGridLayout * gl_ana_1 = new QGridLayout; gl_ana_1->setContentsMargins( 0, 0, 0, 0 ); gl_ana_1->setSpacing( 0 );
   int j = 0;
   ...
   QVBoxLayout * vbl_1 = new QVBoxLayout; vbl_1->setContentsMargins( 0, 0, 0, 0 ); vbl_1->setSpacing( 0 );
   ...
   QVBoxLayout * vbl_3 = new QVBoxLayout; vbl_3->setContentsMargins( 0, 0, 0, 0 ); vbl_3->setSpacing( 0 );
   vbl_3->addWidget(cb_run_mode_3);
   vbl_3->addSpacing(2);

   QGridLayout * gl_3 = new QGridLayout; gl_3->setContentsMargins( 0, 0, 0, 0 ); gl_3->setSpacing( 0 );
   ...
   QGridLayout * gl_3_5 = new QGridLayout; gl_3_5->setContentsMargins( 0, 0, 0, 0 ); gl_3_5->setSpacing( 0 );
   ...
   QGridLayout * gl_3_10 = new QGridLayout; gl_3_10->setContentsMargins( 0, 0, 0, 0 ); gl_3_10->setSpacing( 0 );
   ...
   QGridLayout * gl_3_14 = new QGridLayout; gl_3_14->setContentsMargins( 0, 0, 0, 0 ); gl_3_14->setSpacing( 0 );
   ...
   QHBoxLayout * hbl_modes = new QHBoxLayout; hbl_modes->setContentsMargins( 0, 0, 0, 0 ); hbl_modes->setSpacing( 0 );
...
void US_Hydrodyn_Anaflex_Options::update_ntimc_msg()
{
   if ( (*anaflex_options).ntimc % 10 != 1 )
   {
      ...
      lbl_ntimc->setText(us_tr(" Number of points of the\n correlation function: "));
   }
}
