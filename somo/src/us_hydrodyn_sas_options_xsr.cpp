...
US_Hydrodyn_SasOptionsXsr::US_Hydrodyn_SasOptionsXsr(struct saxs_options *saxs_options, bool *sas_options_xsr_widget, void *us_hydrodyn, QWidget *p, const char *name) : QFrame( p )
{
...
void US_Hydrodyn_SasOptionsXsr::setupGUI()
{
   ...
   lbl_info = new QLabel(us_tr("US-SOMO SAS Cross Sectional Fitting Options:"), this);
   ...
   le_xsr_symmop = new QLineEdit( this );    le_xsr_symmop->setObjectName( "xsr_symmop Line Edit" );
   ...
   lbl_xsr_nx = new QLabel(us_tr(" Number of x grid points in the dummy atom model : "), this);
   ...
   le_xsr_nx = new QLineEdit( this );    le_xsr_nx->setObjectName( "xsr_nx Line Edit" );
   ...
   lbl_xsr_ny = new QLabel(us_tr(" Number of y grid points in the dummy atom model :"), this);
   ...
   le_xsr_ny = new QLineEdit( this );    le_xsr_ny->setObjectName( "xsr_ny Line Edit" );
   ...
   lbl_xsr_griddistance = new QLabel(us_tr(" Radius of each dummy atom (A) : "), this);
   ...
   le_xsr_griddistance = new QLineEdit( this );    le_xsr_griddistance->setObjectName( "xsr_griddistance Line Edit" );
   ...
   lbl_xsr_ncomponents = new QLabel(us_tr(" Number of components with different scattering densities : "), this);
   ...
   le_xsr_ncomponents = new QLineEdit( this );    le_xsr_ncomponents->setObjectName( "xsr_ncomponents Line Edit" );
   ...
   lbl_xsr_compactness_weight = new QLabel(us_tr(" Compactness weight : "), this);
   ...
   le_xsr_compactness_weight = new QLineEdit( this );    le_xsr_compactness_weight->setObjectName( "xsr_compactness_weight Line Edit" );
   ...
   le_xsr_looseness_weight = new QLineEdit( this );    le_xsr_looseness_weight->setObjectName( "xsr_looseness_weight Line Edit" );
   ...
   le_xsr_temperature = new QLineEdit( this );    le_xsr_temperature->setObjectName( "xsr_temperature Line Edit" );
