...
US_Hydrodyn_PDB_Visualization::US_Hydrodyn_PDB_Visualization(struct pdb_visualization *pdb,
                                                             bool *pdb_visualization_widget, QWidget *p, const char *name) : QFrame( p )
{
   this->pdb = pdb;
...
void US_Hydrodyn_PDB_Visualization::setupGUI()
{
   ...
   rb_default->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   rb_spacefilling->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   rb_custom->setFont(QFont( USglobal->config_list.fontFamily, USglobal->config_list.fontSize));
   ...
   case 0 : rb_default->setChecked( true ); break;
   case 1 : rb_spacefilling->setChecked( true ); break;
   ...
   le_filename = new QLineEdit( this );    le_filename->setObjectName( "filename Line Edit" );
