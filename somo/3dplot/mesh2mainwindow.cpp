...
Mesh2MainWindow::Mesh2MainWindow(bool *widget_flag, QString tmp_xtitle, QString tmp_ytitle,
                                 vector <struct element_3D> tmp_solutes, SA2d_control_variables *tmp_sa2d_ctrl_vars,
                                 QWidget* parent, const char* name, Qt::WFlags f ) : Mesh2MainWindowBase( parent, name, f )
{
...
Mesh2MainWindow::Mesh2MainWindow(bool *widget_flag, QString tmp_xtitle, QString tmp_ytitle,
                                 QString tmp_ztitle, double **data, SA2d_control_variables *tmp_sa2d_ctrl_vars,
                                 QWidget* parent, const char* name, Qt::WFlags f ) : Mesh2MainWindowBase( parent, name, f )
{
   this->widget_flag = widget_flag;
   *widget_flag = true;
...
void Mesh2MainWindow::setParameters(QString xtitle, QString ytitle, QString ztitle,
...
Mesh2MainWindow::Mesh2MainWindow(bool *widget_flag, 
                                 ...
                                 QWidget* parent, 
                                 const char* name, Qt::WFlags f ) : Mesh2MainWindowBase( parent, name, f )
{
   this->widget_flag = widget_flag;
   *widget_flag = true;
   col_ = 0;
