...
int main(int argc, char** argv) {
   ...
   // going to have to broadcast to 0 the mic status so it can assign comms / ranks 

   // MPI_Group_incl( org_group, world_size, world_rank, is_mic ? &mic_group : &xhost_group );
