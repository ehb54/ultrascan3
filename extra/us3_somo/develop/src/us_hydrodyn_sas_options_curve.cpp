...
US_Hydrodyn_SasOptionsCurve::US_Hydrodyn_SasOptionsCurve(struct saxs_options *saxs_options, bool *sas_options_curve_widget, void *us_hydrodyn, QWidget *p, const char *name) : Q3Frame(p, name)
{
   ...
   *sas_options_curve_widget = true;
   ...
   setCaption(tr("US-SOMO SAS Curve Generation Options"));
   update_q();
   setupGUI();
   global_Xpos += 30;
   global_Ypos += 30;
...
{
   int minHeight1 = 30;
   lbl_info = new QLabel(tr("US-SOMO SAS Curve Generation Options:"), this);
