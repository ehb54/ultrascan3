...
US_Hydrodyn_SasOptionsXsr::US_Hydrodyn_SasOptionsXsr(struct saxs_options *saxs_options, bool *sas_options_xsr_widget, void *us_hydrodyn, QWidget *p, const char *name) : Q3Frame(p, name)
{
