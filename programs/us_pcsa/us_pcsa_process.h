...
public:
  ...
  void start_fit (double, double, double, double, int, int, int, int, int, int,
                  int, double, double = 0.0);
  ...
  bool get_results (US_DataIO::RawData *, US_DataIO::RawData *, US_Model *,
                    US_Noise *, US_Noise *, int &, QStringList &,
...
private slots:
  void queue_task (WorkPacketPc &, double, double, int, int,
                   QVector<US_ZSolute>);
  ...
  void elite_limits (QVector<US_ModelRecord> &, double &, double &, double &,
