...
void US_PlotControlPc::plot3_btn()
{
   ...
   if ( plot3d_w == 0 )
   {
      ...
      connect( plot3d_w, &US_Plot3D::has_closed,
               this,     &US_PlotControlPc::plot_close );
   }
