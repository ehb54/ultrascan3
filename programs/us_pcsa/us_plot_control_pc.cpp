...
// mw x box checked
void US_PlotControlPc::xmwtCheck(bool chkd) { checkSet(chkd, true, 0); }
// mw y box checked
void US_PlotControlPc::ymwtCheck(bool chkd) { checkSet(chkd, false, 0); }
// sedcoeff x box checked
void US_PlotControlPc::xsedCheck(bool chkd) { checkSet(chkd, true, 1); }
// sedcoeff y box checked
void US_PlotControlPc::ysedCheck(bool chkd) { checkSet(chkd, false, 1); }
// diffcoeff x box checked
void US_PlotControlPc::xdifCheck(bool chkd) { checkSet(chkd, true, 2); }
// diffcoeff y box checked
void US_PlotControlPc::ydifCheck(bool chkd) { checkSet(chkd, false, 2); }
// friccoeff x box checked
void US_PlotControlPc::xfcoCheck(bool chkd) { checkSet(chkd, true, 3); }
// friccoeff y box checked
void US_PlotControlPc::yfcoCheck(bool chkd) { checkSet(chkd, false, 3); }
// fricratio x box checked
void US_PlotControlPc::xfraCheck(bool chkd) { checkSet(chkd, true, 4); }
// fricratio y box checked
void US_PlotControlPc::yfraCheck(bool chkd) { checkSet(chkd, false, 4); }
// Vbar x box checked
void US_PlotControlPc::xvbaCheck(bool chkd) { checkSet(chkd, true, 5); }
// Vbar y box checked
void US_PlotControlPc::yvbaCheck(bool chkd) { checkSet(chkd, false, 5); }
...
void US_PlotControlPc::zscal_value(double value) { zscale = value; }
// grid resolution changed
void US_PlotControlPc::gridr_value(double value) { gridres = value; }
// peak smoothing changed
void US_PlotControlPc::peaks_value(double value) { pksmooth = value; }
// peak width changed
void US_PlotControlPc::peakw_value(double value) { pkwidth = value; }
...
void US_PlotControlPc::close_all() { close(); }

// 3d plot closed
void US_PlotControlPc::plot_close() { plot3d_w = 0; }
