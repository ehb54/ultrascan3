...
US_ResidPlotPc::US_ResidPlotPc(QWidget* parent) : US_WidgetsDialog(parent, 0) {
  ...
  setWindowTitle(
      tr("Param. Constrained Spectrum Analysis "
...
void US_ResidPlotPc::stinCheck(bool) { plot_data(); }

// subtract-ri-noise box [un]checked
void US_ResidPlotPc::srinCheck(bool) { plot_data(); }
...
void US_ResidPlotPc::atinCheck(bool) { plot_data(); }

// add-ri-noise box [un]checked
void US_ResidPlotPc::arinCheck(bool) { plot_data(); }
...
QwtPlot* US_ResidPlotPc::rp_data_plot1() { return data_plot1; }

// Return a pointer to the QwtPlot for the lower plot
QwtPlot* US_ResidPlotPc::rp_data_plot2() { return data_plot2; }
