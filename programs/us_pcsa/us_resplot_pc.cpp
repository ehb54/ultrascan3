...
void
US_ResidPlotPc::pedaCheck (bool chkd)
{
  if (chkd)
...
void
US_ResidPlotPc::psdaCheck (bool chkd)
{
  if (chkd)
    { // box is being checked:  sub boxes enabled if data present
      ck_addtin->setEnabled (have_ti);
...
void
US_ResidPlotPc::presCheck (bool chkd)
{
  skip_plot = true;
...
void
US_ResidPlotPc::ptinCheck (bool chkd)
{
  skip_plot = true;
...
void
US_ResidPlotPc::prinCheck (bool chkd)
{
  skip_plot = true;
...
void
US_ResidPlotPc::pranCheck (bool chkd)
{
  skip_plot = true;
...
void
US_ResidPlotPc::srbmCheck (bool chkd)
{
  if (chkd)
