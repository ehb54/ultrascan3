      ...
      while (getruni)
        {
          ...
          QString msg2
              = tr ("The default run ID for the output combined"
                ...
                + tr ("You may modify this part of the model description"
                      ...
                      " (no spaces).<br/>"
                      "Enter so the total is from 3 to %2 "
                      "characters.<br/><br/>"
                      "It is <b>strongly</b> recommended that you only"
                      " <b>append</b> any descriptive string to the "
                      "original<br/>"
          ...
          runID = QInputDialog::getText (
              this, tr ("Modify Global Model Description RunID"), msg2,
              QLineEdit::Normal, runID, &ok);
...
void
US_CombineModels::update_disk_db (bool isDB)
{
  if (isDB)
    dkdb_cntrls->set_db ();
  else
...
void
US_CombineModels::select_filt (void)
{
  QString pfmsg;
  int nruns = 0;
  pfilts.clear ();
