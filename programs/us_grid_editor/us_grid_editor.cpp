...
US_Grid_Editor::US_Grid_Editor () : US_Widgets ()
{
  ...
  connect (pb_investigator, &QPushButton::clicked, this,
           &US_Grid_Editor::sel_investigator);
  ...
  dkdb_cntrls
      = new US_Disk_DB_Controls (US_Settings::default_data_location ());
  connect (dkdb_cntrls, &US_Disk_DB_Controls::changed, this,
           &US_Grid_Editor::update_disk_db);
  ...
  connect (pb_grid_setup, &QPushButton::clicked, this,
           &US_Grid_Editor::setup_grid);
  ...
  connect (le_dens_20, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_dens_visc_temp);
  connect (le_visc_20, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_dens_visc_temp);
  connect (le_temp, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_dens_visc_temp);
  connect (pb_lu_buffer, &QPushButton::clicked, this,
           &US_Grid_Editor::set_buffer);
  ...
  connect (chkb_log, &QCheckBox::stateChanged, this,
           &US_Grid_Editor::refill_grid_points);
  ...
  connect (bg_point_type, &QButtonGroup::idClicked, this,
           &US_Grid_Editor::set_mid_exct_points);
  ...
  connect (pb_new, &QPushButton::clicked, this,
           &US_Grid_Editor::new_grid_clicked);

  QPushButton *pb_delete = us_pushbutton ("Delete");
  connect (pb_delete, &QPushButton::clicked, this,
           &US_Grid_Editor::delete_grid_clicked);

  QPushButton *pb_update = us_pushbutton ("Update");
  connect (pb_update, &QPushButton::clicked, this,
           &US_Grid_Editor::update_grid_clicked);
  ...
  connect (le_x_min, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_xMin);
  connect (le_x_max, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_xMax);
  connect (le_y_min, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_yMin);
  connect (le_y_max, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_yMax);
  connect (le_z_val, &QLineEdit::editingFinished, this,
           &US_Grid_Editor::new_zVal);

  pb_add_update = us_pushbutton ("Add / Update ");
  connect (pb_add_update, &QPushButton::clicked, this,
           &US_Grid_Editor::add_update);
  ...
  connect (ct_subgrid, &QwtCounter::valueChanged, this,
           &US_Grid_Editor::plot_subgrid);
  connect (ct_nsubgrids, &QwtCounter::valueChanged, this,
           &US_Grid_Editor::set_nsubgrids);
  ...
  QBoxLayout *plot_lyt
      = new US_Plot (data_plot, tr ("Grid Layout"), tr (""), tr (""));
  ...
  QGridLayout *lyt_x_s
      = us_radiobutton (Attribute::symbol (Attribute::ATTR_S), rb_x_s, false);
  QGridLayout *lyt_x_ff0 = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_K), rb_x_ff0, false);
  QGridLayout *lyt_x_mw
      = us_radiobutton (Attribute::symbol (Attribute::ATTR_M), rb_x_mw, false);
  QGridLayout *lyt_x_vbar = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_V), rb_x_vbar, false);
  QGridLayout *lyt_x_D
      = us_radiobutton (Attribute::symbol (Attribute::ATTR_D), rb_x_D, false);
  QGridLayout *lyt_x_sr = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_SR), rb_x_sr, false);
  QGridLayout *lyt_x_Dr = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_DR), rb_x_Dr, false);

  QGridLayout *lyt_y_s
      = us_radiobutton (Attribute::symbol (Attribute::ATTR_S), rb_y_s, false);
  QGridLayout *lyt_y_ff0 = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_K), rb_y_ff0, false);
  QGridLayout *lyt_y_mw
      = us_radiobutton (Attribute::symbol (Attribute::ATTR_M), rb_y_mw, false);
  QGridLayout *lyt_y_vbar = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_V), rb_y_vbar, false);
  QGridLayout *lyt_y_D
      = us_radiobutton (Attribute::symbol (Attribute::ATTR_D), rb_y_D, false);
  QGridLayout *lyt_y_sr = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_SR), rb_y_sr, false);
  QGridLayout *lyt_y_Dr = us_radiobutton (
      Attribute::symbol (Attribute::ATTR_DR), rb_y_Dr, false);
  ...
  connect (x_axis, &QButtonGroup::idReleased, this,
           &US_Grid_Editor::select_x_axis);
  connect (y_axis, &QButtonGroup::idReleased, this,
           &US_Grid_Editor::select_y_axis);
  ...
  connect (ct_size, &QwtCounter::valueChanged, this,
           &US_Grid_Editor::set_symbol_size);

  pb_default_plot = us_pushbutton ("Plot");
  connect (pb_default_plot, &QPushButton::clicked, this,
           &US_Grid_Editor::default_plot_ctrl);
...
void
US_Grid_Editor::rm_subgrid_curve ()
{
...
void
US_Grid_Editor::rm_point_curves ()
{
  ...
  if (grid_set)
    {
      ...
      px1 = correct_unit (ginfo.xMin, Attribute::from_symbol (ginfo.xType),
                          true);
      px2 = correct_unit (ginfo.xMax, Attribute::from_symbol (ginfo.xType),
                          true);
      py1 = correct_unit (ginfo.yMin, Attribute::from_symbol (ginfo.yType),
                          true);
      py2 = correct_unit (ginfo.yMax, Attribute::from_symbol (ginfo.yType),
                          true);
      for (int ii = 0; ii < grid_info.size (); ii++)
        {
          GridInfo ginfo = grid_info.at (ii);
          px1 = qMin (px1, correct_unit (ginfo.xMin,
                                         Attribute::from_symbol (ginfo.xType),
                                         true));
          px2 = qMax (px2, correct_unit (ginfo.xMax,
                                         Attribute::from_symbol (ginfo.xType),
                                         true));
          py1 = qMin (py1, correct_unit (ginfo.yMin,
                                         Attribute::from_symbol (ginfo.yType),
                                         true));
          py2 = qMax (py2, correct_unit (ginfo.yMax,
                                         Attribute::from_symbol (ginfo.yType),
                                         true));
        }
  ...
  for (int nn = 0; nn < grid_points.size (); nn++)
    {
      ...
      QwtSymbol *symbol
          = new QwtSymbol (QwtSymbol::Ellipse, QBrush (color_base),
...
void
US_Grid_Editor::set_nsubgrids (double num)
{
...
void
US_Grid_Editor::plot_subgrid (double subgrid_id)
{
  rm_subgrid_curve ();
  ...
  QwtSymbol *symbol
      = new QwtSymbol (QwtSymbol::Ellipse, QBrush (color_subgrid),
...
void
US_Grid_Editor::highlight (int id)
{
  clear_xyz ();
  for (int ii = 0; ii < point_curves.size (); ii++)
    {
      ...
      QwtSymbol *symbol
          = new QwtSymbol (QwtSymbol::Ellipse, QBrush (color_base), pen, size);
  ...
  if (id != -1)
    {
      ...
      QwtSymbol *symbol = new QwtSymbol (QwtSymbol::Ellipse,
                                         QBrush (color_highlight), pen, size);
      point_curves[id]->setSymbol (symbol);

      GridInfo ginfo = grid_info.at (id);

      double x_min = correct_unit (ginfo.xMin,
                                   Attribute::from_symbol (ginfo.xType), true);
      double x_max = correct_unit (ginfo.xMax,
                                   Attribute::from_symbol (ginfo.xType), true);
      double y_min = correct_unit (ginfo.yMin,
                                   Attribute::from_symbol (ginfo.yType), true);
      double y_max = correct_unit (ginfo.yMax,
                                   Attribute::from_symbol (ginfo.yType), true);
      double z_val = correct_unit (ginfo.zVal,
                                   Attribute::from_symbol (ginfo.zType), true);
...
void
US_Grid_Editor::enable_ctrl (bool state)
{
...
double
US_Grid_Editor::value4plot (GridPoint &grid, Attribute::Type type)
{
...
void
US_Grid_Editor::select_x_axis (int index)
{
  QVector<Attribute::Type> tlist;
  tlist << Attribute::ATTR_S << Attribute::ATTR_K << Attribute::ATTR_M
        << Attribute::ATTR_V << Attribute::ATTR_D << Attribute::ATTR_SR
        << Attribute::ATTR_DR;
...
void
US_Grid_Editor::select_y_axis (int index)
{
  QVector<Attribute::Type> tlist;
  tlist << Attribute::ATTR_S << Attribute::ATTR_K << Attribute::ATTR_M
        << Attribute::ATTR_V << Attribute::ATTR_D << Attribute::ATTR_SR
...
US_Grid_Editor::add_update ()
{
  ...
  ok = ok
       && gen_points (ginfo.yMin, ginfo.yMax, ginfo.yRes, false, isMid,
                      ypoints);
  if (!ok)
    return;
...
void
US_Grid_Editor::set_mid_exct_points (int id)
{
...
bool
US_Grid_Editor::gen_points (double x1, double x2, int np, bool isLog,
                            bool isMid, QVector<double> &result)
{
  if (x2 <= x1)
    return false;
  if (isLog && (x1 * x2 < 0))
...
bool
US_Grid_Editor::gen_grid_points (const QVector<double> &x,
                                 const QVector<double> &y, double z,
                                 QVector<GridPoint> &gpoints)
{
  ...
  if (!wrong_list.isEmpty ())
    {
      ...
      for (int ii = 0; ii < wrong_list.size (); ii++)
        {
          text->append (
              line.arg (ii + 1).arg (wrong_list.at (ii), error_list.at (ii)));
        }
      ...
      if (layout)
        {
          layout->addWidget (text, layout->rowCount (), 0, 1,
                             layout->columnCount ());
        }
      msg_box.exec ();
    }
...
double
US_Grid_Editor::correct_unit (double val, Attribute::Type type, bool h_flag)
{
  double output = val;
...
bool
US_Grid_Editor::check_overlap (double xMin, double xMax, double yMin,
                               double yMax, int excl)
{
  bool isMid = bg_point_type->checkedId () == MIDPOINTS;
  for (int ii = 0; ii < grid_info.size (); ii++)
    {
...
bool
US_Grid_Editor::get_xyz (GridInfo &ginfo, QString &error)
{
  error.clear ();
  ...
  error += validate_double (x_min_t, x_min)
               ? ""
               : tr ("%1: Minimum value is not set.\n").arg (lb_x_ax->text ());
  error += validate_double (x_max_t, x_max)
               ? ""
               : tr ("%1: Maximum value is not set.\n").arg (lb_x_ax->text ());
  error += validate_int (x_res_t, x_res)
               ? ""
               : tr ("%1: Resolusion value is not set.\n")
                     .arg (lb_x_ax->text ());
  error += validate_double (y_min_t, y_min)
               ? ""
               : tr ("%1: Minimum value is not set.\n").arg (lb_y_ax->text ());
  error += validate_double (y_max_t, y_max)
               ? ""
               : tr ("%1: Maximum value is not set.\n").arg (lb_y_ax->text ());
  error += validate_int (y_res_t, y_res)
               ? ""
               : tr ("%1: Resolusion value is not set.\n")
                     .arg (lb_y_ax->text ());
  error += validate_double (z_val_t, z_val)
               ? ""
               : tr ("%1: Value is not set!").arg (lb_z_ax->text ());
  if (!error.isEmpty ())
    return false;
...
bool
US_Grid_Editor::validate_double (const QString str, double &val)
{
  bool ok;
...
bool
US_Grid_Editor::validate_int (const QString str, int &val)
{
  bool ok;
  int i = str.toInt (&ok);
  if (ok)
...
bool
US_Grid_Editor::validate_xyz (GridInfo &ginfo)
{
  QString error;
...
US_Grid_Editor::fill_list ()
{
  ...
  for (int ii = 0; ii < n_grids; ii++)
    {
      GridInfo ginfo = grid_info.at (ii);
      double x1 = correct_unit (ginfo.xMin,
                                Attribute::from_symbol (ginfo.xType), true);
      double x2 = correct_unit (ginfo.xMax,
                                Attribute::from_symbol (ginfo.xType), true);
      double y1 = correct_unit (ginfo.yMin,
                                Attribute::from_symbol (ginfo.yType), true);
      double y2 = correct_unit (ginfo.yMax,
                                Attribute::from_symbol (ginfo.yType), true);
      double z = correct_unit (ginfo.zVal,
                               Attribute::from_symbol (ginfo.zType), true);
  ...
  connect (lw_grids, &QListWidget::currentRowChanged, this,
           &US_Grid_Editor::highlight);
}

void
US_Grid_Editor::sort_points ()
{
  sorted_points.clear ();
...
void
US_Grid_Editor::sort_col_val (QVector<GridPoint> &vec)
{
...
void
US_Grid_Editor::sort_row_idx (QVector<GridPoint> &vec)
{
  std::stable_sort (vec.begin (), vec.end (),
                    [] (const GridPoint &g1, const GridPoint &g2) {
...
void
US_Grid_Editor::check_dens_visc_temp ()
{
  buff_dens = DENS_20W;
  buff_visc = VISC_20W;
  buff_temp = 20;
...
bool
US_Grid_Editor::check_minmax (const QString &type)
{
  double min = 0;
  double max = 0;
  bool min_set = false;
...
void
US_Grid_Editor::set_symbol_size (double)
{
  int ss = ct_size->value ();
  for (int ii = 0; ii < point_curves.size (); ii++)
    {
...
void
US_Grid_Editor::buffer_selected (US_Buffer buffer)
{
  ...
  if (pb_lu_buffer->text ().startsWith ("Load Buffer"))
    {
      ...
      connect (buffer_gui, SIGNAL (valueChanged (US_Buffer)), this,
               SLOT (buffer_selected (US_Buffer)));
      buffer_gui->exec ();
    }
  ...
  for (int ii = 0; ii < grid_points.size (); ii++)
    {
      for (int jj = 0; jj < grid_points.at (ii).size (); jj++)
        {
          grid_points[ii][jj].set_dens_visc_temp (buff_dens, buff_visc,
                                                  buff_temp);
        }
    }
...
void
US_Grid_Editor::update_disk_db (bool isDB)
{
...
US_Grid_Editor::setup_grid ()
{
  if (!grid_points.isEmpty ())
    {
      int yes = QMessageBox::question (
          this, "Warning!",
          tr ("Partial grid list is not empty and by changing the grid "
              "setting, it "
              "will be deleted.<br/>"
  ...
  US_Grid_Preset *grid_preset
      = new US_Grid_Preset (this, x_param, y_param, z_param);
...
US_Grid_Editor::load ()
{
  ...
  US_ModelLoader *mloader
      = new US_ModelLoader (load_db, mfilter, model, mdesc, "");
  if (mloader->exec () != QDialog::Accepted)
    return;

  bool cgmdata
      = !model.customGridData.grids.isEmpty ()
  ...
  if (xt == Attribute::ATTR_NONE || yt == Attribute::ATTR_NONE
      || zt == Attribute::ATTR_NONE)
    {
      QMessageBox::warning (this, "Warning!",
                            "Incorrect grid type!"
                            "<br/><br/><b>"
...
US_Grid_Editor::save ()
{
  ...
  model.description
      = now_time.toString ("yyyyMMdd-hhmm") + "-CustomGrid" + ".model";
  ...
  if (mbox.clickedButton () == pb_edit)
    { // Open another dialog to get a modified runID
      ...
      QString msg2
          = tr ("The default run ID for the grid model"
                "<br/> is <b>%1</b>.<br/><br/>"
      ...
      newtext = QInputDialog::getText (this, tr ("Modify Model Name"), msg2,
...
void
US_Grid_Editor::sel_investigator (void)
{
    ...
    : US_WidgetsDialog (parent)
{
  ...
  QGridLayout *x_s = us_radiobutton (Attribute::long_desc (Attribute::ATTR_S),
                                     rb_x_s, true);
  QGridLayout *x_ff0 = us_radiobutton (
      Attribute::long_desc (Attribute::ATTR_K), rb_x_ff0, false);
  QGridLayout *x_mw = us_radiobutton (Attribute::long_desc (Attribute::ATTR_M),
                                      rb_x_mw, true);
  QGridLayout *x_vbar = us_radiobutton (
      Attribute::long_desc (Attribute::ATTR_V), rb_x_vbar, true);
  QGridLayout *x_D = us_radiobutton (Attribute::long_desc (Attribute::ATTR_D),
                                     rb_x_D, true);

  QGridLayout *y_s = us_radiobutton (Attribute::long_desc (Attribute::ATTR_S),
                                     rb_y_s, false);
  QGridLayout *y_ff0 = us_radiobutton (
      Attribute::long_desc (Attribute::ATTR_K), rb_y_ff0, true);
  QGridLayout *y_mw = us_radiobutton (Attribute::long_desc (Attribute::ATTR_M),
                                      rb_y_mw, true);
  QGridLayout *y_vbar = us_radiobutton (
      Attribute::long_desc (Attribute::ATTR_V), rb_y_vbar, true);
  QGridLayout *y_D = us_radiobutton (Attribute::long_desc (Attribute::ATTR_D),
                                     rb_y_D, true);
  ...
  connect (x_axis, &QButtonGroup::idReleased, this,
           &US_Grid_Preset::select_x_axis);
  connect (y_axis, &QButtonGroup::idReleased, this,
           &US_Grid_Preset::select_y_axis);
...
void
US_Grid_Preset::parameters (Attribute::Type &x, Attribute::Type &y,
                            Attribute::Type &z)
{
  x = x_param;
  y = y_param;
...
void
US_Grid_Preset::select_x_axis (int index)
{
  QVector<Attribute::Type> tlist;
  tlist << Attribute::ATTR_S << Attribute::ATTR_K << Attribute::ATTR_M
        << Attribute::ATTR_V << Attribute::ATTR_D;
  foreach (Attribute::Type type, tlist)
    {
      y_axis->button (type)->setEnabled (true);
    }
...
void
US_Grid_Preset::select_y_axis (int index)
{
  QVector<Attribute::Type> tlist;
  tlist << Attribute::ATTR_S << Attribute::ATTR_K << Attribute::ATTR_M
        << Attribute::ATTR_V << Attribute::ATTR_D;
...
void
US_Grid_Preset::select_z_axis (int index)
{
...
void
US_Grid_Preset::apply ()
{
  accept ();
}

void
US_Grid_Preset::cancel ()
{
  reject ();
}

void
US_Grid_Preset::set_z_axis ()
{
  z_axis->disconnect ();
  z_axis->clear ();
  ...
  connect (z_axis, QOverload<int>::of (&QComboBox::currentIndexChanged), this,
           &US_Grid_Preset::select_z_axis);
}
...
bool
GridPoint::set_param (const QVector<double> &values,
  ...
  for (int ii = 0; ii < 3; ii++)
    {
      ...
      if (types.at (ii) == Attribute::ATTR_S)
      ...
      else if (types.at (ii) == Attribute::ATTR_V)
        {
          ...
          if (VBAR <= 0)
            {
              error = "Partial specific volume is less than or equal to zero. "
                      "Please correct it!";
              return false;
            }
        }
      else if (types.at (ii) == Attribute::ATTR_D)
        {
          ...
          if (D <= 0)
            {
              error = "Diffusion coefficient is less than or equal to zero. "
                      "Please correct it!";
              return false;
            }
        }
      else if (types.at (ii) == Attribute::ATTR_F)
        {
          ...
          if (F <= 0)
            {
              error = "Frictional coefficient is less than or equal to zero. "
                      "Please correct it!";
              return false;
            }
        }
...
void
GridPoint::set_dens_visc_temp (double dens, double visc, double T)
{
  density = dens;
  viscosity = visc;
  temperature = T;
...
void
GridPoint::set_component (const US_Model::SimulationComponent &sc,
                          const QVector<Attribute::Type> *types)
{
  if (types != nullptr)
    {
...
QString
GridPoint::error_string ()
{
  return error;
}

double
GridPoint::value (Attribute::Type type) const
{
  double val = 0;
  if (type == Attribute::ATTR_S)
    val = S;
...
void
GridPoint::set_id (int i)
{
  id = i;
}

void
GridPoint::set_row_col (int r, int c)
{
  row = r;
  col = c;
}
...
int
GridPoint::get_row () const
{
  return row;
}

int
GridPoint::get_col () const
{
  return col;
}

int
GridPoint::get_id () const
{
  return id;
}

double
GridPoint::x_value () const
{
  return value (x_param);
}

double
GridPoint::y_value () const
{
  return value (y_param);
}

double
GridPoint::z_value () const
{
  return value (z_param);
}

void
GridPoint::calc_coefficients ()
{
  US_Model::SimulationComponent sc;
  sc.vbar20 = VBAR;
  sc.s = S;
...
GridPoint::calculate_20w ()
{
  ...
  if (contains (Attribute::ATTR_V, Attribute::ATTR_S,
                Attribute::ATTR_K)) // 1: M, D, F, F0
    {
      if (!check_s_vbar ())
        return false;
  ...
  else if (contains (Attribute::ATTR_V, Attribute::ATTR_S,
                     Attribute::ATTR_M)) // 2: K, D, F, F0
    {
      if (!check_s_vbar ())
        return false;
      double BUOY = 1 - VBAR * DENS;
      ...
      D = RT / (NA * F);
                     ...
                     Attribute::ATTR_D)) // 3: K, M, F, F0
    {
      if (!check_s_vbar ())
        return false;
    }
  else if (contains (Attribute::ATTR_V, Attribute::ATTR_K,
                     Attribute::ATTR_M)) // 4: S, D, F, F0
    {
      double BUOY = 1 - VBAR * DENS;
      D = RT / (3 * VISC * FF0) / std::cbrt (6 * MW * VBAR)
          / std::pow (std::cbrt (NA * PI), 2);
      S = MW * D * BUOY / RT;
    }
  else if (contains (Attribute::ATTR_V, Attribute::ATTR_K,
                     Attribute::ATTR_D)) // 5: S, M, F, F0
    {
      double BUOY = 1 - VBAR * DENS;
      F = RT / (NA * D);
      F0 = F / FF0;
  ...
  else if (contains (Attribute::ATTR_V, Attribute::ATTR_M,
                     Attribute::ATTR_D)) // 6: S, K, F, F0
    {
      double BUOY = 1 - VBAR * DENS;
      S = MW * D * BUOY / RT;
    }
  else if (contains (
               Attribute::ATTR_S, Attribute::ATTR_K,
               Attribute::ATTR_M)) // 7: V, D, F, F0 ( qube root of VBAR )
    {
      double A
          = 6 * std::pow (3 * VISC * S * FF0, 3) * std::pow (NA * PI / MW, 2);
      double Q = A / DENS;
      double Z
          = std::sqrt ((27 * std::pow (Q, 2) * 4 * std::pow (Q, 3)) / 108);
  ...
  else if (contains (Attribute::ATTR_S, Attribute::ATTR_K,
                     Attribute::ATTR_D)) // 8: M, V, F, F0
    {
      F = RT / (NA * D);
      F0 = F / FF0;
  ...
  else if (contains (Attribute::ATTR_S, Attribute::ATTR_M,
                     Attribute::ATTR_D)) // 9: K, V, F, F0
    {
      VBAR = (1 - S * RT / (MW * D)) / DENS;
    }
  else if (contains (Attribute::ATTR_K, Attribute::ATTR_M,
                     Attribute::ATTR_D)) // 10: S, V, F, F0
    {
...
GridPoint::calculate_real ()
{
  ...
  DbgLv (2) << "Solution Data:" << QObject::tr ("T=%1").arg (temperature)
...
GridPoint::check_s_vbar ()
{
  ...
  if ((buoy > 0 && S < 0) || (buoy < 0 && S > 0))
    {
      error
          = "Sedimentation and buoyancy should have the same sign!<br/><br/>";
      error += QObject::tr ("<b>Sedimentation = %1<b/> [Sv] <br/>")
                   .arg (S * 1e+13);
      error += QObject::tr (
          "<b>Buoyancy = 1 - Density( 20°C water ) x vbar<b/><br/>");
      error += QObject::tr ("<b>Buoyancy = 1 - %1 x %2 = %3<b/><br/>")
                   .arg (DENS_20W)
                   .arg (VBAR)
                   .arg (buoy);
      return false;
  ...
  if (std::abs (S) < S_TRSHL)
    {
      error = QObject::tr (
                  "s = %1 [Sv]. s values less than %2 [Sv] are not allowed!")
                  .arg (S * 1e13)
                  .arg (S_TRSHL * 1e13);
      return false;
    }
...
bool
GridPoint::contains (Attribute::Type p1, Attribute::Type p2,
                     Attribute::Type p3)
{
...
Attribute::title (Type t)
{
  ...
  if (t == Attribute::ATTR_S)
    ...
    str = "<p>Diffusion Coefficient ( 20,W ) [ cm<sup>2</sup> s<sup>-1</sup> "
          "]</p>";
  else if (t == Attribute::ATTR_F)
    ...
    str = "<p>Diffusion Coefficient ( T,Buffer ) [ cm<sup>2</sup> "
          "s<sup>-1</sup> ]</p>";
  return str;
}

QString
Attribute::symbol (Type t)
{
  QString str;
  if (t == Attribute::ATTR_S)
    str = "s";
...
Attribute::Type
Attribute::from_symbol (const QString &symbol)
{
