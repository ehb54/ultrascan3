...
#define DbgLv(a) \
  if (US_Settings::us_debug() >= a) qDebug()
...
class Attribute : public QObject {
 ...
 public:
  ...
  //! \brief A static method to return the long-version description of the input
  //! Type.
...
class US_Grid_Editor : public US_Widgets {
 ...
 private:
  ...
  //! \brief Generate evenly spaced numbers over a specified interval.
  bool gen_grid_points(const QVector<double>&, const QVector<double>&, double,
                       QVector<GridPoint>&);
