...
class GridPoint {
   public:
      ...
      //! \param component.
      void set_component(const US_Model::SimulationComponent &component, const QVector<Attribute::Type> *types = nullptr);
...
class US_Grid_Editor : public US_Widgets {
   ...
   private:
      ...
      //! \brief Generate evenly spaced numbers over a specified interval.
      bool gen_grid_points(const QVector<double> &, const QVector<double> &, double, QVector<GridPoint> &);
