...
class US_Ramp {
   public:
      ...
      class TripleInfo {
         public:
            int tripleID; //!< The ID of this c/c/w combination (rawDataID) //KL: unsure if its useful
            QString tripleDesc; //!< The description of this triple ( e.g., "2 / A" ) //KL deleted the wl
            QString description; //!< A text description of this triple
            char tripleGUID[ 16 ]; //!< The GUID of this triple
            //          QVector<tripleGUID[16]> chanGUIDs; //! The GUIDs of the triples of this channel
      ...
      static int saveToDisk(QVector<US_mwlRamp::RampRawData *> &, QList<TripleInfo> &, QString, QString);
