...
US_ExperimentGuiRa::US_ExperimentGuiRa (bool signal_wanted,
...
void
US_ExperimentGuiRa::reload (void)
{
...
void
US_ExperimentGuiRa::syncHardware (void)
{
}

void
US_ExperimentGuiRa::selectInvestigator (void)
{
...
void
US_ExperimentGuiRa::assignInvestigator (int invID)
{
  expInfo.invID = invID;
...
void
US_ExperimentGuiRa::getInvestigatorInfo (void)
{
...
void
US_ExperimentGuiRa::source_changed (bool db)
{
  QStringList DB = US_Settings::defaultDB ();
...
void
US_ExperimentGuiRa::update_disk_db (bool db)
{
...
void
US_ExperimentGuiRa::selectProject (void)
{
...
void
US_ExperimentGuiRa::assignProject (US_Project &project)
{
...
void
US_ExperimentGuiRa::cancelProject (void)
{
  reset ();
}
...
void
US_ExperimentGuiRa::saveLabel (void)
{
  expInfo.label = le_label->text ();
...
QComboBox *
US_ExperimentGuiRa::us_expTypeComboBox (void)
{
...
void
US_ExperimentGuiRa::setInstrumentList (void)
{
...
void
US_ExperimentGuiRa::setOperatorList (void)
{
  QList<listInfo> options;
  QList<US_Rotor::Instrument> instruments = labList[currentLab].instruments;
...
void
US_ExperimentGuiRa::change_instrument (int)
{
...
void
US_ExperimentGuiRa::selectRotor (void)
{
  // Save other elements on the page first
  expInfo.label = le_label->text ();
  expInfo.comments = te_comment->toPlainText ();
...
void
US_ExperimentGuiRa::assignRotor (US_Rotor::Rotor &rotor,
                                 US_Rotor::RotorCalibration &calibration)
{
...
void
US_ExperimentGuiRa::cancelRotor (void)
{
  reset ();
}

void
US_ExperimentGuiRa::accept (void)
{
...
void
US_ExperimentGuiRa::cancel (void)
{
  //   expInfo.clear();
...
void
US_ExperimentGuiRa::connect_error (const QString &error)
{
