...
US_SelectBoxRa::US_SelectBoxRa(QWidget *parent) : QComboBox(parent), US_SelectBaseRa() {
...
US_ListwidgetBoxRa::US_ListwidgetBoxRa(QWidget *parent, int fontAdjust) : QListWidget(parent), US_SelectBaseRa() {
   this->setAutoFillBackground(true);
