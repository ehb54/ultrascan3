...
void
US_SelectBoxRa::addOption (listInfo &option)
{
  this->widgetList << option;
}

void
US_SelectBoxRa::addOptions (QList<listInfo> &options)
{
...
void
US_SelectBoxRa::setLogicalIndex (int ID)
{
...
int
US_SelectBoxRa::getLogicalID (void)
{
...
void
US_ListwidgetBoxRa::addOption (listInfo &option)
{
  this->widgetList << option;
}

void
US_ListwidgetBoxRa::addOptions (QList<listInfo> &options)
{
...
// Function to update a combobox so that the current choice is selected
void
US_ListwidgetBoxRa::setLogicalIndex (int ID)
{
  for (int i = 0; i < this->widgetList.size (); i++)
    {
      if (this->widgetList[i].ID.toInt () == ID)
...
int
US_ListwidgetBoxRa::getLogicalID (void)
{
