...
US_IntensityRa::US_IntensityRa(const QString runID, const QString triple,
  ...
  // Plot Rows
  QBoxLayout* plot = new US_Plot(data_plot, tr("Intensity Profile"),
                                 tr("Scan Number"), tr("Intensity"));
