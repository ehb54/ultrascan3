...
class US_IntensityRa : public US_WidgetsDialog {
      Q_OBJECT
   ...
   public:
      ...
      US_IntensityRa(const QString, const QString, const QVector<double> &, const QVector<double> &);
