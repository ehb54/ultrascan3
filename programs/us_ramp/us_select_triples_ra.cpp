    ...
    : US_WidgetsDialog (0, 0), triples (triples)
{
  ...
  le_original
      = us_lineedit (tr ("%1 original triples").arg (nbr_orig), -1, true);
  le_selected
...
void
US_SelectTriplesRa::add_selections ()
{
...
void
US_SelectTriplesRa::rmv_selections ()
{
...
void
US_SelectTriplesRa::cancel (void)
{
  triples.clear ();
