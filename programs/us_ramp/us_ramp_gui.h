...
class US_RampGui : public US_Widgets {
 ...
 private:
  ...
  US_mwlRamp ramp;  // KL - to get this one working I had to add us_ramp.h/.cpp
                    // to .pro!
 ...
 private slots:
  ...
  //       void toleranceValueChanged( double );     // signal to notify of
  //       change void lambdaStartChanged( int ); void lambdaEndChanged  ( int
  //       );
