...
//! \brief Contains the declaration of the US_FDS_FileManager class and its
//! members.
...
class US_FDS_FileManager : public US_Widgets {
 ...
 private:
  ...
  QList<int>
      scanindex;  //!< List of scan indices corresponding to scaninfo objects.
  ...
  QPushButton*
      pb_save_first_and_last;  //!< Button to save first and last scans.
 ...
 private slots:
  ...
  void help(void) { showHelp.show_help("manual/us_fds_filemanager.html"); };
};
