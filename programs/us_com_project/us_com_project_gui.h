...
private slots:
  ...
  // QString & invID_passed, QString & correctRadii );
...
signals:
  // void to_post_prod( QString & currDir, QString & protocolName, QString &
  // invID_passed, QString & correctRadii  );
...
private slots:
  ...
  // void unable_tabs_buttons( void);  // Slot to unable Tabs and Buttons when
  // user level is low void enable_tabs_buttons( void);  // Slot to enable Tabs
  // and Buttons after protocol is loaded
