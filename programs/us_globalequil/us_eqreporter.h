...
class US_EqReporter : public QObject {
 ...
 public:
  ...
  US_EqReporter(QVector<US_DataIO::EditedData>& data_list,
                ...
                EqRunFit& run_fit, QWidget* parent = 0);
  ...
  QString fit_report(FitCtrlPar& fit_params, bool include_scan_info,
                     bool include_params, QString& report);
 ...
 private slots:
  ...
  QString centerInLine(const QString& text, int width, bool is_header,
