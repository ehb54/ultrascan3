...
//! \brief Defines the US_ModelSelect class for selecting models in global
...
//! \brief A class to handle the selection of models for global equilibrium
//! analysis.
class US_ModelSelect : public US_WidgetsDialog {
 ...
 public:
  ...
  //! \param aud_pars Reference to the list of additional user-defined
  //! parameters.
 ...
 private slots:
  ...
  //! \brief Creates a function components string from a list of components and
  //! a count.
  //! \param components List of function components.
  ...
  void help(void) { showHelp.show_help("global_equil-modsel.html"); };
};
