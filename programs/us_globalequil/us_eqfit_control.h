...
//! \brief Contains the declaration of the US_EqFitControl class and its
//! members.
...
class US_EqFitControl : public US_WidgetsDialog {
 ...
 public:
  ...
  //! \param fitting_widget_created Flag indicating if the fitting widget is
  //! created.
  //! \param selected_scan Current selected scan.
  US_EqFitControl(QVector<EqScanFit>&, EqRunFit&, US_DataIO::EditedData*,
                  US_EqMath*, US_EqReporter*, int, QStringList, bool&, int&);
 ...
 private slots:
  ...
  void help(void) { showHelp.show_help("global_equil-fitctrl.html"); };
};
