...
void US_EqMath::init_params( int modx, bool update_mw,
...
double US_EqMath::calc_testParameter( double mwval )
{
   ...
   for ( int jes = 0; jes < scanfits.size(); jes++ )
      points = std::max( points, scanfits[ jes ].xvs.size() );
