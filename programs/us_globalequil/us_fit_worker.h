...
//! \class US_FitWorker
//! \brief A class for performing equilibrium fitting in a separate thread in
//! UltraScan.
class US_FitWorker : public QThread {
 ...
 private slots:
  ...
  //! \brief Perform a fit iteration using the Generalized Linear Least Squares
  //! method.
  //! \return The result of the fit iteration.
  int fit_iter_GLLS(void);

  //! \brief Perform a fit iteration using the Non-Negative Least Squares
  //! method.
  //! \return The result of the fit iteration.
