...
//! \brief Defines the US_ModelAdPars class for additional model parameters in
...
//! \brief A class to handle additional model parameters for global equilibrium
//! analysis.
class US_ModelAdPars : public US_WidgetsDialog {
 ...
 private slots:
  ...
  void help(void) { showHelp.show_help("global_equil-modapar.html"); };
};
