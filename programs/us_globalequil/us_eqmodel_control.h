...
class US_EqModelControl : public US_WidgetsDialog {
   ...
   public:
      ...
      US_EqModelControl(
         QVector<EqScanFit> &scan_fits, EqRunFit &run_fit, US_DataIO::EditedData *edata, int model_index,
         QStringList model_titles, bool &model_widget_created, int &selected_scan);
