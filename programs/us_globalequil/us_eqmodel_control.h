...
//! \brief Contains the declaration of the US_EqModelControl class and its
//! members.
...
class US_EqModelControl : public US_WidgetsDialog {
 ...
 public:
  ...
  //! \param model_widget_created Flag indicating if the model widget is
  //! created.
  //! \param selected_scan Current selected scan.
  US_EqModelControl(QVector<EqScanFit>& scan_fits, EqRunFit& run_fit,
                    US_DataIO::EditedData* edata, int model_index,
                    QStringList model_titles, bool& model_widget_created,
                    int& selected_scan);
 ...
 private slots:
  ...
  QHBoxLayout* radiobox(QGridLayout* grid1, QRadioButton* rb1,
                        QGridLayout* grid2, QRadioButton* rb2);
