 ...
 * @brief The US_vHW_Enhanced class provides functionality for enhanced vHW
 * analysis.
 */
...
private:
  enum
  {
    ...
    START,
    END
  } groupstep; //!< Enum for group selection steps
  ...
  QVector<QVector<double> >
      mconcs;             //!< Mid-division concentrations, divisions in scans
...
private slots:
  ...
  int
  first_gteq (double, QVector<double> &, int,
              int); //!< Find first value greater than or equal to given value
  int
  first_gteq (double, QVector<double> &,
              int); //!< Find first value greater than or equal to given value
  double sed_coeff (double, double, double * = NULL,
                    int * = NULL); //!< Calculate sedimentation coefficient
  double avg_plateau (void);       //!< Calculate average plateau
  double
  sedcoeff_intercept (void); //!< Calculate sedimentation coefficient intercept
  ...
  void vhw_calcs_enhanced (double *,
                           double *); //!< Perform enhanced vHW calculations
  void vhw_calcs_standard (double *,
                           double *); //!< Perform standard vHW calculations
