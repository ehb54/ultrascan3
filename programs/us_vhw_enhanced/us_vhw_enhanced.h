...
class US_vHW_Enhanced : public US_AnalysisBase2 {
 ...
 private slots:
  ...
  double sedcoeff_intercept(
      void);  //!< Calculate sedimentation coefficient intercept
   ...
   * @brief Display help.
   */
  void help(void) { showHelp.show_help("vhw_enhanced.html"); };
};
