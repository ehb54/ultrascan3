...
QWidget* US_MwlSPlotControl::caller(void) { return wparent; }

// Public slot to force (re-)plot of currently specified 3-D plot
void US_MwlSPlotControl::do_3dplot() { plot3_btn(); }
...
US_Plot3D* US_MwlSPlotControl::widget_3dplot(void) { return plot3d_w; }
