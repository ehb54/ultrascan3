...
QWidget *
US_MwlSPlotControl::caller (void)
{
  return wparent;
}
...
QGLWidget *
US_MwlSPlotControl::data_3dplot (void)
{
...
US_Plot3D *
US_MwlSPlotControl::widget_3dplot (void)
{
  return plot3d_w;
}
