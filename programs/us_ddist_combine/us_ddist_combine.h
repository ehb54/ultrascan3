...
class US_DDistr_Combine : public US_Widgets {
   ...
   private:
      ...
      class DistrDesc {
         public:
            ...
            bool operator<(const DistrDesc &ddiscr) const { return (mdescr < ddiscr.mdescr); }
      };
   ...
   private slots:
      ...
      int envel_data(QVector<double> &, QVector<double> &, QVector<double> &, QVector<double> &);
      int envel_data_auto(
         QVector<double> &, QVector<double> &, QVector<double> &, QVector<double> &, double, double, double);
