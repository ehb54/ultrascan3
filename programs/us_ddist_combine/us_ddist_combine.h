...
class US_DDistr_Combine : public US_Widgets {
 ...
 public:
  ...
  QMap<QStringList, QList<QColor> > model_select_auto(QString,
                                                      QMap<QString, QString>);
  QwtPlot* rp_data_plot1();
  void reset_data_plot1();
  QMap<QStringList, QList<QColor> > changedPlotX_auto(int,
                                                      QMap<QString, QString>);
  QString a_mode;
 ...
 private:
  ...
  class DistrDesc {
   public:
    ...
    bool operator==(const DistrDesc& ddiscr) { return (mGUID == ddiscr.mGUID); }
 ...
 private slots:
  ...
  int reportDocsFromFiles(QString&, QString&, QStringList&, US_DB2*, int&,
                          QString&);
  ...
  int envel_data(QVector<double>&, QVector<double>&, QVector<double>&,
                 QVector<double>&);
  int envel_data_auto(QVector<double>&, QVector<double>&, QVector<double>&,
                      QVector<double>&, double, double, double);

  void help(void) { showHelp.show_help("ddist_combine.html"); };
};
#endif
