...
US_DDistr_Combine::US_DDistr_Combine(const QString auto_mode) : US_Widgets() {
   ...
   QFont cfont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize() - 2, QFont::Bold);
   ...
   QLayout *lo_mdltype = us_checkbox(tr("Use model descriptions for list and legend"), ck_mdltype, false);
   ...
   connect(pb_loadda, SIGNAL(clicked()), this, SLOT(load()));
   connect(pb_saveda, SIGNAL(clicked()), this, SLOT(save()));
   connect(pb_resetd, SIGNAL(clicked()), this, SLOT(reset_data()));
   connect(pb_resetp, SIGNAL(clicked()), this, SLOT(reset_plot()));
   connect(pb_help, SIGNAL(clicked()), this, SLOT(help()));
   connect(pb_close, SIGNAL(clicked()), this, SLOT(close()));

   connect(ck_2dsa, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsait, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsamc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsamw, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsamcmw, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsagl, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsaglmc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsacg, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsacgit, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsacgfm, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsacgmc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_2dsafm, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_ga, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_gamc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_gamw, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_gamcmw, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_gagl, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_gaglmc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsais, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsasl, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsads, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsahl, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsaismc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsaslmc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsadsmc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsahlmc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsaistr, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsasltr, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsadstr, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsahltr, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsa2o, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsa2omc, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_pcsa2otr, SIGNAL(stateChanged(int)), this, SLOT(methodChanged(int)));
   connect(ck_dtall, SIGNAL(stateChanged(int)), this, SLOT(allMethodChanged(int)));

   connect(rb_pltsw, SIGNAL(toggled(bool)), this, SLOT(changedPlotX(bool)));
   connect(rb_pltMW, SIGNAL(toggled(bool)), this, SLOT(changedPlotX(bool)));
   connect(rb_pltDw, SIGNAL(toggled(bool)), this, SLOT(changedPlotX(bool)));
   connect(rb_pltff0, SIGNAL(toggled(bool)), this, SLOT(changedPlotX(bool)));
   connect(rb_pltvb, SIGNAL(toggled(bool)), this, SLOT(changedPlotX(bool)));
   connect(rb_pltMWl, SIGNAL(toggled(bool)), this, SLOT(changedPlotX(bool)));

   connect(ct_sigma, SIGNAL(valueChanged(double)), this, SLOT(envvalChange()));
   connect(le_plxmin, SIGNAL(editingFinished()), this, SLOT(envvalChange()));
   connect(le_plxmax, SIGNAL(editingFinished()), this, SLOT(envvalChange()));

   connect(ck_mdltype, SIGNAL(stateChanged(int)), this, SLOT(ltypeChanged()));

   connect(lw_runids, SIGNAL(currentRowChanged(int)), this, SLOT(runid_select(int)));
   connect(lw_models, SIGNAL(currentRowChanged(int)), this, SLOT(model_select(int)));

   QBoxLayout *plot = new US_Plot(
      data_plot1, tr("Discrete s20,W Distributions"), tr("Sedimentation Coefficient x 1e+13 (corr. for 20,W)"),
   ...
   data_grid->setMinorPen(QPen(US_GuiSettings::plotMinGrid(), 0, Qt::DotLine));
...
QList<QStringList> US_DDistr_Combine::load_auto(QStringList runids_passed, QStringList aDescrs_passed) {
   ...
   for (int ii = 0; ii < distros.size(); ii++) {
      ...
      if (distros[ ii ].runID == runID || distros[ ii ].runID.startsWith(grunID)) { // Only (possibly) add item with matching run ID
...
void US_DDistr_Combine::load(void) {
   ...
   connect(&srdiag, SIGNAL(changed(bool)), this, SLOT(update_disk_db(bool)));
   srdiag.exec();
   ...
   if (dbg_level > 0) {
      ...
      for (int ii = 0; ii < aDescrs.count(); ii++) {
         ...
         if (iter && !mdes.contains("_mcN"))
            continue;
         mdes = "..." + mdes.section(".", 1, -1);
         DbgLv(1) << "  ii" << ii << "mrun" << mrun << "mgid" << mgid << "mdes" << mdes << "iter" << iter << "ddes"
                  << ddes;
      }
   }
   //*DEBUG*
   te_status->setText(tr("Added: %1 run(s), %2 implied total models.").arg(nrunids).arg(distros.count()));
   ...
   for (int ii = 0; ii < nrunids; ii++) { // Add run IDs to list and to project combo box
   ...
   for (int ii = 0; ii < distros.count(); ii++) { // Build a list of unique methods of distros
      QString method = distros[ ii ].mdescr.section(".", -1, -1).section("_", -3, -3);
   ...
   bool hv_2dsagl = methods.contains("2DSA-GL") || methods.contains("2DSA-GL-SG") || methods.contains("2DSA-GL-SC")
                    || methods.contains("2DSA-GL-VR") || methods.contains("2DSA-GL-IT")
                    || methods.contains("2DSA-GL-SG-IT") || methods.contains("2DSA-GL-SC-IT")
                    || methods.contains("2DSA-GL-VR-IT");
   bool hv_2dsaglmc = methods.contains("2DSA-GL-MC") || methods.contains("2DSA-GL-SG-MC")
                      || methods.contains("2DSA-GL-SC-MC") || methods.contains("2DSA-GL-VR-MC");
   ...
   bool hv_gagl = methods.contains("GA-GL") || methods.contains("GA-GL-SG") || methods.contains("GA-GL-SC")
                  || methods.contains("GA-GL-VR");
   bool hv_gaglmc = methods.contains("GA-GL-MC") || methods.contains("GA-GL-SG-MC") || methods.contains("GA-GL-SC-MC")
                    || methods.contains("GA-GL-VR-MC");
   bool hv_pcsais = methods.contains("PCSA-IS") || methods.contains("PCSA-GL-SG-IS")
                    || methods.contains("PCSA-GL-SC-IS") || methods.contains("PCSA-GL-VR-IS");
   bool hv_pcsasl = methods.contains("PCSA-SL") || methods.contains("PCSA-GL-SG-SL")
                    || methods.contains("PCSA-GL-SC-SL") || methods.contains("PCSA-GL-VR-SL");
   bool hv_pcsads = methods.contains("PCSA-DS") || methods.contains("PCSA-GL-SG-DS")
                    || methods.contains("PCSA-GL-SC-DS") || methods.contains("PCSA-GL-VR-DS");
   bool hv_pcsahl = methods.contains("PCSA-HL") || methods.contains("PCSA-GL-SG-HL")
                    || methods.contains("PCSA-GL-SC-HL") || methods.contains("PCSA-GL-VR-HL");
   bool hv_pcsaismc = methods.contains("PCSA-IS-MC") || methods.contains("PCSA-GL-SG-IS-MC")
                      || methods.contains("PCSA-GL-SC-IS-MC") || methods.contains("PCSA-GL-VR-IS-MC");
   bool hv_pcsaslmc = methods.contains("PCSA-SL-MC") || methods.contains("PCSA-GL-SG-SL-MC")
                      || methods.contains("PCSA-GL-SC-SL-MC") || methods.contains("PCSA-GL-VR-SL-MC");
   bool hv_pcsadsmc = methods.contains("PCSA-DS-MC") || methods.contains("PCSA-GL-SG-DS-MC")
                      || methods.contains("PCSA-GL-SC-DS-MC") || methods.contains("PCSA-GL-VR-DS-MC");
   bool hv_pcsahlmc = methods.contains("PCSA-HL-MC") || methods.contains("PCSA-GL-SG-HL-MC")
                      || methods.contains("PCSA-GL-SC-HL-MC") || methods.contains("PCSA-GL-VR-HL-MC");
   bool hv_pcsaistr = methods.contains("PCSA-IS-TR") || methods.contains("PCSA-GL-SG-IS-TR")
                      || methods.contains("PCSA-GL-SC-IS-TR") || methods.contains("PCSA-GL-VR-IS-TR");
   bool hv_pcsasltr = methods.contains("PCSA-SL-TR") || methods.contains("PCSA-GL-SG-SL-TR")
                      || methods.contains("PCSA-GL-SC-SL-TR") || methods.contains("PCSA-GL-VR-SL-TR");
   bool hv_pcsadstr = methods.contains("PCSA-DS-TR") || methods.contains("PCSA-GL-SG-DS-TR")
                      || methods.contains("PCSA-GL-SC-DS-TR") || methods.contains("PCSA-GL-VR-DS-TR");
   bool hv_pcsahltr = methods.contains("PCSA-HL-TR") || methods.contains("PCSA-GL-SG-HL-TR")
                      || methods.contains("PCSA-GL-SC-HL-TR") || methods.contains("PCSA-GL-VR-HL-TR");
   bool hv_pcsa2o = methods.contains("PCSA-2O") || methods.contains("PCSA-GL-SG-2O-TR")
                    || methods.contains("PCSA-GL-SC-2O-TR") || methods.contains("PCSA-GL-VR-2O-TR");
   bool hv_pcsa2omc = methods.contains("PCSA-2O-MC") || methods.contains("PCSA-GL-SG-2O-MC")
                      || methods.contains("PCSA-GL-SC-2O-MC") || methods.contains("PCSA-GL-VR-2O-MC");
   bool hv_pcsa2otr = methods.contains("PCSA-2O-TR") || methods.contains("PCSA-GL-SG-2O-TR")
                      || methods.contains("PCSA-GL-SC-2O-TR") || methods.contains("PCSA-GL-VR-2O-TR");
   ...
   bool hv_dmgagl = methods.contains("DMGA-GL") || methods.contains("DMGA-GL-SG") || methods.contains("DMGA-GL-SC")
                    || methods.contains("DMGA-GL-VR");
   bool hv_dmgaglmc = methods.contains("DMGA-GL-MC") || methods.contains("DMGA-GL-SG-MC")
                      || methods.contains("DMGA-GL-SC-MC") || methods.contains("DMGA-GL-VR-MC");
...
void US_DDistr_Combine::plot_data_auto(QMap<QString, QString> c_parms) {
   ...
   p_title.setFont(QFont(US_Widgets::fixedFont().family(), US_GuiSettings::fontSize() + 1));
...
void US_DDistr_Combine::plot_distr_auto(DistrDesc ddesc, QString distrID, QMap<QString, QString> c_parms) {
   ...
   for (jj = c_parms.begin(); jj != c_parms.end(); ++jj) {
      ...
      qDebug() << "in [COMBO1] ind_distro -- " << ind_distro;
   }

   qDebug() << "In plot_distr_auto(): sigma_p, xmin_p, xmax_p, ranges_p -- " << sigma_p << xmin_p << xmax_p << ranges_p;
...
void US_DDistr_Combine::save(void) {
   ...
   for (int ii = 0; ii < pdistrs.size(); ii++) {
      ...
      if (oproj == "All") { // If save-plot project is "All", save lists of runids and indexes
      ...
      else if (prun == runID) { // If save-plot project matches current run, save it and its index
         prunids << prun;
         prndxs << ii;
         break;
      }
   ...
   while (iruns < nruns) {
      if (!QFile(fdir).exists()) { // If need be, create runID directory
         QDir().mkpath(fdir);
      }
      ...
      if (dkdb_cntrls->db()) {
         ...
         QString trdesc = "Combined Analyses (" + trfirst + "..." + trlast + ")";
         ...
         while (db.next()) {
            ...
            DbgLv(1) << "SV:     editID" << eeditID << "raw exp trip1 fname" << rawID << expID << trip1 << efname;
            if (efname.contains(trip1)) { // Keep saving editID from last triple match
               editID = aeditID;
               DbgLv(1) << "SV:        Name-Trip MATCH:  editID" << editID;
            }
         }

         if (!editID.isEmpty()) { // Use edit ID from last matching triple
            idEdit = editID.toInt();
         }
         else { // Or fall back to one from first valid edit in experiment
         ...
         int st = reportDocsFromFiles(runID, fdir, rfiles, &db, idEdit, trdesc);

         DbgLv(1) << "SV:runID" << runID << "idEdit" << idEdit << "fnamlst" << fnamlst << "trdesc" << trdesc;
         if (iruns == (nruns - 1)) { // Append message line after last run save
            if (st == 0)
...
void US_DDistr_Combine::runid_select(int row) {
   ...
   if (mfilter) {
      if (ck_2dsa->isChecked())
         methods << "2DSA";
      if (ck_2dsait->isChecked())
         methods << "2DSA-IT";
      if (ck_2dsamc->isChecked())
         methods << "2DSA-MC";
      if (ck_2dsamw->isChecked())
         methods << "2DSA-MW";
      if (ck_2dsamcmw->isChecked())
         methods << "2DSA-MC-MW";
      if (ck_2dsagl->isChecked())
         methods << "2DSA-GL"
                 << "2DSA-GL-SG"
                 << "2DSA-GL-SC"
                 << "2DSA-GL-VR"
                 ...
                 << "2DSA-GL-SC-IT"
                 << "2DSA-GL-VR-IT";
      if (ck_2dsaglmc->isChecked())
         methods << "2DSA-GL-MC"
                 << "2DSA-GL-SG-MC"
                 << "2DSA-GL-SC-MC"
                 << "2DSA-GL-VR-MC";
      if (ck_2dsacg->isChecked())
         methods << "2DSA-CG";
      if (ck_2dsacgit->isChecked())
         methods << "2DSA-CG-IT";
      if (ck_2dsacgfm->isChecked())
         methods << "2DSA-CG-FM";
      if (ck_2dsacgmc->isChecked())
         methods << "2DSA-CG-MC";
      if (ck_2dsafm->isChecked())
         methods << "2DSA-FM";
      if (ck_ga->isChecked())
         methods << "GA";
      if (ck_gamc->isChecked())
         methods << "GA-MC";
      if (ck_gamw->isChecked())
         methods << "GA-MW";
      if (ck_gamcmw->isChecked())
         methods << "GA-MC-MW";
      if (ck_gagl->isChecked())
         methods << "GA-GL"
                 << "GA-GL-SG"
                 << "GA-GL-SC"
                 << "GA-GL-VR";
      if (ck_gaglmc->isChecked())
         methods << "GA-GL-MC"
                 << "GA-GL-SG-MC"
                 << "GA-GL-SC-MC"
                 << "GA-GL-VR-MC";
      if (ck_pcsais->isChecked())
         methods << "PCSA-IS"
                 << "PCSA-GL-SG-IS"
                 << "PCSA-GL-SC-IS"
                 << "PCSA-GL-VR-IS";
      if (ck_pcsasl->isChecked())
         methods << "PCSA-SL"
                 << "PCSA-GL-SG-SL"
                 << "PCSA-GL-SC-SL"
                 << "PCSA-GL-VR-SL";
      if (ck_pcsads->isChecked())
         methods << "PCSA-DS"
                 << "PCSA-GL-SG-DS"
                 << "PCSA-GL-SC-DS"
                 << "PCSA-GL-VR-DS";
      if (ck_pcsahl->isChecked())
         methods << "PCSA-HL"
                 << "PCSA-GL-SG-HL"
                 << "PCSA-GL-SC-HL"
                 << "PCSA-GL-VR-HL";
      if (ck_pcsaismc->isChecked())
         methods << "PCSA-IS-MC"
                 << "PCSA-GL-SG-IS-MC"
                 << "PCSA-GL-SC-IS-MC"
                 << "PCSA-GL-VR-IS-MC";
      if (ck_pcsaslmc->isChecked())
         methods << "PCSA-SL-MC"
                 << "PCSA-GL-SG-SL-MC"
                 << "PCSA-GL-SC-SL-MC"
                 << "PCSA-GL-VR-SL-MC";
      if (ck_pcsadsmc->isChecked())
         methods << "PCSA-DS-MC"
                 << "PCSA-GL-SG-DS-MC"
                 << "PCSA-GL-SC-DS-MC"
                 << "PCSA-GL-VR-DS-MC";
      if (ck_pcsahlmc->isChecked())
         methods << "PCSA-HL-MC"
                 << "PCSA-GL-SG-HL-MC"
                 << "PCSA-GL-SC-HL-MC"
                 << "PCSA-GL-VR-HL-MC";
      if (ck_pcsaistr->isChecked())
         methods << "PCSA-IS-TR"
                 << "PCSA-GL-SG-IS-TR"
                 << "PCSA-GL-SC-IS-TR"
                 << "PCSA-GL-VR-IS-TR";
      if (ck_pcsasltr->isChecked())
         methods << "PCSA-SL-TR"
                 << "PCSA-GL-SG-IS-TR"
                 << "PCSA-GL-SC-IS-TR"
                 << "PCSA-GL-VR-IS-TR";
      if (ck_pcsadstr->isChecked())
         methods << "PCSA-DS-TR"
                 << "PCSA-GL-SG-IS-TR"
                 << "PCSA-GL-SC-IS-TR"
                 << "PCSA-GL-VR-IS-TR";
      if (ck_pcsahltr->isChecked())
         methods << "PCSA-HL-TR"
                 << "PCSA-GL-SG-IS-TR"
                 << "PCSA-GL-SC-IS-TR"
                 << "PCSA-GL-VR-IS-TR";
      if (ck_pcsa2o->isChecked())
         methods << "PCSA-2O"
                 << "PCSA-GL-SG-2O"
                 << "PCSA-GL-SC-2O"
                 << "PCSA-GL-VR-2O";
      if (ck_pcsa2omc->isChecked())
         methods << "PCSA-2O-MC"
                 << "PCSA-GL-SG-2O-MC"
                 << "PCSA-GL-SC-2O-MC"
                 << "PCSA-GL-VR-2O-MC";
      if (ck_pcsa2otr->isChecked())
         methods << "PCSA-2O-TR"
                 << "PCSA-GL-SG-2O-TR"
                 << "PCSA-GL-SC-2O-TR"
                 << "PCSA-GL-VR-2O-TR";
      if (ck_dmga->isChecked())
         methods << "DMGA";
      if (ck_dmgamc->isChecked())
         methods << "DMGA-MC";
      if (ck_dmgara->isChecked())
         methods << "DMGA-RA";
      if (ck_dmgaramc->isChecked())
         methods << "DMGA-RA-MC";
      if (ck_dmgagl->isChecked())
         methods << "DMGA-GL";
      if (ck_dmgaglmc->isChecked())
         methods << "DMGA-GL-MC";
   }
   ...
   for (int ii = 0; ii < distros.size(); ii++) {
      ...
      if (distros[ ii ].runID == runID || distros[ ii ].runID.startsWith(grunID)) { // Only (possibly) add item with matching run ID
         ...
         if (mfilter) { // If method-filtering, skip any item whose method is not checked
            QString meth = mdesc.section(".", -1, -1).section("_", -3, -3);
            DbgLv(1) << "RunIDSel:    meth" << meth;
...
QMap<QStringList, QList<QColor>> US_DDistr_Combine::model_select_auto(
   QString modelNameMod, QMap<QString, QString> c_parms) {
   ...
   if (!pdisIDs.contains(distrID)) { // If this distro not yet filled out, do so now
   ...
   te_status->setText(tr("Count of plotted distributions: %1.").arg(pdistrs.count()));
...
QString US_DDistr_Combine::distribID(QString mdescr, QString ddescr) {
   ...
   runID = runID.length() <= mxrch ? runID : runID.left(mxrch) + "(++)";
   ...
   iterID = (method != "2DSA-FM") ? iterID.section("_", -2, -2) : iterID.section("_", -1, -1);

   if (ck_mdltype->isChecked()) { // Model-description list/legend type
      distrID = runID + "." + triple + "." + andate + "_" + method + "_" + iterID;
   }
   else { // Data-description list/legend type  (the default)
      distrID = runID + " (" + triple + ", " + method + ") " + ddescr;
   }

   for (int ii = 0; ii < distros.size(); ii++) { // Find index of full model description match as distinguishing suffix
...
void US_DDistr_Combine::fill_in_desc(DistrDesc &ddesc, int distx) {
   if (ddesc.xvals.size() > 0 && ddesc.model.components.size() > 0 && ddesc.xtype == xtype)
      return;
   ...
   if (ncomps == 0) { // Model not yet loaded, so load it now
   ...
   for (int jj = 0; jj < ncomps; jj++) {
      ...
      if (xtype == 1)
         xval = ddesc.model.components[ jj ].mw;
      else if (xtype == 2)
         xval = ddesc.model.components[ jj ].D;
      else if (xtype == 3)
         xval = ddesc.model.components[ jj ].f_f0;
      else if (xtype == 4)
         xval = ddesc.model.components[ jj ].vbar20;
      else if (xtype == 5)
         xval = log(ddesc.model.components[ jj ].mw);
   ...
   for (int jj = 1; jj < ncomps; jj++) {
      ...
      if (equivalent(xval, xvpr, epsilon)) { // Effectively equal x values:  sum y values
         yval += yvpr;
         ddesc.xvals[ kk ] = (xvpr + xval) * 0.5;
         ddesc.yvals[ kk ] = yval;
      }

      else { // New x value:  save y value and bump count
         kk = nn;
         ddesc.xvals[ nn ] = xval;
         ddesc.yvals[ nn++ ] = yval;
      }
   ...
   for (int jj = 0; jj < nn; jj++) {
      if (ddesc.yvals[ jj ] != 0.0) { // Move point to next non-zero output location
...
void US_DDistr_Combine::write_data(QString &dataFile, QString &listFile, int &irun) {
   int arrsize = 300;

   if (irun > 0) { // After first/only time:  just make a copy of the files
   ...
   for (int ii = 0; ii < nplots; ii++) { // Add smooth Y header strings
      QString mdescr = pdistrs[ ii ].mdescr;
      QString mdtrip = mdescr.section(".", -2, -2);
      QString mditer = mdescr.section(".", -1, -1);
      QString mdmeth = mditer.section("_", 2, 2);
   ...
   for (int jj = 0; jj < maxnvl; jj++) { // Build and write xvalue+concentration data line
      line = "";

      // First add X,Y for raw plots
      for (int ii = 0; ii < nplots; ii++) { // Add each pair of X,Y data pairs
         xvals = &pdistrs[ ii ].xvals;
         yvals = &pdistrs[ ii ].yvals;

         // Get and add raw data to line
         if (jj < xvals->size())
            line += QString().sprintf(valfmt, xvals->at(jj), yvals->at(jj)) + ",";
         else
            line += dummy_pair;
   ...
   for (int ii = 0; ii < nplots; ii++) { // Build and write each long-description line
      line = pdlong[ ii ] + "\n";
      tsl << line;
   }
...
int US_DDistr_Combine::reportDocsFromFiles(
   QString &runID, QString &fdir, QStringList &files, US_DB2 *db, int &idEdit, QString &trdesc) {
   ...
   if (dbg_level > 0) {
      ...
      for (int ii = 0; ii < freport.triples.size(); ii++) {
         ...
         DbgLv(1) << "DFF:  triple" << ii << "docssize" << ndoc << "ID" << freport.triples[ ii ].tripleID << "triple"
                  << freport.triples[ ii ].triple;
         int jj = ndoc - 1;
         if (ndoc > 0) {
            DbgLv(1) << "DFF:    doc" << 0 << "ID" << freport.triples[ ii ].docs[ 0 ].documentID << "label"
                     << freport.triples[ ii ].docs[ 0 ].label;
            DbgLv(1) << "DFF:    doc" << jj << "ID" << freport.triples[ ii ].docs[ jj ].documentID << "label"
                     << freport.triples[ ii ].docs[ jj ].label;
         }
      }
      ...
      if (ndx >= 0) {
         ...
         DbgLv(1) << "DFF:  triple" << ndx << "docs size" << ndoc << "ID" << freport.triples[ ndx ].tripleID << "triple"
                  << freport.triples[ ndx ].triple;
         if (ndoc > 0) {
            DbgLv(1) << "DFF:    doc" << 0 << "ID" << freport.triples[ ndx ].docs[ 0 ].documentID << "label"
                     << freport.triples[ ndx ].docs[ 0 ].label;
            int jj = ndoc - 1;
            DbgLv(1) << "DFF:    doc" << jj << "ID" << freport.triples[ ndx ].docs[ jj ].documentID << "label"
                     << freport.triples[ ndx ].docs[ jj ].label;
         }
      }
   }
   //*DEBUG*
...
void US_DDistr_Combine::update_distros() {
   ...
   for (int ii = 0; ii < aDescrs.count(); ii++) {
      ...
      if (dd.iters != 0 && !mdes.contains("_mcN"))
         continue;
      if (distro_by_mguid(mgid) >= 0)
         continue;
...
void US_DDistr_Combine::changedPlotX(bool on_state) {
   ...
   if (npdis > 0) { // Re-do plot distros to account for X-type change
      QList<DistrDesc> wdistros;
      DistrDesc ddist;
      DistrDesc *pddist;

      for (int ii = 0; ii < npdis; ii++) { // Build rudimentary plot distros without value arrays
         pddist = &pdistrs[ ii ];
...
bool US_DDistr_Combine::equivalent(double aa, double bb, double eps) {
   double dd = (aa != 0.0) ? qAbs(aa) : (bb != 0.0 ? qAbs(bb) : 1.0);
   return ((qAbs(aa - bb) / dd) <= eps);
}

// Generate envelope data
int US_DDistr_Combine::envel_data(
   QVector<double> &xvals, QVector<double> &yvals, QVector<double> &xenvs, QVector<double> &yenvs) {
   int arrsize = 300;
   ...
   for (int jj = 0; jj < vCount; jj++) { // Get min,max of x values (e.g., sedimentation coefficients)
   ...
   for (int jj = 0; jj < arrsize; jj++) { // Initialize envelope values
   ...
   for (int kk = 0; kk < arrsize; kk++) { // Loop to compute envelope grid Y values
      double xval_env = xe[ kk ]; // Envelope X value
      double yval_env = 0.0; // Initial envelope Y value

      for (int jj = 0; jj < vCount; jj++) { // Accumulate Gaussian Y's from each solute
   ...
   double yemx = -1e+30;
   double xemx = -1e+30;
   for (int kk = 0; kk < arrsize; kk++) { // Normalize Y values so integral is equal to total concentration
      ye[ kk ] *= scale;
      if (ye[ kk ] > yemx) {
         yemx = ye[ kk ];
         xemx = xe[ kk ];
   ...
   DbgLv(1) << "ED: Final esum" << env_sum << "csum" << con_sum << "xemx yemx" << xemx << yemx << "sigma  vcount"
            << sigma << vCount;
...
int US_DDistr_Combine::envel_data_auto(
   QVector<double> &xvals, QVector<double> &yvals, QVector<double> &xenvs, QVector<double> &yenvs, double sigma_passed,
   double xmin_passed, double xmax_passed) {
   int arrsize = 300;
   int vCount = xvals.size();
   double min_xval = 1.0e+50;
   double max_xval = -min_xval;
