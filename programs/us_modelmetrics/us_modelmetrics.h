...
class HydroParm {
   public:
      ...
      bool operator==(const HydroParm &objIn) { return (parm == objIn.parm); }
      ...
      bool operator<(const HydroParm &objIn) const { return (parm < objIn.parm); }
};
...
class US_ModelMetrics : public US_Widgets {
   ...
   private slots:
      ...
      QString table_row(
         const int row, const QString &col1, const QString &col2, const QString &col3, const QString &col4) const;
      ...
      //! \return Formatted table row string
      QString table_row(
         const int row, const QString &col1, const QString &col2, const QString &col3, const QString &col4,
         const QString &col5, const QString &col6) const;
      ...
      //! \brief Show help
      void help(void) { showHelp.show_help("manual/us_modelmetrics.html"); };
};
