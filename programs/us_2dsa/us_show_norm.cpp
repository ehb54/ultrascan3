...
void
US_show_norm::plot_data (int)
{
  plot_data ();
}

void
US_show_norm::update_resolu (double dval)
{
  resolu = dval;
}

void
US_show_norm::update_xreso (double dval)
{
  xreso = dval;
}

void
US_show_norm::update_yreso (double dval)
{
  yreso = dval;
}

void
US_show_norm::update_zfloor (double dval)
{
  zfloor = dval;
}

void
US_show_norm::update_plot_smin (double dval)
{
  plt_smin = dval;
...
void
US_show_norm::update_plot_smax (double dval)
{
  plt_smax = dval;
...
void
US_show_norm::update_plot_kmin (double dval)
{
  plt_kmin = dval;
}

void
US_show_norm::update_plot_kmax (double dval)
{
  plt_kmax = dval;
}

void
US_show_norm::select_autosxy ()
{
...
void
US_show_norm::sort_distro (QList<S_Solute> &listsols, bool reduce)
{
...
void
US_show_norm::select_x_axis (int ival)
{
...
void
US_show_norm::select_y_axis (int ival)
{
...
QString
US_show_norm::anno_title (int pltndx)
{
  QString a_title;
...
QwtLinearColorMap *
US_show_norm::ColorMapCopy (QwtLinearColorMap *colormap)
{
