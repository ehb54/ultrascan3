...
// mw x box checked
void
US_PlotControl2D::xmwtCheck (bool chkd)
{
  checkSet (chkd, true, 0);
}
// mw y box checked
void
US_PlotControl2D::ymwtCheck (bool chkd)
{
  checkSet (chkd, false, 0);
}
// sedcoeff x box checked
void
US_PlotControl2D::xsedCheck (bool chkd)
{
  checkSet (chkd, true, 1);
}
// sedcoeff y box checked
void
US_PlotControl2D::ysedCheck (bool chkd)
{
  checkSet (chkd, false, 1);
}
// diffcoeff x box checked
void
US_PlotControl2D::xdifCheck (bool chkd)
{
  checkSet (chkd, true, 2);
}
// diffcoeff y box checked
void
US_PlotControl2D::ydifCheck (bool chkd)
{
  checkSet (chkd, false, 2);
}
// friccoeff x box checked
void
US_PlotControl2D::xfcoCheck (bool chkd)
{
  checkSet (chkd, true, 3);
}
// friccoeff y box checked
void
US_PlotControl2D::yfcoCheck (bool chkd)
{
  checkSet (chkd, false, 3);
}
// fricratio x box checked
void
US_PlotControl2D::xfraCheck (bool chkd)
{
  checkSet (chkd, true, 4);
}
// fricratio y box checked
void
US_PlotControl2D::yfraCheck (bool chkd)
{
  checkSet (chkd, false, 4);
}
// Vbar x box checked
void
US_PlotControl2D::xvbaCheck (bool chkd)
{
  checkSet (chkd, true, 5);
}
// Vbar y box checked
void
US_PlotControl2D::yvbaCheck (bool chkd)
{
...
void
US_PlotControl2D::checkSet (bool chkd, bool isX, int row)
{
...
void
US_PlotControl2D::zscal_value (double value)
{
  zscale = value;
}
// grid resolution changed
void
US_PlotControl2D::gridr_value (double value)
{
  gridres = value;
}
// peak smoothing changed
void
US_PlotControl2D::peaks_value (double value)
{
  pksmooth = value;
}
// peak width changed
void
US_PlotControl2D::peakw_value (double value)
{
  pkwidth = value;
}
...
void
US_PlotControl2D::close_all ()
{
  close ();
}

int
US_PlotControl2D::dimensionType (QVector<QCheckBox *> &xycheck)
{
  int dimType = 1;
...
void
US_PlotControl2D::plot_close (void)
{
  plot3d_w = 0;
}
