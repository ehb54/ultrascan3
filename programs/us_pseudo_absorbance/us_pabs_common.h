...
/**
 * @class HSVcolormap
 * @brief The HSVcolormap class provides methods to generate a colormap based on
 * the HSV color model.
 */
class HSVcolormap {
 public:
  ...
  /**
   * @brief Constructor for HSVcolormap with specified number of colors, start
   * hue, and stop hue.
   * @param n_colors Number of colors
...
/**
 * @class CCW_ITEM
 * @brief The CCW_ITEM class represents items in a cross-cell wavelength (CCW)
 * list.
 */
class CCW_ITEM {
 public:
