...
int
US_RefScanDataIO::writeRefData (const QString &file, RefData &data)
{
  // define unions;
...
int
US_RefScanDataIO::readRefData (const QString &file, RefData &data)
{
  // define unions;
  union union16 u16a, u16b;
  union union32 u32a, u32b;
...
void
US_RefScanDataIO::write (QDataStream &ds, const char *c, int len, quint32 &crc)
{
...
void
US_RefScanDataIO::read (QDataStream &ds, char *cc, int len, quint32 &crc)
{
...
QString
US_RefScanDataIO::errorString (int code)
{
  switch (code)
    {
    case OK:
...
void
US_RefScanDataIO::RefData::clear ()
{
  type[0] = ' ';
  type[1] = ' ';
  nWavelength = 0;
...
US_RefScanDataIO::RefData::get_CA_corrected (bool &state)
{
