...
/**
 * @class US_AddRefScan
 * @brief The US_AddRefScan class handles the addition and management of
 * reference scans in the application.
 */
...
private:
  ...
  public:
    ...
    QVector<QVector<double> >
        dev_S_aln;    ///< Secondary aligned deviation values
  ...
  double sj_param (QVector<QVector<double> > *W, int size_x, double h,
  ...
  QVector<QVector<QVector<double> > > get_ref_dev (QVector<int> ids,
                                                   QVector<double> ref,
                                                   QVector<double> mean,
                                                   double aveMean);
  ...
  QVector<bool> cropping (QVector<double> rmsd, QVector<bool> tsk,
                          double margin);
