...
US_Advanced::US_Advanced(QWidget *w, Qt::WindowFlags flags) : US_Widgets(true, w, flags) {
   // Frame layout
   ...
   te_dbgtext->setFont(QFont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize()));
   ...
   sb_debug->setFont(QFont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize()));
   ...
   sb_advanced->setFont(QFont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize()));
   ...
   sb_threads->setFont(QFont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize()));
   ...
   sb_noisdiag->setFont(QFont(US_GuiSettings::fontFamily(), US_GuiSettings::fontSize()));
...
void US_Advanced::save() {
   ...
   QMessageBox::information(this, tr("Settings Saved"), tr("The settings have been saved."));
}
