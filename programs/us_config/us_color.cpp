...
void
US_Color::getCurrentSettings (void)
{
...
void
US_Color::selectedElement (int index)
{
  QPalette p;
  QColor c;
...
void
US_Color::updateWidgets (double newval)
{
  lcd->display (newval);
  progress->reset ();
...
void
US_Color::updateSchemeList (const QString &active)
{
  schemes->clear ();
...
void
US_Color::selectStyle (const QString &styleName)
{
