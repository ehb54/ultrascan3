...
US_RasmolControl::US_RasmolControl () : US_Widgets ()
{
  ...
  connect (cb_commcmd, SIGNAL (activated (const QString &)), this,
           SLOT (choose_command (const QString &)));
...
void
US_RasmolControl::send_command (void)
{
...
void
US_RasmolControl::choose_command (const QString &scmnd)
{
...
void
US_RasmolControl::list_interps (void)
{
