...
class US_ReporterGMP : public US_Widgets {
   ...
   public:
      ...
      struct PerChanReportMaskStructure {
            ...
            QMap<QString, QMap<QString, QMap<QString, QString>>>
               ShowTripleModelPseudo3dParts; //!< Map of triple model pseudo3d parts to show
            QMap<QString, QMap<QString, int>> has_tripleModelPseudo3d_items; //!< Map of triple model pseudo3d items

            // Individual Combined Plots
            QMap<QString, QMap<QString, QMap<QString, QString>>>
               ShowTripleTypeModelRangeIndividualCombo; //!< Map of individual combined plots
            QMap<QString, QMap<QString, int>>
               has_tripleModelIndCombo_items; //!< Map of triple model individual combined items
      };
   ...
   private:
      ...
      void read_autoflowStatus_record(
      ...
      void parse_edited_perChan_mask_json(
         const QString, PerChanReportMaskStructure &); //!< Parse edited per-channel mask JSON
      ...
      void parse_edited_combPlots_mask_json(
         const QString, CombPlotsReportMaskStructure &); //!< Parse edited combined plots mask JSON
      ...
      int count_noise_auto(
         US_DataIO::EditedData *, US_Model *, QStringList &, QStringList &); //!< Count noise automatically
      ...
      QMap<QString, double> get_replicate_group_results(
         US_ReportGMP::ReportItem, QString, QStringList); //!< Get replicate group results
   ...
   private slots:
      ...
      QString table_row(const QString &, const QString &, const QString &, const QString &)
         const; //!< Generate table row with 4 columns
      QString table_row(const QString &, const QString &, const QString &, const QString &, const QString &)
         const; //!< Generate table row with 5 columns
      QString table_row(
      ...
      QString table_row(
         const QString &, const QString &, const QString &, const QString &, const QString &, const QString &,
         const QString &, const QString &) const; //!< Generate table row with 8 columns
      QString table_row(
         const QString &, const QString &, const QString &, const QString &, const QString &, const QString &,
         const QString &, const QString &, const QString &) const; //!< Generate table row with 9 columns
      ...
      /**
         ...
         */
      void paintPage(
         QPrinter &printer, int pageNumber, int pageCount, QPainter *painter, QTextDocument *doc,
