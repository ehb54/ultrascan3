...
class US_ReporterGMP : public US_Widgets
{
    ...
    private:
        ...
        QMap< QString, QMap < QString, double>> abde_ranges_percents_dna;
        ...
        QString display_scan_excls( QList<int>, QList<int>, QList<int>, int, bool&, QString );
    ...
    private slots:
         ...
         */
        void help(void)
        { showHelp.show_help("manual/gmp/gmp_report_generator.html"); };
