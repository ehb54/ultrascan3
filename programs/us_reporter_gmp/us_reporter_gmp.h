...
class US_ReporterGMP : public US_Widgets {
 ...
 public:
  ...
  struct PerChanReportMaskStructure {
    ...
    // triple_name -> model -> feature -> value [Exp. Duration, Intensity, RMSD,
    // Integration Results, Tot. Conc.]
 ...
 private:
  ...
  QMap<QString, QMap<QString, QString>> parse_autoflowStatus_json(
      const QString, const QString);  //!< Parse autoflow status JSON
  ...
  void read_reportLists_from_aprofile(
      QStringList&, QStringList&);  //!< Read report lists from analysis profile
  ...
  QMap<QString, QString> read_autoflowIntensity(
      QString, US_DB2*);  //!< Read autoflow intensity
  ...
  QMap<QString, QMap<QString, QString>> parse_comb_plots_json(
      const QString);  //!< Parse combined plots JSON
  QMap<QString, QString> parse_models_desc_json(
      const QString, const QString);  //!< Parse models description JSON
  ...
  void parse_edited_combPlots_mask_json(
      const QString, CombPlotsReportMaskStructure&);  //!< Parse edited combined
                                                      //!< plots mask JSON
  ...
  int models_in_edit_auto(QString,
                          QStringList&);  //!< Get models in edit automatically
  int noises_in_model_auto(
      QString, QStringList&);  //!< Get noises in model automatically
 ...
 private slots:
  ...
  void get_assigned_oper_revs(
      QJsonDocument, QStringList&);  //!< Get assigned operator revisions

  QString indent(int) const;  //!< Generate indent
  QString table_row(const QString&, const QString&)
      const;  //!< Generate table row with 2 columns
  QString table_row(const QString&, const QString&, const QString&)
      const;  //!< Generate table row with 3 columns
  QString table_row(
  ...
  QString table_row(const QString&, const QString&, const QString&,
                    const QString&, const QString&, const QString&)
      const;  //!< Generate table row with 6 columns
  QString table_row(
      const QString&, const QString&, const QString&, const QString&,
  ...
  void paintPage(QPrinter& printer, int pageNumber, int pageCount,
                 QPainter* painter, QTextDocument* doc, const QRectF& textRect,
                 qreal footerHeight);
   ...
   * @brief Display help.
   */
  void help(void) { showHelp.show_help("manual/gmp_report_generator.html"); };
