...
void US_ReporterGMP::process_combined_plots ( QString filename_passed )
{
  ...
  html_assembled += "<h1 align=left>Combined Distribution Plots</h1>";
...
{
  html_assembled += "<p class=\"pagebreak \">\n";
  html_assembled += "<h1 align=left>Run Details</h1>";
...
{
  html_assembled += "<p class=\"pagebreak \">\n";
  html_assembled += "<h1 align=left>User Interactions:\n GMP Run Initiation, Live Update, Data Import, Editing, and Analysis</h1>";
...
// ---------------------------------------------------------------------------
void US_ReporterGMP::injectBookmarks( const QString& pdfPath )
{
  PdfMemDocument doc;
  ...
  for ( const Heading& h : m_headings )
    {
