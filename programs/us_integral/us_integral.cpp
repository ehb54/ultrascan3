...
void US_Integral::build_bf_vects() {
  ...
  for (int ii = 0; ii < ndists; ii++) {
    ...
    for (int jj = 0; jj < npoints;
         jj++) {  // Append values for each bf-point for this model
...
void US_Integral::write_csv(const QString fpath, const QString hdr1,
