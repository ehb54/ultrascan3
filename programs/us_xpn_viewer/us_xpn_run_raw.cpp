  ...
  for (int ii = 0; ii < nruns; ii++)
    {
      ...
      rirec.runID = QString ().sprintf (
          "%s-run%d", rirec.expname.toLatin1 ().data (), rirec.dbId);
...
void
US_XpnRunRaw::limit_data (const QString &sfilt)
{
