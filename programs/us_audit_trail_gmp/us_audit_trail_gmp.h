...
class US_auditTrailGMP : public US_Widgets {
   ...
   private slots:
      ...
      void read_autoflowStatus_record(
         QString &status, QString &runID, QString &protocolName, QString &investigatorName, QString &expType,
         QString &date, QString &filename, QString &projectName, QString &solutionName, QString &bufferName,
         QString &analyteName, QString &gradientName, QString &hardwareName, QString &aprofileName,
