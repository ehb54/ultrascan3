...
class US_auditTrailGMP : public US_Widgets {
 ...
 private slots:
  ...
  QLineEdit* check_eSign_status_for_gmpReport_auto(
      QString id, QMap<QString, QString> details);
  ...
  void read_autoflowStatus_record(QString& status, QString& runID,
                                  QString& protocolName,
                                  QString& investigatorName, QString& expType,
                                  QString& date, QString& filename,
                                  QString& projectName, QString& solutionName,
                                  QString& bufferName, QString& analyteName,
                                  QString& gradientName, QString& hardwareName,
                                  QString& aprofileName, QString& aprofileGUID,
  ...
  QMap<QString, QMap<QString, QString>> parse_autoflowStatus_json(
      const QString json, const QString key);
  ...
  void assemble_GMP_live_update(QMap<QString, QMap<QString, QString>> statusMap,
