...
class US_EditScan : public US_WidgetsDialog {
   ...
   public:
      ...
      US_EditScan(
         US_DataIO::Scan &scan, const QVector<double> &radii, double invert, double range_left, double range_right);
   ...
   private slots:
      ...
      void help(void) { showHelp.show_help("manual/edit_scan.html"); }
};
