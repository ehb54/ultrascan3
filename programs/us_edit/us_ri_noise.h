...
class US_RiNoise : public US_WidgetsDialog {
 ...
 public:
  ...
  US_RiNoise(const US_DataIO::RawData& data, const QList<int>& includes,
             double range_left, double range_right, const QString& label,
             int& order, QList<double>& residuals);
