...
class US_Edit : public US_Widgets {
   ...
   public:
      ...
      US_Edit(
         QVector<US_DataIO::RawData> allData, QStringList triples, QString workingDir, int currChInd, int plotind,
         QString exptype);

      US_Edit(
         QVector<US_DataIO::RawData> allData, QStringList triples, QString workingDir, int currChInd, int plotind,
         QString exptype, QStringList editParms, QList<int> editParms_includes);
   ...
   private slots:
      ...
      QString table_row(const QString, const QString, const QString, const QString, const QString, const QString);
      ...
      void help(void) { showHelp.show_help("manual/us_edit.html"); };
