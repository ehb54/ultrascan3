    ...
    : US_WidgetsDialog (0, 0)
{
  ...
  le_original
      = us_lineedit (tr ("%1 original lambdas").arg (nbr_orig), -1, true);
  le_selected
...
void
US_SelectLambdas::add_selections ()
{
...
void
US_SelectLambdas::rmv_selections ()
{
