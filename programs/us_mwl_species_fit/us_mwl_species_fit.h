...
//! \brief Class for managing and performing multi-wavelength species fit
//! analysis.
class US_MwlSpeciesFit : public US_AnalysisBase2 {
 ...
 public:
  ...
  QMap<QString, QMap<QString, QMap<double, double>>>
      extinction_profiles_per_channel;
 ...
 private slots:
  ...
  void help(void) { showHelp.show_help("manual/mwl_species_fit.html"); };
};
