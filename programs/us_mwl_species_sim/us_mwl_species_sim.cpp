...
void
US_MwlSpeciesSim::data_plot (void)
{
  if (nmodels > 0)
    {
      plot_data1 ();
...
// Plot the AUC data
void
US_MwlSpeciesSim::plot_data1 (void)
{
...
void
US_MwlSpeciesSim::pre_filt (void)
{
...
void
US_MwlSpeciesSim::select_models (void)
{
  ...
  for (int jm = 0; jm < nmodels; jm++)
    {
      ...
      if (jm < 5 || (jm + 5) > nmodels)
        {
          DbgLv (1) << "  smdls: jm" << jm << "model.desc" << mdesc
                    << "mdescs[jm]" << mdescs[jm];
        }
      //*DEBUG
...
void
US_MwlSpeciesSim::define_buffer (void)
{
...
void
US_MwlSpeciesSim::change_buffer (US_Buffer b)
{
  buffer = b;
...
void
US_MwlSpeciesSim::sim_params (void)
{
...
void
US_MwlSpeciesSim::set_parameters (void)
{
...
// Select a rotor
void
US_MwlSpeciesSim::select_rotor (void)
{
...
void
US_MwlSpeciesSim::assign_rotor (US_Rotor::Rotor &arotor,
                                US_Rotor::RotorCalibration &calibration)
{
  rotor = arotor;
...
void
US_MwlSpeciesSim::start_sims (void)
{
...
void
US_MwlSpeciesSim::stop_sims (void)
{
...
void
US_MwlSpeciesSim::save_sims (void)
{
...
void
US_MwlSpeciesSim::prev_plot (void)
{
...
void
US_MwlSpeciesSim::next_plot (void)
{
...
void
US_MwlSpeciesSim::close_all (void)
{
...
void
US_MwlSpeciesSim::init_simparams (void)
{
...
void
US_MwlSpeciesSim::init_rawdata (void)
{
  ...
  int npoints
      = qRound ((curr_bottom - curr_meniscus) / simparams.radial_resolution)
        + 1;
...
void
US_MwlSpeciesSim::build_rawdata (void)
{
  const int npad = 10;
  ...
  for (int js = 0; js < nscan; js++)
    {
      ...
      DbgLv (1) << "bldraw:   js" << js << "valmm"
                << rdata.value (js, npoint / 2);
    }
...
int
US_MwlSpeciesSim::writeTimeState (const QString &tmst_fpath,
