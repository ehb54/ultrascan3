...
US_ClipData::US_ClipData(
   double &concentration, double &radius, double meniscus, double loading, QWidget *p, Qt::WindowFlags f) :
   ...
   QLabel *lb_loading = us_label(tr("( Loading concentration: ") + QString().sprintf("%4.2f", loading) + " )");
