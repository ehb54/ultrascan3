...
US_ClipData::US_ClipData(double& concentration, double& radius, double meniscus,
                         double loading, QWidget* p, Qt::WindowFlags f)
  ...
  setWindowTitle(
      tr("Select Finite Element Simulation"
         " Data Range"));

  QLabel* lb_info =
      us_banner(tr("Please select the Cropping Range\n"
