...
public:
  ...
  public:
    ...
    bool
    contains (int x) //!< function to determine if x is contained in the list
    {
      return excludes.contains (x);
    }
    bool
    empty () //!< function to determine if the list is empty
    {
      return excludes.empty ();
    }
    void
    push_back (int x) //!< function to add x to the end of the list
    {
      excludes.push_back (x);
    }
    Excludes &
    operator<< (const int x) //!< function to insert x at the end of the list
    {
      this->push_back (x);
      return *this;
    }
    int
    size (void) //!< function to return the size of the list
    {
  ...
  public:
    ...
    QString
        tripleDesc; //!< The description of this triple ( e.g., "2 / A / 260" )
  ...
  static void readLegacyData (QString, QList<US_DataIO::BeckmanRawScan> &,
                              QString &);
  ...
  static void convertLegacyData (QList<US_DataIO::BeckmanRawScan> &,
                                 QVector<US_DataIO::RawData> &,
                                 QList<TripleInfo> &, QString, double);
  ...
  static int saveToDisk (QVector<US_DataIO::RawData *> &, QList<TripleInfo> &,
                         QVector<Excludes> &, QString, QString, QString, bool);
  ...
  static int readUS3Disk (QString, QVector<US_DataIO::RawData> &,
                          QList<TripleInfo> &, QString &);
  ...
  static void splitRAData (QVector<US_DataIO::RawData> &, QList<TripleInfo> &,
                           int, QList<double> &);
  ...
  static int
  adjustSpeedstep (QVector<US_DataIO::RawData> &,
...
private:
  ...
  static void setTriples (QList<US_DataIO::BeckmanRawScan> &rawLegacyData,
  ...
  static US_DataIO::Scan newScanSubset (US_DataIO::Scan &oldScan,
                                        QVector<double> &radii, double r_start,
                                        double r_end);
};
#endif
