 ...
 public:
  ...
  class Excludes {
   public:
    ...
    bool contains(
        int x)  //!< function to determine if x is contained in the list
    {
    ...
    Excludes& operator<<(
        const int x)  //!< function to insert x at the end of the list
    {
      this->push_back(x);
      return *this;
    }
  ...
  static void splitRAData(QVector<US_DataIO::RawData>&, QList<TripleInfo>&, int,
                          QList<double>&);
