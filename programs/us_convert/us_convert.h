...
class US_Convert {
   public:
      ...
      static void convertLegacyData(
         QList<US_DataIO::BeckmanRawScan> &, QVector<US_DataIO::RawData> &, QList<TripleInfo> &, QString, double);
      ...
      static int saveToDisk(
         QVector<US_DataIO::RawData *> &, QList<TripleInfo> &, QVector<Excludes> &, QString, QString, QString, bool);
      ...
      static int adjustSpeedstep(QVector<US_DataIO::RawData> &, QVector<US_SimulationParameters::SpeedProfile> &);

   private:
      static void convert(
         QList<US_DataIO::BeckmanRawScan> &rawLegacyData, US_DataIO::RawData &newRawData, QString triple,
      ...
      static US_DataIO::Scan newScanSubset(
         US_DataIO::Scan &oldScan, QVector<double> &radii, double r_start, double r_end);
};
#endif
