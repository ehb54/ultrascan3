...
public:
  ...
  QList<double>
      rpms;         //!< A list of rotor speeds observed during the experiment
  ...
  QMap<QString, double>
      RIProfileMap; //!< Referecne Profile, cell/chanell/wavelength/scan ->
                    //!< radial intensity
  ...
  */
  ...
  /*! \brief    Writes an xml file
      ...
      \param speedsteps  Reference to a vector of speed steps for the
                         experiment.
  */
  int saveToDisk (QList<US_Convert::TripleInfo> &, QString, QString, QString,
  ...
  */
  int readFromDisk (QList<US_Convert::TripleInfo> &, QString, QString,
                    QString);
...
private:
  void readExperiment (QXmlStreamReader &, QList<US_Convert::TripleInfo> &,
                       QString, QString);
