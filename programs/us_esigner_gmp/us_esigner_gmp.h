...
private slots:
  ...
  //! \brief Get assigned operators and reviewers for separate assignment from
  //! a JSON document.
  ...
  QString write_pdf_eSignatures (QString runID, QString eSignID,
                                 QString docType, QString eSignData,
                                 QString status);
  ...
  QLineEdit *
  check_eSign_status_for_gmpReport_auto (QString runID,
                                         QMap<QString, QString> details);
