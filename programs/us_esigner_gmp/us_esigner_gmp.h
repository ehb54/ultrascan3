...
class US_eSignaturesGMP : public US_Widgets {
   ...
   private slots:
      ...
      QString compose_updated_admin_logJson(
         int adminID, QString date, QString runID, QString operID, QString revID, QString apprID, QString status,
         QString comments, QString sigID);
      ...
      //! \return The composed JSON string.
      QString compose_updated_eSign_Json(
         int adminID, QString date, QString runID, QJsonArray revIDs, QJsonArray apprIDs, QString status,
         QString &eSignData);
      ...
      //! \param status The status.
      //! \return The composed JSON string.
      QString compose_updated_eSign_Json_sa(
         int adminID, QString date, QString runID, QString eSignData, QJsonArray status);
