...
//! \brief Contains the declaration of the US_eSignaturesGMP class and its
//! members.
...
//! \brief A class for managing electronic signatures for GMP compliance in
//! UltraScan.
class US_eSignaturesGMP : public US_Widgets {
 ...
 public:
  ...
  //! \brief Constructor for the US_eSignaturesGMP class with a single string
  //! parameter.
  //! \param gmpRunID The GMP run ID.
  US_eSignaturesGMP(QString gmpRunID);

  //! \brief Constructor for the US_eSignaturesGMP class with a string list
  //! parameter.
 ...
 private:
  ...
  QMap<QString, QString>
      eSign_details_auto;             //!< Map of eSign details for auto mode.
  ...
  QPushButton* pb_selRun_operRev_set;  //!< Button to select run and set
                                       //!< operators/reviewers.
  ...
  QGridLayout*
      eSignActionsGrid_auto;  //!< Grid layout for eSign actions in auto mode.
 ...
 private slots:
  ...
  void display_reviewers_auto(int& index, QMap<QString, QString> details,
                              QString role);
  ...
  //! \brief Set the GUI for the reviewer/operator panel for separate
  //! assignment.
  ...
  //! \brief Get assigned operators and reviewers for separate assignment from a
  //! JSON document.
  //! \param runID The run ID.
  //! \param doc The JSON document.
  //! \param details The details map.
  //! \return The list of assigned operators and reviewers as a string.
  QString get_assigned_oper_revs_sa(QString runID, QJsonDocument doc,
  ...
  QString compose_updated_admin_logJson(int adminID, QString date,
                                        QString runID, QString operID,
                                        QString revID, QString apprID,
                                        QString status, QString comments,
                                        QString sigID);
  ...
  void compose_updated_ora_list(QString& runID, QString& oldORA,
                                QString& newORA, QString docType,
                                QString eSignType);
  ...
  //! \return The composed JSON string.
  QString compose_updated_eSign_Json(int adminID, QString date, QString runID,
                                     QJsonArray revIDs, QJsonArray apprIDs,
  ...
  //! \param status The status.
  //! \return The composed JSON string.
  QString compose_updated_eSign_Json_sa(int adminID, QString date,
                                        QString runID, QString eSignData,
                                        QJsonArray status);
  ...
  QString write_pdf_eSignatures(QString runID, QString eSignID, QString docType,
                                QString eSignData, QString status);
  ...
  //! \return The eSign status as a string.
  QString check_revs_esign_status_sa(QString runID,
                                     QMap<QString, QString> reviewers);

  //! \brief Check the eSign status for a GMP report in auto mode.
  //! \param runID The run ID.
  //! \param details The details map.
  //! \return A pointer to the line edit containing the eSign status.
  QLineEdit* check_eSign_status_for_gmpReport_auto(
      QString runID, QMap<QString, QString> details);
  ...
  void paintPage(QPrinter& printer, int pageNumber, int pageCount,
                 ...
                 qreal footerHeight,
                 QMap<QString, QMap<QString, QString>> details);
  ...
  void help(void) { showHelp.show_help("manual/gmp_signature.html"); };
