...
//! \brief Contains the declaration of the US_Norm_Profile class and its
//! members.
...
class US_Norm_Profile : public US_Widgets {
 ...
 private:
  ...
  QVector<QVector<double>>
      integralN_sel;         //!< Normalized selected integral values.
  ...
  QPushButton*
      pb_pick_norm;         //!< Button to pick a reference normalization point.
  ...
  void find_percent_from_range(QString, QString, QString, QVector<double>,
                               QVector<double>);
 ...
 private slots:
  ...
  void parse_abde_analysis_jsons(QString, QMap<QString, QString>&,
                                 QMap<QString, double>&, QMap<QString, int>&,
