...
US_Density_Match::US_Density_Match() : US_Widgets()
{
   ...
   connect( ct_division,    &QwtCounter::valueChanged,
            this,           &US_Density_Match::update_divis );
