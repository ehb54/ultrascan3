...
p[] = {
    {P_CONFIG, 1, 0, "us_config", QObject::tr("Loading Configuration"),
    ...
    */
    {P_EDIT, 0, 0, "us_edit", QObject::tr("Loading Editing Data"),
    ...
    {P_ABDE_FIT, 1, 0, "us_abde", QObject::tr("Loading ABDE Fitter"),
    ...
    {P_FITMEN, 0, 0, "us_fit_meniscus", QObject::tr("Loading Fit Meniscus"),
    ...
    {P_LICENSE, 1, 0, "us_license", QObject::tr("Loading License Manager"),
    ...
    {P_VIEWTMST, 0, 0, "us_tmst_viewer", QObject::tr("Loading View Time State"),
     QObject::tr("View Time State")},

    {P_DENSMTCH, 0, 0, "us_density_match",
     QObject::tr("Loading Density Matching"), QObject::tr("Density Matching")},
    ...
    {P_AUDIT, 0, 0, "us_audit_trail_gmp",
     QObject::tr("Loading Audit Trail Program"), QObject::tr("Audit Trail")},
