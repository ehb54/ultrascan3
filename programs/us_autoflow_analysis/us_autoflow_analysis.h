 ...
 * @brief This class handles the automatic analysis of ultra-sedimentation
 * data.
 */
...
public:
  ...
  QMap<QString, QTreeWidgetItem *>
      topItem; /**< Top-level items in the tree widget. */
  QMap<QString, QTreeWidgetItem *>
      childItem_2DSA; /**< Child items for 2DSA analysis. */
  QMap<QString, QTreeWidgetItem *>
      childItem_2DSA_FM; /**< Child items for 2DSA-FM analysis. */
  QMap<QString, QTreeWidgetItem *>
      childItem_2DSA_FITMEN; /**< Child items for 2DSA-FITMEN analysis. */
  QMap<QString, QTreeWidgetItem *>
      childItem_2DSA_IT; /**< Child items for 2DSA-IT analysis. */
  QMap<QString, QTreeWidgetItem *>
      childItem_2DSA_MC; /**< Child items for 2DSA-MC analysis. */
  QMap<QString, QTreeWidgetItem *>
      childItem_PCSA; /**< Child items for PCSA analysis. */

  QMap<QString, QGroupBox *>
      groupbox_2DSA; /**< Group boxes for 2DSA analysis. */
  QMap<QString, QGroupBox *>
      groupbox_2DSA_FM; /**< Group boxes for 2DSA-FM analysis. */
  QMap<QString, QGroupBox *>
      groupbox_2DSA_FITMEN; /**< Group boxes for 2DSA-FITMEN analysis. */
  QMap<QString, QGroupBox *>
      groupbox_2DSA_IT; /**< Group boxes for 2DSA-IT analysis. */
  QMap<QString, QGroupBox *>
      groupbox_2DSA_MC; /**< Group boxes for 2DSA-MC analysis. */
  QMap<QString, QGroupBox *>
      groupbox_PCSA; /**< Group boxes for PCSA analysis. */
  ...
  bool in_reload_end_process; /**< Flag indicating if the process is being
                                 reloaded. */
  ...
  QPointer<US_ResidPlotFem>
      resplotd; /**< Pointer to the Residual Plot for FEM data. */
  ...
  QProgressDialog
      *progress_msg; /**< Progress dialog for showing progress messages. */
...
private:
  ...
  QPointer<US_ResidsBitmap>
      rbmapd; /**< Pointer to the residual bitmap for the dataset. */
  ...
  QMap<QString, QString>
      protocol_details_at_analysis; /**< Protocol details at the time of
                                       analysis. */
  ...
  QMap<QString, QMap<QString, QString> >
      Array_of_analysis; /**< Array of analysis data. */
  QMap<QString, QMap<QString, QString> >
      Array_of_analysis_by_requestID; /**< Array of analysis by request ID. */
  QMap<QString, QStringList>
      Channel_to_requestIDs; /**< Mapping of channels to request IDs. */
   ...
   */
  QMap<QString, QString> read_autoflowAnalysis_record (US_DB2 *,
                                                       const QString &);
   ...
   */
  QMap<QString, QString> read_autoflowAnalysisHistory_record (US_DB2 *,
                                                              const QString &);
   ...
   * @param modelID The model ID.
   */
  void noises_in_edit (QString, QStringList &, QStringList &, QStringList &,
                       QString);
   ...
   */
  void update_autoflowAnalysis_status_at_fitmen (US_DB2 *,
                                                 const QStringList &);
   ...
   */
  void record_or_update_analysis_cancel_status (US_DB2 *, QString, QString,
                                                QString);
   ...
   * @param analysisIDs List of analysis IDs.
   */
  void update_autoflowAnalysis_uponDeletion_other_wvl (US_DB2 *,
                                                       const QStringList &);
  ...
  QSignalMapper
      *signalMapper_overlay; /**< Signal mapper for overlay signals. */
...
signals:
  ...
  /**
   * @brief Signal emitted when the analysis is returned to the initial
   * autoflow stage.
   */
