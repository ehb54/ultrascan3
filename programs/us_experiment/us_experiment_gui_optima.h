...
class US_ExperGuiGeneral : public US_WidgetsDialog {
 ...
 public:
  ...
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_general.html"); };
 ...
 private:
  ...
  QMap<QString, bool>
      ul2_operator_for_optima;  // for UL<3, determine if the user is an
...
class US_ExperGuiRotor : public US_WidgetsDialog {
 ...
 public:
  ...
  QStringList sibLValue(const QString, const QString);
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_rotor.html"); };
 ...
 private slots:
  ...
  QMap<QString, QStringList> build_protocol_for_data_import(
  ...
  void advRotorChanged(US_Rotor::Rotor&, US_Rotor::RotorCalibration&);
...
class US_ExperGuiSpeeds : public US_WidgetsDialog {
 ...
 public:
  ...
  QStringList sibLValue(const QString, const QString);
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_speeds.html"); };
...
class US_ExperGuiCells : public US_WidgetsDialog {
 ...
 public:
  ...
  QStringList sibLValue(const QString, const QString);
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_cells.html"); };
...
class US_ExperGuiSolutions : public US_WidgetsDialog {
 ...
 public:
  ...
  QStringList sibLValue(const QString, const QString);
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_solutions.html"); };
 ...
 private slots:
  ...
  void commentStrings(const QString, QString&, QStringList&, const int);
...
class US_ExperGuiOptical : public US_WidgetsDialog {
 ...
 public:
  ...
  QStringList sibLValue(const QString, const QString);
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_photomult.html"); };
...
class US_ExperGuiRanges : public US_WidgetsDialog {
 ...
 private slots:
  ...
  bool iStwoOrMoreAnalytesSpectra_forChannel(QString, QStringList&, QString,
                                             int);
  bool validExtinctionProfile(QString, QList<double>, QList<double>,
                              QStringList&);
...
class US_ExperGuiUpload : public US_WidgetsDialog {
 ...
 public:
  ...
  QStringList sibLValue(const QString, const QString);
  int status(void);
  void help(void) { showHelp.show_help("manual/experiment_submit.html"); };
 ...
 private slots:
  ...
  void submitExperiment_confirm_protDev(
      void);  // Submit the experiment when US_ProtDev
  ...
  int writeReportToDB(QString,
                      US_ReportGMP);  // Write ReportItems && Parent Report
...
class US_ExperimentMain : public US_Widgets {
 ...
 private slots:
  ...
  void disable_tabs_buttons(
      void);  // Slot to unable Tabs and Buttons when user level is low
  void enable_tabs_buttons_readonly(
      void);  // Slot to enable Tabs and Buttons after protocol is loaded
  void enable_tabs_buttons(
      void);  // Slot to enable Tabs and Buttons after run_name is entered
