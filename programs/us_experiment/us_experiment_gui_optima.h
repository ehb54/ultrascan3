...
private slots:
  ...
  QMap<QString, QStringList>
      build_protocol_for_data_import (QMap<QString, QStringList>);
...
private slots:
  ...
  void
  submitExperiment_protDev (void); // Submit the experiment when US_ProtDev
...
public slots:
  ...
  void
  accept_passed_protocol_details (QMap<QString, QString> &protocol_details);
