...
class US_AdvancedFem : public US_WidgetsDialog {
 ...
 public:
  ...
  US_AdvancedFem(US_Model*, QMap<QString, QString>&, QWidget* p = 0);

 private:
  US_Model* model;  //! \brief Pointer to model
  QMap<QString, QString>&
      parmap;  //! \brief Reference to advanced dialog values
 ...
 private slots:
  ...
  void done(void);
  void help(void) { showHelp.show_help("fe_match_adv.html"); };
};
#endif
