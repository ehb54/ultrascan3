...
void
US_AdvDmgaMc::change_model (double mnbr)
{
  int mx = (int)mnbr - 1;
  umodel = imodels[mx];
...
void
US_AdvDmgaMc::set_model_type (bool chekd)
{
  if (!chekd)
    return;
