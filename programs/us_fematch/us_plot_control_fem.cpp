...
//qDebug() << "PC: p3btn type x,y" << typex << typey;
   ...
   if ( plot3d_w == 0 )
   {
      ...
      connect( plot3d_w, &US_Plot3D::has_closed,
               this,     &US_PlotControlFem::plot_close  );
   }
