...
class US_FeMatch : public US_Widgets {
   ...
   public:
      ...
      void auto_load_simulate(
         US_DataIO::RawData rawData, US_DataIO::EditedData editedData, US_Model model, int int_param,
         QPoint point_param);
   ...
   private:
      ...
      QTextEdit *te_model; //!< Text edit for the loaded model.
   ...
   private slots:
      ...
      //! \return The table row string.
      QString table_row(
         const QString &col1, const QString &col2, const QString &col3, const QString &col4, const QString &col5) const;
      ...
      //! \return The table row string.
      QString table_row(
         const QString &col1, const QString &col2, const QString &col3, const QString &col4, const QString &col5,
         const QString &col6, const QString &col7) const;
