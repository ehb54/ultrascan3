...
public:
  ...
  void auto_load_simulate (US_DataIO::RawData rawData,
                           US_DataIO::EditedData editedData, US_Model model,
                           int int_param, QPoint point_param);
...
private slots:
  ...
  double interp_sval (double x_value, double *x_data, double *y_data,
                      int size);
  ...
  //! \return The table row string.
  QString table_row (const QString &col1, const QString &col2,
                     const QString &col3) const;
  ...
  QString html_header (QString title, QString subtitle,
