...
void
US_SelectRunid::search (const QString &search_string)
{
...
void
US_SelectRunid::scan_dbase_runs ()
{
  US_Passwd pw;
...
void
US_SelectRunid::scan_local_runs (void)
{
...
void
US_SelectRunid::update_person (int ID)
{
...
void
US_SelectRunid::update_disk_db (bool isDB)
{
  emit changed (isDB);
...
void
US_SelectRunid::selectionChanged ()
{
  count_seld = lw_data->selectedItems ().size ();
...
void
US_SelectRunid::sort_rlabels (const QStringList rlabs)
{
  slabels.clear ();
