    ...
    : US_WidgetsDialog (0, 0)
{
  ...
  connect (ck_contour, SIGNAL (toggled (bool)), this,
           SLOT (ptype_toggle (bool)));
...
void
US_VhwCPlotControl::ptype_toggle (bool chkd)
{
...
QWidget *
US_VhwCPlotControl::caller (void)
{
  return wparent;
}
...
QGLWidget *
US_VhwCPlotControl::data_3dplot (void)
{
...
US_Plot3D *
US_VhwCPlotControl::widget_3dplot (void)
{
  return plot3d_w;
}
