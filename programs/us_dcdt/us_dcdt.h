...
class US_Dcdt : public US_AnalysisBase2 {
 ...
 private:
  ...
  int previousScanCount;  //!< Total number of scans before skipping and
                          //!< exclusion.
  ...
  QList<QVector<double>>
      sValues;  //!< Holds s-value transformations from the dcdt scans.
 ...
 private slots:
  ...
  void help(void) { showHelp.show_help("manual/time_derivative.html"); }
};
