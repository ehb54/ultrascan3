//! \file us_export.h
//! \brief Contains the declaration of the US_ExportLegacy class and its
//! members.
...
class US_ExportLegacy : public US_Widgets {
 ...
 private slots:
  ...
  void rDataStrings(US_DataIO::RawData* data, QString& runID, QString& filename,
                    QString& dataType, QString& comment);
  ...
  void help(void) { showHelp.show_help("export_legacy.html"); };
