  ...
  while (db.next ())
    {
      ...
      if (resruns.contains (runid))
        {
          runids << runid;
          qDebug () << "  report id" << db.value (0).toString () << "runID"
                    << runid;
          kreports++;
        }
    }
