...
QWidget* US_MwlPlotControl::caller(void) { return wparent; }

// Public slot to force (re-)plot of currently specified 3-D plot
void US_MwlPlotControl::do_3dplot() { plot3_btn(); }
...
US_Plot3D* US_MwlPlotControl::widget_3dplot(void) { return plot3d_w; }
