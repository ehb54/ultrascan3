...
private:
  ...
  public:
    ...
    bool
    operator< (const Fitness &f) const
    {
  ...
  void dgenes_to_marker (QVector<double> &, QList<DGene> &, const int,
                         const int);
  void marker_to_dgenes (QVector<double> &, QList<DGene> &, const int,
                         const int);
