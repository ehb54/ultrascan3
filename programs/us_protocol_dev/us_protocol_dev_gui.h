...
//! \brief This file contains the declaration of the classes for the US
...
public:
   ...
   */
  QSize
  sizeFromContents (ContentsType type, const QStyleOption *option,
...
//! \brief Class representing the initial panel in the protocol development
//! GUI.
...
signals:
   ...
   */
  void
  switch_to_post_processing_init (QMap<QString, QString> &protocol_details);
...
//! \class US_ExperGui
//! \brief Class representing the experiment panel in the protocol development
//! GUI.
...
//! \class US_ObservGui
//! \brief Class representing the observation panel in the protocol development
//! GUI.
...
//! \brief Class representing the post-production panel in the protocol
//! development GUI.
...
//! \class US_EditingGui
//! \brief Class representing the editing panel in the protocol development
//! GUI.
...
//! \brief Class representing the analysis panel in the protocol development
//! GUI.
...
public:
  ...
  QMessageBox *
      msg_analysis_update_finishing; //!< Analysis update finishing message box
