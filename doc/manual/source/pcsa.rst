 ...
 *  **Step 2:** *Define the Analysis Fit:* Secondly, open an analysis control window by clicking on "Fit Control". Within that dialog, define the ranges and counts that comprise the analysis. 
