...
**Step 4:** *Examine the results.* After simulation, a variety of options are available for displaying :doc:`simulation results <fe_match_simulate>`, residuals, and distributions. Report text files and graphics plot files can also be generated.
