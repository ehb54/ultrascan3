...
.. image:: ../_static/images/experiment_submit_details.png
    :align: center
...
A panel status box and multiple buttons are shared by all panels. The `General <general>` tab help page has detailed explanations of these items. 