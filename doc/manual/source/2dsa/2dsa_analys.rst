...
.. list-table::
  ...
  * - **Custom Grid**
    - Check this box to load a custom grid as the preferred optimization method. A `Load Distribution dialog    <../common_dialogs.html#load-distribution-model>`_ to load the custom grid generated by the `Custom Grid Editor (CG) <../grid_editor.html>`_. 
  * - **Float Meniscus:**
