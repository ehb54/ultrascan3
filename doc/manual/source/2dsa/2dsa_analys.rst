...
.. list-table::
  ...
  * - **Custom Grid**
    - Check this box to load a custom grid as the preferred optimization method. A :ref:`Load Distribution dialog <fe-data-loader>` to load the custom grid generated by the :doc:`Custom Grid Editor (CG) <../grid_editor>`. 
  * - **Float Meniscus:**
