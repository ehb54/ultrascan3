...
**Refinement Options:** These parameters are also found in the standard analysis control dialog and the Regularization options.
...
.. list-table::
  ...
  * - **Regularization Factor:**
    - Level of regularization to apply. 