===========================================
UltraScan-III Configuration and Preference
===========================================
...
When Reset is selected, the fields are cleared and a new entry can be entered. The Test DB Connectivity button will try to connect to the database in the Detailed Information fields to provide a confirmation that the data is correct.
