...
// Takes care of minumum delay for the experiment.
...
//   speed .push_back( 0 );
   ...
   if ( nsteps > 1 )
   {
      US_SimulationParameters::SpeedProfile* sp_prev = &simparams.speed_step[ current_speed_step-1 ];
