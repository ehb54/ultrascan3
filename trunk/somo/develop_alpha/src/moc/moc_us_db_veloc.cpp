/****************************************************************************
** US_DB_Veloc meta object code from reading C++ file 'us_db_veloc.h'
**
...
const char *US_DB_Veloc::className() const
{
    return "US_DB_Veloc";
}

QMetaObject *US_DB_Veloc::metaObj = 0;
static QMetaObjectCleanUp cleanUp_US_DB_Veloc( "US_DB_Veloc", &US_DB_Veloc::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString US_DB_Veloc::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "US_DB_Veloc", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString US_DB_Veloc::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "US_DB_Veloc", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* US_DB_Veloc::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	{ "closeEvent(QCloseEvent*)", &slot_15, QMetaData::Private }
    };
    metaObj = QMetaObject::new_metaobject(
	"US_DB_Veloc", parentObject,
	slot_tbl, 16,
	0, 0,
	...
	0, 0 );
    cleanUp_US_DB_Veloc.setMetaObject( metaObj );
    return metaObj;
}

void* US_DB_Veloc::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "US_DB_Veloc" ) )
	return this;
    return US_DB_Widgets::qt_cast( clname );
}

bool US_DB_Veloc::qt_invoke( int _id, QUObject* _o )
{
...
bool US_DB_Veloc::qt_emit( int _id, QUObject* _o )
{
    return US_DB_Widgets::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool US_DB_Veloc::qt_property( int id, int f, QVariant* v)
{
    return US_DB_Widgets::qt_property( id, f, v);
}

bool US_DB_Veloc::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
