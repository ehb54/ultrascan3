/****************************************************************************
** dcdr_dat_W meta object code from reading C++ file 'us_dcdrdat.h'
**
...
const char *dcdr_dat_W::className() const
{
    return "dcdr_dat_W";
}

QMetaObject *dcdr_dat_W::metaObj = 0;
static QMetaObjectCleanUp cleanUp_dcdr_dat_W( "dcdr_dat_W", &dcdr_dat_W::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString dcdr_dat_W::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "dcdr_dat_W", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString dcdr_dat_W::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "dcdr_dat_W", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* dcdr_dat_W::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    QMetaObject* parentObject = Data_Control_W::staticMetaObject();
    static const QUMethod slot_0 = {"setup_GUI", 0, 0 };
    static const QUMethod slot_1 = {"write_dcdr_avg", 0, 0 };
    static const QUMethod slot_2 = {"write_dcdr_scans", 0, 0 };
    static const QUMethod slot_3 = {"write_dcdr_sval", 0, 0 };
	...
	{ "write_dcdr_avg()", &slot_1, QMetaData::Private },
	{ "write_dcdr_scans()", &slot_2, QMetaData::Private },
	{ "write_dcdr_sval()", &slot_3, QMetaData::Private },
	...
	0, 0 );
    cleanUp_dcdr_dat_W.setMetaObject( metaObj );
    return metaObj;
}

void* dcdr_dat_W::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "dcdr_dat_W" ) )
	return this;
    return Data_Control_W::qt_cast( clname );
}

bool dcdr_dat_W::qt_invoke( int _id, QUObject* _o )
{
    switch ( _id - staticMetaObject()->slotOffset() ) {
    case 0: setup_GUI(); break;
    case 1: write_dcdr_avg(); break;
    case 2: write_dcdr_scans(); break;
    case 3: write_dcdr_sval(); break;
...
bool dcdr_dat_W::qt_emit( int _id, QUObject* _o )
{
    return Data_Control_W::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool dcdr_dat_W::qt_property( int id, int f, QVariant* v)
{
    return Data_Control_W::qt_property( id, f, v);
}

bool dcdr_dat_W::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
