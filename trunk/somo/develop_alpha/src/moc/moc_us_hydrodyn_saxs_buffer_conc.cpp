/****************************************************************************
** US_Hydrodyn_Saxs_Buffer_Conc meta object code from reading C++ file 'us_hydrodyn_saxs_buffer_conc.h'
**
...
const char *US_Hydrodyn_Saxs_Buffer_Conc::className() const
{
    return "US_Hydrodyn_Saxs_Buffer_Conc";
}

QMetaObject *US_Hydrodyn_Saxs_Buffer_Conc::metaObj = 0;
static QMetaObjectCleanUp cleanUp_US_Hydrodyn_Saxs_Buffer_Conc( "US_Hydrodyn_Saxs_Buffer_Conc", &US_Hydrodyn_Saxs_Buffer_Conc::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString US_Hydrodyn_Saxs_Buffer_Conc::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "US_Hydrodyn_Saxs_Buffer_Conc", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString US_Hydrodyn_Saxs_Buffer_Conc::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "US_Hydrodyn_Saxs_Buffer_Conc", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* US_Hydrodyn_Saxs_Buffer_Conc::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	"US_Hydrodyn_Saxs_Buffer_Conc", parentObject,
	slot_tbl, 12,
	0, 0,
	...
	0, 0 );
    cleanUp_US_Hydrodyn_Saxs_Buffer_Conc.setMetaObject( metaObj );
    return metaObj;
}

void* US_Hydrodyn_Saxs_Buffer_Conc::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "US_Hydrodyn_Saxs_Buffer_Conc" ) )
	return this;
    return Q3Frame::qt_cast( clname );
}

bool US_Hydrodyn_Saxs_Buffer_Conc::qt_invoke( int _id, QUObject* _o )
{
...
bool US_Hydrodyn_Saxs_Buffer_Conc::qt_emit( int _id, QUObject* _o )
{
    return Q3Frame::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool US_Hydrodyn_Saxs_Buffer_Conc::qt_property( int id, int f, QVariant* v)
{
    return Q3Frame::qt_property( id, f, v);
}

bool US_Hydrodyn_Saxs_Buffer_Conc::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
